...
const MEETINGS = [
  {
    ...
    isAgendaOnly: false,
    badge: "new",
    overview: "The Marathon County Health & Human Services Committee held an orientation meeting for new and returning board members, featuring educational presentations from the Health Department, Veteran Service Office, and Aging Disability Resource Center. The only formal action taken was approval of the April 1st meeting minutes. Department heads outlined their missions, services, and budget structures.",
    agenda: [
      { time:"0:00", item:"Call to order and remote attendance confirmation" },
      { time:"0:23", item:"Pledge of Allegiance" },
      { time:"0:52", item:"Approval of April 1st committee meeting minutes" },
      { time:"1:18", item:"Operational functions required by statute - no items presented" },
      { time:"3:35", item:"Review of standing committee ordinance section 2.04 - missions, duties, responsibilities" },
      { time:"11:50", item:"Health Department overview presentation" },
      { time:"20:00", item:"Health Department budget review and org chart" },
      { time:"40:00", item:"Social Services Department overview" },
      { time:"50:01", item:"Veteran Service Office overview presentation" },
      { time:"1:15:00", item:"Aging Disability Resource Center presentation" },
      { time:"1:30:00", item:"Next meeting date and adjournment" },
    ],
    discussions: [
      { item:"Approval of April 1st Meeting Minutes", body:"Supervisor Cavelli moved to approve the minutes, seconded by Vice Chair Rosenberg. The motion carried unanimously with no discussion." },
      { item:"Standing Committee Ordinance Review", body:"Administrator Lance Leonard explained the committee's jurisdiction under ordinance section 2.04 subsection 5, covering the Health Department, Social Services Department, Veteran Service Office, North Central Health Care, and Aging Disability Resource Center. He explained the committee's relationship with subordinate bodies including the Social Services Board, Veteran Service Commission, Transportation Coordinating Committee, and Board of Health." },
      { item:"Health Department Presentation", body:"Health Officer Caitlyn Suginaka presented an overview of the department's mission to prevent disease, promote health, and protect from environmental hazards. She highlighted programs including 1,200+ licenses for food establishments and public facilities, nurse family partnership for pregnant mothers, public health vending machines offering free tick kits and harm reduction supplies, and a new homeless system response position created from the previous session's task force. The department has 37.6 FTE and is funded approximately half by tax levy with significant grant revenue." },
      { item:"Social Services Department Overview", body:"Administrator Leonard presented on behalf of Director Christa (not present), explaining the department's 140 FTE staff covering child welfare, youth justice, children's long-term support, economic support, and child support programs. He highlighted the successful Family Keys pilot program addressing housing instability, noting the program was substantively changed based on board feedback. The department's $22 million budget includes approximately $7 million in tax levy." },
      { item:"Veteran Service Office Presentation", body:"Veteran Service Officer Erin Galindo reported the office grew from 2.75 to 3.0 FTE in 2025. Customer interactions increased from 5,900 to 8,149 in 2025. Veterans in Marathon County received $44 million annually in benefits plus $2.6 million in retroactive payments in 2025. Galindo highlighted initiatives including surviving spouse benefits outreach, housing stability programs with Center for Veterans Issues, and suicide prevention efforts noting 7 of 30 county suicides in 2025 were veterans. In response to Supervisor Kremes' question about staffing adequacy, Galindo acknowledged the office is under-manned but performing well with current resources." },
      { item:"ADRC Presentation", body:"Executive Director Mike Ray explained the four-county (Marathon, Lincoln, Langlade, Wood) organization providing aging and disability services with approximately 60 FTE and 385-400 volunteers. He noted significant financial challenges with nutrition program costs up 40-45% over four years while federal funding remained flat. The organization received its first levy increase in over a decade in 2025, with Marathon County contributing $413,135 for 2026. Vice Chair Rosenberg praised the culturally appropriate meal program at the Hmong American Center." },
    ],
    publicComment: "No public comment was offered.",
    actionItems: [
      "April 1st meeting minutes approved unanimously",
      "North Central Healthcare presentation to be scheduled for a separate future meeting",
      "Strategic plan review to be added to upcoming agenda items",
      "Next meeting confirmed as June 3rd at 3 PM (corrected from initially stated May 29th)",
    ],
  },
  {
    ...
    isAgendaOnly: false,
    badge: "new",
    overview: "The Marathon County Environmental Resources Committee approved two rezoning petitions unanimously and voted to forward a modified fee waiver resolution to the county board that will only cover septic system reconnect fees for properties damaged by the April 17, 2026 tornado. The committee also received educational presentations from Solid Waste, Parks Recreation and Forestry, and Conservation Planning and Zoning departments.",
    agenda: [
      ...
      { time:"19:45", item:"Consideration of fee waiver for properties impacted by April 17, 2026 severe weather" },
      { time:"55:00", item:"Educational presentation: Committee roles and responsibilities overview" },
      { time:"57:30", item:"Educational presentation: Solid Waste Department overview" },
    ...
    discussions: [
      ...
      { item:"Tim Veland rezoning petition - Town of Green Valley", body:"Land Use Specialist Garrett Pogle presented the staff report for rezoning from urban residential and general agriculture to rural residential for James Offer and David Tract properties. The Town of Green Valley recommended approval on March 10, 2026. No public testimony was offered. Supervisor Drebeck moved to approve based on findings of fact and town approval, Supervisor Kurt seconded. Motion carried unanimously." },
      { item:"Jeffrey and Cynthia Schmidtz rezoning petition - Town of McMillan", body:"Garrett Pogle presented the petition to rezone from conservancy recreation to general agriculture. Supervisor Leur asked about the conservancy nature of the property; Pogle explained the property contains a home and horse riding stable, and the rezoning would make the existing structures conforming uses. The Town of McMillan recommended approval on April 20, 2026. No public testimony was offered. Supervisor Sefeld moved to approve, Supervisor Drew seconded. Motion carried unanimously." },
      { item:"Fee waiver for April 17, 2026 severe weather impacted properties", body:"Director Lori Mskimmons presented a proposal to waive county zoning and septic system fees for properties damaged by the April 17 tornado in Ringle, Kronenwetter, Easton, and Weston. Supervisor Drew questioned where to draw the line for future events. Supervisor Drebeck expressed concerns about fairness to those affected by non-declared disasters. Marilyn Bend asked about septic hookup costs. After debate, Supervisor Drebeck moved to amend the resolution to only waive reconnect fees ($160) for septic systems, not other zoning or pouts fees. Supervisor Kurt seconded the amendment. The amendment passed. The amended resolution then passed with the vote not unanimous, forwarding to the county board." },
      { item:"Solid Waste Department presentation", body:"Director Dave Hagen Busher provided an overview of solid waste operations including the Bluebird Ridge landfill serving Marathon, Portage, and Shawano counties, the renewable natural gas partnership with Vidi Energy, and upcoming challenges including a $6 million expansion project and mandatory leachate pre-treatment requirements by 2032 due to PFAS regulations. Marilyn Bend praised the department's work during the Ringle tornado response." },
      { item:"Parks, Recreation and Forestry Department presentation", body:"County Forest Administrator Tom Lovelin presented on behalf of Director Jamie, covering the department's 44 full-time and 120 seasonal employees serving both county and city of Wausau parks. He highlighted Nine Mile County Forest generates $3.25 million annually for the local economy from out-of-town visitors. Supervisor Sefeld announced Tom Lovelin is retiring June 1st after nearly 30 years of service, with Joe Tucker selected as his replacement." },
    ],
    publicComment: "No public comment was offered.",
    actionItems: [
      "Rezoning approved for James Offer and David Tract properties in Town of Green Valley - forwarded to County Board",
      "Rezoning approved for Jeffrey and Cynthia Schmidtz property in Town of McMillan - forwarded to County Board",
