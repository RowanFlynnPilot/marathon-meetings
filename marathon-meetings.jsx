...
const MEETINGS = [
  {
    ...
    isAgendaOnly: false,
    badge: "new",
    overview: "The Marathon County Health & Human Services Committee held an educational orientation meeting for new and returning members, featuring presentations from department heads about the Health Department, Social Services, Veterans Service Office, and Aging & Disability Resource Center. The committee approved April 1st meeting minutes and received comprehensive overviews of each department's mission, services, budgets, and current initiatives including homelessness response efforts and veteran suicide prevention programs.",
    agenda: [
      { time:"0:00", item:"Call to order and remote participation acknowledgment" },
      ...
      { time:"3:15", item:"Review of standing committee ordinance section 2.04" },
      { time:"12:30", item:"Health Department overview presentation" },
      { time:"20:00", item:"Health Department budget and organizational discussion" },
      { time:"40:00", item:"Social Services Department overview" },
      { time:"50:00", item:"Veterans Service Office presentation" },
    ...
    discussions: [
      ...
      { item:"Review of standing committee ordinance and jurisdiction", body:"Administrator Lance Leonard explained the committee's structure under ordinance section 2.04 sub 5, including reporting relationships with the Health Department, Social Services, Veterans Service Office, North Central Health Care, and Aging & Disability Resource Center. He noted the committee will receive reports from statutory bodies including the Social Services Board, Veterans Service Commission, Transportation Coordinating Committee, and Board of Health. Chair Boots emphasized the upcoming strategic plan development expected to be completed by December." },
      { item:"Health Department overview", body:"Health Officer Caitlyn Suginaka presented on the department's mission of preventing disease, promoting health, and protecting against environmental hazards. She highlighted over 1,200 licenses overseen for restaurants, pools, and campgrounds, the Nurse Family Partnership program now graduating its first two-year-olds, public health vending machines with free tick kits and harm reduction supplies, and a new homeless system response position. The department has approximately 37.6 FTE with about half of their $5 million budget from tax levy and the rest from grants and service charges. Discussion included emergency preparedness for potential measles outbreaks." },
      { item:"Social Services Department overview", body:"Administrator Leonard presented on behalf of Director Christa, who was unavailable. The department has nearly 140 FTE with a $22 million budget, of which about $7 million is tax levy. He highlighted the successful Family Keys housing stability pilot program that addresses root causes of housing instability for child welfare and youth justice families, noting many participants had never had bank accounts or formal leases before. The department handles child protective services, youth justice, children's long-term support, economic support, and child support services." },
      { item:"Veterans Service Office presentation", body:"Veterans Service Officer Erin Galindo reported the office now has 3.0 FTE and had 8,149 interactions in 2025, up significantly from 5,900. Veterans in Marathon County received $44 million annually in VA benefits with $2.6 million in retroactive payments in 2025 alone. He noted seven of Marathon County's 30 suicides in 2025 were veterans, making suicide prevention a priority. The office is pursuing the Staff Sergeant Gordon Fox Grant for veteran suicide prevention and has established a partnership with Center for Veterans Issues for housing stability. Supervisor Kremes asked about regional coordination, and Galindo explained state statute requires each county to have its own VSO but they collaborate extensively with neighboring counties." },
      { item:"Aging & Disability Resource Center presentation", body:"Executive Director Mike Ray explained the ADRC serves four counties (Marathon, Lincoln, Langlade, and Wood) with about 60 FTE and 385-400 volunteers. The organization receives 11% of funding from county levy, with Marathon County contributing $413,135 for 2026. He emphasized severe financial challenges with nutrition program costs rising 40-45% over four years while federal funding remained flat due to non-reauthorization of the Older Americans Act. Vice Chair Rosenberg praised the culturally appropriate meal program at the Hmong American Center." },
    ],
    ...
    actionItems: [
      ...
      "ADRC Executive Director to present annual report with 2025 data to full county board",
      ...
      "Strategic plan development to be addressed at upcoming meetings with goal of completion by December",
    ],
  },
  {
    ...
    isAgendaOnly: false,
    badge: "new",
    overview: "The Marathon County Board of Supervisors held an adjourned organizational meeting where they approved committee appointments, elected Supervisors Hapa and Arstead to the Executive Committee at-large positions, and unanimously passed a resolution reducing landfill tipping fees for disaster-related debris following severe weather that devastated parts of the county, particularly the town of Ringle.",
    agenda: [
      { time:"0:00", item:"Pledge of Allegiance and moment of reflection" },
      { time:"2:00", item:"Reading of meeting notice" },
      { time:"3:00", item:"Roll call and sign-in" },
      { time:"5:01", item:"Chair remarks on committee appointments" },
      ...
      { time:"23:00", item:"Resolution 26-26: Landfill tipping fee modification" },
      { time:"1:15:00", item:"Announcements and adjournment" },
    ],
    discussions: [
      { item:"Committee Appointments", body:"Chair Gibbs explained the goals guiding committee appointments, including increasing diversity of perspective, providing leadership development opportunities for newer supervisors (34% of the board is in first or second term), and honoring supervisor preferences. Vice Chair Boots assisted in developing the appointments. The motion was made by Supervisor Cavelli and seconded by Supervisor Crims. The motion carried but was not unanimous." },
      { item:"Election of At-Large Executive Committee Members", body:"Three supervisors were nominated for two at-large Executive Committee positions: Supervisor Hapa (nominated by Supervisor Mask), Supervisor Leur (nominated by Supervisor Rosenberg), and Supervisor Arstead (nominated by Supervisor Boots). Supervisor Rosenberg explained she nominated Supervisor Leur because she had seen her advocate for the county's youngest children and oldest elders. Paper ballots were distributed and Supervisors Hapa and Arstead were elected to the Executive Committee." },
      { item:"Consent Agenda (Items C10-C14A)", body:"The consent agenda was approved unanimously on a motion by Supervisor Cavelli and second by Supervisor Drebeck." },
      { item:"Resolution 24-26: Out of Home Placement Reserve Increase", body:"Motion by Supervisor Morash, seconded by Supervisor Robinson. The resolution was approved but was not unanimous." },
      { item:"Resolution 25-26: Social Services Budget Amendment", body:"Motion by Supervisor P, seconded by Supervisor Robinson. The resolution was approved but was not unanimous." },
      { item:"Resolution 26-26: Landfill Tipping Fee Modification", body:"Administrator Leonard and Solid Waste Director Hagen Busher presented a proposal from the Solid Waste Management Board to reduce tipping fees for debris from the recent severe weather disaster that impacted Ringle and other communities. The state waived $13.10 per ton, Ringle planned to waive $2.33, and the county proposed reducing fees to $36.94 per ton (covering operational costs). Public comment was allowed with Jessica Tolesie and Matt Haybeck requesting the county waive fees entirely and extend the timeline to six months. Multiple supervisors asked questions about fee structures, timeline extensions, and future policy. The board first voted unanimously to suspend rules to consider the resolution directly from the Solid Waste Management Board, then passed Resolution 26-26 unanimously on a motion by Supervisor Arstead and second by Supervisor Morash." },
    ],
    publicComment: "Two residents were granted special dispensation to speak on the landfill tipping fee resolution. Jessica Tolesie asked the county to fully waive fees for six months, noting the state, DNR, and Ringle were waiving their portions, and that residents face insurance deductibles and uncovered expenses. Matt Haybeck spoke on behalf of residents whose homes must be demolished, requesting fee relief for underinsured homeowners and noting some insurance adjusters haven't yet arrived.",
    actionItems: [
      "Committee appointments for 2025-2027 term approved",
      "Supervisors Hapa and Arstead elected to Executive Committee at-large positions",
      "Resolution 26-26 approved reducing landfill tipping fees to approximately $36.94 per ton for disaster-related debris through June 17, 2025",
      "Administrator Leonard to continue discussions with the Community Foundation about reimbursing uninsured disaster cleanup costs",
      "Solid Waste Management Board directed to develop a formal policy on handling similar disaster situations within six months",
      "Board may revisit tipping fee relief at May meeting if extension beyond June 17 is needed",
    ],
  },
  {
    ...
    isAgendaOnly: false,
    badge: "new",
    overview: "The Marathon County Environmental Resources Committee approved two rezoning petitions unanimously and voted to forward a modified fee waiver resolution to the county board that will only cover septic reconnect fees (not other zoning or septic fees) for properties damaged by the April 17, 2026 tornado. The committee also received educational presentations from Solid Waste, Parks Recreation and Forestry, and Conservation Planning and Zoning departments.",
    agenda: [
      { time:"0:00", item:"Call to order and Pledge of Allegiance" },
      { time:"0:45", item:"Public comment" },
      { time:"0:52", item:"Approval of March 31, 2026 committee minutes" },
      ...
      { time:"55:02", item:"Educational presentation: Department introductions and ERC roles and responsibilities" },
      { time:"57:00", item:"Educational presentation: Solid Waste Department overview" },
      { time:"1:17:30", item:"Educational presentation: Parks, Recreation, and Forestry Department overview" },
      { time:"1:35:02", item:"Educational presentation: Conservation Planning and Zoning Department overview" },
    ],
    discussions: [
      { item:"Approval of March 31, 2026 committee minutes", body:"Supervisor Sefeld made a motion to approve the minutes, seconded by Supervisor Drebeck. The motion passed unanimously with no discussion." },
      { item:"Tim Veland rezoning petition - Town of Green Valley", body:"Garrett Pogle presented the staff report for rezoning from urban residential and general agriculture to rural residential for a land division. The Town of Green Valley recommended approval on March 10, 2026. No public testimony was offered for or against. Supervisor Drebeck moved to approve based on findings of fact, conclusions of law, and town approval. Supervisor Kurt seconded. Motion passed unanimously." },
      { item:"Jeffrey and Cynthia Schmidtz rezoning petition - Town of McMillan", body:"The petition sought to rezone from Conservancy Recreation to General Agriculture. Supervisor Lever asked about the conservancy nature, and Garrett Pogle explained the property has a home and horse riding stable, with the rezoning needed to make the home a conforming use rather than non-conforming. No natural areas would be lost. Town of McMillan recommended approval on April 20, 2026. No public testimony was offered. Supervisor Sefeld moved to approve, Supervisor Drew seconded. Motion passed unanimously." },
      { item:"Fee waiver for April 17, 2026 severe weather properties", body:"Director Lori Mskimmons presented a proposal to waive county zoning and septic fees for tornado-damaged properties in Ringle, Kronenwetter, Easton, and Weston. Supervisor Drew questioned fairness to individual tornado victims who don't receive fee waivers. Supervisor Drebeck expressed concerns about precedent. Supervisor Sefeld questioned tracking costs and potential levy impacts. Administrator Lance Pliml clarified this wouldn't require additional staff costs. Supervisor Sefeld moved to forward the full resolution. After debate, Supervisor Drebeck proposed an amendment to limit the waiver to only reconnect fees ($160) for septic systems, not other zoning or septic fees. Supervisor Kurt seconded the amendment. The amendment passed (not unanimous). The amended resolution then passed to forward to county board (not unanimous)." },
      { item:"Solid Waste Department presentation", body:"Director David Hagenbusher provided an overview of the landfill operations, explaining the tipping fee breakdown, the renewable natural gas partnership with Vidi Energy, and upcoming challenges including leachate treatment requirements by 2032 due to PFAS concerns. He noted a $6 million cell construction project starting this year. Marilyn Bend praised the department's work during the Ringo tornado response." },
      { item:"Parks, Recreation, and Forestry Department presentation", body:"Tom Lovelin, County Forest Administrator, presented on behalf of Director Jamie who had an emergency. He covered the joint city-county park system, the 30,700-acre county forest, and Nine Mile County Forest's $3.25 million annual economic impact from out-of-town visitors. Supervisor Sefeld announced Tom's retirement effective June 1st after nearly 30 years of service. Multiple committee members thanked him for his service." },
    ],
    publicComment: "No public comment was offered. No one signed up for public comment.",
    actionItems: [
      "Forward modified fee waiver resolution to county board - waiving only septic reconnect fees ($160) for properties damaged by April 17, 2026 severe weather",
      "Forward James Offer\/David Tract rezoning (urban residential\/general agriculture to rural residential, Town of Green Valley) to county board for approval",
      "Forward Jeffrey and Cynthia Schmidtz rezoning (Conservancy Recreation to General Agriculture, Town of McMillan) to county board for approval",
      "Town of Green Valley and Town of McMillan should update comprehensive plans to reflect zoning changes if applicable",
      "CPZ to track costs and requests related to tornado fee waivers for future policy consideration",
