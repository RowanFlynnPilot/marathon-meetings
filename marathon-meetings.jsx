...
const MEETINGS = [
  {
    ...
    isAgendaOnly: false,
    badge: "new",
    overview: "This agenda is for the Village of Weston Board of Trustees regular meeting, not a Parks Committee meeting as indicated in the metadata. The meeting was expected to cover multiple rezoning ordinances, a subdivision plat approval, parking restrictions, park-related items including shelter fees and field maintenance, infrastructure projects, and various administrative matters. Note: This summary is based on the agenda document only, not a transcript.",
    agenda: [
    ...
    discussions: [
      { item:"Ordinance No. 26-004: Rezoning of 8905 Birch Street", body:"This ordinance would rezone a portion of property at 8905 Birch Street from Rural Residential-5 Acre (RR-5) to Single Family Residential-Small Lot (SF-S) zoning district. This represents a significant density increase for the affected property." },
      { item:"Ordinance No. 26-005: Rezoning of 7105 Christiansen Avenue", body:"This ordinance would rezone a portion of property at 7105 Christiansen Avenue from Single Family Residential-Large Lot (SF-L) to Single Family Residential-Small Lot (SF-S). This would allow for smaller lot development on the property." },
      { item:"Ordinance No. 26-006: Speed Limits Amendment", body:"This ordinance would amend Chapter 82.600 of the Municipal Code relating to speed limits. The specific streets or speed changes are not detailed in the agenda." },
      { item:"Resolution No. 2026-008: Hinner Springs Second Addition Subdivision Final Plat", body:"The Board is expected to consider approval of the final plat for the Hinner Springs Second Addition Subdivision, which would authorize the development to proceed." },
      { item:"April 2026 Referendum Informational Sessions Update", body:"This discussion-only item involves an update on informational sessions planned for an April 2026 referendum. The agenda does not specify the subject of the referendum." },
      { item:"Proposed E-Bicycle and E-Moto Ordinance", body:"The Board will discuss whether to refer dialogue on proposed regulations for electric bicycles and electric mopeds to the Community Life and Public Safety Committee." },
      ...
      { item:"Intersection Signage at Community Center Drive and Birch St", body:"The Board will discuss and potentially take action on signage at the intersection of Community Center Drive and Birch Street." },
      { item:"Baseball\/Softball Field Maintenance and User Agreement", body:"The Board will consider a maintenance and user agreement for baseball and softball fields, which would establish responsibilities and terms for field use." },
      ...
      { item:"Park Shelter Fees and Field Rental Costs", body:"The Board will discuss and potentially take action on fee structures for park shelter rentals and field rental costs." },
      { item:"Eagle Scout Project at Machmueller Park", body:"The Board will consider approval of an Eagle Scout project proposed for Machmueller Park. Specific project details are not included in the agenda." },
      ...
      { item:"Microsoft Teams for Communication", body:"The Board will discuss and potentially take action on implementing Microsoft Teams as a communication platform for village operations." },
      { item:"Military Road Utility Engineering Services Contract", body:"The Board will consider an engineering services contract for utility work on Military Road." },
      { item:"Bus 51 Storm Pond Engineering Services Contract Amendment", body:"The Board will consider an amendment to the existing engineering services contract for the Bus 51 storm pond project." },
      { item:"Sewer Televising Software Contract", body:"The Board will consider a contract for software related to sewer televising inspection operations." },
      { item:"2026 Annual Street Maintenance Plan and Budget", body:"The Board will discuss and potentially approve the annual street maintenance plan and associated budget for 2026." },
      { item:"Hospital Area Repaving Change Order #4", body:"The Board will consider the fourth change order for the hospital area repaving project." },
      { item:"Well 2 Rehabilitation", body:"The Board will discuss and potentially take action on rehabilitation work for Well 2 in the village's water system." },
      { item:"Sign Encroachment Agreement with Macco's Floor Covering", body:"The Board will consider a sign encroachment agreement with 7th Floor Investments, LLC (Macco's Floor Covering) at 3111 Schofield Avenue." },
    ],
    publicComment: "Public comment period is on the agenda for up to three minutes per person regarding non-agenda items, with time extension permitted at the Chief Presiding Officer's discretion.",
    actionItems: [
      ...
      "Approve consent agenda including vouchers and agent change for Reliance Fuel LLC",
      "Acknowledge work product transmittals including building permits, budget status, and code enforcement reports",
    ],
  },
  {
    ...
    isAgendaOnly: false,
    badge: "new",
    overview: "The Village of Weston Board of Trustees was scheduled to meet on March 23, 2026, to consider multiple rezoning ordinances, a subdivision plat approval, parking restrictions, park-related matters, utility infrastructure projects, and various policy discussions. Note: The meeting title indicates 'Finance and Human Resources Committee' but the agenda is actually for a Board of Trustees regular meeting. This summary is based on the agenda, not a transcript.",
    agenda: [
    ...
    discussions: [
      { item:"Ordinance No. 26-004: Rezoning of 8905 Birch Street", body:"This ordinance would approve rezoning a portion of 8905 Birch Street from RR-5 (Rural Residential-5 Acre) to SF-S (Single Family Residential-Small Lot) zoning district, potentially allowing for higher density residential development." },
      { item:"Ordinance No. 26-005: Rezoning of 7105 Christiansen Avenue", body:"This ordinance would approve rezoning a portion of 7105 Christiansen Avenue from SF-L (Single Family Residential-Large Lot) to SF-S (Single Family Residential-Small Lot), which could enable smaller lot residential development on the property." },
      ...
      { item:"Resolution No. 2026-008: Hinner Springs Second Addition Subdivision", body:"The Board was to consider approval of the final plat for the Hinner Springs Second Addition Subdivision, which would authorize the development to proceed." },
      { item:"April 2026 Referendum Informational Sessions Update", body:"Discussion-only item regarding updates on informational sessions planned for an April 2026 referendum, though specific referendum details are not provided in the agenda." },
      { item:"E-Bicycle and E-Moto Ordinance", body:"The Board was to discuss proposed regulations for e-bicycles and e-motos, with dialogue to occur at the Community Life and Public Safety Committee level." },
      { item:"Parking Restrictions Removal", body:"The Board was to consider removing no parking restrictions on Alta Verde St south of Jelinek Avenue and on Alderson Street along Kennedy Park." },
      { item:"Baseball\/Softball Field Maintenance and User Agreement", body:"Discussion and possible action on maintenance arrangements and user agreements for village baseball and softball fields." },
      { item:"Park Shelter Fees and Field Rental Costs", body:"The Board was to review and potentially adjust fees for park shelter rentals and field usage." },
      { item:"Eagle Scout Project at Machmueller Park", body:"The Board was to consider approval of an Eagle Scout project proposed for Machmueller Park." },
      { item:"Remote Meeting Attendance Policy", body:"Review of the Elected and Appointed Officials' Handbook specifically regarding the policy for remote meeting attendance." },
      { item:"Microsoft Teams for Communication", body:"Discussion regarding the potential adoption or use of Microsoft Teams as a communication platform for village operations." },
      { item:"Military Road Utility Engineering Services Contract", body:"The Board was to consider a contract for engineering services related to utilities on Military Road." },
      { item:"Bus 51 Storm Pond Engineering Services Contract Amendment", body:"Amendment to an existing engineering services contract for the Bus 51 Storm Pond project." },
      { item:"Sewer Televising Software Contract", body:"The Board was to consider a contract for sewer televising software to support infrastructure inspection and maintenance." },
      { item:"2026 Annual Street Maintenance Plan and Budget", body:"Review and approval of the village's annual plan and budget for street maintenance activities in 2026." },
      { item:"Hospital Area Repaving Change Order #4", body:"The Board was to consider the fourth change order for the hospital area repaving project, indicating ongoing modifications to the project scope or costs." },
      { item:"Well 2 Rehabilitation", body:"Discussion and possible action on rehabilitation work needed for Well 2 in the village's water system." },
    ...
    actionItems: [
      ...
      "Consider Eagle Scout Project at Machmueller Park",
      "Review Remote Meeting Attendance Policy",
      "Consider use of Microsoft Teams for Communication",
      "Consider Military Road Utility Engineering Services Contract",
  ...
  },
  {
    ...
    isAgendaOnly: false,
    badge: "new",
    overview: "The Village of Weston Board of Trustees was scheduled to consider multiple rezoning ordinances, a subdivision final plat approval, various infrastructure and parks-related items, and discuss an upcoming April 2026 referendum. Based on agenda only, not a transcript.",
    agenda: [
    ...
    discussions: [
      { item:"Ordinance No. 26-004: Rezoning 8905 Birch Street", body:"This ordinance would rezone a portion of 8905 Birch Street from Rural Residential-5 Acre (RR-5) to Single Family Residential-Small Lot (SF-S) zoning district, potentially allowing for higher density residential development." },
      { item:"Ordinance No. 26-005: Rezoning 7105 Christiansen Avenue", body:"This ordinance would rezone a portion of 7105 Christiansen Avenue from Single Family Residential-Large Lot (SF-L) to Single Family Residential-Small Lot (SF-S), allowing for smaller lot residential development." },
      { item:"Ordinance No. 26-006: Speed Limits Amendment", body:"This ordinance would amend Chapter 82.600 of the Municipal Code relating to speed limits within the Village of Weston." },
      { item:"Resolution No. 2026-008: Hinner Springs Second Addition Final Plat", body:"The Board was scheduled to consider approval of the final plat for Hinner Springs Second Addition Subdivision, which would authorize the development to proceed." },
      { item:"April 2026 Referendum Informational Sessions Update", body:"This discussion-only item would provide the Board with an update on informational sessions being planned for an upcoming April 2026 referendum." },
      { item:"E-Bicycle and E-Moto Ordinance", body:"The Board was to discuss or take action on a proposed ordinance addressing e-bicycles and e-motos, with dialogue occurring at the Community Life and Public Safety Committee level." },
      { item:"Parking Restrictions Removal", body:"The Board was to consider removing no parking restrictions on Alta Verde Street south of Jelinek Avenue and on Alderson Street along Kennedy Park." },
      { item:"2026 Annual Street Maintenance Plan and Budget", body:"The Board was scheduled to discuss and potentially approve the annual street maintenance plan and associated budget for 2026." },
      ...
      { item:"Well 2 Rehabilitation", body:"The Board was scheduled to discuss and potentially approve rehabilitation work on Well 2, which serves the Village's water system." },
      { item:"Park Shelter Fees and Field Rental Costs", body:"The Board was to review and potentially adjust fees for park shelter rentals and field usage within Village parks." },
      { item:"Remote Meeting Attendance Policy Review", body:"The Board was scheduled to review the Elected and Appointed Officials' Handbook policy regarding remote meeting attendance." },
    ],
    publicComment: "Public comment was on the agenda, allowing any person to address the Board for up to three minutes regarding non-agenda items, with time extensions permitted at the Chief Presiding Officer's discretion.",
    actionItems: [
      ...
      "Consider E-Bicycle and E-Moto ordinance direction",
  ...
  },
  {
    ...
    isAgendaOnly: false,
    badge: "new",
    overview: "This Board of Public Works meeting was expected to cover bid openings for two 2026 construction projects, change orders and payment for an ongoing 2025 street project, and a concrete license application. Based on the agenda, not a transcript.",
    agenda: [
    ...
    discussions: [
      ...
      { item:"2026 Asphalt Paving Project 'A'", body:"The board was scheduled to open sealed bids for the 2026 asphalt paving project and make a recommendation for contract award." },
      { item:"Randolph Street\/Cherry Street Change Orders", body:"The board was to consider Change Order #1 and Change Order #2 for the ongoing 2025 street construction project being performed by Haas Sons, Inc. on Randolph Street and Cherry Street." },
      { item:"Randolph Street\/Cherry Street Pay Estimate #9", body:"The board was to consider Pay Estimate #9 for Haas Sons, Inc. for work completed on the 2025 Randolph Street\/Cherry Street construction project." },
      { item:"Portland Cement Concrete License: KSK, Inc.", body:"The board was to consider a Portland Cement Concrete License application submitted by KSK, Inc." },
    ],
  ...
  },
  {
    ...
    discussions: [
      { item:"Election of a Vice Chair", body:"The commission was scheduled to elect a vice chair for the Plan Commission. This is a leadership position that would preside in the absence of Mayor Doug Diny." },
      { item:"Conditional Use Permit - 218 South 4th Street (Dunwoody Storage)", body:"A public hearing was scheduled regarding a Conditional Use Permit request to authorize construction of a Personal Storage Facility in the Light Industrial (LI) Zoning District. The applicant is Dunwoody Storage." },
      { item:"Conditional Use Permit - 731 N 1st Street (Beacon Resources, LLC)", body:"The commission was to consider a Conditional Use Permit for a significant residential development project. Beacon Resources, LLC proposed a 70-unit apartment building standing 7 stories tall." },
      { item:"Transportation Project Plat - Grand Avenue Signal Replacements", body:"The commission was scheduled to review and potentially approve a Transportation Project Plat for Project 370-40-40. This involves signal replacements at Grand Avenue, Sturgeon Eddy Road, and Townline Road." },
    ],
    ...
    actionItems: [
      ...
      "Vote on Conditional Use Permit for 218 South 4th Street personal storage facility",
      "Vote on Conditional Use Permit for 731 N 1st Street 70-unit apartment building",
      "Vote on Transportation Project Plat for Grand Avenue signal replacements",
    ],
    civicItems: [
  ...
  },
  {
    ...
    isAgendaOnly: false,
    badge: "new",
    overview: "This Board of Public Works meeting was scheduled to open bids and make a recommendation for the 2026 Asphalt Paving Project 'A'. Based on the agenda only, this appears to be a focused meeting on a single infrastructure matter.",
    agenda: [
      { time:"N\/A", item:"Open bids and make recommendation for 2026 Asphalt Paving Project 'A'" },
    ],
    discussions: [
      { item:"2026 Asphalt Paving Project 'A' Bids", body:"The board was scheduled to open sealed bids submitted for the 2026 Asphalt Paving Project 'A' and evaluate them to make a recommendation. This is a standard procurement process for municipal road maintenance and improvement work." },
    ],
    publicComment: "Not indicated on agenda.",
    actionItems: [
      "Open bids for 2026 Asphalt Paving Project 'A'",
      "Make recommendation on 2026 Asphalt Paving Project 'A' contractor selection",
    ],
    civicItems: [
  ...
  },
  {
    ...
    isAgendaOnly: false,
    badge: "new",
    overview: "The Public Health & Safety Committee was scheduled to consider updates to solid waste disposal regulations, repeal of a mobile phone driving ordinance, and a solar energy partnership. The meeting also included informational presentations on fire department operations and tavern activities. Note: This summary is based on the agenda, not a transcript.",
    agenda: [
      { time:"N\/A", item:"Public comment on agenda items" },
    ...
    discussions: [
      { item:"Various license applications", body:"The committee was scheduled to review and take action on various license applications, with specific details to be presented at the meeting." },
      { item:"Solid Waste Disposal Code Update", body:"The committee was to consider repealing and recreating Wausau Municipal Code Chapter 6.44 governing solid waste disposal, indicating a comprehensive update to the city's waste management regulations." },
      { item:"Mobile Phone Driving Ordinance Repeal", body:"The committee was to consider repealing the local ordinance prohibiting use of hand-held mobile telephones and electronic devices while driving, potentially due to state law preemption or other factors." },
      { item:"Grow Solar Partnership MOU", body:"The committee was to consider a memorandum of understanding with the Midwest Renewable Energy Association to partner in operating the Grow Solar Central Wisconsin Group Buy Program, a solar energy initiative." },
      { item:"Fire Department 2025 Annual Report", body:"The Wausau Fire Department was scheduled to present its 2025 annual report as an informational discussion item for the committee." },
      { item:"Tavern Activities Report", body:"A report on tavern activities from February 2026 was scheduled for discussion, providing the committee with updates on licensed establishment activity." },
      { item:"Community Outreach Update", body:"An update on community outreach efforts was scheduled for discussion, though specific details were not provided in the agenda." },
    ],
  ...
  },
  {
    ...
    isAgendaOnly: false,
    badge: "new",
    overview: "The Wausau Finance Committee was scheduled to address multiple fiscal matters including airport ground leases, a national opioid settlement, budget amendments for water infrastructure and fund carryovers, and potential property acquisitions for the Public Works department. This agenda reflects significant city financial decisions including debt issuance and participation in multi-state litigation settlement. Note: This summary is based on the agenda, not a transcript.",
    agenda: [
      { time:"N\/A", item:"Public comment on agenda items" },
    ...
    discussions: [
      { item:"Alleged Claim for Recovery of Unlawful Tax - Green Acres at Greenwood Hills, LLC", body:"The committee was to consider approving a claim for recovery of unlawful tax related to Outlot 1 of this property, suggesting a tax assessment dispute requiring resolution." },
      { item:"Airport Ground Lease Transfers at 939 Woods Place", body:"Three related items involving termination of an existing ground lease with Wynn O. Jones, approval of title transfer for buildings and improvements, and establishing a new lease with Owen Jones at the same airport location." },
      { item:"Airport Ground Lease with Cole Lundberg", body:"The committee was to consider approving a new airport ground lease agreement with Cole Lundberg, separate from the Woods Place transactions." },
      { item:"Six Remnant Defendants National Opioid Settlement Agreement", body:"The city was considering approval to participate in a national opioid settlement agreement, which would provide the city with settlement funds related to the ongoing opioid litigation against remaining defendants." },
      { item:"Wausau Water Works Lead Service Line Replacement Budget Amendment", body:"A budget amendment was proposed to cover costs for the 2025 lead service line replacement project that exceed the funding provided by the Wisconsin DNR subsidized loan." },
      { item:"Budget Amendment for 2025-2026 Fund Carryover", body:"The committee was to approve carrying over unspent funds from the 2025 budget year into 2026, a standard year-end financial procedure." },
      { item:"2025 Motor Pool Fund Review", body:"A financial review of the Motor Pool Fund's 2025 performance was scheduled, along with consideration of any necessary budget amendments based on results." },
      { item:"2026 General Obligation Promissory Note", body:"The committee was to approve issuing general obligation debt to fund capital improvement projects for 2026, a significant borrowing decision for the city." },
      { item:"2025 General Fund Financial Results Review", body:"A review of the city's overall General Fund financial performance for 2025 was scheduled, providing insight into the city's fiscal health." },
      { item:"DPW Streets Division Property Acquisitions", body:"The committee was to consider purchasing four properties on Adolph Street and Myron Street to expand land available to the Department of Public Works Streets Division, with negotiations to occur in closed session." },
    ],
    ...
    actionItems: [
      ...
      "Vote on consent to transfer title at 939 Woods Place",
      ...
      "Vote on participation in Six Remnant Defendants National Opioid Settlement",
      ...
      "Vote on property acquisitions for DPW Streets Division",
    ],
    civicItems: [
      { number:"1", name:"Public comment on agenda items and reading of the City of Wausau Public Comment Statement.", votes:[], docs:[], children:[] },
  ...
  },
  {
    ...
    isAgendaOnly: false,
    badge: "new",
    overview: "This regular Wausau Common Council meeting was expected to cover various ordinances and resolutions including solid waste service agreements, airspace obstruction removal agreements near the airport, a police department budget modification, and a development agreement for Waterside Place. The agenda also included a closed session regarding litigation strategy for an ongoing court case. Based on the agenda, not a transcript.",
    agenda: [
      { time:"N\/A", item:"Proclamation: Sarah Ruffi Day (March 31, 2026)" },
      { time:"N\/A", item:"Mayoral Citation Recognition of DPW Plow Crews and Support Team" },
      { time:"N\/A", item:"Sustainability Award to Kolbe & Kolbe Millwork Co., Inc." },
      { time:"N\/A", item:"Comments and suggestions from preregistered citizens" },
      { time:"N\/A", item:"26-0308 Ordinance Amending Section 9.20.070 Fires, Fireworks, Firearms, Missiles" },
      { time:"N\/A", item:"92-0623 Resolution Approving Parking Lot Lease Renewal with Colonial Property 4, LLC" },
      { time:"N\/A", item:"26-0302 Confirming Mayor's Appointments to Plan Commission, Affordable Housing Task Force, and BID Board" },
      { time:"N\/A", item:"92-1009 Resolution Approving Residential Solid Waste and Recycling Service Agreement with Harter's Fox Valley Disposal LLC" },
      { time:"N\/A", item:"26-0203 Resolution Approving Airspace Obstruction Removal Agreement with Schofield Ridgeland Legacy LLC" },
      { time:"N\/A", item:"26-0204 Resolution Approving Airspace Obstruction Removal Agreement with Zachary Lange" },
      { time:"N\/A", item:"25-1109A Resolution for Police Department Budget Modification for Red-Dot Optics Purchase" },
      { time:"N\/A", item:"25-1011 Joint Resolution Approving Development Agreement for Waterside Place at 11 Scott Street" },
      { time:"N\/A", item:"90-1136 Ordinance Repealing and Recreating Chapter 6.44 Solid Waste Disposal" },
      { time:"N\/A", item:"26-0307 Resolution Approving Settlement Release - David Hoelzel v. City of Wausau" },
      { time:"N\/A", item:"26-0309 Joint Resolution Approving Paid Duty Time for Out of Country Police Training" },
      { time:"N\/A", item:"26-0310 Joint Resolution Approving Community Outreach Professional Shelter Operations Duty Premium" },
      { time:"N\/A", item:"Closed Session regarding litigation strategy for Marathon County Case No. 25-CV-594" },
    ],
    discussions: [
      { item:"DPW Recognition and Sustainability Award", body:"The Council was expected to present a Mayoral Citation to the Department of Public Works plow crews and support team for exemplary service, and the Sustainability, Energy, & Environment Committee was to present an award to Kolbe & Kolbe Millwork Co., Inc." },
      { item:"Solid Waste and Recycling Service Agreement", body:"Resolution 92-1009 from the Finance Committee involves approving a residential solid waste and recycling service agreement with Harter's Fox Valley Disposal LLC. This represents a significant contract for city waste management services." },
      { item:"Airspace Obstruction Removal Agreements", body:"Two related resolutions (26-0203 and 26-0204) involve agreements with property owners on Ridgeland Avenue in Schofield for airspace obstruction removal, likely related to airport safety zones. Both include related budget modifications." },
      { item:"Police Department Budget Modification for Red-Dot Optics", body:"Resolution 25-1109A would allow the Police Department to use proceeds from the sale of a Thompson sub-machinegun to purchase red-dot optics equipment." },
      { item:"Waterside Place Development Agreement", body:"Joint Resolution 25-1011 from the Economic Development and Infrastructure & Facilities Committees involves approving a development agreement and amended parking agreement with 11 Scott Street, LLC for the Waterside Place project." },
      { item:"Solid Waste Disposal Code Update", body:"Ordinance 90-1136 from the Public Health & Safety Committee would repeal and recreate Wausau Municipal Code Chapter 6.44 regarding Solid Waste Disposal, requiring suspension of normal council rules for consideration." },
      { item:"Settlement of Hoelzel Litigation", body:"Resolution 26-0307 involves approving a release of claims for settlement of a counterclaim and third party complaint in David Hoelzel v. City of Wausau. A closed session was scheduled to discuss litigation strategy with legal counsel." },
      { item:"Police Training and Shelter Operations Staffing", body:"Two joint resolutions from Human Resources and Finance Committees address paid duty time for out-of-country police training (26-0309) and a community outreach professional shelter operations duty premium differential (26-0310)." },
    ],
    publicComment: "Public comment was scheduled both before the business meeting (Item 6 - preregistered citizens) and after (Item 13 - citizens present during Public Comment). The agenda included reading of the City's Public Comment Statement.",
    actionItems: [
      "Vote on ordinance amending parks code regarding fires, fireworks, firearms, and missiles",
      ...
      "Vote on settlement release for David Hoelzel litigation",
      "Vote on paid duty time for out-of-country police training",
      "Vote on shelter operations duty premium differential",
      "Closed session discussion on litigation strategy",
    ],
    civicItems: [
  ...
  },
  {
    ...
    isAgendaOnly: true,
    badge: "new",
    overview: "The Education\/Operations Committee Meeting addressed the district's 4K program partnerships for 2026-2027, provided a comprehensive annual safety update including drill debriefs, and reviewed extensive policy updates through Neola. The meeting featured recognition of John Marshall Elementary through the Excellence in Action segment.",
    agenda: [
    ...
    discussions: [
      { item:"4K Program Agreement", body:"The district's four-year-old kindergarten program seeks approval for 2026-2027 partnership agreements with community collaboration sites including Wausau Child Care, Mountain View Montessori, Woodson YMCA, Newman Catholic Schools, and Marathon County Head Start. These partnerships have been ongoing since 2002, with 4K Principal Kara Rakowski and Director Julie Schell presenting the agreement details." },
      { item:"Annual Safety Update \/ Drill Debrief", body:"The district presented its comprehensive safety program using the I Love U Guys Standard Response Protocol with standardized vocabulary (HOLD, SECURE, LOCKDOWN, EVACUATE, SHELTER) for consistent emergency responses. Security highlights include secure building entrances, Visitor Aware System, security cameras, locked exterior doors, and district-wide drills conducted in September and October in partnership with Wausau Police Department and School Resource Officers." },
      { item:"Neola Policies Update", body:"The committee reviewed proposed changes to 43 district policies covering a wide range of topics including board member conduct, employment practices, student entrance age, third grade promotion and retention, academic honesty, drug policies, drone use, school safety, food service, and wellness. The update includes both Volume 34 Number 2 policy revisions and technical corrections to existing policies." },
    ],
  ...
  },
  {
    ...
    discussions: [
      { item:"Discussion regarding the Competitive Negotiations of a Purchase\/Sale of Real Estate", body:"The board entered closed session under Wisconsin Statute 19.85(1)(e) to discuss competitive negotiations related to the purchase or sale of real estate. This exemption allows private deliberation to protect the district's bargaining position in property transactions." },
      { item:"Evaluation of Superintendent of Schools", body:"The board conducted a closed session evaluation of the Superintendent of Schools under Wisconsin Statute 19.85(1)(c). This statute permits private discussion of employee performance evaluations to protect personnel matters." },
    ],
    ...
    actionItems: [
      ...
      "Potential action as a result of closed session superintendent evaluation",
    ],
  },
  {
    ...
    isAgendaOnly: true,
    badge: "new",
    overview: "The Wausau School District Board of Education held a regular meeting covering referendum construction updates for elementary schools, charter school status, policy updates, and safety reports. Key action items included approving 4K program agreements with community partners, policy revisions, and a resolution of commendation for Rob Hughes.",
    agenda: [
      { time:"0:00", item:"Call to Order" },
    ...
    discussions: [
      ...
      { item:"4K Program Agreement", body:"The Wausau School District four-year-old kindergarten program sought approval to enter into agreements with community collaboration partner sites for the 2026-2027 school year, including Wausau Child Care, Mountain View Montessori, Woodson YMCA, Newman Catholic Schools, and Marathon County Head Start." },
      { item:"Annual Safety Update \/ Drill Debrief", body:"Andy Grimm and members of the Wausau Police Department shared the annual safety update from the November Education\/Operations Committee Meeting, including information about the partnership with School Resource Officers." },
      { item:"Neola Policies Update", body:"At the November Education\/Operations Committee meeting, proposed changes to 43 attached policies were reviewed, covering topics including definitions, board member conduct, student supervision, academic honesty, drug policies, drones, volunteers, school safety, and wellness." },
    ],
  ...
  },
  {
    ...
    isAgendaOnly: true,
    badge: "new",
    overview: "This Audit of the Bills Committee meeting focused on reviewing and approving the district's financial expenditures for December 2025. This routine committee meeting ensures proper oversight of Wausau School District spending.",
    agenda: [
      { time:"0:00", item:"Call to Order" },
    ...
    discussions: [
      { item:"Audit of the Bills", body:"The committee reviewed the December 2025 audit of bills document, which details the district's financial expenditures requiring committee approval. The attachment dated December 9, 2025 contains the itemized list of bills for committee review and verification." },
    ],
    publicComment: "No public comment period was included on this agenda.",
    actionItems: [
  ...
  },
  {
    ...
    discussions: [
      { item:"Approve Administrator Contracts and Discuss Performance and Employment of a Staff Member", body:"The board entered closed session under Wisconsin Statute 19.85(1)(c) to discuss and approve administrator contracts and address performance and employment matters related to staff member(s). This statute permits closed sessions for personnel-related discussions." },
      { item:"Discussion regarding the Competitive Negotiations of a Purchase\/Sale of Real Estate", body:"The board discussed competitive negotiations involving the purchase or sale of real estate in closed session under Wisconsin Statute 19.85(1)(e). This statute allows closed sessions when discussing property transactions where competitive bargaining reasons exist." },
      { item:"Resolution of Commendation: Ellie Mason", body:"The board considered a resolution of commendation honoring Ellie Mason. An attachment with the full resolution was included in the meeting packet dated December 12, 2025." },
    ],
    publicComment: "No public comment period was included on this agenda.",
    actionItems: [
      "Approve Administrator Contracts",
      "Approve Resolution of Commendation for Ellie Mason",
      "Take action on closed session matters if necessary and appropriate upon reconvening in open session",
    ],
  },
  {
    ...
    isAgendaOnly: true,
    badge: "new",
    overview: "The Wausau School District Education\/Operations Committee met to consider open enrollment seat availability for 2026-2027, review snow day communication procedures, and approve athletic co-op renewals for hockey and lacrosse programs. The meeting also featured a performance and presentation highlighting John Muir Middle School.",
    agenda: [
      { time:"0:00", item:"Call to Order" },
    ...
    discussions: [
      { item:"Open Enrollment Seat Availability", body:"Wendy Cartledge presented the Open Enrollment Space Determinations for the 2026-2027 school year. This item requires committee action to determine available seats for students transferring into the district through Wisconsin's open enrollment program." },
      { item:"Snow Day Communication & Procedures", body:"Diana White and Dr. Katie Colwell presented information on communications and procedures for snow days. The presentation addressed what happens beyond the standard three snow days allotted to the district." },
      { item:"Approve Co-Ops", body:"Athletic Directors BJ Brandt and Darci Mick Beversdorf presented information on athletic cooperative renewals including boys hockey with East\/Merrill\/Newman Catholic, girls lacrosse with East\/West\/DCE\/Mosinee, and girls STORM hockey with East\/West\/DCE\/Mosinee plus the addition of Merrill and Stratford. All co-ops are for the 2026-27 and 2027-28 school years." },
    ],
    publicComment: "A public and student comment period was included on the agenda.",
    actionItems: [
  ...
  },
  {
    ...
    isAgendaOnly: true,
    badge: "new",
    overview: "This special meeting of the Wausau School District Board of Education focused primarily on personnel matters, including routine staff appointments and separations, as well as two closed sessions to address employee termination proceedings and administrator contracts. The meeting's significance centers on a quasi-judicial hearing regarding employee conduct allegations and potential termination.",
    agenda: [
      { time:"0:00", item:"Call to Order" },
      { time:"0:02", item:"Approve Consent Agenda (Action Requested)" },
      { time:"0:05", item:"Request for Closed Session - Employee Conduct Hearing" },
      { time:"0:07", item:"Request for Closed Session - Administrator Contracts" },
  ...
  },
  {
    ...
    isAgendaOnly: true,
    badge: "new",
    overview: "This regular meeting of the Wausau School District Board of Education covers the approval of the 2024-25 audit report, WASB resolutions voting direction, and a discussion on replacing the chiller system at Wausau West High School. The board will also consider open enrollment seat availability, athletic co-op renewals, and enter closed session for potential litigation and superintendent evaluation discussions.",
    agenda: [
      { time:"0:00", item:"Call to Order" },
      { time:"0:02", item:"Roll Call" },
    ...
    discussions: [
      ...
      { item:"Wausau West Chiller Discussion", body:"Elizabeth Channel, Interim Assistant Superintendent of Operations, and Ryan Urmanski, Director of Buildings and Grounds, will present a request to solicit bids for replacement of the chiller system at Wausau West High School." },
      { item:"Resolution Authorizing Entry into Intergovernmental Cooperation Agreement for Wisconsin Investment Series Cooperative", body:"Assistant Superintendent of Operations Elizabeth Channel is presenting a resolution to continue the District's membership in the Wisconsin Investment Series Cooperative. This updates the authorization which is over ten years old in accordance with best practice." },
      ...
      { item:"Approve Co-Ops", body:"The board will consider athletic co-op renewals including boys hockey East\/Merrill with Newman Catholic, girls lacrosse East\/West\/DCE\/Mosinee, and girls STORM hockey East\/West\/DCE\/Mosinee with the addition of Merrill and Stratford for the 2026-27 and 2027-28 school years." },
    ],
    publicComment: "A public and student comment period is included on the agenda.",
    actionItems: [
      "Approve Consent Agenda including appointments, separations, leaves of absence, retirements, meeting minutes, payment of bills, and donations",
  ...
  },
  {
    ...
    isAgendaOnly: true,
    badge: "new",
    overview: "This Audit of the Bills Committee meeting focused on reviewing and approving district expenditures. The committee examined financial documentation to ensure proper fiscal oversight of Wausau School District spending.",
    agenda: [
      { time:"0:00", item:"Call to Order" },
    ...
    discussions: [
      { item:"Audit of the Bills", body:"Committee members reviewed the January 26 audit of bills documentation, which includes district expenditures requiring committee approval. The attachment contains itemized bills and payments processed by the district for committee verification." },
    ],
    publicComment: "No public comment period was included on this agenda.",
    actionItems: [
  ...
  },
  {
    ...
    isAgendaOnly: true,
    badge: "new",
    overview: "The Wausau School District Education\/Operations Committee meeting focused on advancing referendum construction projects with 95% design approvals for four elementary schools, reviewing the 2026-2027 school calendar, and examining financial projection model assumptions. The meeting also included demographic reporting and discussion of potential governance model changes.",
    agenda: [
      { time:"0:00", item:"Call to Order" },
      { time:"0:02", item:"Approve the Minutes" },
    ...
    publicComment: "Public and Student Comment period was included on this agenda.",
    actionItems: [
  ...
  },
  {
    ...
    isAgendaOnly: true,
    badge: "new",
    overview: "This special meeting of the Wausau School District Board of Education focused on personnel matters through the consent agenda, approval of the 2026-2027 school year calendar, and a closed session evaluation of the Superintendent. The meeting addressed routine staffing changes and finalized the upcoming academic year calendar previously presented by Diana White.",
    agenda: [
      { time:"0:00", item:"Call to Order" },
    ...
    discussions: [
      { item:"Approve 2026-2027 District Calendar", body:"Diana White previously presented a draft of the 2026-2027 school year calendar at an earlier meeting for board review. The board was asked to approve the finalized calendar at this special meeting, with an estimated presentation time of one minute." },
      { item:"Evaluation of Superintendent of Schools", body:"The board entered closed session pursuant to Wisconsin Statute s. 19.85 (1)(c) to conduct an evaluation of the Superintendent of Schools. The board planned to reconvene in open session afterward and take action if necessary based on the closed session discussion." },
    ],
    publicComment: "No public comment period was included on this agenda.",
    actionItems: [
      "Approve Consent Agenda including appointments, separations, leaves of absence, and retirements",
  ...
  },
  {
    ...
    actionItems: [
      ...
      "Consider action on Governance Model Option for committee structure changes",
      "Closed session regarding competitive negotiations of purchase\/sale of real estate with possible action upon reconvening",
    ],
  },
  {
    ...
    discussions: [
      { item:"Approve Consent Agenda", body:"The consent agenda included personnel actions covering additional staff appointments, replacement staff, and contract increases. It also addressed separations including resignations, contract decreases, and terminations, as well as leaves of absence and retirements." },
    ...
    actionItems: [
      "Approve Consent Agenda including appointments, separations, leaves of absence, and retirements",
      "Vote to enter closed session for litigation discussion",
  ...
  },
  {
    ...
    isAgendaOnly: true,
    badge: "new",
    overview: "The Wausau School District Board of Education Committee of the Whole meeting covered the district's five-year fiscal forecast to aid in budget planning, an AGR schools mid-year update on student outcomes, and a comprehensive review of over 60 district policies requiring updates. The board also received referendum budget updates on ongoing facility improvements and celebrated excellence at the district planetarium and Wausau West High School.",
    agenda: [
      { time:"0:00", item:"Call to Order" },
      { time:"0:02", item:"Approve the Minutes" },
    ...
    discussions: [
      { item:"Five Year Fiscal Forecast", body:"The Board was presented with a five-year fiscal forecast model for the District to aid in constructing the 2026-27 budget reconciliation plan. Administration noted the projections involve many variables that change periodically, and significant changes will be brought to the Board's attention as they occur." },
      { item:"AGR Annual Report", body:"This mid-year update provided the Board with AGR student outcome scores required by DPI, including screening results. The report featured work being done in the three AGR schools to strengthen organizational systems and demonstrate how these schools are evolving their practices to improve student achievement." },
      { item:"NEOLA UPDATE", body:"The Committee reviewed proposed changes to numerous district policies, ranging from technical corrections to more substantial updates. Policy areas covered include board member conduct, student supervision, reading instruction goals, cell phones, athletic programs, fiscal management, and school support organizations." },
      { item:"Referendum Budget Update", body:"The Board received a routine update on the April 2022 referendum-funded facility improvements as construction continues to develop. These updates will be presented routinely until all projects are completed." },
    ],
    publicComment: "A public and student comment period was included on the agenda.",
    actionItems: [
      "Approve the Minutes",
      "Audit of the Bills",
      "NEOLA Policy Updates including policies on definitions, board member behavior, student supervision, reading instruction, Title I engagement, athletics, advanced learning, cell phones, homeless students, third grade promotion, student employment, fund management, purchasing, and school support organizations",
    ],
  },
  {
    ...
    isAgendaOnly: true,
    badge: "new",
    overview: "This special meeting of the Wausau School District Board of Education was convened to hold a pupil expulsion hearing in closed session. The board was authorized to deliberate privately and take action on the expulsion matter as necessary.",
    agenda: [
      { time:"0:00", item:"Call To Order" },
    ...
    discussions: [
      { item:"Closed Session - Pupil Expulsion Hearing", body:"The Board convened in closed session to hold a pupil expulsion hearing as permitted under Wisconsin Statutes governing closed meetings and pupil records confidentiality. The Board was authorized to deliberate privately at the conclusion of the hearing and take action in closed session if necessary. Following the closed session, the Board could reconvene in open session for any further action required." },
    ],
    publicComment: "No public comment period was included on this agenda.",
    actionItems: [
  ...
  },
  {
    ...
    isAgendaOnly: true,
    badge: "new",
    overview: "This public meeting brought together the Elementary Task Force one year after the elementary school consolidation decision to reflect on the process and outcomes. The meeting featured a summary of the consolidation and reflections from task force members, though no official Board action was taken despite a quorum potentially being present.",
    agenda: [
    ...
    discussions: [
      { item:"Summary of Elementary Consolidation", body:"This item provided an overview of the elementary school consolidation process that occurred in the Wausau School District. The summary likely covered the decisions made and implementation of the consolidation plan." },
      { item:"Task Force Member Reflectives: One Year Later", body:"Task force members shared their reflections on the elementary consolidation process one year after the decision. Members provided perspective on how the consolidation has impacted the district since implementation." },
    ],
    publicComment: "No public comment period was included on this agenda.",
    actionItems: [
  ...
  },
  {
    ...
    isAgendaOnly: true,
    badge: "new",
    overview: "This was a WEA-sponsored meet and greet event for Wausau School District Board of Education candidates. While a quorum of board members may have been present, this was explicitly a non-action meeting with no official board business conducted.",
    agenda: [
      { time:"0:00", item:"WEA Sponsored WSD School Board Candidates Meet & Greet Event" },
    ],
    discussions: [
      { item:"WEA Sponsored WSD School Board Candidates Meet & Greet Event", body:"This event was organized by the Wausau Education Association to allow community members to meet candidates running for the Wausau School District Board of Education. A quorum of current board members may have attended, but no official board action was scheduled or taken." },
    ],
    publicComment: "No public comment period was included on this agenda.",
    actionItems: [
  ...
  },
  {
    ...
    isAgendaOnly: true,
    badge: "new",
    overview: "The Wausau School District Board of Education held a regular meeting covering a proposal to switch middle school devices from Chromebooks to iPads, updates on the 2022 referendum-funded construction projects, and a five-year fiscal forecast presentation. The meeting also included reports on Achievement Gap Reduction schools and routine consent agenda items including personnel matters and budget reports.",
    agenda: [
      { time:"0:00", item:"Call to Order" },
      { time:"0:02", item:"Roll Call" },
      { time:"0:04", item:"Pledge of Allegiance: Jim Bouch, President" },
    ...
    discussions: [
      { item:"Referendum Budget Update", body:"Construction and budget updates on the April 2022 referendum-funded facility improvements were presented, continuing routine updates until projects are completed. The attached presentation was previously shared at the February Committee of the Whole Meeting." },
      { item:"iPads Presentation", body:"Administration presented information on switching one-to-one devices at the middle school level from Chromebooks to iPads. The presentation was estimated to take 20 minutes and required board action." },
      { item:"Five Year Fiscal Forecast", body:"A five-year fiscal forecast model was presented to aid in constructing the 2026-27 budget reconciliation plan. Administration noted that projections depend on many variables that change periodically and will bring significant changes to the Board's attention." },
      { item:"AGR Annual Report", body:"The mid-year Achievement Gap Reduction student outcome scores required by DPI were presented, featuring screening results and work being done at the three AGR schools to strengthen organizational systems and improve student achievement." },
    ],
    publicComment: "A public and student comment period was included on the agenda.",
    actionItems: [
      "Approve Consent Agenda including personnel appointments, separations, leaves, retirements, meeting minutes, budget status report, CESA 9 Shared Services Contract, and donations",
      "Vote on middle school iPad rollout proposal to replace Chromebooks with iPads",
    ],
  },
  {
    ...
    isAgendaOnly: true,
    badge: "new",
    overview: "The Wausau School District Board of Education Committee of the Whole meeting addressed facility fee amendments for artificial fields, a referendum budget update, and an extensive NEOLA policy review covering over 60 policies including cell phones, AI, academic honesty, and child abuse reporting. The meeting also included renewal of the Wisconsin School Nutrition Purchasing Cooperative membership and recognition of Stettin Elementary.",
    agenda: [
      { time:"0:00", item:"Call to Order" },
      { time:"0:02", item:"Approve the Minutes" },
      { time:"0:05", item:"Audit of the Bills" },
    ...
    discussions: [
      ...
      { item:"Facility Fees", body:"Ryan Urmanski, Director of Buildings and Grounds, presented information to amend the current facility use fee schedule to reflect costs for artificial fields and field lighting for requested events. The board was asked to approve the fee schedule for immediate implementation." },
      { item:"Referendum Budget Update", body:"Elizabeth Channel, Interim Assistant Superintendent of Operations, shared an update on the status of the Referendum Budget. A memo summarizing the budget status was included in the meeting materials." },
      { item:"NEOLA UPDATE - Policies", body:"The committee reviewed proposed changes to 31 policies covering definitions, board member conduct, district administrator relationships, reading instruction, parent engagement, athletics, advanced learning, expenses, academic honesty, homeless students, cell phones, third grade promotion, student drug use, purchasing, and artificial intelligence. Some changes are technical corrections while others are more substantive." },
      { item:"NEOLA UPDATE - School Support Organization Related Policies", body:"The committee reviewed 9 policies related to student fund-raising, crowdfunding, accountability and oversight, non-district supported student activity accounts, gifts and grants, district supported organizations, school support organizations, and advertising activities." },
      { item:"NEOLA UPDATE - Technical Corrections", body:"The committee reviewed technical corrections to 18 policies covering board member qualifications, employment, medication administration, at-risk students, suspension and expulsion, student activism, student rights, video surveillance, crisis intervention, school safety, pandemic equipment, head lice, threats of violence, and veterans diplomas." },
      { item:"NEOLA UPDATE - Act 57 Related Policies", body:"The committee reviewed 4 policies related to Wisconsin Act 57, addressing student supervision and welfare requirements for administrators, teachers, and support staff, as well as child abuse and neglect reporting procedures." },
    ],
    publicComment: "No public comment period was included on this agenda.",
    actionItems: [
      ...
      "Approve NEOLA policy updates including 31 general policies, 9 school support organization policies, 18 technical corrections, and 4 Act 57 related policies",
    ],
  },
  {
