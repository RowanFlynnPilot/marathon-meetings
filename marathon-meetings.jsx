...
const MEETINGS = [
  {
    ...
    agenda: [
      ...
      { time:"36:00", item:"Mayor appointments to commissions and boards" },
      { time:"37:00", item:"Solid waste and recycling service agreement with Harter's Fox Valley" },
      { time:"42:00", item:"Police Department paid duty time and budget modifications" },
      { time:"44:00", item:"Settlement resolution - David Holes vs City of Wausau" },
    ],
    discussions: [
      { item:"Development agreement for 11 Scott Street LLC (Waterside Place)", body:"Mark Craig and Raleigh Lray spoke in support of the $10+ million project to convert a vacant 100,000 sq ft building into 52 mid-priced residential units. Alder Rasmusen supported the project citing return to taxable status and reclaiming parking spaces for public use. Alder Neil outlined benefits including $55,000 annual parking revenue, helping TID 8 reach valuation goals, and filling mid-range housing gaps. Alder Larson dissented, objecting to discounting city parking assets during budget cuts. Alder Tierney questioned provisions requiring the city to provide alternative parking within 300 yards if the ramp closes. Director Randy Feifer explained the agreement reduces existing parking obligations from 480 to 150 spaces while generating new revenue. Motion passed 6-3." },
      { item:"Mayoral citation for Public Works crews", body:"Mayor Denny recognized city employees who responded to record 30.9-inch snowfall from March 14-16, 2026. Kevin Kester, street supervisors Dustin and Josh, storeroom manager Mitch Harris, and fleet technician Jieven Matah were specifically mentioned. Kevin Kester addressed the council, praising the plow crews and mechanics, noting fleet technicians worked 12 straight days without a day off providing 24-hour breakdown support." },
      { item:"Sustainability Award to Colby and Colby Millwork", body:"Christine Daniels from the Sustainability, Energy and Environment Committee presented the 2026 City of Wausau Sustainability Award to Colby and Colby Millwork. Keith Kaning and Mike Thompson accepted, describing their 2,000+ solar panel installation operational since July 2025 that generates enough power for 120 homes, along with LED lighting upgrades and recycling initiatives for wood, aluminum, glass, and vinyl manufacturing materials." },
      { item:"Solid waste disposal ordinance and recycling agreement", body:"Council approved repealing and recreating Municipal Code Chapter 6.44 on solid waste disposal to align with state code (passed 9-0). Also approved was a 7-year residential solid waste and recycling service agreement with Harter's Fox Valley disposal (passed 9-0), correcting an earlier term sheet discrepancy between 7 and 10 years." },
      { item:"Settlement resolution - David Holes vs City of Wausau", body:"Assistant City Attorney Vincent Bonito explained this involves a 2022 bus accident where Transit Mutual paid the city's claim. The individual who hit the bus later filed a personal injury claim, and the city filed a counter claim. The insurer agreed to pay bus damages, and this resolution releases the city's counter claim. Alder Neil confirmed this is separate from the individual's ongoing injury claim. Passed 8-1." },
    ],
    publicComment: "Two speakers addressed the council. Raleigh Lray spoke in support of the 11 Scott Street project, describing it as a green sustainable repurposing of a vacant building that will add mid-priced apartments downtown. Mark Craig, 3246 North 8th Street, also spoke in support, noting the project exceeds $10 million and won't happen without council support, referencing the previous 7-4 term sheet vote.",
    actionItems: [
      ...
      "7-year solid waste agreement with Harter's Fox Valley approved 9-0",
      "Airspace obstruction removal agreements for Ridgeland Avenue properties approved 9-0",
      "Police Department budget modification for Red Dot Optics using Thompson submachine gun sale proceeds approved 9-0",
      "Solid waste disposal code chapter 6.44 repealed and recreated 9-0",
  ...
  },
  {
    ...
    discussions: [
      ...
      { item:"Transportation project plat for Grand Avenue signal replacements", body:"Motion to approve made by Bugamin, seconded by Balkan. The project plat for signal replacements at Sturgeon and Townline Road (Project 370-40-40) passed unanimously with no discussion." },
    ],
    publicComment: "Linda Lawrence submitted written comment via email on March 12th supporting the apartment building proposal at 731 North First Street, stating housing of this capacity will benefit downtown small businesses and expressing confidence in the developer's track record. Jason Dunwy and Melinda Dunwy spoke in person during the public hearing regarding the storage facility, advocating for its approval to serve new downtown residents.",
    actionItems: [
  ...
  },
  {
    ...
    isAgendaOnly: false,
    badge: "new",
    overview: "The Marathon County Board of Supervisors held an educational meeting featuring presentations on PFAS contamination litigation opportunities and county regulatory authority over renewable energy projects. No votes were taken as this was an informational session, but the board received detailed legal guidance on joining multi-district PFAS litigation against chemical manufacturers and options for addressing proposed large-scale wind energy projects in the county.",
    agenda: [
      ...
      { time:"2:45", item:"Public comment period (15 minutes, 5 speakers)" },
      ...
      { time:"1:10:01", item:"Discussion of proposed wind energy projects in Marathon County" },
      { time:"1:25:03", item:"County options for addressing renewable energy projects" },
      { time:"1:40:00", item:"Joint Development Agreement considerations" },
    ],
    discussions: [
      { item:"Public Comment", body:"Five residents spoke during public comment. Cindy Nielson from Stratford stated she visited 200 houses and found no support for wind turbines, urging the board to provide more information to residents. Wendy Rowski from Green Valley asked the board to vote no on advancing the comprehensive plan, objecting to the term 'wind farm' and requesting it be called 'industrial wind energy development.' Barb Newton and Sydney Hogan from Rib Mountain reiterated support for speed reduction and no-passing zone on Double N Road, noting 75 residents signed a petition. Heidi Pesky from Town of McMillan argued against joint development agreements, listing potential drawbacks including limiting county autonomy for 30-50 years." },
      { item:"PFAS Multi-District Litigation Presentation", body:"Attorney Carrie McDougall from Baron and Budd Law Firm explained the nationwide PFAS litigation, noting a $12-13 billion settlement with 3M and $3-5 billion from DuPont for water contamination claims. He stated Marathon County could file claims for soil contamination at the airport, wastewater facilities, and landfill. The litigation operates on a 25% contingency fee basis with no upfront costs to the county. Vice Chair Dickinson clarified that the airport has no known PFAS contamination currently. Supervisor Robinson asked about protecting landowners affected by biosolids spreading, with attorneys explaining claims must be unique to Marathon County but proceeds could be distributed at the board's discretion." },
      { item:"Renewable Energy Regulatory Authority Presentation", body:"Attorney Rebecca Roker from Atollis Law explained that projects over 100 megawatts fall under PSC jurisdiction, limiting county regulatory authority. She noted the PSC has approved all 33 solar projects reviewed and likely all wind projects as well. The Hub City Wind project from Alliant Energy and the Stormark Wind Energy Center were identified as proposed projects, though no PSC applications have been filed yet. Roker presented four options for the county: do nothing, negotiate a Joint Development Agreement, intervene in PSC proceedings, or litigate. She strongly recommended JDAs as the most effective tool to protect county interests regarding liability, roads, decommissioning, emergency response, and environmental protections." },
    ],
    publicComment: "Five speakers addressed the board. Cindy Nielson (Stratford\/Oplane Township) reported visiting 200 houses and finding unanimous opposition to wind turbines. Wendy Rowski (Green Valley) urged voting no on the comprehensive plan and replacing 'wind farm' terminology with 'industrial wind energy development.' Barb Newton (Rib Mountain) reiterated support for speed reduction on Double N Road, citing near-collisions. Heidi Pesky (Town of McMillan) argued joint development agreements are unnecessary and potentially harmful to county interests. Sydney Hogan (Rib Mountain) supported the Double N Road speed reduction and thanked the infrastructure committee for forwarding the recommendation.",
    actionItems: [
      "Board to consider resolution on PFAS litigation at next week's meeting",
      "County to evaluate PFAS testing at airport, wastewater, and landfill facilities",
      "Board to consider options for engaging with proposed wind energy projects including Joint Development Agreements",
      "Supervisors encouraged to contact board chair, administrator, and corporation counsel with additional questions on PFAS litigation",
    ],
  },
  {
  ...
  },
  {
    ...
    agenda: [
      ...
      { time:"0:22", item:"Open bids for North 8th Avenue (postponed)" },
      { time:"1:30", item:"2025 Street Construction Project A - Rolph Street, Cherry Street Change Order 1" },
    ...
    discussions: [
      ...
      { item:"26th Street Construction Project Bids", body:"Seven bids were opened and read aloud. Switlick submitted the lowest bid at $1,279,089.75, narrowly beating Hos at $1,280,877.96. Other bidders included A1 ($1,374,600), Francis Melvin ($1,385,383), Steen ($1,489,126), James Peterson ($1,570,698.56), and Earth ($1,686,708.75). A member noted 'tight bids' regarding the close competition. Motion to approve Switlick passed unanimously." },
      ...
      { item:"Rolph Street\/Cherry Street Change Order 1", body:"Staff presented four items totaling $14,436.50: an inside drop on a manhole ($4,856) due to an unrecorded large diameter sanitary service; water main tie-in adjustment ($2,317.50) due to finding 6-inch instead of 8-inch main; miscellaneous storm sewer work ($5,016) for private tie-ins at $66 per lineal foot; and geogrid installation ($2,247) for approximately 750 square yards near Thomas Jefferson Elementary due to poor soil conditions. Change Order 2 regarding liquidated damages was deferred pending further discussions. Motion to approve Change Order 1 passed unanimously." },
      { item:"Rolph Street\/Cherry Street Pay Estimate #9", body:"Pay estimate number nine for Haw Suns Incorporated covering work completed through year end was presented for $535,114.20. Motion to approve passed unanimously." },
      { item:"Portland Cement Concrete License - KSK Inc.", body:"Vinnie confirmed he reviewed the license application and everything was in order. Motion to approve the license for KSK Incorporated passed unanimously." },
    ],
    publicComment: "No public comment was offered.",
    actionItems: [
      "Award 26th Street construction project contract to Switlick for $1,279,089.75",
      "North 8th Avenue bid opening postponed to future meeting",
      "Change Order 1 approved for Rolph Street\/Cherry Street project totaling $14,436.50",
      "Change Order 2 with liquidated damages to return at future meeting",
      "Pay Estimate #9 approved for Haw Suns Inc. for $535,114.20",
  ...
  },
  {
    ...
    docUrl: "https://www.westonwi.gov/AgendaCenter/ViewFile/Agenda/_04162026-1905",
    isAgendaOnly: false,
    badge: "new",
    overview: "The Village of Weston Finance and Human Resource Committee approved a modified employee clothing allowance policy after extensive debate, settling on $400 for 2026 and $500 annually starting 2027, plus a washer and dryer for staff use. The committee also received a detailed presentation on public works operations and budget, highlighting that the department operates below average costs compared to similar communities.",
    agenda: [
      ...
      { time:"4:15", item:"Acknowledge T-1 and T-2 detail reports for February" },
      ...
      { time:"1:15:01", item:"Remarks from staff and committee members, future agenda items" },
    ],
    discussions: [
      { item:"Public works operations and budget presentation", body:"Public Works Director Michael presented a comprehensive overview of department operations, covering 119.5 centerline miles of road, 114 miles of water main, 103 miles of sanitary sewer, and 70 miles of storm sewer. He noted the 2026 public works budget decreased by $26,000 (1.1%) compared to 2025. Michael emphasized the village spends approximately $9,700 less per mile than average central Wisconsin communities, and highlighted staff's recent 16-17 hour shifts during a major snow event. He cautioned against diverting transportation aid funds to non-street purposes, as this would reduce future state funding based on the six-year average formula." },
      { item:"Reimbursement for clothing and equipment allowance", body:"After canceling the Cintas uniform contract, staff proposed increasing the employee clothing allowance from $300 to $600. Committee member Brad Daniels opposed the increase, citing fiscal responsibility concerns and the upcoming fire department referendum. Michael defended the proposal, noting employees work in harsh conditions with chemicals and materials that destroy clothing. The initial motion for $600 failed 3-2 (Daniels, Olsson, Mai voting no; Love, Sober voting yes). A $400 motion also failed 3-3. Barbara Mai then moved for $400 in 2026, $500 annually starting 2027, plus a washer and dryer purchase, which passed with one opposed." },
    ],
    publicComment: "Lisa Beck of 1808 Cortez Lane spoke, praising Mike for public works efforts after a recent storm. She also questioned the proposed clothing allowance increase, suggesting the village consider a lesser amount rather than the highest proposed figure to save money.",
    actionItems: [
      "Approved minutes from February 16, 2026 meeting",
      "Acknowledged February financial report for all funds",
      "Acknowledged T-1 and T-2 detail reports for February",
      ...
      "Next meeting scheduled for Tuesday, April 21st at approximately 5:00 PM",
    ],
  },
  {
    ...
    isAgendaOnly: false,
    badge: "new",
    overview: "The Public Health and Safety Committee approved a parklet permit for Westside Diner and Lounge, approved various license applications while holding one denial recommendation for further review, repealed outdated ordinances on solid waste and cell phone use while driving, and received updates on the fire department's annual report and the upcoming transition of the homeless shelter from WMC to Bridge Street Mission.",
    agenda: [
      { time:"0:00", item:"Call to order and roll call" },
      { time:"0:30", item:"Public comment on agenda items" },
      { time:"1:00", item:"Approval of minutes from February 16, 2026" },
      { time:"1:30", item:"License applications - Westside Diner and Lounge parklet permit" },
      ...
      { time:"24:00", item:"MOU with Midwest Renewable Energy for solar program" },
      { time:"27:00", item:"Fire Department 2025 annual report discussion" },
      { time:"33:00", item:"Tavern activities report - February 2026" },
      { time:"37:00", item:"Community outreach update and shelter transition" },
    ],
    discussions: [
      { item:"Westside Diner and Lounge Parklet Permit", body:"Tyler Vote presented detailed plans for a parklet extending 4 feet into the street and 4 feet onto the sidewalk at 628 North Third Avenue. He explained it would provide sunny seating for breakfast customers and would be similar to the parklet he previously operated at Malarkey's pub. Alder Larson noted initial concerns but was satisfied with the layout presented. The permit was approved unanimously with Watson making the motion and Larson seconding, with a trial period through October 2026 and a follow-up report scheduled for November." },
      { item:"License Denial Recommendations", body:"Theodore Davis appeared regarding his bartender license denial, explaining a mistake made 20 years ago as a minor that has followed him. His boyfriend Matthew Prieb spoke in support, emphasizing Davis has not reoffended and is a good person. Deputy Chief Baiton indicated he was unfamiliar with rehabilitation documents Davis had submitted to Chief Barnes. The committee voted to hold the item for the next meeting pending Chief Barnes' review. Joanna Gregory did not appear for her denial hearing." },
      { item:"Solid Waste Disposal Ordinance", body:"Assistant City Attorney Vinnie Bonino presented the repeal and recreation of Chapter 6.44 to comply with state-level changes. The motion was approved unanimously with Larson moving and Watson seconding." },
      { item:"Handheld Mobile Phone Ordinance Repeal", body:"Bonino explained that state inattentive driving statutes have been amended to regulate cell phone usage, making the local ordinance redundant. The repeal was approved unanimously with Watson moving and Larson seconding." },
      { item:"Solar Program MOU with MREA", body:"Carrie from the planning department explained the partnership would provide cost savings, vetting of solar installers, and technical assistance for residents. Alder Sarah spoke favorably based on her personal experience with solar installation. The sustainability committee had unanimously recommended approval on March 5th. Approved unanimously with Watson moving and Larson seconding." },
      { item:"Fire Department Annual Report", body:"Fire Chief Cop reported the department responded to over 7,200 calls in 2025, averaging 20 per day. He announced that as of Friday, Wausau was confirmed to maintain ISO Class 2 status for the next four years. The committee discussed upcoming public information sessions on March 31st, April 1st, and April 3rd regarding the fire department referendum on April 7th." },
      { item:"Shelter Transition to Bridge Street Mission", body:"Tracy Durante reported 415 unduplicated guests served since the shelter opened and over 740 volunteer hours in February. James Torensson, new Director of Homeless Services at Bridge Street Mission, announced the shelter transition is expected around April 20th, with WMC extending its contract through April 19th to avoid service gaps. The committee expressed interest in touring the new facility at the ribbon cutting ceremony." },
    ],
    publicComment: "Carrie Mor Everest of 1025 Everest Boulevard spoke during public comment at the end of the meeting. She raised concerns about how unhoused individuals are treated during emergency 911 calls at the shelter, stating she has witnessed unprofessional treatment multiple times over 10 months of volunteering. She expressed frustration that her complaints have not been addressed and called for better service to the community.",
    actionItems: [
      "Parklet permit approved for Westside Diner and Lounge at 628 North Third Avenue through October 2026, with follow-up report in November",
      "Theodore Davis bartender license denial held pending Chief Barnes' review of rehabilitation documents",
      "Joanna Gregory bartender license denied (did not appear)",
      "Various license applications approved as recommended including Oasis Arcade, Whiskey River Bar and Grill, Hayawa, and summer events",
      ...
      "Fire department public information sessions scheduled for March 31st, April 1st, and April 3rd",
    ],
  },
  {
    ...
    isAgendaOnly: false,
    badge: "new",
    overview: "The Village of Weston Board of Trustees approved multiple ordinances including rezonings and a modified speed limit ordinance for Weston Avenue (35 mph from Camp Phillips to Von Kennel, 45 mph from Von Kennel to Highway J), after rejecting the original proposal. The board also approved a 10-year baseball\/softball field maintenance agreement, various infrastructure contracts, and deferred action on the remote meeting attendance policy until the new board is seated after the upcoming election.",
    agenda: [
      { time:"0:01", item:"Call to order and Pledge of Allegiance" },
      ...
      { time:"35:02", item:"New business - E-bike ordinance, parking restrictions, intersection signage, field agreements, park fees, contracts" },
    ],
    discussions: [
      { item:"Public Comment", body:"Jim Pensel of 5002 Aerrol Street spoke critically about the village's approach to funding the fire department through referendum. He praised SAFER staff but argued the board has 'a priority problem' rather than a revenue problem, criticizing spending on artificial turf and the aquatic center while fire\/EMS is understaffed. He called for the board to 'stop looking for the easy way out through referendums and start making the hard choices.'" },
      { item:"Finance Department Report", body:"Finance Director Jessica responded to public comment, explaining the village cannot borrow for additional firefighters - only for capital projects like the Kennedy Park turf. She emphasized the village is 'the cheapest' and 'most efficient' but needs more operating revenue, noting public works staff worked 17-18 hour days during the recent blizzard but still received complaints. She expressed frustration with 'naysayers' and hinted her position might be open soon." },
      { item:"Speed Limit Ordinance 26-006", body:"The original ordinance setting 35 mph on Weston Avenue from Von Kennel to Ryan Street failed 4-3, with Maloney, Jordan, and the President voting no. Trustee Maloney argued the stretch from Von Kennel to Jay should remain 45 mph due to sparse driveways and better road conditions compared to other 35 mph streets. A revised motion was approved setting 35 mph from Camp Phillips to Von Kennel and keeping 45 mph from Von Kennel to Highway J." },
      { item:"Intersection Signage at Community Center Drive and Birch Street", body:"The board approved changing the stop sign to a yield sign, with a friendly amendment adding a stop sign for bicyclists coming off the pedestrian bridge. Trustee Hooang raised safety concerns about cyclists traveling 15-20 mph off the bridge with no signage to stop them. The motion passed unanimously with the bicycle stop sign addition." },
      { item:"Baseball\/Softball Field Maintenance Agreement", body:"The board approved a 10-year agreement with youth baseball and softball organizations for field maintenance at Kennedy Park. The committee recommended the long term to protect the village's investment and provide stability despite leadership changes in both the village and youth organizations. The agreement requires the organizations to maintain fields in lieu of fees. Passed unanimously." },
      { item:"Remote Meeting Attendance Policy", body:"Trustee Lewis recommended deferring this item until the next meeting so the newly seated board can make the decision. The motion to defer passed unanimously." },
      ...
      { item:"Removal of No Parking Restrictions at Kennedy Park", body:"The board approved removing no parking restrictions on the west side of Alderson Street along Kennedy Park to provide additional parking for the farmers market and other events. The restriction was originally implemented when the high school used the fields for soccer. Passed unanimously." },
    ],
    publicComment: "Jim Pensel of 5002 Aerrol Street spoke for approximately 4 minutes expressing appreciation for SAFER fire\/EMS staff but criticizing the board's approach to funding through referendum. He argued the village has a 'priority problem' not a revenue problem, citing spending on artificial turf and the aquatic center as 'wants' while fire department staffing is a 'need.' He called for the board to make 'hard choices' rather than seeking referendums.",
    actionItems: [
      "Speed limit ordinance approved with modification: 35 mph from Camp Phillips to Von Kennel, 45 mph from Von Kennel to Highway J on Weston Avenue",
      ...
      "Microsoft Teams adopted for trustee communication starting next term",
      "Remote meeting attendance policy deferred to April 21st meeting for new board consideration",
      "E-bike ordinance tabled pending county completion of their process",
  ...
  },
  {
    ...
    isAgendaOnly: false,
    badge: "new",
    overview: "The Marathon County Board of Supervisors adopted the comprehensive plan for 2026 after approving nine amendments addressing topics including renewable energy terminology, data centers, AI technology, and energy sources. The board also approved salaries for elected officials, authorized phase 2 design for a new highway facility, engaged outside counsel for PFAS litigation, and ratified a local state of emergency declaration related to a recent blizzard.",
    agenda: [
      { time:"0:12", item:"Call to order, pledge of allegiance, moment of reflection" },
      { time:"1:28", item:"Reading of the notice and roll call" },
      ...
      { time:"1:20:01", item:"E15 - Establishing salaries for clerk of courts, sheriff, elected department heads (Resolution 12-26)" },
      { time:"1:21:00", item:"E16 - Phase 2 design services for new highway facility (Resolution 13-26)" },
      { time:"1:23:00", item:"E17 - Engaging outside counsel for PFAS litigation (Resolution 14-26)" },
      { time:"1:28:30", item:"E18-E19 - Budget amendments and capital asset threshold resolutions" },
      { time:"1:30:01", item:"F20 - Law enforcement drug trafficking response grant and G21 - Ratification of local state of emergency" },
    ],
    discussions: [
      { item:"Comprehensive Plan 2026 Amendments", body:"Administrator Leonard presented 10 proposed amendments compiled from supervisor feedback. Amendment 1 (livability standards) passed unanimously. Amendments 2, 3, and 4 (alternative energy terminology changes to refer to 'energy projects' rather than 'renewable energy farms') were separated upon motion by Supervisor Crawl and each passed with some opposition. Amendment 5 (data centers and battery storage background) passed despite Supervisor Leur voting no, calling it 'too ideological.' Amendment 6 (radon and lead remediation) passed unanimously. Amendment 7 (regulate energy projects when allowed by law) passed non-unanimously. Amendment 8 (AI and automation language proposed by Supervisor Leur) passed unanimously after discussion with Supervisor Cavelli about ethical and transparent AI use. Amendment 9 was heavily debated; Supervisor Sindellski's original proposal on clean coal, natural gas, and nuclear was amended by Supervisor Boots to read 'promote coal and natural gas until a long-term sustainable and reliable energy source can be found that does not adversely affect agricultural land.' Supervisors Robinson and Rosenberg opposed, arguing there is no 'clean coal.' The amended version passed non-unanimously. A late amendment by Supervisor Sindellski regarding utility-scale wind\/solar as industrial uses failed after debate; Supervisor Jeang's motion to refer it to committee for July also failed. The comprehensive plan as amended passed non-unanimously." },
      { item:"Salaries for Elected Officials (Resolution 12-26)", body:"The resolution establishing salaries for clerk of courts, sheriff, and elected department heads for the upcoming term was approved. Motion by Supervisor Conway, second by Supervisor Rosenberg, passed with the motion carried." },
      { item:"Highway Facility Phase 2 Design (Resolution 13-26)", body:"Authorization to proceed with phase 2 design services for the new highway facility passed unanimously. Supervisor Soyber requested future information about plans for the old facility. Supervisor Sindellski asked about the $53 million cost estimate but was told that was not part of this vote." },
      { item:"PFAS Litigation Outside Counsel (Resolution 14-26)", body:"Resolution authorizing engagement of outside counsel on contingency basis for PFAS lawsuits was approved unanimously with two amendments. Supervisor Robinson's amendment directing the county administrator to evaluate past and present practices that may have resulted in PFAS exposure to determine risk passed unanimously. Vice Chair Dickinson's amendment modifying airport-related language also passed unanimously." },
      { item:"Local State of Emergency Ratification (Resolution 22-26)", body:"Administrator Leonard explained the ratification preserves the county's opportunity to seek reimbursement for blizzard response costs after the governor's declaration expired. He praised county staff across facilities, parks, highway, sheriff's office, and airport for working 12-16 hour shifts during the event. Supervisor Fifer echoed thanks as infrastructure committee chair. Resolution passed unanimously." },
      { item:"Administrator Performance Evaluation", body:"Chair Gibbs explained the executive committee completed the administrator's evaluation using board input from the previous Thursday meeting with no wording changes. Supervisor Robinson moved to accept the executive committee's recommendation on salary and performance evaluation without going into closed session. Motion passed unanimously." },
    ],
    publicComment: "No public comment was offered.",
    actionItems: [
      ...
      "County administrator directed to evaluate PFAS exposure risks from past and present county operations",
      ...
      "Administrator performance evaluation and salary placement accepted",
  ...
  },
  {
    ...
    isAgendaOnly: false,
    badge: "new",
    overview: "The Village of Weston Parks and Recreation Committee approved minutes, selected Rettler Corporation for the Mock Mueller Park master plan, and discussed park impact fees and ice rink operations. Key decisions included unanimously selecting Rettler over six other proposals for park planning services, while impact fee increases and ice rink future were discussed but deferred for further information.",
    agenda: [
      ...
      { time:"25:30", item:"Discussion on Mock Mueller Park master plan RFP proposals" },
    ...
    discussions: [
      ...
      { item:"Parks and Recreation Impact Fee Discussion", body:"Jennifer from Planning presented information on impact fees, noting current fees of $300 for single family are significantly lower than neighboring communities charging $600-650. The 2020 study recommended up to $761 per single family unit. Committee members expressed support for a moderate increase to align with neighboring communities. Katrina stated she would support the moderate increase bracket. The matter was referred back to Plan Commission for further deliberation with committee input that fees should be consistent with neighbors while remaining competitive." },
      { item:"Mock Mueller Park Master Plan RFP Selection", body:"Seven proposals were received for the park master plan, reviewed by four staff members. The two lowest bids were JSD ($[inaudible]) and Rettler Corporation, both with prior village experience. Roger made a motion to select Rettler Corporation, seconded by Katrina. The motion passed unanimously. Staff noted Rettler has done recent master plans including Kennedy Park and the comprehensive outdoor recreation plan." },
      { item:"Yellow Banks Kayak Launch Expenses Review", body:"Jessica presented a detailed breakdown of the kayak launch project expenses and grant funding. The project had unforeseen costs including poor subgrade and an unknown well casing discovery. Grants were secured from DNR and Marathon County Transportation (which covered full expense for ADA-accessible components). Katrina praised the RFC document and the significant reduction in out-of-pocket costs due to grant writing by Jessica and Dan Hagen, with donated time from MTS for site planning. Committee discussed recognizing Dan Hagen formally for his contributions." },
      { item:"Ice Rink Operations at Kennedy Park", body:"Staff presented information on ice rink operations requested by committee member Katrina. The warming house has been unattended since 2020 due to COVID and subsequent staffing shortages. Everest Youth Hockey remains interested in the facility and has provided cost estimates for a covered structure. Discussion touched on Marathon Park changes potentially increasing demand for ice facilities. Katrina emphasized not wanting hockey to be forgotten amid baseball-focused Kennedy Park discussions. Committee requested additional historical attendance data from 2018-19 seasons and user feedback for future meetings." },
    ],
    publicComment: "Jim Pinsel of [inaudible] Street expressed frustration about receiving no response to his previous three-page submission of questions, criticizing the lack of investigation into 2024 playground equipment installation issues, absence of Kennedy Park fundraising updates, and incomplete cost analysis for the ice rink that he estimated actually costs $20,000-30,000 annually when factoring in labor hours. Lisa Beck of 1808 Cortez Lane thanked Michael for snow plow work during the recent blizzard and praised Sean and Jessica for the well-written Yellow Banks RFC document detailing expenses and deficit coverage. A written response to Jim Benson's previous email was submitted and will be included in the minutes.",
    actionItems: [
      ...
      "Staff to compile 2018-19 ice rink attendance records and labor hour costs for future meeting",
      "Staff to gather user feedback on ice rink amenity",
  ...
  },
  {
    ...
    isAgendaOnly: false,
    badge: "new",
    overview: "The Wausau Finance Committee approved several airport ground leases, denied a tax recovery claim related to ongoing Greenwood Hills litigation, and postponed decisions on the national opioid settlement and a budget amendment for lead service line replacement costs. The committee also approved budget carryover funds from 2025 to 2026 and reviewed favorable 2025 financial results showing a general fund surplus.",
    agenda: [
      { time:"2:01", item:"Call to order and public comment" },
      { time:"2:28", item:"Approval of March 10, 2026 minutes" },
      { time:"2:50", item:"Alleged claim for recovery of unlawful tax - Green Acres at Greenwood Hills LLC" },
      { time:"3:38", item:"Consent to transfer title to buildings at 939 Woods Place" },
      { time:"4:08", item:"Terminating airport ground lease with Win O. Jones" },
      ...
      { time:"54:20", item:"Considering purchase of properties for DPW Streets Division" },
    ],
    discussions: [
      { item:"Minutes approval", body:"The March 10, 2026 regular finance committee minutes were approved. Motion by Watson, second by Griner. Passed unanimously." },
      { item:"Green Acres at Greenwood Hills LLC tax recovery claim", body:"This claim is part of ongoing litigation with Greenwood Hills. Rick Rubble from assessments was available for questions. Watson moved to approve the claim, Griner seconded. The chair explained a 'no' vote would deny the claim. Motion failed with opposition votes, effectively denying the claim." },
      { item:"Airport ground lease transfers at 939 Woods Place", body:"Three related items facilitated transfer of a hangar from Win O. Jones to Owen Jones. The consent to transfer title was approved (Watson\/Griner), the lease termination with Win O. Jones was approved (Tierney\/Watson), and the new lease with Owen Jones was approved (Watson\/Tierney). All passed unanimously." },
      { item:"Airport ground lease with Cole Lundberg", body:"Motion by Griner, second by Watson to approve the airport ground lease. Passed unanimously." },
      { item:"National opioid settlement agreement participation", body:"The committee discussed a class action settlement notice received by the city attorney's office. Alder Malini questioned where the item came from and expressed discomfort proceeding without more information. Watson noted concerns about signing away future remedies. Assistant Attorney Vincent explained law firms sent notice identifying the city as a potential class member. With deadline of May 4th, Griner moved to postpone to the next meeting for more information. Seconded by Tierney. Passed unanimously." },
      { item:"Lead service line replacement budget amendment", body:"Eric from Public Works explained the DNR changed funding rules after an initial agreement, leaving $709,000 in non-construction costs unfunded by the subsidized loan. Finance Director Marian outlined options including GO borrowing, taking from reserves, or using PFAS settlement money. Alder Tierney opposed adding more debt given current debt levels. Watson moved to postpone to the next meeting for more information. Seconded by Griner. Passed unanimously." },
      { item:"Budget carryover from 2025 to 2026", body:"Large carryover amount explained as primarily grant-funded items including 10 transit buses from VW mitigation program and airport projects. Some projects like city hall chimney liner and DPW fence replacement haven't started yet. Watson moved to approve, Griner seconded. Passed unanimously." },
      { item:"Motorpool fund financial results", body:"Finance Director reported the motorpool fund would show net profit of $150,000 after GMT transfer but faces $177,000 cash flow shortfall due to outstanding purchase orders exceeding available debt proceeds. Two dump trucks and an ambulance have been on order since 2023 due to supply chain issues. Solomon from MotorPool explained they're now second and third in line for the spreader upfits. ARPA savings may cover the shortfall. Informational item, no action taken." },
      { item:"General fund financial results", body:"The general fund showed a surplus of approximately $1.2 million driven by strong building permits, investment income, and EMS runs. After full motorpool charges, surplus is $125,000. With proposed transfers to recycling, airport, and parking funds, remaining surplus would be $540,000. CCITC was over budget by $194,000 due to communication issues including unbudgeted website costs and Office 365 upgrade. Tierney moved to approve transfers to recycling, airport, and parking funds. Watson seconded. Passed unanimously." },
      { item:"2026 general obligation promissory note", body:"Finance Director presented the borrowing calendar for 2026 capital improvements including street projects, motorpool, and TID district items. Watson noted debt utilization percentage will decrease even with new issuance. Watson moved to approve the calendar. Chair provided second. Passed unanimously. Phil Cawson from Ehlers will present parameters resolution at the next meeting." },
      { item:"Property purchase consideration for DPW", body:"Properties at 108 Adolf Street, 112 Adolf Street, 112½ Adolf Street, and 233 Myron Street were on the agenda. Due to time constraints before council meeting and no urgency, Watson moved to postpone to the next meeting. Tierney seconded. Passed unanimously. Closed session was not held." },
    ],
    publicComment: "No public comment was offered.",
    actionItems: [
      "Denied tax recovery claim for Green Acres at Greenwood Hills LLC",
      "Approved three airport ground lease actions transferring hangar from Win O. Jones to Owen Jones at 939 Woods Place",
      "Approved airport ground lease with Cole Lundberg",
      "Postponed opioid settlement participation decision to next meeting pending more information from City Attorney",
      "Postponed lead service line replacement budget amendment to next meeting",
      "Approved budget carryover funds from 2025 to 2026",
      "Approved transfers to recycling, airport, and parking funds from general fund",
  ...
  },
  {
    ...
    isAgendaOnly: false,
    badge: "new",
    overview: "The Marathon County Executive Committee met briefly and voted unanimously to enter closed session to discuss the performance review of the county administrator. The committee had received board feedback from the previous Thursday regarding the administrator's evaluation.",
    agenda: [
      { time:"0:00", item:"Call to order" },
    ...
    discussions: [
      { item:"Performance review of the administrator", body:"The chair explained the committee had the option to enter closed session to discuss the final review of the county administrator, incorporating board feedback received the previous Thursday. The evaluation used a three-tier rating system (needs improvement, successful, exceptional) scored on a 0-5 scale. Corporation counsel was asked to provide a summary of the appraisal. A motion was made and seconded to enter closed session, which passed unanimously with all members voting aye: Gibbs, Dickinson, Arstead, Boots, Drebeck, Fifick, Mask, Ritter, Morash, and Robinson." },
    ],
    publicComment: "No public comment was offered.",
    actionItems: [
  ...
  },
  {
    ...
    isAgendaOnly: false,
    badge: "new",
    overview: "The Marathon County HR and Finance Committee approved several routine matters including a claim disallowance, revised property auction values, carry forward funds resolution, and a capital assets threshold policy change. The committee also received introductions from new healthcare consultants National Insurance Services and heard detailed fiscal updates for 2025 year-end and 2026 year-to-date from the Finance Director.",
    agenda: [
      ...
      { time:"11:04", item:"Resolution to amend capital assets threshold policy" },
      { time:"12:23", item:"Introduction of healthcare consultants - National Insurance Services" },
    ...
    discussions: [
      { item:"Claim disallowance - Mercedes Holmes", body:"Corporation Counsel presented a claim received December 5th from Mercedes Holmes relating to the death of her 3-year-old child Zalen Bernett, who was placed in a treatment foster care home licensed through another agency in Dunn County. Law enforcement and social service investigations found no wrongdoing and the death was determined natural causes. Outside counsel and the insurance carrier recommended disallowance. Chair Gibbs moved to disallow the claim; Supervisor Lumer seconded. Motion carried." },
      { item:"Revised property values for public auction", body:"Staff reported two parcels on Mullen Street and South Third Avenue failed to sell twice on Wisconsin Surplus auctions when bids didn't reach appraised values. Chair Gibbs moved to set revised minimum sale prices of $9,000 for 529 Mullen Street and $7,500 for 738 South Third Avenue. Supervisor Lumer seconded. Motion carried unanimously. Staff noted a bidder who failed to pay has been marked as non-pay and banned from future auctions." },
      { item:"Resolution to approve carry forward funds", body:"Finance Director Sam presented Resolution R20-2026 for program revenues and multi-year projects requiring carryover funds. Notable items included replenishing veterans relief funds using 2025 budget excess to provide approximately three years of funding, and $142,731 for administration special projects including $75,000 for homelessness contract. Vice Chair Marshall asked about redacted records funds for Register of Deeds; staff will research and report back. Chair Gibbs moved approval; Supervisor Hart seconded. Motion carried." },
      { item:"Capital assets threshold policy amendment", body:"Finance Director explained the current $5,000 threshold for capitalizing assets was set following 2006 GFOA guidance and proposed increasing it to $10,000. Supervisor Hart moved to approve the resolution and forward to full county board; Chair Gibbs seconded. Motion carried unanimously." },
      { item:"Introduction of healthcare consultants - National Insurance Services", body:"HR Director Candace introduced National Insurance Services representatives following their successful RFP award. Lead consultant with 28 years experience and account manager Jordan Stanley presented their team and approach. They discussed evaluating the near-site ATA clinic for return on investment, comparing fully insured versus self-insured models, and improving communication with the board. Vice Chair Marshall and Chair Gibbs asked about costs compared to other employers, emergency room utilization strategies, and the evaluation process for insurance funding models." },
      { item:"2025 year-end fiscal update", body:"Finance Director Sam provided detailed department-by-department review of 2025 closing. Key items included: treasuer received $257,238 TID closure check from City of Wausau and $222,752 in unclaimed property from state; opioid fund received $352,389 in settlements with total cash at $2.2 million; parks fund ice revenue increased $70,000; grants fund showed $800,000+ surplus from ARPA fund interest. Multiple transfers and reclassifications still pending. Capital assets reconciliation ongoing before final fund balance surplus can be determined." },
      { item:"Finance department quarterly update", body:"Finance Director reported the team is fully staffed since mid-December with new payroll analyst. Accomplishments include quarterly closeout preparations, countywide training on uniform practices, W-2 processing including complex 'big beautiful bill' overtime tax calculations, 1099 processing, random cash audits, and department budget meetings. Upcoming work includes payroll budget preparation, policy updates for accounts receivable and fixed assets, and implementing first quarter closeout by May 31st with monthly closeouts thereafter. County Administrator Lance praised Sam and her team extensively for their work during challenging year-end close." },
      { item:"County Treasurer update", body:"Treasurer Connie reported on tax collection activities including 1,582 delinquent tax notices mailed in March (down from 1,786 last year), processing February settlements, lottery credit reporting issues with municipalities, and ongoing education efforts for municipal treasurers on proper receiving procedures. Discussion addressed payment agreements no longer being offered due to high default rates, eviction hearings related to tax delinquent parcels, and resources for struggling taxpayers. Chair Robinson and others acknowledged improved processes for addressing tax delinquency that better protect homeowner equity." },
    ],
    publicComment: "No public comment was offered.",
    actionItems: [
      "Disallowed claim from Mercedes Holmes regarding child's death",
      "Set revised auction prices: $9,000 for 529 Mullen Street and $7,500 for 738 South Third Avenue parcels",
      ...
      "Finance staff to research Register of Deeds redacted records fund history and potential repurposing",
      "National Insurance Services to provide healthcare cost updates prior to budget assumption development in early summer",
      "First quarter 2026 closeout scheduled for May 31st with monthly closeouts thereafter",
      "Administration to bring recommendation for increased Social Services reserve account (currently $400,000)",
  ...
  },
  {
    ...
    isAgendaOnly: true,
    badge: "new",
    overview: "Based on the published agenda, this special meeting was scheduled to address the termination of the Village of Weston's Tax Increment Financing District #1, which was created in 1998. The meeting was called specifically to meet a state-mandated April 15th deadline for notifying the Department of Revenue about TIF closures.",
    agenda: [
    ...
    discussions: [
      { item:"Resolution No. 2026-009: TID #1 Termination", body:"The Board was scheduled to consider terminating Tax Increment Financing District #1, which was created on March 30, 1998. According to the agenda materials, staff confirmed sufficient funds are available to close the district, including coverage for approximately $10.88 million in outstanding expenses such as bond payments, administration costs, and grant payments. The resolution was expected to authorize the Village Clerk to notify the Wisconsin Department of Revenue and establish a timeline for final accounting submission." },
    ],
    publicComment: "Public comment period was included on the agenda, allowing up to three minutes per speaker for non-agenda items, with time extensions at the presiding officer's discretion.",
    actionItems: [
      ...
      "Expected to authorize signing of DOR Final Accounting Submission Date form (PE-223)",
    ],
  },
  {
    ...
    isAgendaOnly: true,
    badge: "new",
    overview: "Based on the published agenda, this special meeting of the Village of Weston Board of Trustees was scheduled to address the termination of Tax Increment Financing District #1, which was created in 1998. The termination requires Board action before an April 15th state deadline and would allow distribution of excess increment funds to affected taxing districts.",
    agenda: [
    ...
    discussions: [
      { item:"Resolution No. 2026-009: TIF District #1 Termination", body:"The Board was scheduled to consider terminating TIF District #1, which was created on March 30, 1998. According to the agenda materials, sufficient increment was collected to cover all project costs including approximately $10.9 million in outstanding expenses for administration, grant payments, road maintenance, and bond payments. The resolution was set for action to meet the April 15th Department of Revenue deadline for TIF closures." },
    ],
    publicComment: "Public comment period was on the agenda, allowing up to three minutes per person for non-agenda items.",
    actionItems: [
      "Board was scheduled to vote on Resolution No. 2026-009 to terminate TIF District #1",
      "Village Clerk was expected to be authorized to notify the Wisconsin Department of Revenue and sign the required Final Accounting Submission Date form",
  ...
  },
  {
    ...
    isAgendaOnly: true,
    badge: "new",
    overview: "Based on the published agenda, this special meeting of the Village of Weston Board of Trustees was scheduled to address the termination of Tax Increment Financing District #1, which was created in 1998. This action was required to meet a state deadline of April 15th for notifying the Department of Revenue, and would allow for distribution of excess tax increment to affected taxing districts.",
    agenda: [
    ...
    discussions: [
      { item:"Resolution No. 2026-009: TID #1 Termination", body:"The Board was scheduled to consider terminating Tax Increment Financing District #1, which was originally created on March 30, 1998. Staff confirmed sufficient funds were available to close the district, with outstanding expenses including $250,000 in administration costs, $367,933 in grant payments, $300,000 for Business Park road maintenance, and over $9.9 million in bond principal and interest payments. The resolution was set to direct the Village Clerk to notify the Wisconsin Department of Revenue and authorize distribution of any excess increment to affected taxing districts." },
    ],
    ...
    actionItems: [
      ...
      "Village Clerk expected to be authorized to notify Wisconsin Department of Revenue of TID termination",
      "Village Clerk expected to be authorized to sign DOR Final Accounting Submission Date form (PE-223)",
      "Village Treasurer expected to be authorized to distribute excess increment to affected taxing districts",
    ],
  },
  {
    ...
    isAgendaOnly: false,
    badge: "new",
    overview: "The Wausau Economic Development Committee met to consider survey results for 1300 Cleveland Avenue land use, a Habitat for Humanity property purchase offer for 921 S. 19th Avenue, and two Thomas Street residential infill and redevelopment proposals. Vote records do not contain specific motion outcomes or vote counts for these items.",
    agenda: [
    ...
    discussions: [
      { item:"March 3, 2026 Regular Economic Development Committee Minutes", body:"Minutes from the previous meeting were on the agenda for consideration. Specific vote outcome is not recorded in the available vote records." },
      { item:"Non-Industrial Land Use Preference Survey for 1300 Cleveland Avenue", body:"The committee discussed survey results regarding preferred non-industrial uses for the city-owned property at 1300 Cleveland Avenue. Specific vote outcome or action taken is not recorded in the available vote records." },
      { item:"Property disposition offer from Habitat for Humanity of Wausau for 921 S. 19th Avenue", body:"The committee considered a purchase offer from Habitat for Humanity of Wausau for the property at 921 S. 19th Avenue. Specific vote outcome or action taken is not recorded in the available vote records." },
      { item:"Thomas St residential infill Request for Interest (206, 212, 226, and 230 E Thomas St)", body:"The committee reviewed a Request for Interest for residential infill development on four East Thomas Street parcels. Specific vote outcome or action taken is not recorded in the available vote records." },
      { item:"Thomas St and McCleary St vacant lots redevelopment (237, 241 and 249 E Thomas St)", body:"The committee discussed redevelopment options for three vacant lots on East Thomas Street near McCleary Street. Specific vote outcome or action taken is not recorded in the available vote records." },
    ],
    publicComment: "Public comment on agenda items was included on the agenda as the first item.",
    actionItems: [
      "Outcomes for all discussion items are not recorded in the available vote records; review of meeting video or official minutes may be required to confirm specific actions taken",
    ],
    civicItems: [
  ...
  },
  {
    ...
    isAgendaOnly: false,
    badge: "new",
    overview: "The Wausau Board of Public Works approved most agenda items including pay estimates for wastewater facility improvements and water treatment plant demolition, but rejected pay estimates for lead service line replacement. The board also approved contractor licenses and entered closed session to deliberate on claims.",
    agenda: [
    ...
    discussions: [
      ...
      { item:"Open Quotations for Storm Sewer Materials", body:"Quotations for storm sewer materials were opened. No vote action was recorded for this item." },
      ...
      { item:"Pay Estimate #24 and Pay Estimate #25 with Community Infrastructure Partners for replacement of lead service lines", body:"The board rejected Pay Estimate #24 and Pay Estimate #25 with Community Infrastructure Partners for lead service line replacement work. The motion to approve failed." },
    ...
    actionItems: [
      ...
      "Pay Estimates #24 and #25 for Community Infrastructure Partners lead service line replacement denied - requires follow-up",
      "Final payment of $1,000 approved for Robinson Brothers Environmental asbestos abatement",
      "Pay Estimate #2 of $62,272.50 approved for MRD Group water treatment plant demolition",
      "Change Order #2 contract extensions approved for Haas Sons, Inc. street construction project",
      "Contractor licenses approved for SD Ellenbecker, Lewis Construction, and Kell Contracting",
    ],
    civicItems: [
  ...
  },
  {
    ...
    isAgendaOnly: false,
    badge: "new",
    overview: "The Wausau Water Works Commission approved the March 3, 2026 meeting minutes and received updates on multiple water infrastructure projects including lead service line replacement, wastewater facility improvements, and PFAS testing. The meeting adjourned with a unanimous 5-0 vote.",
    agenda: [
    ...
    discussions: [
      { item:"March 3, 2026 Regular Meeting Minutes", body:"The commission approved the minutes from the March 3, 2026 regular meeting. The vote record indicates the motion passed, though specific vote count and movers were not recorded for this item." },
      { item:"Capital Projects Planning and Initial Discussion", body:"The director presented initial discussion on capital projects planning. This was an informational report with no vote required." },
      { item:"Wastewater Update on Headworks Screening Project, Cherry Street Lift Station Project, and Status of Class A Biosolids from WDNR", body:"The commission received updates on multiple wastewater projects including the Headworks Screening Project, Cherry Street Lift Station Project, and the status of Class A Biosolids approval from the Wisconsin Department of Natural Resources. This was an informational report with no vote required." },
      { item:"LSL Replacement Project for 2026", body:"The commission discussed updates on the lead service line replacement project for 2026 and received information on the nationwide cost implications of new regulations. This was a discussion item with no vote required." },
  ...
  },
  {
    ...
    isAgendaOnly: false,
    badge: "new",
    overview: "The Infrastructure & Facilities Committee approved increased parking restriction signs on S 9th Ave and\/or S 10th Ave and parking restrictions on N 2nd St (400-600 blocks), while rejecting proposals for broader parking restrictions on S. 9th and 10th Ave, snow plowing policy changes, special assessments for 2025 street construction, and a city bike rack request form.",
    agenda: [
      { time:"N\/A", item:"Public comment on agenda items" },
    ...
    discussions: [
      { item:"March 12, 2026 Minutes", body:"The committee approved the minutes from the March 12, 2026 regular meeting. The motion passed." },
      { item:"Parking restrictions on S. 9th Ave, S. 10th Ave, and Bopf Street", body:"The committee voted on proposed parking restrictions on S. 9th Ave between Thomas Street and Chellis Street, S. 10th Ave between Thomas Street and Chellis Street, and Bopf Street between S. 9th Ave and S. 10th Ave. The motion to approve failed." },
      ...
      { item:"Snow plowing policy", body:"The committee considered changes to the snow plowing policy. The motion to approve failed." },
      { item:"Final Resolution to levy special assessments for the 2025 Street Construction Projects", body:"The committee voted on a final resolution to levy special assessments for the 2025 Street Construction Projects. The motion to approve failed." },
      { item:"City bike rack request form", body:"The committee considered approving a City bike rack request form. The motion to approve failed." },
      ...
      { item:"Sherman Street Overlay from 3rd Ave to 8th Ave", body:"This item was listed as discussion only with no action indicated. The committee discussed the Sherman Street overlay project from 3rd Ave to 8th Ave." },
    ],
    ...
    actionItems: [
      ...
      "March 12, 2026 meeting minutes approved and filed",
    ],
    civicItems: [
      { number:"1", name:"Public comment on agenda items and reading of the City of Wausau Public Comment Statement.", votes:[], docs:[], children:[] },
      { number:"2", name:"Consideration of the minutes of the preceding meeting(s).", votes:[], docs:[], children:[
  ...
  },
  {
    ...
    discussions: [
      ...
      { item:"Open Statement of Qualifications for Real Estate Services, STH 52 (East Wausau Avenue) Project ID 6999-00-23", body:"Statements of qualifications were opened for real estate services related to the STH 52 East Wausau Avenue project. No vote was recorded for this procedural item." },
      { item:"Open Statement of Qualifications for Real Estate Services, Bus. 51 (Grand Avenue) Project ID 6999-02-20", body:"Statements of qualifications were opened for real estate services related to the Business 51 Grand Avenue project. No vote was recorded for this procedural item." },
      { item:"Claims filed with City", body:"The board acted on seven claims: denied claims from Scott Hagen ($52.41), Michael Kittelson ($103.93), Sabrina Steppert ($301.47), Alesandra Alanis ($4,866.60), and Jackie Lucht ($781.50). The subrogated claim of Patricia Tikalsky was approved for $6,266.21. All motions passed; specific vote counts not recorded." },
    ],
    publicComment: "Not indicated on agenda.",
    actionItems: [
      "Storm sewer materials to be purchased from County Materials, Volm, and Ferguson",
      "Evaluate submitted statements of qualifications for real estate services on STH 52 and Bus. 51 projects",
      "Process approved claim payment of $6,266.21 to Patricia Tikalsky",
      "Communicate denial decisions to claimants Scott Hagen, Michael Kittelson, Sabrina Steppert, Alesandra Alanis, and Jackie Lucht",
    ],
    civicItems: [
      { number:"1", name:"Consideration of the minutes of the preceding meeting(s).", votes:[], docs:[], children:[
  ...
  },
  {
    ...
    isAgendaOnly: true,
    badge: "new",
    overview: "Based on the published agenda, the Marathon County Human Resources, Finance, and Property Committee meeting on April 8, 2026 was scheduled to address county finance, human resources, and property matters. The specific agenda items were not provided in the source material, limiting details about the particular topics set for consideration.",
    agenda: [
      { time:"N\/A", item:"Agenda items not available - only agenda packet link provided" },
    ],
    discussions: [
      { item:"Committee Business", body:"The committee was scheduled to meet to address matters related to human resources, finance, and property for Marathon County. Specific discussion items were not available from the provided source material." },
    ],
    publicComment: "Not indicated on agenda.",
    actionItems: [
  ...
  },
  {
    ...
    isAgendaOnly: true,
    badge: "new",
    overview: "Based on the published agenda, the Marathon County Executive Committee was scheduled to meet on 4\/9\/26. The specific agenda items were not detailed in the provided document, which only contained a link to the full meeting packet on the Marathon County website.",
    agenda: [
      { time:"N\/A", item:"Agenda details not provided in source document - full packet available via Marathon County website" },
    ],
    discussions: [
      { item:"Meeting Packet", body:"The agenda document provided only a link to the full meeting packet hosted on the Marathon County government website. Specific discussion items were not enumerated in the source material provided." },
    ],
    publicComment: "Not indicated on agenda.",
    actionItems: [
      "Full agenda details and expected action items available in meeting packet at marathoncounty.gov",
    ],
  },
  {
    ...
    discussions: [
      { item:"Excellence in Action: Stettin Elementary", body:"The board was scheduled to recognize Stettin Elementary through the Excellence in Action program, which typically highlights accomplishments and innovative practices at district schools." },
      { item:"Wisconsin School Nutrition Purchasing Cooperative Agreement (WiSNP)", body:"In an estimated 5-minute presentation, the board was expected to consider continued membership in the Wisconsin School Nutrition Purchasing Cooperative for the 2026-2027 school year. The WiSNP Co-op requested member districts to present the cooperative's resolution to their respective boards for approval." },
      { item:"Facility Fees", body:"Ryan Urmanski, Director of Buildings and Grounds, was scheduled to present a 10-minute proposal to amend the Wausau School District Facility Use Fee Schedule. The amendment was expected to address costs for use of artificial fields and field lighting for requested events, with immediate implementation sought if the board agreed on the fee schedule." },
      ...
      { item:"NEOLA UPDATE", body:"In an estimated 20-minute session, the committee was scheduled to review proposed changes to over 60 district policies. The updates ranged from minor technical corrections to more substantial revisions, including policies on cell phones and personal communication devices, artificial intelligence, academic honesty, student employment, fundraising, crowdfunding, and Act 57 related policies regarding student supervision, welfare, and child abuse reporting." },
    ],
    ...
    actionItems: [
      ...
      "Action was requested to amend the Wausau School District Facility Use Fee Schedule for artificial fields and field lighting",
      "Action was requested for approval of NEOLA policy updates covering definitions, board member conduct, administrator relationships, reading instruction, Title I parent engagement, athletics, advanced learning, job expenses, academic honesty, homeless students, entrance age, cell phones, third grade promotion, student parking, drug policies, student employment, electronic fund transfers, debt management, purchasing, accounting systems, digital accessibility, and artificial intelligence",
      "Action was requested for approval of school support organization related policies including fundraising, crowdfunding, gifts and grants, and advertising",
      "Action was requested for approval of technical corrections to various policies",
      "Action was requested for approval of Act 57 related policies regarding student supervision, welfare, and child abuse and neglect",
    ],
  },
  {
    ...
    isAgendaOnly: true,
    badge: "new",
    overview: "Based on the published agenda, this meeting was scheduled to address the verification of school board election results for the Wausau School District. This procedural meeting appeared to be focused solely on the formal certification of election outcomes, which is a standard requirement following local school board elections.",
    agenda: [
      { time:"N\/A", item:"Verify School Board Election Results" },
    ],
    discussions: [
      { item:"Verify School Board Election Results", body:"The board was scheduled to review and verify the results of the school board election. This procedural item was expected to formally certify the election outcomes and confirm newly elected or re-elected board members." },
    ],
    publicComment: "No public comment period was included on this agenda.",
    actionItems: [
  ...
  },
  {
    ...
    discussions: [
      { item:"Pupil Expulsion Hearing", body:"The Board was scheduled to convene in closed session to conduct a pupil expulsion hearing as permitted under Wisconsin Statutes sections 19.85(1)(a), (f), and (g), as well as section 118.125 regarding student records confidentiality. The Board was expected to deliberate privately at the conclusion of the hearing and may have taken action in either closed or open session as deemed necessary or appropriate." },
    ],
    publicComment: "No public comment period was included on this agenda.",
    actionItems: [
  ...
  },
  {
    ...
    isAgendaOnly: true,
    badge: "new",
    overview: "Based on the published agenda, the Wausau School District Board of Education was scheduled to address several significant items including a 10-year capital improvement plan, property sale fund transfers, multiple athletic co-op agreements, and an extensive policy update covering over 60 district policies. The meeting also included Excellence in Action recognitions for WAVE and South Mountain Elementary, and a closed session for consideration of non-renewal contracts.",
    agenda: [
      { time:"N\/A", item:"Call to Order" },
    ...
    discussions: [
      ...
      { item:"Transfer Funds to Fund 46", body:"Elizabeth Channel, Assistant Superintendent of Operations, was expected to present a 5-minute proposal to move revenue generated from three property sales to Fund 46 for future capital improvements. Action was requested from the Board." },
      { item:"Recommendation for 2026-27 Capital Projects", body:"Ryan Urmanski, Director of Buildings and Grounds, was scheduled to deliver a 15-minute presentation on the 10-Year Capital Improvement Plan for district facilities. This was expected to be a significant discussion item with action requested." },
      { item:"Boys and Girls LaCrosse Co-Op", body:"Jon Tomski, BJ Brandt, and Darci Mick Beversdorf were scheduled to present Boys and Girls LaCrosse Co-Op agreements for Board consideration in a 5-minute presentation. The item included signature pages for both Wausau West and Wausau East participation." },
      { item:"Alpine Ski Co-Op", body:"Jon Tomski, BJ Brandt, and Darci Mick Beversdorf were expected to present the Alpine Skiing Co-Op for Board consideration in a 5-minute presentation, with the agreement covering 2026-2028." },
      { item:"East\/Newman JV Baseball Co Op", body:"Wausau East was seeking to enter a Co-Op agreement with Newman for JV baseball to allow for a full JV\/JV2 season. The agenda noted no official action was needed for this informational item." },
      ...
      { item:"Facility Fees", body:"Following Ryan Urmanski's March Committee of the Whole presentation, the Board was expected to consider amendments to the Facility Use Fee Schedule to reflect costs for artificial fields and field lighting. If approved, changes would be effective immediately." },
      { item:"NEOLA Policy Update", body:"A comprehensive 10-minute policy review was scheduled covering over 60 district policies including updates to definitions, board member conduct, student policies on cell phones and academic honesty, financial policies, AI policy, and Act 57 related child welfare policies. The update included technical corrections, school support organization policies, and substantive policy changes." },
      { item:"Closed Session - Non-renewal Contracts", body:"The Board was scheduled to enter closed session pursuant to Wisconsin Statute 19.85(1)(c) for consideration of contracts for preliminary notice of non-renewal, with the possibility of reconvening in open session for further action." },
    ],
    ...
    actionItems: [
      ...
      "Action was requested for NEOLA policy updates covering multiple policy categories",
      "Board was expected to consider non-renewal contracts in closed session",
    ],
  },
  {
