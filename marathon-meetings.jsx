...
const MEETINGS = [
  {
    ...
    date: "May 23, 2026", shortDate: "MAY 23",
    committee: "Public Works", duration: "~1h",
    url: "https://www.youtube.com/watch?v=j64Gj2ean2k",
    docUrl: null,
    isAgendaOnly: false,
    badge: "new",
    overview: "The Public Works Committee approved several infrastructure-related items including a resolution supporting state transportation funding, awarded a recycled asphalt crushing contract to King Gravel for $126,900, and directed staff to create enforcement language for sewer discharge violations with fines up to $100\/day. The committee also approved construction agreements for Military Road and inspection services for upcoming road projects.",
    agenda: [
      { time:"0:09", item:"Call to order" },
      { time:"0:18", item:"Pledge of Allegiance" },
      { time:"0:45", item:"Roll call" },
      { time:"1:02", item:"Public comment" },
      ...
      { time:"19:55", item:"Street operation update" },
      { time:"29:45", item:"Utility operating update" },
      { time:"44:00", item:"Review 2025 Water Utility PSC annual reports" },
      { time:"49:45", item:"Resolution 2026-014 transportation funding" },
      { time:"53:15", item:"Recycled asphalt base course production" },
      { time:"56:50", item:"Sanitary sewer discharge violation discussion" },
      { time:"1:12:45", item:"Water and sewer connection agreement for Radkey Avenue" },
      { time:"1:18:15", item:"Military Road construction agreement" },
    ],
    discussions: [
      { item:"CIP Update", body:"Michael reported the village received a local road improvement grant for Birch Street reconstruction between Scofield Avenue and Community Center Drive, covering over 50% of the approximately $1.5 million project. This 2029 project will likely be moved up to 2028. Michael noted the village has received over $9 million in grant funding over the past 4-5 years. Discussion also covered Weston Avenue repairs by Integrity Grading and Excavating for settlement issues over sewer trenches, and upcoming repairs on Scofield Avenue and Fuller Street for manhole adjustments and concrete repairs." },
      { item:"Street Operations Update", body:"Staff reported on spring activities including removal of road limits on April 29th, mailbox and sign repairs, dewatering operations near Weston Avenue tributary for about a week due to flooding, and curb line sweeping. Hot mix patching has resumed. Storm damage from East Nick area required tree cleanup. Jones Street culvert failures required installation of a third 18-inch culvert. Equipment maintenance was detailed including winterizing plow trucks with fluid film anti-rust treatment and various vehicle servicing." },
      { item:"Utility Operating Update", body:"Josh reported on water service repairs at Caribou Coffee, well maintenance, and continued private well sampling. Sanitary system experienced significant clear water infiltration - April showed 37 million gallons pumped into system but 53-54 million gallons treated, indicating approximately 15 million gallons of clear water intrusion. Staff identified sump pump discharge violations at Kathleen lift station. Water main flushing notices going out with flushing starting next week. Well 2 rehab at Carey started today." },
      { item:"2025 Water Utility PSC Annual Reports", body:"Michael presented the annual report showing net operating income of $482,911 for 2025, consistent with 2024's $490,000. Water loss is at 6%. Utility value increased to nearly $34 million with $6.7 million in infrastructure placed in service. The utility serves 6,100 customers total - 5,250 in Weston, 830 in Rothschild, and 5 in Scofield\/Rib Mountain Metro. Cash on hand is $6.8 million. Motion to acknowledge passed unanimously." },
      { item:"Resolution 2026-014 Transportation Funding", body:"Michael explained this League of Wisconsin Municipalities resolution seeks long-term funding solutions for state transportation. While grant funding helps one-time costs, recurring funding for street maintenance and snow plowing is inadequate, requiring general tax subsidies. Wisconsin remains affordable for automobile ownership compared to neighboring states. Motion to recommend village board adopt resolution passed unanimously." },
      { item:"Recycled Base Course Production", body:"Michael presented the bid for crushing recycled concrete and asphalt at the Ryan Street site. King Gravel was low bidder at $4.23\/ton for estimated 30,000 tons totaling $126,900. Analysis showed village saves approximately $11\/cubic yard compared to City of Wausau's costs, resulting in about $130,000 savings across three 2026 projects. Motion to award to King Gravel passed unanimously." },
      { item:"Sanitary Sewer Discharge Violation Discussion", body:"Staff sought guidance on enforcement of sewer discharge violations, particularly sump pump discharges into sanitary sewers. Current code allows fines of $100-$1,000 per day. Committee discussed distinguishing between unknowing and willful violations. An upcoming I&I study by Inpipe Technologies will help identify problem areas. Committee directed staff to create enforcement language with fines not to exceed $100\/day for first offenses. Motion passed unanimously." },
      { item:"Radkey Avenue Water\/Sewer Connection", body:"Michael explained a builder wants to construct a duplex on a lot without direct main frontage. Staff proposed allowing a temporary long lateral connection until Radkey Avenue reconstruction, at which time the owner would pay assessment for main extension. Committee added language requiring reconstruction no later than 2029. Motion to recommend approval with the 2029 deadline passed unanimously." },
      { item:"Military Road Construction Agreement", body:"Michael presented intergovernmental agreement with Rothschild for Military Road construction from Wolfman Street to Helin Street. Weston's share for utility relocation is $94,860 ($6,156 sanitary, $88,704 water main). Steam Construction is the contractor. Water main relocation needed due to storm sewer conflicts. Motion to recommend approval passed unanimously." },
      { item:"Construction Services for Alderson\/Jelinek and Bladel Projects", body:"Michael presented proposals for construction inspection services. For Alderson\/Jelinek roundabout project, MSA proposed $37,315 versus Clark Dietz at $48,910 - staff recommended MSA. For Bladel Avenue, MSA proposed $70,400 and Clark Dietz $73,730 - staff recommended Clark Dietz for the extra $3,000 due to having full-time experienced staff versus MSA's summer intern. Motion to recommend MSA for roundabout and Clark Dietz for Bladel passed unanimously." },
    ],
    publicComment: "No public comment was offered.",
    actionItems: [
      "Approved minutes from April 13, 2026 meeting",
      "Acknowledged April 2026 water and sewer permits",
      "Recommended village board adopt Resolution 2026-014 supporting state transportation funding",
      "Awarded 2026 recycled asphalt crushing contract to King Gravel at $4.23\/ton (estimated $126,900)",
      "Directed staff to create enforcement language for sewer discharge violations with fines up to $100\/day",
      "Approved temporary water\/sewer connection agreement for 2230 Radkey Avenue with assessment due upon reconstruction no later than 2029",
      "Recommended approval of Military Road construction agreement with Rothschild for $94,860 village share",
      "Recommended MSA for Alderson\/Jelinek roundabout inspection services ($37,315) and Clark Dietz for Bladel Avenue inspection ($73,730)",
      "Special assessment meeting scheduled for May 28, 2026 at 6:00 PM for Bladel Avenue project",
      "Staff to provide cost analysis of clear water infiltration treatment costs at next meeting",
    ],
  },
  {
    ...
    agenda: [
      ...
      { time:"4:28", item:"Disclosures and recusals" },
      { time:"4:40", item:"Approval of April 13, 2026 meeting minutes" },
      { time:"5:21", item:"Site plan review - Mountain Bay Metro Police Department and Municipal Court facility at 3600 Community Center Drive" },
      { time:"19:45", item:"Creation of salt storage shed inspection program for wellhead protection district" },
      { time:"28:22", item:"April 2026 staff approved certified survey maps and site plans" },
      { time:"28:35", item:"April 2026 building permits" },
      { time:"28:50", item:"Planning and development department monthly project update" },
      { time:"31:15", item:"Commissioner remarks" },
      { time:"31:45", item:"Future agenda items" },
      { time:"34:35", item:"Adjournment" },
    ],
    discussions: [
      { item:"Mountain Bay Metro Police Department and Municipal Court Facility Site Plan", body:"Staff presented the site plan for the new police department and municipal court at 3600 Community Center Drive, noting it meets all B2 zoning requirements. Chief Jeremy explained the building was rotated to face east due to a gas pipeline constraint, with parking over the 36-inch deep pipeline acceptable to the gas company. The building will accommodate 50-60 officers for future growth beyond the current 40 officers. Discussion included the alternate storage shed placement, with commissioners suggesting moving it north to allow for future building expansion. Motion to approve was made by a commissioner and passed unanimously with conditions 2-5 as listed by staff." },
      { item:"Salt Storage Shed Inspection Program for Wellhead Protection District", body:"Jennifer presented the new inspection program requiring two annual inspections per facility - a warm weather inspection focusing on structural integrity and a winter operational inspection focusing on material handling. The program uses standardized worksheets similar to DOT standards. Staff noted one existing facility near Sternberg has never gone through the wellhead protection conditional use process and commissioners agreed staff should reach out to bring them into compliance. Motion to approve the program with staff reporting back to both Plan Commission and Public Works passed unanimously." },
      { item:"April 2026 Meeting Minutes", body:"Motion to approve the April 13, 2026 meeting minutes as presented was made, seconded, and passed unanimously without discussion." },
      { item:"April 2026 Staff Approved Items and Building Permits", body:"Both the April 2026 staff approved certified survey maps\/site plans and the April 2026 building permits were approved unanimously without discussion." },
      { item:"Planning Department Update and Future Items", body:"Jennifer announced the first joint Plan Commission-Village Board steering committee meeting for the comprehensive plan is scheduled for Monday, June 1st at 5:00 p.m. Commissioner asked about potential residential TIF districts for workforce housing, and staff indicated Ehlers has prepared a presentation on qualifications that could be shared with the commission, possibly incorporated into comprehensive plan discussions." },
    ],
    publicComment: "Jim Penson of 5002 Arrow Street, Weston spoke via online connection. He urged the commission to exercise common sense on landscaping requirements for the police department project to avoid excessive taxpayer costs similar to the Greenheck Turner building, and requested that the salt shed inspection program include annual reporting on inspection results for the limited number of facilities in wellhead protection zones.",
    actionItems: [
      "Site plan for Mountain Bay Metro Police Department and Municipal Court at 3600 Community Center Drive approved with staff conditions 2-5",
      "Salt storage shed inspection program adopted for wellhead protection district with two annual inspections per facility",
      "Staff to report inspection findings to Plan Commission and Public Works Committee in approximately one year",
  ...
  },
  {
    ...
    isAgendaOnly: false,
    badge: "new",
    overview: "The Marathon County Health & Human Services Committee held an educational orientation meeting for new board members, featuring presentations from the Health Department, Veteran Service Office, and Aging Disability Resource Center. No action items were voted upon except approval of April 1st meeting minutes; the meeting focused on introducing department missions, services, budgets, and organizational structures to committee members.",
    agenda: [
      { time:"0:00", item:"Call to order and remote participation confirmation" },
      { time:"0:31", item:"Pledge of Allegiance" },
      { time:"1:05", item:"Approval of April 1st committee meeting minutes" },
      { time:"1:40", item:"Operational functions required by statute - no items for this meeting" },
      { time:"3:15", item:"Review of standing committee ordinance section 2.04 - missions, duties, responsibilities" },
      { time:"12:45", item:"Health Department overview presentation by Health Officer Caitlyn Suginaka" },
      { time:"25:04", item:"Social Services Department overview by Administrator Leonard" },
      { time:"45:01", item:"Veteran Service Office presentation by Veteran Service Officer Aaron Galindo" },
    ...
    discussions: [
      ...
      { item:"Review of standing committee ordinance and jurisdiction", body:"Administrator Lance Leonard explained the committee's structure under ordinance section 2.04 sub5, including oversight of the Health Department, Social Services, and Veteran Service Office as direct county departments, plus North Central Health Care and Aging Disability Resource Center as multi-county entities. He outlined affiliated boards including the Social Services Board, Veteran Service Commission, Transportation Coordinating Committee, North Central Healthcare Board, and Marathon County Board of Health." },
      { item:"Health Department overview", body:"Health Officer Caitlyn Suginaka presented the department's mission to prevent disease, promote health, and protect from environmental hazards. She highlighted over 1,200 licenses managed, communicable disease prevention including recent tick kit distribution through public health vending machines, the Nurse Family Partnership program with first graduates at age 2, and a new FTE position for homeless system response created from last session's task force. The department has approximately 37.6 FTE across four divisions: environmental health, nursing, community health improvement, and administration." },
      { item:"Social Services Department overview", body:"Administrator Leonard presented on behalf of absent Director Christa, explaining the department's divisions including child welfare, youth justice, children's long-term support, economic support, and child support. He highlighted the successful Family Keys program addressing housing instability, which was piloted with state funding alongside Lacrosse and Wood counties. The department has approximately 140 FTE with a 2026 budget of over $22 million, of which about $7 million is tax levy." },
      { item:"Veteran Service Office presentation", body:"Veteran Service Officer Aaron Galindo reported his 3.0 FTE office had 8,149 interactions in 2025, up from 5,900. He highlighted $44 million in annual VA benefits flowing to county veterans plus $2.6 million in retroactive payments in 2025. Key initiatives include surviving spouse DIC benefits outreach, housing stability partnerships with Center for Veterans Issues, and suicide prevention efforts noting 7 of 30 county suicides in 2025 were veterans. Supervisor Kremes asked about pandemic preparedness and regional cooperation; Galindo explained veterans can work with any county VSO and his office maintains good relationships with neighboring counties." },
      { item:"Aging Disability Resource Center presentation", body:"Executive Director Mike Ray explained the ADRC serves four counties (Marathon, Lincoln, Langlade, Wood) with about 60 FTE and 385-400 volunteers. Services include information assistance, Meals on Wheels, caregiver support, dementia care specialists, and falls prevention programs. He noted significant financial challenges with nutrition program costs up 40-45% in four years while federal Older Americans Act funding remains flat. The ADRC received its first levy increase in 2024 after holding flat since formation in 2011. Vice Chair Rosenberg praised the culturally appropriate meals program at the Mung American Center." },
    ],
    publicComment: "No public comment was offered.",
    actionItems: [
      ...
      "ADRC Executive Director Mike Ray to present full annual report with 2025 data to full board",
      "Chair Boots to bring strategic plan information to upcoming meetings",
      "Next meeting corrected to Tuesday June 3rd at 3:00 PM (not May 29th as initially stated)",
      "Committee members encouraged to email Chair Boots and Administrator Leonard with agenda item requests",
    ],
  },
  {
    ...
    isAgendaOnly: false,
    badge: "new",
    overview: "The Marathon County Board of Supervisors held an adjourned organizational meeting where they approved committee appointments, elected Supervisors Hapa and Arstead to at-large executive committee positions, and unanimously approved a modified landfill tipping fee structure to provide relief for residents affected by recent severe weather and tornado damage in the Ringle area.",
    agenda: [
      { time:"0:00", item:"Pledge of Allegiance and moment of reflection" },
      { time:"0:30", item:"Reading of the notice" },
      { time:"1:00", item:"Roll call" },
      { time:"5:01", item:"Committee appointments presentation and remarks from Chair" },
      ...
      { time:"21:00", item:"Resolution 25-26: Amend social services budget" },
      { time:"21:30", item:"Resolution 26-26: Modification to landfill tipping fees" },
      { time:"1:10:02", item:"Announcements, requests, and adjournment" },
    ],
    discussions: [
      { item:"Committee appointments", body:"Chair Gibbs delivered remarks emphasizing leadership responsibilities and noting that 34% of the board is in its first or second term. He thanked Vice Chair Boots for assistance in developing appointments and outlined goals including increasing diversity of perspectives on committees and providing growth opportunities for supervisors. The motion by Supervisor Cavelli, seconded by Supervisor Crims, was carried but was not unanimous." },
      { item:"Election of at-large executive committee members", body:"Three supervisors were nominated: Supervisor Hapa (nominated by Supervisor Mask), Supervisor Leur (nominated by Supervisor Rosenberg), and Supervisor Arstead (nominated by Supervisor Boots). Supervisor Rosenberg spoke in support of Supervisor Leur, citing her advocacy for the county's youngest children and oldest elders. Paper ballots were distributed and supervisors selected two names. Supervisors Hapa and Arstead were elected to the executive committee." },
      { item:"Consent agenda items C10-C14A", body:"Motion by Supervisor Cavelli, seconded by Supervisor Drebeck. The motion was carried unanimously with no discussion." },
      { item:"Resolution 24-26: Out of home placement reserve increase", body:"Motion by Supervisor Morash, seconded by Supervisor Robinson. The motion was carried but was not unanimous with no discussion recorded." },
      { item:"Resolution 25-26: Amend social services budget", body:"Motion by Supervisor P, seconded by Supervisor Robinson. The motion was carried but was not unanimous with no discussion recorded." },
      { item:"Resolution 26-26: Modification to landfill tipping fees", body:"Administrator Leonard and Director Hagen Busher presented the proposal from the Solid Waste Management Board to reduce tipping fees for disaster-related debris following severe weather that caused significant damage in Ringle and other areas. The state is waiving $13.10 per ton, Ringle is waiving $2.33 per ton, and the county proposed reducing fees to $36.94 per ton (covering operational costs). Two residents, Jessica Toasty and Matt Haybeck, were granted special permission to speak and requested full fee waivers and extended timelines beyond 60 days. Multiple supervisors asked questions about the fee structure, timeline extensions, and future policy development. Administrator Leonard mentioned potential partnership with the community foundation to help with unreimbursed costs. The board first unanimously approved suspending rules to hear the resolution (which hadn't gone through a standing committee), then unanimously approved Resolution 26-26." },
    ],
    publicComment: "Two residents were granted special dispensation to speak on the landfill tipping fee resolution at Supervisor Rosenberg's request. Jessica Toasty asked the county to waive fees entirely, noting that the state, DNR, and Ringle were waiving their fees, and requested a six-month timeline. She mentioned one business has spent $40,000 on hauling expenses and that Marathon County hasn't provided much financial assistance. Matt Haybeck spoke on behalf of homeowners needing to demolish houses, noting 44 affected homes, many still waiting for insurance adjusters, and requested more time for fee waivers.",
    actionItems: [
      ...
      "Resolution 25-26 approved: Amend social services budget 2026",
      "Resolution 26-26 approved: Modified landfill tipping fees for disaster debris through June 17th",
      "Administrator Leonard to work with community foundation on mechanism for reimbursing unreimbursed insurance costs for individual landowners",
      "Solid waste management board to develop clear policy within six months for handling similar disaster situations in the future",
      "Staff to continue tracking disaster-related debris with certification forms",
    ],
  },
  {
    ...
    isAgendaOnly: false,
    badge: "new",
    overview: "The Marathon County Environmental Resources Committee approved two rezoning petitions unanimously and voted to forward a modified fee waiver proposal for tornado-damaged properties to the county board. The committee also received educational presentations from Solid Waste, Parks Recreation and Forestry, and Conservation Planning and Zoning departments.",
    agenda: [
      { time:"0:00", item:"Call to order and Pledge of Allegiance" },
      { time:"1:18", item:"Public comment" },
      { time:"1:28", item:"Approval of March 31, 2026 committee minutes" },
      { time:"1:50", item:"Public hearing - Tim Veland rezoning petition (urban residential\/general agriculture to rural residential, Town of Green Valley)" },
      ...
      { time:"19:55", item:"Consideration of fee waivers for properties impacted by April 17, 2026 severe weather" },
      { time:"56:30", item:"Solid Waste Department overview presentation" },
      { time:"1:19:30", item:"Parks, Recreation and Forestry Department overview presentation" },
      { time:"1:34:30", item:"Conservation Planning and Zoning Department overview presentation" },
    ],
    discussions: [
      { item:"Approval of March 31, 2026 committee minutes", body:"Supervisor Sefeld made a motion to approve the minutes with Supervisor Drebeck providing the second. The motion carried unanimously with no discussion." },
      { item:"Tim Veland rezoning petition - Town of Green Valley", body:"Land Use Specialist Garrett Pogle presented the staff report for rezoning from urban residential and general agriculture to rural residential for a proposed land division. The Town of Green Valley recommended approval on March 10, 2026. No public comment was offered. Supervisor Drebeck moved to approve based on findings of fact, conclusions of law, and town approval. Supervisor Kurt seconded. Motion carried unanimously." },
      { item:"Jeffrey and Cynthia Schmidtz rezoning petition - Town of McMillan", body:"Garrett Pogle presented the rezoning request from Conservancy Recreation to General Agriculture. Supervisor Leur asked about the conservancy nature of the property; Pogle explained the property contains a home and horse riding stable, and the rezoning would make the existing structures conforming uses. No natural areas would be lost. The Town of McMillan recommended approval on April 20, 2026. No public comment was offered. Supervisor Sefeld moved to approve; Supervisor Drew seconded. Motion carried unanimously." },
      { item:"Fee waivers for April 17, 2026 severe weather victims", body:"Director Lori Mskimmons presented a proposal to waive county zoning and septic fees for properties damaged by the April 17 tornado affecting towns of Ringle, Easton, and villages of Kronenwetter and Weston. Supervisor Drew questioned where to draw the line for future events. Supervisor Leur asked about tracking costs. Supervisor Drebeck raised concerns about fairness to other disaster victims not in declared emergency areas. Eric Vogel asked about insurance coverage. After debate, Supervisor Drebeck moved to amend the proposal to only waive reconnect fees ($160) for septic systems, not other zoning or septic fees. Supervisor Kurt seconded the amendment. The amendment carried. The amended resolution then passed on a non-unanimous vote to forward to the county board." },
      { item:"Solid Waste Department presentation", body:"Director David Hagenbusher provided an overview of solid waste operations including the landfill history since 1980, the renewable natural gas partnership with Vidi Energy generating revenue since September 2025, and upcoming challenges including leachate treatment requirements by 2032. He noted they accept about 1,000 tons daily and work with Portage and Shawano counties. Marilyn Bend praised the department's work during the Ringle tornado response." },
      { item:"Parks, Recreation and Forestry Department presentation", body:"County Forest Administrator Tom Lovelin presented on behalf of Director Jamie, covering the department's 44 full-time and 120 seasonal employees serving both county and city of Wausau. He highlighted Nine Mile County Forest generating $3.25 million annually for the local economy from out-of-town visitors. Supervisor Sefeld announced Tom Lovelin is retiring June 1st after nearly 30 years of service, with Joe Tucker selected as his replacement." },
    ],
    publicComment: "No public comment was offered. No one signed up for public comment at the beginning of the meeting, and no members of the public spoke during the two rezoning public hearings.",
    actionItems: [
      "Rezoning approved for James Offer and David Tract property from urban residential\/general agriculture to rural residential in Town of Green Valley - forwarded to county board",
      "Rezoning approved for Jeffrey and Cynthia Schmidtz property from Conservancy Recreation to General Agriculture in Town of McMillan - forwarded to county board",
      "Modified fee waiver resolution (reconnect fees only) for April 17, 2026 tornado-impacted properties forwarded to county board for consideration",
      "Staff directed to track costs and requests related to fee waivers for potential future policy development",
    ],
  },
  {
    ...
    isAgendaOnly: false,
    badge: "new",
    overview: "The Village of Weston Community Life and Public Safety Committee met on May 4th to address several ordinance changes and enforcement matters. Key actions included recommending approval of nuisance ordinance amendments, an e-bike\/e-moto ordinance with restrictions on emoto roadway use, mobile food vendor fire inspection requirements, address corrections, and a raze order for a condemned property at 4104 Shore Avenue.",
    agenda: [
      ...
      { time:"34:00", item:"Overnight parking regulations October 31 to May 1" },
      { time:"53:00", item:"Crosswalk request on Alderson Street" },
      { time:"62:00", item:"Mobile food vendor fire inspection amendment" },
      { time:"70:00", item:"Address corrections for E911 compliance" },
      { time:"75:00", item:"Raze request for 4104 Shore Avenue" },
    ],
    discussions: [
      { item:"Department Reports", body:"Code Enforcement Officer Audrey reported that 3020 Mountain View Avenue will come off the enforcement roll after property sale and new owner submitted repair permits. Police Chief Hunt reported 2,394 calls in March (77 per day), 410 traffic stops, and 281 citations. The department has hired its 40th officer, with the 38th starting last week, 39th in May, and 40th around January. Two SROs work with zoning during summer for all three municipalities. Motion to acknowledge reports 5, 6, and 7 passed unanimously." },
      { item:"Chapter 50 Nuisance Amendments", body:"Committee reviewed final copy of nuisance ordinance amendments previously discussed, including tree limb height requirements of 14 and 10 feet over streets and walkways. Motion by Olsen, seconded by Campkey, to recommend approval to the Board of Trustees passed unanimously." },
      { item:"E-bicycle Ordinance Chapter 82", body:"Extensive discussion on regulating e-bikes and emotos (electric motorcycles). Chief Hunt strongly advocated prohibiting emotos from roadways and sidewalks, comparing them to unlicensed dirt bikes. Committee discussed concerns about electric scooters used by children but decided to rely on officer discretion rather than specific exemptions. Motion by Olsen, seconded by Chwanka, to recommend approval with emoto prohibition on roadways, sidewalks, trails, and public property passed unanimously." },
      { item:"Overnight Parking Regulations", body:"Trustee Tolson presented research showing Weston's 12-hour overnight parking restriction (4am-4pm) is significantly longer than surrounding municipalities (typically 4-5 hours). Public Works Director Michael suggested eliminating the overnight parking restriction entirely and instead signing specific problem areas. Chief Hunt opposed removal, preferring uniform overnight restrictions to clear cars before plowing. Committee decided to table the item until July for Michael to identify specific areas needing restrictions." },
      { item:"Crosswalk Request on Alderson Street", body:"Mount Olive Church requested a crosswalk between the church and DC Everest High School parking lot. Committee discussed costs ($2,000-3,000 for basic crosswalk, $25,000-30,000 for lighted system). Chief Hunt noted no incidents in the area. Motion by Olsen, seconded by Chwanka, to recommend board approval contingent on Mount Olive covering installation costs passed unanimously." },
      { item:"Mobile Food Vendor Fire Inspections", body:"Fire department presented a regional inspection program with Wisconsin Rapids, Marshfield, Stevens Point, Plover, Rib Mountain, and SAFER. One inspection sticker is valid across all participating municipalities. Fire Marshal Marty already conducted an inspection that failed due to improper LP piping and unsecured propane containers. Motion by Chwanka, seconded by Campkey, to approve Ordinance 26-8 passed unanimously." },
      { item:"Address Corrections for E911 Compliance", body:"Staff presented three addressing errors: 5915 Delicowski Street (duplex needing split to 5915\/5917), 3917 Ross Avenue (out of sequence with nearby apartment building), and 2211 Radkey Avenue (new duplex on private drive). Chief Hunt added Weston Villa Apartments on Delicowski has eight separate addresses for one structure. Motion to recommend approval passed unanimously." },
      { item:"Raze Order for 4104 Shore Avenue", body:"Property has been abandoned since 2010-2011 and posted since 2021. Previous attempt to use structure for fire training was rejected as unsafe. Owners are current on taxes and have indicated preference for village to proceed with demolition. Costs will be added to tax roll. Motion by Olsen, seconded by Campkey, to recommend board authorization for raze order passed unanimously." },
    ],
    publicComment: "Jim Senalt spoke regarding multiple agenda items: criticized the new farmers market location at the park predicting grass destruction from vehicle parking; noted potential code violation with parking on grass; questioned ADA compliance of handicap spaces on grass versus firm surfaces; asked about the origin of food truck fire inspections; raised concerns about mobile food vendor regulations on public property versus private property; and criticized the age of some code enforcement cases requesting better accountability reporting on long-standing violations.",
    actionItems: [
      "Chapter 50 nuisance amendments recommended to Board of Trustees for approval",
      "E-bike\/e-moto ordinance recommended to Board with emoto prohibition on all public areas",
      "Michael to identify specific areas needing parking restrictions for July meeting",
      "Michael to contact Mount Olive Church regarding crosswalk cost sharing",
      "Ordinance 26-8 for mobile food vendor fire inspections approved",
      "Address corrections for three properties recommended to Board",
      "Raze order for 4104 Shore Avenue recommended to Board",
