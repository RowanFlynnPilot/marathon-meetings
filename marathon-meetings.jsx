...
const MEETINGS = [
  {
    ...
    isAgendaOnly: false,
    badge: "new",
    overview: "The Weston Parks and Recreation Committee approved minutes, selected Rettler Corporation for the Mock Mueller Park master plan project, and discussed park impact fees and ice rink operations. The committee provided feedback supporting moderate increases to park impact fees to align with neighboring communities, and reviewed expenses for the Yellow Banks kayak launch project which came in significantly under budget due to successful grant funding.",
    agenda: [
      { time:"0:05", item:"Call to order and Pledge of Allegiance" },
      { time:"0:29", item:"Roll call" },
      { time:"0:47", item:"Approval of minutes from February 23, 2026" },
      ...
      { time:"26:09", item:"Unfinished business - RFP for Mock Mueller Park graphic master plan and budget estimates" },
      { time:"31:16", item:"New business - Review of Yellow Banks kayak launch expenses" },
      { time:"36:52", item:"New business - Components of operations for ice rink at Kennedy Park" },
      { time:"50:18", item:"Future items and next meeting date" },
      { time:"53:34", item:"Adjournment" },
    ],
    discussions: [
      { item:"Approval of minutes from February 23, 2026", body:"A motion to accept the minutes was made and seconded. The motion passed unanimously with all members present voting in favor. Committee member Karn was noted as absent and excused." },
      { item:"Public comments", body:"Jim Pinsel of Pencil Street expressed frustration about not receiving responses to his previous comments and questions. He raised concerns about playground equipment allegedly installed negligently in 2024, lack of Kennedy Park fundraising updates, ice rink cost analysis, and questioned why staff hours weren't translated into dollar costs in reports. He estimated the true cost to operate the ice rink at $20,000-$30,000 when factoring in labor. Lisa Beck of 1808 Cortez Lane praised Michael for handling the recent blizzard and snow removal, and commended Sean and Jessica for the well-written Yellow Banks RFC documentation." },
      { item:"Parks and recreation impact fee discussion", body:"Jennifer presented information on park impact fees, noting the 2020 study allowed fees up to $761 for single family units but the committee in 2022 only raised fees from approximately $250 to $300. Neighboring communities charge $600-$900 for single family homes. Committee members Katrina and others expressed support for a moderate increase to align with neighbors. Specific questions were raised about costs for the Granite Ridge subdivision path, which would only cover about one-third of expenses at current rates. The committee consensus was to support moderate fee increases to remain competitive while improving parks. Jennifer will present comparison data to Plan Commission next month." },
      { item:"RFP for Mock Mueller Park master plan", body:"Seven proposals were received for the park master plan project, reviewed by four staff members based on firm experience, personnel, project understanding, and cost. The two lowest bidders were JSD and Rettler Corporation with similar pricing. Staff noted Rettler is known for park planning and has done previous work including the Kennedy Park master plan and CORP update. Roger made a motion to select Rettler Corporation, seconded by Katrina. The motion passed unanimously." },
      { item:"Yellow Banks kayak launch expenses", body:"Jessica compiled expense documentation showing the project came in significantly under budget due to successful grant applications. Grants were obtained from DNR and Marathon County Transportation (which covered the full ADA dock expense). Additional unforeseen costs included subgrade issues and an unknown well casing discovered during construction. PGA had the lowest bid and provided favorable pricing. Committee members praised Jessica and Dan Hagen for their grant writing work, with Katrina noting this success should be highlighted more to the public. Dan Hagen and MTS donated site planning services." },
      { item:"Ice rink operations at Kennedy Park", body:"Staff presented information on Kennedy Park ice rink operations. No attendance records exist after 2019 because warming house staffing couldn't be recruited after COVID. Everest Youth Hockey has expressed interest in building a covered rink structure to extend the ice season and has provided cost estimates, but discussions remain preliminary. Committee member Katrina stated she wanted to ensure hockey interests aren't forgotten amid baseball-focused Kennedy Park discussions. Staff will bring back attendance data from 2018-19 seasons and additional information next month. Michael noted they are the only outdoor full-size hockey rink in the area." },
    ],
    publicComment: "Two residents spoke during public comment. Jim Pinsel expressed frustration about not receiving responses to his February comments, raised concerns about playground equipment installation, Kennedy Park fundraising transparency, ice rink cost analysis methodology, and questioned why labor hours weren't converted to dollar costs. Lisa Beck praised staff for handling the recent blizzard and complimented the Yellow Banks RFC documentation. A written response to Jim Pinsel's previous comments was submitted and will be included in the minutes.",
    actionItems: [
      ...
      "Staff to bring back ice rink attendance data from 2018-19 seasons to next meeting",
  ...
  },
  {
    ...
    isAgendaOnly: true,
    badge: "new",
    overview: "Based on the published agenda, the Village of Weston Board of Trustees was scheduled to meet on March 23, 2026 to address multiple rezoning ordinances, a subdivision plat approval, and numerous public works and infrastructure matters including street maintenance, utility engineering contracts, and well rehabilitation. The meeting also included discussion items on an April referendum, e-bicycle regulations, and various park-related fees and agreements.",
    agenda: [
    ...
    discussions: [
      ...
      { item:"Ordinance No. 26-005: Rezoning of 7105 Christiansen Avenue", body:"The Board was set to review rezoning a portion of 7105 Christiansen Avenue from Single Family Residential-Large Lot (SF-L) to Single Family Residential-Small Lot (SF-S). This rezoning was expected to permit smaller lot development in this area." },
      { item:"Ordinance No. 26-006: Speed Limits Amendment", body:"The Board was scheduled to consider amendments to Chapter 82.600 of the Municipal Code regarding speed limits. The specific speed limit changes were not detailed in the agenda." },
      { item:"Resolution No. 2026-008: Hinner Springs Second Addition Subdivision", body:"The Board was expected to consider approval of the final plat for Hinner Springs Second Addition Subdivision. This would be a formal step in the development approval process for this residential subdivision." },
      { item:"April 2026 Referendum Informational Sessions Update", body:"This discussion-only item was scheduled to provide the Board with an update on informational sessions planned for an April 2026 referendum. No action was expected on this item." },
      { item:"Proposed E-Bicycle and E-Moto Ordinance", body:"The Board was set to discuss potential regulations for e-bicycles and e-motos, with dialogue expected to take place at the Community Life and Public Safety Committee. This reflects growing interest in regulating electric personal transportation devices." },
      { item:"2026 Annual Street Maintenance Plan and Budget", body:"The Board was scheduled to discuss and potentially take action on the village's 2026 street maintenance plan and associated budget. This would outline priorities for road repairs and maintenance throughout the year." },
      { item:"Military Road Utility Engineering Services Contract", body:"The Board was expected to consider a contract for engineering services related to utilities on Military Road. The scope and cost of the contract were not specified in the agenda." },
      { item:"Well 2 Rehabilitation", body:"The Board was scheduled to discuss and potentially take action on rehabilitation of Well 2, which appears to be part of the village's water infrastructure maintenance efforts." },
      { item:"Park Shelter Fees and Field Rental Costs", body:"The Board was set to review and potentially adjust fees for park shelter rentals and field usage. This item was expected to address pricing for community recreational facilities." },
    ],
    ...
    actionItems: [
      ...
      "Expected to consider approval of vouchers (check numbers 66279-66316, 66322-66380, 66396-66429, 90240-90243)",
  ...
  },
  {
    ...
    isAgendaOnly: true,
    badge: "new",
    overview: "Based on the published agenda, the Village of Weston Board of Trustees was scheduled to address multiple rezoning ordinances, a subdivision final plat approval, infrastructure projects including street maintenance and utility engineering contracts, and various parks and recreation matters including field maintenance agreements and shelter fees. The meeting also included discussion of an upcoming April 2026 referendum and potential e-bicycle regulations.",
    agenda: [
      { time:"N\/A", item:"Approval of February 16, 2026, Board of Trustees Meeting Minutes" },
      { time:"N\/A", item:"Acknowledge Reports\/Minutes from Boards, Committees, Commissions" },
      { time:"N\/A", item:"Acknowledge Reports from Departments" },
    ...
    discussions: [
      { item:"Ordinance No. 26-004: Rezoning of 8905 Birch Street", body:"The Board was scheduled to consider rezoning a portion of property at 8905 Birch Street from Rural Residential-5 Acre (RR-5) to Single Family Residential-Small Lot (SF-S). This rezoning was expected to enable higher-density residential development on the parcel." },
      { item:"Ordinance No. 26-005: Rezoning of 7105 Christiansen Avenue", body:"The Board was set to review rezoning a portion of property at 7105 Christiansen Avenue from Single Family Residential-Large Lot (SF-L) to Single Family Residential-Small Lot (SF-S). This change was expected to allow for smaller lot residential development." },
      { item:"Ordinance No. 26-006: Speed Limits Amendment", body:"The Board was scheduled to consider amendments to Chapter 82.600 of the Municipal Code regarding speed limits within the Village. The specific speed limit changes were expected to be detailed in the ordinance." },
      { item:"Resolution No. 2026-008: Hinner Springs Second Addition Subdivision Final Plat", body:"The Board was expected to consider approval of the final plat for the Hinner Springs Second Addition Subdivision. This action was set to formally authorize the subdivision layout and allow development to proceed." },
      { item:"April 2026 Referendum Informational Sessions Update", body:"The Board was scheduled to discuss updates regarding informational sessions for an upcoming April 2026 referendum. This was listed as discussion only, with no action expected to be taken." },
      { item:"Proposed E-Bicycle and E-Moto Ordinance Dialogue", body:"The Board was set to discuss referring e-bicycle and e-moto regulations to the Community Life and Public Safety Committee for further dialogue. This addresses emerging transportation modes requiring regulatory consideration." },
      { item:"Removal of No Parking Restrictions", body:"The Board was expected to consider removing no parking restrictions on Alta Verde Street south of Jelinek Avenue and on Alderson Street along Kennedy Park. This change could affect parking availability for park users and nearby residents." },
      { item:"Baseball\/Softball Field Maintenance and User Agreement", body:"The Board was scheduled to discuss and potentially act on agreements governing maintenance responsibilities and usage terms for baseball and softball fields. This was expected to formalize arrangements between the Village and field users." },
      { item:"Park Shelter Fees and Field Rental Costs", body:"The Board was set to review park shelter rental fees and field rental costs. Any changes would affect community groups and residents seeking to reserve Village recreational facilities." },
      { item:"Eagle Scout Project at Machmueller Park", body:"The Board was expected to consider an Eagle Scout project proposed for Machmueller Park. Such projects typically involve volunteer-led improvements that benefit community parks." },
      { item:"Remote Meeting Attendance Policy Review", body:"The Board was scheduled to review the Elected and Appointed Officials' Handbook policy regarding remote meeting attendance. This addresses procedures for officials participating in meetings via electronic means." },
      { item:"Microsoft Teams for Communication", body:"The Board was set to discuss adopting Microsoft Teams as a communication platform. This technology decision could affect how Village officials and staff collaborate." },
      { item:"Military Road Utility Engineering Services Contract", body:"The Board was expected to consider an engineering services contract for utility work on Military Road. This infrastructure project would involve professional engineering oversight." },
      { item:"Bus 51 Storm Pond Engineering Services Contract Amendment", body:"The Board was scheduled to consider amending an existing engineering services contract for the Bus 51 storm pond project. This suggests modifications to scope or cost of ongoing stormwater infrastructure work." },
      { item:"2026 Annual Street Maintenance Plan and Budget", body:"The Board was set to review and potentially approve the 2026 annual street maintenance plan and associated budget. This plan was expected to outline roadway repairs and improvements for the year." },
      { item:"Hospital Area Repaving Change Order #4", body:"The Board was expected to consider the fourth change order for the hospital area repaving project. Change orders typically address modifications to scope, timeline, or cost of ongoing construction work." },
      { item:"Well 2 Rehabilitation", body:"The Board was scheduled to discuss rehabilitation of Well 2, part of the Village's water supply infrastructure. This maintenance work was expected to ensure continued reliable water service." },
      { item:"Sign Encroachment Agreement", body:"The Board was set to consider a sign encroachment agreement with 7th Floor Investments, LLC for Macco's Floor Covering at 3111 Schofield Avenue. This agreement would address signage extending into Village right-of-way." },
    ],
    publicComment: "Public comment was on the agenda, allowing any person to address the Board for up to three minutes regarding non-agenda items.",
    actionItems: [
      "Scheduled to vote on approval of February 16, 2026 meeting minutes",
      "Expected to consider Ordinance No. 26-004 rezoning 8905 Birch Street from RR-5 to SF-S",
      "Expected to consider Ordinance No. 26-005 rezoning 7105 Christiansen Avenue from SF-L to SF-S",
      ...
      "Expected to consider appointment of agent change for Reliance Fuel LLC",
      ...
      "Expected to consider Well 2 Rehabilitation",
      "Scheduled to consider Sign Encroachment Agreement with 7th Floor Investments, LLC",
    ],
  },
  {
    ...
    discussions: [
      { item:"March 10, 2026 Regular Board of Public Work Minutes", body:"The board approved the minutes from the March 10, 2026 meeting." },
      ...
      { item:"2026 Asphalt Paving Project 'A'", body:"The board opened bids for this paving project but the motion to approve failed. The outcome may require rebidding or further review." },
      { item:"2025 Street Construction Project 'A' - Randolph Street\/Cherry Street Change Orders", body:"The board approved Change Order #1 in the amount of $14,436.50 for the Haas Sons, Inc. contract. The vote on Change Order #2 is not separately recorded in the vote records." },
      { item:"2025 Street Construction Project 'A' - Randolph Street\/Cherry Street Pay Estimate #9", body:"The board approved Pay Estimate #9 to Haas Sons, Inc. in the amount of $535,011.42. The motion passed." },
    ...
    actionItems: [
      "Contract awarded to Switlick & Sons, Inc. for $1,279,989.75 for North 8th Avenue street construction - forward to City Council for final approval",
      "2026 Asphalt Paving Project 'A' bids rejected - project may require rebidding or reconsideration",
      "Change Order #1 for $14,436.50 approved for Randolph Street\/Cherry Street project",
      "Pay Estimate #9 for $535,011.42 approved for payment to Haas Sons, Inc.",
  ...
  },
  {
    ...
    discussions: [
      ...
      { item:"Consideration of the minutes of the February 18, 2026 Regular Plan Commission Meeting", body:"The minutes from the February 18, 2026 Regular Plan Commission Meeting were approved. Specific vote count and movers were not recorded." },
      { item:"Public Hearing: Conditional Use Permit for 218 South 4th Street (Dunwoody Storage)", body:"A public hearing was held regarding a Conditional Use Permit for 218 South 4th Street to authorize construction of a Personal Storage Facility in the Light Industrial Zoning District. No vote was recorded for this item as it was a public hearing only." },
      { item:"Conditional Use Permit for 731 N 1st Street (Beacon Resources, LLC)", body:"The Commission approved a Conditional Use Permit for 731 N 1st Street to allow construction of a 70-unit, 7-story apartment building by Beacon Resources, LLC. The motion passed; specific vote count was not recorded." },
      { item:"Transportation Project Plat for Grand Avenue signal replacements", body:"The Commission approved the Transportation Project Plat for Project 370-40-40, covering Grand Avenue signal replacements at Sturgeon Eddy Road and Townline Road. The motion passed; specific vote count was not recorded." },
    ],
    publicComment: "Public comment on agenda items was included on the agenda as Item 2.",
    actionItems: [
      "Conditional Use Permit approved for 70-unit apartment building at 731 N 1st Street - project may proceed",
      "Transportation Project Plat approved for Grand Avenue signal replacements at Sturgeon Eddy Road and Townline Road",
      "Conditional Use Permit for personal storage facility at 218 South 4th Street received public hearing - further action may be scheduled",
    ],
    civicItems: [
  ...
  },
  {
    ...
    isAgendaOnly: false,
    badge: "new",
    overview: "The Wausau Board of Public Works awarded the 2026 Asphalt Paving Project 'A' contract to RC Pavers, LLC for $824,146.34. The meeting concluded with adjournment approved 2-0.",
    agenda: [
      { time:"N\/A", item:"Open bids and make recommendation for 2026 Asphalt Paving Project 'A'" },
    ],
    discussions: [
      { item:"2026 Asphalt Paving Project 'A'", body:"The board opened bids and voted to award the contract to RC Pavers, LLC in the amount of $824,146.34. The motion passed." },
    ],
    publicComment: "Not indicated on agenda.",
    actionItems: [
  ...
  },
  {
    ...
    isAgendaOnly: false,
    badge: "new",
    overview: "The Public Health and Safety Committee approved all action items including license applications, a solid waste disposal code update, repeal of a hand-held device driving ordinance, and a solar energy partnership with MREA. The committee also received reports on fire department activities, tavern activities, and community outreach.",
    agenda: [
    ...
    discussions: [
      { item:"Consideration of the minutes of the preceding meeting(s)", body:"The February 16, 2026 meeting minutes were approved 3-0. Sarah Watson moved and Lou Larson seconded the motion." },
      ...
      { item:"Approving Memorandum of Understanding between the City of Wausau and the Midwest Renewable Energy Association (MREA)", body:"The committee approved the MOU to partner with MREA in the operation of the Grow Solar Central Wisconsin Group Buy Program. The motion passed." },
      { item:"Wausau Fire Department 2025 Annual Report", body:"The committee received the Fire Department's 2025 annual report as a discussion item. No vote was required." },
      { item:"Tavern Activities Report from February 2026", body:"The committee reviewed the February 2026 tavern activities report as a discussion item. No vote was required." },
    ...
    actionItems: [
      "License applications approved as recommended by staff with exception of Theodore Davis",
      "Wausau Municipal Code Chapter 6.44 Solid Waste Disposal repealed and recreated with new provisions",
      "Wausau Municipal Code Section 10.01.012 on hand-held device use while driving repealed",
  ...
  },
  {
    ...
    isAgendaOnly: false,
    badge: "new",
    overview: "The Wausau Finance Committee denied a tax recovery claim for Green Acres at Greenwood Hills while approving multiple airport lease transactions and budget amendments. Several items including the National Opioid Settlement participation and property purchases for the Streets Division were postponed to the next meeting.",
    agenda: [
      { time:"N\/A", item:"Public comment on agenda items" },
    ...
    discussions: [
      { item:"March 10, 2026 Regular Finance Committee Minutes", body:"Approved 4-0. Motion made by Sarah Watson and seconded by Aaron Griner. Michael Martens, Vicki Tierney, Sarah Watson, and Aaron Griner all voted yes." },
      { item:"Alleged Claim for Recovery of Unlawful Tax for Green Acres at Greenwood Hills, LLC - Outlot 1", body:"The motion to approve the claim for recovery failed. Specific vote count not recorded in the vote records." },
      { item:"Consent to transfer title to buildings at 939 Woods Place", body:"The committee approved the consent to transfer title to buildings and improvements and waiver of first right of refusal. Motion passed; specific vote count not recorded." },
      { item:"Terminating Airport Ground Lease with Wynn O. Jones at 939 Woods Place", body:"Approved by the committee. Motion passed; specific vote count not recorded." },
      { item:"Approving Airport Ground Lease with Owen Jones at 939 Woods Place", body:"Approved by the committee. Motion passed; specific vote count not recorded." },
      { item:"Approving Airport Ground Lease with Cole Lundberg", body:"Approved by the committee. Motion passed; specific vote count not recorded." },
      { item:"Six Remnant Defendants National Opioid Settlement Agreement", body:"The committee voted to postpone this item to the next scheduled meeting. Motion passed; specific vote count not recorded." },
      { item:"Budget amendment for Wausau Water Works Lead Service Line Replacement", body:"The committee voted to postpone consideration of this item to the next meeting. Motion passed; specific vote count not recorded." },
      { item:"Budget amendment for carryover of funds from 2025 to 2026", body:"Approved by the committee. Motion passed; specific vote count not recorded." },
      { item:"2026 General Obligation Promissory Note for Capital Improvements", body:"The committee approved advancing this item to the calendar. Motion passed; specific vote count not recorded." },
      { item:"Review of 2025 General Fund Financial Results", body:"The committee approved the transfer of funds following review. Motion passed; specific vote count not recorded." },
      { item:"Purchasing properties for DPW Streets Division", body:"The committee voted to postpone consideration of the purchase of properties at 108, 112, 112-1\/2 Adolph Street and 233 Myron Street until the next meeting. Motion passed; specific vote count not recorded." },
    ],
    publicComment: "Public comment on agenda items was listed on the agenda.",
    actionItems: [
      "Green Acres at Greenwood Hills tax recovery claim denied - no further action",
      "Airport lease transfers at 939 Woods Place approved - proceed with Owen Jones lease and terminate Wynn O. Jones lease",
      "Airport Ground Lease with Cole Lundberg approved",
      "Budget amendment for 2025-2026 fund carryover approved",
      "2026 General Obligation Promissory Note for Capital Improvements advanced to full council calendar",
      "National Opioid Settlement Agreement participation postponed to next Finance Committee meeting",
      "Water Works Lead Service Line Replacement budget amendment postponed to next meeting",
      "Property purchases at Adolph Street and Myron Street for Streets Division postponed to next meeting",
    ],
    civicItems: [
      { number:"1", name:"Public comment on agenda items and reading of the City of Wausau Public Comment Statement.", votes:[], docs:[], children:[] },
  ...
  },
  {
    ...
    isAgendaOnly: false,
    badge: "new",
    overview: "The Wausau Common Council approved all agenda items including a development agreement for Waterside Place at 11 Scott Street, a residential solid waste and recycling service agreement with Harter's Fox Valley Disposal LLC, and a budget modification allowing the Police Department to use proceeds from selling a Thompson sub-machinegun to purchase red-dot optics. The council also suspended procedural rules (7-2 vote) to consider four additional items that all passed.",
    agenda: [
      ...
      { time:"N\/A", item:"Closed Session regarding litigation settlement offer in David Hoelzel case" },
    ],
    discussions: [
      { item:"March 10, 2026 Regular Common Council Minutes", body:"Approved 9-0. Motion moved by Sarah Watson and seconded by Vicki Tierney." },
      { item:"Consent Agenda (Ordinance Amending Section 9.20.070 and Parking Lot Lease Renewal)", body:"The consent agenda containing the Parks & Recreation Committee ordinance amending regulations on fires, fireworks, firearms, and missiles, along with the parking lot lease renewal with Colonial Property 4, LLC was approved 9-0. Motion moved by Sarah Watson and seconded by Chad Henke." },
      { item:"Confirming Appointments of the Mayor", body:"The resolution confirming mayoral appointments to the Plan Commission, Affordable Housing Task Force, and Business Improvement District Board was approved. Detailed vote count not recorded." },
      { item:"Residential Solid Waste and Recycling Service Agreement with Harter's Fox Valley Disposal LLC", body:"The resolution approving the residential solid waste and recycling service agreement was approved. Detailed vote count not recorded." },
      { item:"Airspace Obstruction Removal Agreement with Schofield Ridgeland Legacy LLC", body:"The resolution approving the airspace obstruction removal agreement for properties at 724 and 732 Ridgeland Avenue, Schofield, along with related budget modification, was approved. Detailed vote count not recorded." },
      { item:"Airspace Obstruction Removal Agreement with Zachary Lange", body:"The resolution approving the airspace obstruction removal agreement for 811 Ridgeland Avenue, Schofield, and related budget modification was approved. Detailed vote count not recorded." },
      { item:"2026 Budget Modification for Police Department Red-Dot Optics", body:"The resolution allowing the Wausau Police Department to use proceeds from the sale of a Thompson sub-machinegun to purchase red-dot optics was approved. Detailed vote count not recorded." },
      { item:"Development Agreement for Waterside Place at 11 Scott Street", body:"The joint resolution from the Economic Development Committee and Infrastructure & Facilities Committee approving the development agreement and amended parking agreement with 11 Scott Street, LLC was approved. Detailed vote count not recorded." },
      { item:"Suspension of Council Rules", body:"The motion to suspend Rule 1(D), 6(B), and 12(A) to consider four additional items passed 7-2. Motion moved by Lisa Rasmussen and seconded by Sarah Watson. Terry Kilian and Vicki Tierney voted no." },
      { item:"Ordinance Repealing and Recreating Chapter 6.44 Solid Waste Disposal", body:"The ordinance from the Public Health & Safety Committee repealing and recreating the municipal code chapter on solid waste disposal was approved. Detailed vote count not recorded." },
      { item:"Settlement of David Hoelzel v. City of Wausau", body:"The resolution approving release of all claims for property damage settlement in the Hoelzel case (Marathon County Case No. 25-CV-594) was approved. Detailed vote count not recorded." },
      { item:"Paid Duty Time for Out of Country Police Training", body:"The joint resolution approving paid duty time for a Wausau Police Department officer to attend out of country training was approved. Detailed vote count not recorded." },
      { item:"Community Outreach Professional Shelter Operations Duty Premium Differential", body:"The joint resolution approving a duty premium differential for community outreach professional shelter operations was approved. Detailed vote count not recorded." },
    ],
    ...
    actionItems: [
      "Residential solid waste and recycling service agreement with Harter's Fox Valley Disposal LLC to be executed",
      "Development agreement and amended parking agreement for Waterside Place at 11 Scott Street to be finalized",
      "Airspace obstruction removal agreements with Schofield Ridgeland Legacy LLC and Zachary Lange to be executed with related budget modifications",
      "Police Department authorized to purchase red-dot optics using Thompson sub-machinegun sale proceeds",
      "Chapter 6.44 Solid Waste Disposal to be repealed and recreated per new ordinance",
      "Settlement release to be executed in David Hoelzel v. City of Wausau case",
      "Paid duty time approved for police officer out of country training",
      "Community outreach professional shelter operations duty premium differential to be implemented",
    ],
    civicItems: [
  ...
  },
  {
    ...
    isAgendaOnly: true,
    badge: "new",
    overview: "The Wausau School District Education\/Operations Committee meeting addressed 4K program partnership agreements for 2026-2027, annual safety updates including drill debriefs, and a comprehensive review of 43 Neola policy updates. The meeting also featured an Excellence in Action presentation highlighting John Marshall Elementary.",
    agenda: [
    ...
    discussions: [
      { item:"4K Program Agreement", body:"The district's four-year-old kindergarten program is seeking approval to continue partnerships with six community collaboration sites for the 2026-2027 school year, including Wausau Child Care, Mountain View Montessori, Woodson YMCA, Newman Catholic Schools, and Head Start Program. These partnerships have been in place since 2002, with 4K Principal Kara Rakowski and Director of Elementary Education Julie Schell presenting the agreement." },
      ...
      { item:"Neola Policies Update", body:"The committee reviewed 43 proposed policy changes covering a wide range of topics including board member conduct, student entrance age, third grade promotion and retention, academic honesty, drug possession, drone use, school safety, food service, wellness, and visitor policies. The updates include both Volume 34 Number 2 changes and technical corrections to existing policies." },
    ],
  ...
  },
  {
    ...
    isAgendaOnly: true,
    badge: "new",
    overview: "This special meeting of the Wausau School District Board of Education focused on closed session discussions regarding real estate negotiations and the evaluation of the Superintendent of Schools. The board planned to reconvene in open session to take any necessary action resulting from these confidential deliberations.",
    agenda: [
      { time:"0:00", item:"Call to Order" },
    ...
    discussions: [
      { item:"Discussion regarding the Competitive Negotiations of a Purchase\/Sale of Real Estate", body:"The board entered closed session under Wisconsin statute 19.85(1)(e) to discuss competitive negotiations related to the purchase or sale of real estate. This statutory exception allows confidential discussion of property transactions to protect the district's negotiating position." },
      { item:"Evaluation of Superintendent of Schools", body:"The board conducted a closed session evaluation of the Superintendent under Wisconsin statute 19.85(1)(c). This provision permits private discussion of employee performance evaluations to protect personnel matters." },
    ],
    publicComment: "No public comment period was included on this agenda.",
    actionItems: [
      "Take action as a result of the closed session regarding real estate negotiations",
      "Take action as a result of the closed session regarding Superintendent evaluation",
    ],
  },
  {
    ...
    isAgendaOnly: true,
    badge: "new",
    overview: "The Wausau School District Board of Education's December 8, 2025 regular meeting addressed referendum-funded elementary school construction updates at 50% completion, the annual safety update with police partnership details, and multiple policy revisions. The board also considered recognition for Rob Hughes, charter school updates from Red Granite, and 4K program agreements for the 2026-2027 school year.",
    agenda: [
      { time:"0:00", item:"Call to Order" },
    ...
    discussions: [
      { item:"50% Updates for Elementary Referendum Construction", body:"The board received updates on referendum-funded improvement plans that have reached 50% design completion. Current plans for John Marshall, Rib Mountain, Franklin Elementaries, and Lincoln Early Learning Academy were shared with the board during this 15-minute presentation." },
      { item:"Red Granite Update", body:"Red Granite Principal Maud Mangin and Red Granite Governance Board President Amanda Molin provided a status update on the Red Granite Charter School. This 5-minute presentation required board action." },
      { item:"4K Program Agreement", body:"The district's four-year-old kindergarten program sought approval to enter into agreements with community collaboration partner sites for the 2026-2027 school year. Partner sites include Wausau Child Care, Mountain View Montessori, Woodson YMCA Wausau Branch, Newman Catholic Schools, and Marathon County Child Development Agency Head Start Program - Barrington Center." },
      { item:"Annual Safety Update \/ Drill Debrief", body:"Andy Grimm and members of the Wausau Police Department shared the annual safety update that was previously presented at the November Education\/Operations Committee Meeting. The presentation highlighted the strong partnership between the Wausau Police Department and the district, especially with School Resource Officers." },
      { item:"Neola Policies Update", body:"Proposed changes to 43 district policies were reviewed, following the November Education\/Operations Committee meeting discussion. The policies cover a wide range of topics including board member conduct, student entrance age, academic honesty, drug policies, school safety, food service, and visitors." },
    ],
    publicComment: "Public and Student Comment period was included on the agenda following the Resolution of Commendation.",
    actionItems: [
  ...
  },
  {
    ...
    isAgendaOnly: true,
    badge: "new",
    overview: "The Audit of the Bills Committee met to review and approve the district's financial expenditures for December 2025. This routine financial oversight meeting ensures proper accountability for Wausau School District spending.",
    agenda: [
      { time:"0:00", item:"Call to Order" },
    ...
    discussions: [
      { item:"Audit of the Bills", body:"The committee reviewed the December 2025 audit of bills document, which details the district's expenditures requiring approval. This financial review ensures all payments are properly documented and authorized before processing." },
    ],
    publicComment: "No public comment period was included on this agenda.",
    actionItems: [
  ...
  },
  {
    ...
    isAgendaOnly: true,
    badge: "new",
    overview: "This special meeting of the Wausau School District Board of Education focuses primarily on closed session matters including administrator contracts, staff employment discussions, and real estate negotiations. The meeting also includes a public recognition of Ellie Mason with a Resolution of Commendation.",
    agenda: [
      { time:"0:00", item:"Call to Order" },
      { time:"0:02", item:"Request for Closed Session Pursuant to State Statutes" },
    ...
    discussions: [
      { item:"Approve Administrator Contracts and Discuss Performance and Employment of a Staff Member", body:"The board will enter closed session under Wisconsin statute 19.85(1)(c) to discuss administrator contracts and matters related to the performance and employment of staff members. Personnel matters of this nature are discussed privately to protect employee privacy." },
      { item:"Discussion regarding the Competitive Negotiations of a Purchase\/Sale of Real Estate", body:"The board will discuss real estate transactions in closed session under Wisconsin statute 19.85(1)(e), which permits private deliberation on competitive negotiations for property purchases or sales. This protects the district's negotiating position." },
      { item:"Resolution of Commendation: Ellie Mason", body:"The board will formally recognize Ellie Mason with a Resolution of Commendation. An attachment dated December 12, 2025 provides details about the recognition being presented." },
    ],
    publicComment: "No public comment period was included on this agenda.",
    actionItems: [
      "Approve Resolution of Commendation for Ellie Mason",
      "Approve Administrator Contracts",
      "Take action on real estate negotiations if necessary following closed session",
    ],
  },
  {
    ...
    isAgendaOnly: true,
    badge: "new",
    overview: "The Wausau School District Education\/Operations Committee met to consider open enrollment seat availability for 2026-2027 and approve multiple athletic co-op renewals with neighboring schools. The meeting also featured a performance and tour highlighting John Muir Middle School's recent updates.",
    agenda: [
      { time:"0:00", item:"Call to Order" },
    ...
    discussions: [
      ...
      { item:"Approve Co-Ops", body:"Athletic directors BJ Brandt and Darci Mick Beversdorf presented information on multiple athletic co-op renewals including boys hockey with East\/Merrill\/Newman Catholic, girls lacrosse with East\/West\/DCE\/Mosinee, and girls STORM hockey with East\/West\/DCE\/Mosinee plus the addition of Merrill and Stratford. All co-ops are for the 2026-27 and 2027-28 school years." },
    ],
    publicComment: "A public and student comment period was included on the agenda.",
    actionItems: [
      ...
      "Approve minutes from November 24, 2025 meeting",
    ],
  },
  {
    ...
    isAgendaOnly: true,
    badge: "new",
    overview: "This special meeting of the Wausau School District Board of Education focused primarily on personnel matters, including routine staff appointments and separations, as well as two closed sessions to address employee conduct allegations with potential termination and administrator contract approvals. The meeting's significance lies in the quasi-judicial hearing regarding employee termination and administrator contract decisions.",
    agenda: [
      { time:"0:00", item:"Call to Order" },
      ...
      { time:"0:07", item:"Request for Closed Session Pursuant to State Statutes - Administrator Contracts" },
      { time:"0:09", item:"Adjourn" },
    ],
    discussions: [
      { item:"Convene into closed session - Employee Conduct", body:"The board convened in closed session to receive evidence concerning allegations regarding employee conduct and consider administrative recommendation for the employee's termination from employment. The board deliberated on evidence received during the quasi-judicial hearing and may have also considered an employee resignation agreement." },
      { item:"Approve Administrator Contracts", body:"The board entered closed session to approve administrator contracts and discuss performance and employment matters of staff members pursuant to Wisconsin Statute 19.85(1)(c). The board was to reconvene in open session to take further action if necessary and appropriate." },
    ],
    publicComment: "No public comment period was included on this agenda.",
    actionItems: [
  ...
  },
  {
    ...
    isAgendaOnly: true,
    badge: "new",
    overview: "This regular meeting of the Wausau School District Board of Education covered the 2024-25 audit report presentation, WASB resolutions voting instructions, approval of athletic co-ops, and discussion of replacing the chiller system at Wausau West. The board also addressed open enrollment seat availability for 2026-27 and considered closed session items regarding potential litigation and superintendent evaluation.",
    agenda: [
      { time:"0:00", item:"Call to Order" },
      { time:"0:02", item:"Roll Call" },
      ...
      { time:"1:39", item:"Request for Closed Session" },
    ...
    discussions: [
      ...
      { item:"WASB Resolutions", body:"The Board reviewed proposed WASB Resolutions including a late addition Resolution 13 regarding a proposed amendment to WASB bylaws. Board members directed the WASB Delegate on how to vote on behalf of the District at the upcoming convention." },
      { item:"Wausau West Chiller Discussion", body:"Interim Assistant Superintendent of Operations Elizabeth Channel and Director of Buildings and Grounds Ryan Urmanski presented a request to solicit bids for the replacement of the chiller system at Wausau West. This infrastructure item addresses climate control needs at the high school." },
      { item:"Wisconsin Investment Series Cooperative Resolution", body:"Assistant Superintendent of Operations Elizabeth Channel presented a resolution to continue the District's membership in the Wisconsin Investment Series Cooperative. This updates authorization that is over ten years old in accordance with best practice." },
      { item:"Open Enrollment Seat Availability", body:"At the December Education\/Operations Committee Meeting, Wendy Cartledge presented the Open Enrollment Space Determinations for the 2026-2027 school year. The Board was asked to approve these seat availability numbers." },
      { item:"Approve Co-Ops", body:"The Board considered renewal of several athletic cooperative agreements including boys hockey East\/Merrill\/Newman Catholic, girls lacrosse East\/West\/DCE\/Mosinee, and girls STORM hockey with the addition of Merrill and Stratford. All co-ops are for the 26-27 and 27-28 school years." },
      { item:"Closed Session - Preliminary Discussion Regarding Potential Litigation", body:"The Board requested closed session pursuant to State Statute 19.85(g) for preliminary discussion regarding potential litigation matters affecting the district." },
      { item:"Closed Session - Evaluation of Superintendent", body:"The Board requested closed session pursuant to State Statute 19.85(1)(c) to conduct evaluation of the Superintendent of Schools." },
    ],
    publicComment: "The agenda included a Public and Student Comment period as item V, allowing community members and students to address the Board.",
    actionItems: [
      ...
      "Potential action following closed session discussions",
    ],
  },
  {
    ...
    isAgendaOnly: true,
    badge: "new",
    overview: "The Audit of the Bills Committee met to review and approve the district's bills for payment. This routine financial oversight meeting ensures proper review of Wausau School District expenditures.",
    agenda: [
      { time:"0:00", item:"Call to Order" },
    ...
    discussions: [
      { item:"Audit of the Bills", body:"The committee reviewed the January 26, 2026 audit of bills document for the school district. This involves examining and verifying invoices and payments to ensure accuracy and proper authorization of district expenditures." },
    ],
    publicComment: "No public comment period was included on this agenda.",
    actionItems: [
  ...
  },
  {
    ...
    isAgendaOnly: true,
    badge: "new",
    overview: "The Education\/Operations Committee meeting focused on referendum project designs for four elementary schools reaching 95% completion, financial planning including legal expenses and multi-year projection models, and the 2026-2027 school calendar. The meeting also addressed student demographics and potential governance model changes for committee structure.",
    agenda: [
      { time:"0:00", item:"Call to Order" },
      { time:"0:02", item:"Approve the Minutes" },
    ...
    discussions: [
      ...
      { item:"Presentation of Financial Projection Model Assumptions", body:"Interim Assistant Superintendent Elizabeth Channel shared key variables contributing to the District's multi-year financial projection model, which represents a baseline using current information. The model uses 2025-2026 budget numbers with percentages and dollar amounts projected forward, with the full projection model to be presented at a later date." },
      { item:"2025-2026 Student Demographic Report", body:"Director of Technology Ralph Williams presented the Demographics Report for the 2025-2026 school year, providing data on student population characteristics." },
    ...
    actionItems: [
      ...
      "Consider governance model changes for Audit of Bills Committee and Education\/Operations Committee",
    ],
  },
  {
    ...
    isAgendaOnly: true,
    badge: "new",
    overview: "This special meeting of the Wausau School District Board of Education focused on approving personnel actions through the consent agenda, adopting the 2026-2027 school year calendar, and conducting a closed session evaluation of the Superintendent. The meeting addressed routine staffing matters and finalized the district calendar following a previous presentation.",
    agenda: [
      { time:"0:00", item:"Call to Order" },
    ...
    discussions: [
      { item:"Approve 2026-2027 District Calendar", body:"Diana White had previously presented a draft of the 2026-2027 school year calendar to the Board for their review. This agenda item requested formal Board approval of the calendar following that presentation. The estimated presentation time was 1 minute." },
      { item:"Evaluation of Superintendent of Schools", body:"The Board entered closed session pursuant to Wisconsin State Statute s. 19.85 (1)(c) to conduct an evaluation of the Superintendent of Schools. This personnel matter required confidential discussion before potentially reconvening in open session to take any necessary action." },
    ],
    publicComment: "No public comment period was included on this agenda.",
    actionItems: [
      "Approve Consent Agenda including appointments, separations, leaves of absence, and retirements",
      "Approve 2026-2027 District Calendar",
      "Potential action as a result of closed session regarding Superintendent evaluation",
    ],
  },
  {
    ...
    agenda: [
      ...
      { time:"1:35", item:"Request for Closed Session - Competitive Negotiations of Purchase\/Sale of Real Estate" },
      { time:"1:45", item:"Reconvene in Open Session" },
      { time:"1:50", item:"Adjourn" },
    ],
    discussions: [
      { item:"Franklin, Rib Mountain, Lincoln & John Marshall 95% Design", body:"As referendum projects for each facility reach the end of the design phase at 95% completion, the Board reviewed the designs and budget for Franklin, Rib Mountain, Lincoln, and John Marshall Elementary schools. The Board was asked to consider approval of these plans to be issued for competitive bidding." },
      ...
      { item:"Wausau West Chiller System", body:"Interim Assistant Superintendent of Operations Elizabeth Channel and Director of Buildings and Grounds Ryan Urmanski presented a request to approve the bid for the replacement of the chiller system at Wausau West High School." },
      { item:"Wausau East Hockey Update", body:"An informational presentation addressed the disbandment of the East\/Merrill Boys Hockey Co-Op and explored potential options for the district, Wausau East, and East Hockey players going forward." },
  ...
  },
  {
    ...
    isAgendaOnly: true,
    badge: "new",
    overview: "This special meeting of the Wausau School District Board of Education focused on personnel matters through the consent agenda and included a closed session to discuss potential litigation. The meeting addressed staff appointments, separations, leaves of absence, and retirements.",
    agenda: [
      { time:"0:00", item:"Call to Order" },
    ...
    discussions: [
      ...
      { item:"Preliminary Discussion Regarding Potential Litigation", body:"The board entered closed session under Wisconsin Statute 19.85(g) to hold preliminary discussions regarding potential litigation matters facing the district. The board planned to reconvene in open session to take any necessary action following the closed session discussion." },
    ],
    publicComment: "No public comment period was included on this agenda.",
    actionItems: [
      "Approve Consent Agenda including appointments, separations, leaves of absence, and retirements",
  ...
  },
  {
    ...
    isAgendaOnly: true,
    badge: "new",
    overview: "The Wausau School District Board of Education Committee of the Whole meeting focused on financial planning with a five-year fiscal forecast presentation, AGR school mid-year progress reports, and a comprehensive NEOLA policy update covering over 60 policies. The meeting also included referendum budget updates and recognition of the district planetarium and Wausau West High School achievements.",
    agenda: [
      { time:"0:00", item:"Call to Order" },
      { time:"0:02", item:"Approve the Minutes" },
    ...
    discussions: [
      { item:"Five Year Fiscal Forecast", body:"The Board received a five-year fiscal forecast model for the District that will be used during the next three months to construct the 2026-27 budget reconciliation plan and budget. Administration noted that projections involve many variables that change periodically, and significant changes will be brought to the Board's attention as they occur." },
      { item:"AGR Annual Report", body:"This mid-year update presented AGR student outcome scores required by DPI, including screening results from the three AGR schools. The report featured work being done to strengthen organizational systems and demonstrated how these schools are evolving their practices to improve student achievement." },
      { item:"NEOLA UPDATE", body:"The Committee reviewed proposed changes to over 60 policies across multiple categories including definitions, board member conduct, administrator relationships, student policies, financial policies, and school support organization policies. Changes ranged from small technical corrections to more substantive updates, with revised policies on cell phones, academic honesty, homeless students, and fundraising among those addressed." },
      { item:"Referendum Budget Update", body:"Administration provided routine updates on the April 2022 referendum-funded facility improvements as construction continues to develop. These updates will be presented regularly until projects are completed." },
    ],
    publicComment: "A public and student comment period was included on the agenda.",
    actionItems: [
      "NEOLA policy updates approval including policies on definitions, board member conduct, student supervision, reading instruction, athletics, cell phones, homeless students, academic honesty, financial management, and school support organizations",
    ],
  },
  {
    ...
    isAgendaOnly: true,
    badge: "new",
    overview: "This special meeting of the Wausau School District Board of Education was convened to conduct a pupil expulsion hearing in closed session. The meeting addressed student disciplinary matters requiring confidential proceedings under Wisconsin Statutes.",
    agenda: [
      { time:"0:00", item:"Call To Order" },
    ...
    discussions: [
      { item:"Closed Session - Pupil Expulsion Hearing", body:"The Board convened in closed session to conduct a pupil expulsion hearing as permitted under Wisconsin Statutes sections 19.85(1)(a), (f), (g), and 118.125 which protect student records and privacy. The Board was authorized to deliberate privately following the hearing and take action in closed session if necessary. Upon conclusion, the Board would reconvene in open session for any further action needed." },
    ],
    publicComment: "No public comment period was included on this agenda.",
    actionItems: [
      "Motion to convene in closed session for pupil expulsion hearing",
      "Potential action on expulsion in closed session",
  ...
  },
  {
    ...
    isAgendaOnly: true,
    badge: "new",
    overview: "This special public meeting brought together the Elementary Task Force for a reunion to reflect on the elementary school consolidation process one year later. Task force members shared their perspectives on the consolidation effort, though no official Board of Education action was taken at this meeting.",
    agenda: [
      { time:"0:00", item:"Elementary Task Force Reunion" },
      { time:"0:03", item:"Summary of Elementary Consolidation" },
      { time:"0:08", item:"Task Force Member Reflectives: One Year Later" },
    ...
    discussions: [
      ...
      { item:"Task Force Member Reflectives: One Year Later", body:"Task force members who participated in the elementary consolidation planning shared their reflections and perspectives one year after the process. This provided an opportunity to assess outcomes and lessons learned from the consolidation effort." },
    ],
    publicComment: "No public comment period was included on this agenda.",
    actionItems: [
  ...
  },
  {
    ...
    isAgendaOnly: true,
    badge: "new",
    overview: "This was a WEA-sponsored meet and greet event for Wausau School District Board of Education candidates. While a quorum of board members may have been present, no official board action was taken at this informal event.",
    agenda: [
      { time:"0:00", item:"WEA Sponsored WSD School Board Candidates Meet & Greet Event" },
    ],
    discussions: [
      { item:"WEA Sponsored WSD School Board Candidates Meet & Greet Event", body:"This event was organized by the Wausau Education Association to provide an opportunity for school board candidates to meet with community members. A quorum of current board members may have attended, but the agenda explicitly noted that no board action would be taken." },
    ],
    publicComment: "No public comment period was included on this agenda.",
    actionItems: [
  ...
  },
  {
    ...
    isAgendaOnly: true,
    badge: "new",
    overview: "The Wausau School District Board of Education held a regular meeting covering routine consent agenda items, a referendum budget update, and a presentation on switching middle school devices from Chromebooks to iPads. The meeting also included updates on the district's five-year fiscal forecast and AGR (Achievement Gap Reduction) annual report.",
    agenda: [
      { time:"0:00", item:"Call to Order" },
      { time:"0:02", item:"Roll Call" },
      { time:"0:04", item:"Pledge of Allegiance" },
    ...
    discussions: [
      ...
      { item:"iPads Presentation", body:"The board received information on switching one-to-one devices at the middle school from Chromebooks to iPads. This presentation was estimated to take 20 minutes and required board action." },
      { item:"Five Year Fiscal Forecast", body:"The district presented a five-year fiscal forecast model that will be applied during the next three months to aid in constructing the 2026-27 budget reconciliation plan. Administration noted that projections result from many variables that change periodically and significant changes will be brought to the Board's attention." },
      { item:"AGR Annual Report", body:"The board received the mid-year AGR student outcome scores required by the DPI, featuring screening results and work being done in three AGR schools to strengthen organizational systems. The update demonstrated how these schools are evolving their practices to improve student achievement." },
    ],
    publicComment: "A public and student comment period was included on the agenda.",
    actionItems: [
  ...
  },
  {
    ...
    isAgendaOnly: true,
    badge: "new",
    overview: "The Wausau School District Board of Education Committee of the Whole meeting addressed several operational matters including nutrition purchasing cooperative membership, facility fee amendments for artificial fields, a referendum budget update, and an extensive NEOLA policy update covering over 60 policies. The meeting also featured recognition of Stettin Elementary through the Excellence in Action segment.",
    agenda: [
      { time:"0:00", item:"Call to Order" },
      { time:"0:02", item:"Approve the Minutes" },
      { time:"0:05", item:"Audit of the Bills" },
    ...
    discussions: [
      ...
      { item:"NEOLA UPDATE", body:"The Committee will review proposed changes to numerous district policies, with some involving only technical corrections and others being more substantial. The update covers policies related to board operations, student affairs, finances, school support organizations, and Act 57 requirements including child abuse and neglect reporting." },
    ],
    publicComment: "No public comment period was included on this agenda.",
    actionItems: [
      ...
      "Approve NEOLA policy updates including definitions, board member behavior, reading instruction goals, cell phone policy, academic honesty, homeless students, third grade promotion, AI policy, and numerous technical corrections",
      "Approve school support organization related policies",
      "Approve Act 57 related policies on student supervision and child abuse reporting",
    ],
  },
  {
