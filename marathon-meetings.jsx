...
const MEETINGS = [
  {
    ...
    isAgendaOnly: false,
    badge: "new",
    overview: "The Village of Weston Board of Trustees was scheduled to meet on March 23, 2026 to consider multiple rezoning ordinances, a subdivision final plat approval, parking restrictions, park-related fees and agreements, infrastructure projects, and various administrative matters. This meeting included significant land use decisions and public infrastructure investments. Note: This summary is based on the agenda, not a transcript.",
    agenda: [
      { time:"6:00 p.m.", item:"Public Comments - non-agenda items (3 minutes per person)" },
      { time:"N\/A", item:"Approval of February 16, 2026 Board of Trustees Meeting Minutes" },
      { time:"N\/A", item:"Acknowledge Reports\/Minutes from Boards, Committees, Commissions (CDA, CLPS, Police, ETZ, Finance, Parks, Plan Commission, Public Works, SAFER, Tourism, Refuse\/Recycling)" },
    ...
    discussions: [
      { item:"Ordinance No. 26-004: Rezoning at 8905 Birch Street", body:"This ordinance would rezone a portion of property at 8905 Birch Street from Rural Residential-5 Acre (RR-5) to Single Family Residential-Small Lot (SF-S). This represents a significant density change from rural to more intensive residential use." },
      { item:"Ordinance No. 26-005: Rezoning at 7105 Christiansen Avenue", body:"This ordinance would rezone a portion of property at 7105 Christiansen Avenue from Single Family Residential-Large Lot (SF-L) to Single Family Residential-Small Lot (SF-S). This would allow for smaller lot development on the property." },
      { item:"Ordinance No. 26-006: Speed Limits Amendment", body:"This ordinance would amend Chapter 82.600 of the Municipal Code regarding speed limits within the Village. The specific streets and speed changes are not detailed in the agenda." },
      { item:"Resolution No. 2026-008: Hinner Springs Second Addition Subdivision Final Plat", body:"The Board would consider approving the final plat for Hinner Springs Second Addition Subdivision, which represents the next phase of this residential development." },
      { item:"April 2026 Referendum Informational Sessions Update", body:"This is a discussion-only item regarding updates on informational sessions planned for an April 2026 referendum. The specific referendum topic is not detailed in the agenda." },
      { item:"E-Bicycle and E-Moto Ordinance Dialogue", body:"The Board would discuss a proposed ordinance regulating electric bicycles and electric mopeds, with dialogue occurring through the Community Life and Public Safety Committee." },
      { item:"Parking Restrictions Removal", body:"The Board would consider removing No Parking restrictions on Alta Verde Street south of Jelinek Avenue and on Alderson Street along Kennedy Park." },
      { item:"Intersection Signage at Community Center Drive and Birch St", body:"The Board would discuss and potentially take action on signage needs at the intersection of Community Center Drive and Birch Street." },
      { item:"Baseball\/Softball Field Maintenance and User Agreement", body:"The Board would consider a maintenance and user agreement for baseball and softball fields, which likely addresses responsibilities between the Village and user groups." },
      ...
      { item:"Park Shelter Fees and Field Rental Costs", body:"The Board would discuss and potentially take action on fee structures for park shelter reservations and field rentals." },
      { item:"Eagle Scout Project at Machmueller Park", body:"The Board would consider approving an Eagle Scout project to be completed at Machmueller Park. The specific project details are not provided in the agenda." },
      { item:"Remote Meeting Attendance Policy Review", body:"The Board would review the Elected and Appointed Officials' Handbook policy regarding remote meeting attendance for officials." },
      { item:"Microsoft Teams for Communication", body:"The Board would discuss and potentially take action on implementing Microsoft Teams as a communication tool for Village operations." },
      { item:"Military Road Utility Engineering Services Contract", body:"The Board would consider a contract for engineering services related to utility work on Military Road." },
      { item:"Bus 51 Storm Pond Engineering Services Contract Amendment", body:"The Board would consider an amendment to the existing engineering services contract for the Bus 51 storm pond project." },
      { item:"Sewer Televising Software Contract", body:"The Board would consider a contract for software used in sewer line televising inspections." },
      ...
      { item:"Hospital Area Repaving Change Order #4", body:"The Board would consider the fourth change order for the Hospital Area repaving project, indicating ongoing modifications to the original contract scope." },
      { item:"Well 2 Rehabilitation", body:"The Board would discuss and potentially take action on rehabilitation work needed for Well 2 in the Village's water system." },
      { item:"Sign Encroachment Agreement with Macco's Floor Covering", body:"The Board would consider a sign encroachment agreement with 7th Floor Investments, LLC for Macco's Floor Covering located at 3111 Schofield Avenue." },
    ],
    publicComment: "Public comment was on the agenda for non-agenda items, with up to three minutes per person and time extensions at the Chief Presiding Officer's discretion.",
    actionItems: [
      "Consider approval of Ordinance No. 26-004 rezoning portion of 8905 Birch Street",
      "Consider approval of Ordinance No. 26-005 rezoning portion of 7105 Christiansen Avenue",
      "Consider approval of Ordinance No. 26-006 amending speed limits",
      "Consider approval of Resolution No. 2026-008 for Hinner Springs Second Addition final plat",
      ...
      "Consider Sign Encroachment Agreement with Macco's Floor Covering",
  ...
  },
  {
    ...
    isAgendaOnly: false,
    badge: "new",
    overview: "The Village of Weston Board of Trustees was scheduled to address multiple rezoning ordinances, a subdivision plat approval, infrastructure projects including street maintenance and utility work, and various policy discussions including e-bicycle regulations and park fees. Based on agenda only - no transcript available.",
    agenda: [
    ...
    discussions: [
      ...
      { item:"April 2026 Referendum Informational Sessions Update", body:"Discussion-only item to provide updates on informational sessions planned for an upcoming April 2026 referendum." },
      { item:"Proposed E-Bicycle and E-Moto Ordinance", body:"Discussion and potential action on initiating dialogue at the Community Life and Public Safety Committee regarding regulations for electric bicycles and electric motos." },
      { item:"Removal of No Parking Restrictions", body:"Discussion and potential action on removing no parking restrictions on Alta Verde St south of Jelinek Avenue and on Alderson Street along Kennedy Park." },
      { item:"Baseball\/Softball Field Maintenance and User Agreement", body:"Discussion and potential action on agreements related to maintenance responsibilities and usage terms for baseball and softball fields." },
      ...
      { item:"Remote Meeting Attendance Policy", body:"Discussion and potential action on reviewing the policy for remote meeting attendance by elected and appointed officials as outlined in the Officials' Handbook." },
      { item:"Military Road Utility Engineering Services Contract", body:"Discussion and potential action on a contract for engineering services related to utility work on Military Road." },
      ...
      { item:"2026 Annual Street Maintenance Plan and Budget", body:"Discussion and potential action on the village's annual plan and budget allocation for street maintenance in 2026." },
    ...
    actionItems: [
      ...
      "Consider action on E-Bicycle and E-Moto ordinance dialogue referral",
      "Consider removal of no parking restrictions on Alta Verde St and Alderson Street",
      "Consider approval of Baseball\/Softball Field Maintenance and User Agreement",
      "Consider approval of Commercial Rotary Mower purchase",
      "Consider approval of Park Shelter Fees and Field Rental Costs",
      "Consider approval of Eagle Scout Project at Machmueller Park",
      "Consider action on Remote Meeting Attendance Policy",
      "Consider approval of Microsoft Teams for Communication",
      "Consider approval of Military Road Utility Engineering Services Contract",
      "Consider approval of Bus 51 Storm Pond Engineering Services Contract Amendment",
      "Consider approval of Sewer Televising Software Contract",
      "Consider approval of 2026 Annual Street Maintenance Plan and Budget",
      "Consider approval of Hospital Area Repaving Change Order #4",
      "Consider approval of Well 2 Rehabilitation",
      "Consider approval of Sign Encroachment Agreement with 7th Floor Investments, LLC",
    ],
  },
  {
    ...
    isAgendaOnly: false,
    badge: "new",
    overview: "This Board of Trustees meeting was expected to cover a broad range of village business including multiple zoning ordinances, a subdivision final plat approval, parking restrictions, park-related fees and agreements, infrastructure projects, and an upcoming referendum. Based on the agenda, not a transcript.",
    agenda: [
      { time:"N\/A", item:"Public Comments" },
      { time:"N\/A", item:"Approval of February 16, 2026, Board of Trustees Meeting Minutes" },
      { time:"N\/A", item:"Acknowledge Reports\/Minutes from Boards, Committees, Commissions" },
    ...
    discussions: [
      { item:"Ordinance No. 26-004: Rezoning at 8905 Birch Street", body:"This ordinance would rezone a portion of property at 8905 Birch Street from Rural Residential-5 Acre (RR-5) to Single Family Residential-Small Lot (SF-S) zoning district." },
      { item:"Ordinance No. 26-005: Rezoning at 7105 Christiansen Avenue", body:"This ordinance would rezone a portion of property at 7105 Christiansen Avenue from Single Family Residential-Large Lot (SF-L) to Single Family Residential-Small Lot (SF-S) zoning district." },
      ...
      { item:"Resolution No. 2026-008: Hinner Springs Second Addition Subdivision", body:"This resolution would approve the final plat for the Hinner Springs Second Addition Subdivision, allowing the development to proceed." },
      { item:"April 2026 Referendum Informational Sessions Update", body:"Discussion-only item regarding an update on informational sessions planned for an upcoming April 2026 referendum. The agenda indicates this is unfinished business." },
      { item:"E-Bicycle and E-Moto Ordinance Dialogue", body:"The Board would consider referring a proposed ordinance regarding e-bicycles and e-motos to the Community Life and Public Safety Committee for discussion." },
      ...
      { item:"Intersection Signage at Community Center Drive and Birch St", body:"The Board would consider signage changes or additions at the intersection of Community Center Drive and Birch Street." },
      { item:"Baseball\/Softball Field Maintenance and User Agreement", body:"Discussion and potential action on agreements governing the maintenance and use of village baseball and softball fields." },
      { item:"Purchase of Commercial Rotary Mower", body:"The Board would consider approving the purchase of a commercial rotary mower for village operations." },
      { item:"Park Shelter Fees and Field Rental Costs", body:"Discussion of fees for park shelter rentals and field rental costs, potentially including rate adjustments." },
      ...
      { item:"Remote Meeting Attendance Policy Review", body:"Review of the Elected and Appointed Officials' Handbook policy regarding remote meeting attendance." },
      { item:"Microsoft Teams for Communication", body:"Discussion on adopting or using Microsoft Teams as a communication tool for village operations." },
      { item:"Military Road Utility Engineering Services Contract", body:"The Board would consider a contract for engineering services related to Military Road utility work." },
      ...
      { item:"Sewer Televising Software Contract", body:"The Board would consider a contract for software used in sewer televising inspections." },
      ...
      { item:"Hospital Area Repaving Change Order #4", body:"The Board would consider approval of Change Order #4 for the hospital area repaving project." },
      ...
      { item:"Sign Encroachment Agreement with Macco's Floor Covering", body:"The Board would consider a sign encroachment agreement with 7th Floor Investments, LLC for Macco's Floor Covering at 3111 Schofield Avenue." },
    ],
    ...
    actionItems: [
      ...
      "Action on final plat approval for Hinner Springs Second Addition (Resolution 2026-008)",
      "Action on E-Bicycle and E-Moto Ordinance referral to CLPS Committee",
      "Action on removal of no parking restrictions on Alta Verde St and Alderson Street",
      ...
      "Action on use of Microsoft Teams for Communication",
  ...
  },
  {
    ...
    isAgendaOnly: false,
    badge: "new",
    overview: "This Infrastructure & Facilities Committee meeting was expected to address parking restrictions on several south-side streets, review the proposed 2027 street construction projects and five-year plan, and consider parking and transportation agreements. Based on agenda only, not a transcript.",
    agenda: [
    ...
    discussions: [
      { item:"Parking restrictions on S. 9th Ave, S. 10th Ave, and Bopf Street", body:"The committee was scheduled to consider parking restrictions on S. 9th Ave between Thomas Street and Chellis Street, S. 10th Ave between Thomas Street and Chellis Street, and Bopf Street between S. 9th Ave and S. 10th Ave. This appears to address parking management in a residential area on the city's south side." },
      { item:"Proposed 2027 Street Construction Projects and 5 Year Plan", body:"The committee was to review and potentially act on the city's proposed street construction projects for 2027 and the accompanying five-year capital improvement plan for streets and infrastructure." },
      { item:"Amended and Restated Parking Agreement with 11 Scott Street, LLC", body:"This item involves an amended parking agreement for the property at 11 Scott Street, also known as Riverside Place. The committee was expected to consider modifications to an existing parking arrangement with the property owner." },
      { item:"Transportation Project Plat for Grand Avenue Signal Replacements", body:"The committee was scheduled to review a transportation project plat (Project 370-40-40) for signal replacements on Grand Avenue at Sturgeon Eddy Road and Townline Road intersections." },
    ],
    publicComment: "Public comment on agenda items was listed as the first item on the agenda.",
    actionItems: [
      "Possible action on parking restrictions for S. 9th Ave, S. 10th Ave, and Bopf Street areas",
  ...
  },
  {
    ...
    isAgendaOnly: false,
    badge: "new",
    overview: "This Board of Public Works meeting was scheduled to open bids for two 2026 construction projects (North 8th Avenue and asphalt paving), approve change orders and payment for an ongoing 2025 street construction project, and consider a concrete license application. Based on agenda only, not a transcript.",
    agenda: [
    ...
    discussions: [
      { item:"2026 Street Construction Project \"B\" - North 8th Avenue Bids", body:"The board was scheduled to open sealed bids from contractors for the North 8th Avenue street construction project and make a recommendation on the winning bid." },
      { item:"2026 Asphalt Paving Project \"A\" Bids", body:"The board was scheduled to open sealed bids for the city's 2026 asphalt paving project and make a recommendation for contract award." },
      { item:"Randolph Street\/Cherry Street Change Orders", body:"The board was to consider two change orders for the ongoing 2025 street construction project being performed by Haas Sons, Inc. Change orders typically modify contract scope, timeline, or costs." },
      { item:"Randolph Street\/Cherry Street Pay Estimate #9", body:"The board was to approve Pay Estimate #9 for Haas Sons, Inc., representing progress payment for work completed on the Randolph Street\/Cherry Street construction project." },
      { item:"Portland Cement Concrete License: KSK, Inc.", body:"The board was to consider a license application from KSK, Inc. to perform portland cement concrete work within the city." },
    ],
    publicComment: "Not indicated on agenda.",
    actionItems: [
      "Open bids and make recommendation for North 8th Avenue street construction",
      "Open bids and make recommendation for 2026 asphalt paving project",
      "Consider Change Order #1 and Change Order #2 for Haas Sons, Inc.",
      "Approve Pay Estimate #9 for Haas Sons, Inc.",
      "Consider concrete license for KSK, Inc.",
    ],
    civicItems: [
  ...
  },
  {
    ...
    isAgendaOnly: false,
    badge: "new",
    overview: "The Wausau Plan Commission meeting agenda for March 17, 2026 includes election of a vice chair, a public hearing on a conditional use permit for a personal storage facility, and discussion of a 70-unit apartment building and transportation infrastructure improvements. Based on the agenda only, not a transcript.",
    agenda: [
    ...
    discussions: [
      { item:"Election of a Vice Chair", body:"The commission will elect a vice chair to serve in the absence of Mayor Doug Diny who serves as chair." },
      { item:"Conditional Use Permit - 218 South 4th Street (Dunwoody Storage)", body:"Public hearing on a conditional use permit application to authorize construction of a personal storage facility in the Light Industrial zoning district. This is the public hearing phase for community input." },
      { item:"Conditional Use Permit - 731 N 1st Street (Beacon Resources, LLC)", body:"Discussion and possible action on a conditional use permit for a significant residential development consisting of a 70-unit, 7-story apartment building proposed by Beacon Resources, LLC." },
    ...
    publicComment: "Public comment on agenda items is listed as agenda item 2, with reference to reading of the City of Wausau Public Comment Statement.",
    actionItems: [
      "Elect Vice Chair",
      "Consider approval of Conditional Use Permit for 218 South 4th Street personal storage facility",
      "Consider approval of Conditional Use Permit for 731 N 1st Street apartment building",
  ...
  },
  {
    ...
    isAgendaOnly: false,
    badge: "new",
    overview: "This Board of Public Works meeting was scheduled to open and review bids for the 2026 Asphalt Paving Project 'A' and make a recommendation. This is a brief, single-item agenda focused on advancing a municipal paving project through the bid process. Note: This summary is based on the agenda, not a transcript.",
    agenda: [
      { time:"1:00 PM", item:"Open bids and make recommendation for 2026 Asphalt Paving Project 'A'" },
    ],
    discussions: [
      { item:"2026 Asphalt Paving Project 'A' Bids", body:"The board was scheduled to open sealed bids submitted for the 2026 Asphalt Paving Project 'A' and review the proposals. Following bid review, the board would make a recommendation on awarding the paving contract." },
    ],
    publicComment: "Not indicated on agenda.",
    actionItems: [
  ...
  },
  {
    ...
    isAgendaOnly: false,
    badge: "new",
    overview: "This Public Health & Safety Committee meeting was expected to address several regulatory matters including solid waste disposal code changes, repealing a mobile phone driving ordinance, and a solar energy partnership. The committee also planned to receive the Fire Department's 2025 annual report and other informational updates. Note: this summary is based on the agenda, not a transcript.",
    agenda: [
      { time:"N\/A", item:"Public comment on agenda items" },
      { time:"N\/A", item:"Consideration of minutes from February 16, 2026 meeting" },
    ...
    discussions: [
      { item:"Various license applications", body:"The committee was scheduled to consider approval or denial of unspecified license applications, a routine matter for the Public Health & Safety Committee." },
      { item:"Solid Waste Disposal Code revision", body:"The committee planned to consider repealing and recreating Chapter 6.44 of the Municipal Code regarding solid waste disposal, suggesting a comprehensive update to the city's waste management regulations." },
      { item:"Mobile Phone Driving Ordinance repeal", body:"The committee was set to discuss repealing the local ordinance prohibiting hand-held mobile phone use while driving, possibly due to existing state law covering this issue." },
      { item:"Grow Solar Central Wisconsin Group Buy Program MOU", body:"The committee planned to consider a partnership with the Midwest Renewable Energy Association to participate in a solar group buy program, which typically helps residents access discounted solar installations." },
      { item:"Fire Department 2025 Annual Report", body:"The committee was scheduled to receive and discuss the Wausau Fire Department's annual report covering 2025 operations and activities." },
      { item:"Tavern Activities Report", body:"A monthly informational report on tavern-related activities and incidents from February 2026 was scheduled for committee review." },
      { item:"Community Outreach Update", body:"The committee planned to receive an update on community outreach efforts, though specific details were not provided in the agenda." },
    ],
    publicComment: "Public comment on agenda items was listed as the first item on the agenda.",
    actionItems: [
      "Vote on various license applications",
      "Vote on repealing and recreating Chapter 6.44 Solid Waste Disposal",
      "Vote on repealing Section 10.01.012 mobile phone driving ordinance",
  ...
  },
  {
    ...
    isAgendaOnly: false,
    badge: "new",
    overview: "The Finance Committee meeting agenda covers a range of financial and property matters including airport ground leases, participation in a national opioid settlement, budget amendments for water works and carryover funds, and potential property acquisitions for the Department of Public Works. This is based on the agenda document, not a meeting transcript.",
    agenda: [
      { time:"N\/A", item:"Public comment on agenda items" },
      { time:"N\/A", item:"Consideration of minutes from March 10, 2026 meeting" },
      { time:"N\/A", item:"Approving Alleged Claim for Recovery of Unlawful Tax for Green Acres at Greenwood Hills, LLC - Outlot 1" },
      { time:"N\/A", item:"Approving consent to transfer title to buildings at 939 Woods Place" },
    ...
    discussions: [
      { item:"Unlawful Tax Claim - Green Acres at Greenwood Hills", body:"The committee will consider approving an alleged claim for recovery of unlawful tax related to Outlot 1 of the Green Acres at Greenwood Hills, LLC property." },
      { item:"939 Woods Place Property Matters", body:"Multiple related items involving the transfer of building title and waiver of first right of refusal, termination of an existing airport ground lease with Wynn O. Jones, and approval of a new lease with Owen Jones for the same property." },
      { item:"Airport Ground Lease - Cole Lundberg", body:"The committee will consider approving a new airport ground lease agreement with Cole Lundberg." },
      { item:"National Opioid Settlement Agreement", body:"The committee will consider the city's participation in the Six Remnant Defendants National Opioid Settlement Agreement, which would provide funds related to opioid litigation." },
      { item:"Water Works Budget Amendment", body:"A budget amendment is proposed for the Wausau Water Works 2025 Lead Service Line Replacement project to cover costs not funded by the WDNR subsidized loan." },
      { item:"2025-2026 Fund Carryover", body:"The committee will consider approving a budget amendment to carry over funds from fiscal year 2025 to 2026." },
      { item:"Motor Pool Fund Review", body:"The committee will review the 2025 Motor Pool Fund financial results and consider a related budget amendment." },
      { item:"2026 General Obligation Promissory Note", body:"The committee will consider approving a 2026 General Obligation Promissory Note for capital improvements projects." },
      { item:"2025 General Fund Financial Results", body:"The committee will review the city's 2025 General Fund financial performance." },
      { item:"DPW Property Acquisition", body:"The committee will consider purchasing four properties on Adolph Street and Myron Street to expand land holdings for the Department of Public Works Streets Division. Related closed session will address competitive negotiation aspects." },
    ],
    publicComment: "Public comment on agenda items is listed as the first item on the agenda, with reading of the City of Wausau Public Comment Statement.",
    actionItems: [
      "Vote on unlawful tax claim for Green Acres at Greenwood Hills, LLC",
      ...
      "Vote on participating in Six Remnant Defendants National Opioid Settlement Agreement",
      "Vote on budget amendment for Water Works Lead Service Line Replacement project",
      ...
      "Vote on purchasing properties at 108, 112, 112-1\/2 Adolph Street and 233 Myron Street",
    ],
    civicItems: [
      { number:"1", name:"Public comment on agenda items and reading of the City of Wausau Public Comment Statement.", votes:[], docs:[], children:[] },
  ...
  },
  {
    ...
    isAgendaOnly: false,
    badge: "new",
    overview: "The Wausau Common Council meeting agenda includes presentations recognizing city workers and a sustainability award, multiple ordinances and resolutions covering solid waste services, parking agreements, airport obstruction removals, and a police department budget modification. The meeting also includes a closed session regarding litigation strategy for a pending lawsuit. This summary is based on the agenda, not a transcript.",
    agenda: [
      ...
      { time:"N\/A", item:"Consent Agenda - Ordinance 26-0308 Amending Section 9.20.070 Fires, Fireworks, Firearms, Missiles" },
      { time:"N\/A", item:"Consent Agenda - Resolution 92-0623 Approving Renewal of Parking Lot Lease with Colonial Property 4, LLC" },
      ...
      { time:"N\/A", item:"Resolution 25-1109A Adopting 2026 Budget Modification for Police Department Red-Dot Optics Purchase" },
      { time:"N\/A", item:"Joint Resolution 25-1011 Approving Development Agreement for Waterside Place at 11 Scott Street" },
    ...
    discussions: [
      { item:"Mayoral Citation - Public Works Plow Crews", body:"Recognition of exemplary service by the City of Wausau Department of Public Works plow crews and support team, likely for winter snow removal efforts." },
      { item:"Sustainability Award to Kolbe & Kolbe Millwork Co., Inc.", body:"The Sustainability, Energy, & Environment Committee is presenting an award to Kolbe & Kolbe Millwork Co., Inc. for environmental or sustainability achievements." },
      { item:"Ordinance 26-0308 - Fires, Fireworks, Firearms, Missiles", body:"An ordinance from the Parks & Recreation Committee proposing amendments to Section 9.20.070 of the municipal code regarding regulations on fires, fireworks, firearms, and missiles in city areas." },
      { item:"Resolution 92-1009 - Solid Waste and Recycling Service Agreement", body:"The Finance Committee recommends approving a residential solid waste and recycling service agreement with Harter's Fox Valley Disposal LLC to provide waste collection services to city residents." },
      { item:"Resolutions 26-0203 and 26-0204 - Airspace Obstruction Removal Agreements", body:"Two resolutions from the Finance Committee to approve agreements for removing airspace obstructions at properties on Ridgeland Avenue in Schofield, with related budget modifications, likely related to airport safety requirements." },
      { item:"Resolution 25-1109A - Police Department Budget Modification", body:"A resolution to modify the 2026 budget allowing the Wausau Police Department to use proceeds from the sale of a Thompson Sub-Machinegun to purchase red-dot optics for department firearms." },
      { item:"Resolution 25-1011 - Waterside Place Development Agreement", body:"A joint resolution from Economic Development and Infrastructure & Facilities Committees approving a development agreement and amended parking agreement with 11 Scott Street, LLC for the Waterside Place development project." },
      { item:"Ordinance 90-1136 - Solid Waste Disposal Code Update", body:"An ordinance from the Public Health & Safety Committee to repeal and recreate Chapter 6.44 of the Municipal Code regarding solid waste disposal regulations, requiring suspension of normal procedural rules." },
      { item:"Resolution 26-0307 - Settlement of Hoelzel Litigation", body:"A resolution to approve release of all claims for property damage settlement related to a counterclaim and third party complaint in David Hoelzel v. City of Wausau litigation." },
      { item:"Resolutions 26-0309 and 26-0310 - Police and Shelter Operations Personnel", body:"Two joint resolutions from Human Resources and Finance Committees addressing paid duty time for out-of-country police training and establishing a premium differential for community outreach professionals in shelter operations." },
    ],
    publicComment: "Public comment is on the agenda with preregistered citizen comments before business items and additional public comment both before and after the business meeting.",
    actionItems: [
      "Vote on confirming mayoral appointments to Plan Commission, Affordable Housing Task Force, and BID Board",
      "Vote on residential solid waste and recycling service agreement with Harter's Fox Valley Disposal LLC",
      "Vote on airspace obstruction removal agreements and related budget modifications",
      ...
      "Vote on settlement release in Hoelzel v. City of Wausau litigation",
  ...
  },
  {
    ...
    isAgendaOnly: true,
    badge: "new",
    overview: "The Wausau School District Board of Education Audit of the Bills Committee convened to review and approve district expenditures for the November billing cycle. This routine financial oversight meeting ensures proper review of district payments and fiscal accountability.",
    agenda: [
    ...
    discussions: [
      { item:"Audit of the Bills", body:"Committee members reviewed the November 2025 audit of bills document, which details district expenditures requiring approval. The attachment dated November 18, 2025 contains the itemized list of payments for committee examination and verification." },
    ],
  ...
  },
  {
    ...
    isAgendaOnly: true,
    badge: "new",
    overview: "The Wausau School District Education\/Operations Committee meeting addressed 4K program partnerships for 2026-2027, presented an annual safety update including drill debriefs, and reviewed extensive policy updates through Neola. The meeting also featured an Excellence in Action presentation highlighting John Marshall Elementary.",
    agenda: [
      { time:"0:00", item:"Call to Order" },
    ...
    discussions: [
      { item:"4K Program Agreement", body:"The district's four-year-old kindergarten program sought approval for 2026-2027 program agreements with community collaboration sites including Wausau Child Care, Mountain View Montessori, Woodson YMCA Wausau Branch, Newman Catholic Schools, and Marathon County Child Development Agency Head Start Program. These partnerships have been in place since 2002 and were presented by 4K Principal Kara Rakowski and Director of Elementary Education Julie Schell." },
      { item:"Annual Safety Update \/ Drill Debrief", body:"The district presented its comprehensive safety program using the I Love U Guys Standard Response Protocol with standardized vocabulary (HOLD, SECURE, LOCKDOWN, EVACUATE, SHELTER) for consistent responses across the educational community. Security highlights include secure building entrances, Visitor Aware System, security cameras, locked exterior doors, and recent district-wide LOCKDOWN and EVACUATION drills conducted in partnership with Wausau Police Department and School Resource Officers." },
      { item:"Neola Policies Update", body:"The committee reviewed proposed changes to 43 attached policies covering a wide range of topics including board member conduct, student entrance age, third grade promotion and retention, academic honesty, student drug use policies, drone use, school safety, food service, wellness, and visitor policies. The update included both Volume 34 Number 2 policy changes and technical corrections to existing policies." },
    ],
    publicComment: "A public and student comment period was included on the agenda.",
    actionItems: [
      "Approve 4K Program Agreements with community partner sites for 2026-2027 school year",
  ...
  },
  {
    ...
    isAgendaOnly: true,
    badge: "new",
    overview: "This special meeting of the Wausau School District Board of Education focused on closed session discussions regarding real estate negotiations and the superintendent's evaluation. The board planned to reconvene in open session to potentially take action on matters discussed privately.",
    agenda: [
      { time:"0:00", item:"Call to Order" },
    ...
    discussions: [
      { item:"Discussion regarding the Competitive Negotiations of a Purchase\/Sale of Real Estate", body:"The board entered closed session under Wisconsin Statute 19.85(1)(e) to discuss competitive negotiations related to the purchase or sale of real estate. This closed session protects the district's negotiating position on property transactions." },
      { item:"Evaluation of Superintendent of Schools", body:"The board conducted a closed session evaluation of the Superintendent of Schools under Wisconsin Statute 19.85(1)(c). This statute allows for private discussion of employee performance evaluations." },
      { item:"Reconvene in Open Session", body:"Following closed session discussions, the board planned to reconvene publicly and potentially take formal action on matters discussed regarding real estate negotiations or the superintendent evaluation." },
    ],
    publicComment: "No public comment period was included on this agenda.",
    actionItems: [
  ...
  },
  {
    ...
    isAgendaOnly: true,
    badge: "new",
    overview: "The Wausau School District Board of Education held a regular meeting covering referendum construction updates for four elementary schools, a charter school status report, policy updates, and routine consent agenda items including personnel changes and bill payments. Key action items included approval of a resolution of commendation for Rob Hughes and 4K program agreements with community partners for the 2026-2027 school year.",
    agenda: [
      { time:"0:00", item:"Call to Order" },
    ...
    discussions: [
      ...
      { item:"Neola Policies Update", body:"At the November Education\/Operations Committee meeting, proposed changes to 43 attached policies were reviewed. The policy updates covered a wide range of topics including board member conduct, student supervision, academic honesty, drug policies, drones, school safety, food service, and wellness programs." },
    ],
    publicComment: "A public and student comment period was included on the agenda.",
    actionItems: [
      ...
      "Approve Red Granite Charter School Update",
  ...
  },
  {
    ...
    isAgendaOnly: true,
    badge: "new",
    overview: "The Wausau School District Board of Education's Audit of the Bills Committee met to review and approve the district's bills for December 2025. This routine financial oversight meeting ensures proper expenditure of district funds.",
    agenda: [
      { time:"0:00", item:"Call to Order" },
      { time:"0:02", item:"Audit of the Bills" },
      { time:"0:07", item:"Adjourn" },
    ...
    discussions: [
      { item:"Audit of the Bills", body:"Committee members reviewed the December 2025 bills for the district, as documented in the attached AuditofbillsDecember25 file dated 12\/9\/2025. This financial review ensures all district expenditures are properly documented and authorized before payment." },
    ],
    publicComment: "No public comment period was included on this agenda.",
    actionItems: [
      "Approve December 2025 audit of bills",
    ],
  },
  {
    ...
    isAgendaOnly: true,
    badge: "new",
    overview: "This special meeting of the Wausau School District Board of Education primarily focused on closed session matters including administrator contracts, staff employment discussions, and real estate negotiations. The meeting also included a public recognition of Ellie Mason through a Resolution of Commendation.",
    agenda: [
      { time:"0:00", item:"Call to Order" },
      { time:"0:02", item:"Request for Closed Session Pursuant to State Statutes" },
    ...
    discussions: [
      { item:"Approve Administrator Contracts and Discuss Performance and Employment of a Staff Member", body:"The board entered closed session under Wisconsin statute 19.85(1)(c) to discuss administrator contracts and matters related to the performance and employment of staff members. This statutory provision allows boards to meet privately when discussing personnel matters." },
      { item:"Discussion regarding the Competitive Negotiations of a Purchase\/Sale of Real Estate", body:"The board discussed competitive negotiations related to the purchase or sale of real estate in closed session under Wisconsin statute 19.85(1)(e). This provision permits closed sessions when public knowledge of negotiations could harm the district's bargaining position." },
      { item:"Resolution of Commendation: Ellie Mason", body:"The board considered a Resolution of Commendation recognizing Ellie Mason for her contributions or achievements. The resolution documentation was attached to the agenda packet dated December 12, 2025." },
    ],
    publicComment: "No public comment period was included on this agenda.",
    actionItems: [
      "Approve administrator contracts",
      "Take action on staff member employment matters if necessary",
      "Take action on real estate negotiations if necessary",
  ...
  },
  {
    ...
    isAgendaOnly: true,
    badge: "new",
    overview: "The Education\/Operations Committee meeting addressed open enrollment space determinations for the 2026-2027 school year, snow day communication procedures, and several athletic co-op renewals for hockey and lacrosse programs. The meeting also featured a performance by John Muir Middle School students and highlighted the school's accomplishments.",
    agenda: [
      { time:"0:00", item:"Call to Order" },
    ...
    discussions: [
      ...
      { item:"Approve Co-Ops", body:"Athletic Directors BJ Brandt and Darci Mick Beversdorf presented information on several athletic co-op renewals for the 2026-27 and 2027-28 school years. The renewals include boys hockey with East\/Merrill\/Newman Catholic, girls lacrosse with East\/West\/DCE\/Mosinee, and girls STORM hockey with East\/West\/DCE\/Mosinee adding Merrill and Stratford." },
    ],
    publicComment: "A public and student comment period was included on the agenda.",
    actionItems: [
      "Approve Open Enrollment Space Determinations for 2026-2027",
      "Approve Co-Op renewals for boys hockey East\/Merrill\/Newman Catholic for 26-27 and 27-28 school years",
  ...
  },
  {
    ...
    isAgendaOnly: true,
    badge: "new",
    overview: "This special meeting of the Wausau School District Board of Education focused primarily on personnel matters, including routine staffing changes and two separate closed sessions. The closed sessions addressed employee termination proceedings with a quasi-judicial hearing and administrator contract approvals.",
    agenda: [
      { time:"0:00", item:"Call to Order" },
      { time:"0:02", item:"Approve Consent Agenda (Action Requested)" },
      { time:"0:05", item:"Request for Closed Session - Employee Conduct Hearing and Termination" },
      { time:"0:07", item:"Request for Closed Session - Administrator Contracts and Staff Performance" },
      { time:"0:10", item:"Adjourn" },
    ],
    discussions: [
      { item:"Convene into closed session pursuant to Wis. Stat. 19.85(1)(b)", body:"The board convened in closed session to receive evidence concerning allegations regarding employee conduct and to consider administrative recommendations for the employee's termination from employment. The board deliberated regarding evidence received during the quasi-judicial hearing and may have also considered an employee resignation agreement." },
      { item:"Approve Administrator Contracts and Discuss Performance", body:"The board entered closed session pursuant to Wis. Stat. 19.85(1)(c) to approve administrator contracts and discuss the performance and employment of staff members. The board planned to reconvene in open session to take further action if necessary." },
    ],
    publicComment: "No public comment period was included on this agenda.",
    actionItems: [
      "Approve Consent Agenda including Appointments, Separations, Leaves of Absence, and Retirements",
      "Consider action on employee termination or resignation agreement following closed session deliberation",
  ...
  },
  {
    ...
    isAgendaOnly: true,
    badge: "new",
    overview: "This regular meeting of the Wausau School District Board of Education covers the approval of the 2024-25 audit report, WASB resolutions voting directions, a discussion on replacing the Wausau West chiller system, and several cooperative agreement renewals for athletic programs. The board will also address open enrollment seat availability for 2026-2027 and hold closed sessions regarding potential litigation and superintendent evaluation.",
    agenda: [
      { time:"0:00", item:"Call to Order" },
      { time:"0:02", item:"Roll Call" },
      { time:"0:04", item:"Pledge of Allegiance" },
      ...
      { time:"1:29", item:"Request for Closed Session" },
    ...
    discussions: [
      ...
      { item:"WASB Resolutions", body:"The Board will review the proposed Wisconsin Association of School Boards Resolutions and direct the WASB Delegate on how to vote on behalf of the District. A late addition includes a proposed amendment to the WASB bylaws." },
      ...
      { item:"Wisconsin Investment Series Cooperative Resolution", body:"Assistant Superintendent of Operations Elizabeth Channel is presenting a resolution to allow the District to continue its membership in the Wisconsin Investment Series Cooperative. This updates the authorization which is over ten years old in accordance with best practice." },
      ...
      { item:"Approve Co-Ops", body:"The board will consider renewals for boys hockey East\/Merrill Newman Catholic co-op, girls lacrosse East\/West\/DCE\/Mosinee co-op, and girls STORM hockey co-op with the addition of Merrill and Stratford, all for the 2026-27 and 2027-28 school years." },
      ...
      { item:"Closed Session - Evaluation of Superintendent", body:"The board will conduct an evaluation of the Superintendent of Schools pursuant to State Statute 19.85(1)(c)." },
    ],
    publicComment: "Public and Student Comment period is included on the agenda as item V.",
    actionItems: [
      "Approve Consent Agenda including appointments, separations, leaves of absence, retirements, meeting minutes, payment of bills, and donations",
      "Approve the 2024-25 Audit Report",
      "Direct WASB Delegate on how to vote on proposed resolutions",
  ...
  },
  {
    ...
    isAgendaOnly: true,
    badge: "new",
    overview: "The Audit of the Bills Committee met to review and approve the district's financial expenditures for the period covered in the January 26, 2026 audit report. This routine financial oversight meeting ensures proper review of Wausau School District spending before payments are processed.",
    agenda: [
      { time:"0:00", item:"Call to Order" },
      { time:"0:02", item:"Audit of the Bills" },
      { time:"0:07", item:"Adjourn" },
    ...
    discussions: [
      { item:"Audit of the Bills", body:"Committee members reviewed the district's bills and expenditures as documented in the January 26 audit attachment prepared on January 22, 2026. This standard financial review process allows board members to examine and verify district spending before authorizing payments." },
    ],
    publicComment: "No public comment period was included on this agenda.",
    actionItems: [
  ...
  },
  {
    ...
    isAgendaOnly: true,
    badge: "new",
    overview: "The Wausau School District Education\/Operations Committee meeting focused on advancing referendum-related construction projects with 95% design approval for four elementary schools, reviewing quarterly legal expenses, and discussing the 2026-2027 school calendar. The meeting also addressed financial planning assumptions, student demographics, and potential governance model changes.",
    agenda: [
      { time:"0:00", item:"Call to Order" },
      { time:"0:02", item:"Approve the Minutes" },
      ...
      { time:"0:24", item:"Franklin, Rib Mountain, Lincoln & John Marshall 95% Design (Action Requested)" },
      { time:"0:34", item:"Legal Expenses for 2nd Quarter of 2025-2026" },
      { time:"0:39", item:"Approve 2026-2027 District Calendar (Action Requested)" },
      { time:"0:44", item:"Presentation of Financial Projection Model Assumptions" },
      { time:"0:59", item:"2025-2026 Student Demographic Report" },
      { time:"1:09", item:"Governance Model Option (Possible Action)" },
      { time:"1:19", item:"ADJOURN" },
    ],
    discussions: [
      ...
      { item:"Legal Expenses for 2nd Quarter of 2025-2026", body:"Interim Assistant Superintendent Elizabeth Channel presented a summary report of all legal counsel expenses incurred during the second quarter. The report was broken down by law firm and type of legal advice sought, requiring no action." },
    ...
    actionItems: [
      ...
      "Possible action on governance model changes regarding committee structure",
    ],
  },
  {
    ...
    isAgendaOnly: true,
    badge: "new",
    overview: "This special meeting of the Wausau School District Board of Education focused on approving routine personnel matters through the consent agenda, finalizing the 2026-2027 district calendar, and conducting a closed session evaluation of the Superintendent of Schools. The meeting addressed administrative functions essential to district operations.",
    agenda: [
      { time:"0:00", item:"Call to Order" },
    ...
    discussions: [
      { item:"Approve 2026-2027 District Calendar", body:"Diana White previously presented a draft of the 2026-2027 school year calendar at a prior meeting for School Board review. The board was asked to take action to formally approve the calendar for the upcoming academic year." },
      { item:"Evaluation of Superintendent of Schools", body:"The board entered closed session under Wisconsin statute s. 19.85 (1)(c) to conduct an evaluation of the Superintendent of Schools. This is a personnel matter that requires confidential discussion as permitted by state law." },
    ],
    publicComment: "No public comment period was included on this agenda.",
    actionItems: [
      "Approve Consent Agenda including appointments, separations, leaves of absence, and retirements",
  ...
  },
  {
    ...
    isAgendaOnly: true,
    badge: "new",
    overview: "This Wausau School District Board of Education regular meeting addressed referendum-related school design approvals, a chiller system replacement at Wausau West, and updates on the Wausau East hockey program following the disbandment of a co-op arrangement. The board also considered governance model changes and received reports on demographics, legal expenses, and financial projections.",
    agenda: [
      { time:"0:00", item:"Call to Order" },
      { time:"0:02", item:"Roll Call" },
      { time:"0:04", item:"Pledge of Allegiance" },
      ...
      { time:"0:35", item:"Approve Consent Agenda" },
      { time:"0:40", item:"Old\/Recurring Business - Education\/Operations Committee Meeting" },
      { time:"0:42", item:"Franklin, Rib Mountain, Lincoln & John Marshall 95% Design" },
      { time:"0:44", item:"Legal Expenses for 2nd Quarter of 2025-2026" },
      { time:"0:46", item:"2025-2026 Student Demographic Report" },
      { time:"0:48", item:"New Business - Wausau West Chiller System" },
      { time:"0:58", item:"Wausau East Hockey Update" },
      { time:"1:13", item:"Presentation of Financial Projection Model Assumptions" },
      { time:"1:15", item:"Governance Model Option" },
      { time:"1:17", item:"Open Forum" },
      { time:"1:27", item:"Request for Closed Session - Competitive Negotiations of Purchase\/Sale of Real Estate" },
      { time:"1:37", item:"Reconvene in Open Session" },
    ...
    discussions: [
      ...
      { item:"Legal Expenses for 2nd Quarter of 2025-2026", body:"Interim Assistant Superintendent Elizabeth Channel presented a summary report of all legal counsel expenses incurred during the second quarter of 2025-2026. The report was broken down by law firm and type of legal advice sought as an informational item requiring no action." },
      { item:"2025-2026 Student Demographic Report", body:"Director of Technology Ralph Williams presented the Demographics Report for the 2025-2026 school year to the Education\/Operations Committee. This informational report was shared with the full Board." },
      { item:"Wausau West Chiller System", body:"Interim Assistant Superintendent Elizabeth Channel and Director of Buildings and Grounds Ryan Urmanski presented a request to approve the bid for replacement of the chiller system at Wausau West High School. The presentation was estimated to take 10 minutes." },
      { item:"Wausau East Hockey Update", body:"An informational presentation addressed the disbandment of the East\/Merrill Boys Hockey Co-Op and potential options for the district, Wausau East, and East Hockey players. This 15-minute presentation explored future pathways for the hockey program." },
      ...
      { item:"Governance Model Option", body:"The Board discussed potentially changing the Audit of the Bills Committee and clarifying the purpose of the Education\/Operations Committee with a potential rename. Board procedures documentation was attached for consideration." },
    ],
  ...
  },
  {
    ...
    discussions: [
      ...
      { item:"Preliminary Discussion Regarding Potential Litigation", body:"The board planned to enter closed session under Wisconsin Statute 19.85(g) to discuss preliminary matters regarding potential litigation facing the district. The board would reconvene in open session afterward to take further action if necessary and appropriate." },
    ],
    publicComment: "No public comment period was included on this agenda.",
    actionItems: [
      "Approve Consent Agenda including appointments, separations, leaves of absence, and retirements",
      "Vote to enter closed session for potential litigation discussion",
      "Take action if necessary following closed session discussion on potential litigation",
    ],
  },
  {
    ...
    isAgendaOnly: true,
    badge: "new",
    overview: "The Wausau School District Board of Education Committee of the Whole meeting covered fiscal planning with a five-year forecast, AGR school mid-year progress reports, and an extensive policy update through NEOLA. The meeting also included recognition segments for the district planetarium and Wausau West High School, with a facility tour scheduled after adjournment.",
    agenda: [
      { time:"0:00", item:"Call to Order" },
      { time:"0:02", item:"Approve the Minutes" },
    ...
    discussions: [
      { item:"Five Year Fiscal Forecast", body:"The Board will receive a five-year fiscal forecast model to aid in constructing the 2026-27 budget reconciliation plan. Administration emphasized that projections are based on many variables that change periodically, and significant changes will be communicated to the Board as they occur." },
      { item:"AGR Annual Report", body:"This mid-year update presents AGR student outcome scores required by DPI, including screening results from the district's three AGR schools. The report highlights systemic improvements and evolving practices designed to strengthen organizational systems and improve student achievement." },
      { item:"NEOLA UPDATE", body:"The Committee will review proposed changes to numerous district policies, ranging from technical corrections to more substantive updates. Policy areas include definitions, board member conduct, student supervision, reading instruction goals, cell phone usage, academic honesty, homeless students, fund balance, purchasing, and school support organization policies." },
      { item:"Referendum Budget Update", body:"Administration will provide a routine update on the April 2022 referendum-funded facility improvements. Construction and budget updates will continue to be presented until all projects are completed." },
    ],
    publicComment: "A Public and Student Comment period was included on the agenda.",
    actionItems: [
      "Approve the Minutes",
      "Approve Audit of the Bills",
      "Approve NEOLA Policy Updates including policies on definitions, board member behavior, student supervision, reading instruction, cell phones, homeless students, academic honesty, fund balance, purchasing, and school support organizations",
    ],
  },
  {
    ...
    isAgendaOnly: true,
    badge: "new",
    overview: "This special meeting of the Wausau School District Board of Education was convened to conduct a student expulsion hearing in closed session. The board met pursuant to Wisconsin Statutes to deliberate on the matter privately and potentially take action regarding the expulsion.",
    agenda: [
      { time:"0:00", item:"Call To Order" },
    ...
    discussions: [
      { item:"Closed Session - Pupil Expulsion Hearing", body:"The Board convened in closed session pursuant to Wisconsin Statutes to hold a pupil expulsion hearing. The Board was authorized to deliberate privately at the conclusion of the hearing and take action in closed session if necessary. Following closed session, the Board could reconvene in open session and take further action if appropriate." },
    ],
    publicComment: "No public comment period was included on this agenda.",
    actionItems: [
  ...
  },
  {
    ...
    isAgendaOnly: true,
    badge: "new",
    overview: "This meeting featured a reunion of the Elementary Task Force to reflect on the elementary school consolidation process one year later. Task force members shared their reflections on the consolidation, though no official Board action was taken at this informational session.",
    agenda: [
    ...
    discussions: [
      { item:"Summary of Elementary Consolidation", body:"This item provided an overview of the elementary school consolidation that was implemented in the Wausau School District. The summary likely covered the process, decisions made, and outcomes of consolidating elementary schools." },
      { item:"Task Force Member Reflectives: One Year Later", body:"Task force members who participated in the elementary consolidation planning process shared their reflections one year after implementation. This provided an opportunity to assess how the consolidation has worked and gather perspectives from those involved in the original decision-making." },
    ],
    publicComment: "No public comment period was included on this agenda.",
    actionItems: [
  ...
  },
  {
    ...
    isAgendaOnly: true,
    badge: "new",
    overview: "This meeting was a WEA-sponsored candidate meet and greet event for Wausau School District Board of Education candidates. While a quorum of board members may have been present, no official board action was taken at this event.",
    agenda: [
      { time:"0:00", item:"WEA Sponsored WSD School Board Candidates Meet & Greet Event" },
    ],
    discussions: [
      { item:"WEA Sponsored WSD School Board Candidates Meet & Greet Event", body:"The Wausau Education Association sponsored an event for school board candidates to meet with the public. A quorum of current Board of Education members may have attended, but the agenda explicitly noted that no board action would be taken at this event." },
    ],
    publicComment: "No public comment period was included on this agenda.",
    actionItems: [
  ...
  },
  {
    ...
    isAgendaOnly: true,
    badge: "new",
    overview: "This regular meeting of the Wausau School District Board of Education covers routine consent agenda items including personnel matters and bill payments, along with substantive discussions on switching middle school devices from Chromebooks to iPads and reviewing the district's five-year fiscal forecast. The board will also receive updates on the 2022 referendum-funded construction projects and Achievement Gap Reduction (AGR) program outcomes.",
    agenda: [
      { time:"0:00", item:"Call to Order" },
      { time:"0:02", item:"Roll Call" },
      { time:"0:04", item:"Pledge of Allegiance" },
    ...
    discussions: [
      { item:"Referendum Budget Update", body:"As the April 2022 referendum-funded facility improvements continue to develop, the construction and budget updates are routinely presented until projects are completed. The presentation was previously shared at the February Committee of the Whole Meeting with an estimated 2-minute presentation time." },
      { item:"iPads Presentation", body:"The board will receive a 20-minute presentation on switching one-to-one devices at the middle school from Chromebooks to iPads. This item requires board action on the proposed technology transition for middle school students." },
      { item:"Five Year Fiscal Forecast", body:"The district's five-year fiscal forecast model will be discussed, which was first presented at the February Committee of the Whole meeting. The projection model will be used over the next three months to construct the 2026-27 budget reconciliation plan, with administration noting that projections are subject to change based on multiple variables." },
      { item:"AGR Annual Report", body:"The board will review mid-year Achievement Gap Reduction student outcome scores required by DPI. The report features screening results and highlights work being done at the three AGR schools to strengthen organizational systems and improve student achievement." },
    ],
    publicComment: "A public and student comment period is included on the agenda as item VI.",
    actionItems: [
      "Approve Consent Agenda including appointments, separations, leaves of absence, retirements, minutes, payment of bills, CESA 9 Shared Services Contract, and donations",
      "iPads Presentation - Action on middle school device transition from Chromebooks to iPads",
    ],
  },
  {
    ...
    isAgendaOnly: true,
    badge: "new",
    overview: "The Wausau School District Board of Education Committee of the Whole meeting addressed operational matters including nutrition cooperative membership, facility fee amendments for artificial fields, and a referendum budget update. The meeting featured an extensive review of NEOLA policy updates covering over 60 district policies including new AI guidelines and Act 57 compliance changes.",
    agenda: [
      { time:"0:00", item:"Call to Order" },
      { time:"0:02", item:"Approve the Minutes" },
      { time:"0:05", item:"Audit of the Bills" },
    ...
    discussions: [
      ...
      { item:"NEOLA UPDATE", body:"The committee reviewed proposed changes to numerous district policies ranging from technical corrections to substantive updates. Key policy areas include board member conduct, reading instruction goals, cell phones, academic honesty, student fees, artificial intelligence use, and Act 57 related policies on child abuse and neglect reporting." },
    ],
    publicComment: "No public comment period was included on this agenda.",
    actionItems: [
      ...
      "Approve NEOLA policy updates including definitions, board member conduct, reading instruction, cell phones, academic honesty, AI guidelines, and Act 57 compliance policies",
