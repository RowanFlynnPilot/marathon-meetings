...
const MEETINGS = [
  {
    ...
    date: "May 7, 2026", shortDate: "MAY 7",
    ...
    isAgendaOnly: false,
    badge: "new",
    overview: "The Marathon County Health & Human Services Committee held an educational orientation meeting for new and returning board members. The committee approved April 1st meeting minutes unanimously and received presentations from department heads covering the Health Department, Social Services, Veteran Services, and the Aging Disability Resource Center. No major policy decisions were made as this was primarily an informational session to familiarize members with departmental operations and budgets.",
    agenda: [
      { time:"0:00", item:"Call to order and remote attendance confirmation" },
      { time:"0:22", item:"Pledge of Allegiance" },
      { time:"0:56", item:"Approval of April 1st committee meeting minutes" },
      { time:"1:22", item:"Operational functions required by statute - overview of agenda structure" },
      { time:"4:07", item:"Review of standing committee ordinance, missions, duties, and responsibilities" },
      { time:"13:08", item:"Health Department presentation by Health Officer Caitlyn Suginaka" },
      { time:"21:46", item:"Health Department budget overview" },
      { time:"37:59", item:"Social Services Department overview by Administrator Leonard" },
      { time:"47:47", item:"Veteran Service Department presentation by VSO Aaron Galindo" },
      { time:"1:15:00", item:"Aging Disability Resource Center presentation by Executive Director Mike Ray" },
      { time:"1:29:56", item:"Discussion of next meeting date and adjournment" },
    ],
    discussions: [
      ...
      { item:"Health Department Overview", body:"Health Officer Caitlyn Suginaka presented on the department's mission to prevent disease, promote health, and protect the public from environmental hazards. She highlighted the department's 37.6 FTE staff across four divisions: environmental health (managing 1,200+ licenses), nursing\/communicable disease, family health, and community health improvement. She noted new initiatives including public health vending machines stocked with free resources like tick kits, the Nurse Family Partnership program now graduating its first cohort of two-year-olds, and a new homeless system response position approved by the county board last session." },
      { item:"Social Services Department Overview", body:"Administrator Leonard provided an overview in the absence of Director Christa. He explained the department's divisions including child welfare, child protective services, youth justice, children's long-term support, economic support, and child support. With nearly 140 FTE, it's the county's second-largest department. Leonard highlighted the successful Family Keys pilot program addressing housing instability for families involved with child welfare and youth justice, noting the program has helped families who had never had bank accounts, credit, or formal leases. He indicated potential restructuring requests may come during budget season." },
      { item:"Veteran Service Department Overview", body:"VSO Aaron Galindo presented on his department of 3.0 FTE that had 8,149 interactions in 2025, up significantly from 5,900 the prior year. He reported $44 million in annual VA benefits flowing to county veterans, plus $2.6 million in retroactive payments in 2025. Galindo highlighted initiatives including housing stability partnerships with Center for Veterans Issues, suicide prevention efforts (noting 7 of Marathon County's 30 suicides in 2025 were veterans), and education efforts with hospice and medical examiner's office on proper death certificate documentation for surviving spouse benefits." },
      { item:"Aging Disability Resource Center Overview", body:"Executive Director Mike Ray presented on the four-county ADRC serving Marathon, Lincoln, Langlade, and Wood counties with about 60 FTE and 385-400 volunteers. He explained their role as the one-stop shop for aging and disability services, including Meals on Wheels. Ray noted significant financial challenges with federal funding flat since 2024 while nutrition costs rose 40-45%, forcing reductions in meals served and staffing. The organization hadn't requested a levy increase from 2011 until 2024. Marathon County's contribution is $413,135." },
    ],
    ...
    actionItems: [
      ...
      "Chair Boots will bring strategic plan information to upcoming meetings for committee discussion",
      "Health Officer Suginaka to follow up on exact locations of public health vending machines",
  ...
  },
  {
    ...
    agenda: [
      ...
      { time:"22:00", item:"Resolution 26-26: Landfill tipping fee modification for storm debris" },
      { time:"1:10:02", item:"Announcements and adjournment" },
    ],
    discussions: [
      { item:"Committee Appointments", body:"Chair Gibbs presented committee appointments developed with Vice Chair Boots, emphasizing goals of increasing diversity of perspectives, developing new supervisors as leaders, and honoring supervisor preferences. He noted that over 34% of the board is in their first or second term and most supervisors received their first or second choice assignments. The motion by Supervisor Cavelli, seconded by Supervisor Crims, was carried but not unanimously. Supervisor Siebert noted he was marked absent but was not given the option to vote, indicating he would have voted aye." },
      { item:"Election of At-Large Executive Committee Members", body:"Three supervisors were nominated for two at-large executive committee positions: Supervisor Hapa (nominated by Supervisor Mask), Supervisor Leur (nominated by Supervisor Rosenberg), and Supervisor Arstead (nominated by Vice Chair Boots). Supervisor Rosenberg spoke in favor of Supervisor Leur, stating she had seen Leur advocate for the county's smallest children and oldest elders. Paper ballots were distributed and counted. Supervisors Hapa and Arstead were elected to the executive committee." },
      { item:"Consent Agenda", body:"Items C10 through C14A were approved on the consent agenda. Motion by Supervisor Cavelli, seconded by Supervisor Drebeck. The motion carried unanimously." },
      ...
      { item:"Resolution 26-26: Landfill Tipping Fee Modification", body:"Administrator Leonard and Solid Waste Director Hagen Busher presented a proposal to reduce tipping fees for storm debris following severe weather that impacted Ringle and other communities. The standard tipping fee of $65\/ton would be reduced to approximately $36.94\/ton for certified storm debris, with the state waiving $13.10 and Ringle waiving $2.33. Two residents, Jessica Toasty and Matt Haybeck, were granted special permission to address the board, both asking the county to waive fees entirely for affected residents. Director Hagen Busher noted that Brown County and Dane County only dropped the state fee, and warned about FEMA reimbursement issues if fees are fully waived. The board voted unanimously to suspend rules to consider the resolution, then voted unanimously to approve Resolution 26-26. Administrator Leonard indicated ongoing discussions with the community foundation about additional relief options." },
    ],
    publicComment: "Two residents were granted special dispensation to speak on the landfill tipping fee resolution at the request of Supervisor Rosenberg. Jessica Toasty urged the county to waive fees entirely, noting the state, DNR, and Ringle are waiving their fees and that Marathon County had not provided much financial assistance. She mentioned businesses have donated up to $40,000 in cleanup efforts and requested the waiver extend for six months. Matt Haybeck spoke on behalf of residents with homes requiring demolition, noting some insurance adjusters haven't arrived yet and requesting more time for the fee waiver.",
    actionItems: [
      ...
      "Resolution 26-26 approved: Reduced landfill tipping fees for storm debris through June 17, 2025",
      "Administrator Leonard to continue discussions with community foundation regarding additional relief for uninsured costs",
      "Solid waste management board to develop policy on handling similar disaster situations within six months",
      "Supervisor Gao requested notification of future solid waste board meetings",
    ],
  },
  {
    ...
    isAgendaOnly: false,
    badge: "new",
    overview: "The Marathon County Environmental Resources Committee met on May 5, 2026, approving two rezoning petitions unanimously and voting to forward a modified fee waiver resolution for tornado-damaged properties to the full county board. The committee also received educational presentations from the Solid Waste, Parks Recreation and Forestry, and Conservation Planning and Zoning departments.",
    agenda: [
    ...
    discussions: [
      ...
      { item:"Rezoning petition - Tim Veland on behalf of James Offer and David Tract", body:"Garrett Pogle presented the staff report for rezoning from urban residential and general agriculture to rural residential in the Town of Green Valley. The Town Board recommended approval on March 10, 2026. No public testimony was offered. Supervisor Drebeck moved to approve based on findings of fact and town approval, seconded by Supervisor Kurt. Motion carried unanimously." },
      { item:"Rezoning petition - Jeffrey and Cynthia Schmidtz", body:"Staff presented the petition to rezone from conservancy recreation to general agriculture in the Town of McMillan. Supervisor Leur asked about the conservancy nature; Garrett Pogle explained the property contains a home and horse riding stable, and rezoning would make the home a conforming use rather than non-conforming. The Town Board recommended approval on April 20, 2026. No public testimony was offered. Supervisor Sefeld moved to approve, seconded by Supervisor Drew. Motion carried unanimously." },
      { item:"Fee waivers for April 17, 2026 severe weather victims", body:"Director Lori Mskimmons presented a proposal to waive county zoning and POWTS fees for properties damaged by the April 17 tornado affecting the Town of Ringle, Village of Kronenwetter, Town of Easton, and Village of Weston. Significant committee debate ensued. Supervisor Drew questioned where to draw the line for future events. Supervisor Leur asked about budget impacts. Supervisor Drebeck expressed concern about fairness to tornado victims in non-declared disasters. Marilyn Bend asked about mound system costs. Supervisor Drebeck moved to amend the resolution to only waive reconnect fees ($160) and not other zoning or POWTS fees. Supervisor K seconded. The amendment carried. The amended resolution was then approved to forward to the full county board, though the vote was not unanimous." },
      { item:"Solid Waste Department presentation", body:"Director Dave Hagen Busher presented an overview of the department's operations, including the landfill's 45-year history, renewable natural gas partnership with Vidi Energy generating royalties, and significant challenges with leachate treatment due to PFAS regulations requiring on-site treatment by 2032. He noted the department operates with 11 FTEs processing up to 2,000 tons daily." },
      { item:"Parks, Recreation and Forestry presentation", body:"Tom Lovelin, County Forest Administrator, presented on behalf of Director Jamie. The department operates both county and city park systems with 44 full-time and 120 seasonal employees. Nine Mile County Forest generates $3.25 million annually for the local economy from out-of-town visitors. Lovelin announced his retirement effective June 1 after 35 years, with Joe Tucker selected as his successor." },
    ],
    publicComment: "No public comment was offered.",
    actionItems: [
      "Forward amended fee waiver resolution (covering only POWTS reconnect fees) to Marathon County Board of Supervisors",
      "Forward both rezoning petitions to Marathon County Board of Supervisors for final approval",
      "Towns of Green Valley and McMillan should update comprehensive plans to reflect zoning changes if applicable",
      "Solid Waste to reapply for Clean Water Fund grant for leachate treatment facility by October 2026",
      "Schedule summer educational meeting on conservation topics",
    ],
  },
  {
