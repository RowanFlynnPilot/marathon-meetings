...
const MEETINGS = [
  {
    ...
    date: "May 22, 2026", shortDate: "MAY 22",
    committee: "Public Works", duration: "~1h",
    url: "https://www.youtube.com/watch?v=j64Gj2ean2k",
    docUrl: null,
    isAgendaOnly: false,
    badge: "new",
    overview: "The Public Works Committee approved several infrastructure contracts and discussed ongoing road projects, utility operations, and water\/sewer issues. Key actions included awarding a recycled asphalt crushing contract to King Gravel, approving a transportation funding resolution, and authorizing construction service agreements for upcoming road projects.",
    agenda: [
      { time:"0:09", item:"Call to order" },
      { time:"0:30", item:"Pledge of Allegiance" },
      { time:"1:05", item:"Roll call" },
      { time:"1:20", item:"Public comment" },
      { time:"1:30", item:"Approval of April 13, 2026 meeting minutes" },
      { time:"1:45", item:"Acknowledge April 2026 water and sewer permit" },
      { time:"2:00", item:"CIP update" },
      { time:"18:50", item:"Street operation update" },
      { time:"29:45", item:"Utility operating update" },
      { time:"44:00", item:"Review 2025 Water Utility PSC annual report" },
      { time:"49:30", item:"Resolution 2026-014 transportation funding" },
      { time:"53:00", item:"Recycled base course production" },
      { time:"56:30", item:"Sanitary sewer discharge violation discussion" },
    ],
    discussions: [
      { item:"CIP Update", body:"Michael reported the village received a Local Road Improvement Grant for Birch Street reconstruction between Schofield Avenue and Community Center Drive, covering over 50% of the estimated $1.5 million project cost. This 2029 project will likely move to 2028. He noted the village has received over $9 million in grant funding over the past 4-5 years. Discussion also covered Weston Avenue repairs by Integrity Grading and Excavating for road depression issues, and upcoming repairs on Schofield Avenue and Fuller Street for manhole and pavement issues." },
      { item:"Street Operations Update", body:"Staff reported on spring activities including road limit removal, mailbox and sign repairs, curb line sweeping, and hot mix patching. Dewatering operations were conducted near Weston Avenue tributary for about a week due to flooding. Culverts failed on Jones Street requiring replacement. Discussion ensued about potential permanent pump solutions for recurring flooding issues near Crane Meadows area." },
      { item:"Utility Operating Update", body:"Josh reported on water service repairs, well maintenance, and sanitary system issues. Significant clear water infiltration was detected - April showed 37 million gallons pumped into the system but 53-54 million gallons treated at the wastewater plant, indicating approximately 15 million gallons of clear water infiltration. The INI study with In-Pipe Technologies will help identify sources. Kennedy Park Farmers Market received positive feedback with no traffic or parking complaints." },
      { item:"2025 Water Utility PSC Annual Report", body:"Michael presented the annual report showing operating revenues of approximately $3 million and net income of $482,911 for 2025, consistent with 2024's $490,000. Water loss was 6%. The utility value increased to nearly $34 million with $6.7 million in infrastructure placed in service. The utility serves approximately 6,100 customers. Motion to acknowledge passed unanimously." },
      { item:"Resolution 2026-014 Transportation Funding", body:"Michael explained this League of Wisconsin Municipalities sample resolution supports long-term transportation funding solutions at the state level. The village has decreased its public works budget recently and seeks state assistance for recurring operational costs beyond one-time grants. Motion to adopt passed unanimously." },
      { item:"Recycled Base Course Production", body:"Michael presented the recycled asphalt crushing contract, noting King Gravel submitted the low bid at $4.23 per ton for an estimated 30,000 tons ($126,900 total). He demonstrated this practice saves approximately $11 per cubic yard compared to City of Wausau costs, totaling about $130,000 in savings across this year's three projects. Motion to award to King Gravel passed unanimously." },
      { item:"Sanitary Sewer Discharge Violation Discussion", body:"Staff sought guidance on enforcement of violations for residents discharging clear water (primarily sump pumps) into sanitary sewers. Current code allows fines of $100-$1,000 per day. Committee discussed distinguishing between unknowing and willful violations. Motion passed to direct staff to create enforcement language with fines not to exceed $100 per day, with enforcement to begin after the INI study identifies problem areas." },
      { item:"Water and Sewer Connection Agreement - Radkey Avenue", body:"Michael explained a vacant lot at 2230 Radkey Avenue needs temporary water\/sewer connection via long lateral until Radkey Avenue reconstruction. Committee added requirement that reconstruction occur no later than 2029 when the property owner would pay assessment for main extension. Motion passed unanimously with the 2029 deadline addition." },
      { item:"Military Road Construction Agreement", body:"The committee approved an intergovernmental agreement with Village of Rothschild for Military Road construction. Weston's share for water and sanitary sewer work is estimated at $94,860. Steam Construction is the contractor. Motion passed unanimously." },
      { item:"Construction Services Proposals", body:"Michael presented proposals for construction inspection services. For Alderson\/Jelinek roundabout project, MSA was selected at $37,315 (lower than Clark Dietz at $48,910). For Bladel Avenue project, Clark Dietz was recommended at $73,730 despite MSA's lower $70,400 bid because Clark Dietz proposed full-time experienced staff rather than a summer intern. Motion passed unanimously." },
    ],
    ...
    actionItems: [
      ...
      "Direct staff to create sanitary sewer discharge violation enforcement language with fines up to $100\/day",
      "Authorize water\/sewer connection agreement for 2230 Radkey Avenue with reconstruction deadline of 2029",
      "Approve Military Road construction agreement with Rothschild for estimated $94,860",
      "Award Alderson\/Jelinek construction services to MSA and Bladel Avenue construction services to Clark Dietz",
      "Schedule special assessment meeting for Bladel Avenue on May 28, 2026 at 6:00 PM",
      "Staff to provide cost analysis of clear water infiltration impact for future meeting",
      "Look into adding street lighting to Schofield Avenue from Birch Street to Camp Phillips Road in 2030 project",
    ],
  },
  {
    ...
    isAgendaOnly: false,
    badge: "new",
    overview: "The Village of Weston Plan Commission approved a site plan for the new Mountain Bay Metropolitan Police Department and Municipal Court facility at 3600 Community Drive, and adopted a salt storage shed inspection program for wellhead protection districts. Both items passed unanimously.",
    agenda: [
      ...
      { time:"5:30", item:"Site plan review - Mountain Bay Metro Police Department and Municipal Court facility at 3600 Community Center Drive" },
      { time:"20:01", item:"Creation of salt storage shed inspection program for wellhead protection district" },
      { time:"28:00", item:"April 2026 staff approved certified survey map and site plan" },
      { time:"28:30", item:"April 2026 building permit report" },
      { time:"29:00", item:"Planning and development department monthly project update report" },
      { time:"30:00", item:"Commissioner remarks" },
      { time:"31:00", item:"Future agenda items and staff updates" },
      { time:"34:40", item:"Adjournment" },
    ],
    discussions: [
      { item:"Mountain Bay Metro Police Department and Municipal Court facility site plan", body:"Staff presented the site plan for the new police department and municipal court at 3600 Community Center Drive. Jennifer explained the building meets all B2 zoning requirements and was rotated to address challenges with a gas pipeline running through the property. Chief Jeremy explained the building was reoriented to avoid the 36-inch gas pipeline and reduce fill costs, with the parking lot now positioned over the pipeline which is acceptable to the gas company. Discussion covered future expansion possibilities to the north, placement of an alternate storage shed, and landscaping that meets current relaxed code requirements. Motion to recommend approval to the board of trustees with conditions 2-5 passed unanimously." },
      { item:"Salt storage shed inspection program for wellhead protection district", body:"Jennifer presented a program for two annual inspections of salt storage facilities within wellhead protection areas - a warm weather inspection focusing on structural integrity and a winter operational inspection focusing on material handling practices. Staff developed a standardized inspection worksheet similar to DOT standards. Discussion revealed one existing facility near Sternberg has never gone through the wellhead protection conditional use process despite being closest to the village well. Commissioners agreed staff should reach out to that facility. Motion to approve the program with reporting back to both Plan Commission and Public Works committee passed unanimously." },
      { item:"April 2026 meeting minutes", body:"Motion to approve the April 13, 2026 meeting minutes as presented passed unanimously with no discussion." },
      { item:"Planning department monthly update", body:"Jennifer announced the first joint Plan Commission and Village Board steering committee meeting for the comprehensive plan is scheduled for Monday, June 1st at 5:00 p.m. Discussion followed about residential TIF districts and workforce housing, with staff noting Ehlers has prepared a presentation on qualifications that could be shared with commissioners or incorporated into comprehensive plan discussions." },
    ],
    publicComment: "Jim Penson of 5002 Arrow Street, Weston, spoke via remote connection. He asked the commission to exercise common sense regarding landscaping requirements for the police department project, referencing the Green Heck Turner building as an example of excessive landscaping costs to taxpayers. He also requested the commission require annual reporting on salt shed inspections in wellhead protection zones, noting some zoning complaints have gone unresolved for years.",
    actionItems: [
      "Site plan for Mountain Bay Metro Police Department and Municipal Court facility recommended for approval to Board of Trustees with conditions 2-5",
      "Salt storage shed inspection program adopted with twice-annual inspections and reporting to Plan Commission and Public Works committee",
      ...
      "First joint Plan Commission and Village Board steering committee meeting for comprehensive plan scheduled for June 1st at 5:00 p.m.",
  ...
  },
  {
    ...
    isAgendaOnly: false,
    badge: "new",
    overview: "The Marathon County Health & Human Services Committee held an educational meeting to orient new board members on committee structure, jurisdiction, and department operations. No policy votes were taken; the meeting focused on presentations from department heads covering the Health Department, Social Services, Veteran Service Office, and Aging Disability Resource Center.",
    agenda: [
      ...
      { time:"1:30", item:"Discussion of operational functions required by statute" },
      { time:"3:15", item:"Review of standing committee ordinances, missions, duties and jurisdiction" },
      { time:"13:30", item:"Health Department presentation by Health Officer Caitlyn Suginaka" },
      { time:"25:04", item:"Discussion of health department budget and organization" },
      { time:"40:00", item:"Social Services Department overview by Administrator Leonard" },
      { time:"50:01", item:"Veteran Service Office presentation by VSO Erin Galindo" },
    ...
    discussions: [
      { item:"Approval of April 1st meeting minutes", body:"Supervisor Cavelli moved to approve the minutes, seconded by Vice Chair Rosenberg. The motion passed unanimously with no discussion." },
      { item:"Standing committee ordinances and jurisdiction review", body:"Administrator Leonard explained the committee's structure under section 2.04 sub5 of county ordinances. He detailed reporting relationships with Health Department, Social Services, Veteran Service Office, North Central Health Care, and ADRC. He explained the committee will hear from statutory bodies including Social Services Board, Veterans Service Commission, Transportation Coordinating Committee, Board of Health, and North Central Community Action Program. Chair Boots noted the strategic plan development will be a major focus for the coming year." },
      { item:"Health Department presentation", body:"Health Officer Caitlyn Suginaka presented on the department's mission covering food\/water safety, infectious disease prevention, family health programs, and environmental health. She highlighted the Nurse Family Partnership program graduating its first two-year-olds, public health vending machines offering free tick kits and harm reduction supplies, and a new homeless system response position. The department has 37.6 FTE across environmental health, nursing, community health improvement, and administrative teams. Administrator Leonard noted approximately half of the $5 million budget is tax levy with significant intergovernmental grant revenue." },
      { item:"Social Services Department overview", body:"Administrator Leonard covered Social Services in Director Christa's absence. The department has nearly 140 FTE working in child welfare, youth justice, children's long-term support, economic support, and child support. He highlighted the successful Family Keys housing stability pilot program developed with state funding and county board input, which addresses housing instability root causes for families. The department's $22 million budget includes about $7 million in tax levy." },
      { item:"Veteran Service Office presentation", body:"VSO Erin Galindo reported the office increased to 3.0 FTE in 2025 and had 8,149 client interactions, up from 5,900 the previous year. He noted $44 million in annual VA benefits flowing to Marathon County veterans, with $2.6 million in retroactive payments in 2025. Key initiatives include surviving spouse DIC benefits outreach, housing stability through HUD-VASH partnerships, and suicide prevention efforts following 7 veteran suicides among 30 total county suicides in 2025. Supervisor Kremes asked about regional cooperation; Galindo explained state statute requires each county have its own VSO and described good working relationships with neighboring counties using shared VetPro software." },
      { item:"ADRC presentation", body:"Executive Director Mike Ray explained the four-county ADRC (Marathon, Lincoln, Langlade, Wood) provides aging and disability services as a one-stop shop. He described nutrition programs, caregiver support, dementia care specialists, falls prevention, and Medicare\/Medicaid benefit assistance. The organization has about 60 FTE plus 385-400 volunteers. Ray noted severe financial challenges with nutrition program costs up 40-45% in four years while federal Older Americans Act funding remains flat at 2024 levels. Marathon County's levy contribution is $413,135. Vice Chair Rosenberg thanked the program for culturally appropriate meals at the Hmong American Center." },
    ],
    publicComment: "No public comment was offered.",
    actionItems: [
      "Schedule North Central Healthcare for separate full presentation before committee",
      "Next meeting scheduled for Tuesday, June 3rd at 3 PM (corrected from initially stated May 29th)",
      "Committee members should email Chair Boots and Administrator Leonard with future agenda item requests",
      "Chair Boots will bring strategic plan materials to upcoming meetings",
    ],
  },
  {
    ...
    isAgendaOnly: false,
    badge: "new",
    overview: "The Marathon County Board of Supervisors held an adjourned organizational meeting where they approved committee appointments, elected two at-large members to the Executive Committee, and unanimously passed a resolution reducing landfill tipping fees for disaster debris following the recent tornado and flooding. The fee reduction, from $65\/ton to approximately $36.94\/ton for certified disaster debris, was brought directly from the Solid Waste Management Board after severe weather devastated parts of Ringle and other communities.",
    agenda: [
    ...
    discussions: [
      { item:"Committee Appointments", body:"Chair Gibbs delivered remarks emphasizing that appointments were developed with Vice Chair Boots to increase diversity of perspective, ensure leadership development for newer supervisors (34% are in first or second term), and honor supervisor preferences. The motion to approve both county board chair and administrator appointments together was made by Supervisor Cavelli and seconded by Supervisor Crims. The motion carried but was not unanimous. Supervisor Mask noted the system marked him absent but he wished to be recorded as voting aye." },
      { item:"Election of At-Large Executive Committee Members", body:"Three supervisors were nominated: Supervisor Hapa (nominated by Supervisor Mask), Supervisor Leur (nominated by Supervisor Rosenberg), and Supervisor Arstead (nominated by Vice Chair Boots). Supervisor Rosenberg spoke in support of Supervisor Leur, citing her advocacy for the county's youngest and oldest residents. Paper ballots were distributed and supervisors selected two names. Supervisors Hapa and Arstead were elected to the Executive Committee." },
      { item:"Consent Agenda (Items C10-C14A)", body:"Motion by Supervisor Cavelli, seconded by Supervisor Drebeck. The motion carried unanimously with no discussion." },
      { item:"Out of Home Placement Reserve Increase (Resolution 24-26)", body:"Motion by Supervisor Morash, seconded by Supervisor Robinson. The resolution was approved but the vote was not unanimous." },
      { item:"Social Services Budget Amendment (Resolution 25-26)", body:"Motion by Supervisor P, seconded by Supervisor Robinson. The resolution was approved but the vote was not unanimous." },
      { item:"Landfill Tipping Fees Modification (Resolution 26-26)", body:"Administrator Leonard and Director Hagen Busher presented the proposal from the Solid Waste Management Board to reduce tipping fees for disaster debris from $65\/ton to $36.94\/ton for certified storm-related waste. The state waived $13.10 and Ringle Township waived $2.33 of their respective fees. The board suspended rules (unanimous vote) to consider the resolution without standing committee review. Two Ringle residents, Jessica Toasty and Matt Haybeck, were granted special dispensation to speak, requesting the county waive all fees and extend the timeline beyond 60 days. Supervisor Rosenberg, Supervisor Gao, Supervisor Leur, Supervisor Robinson and others asked clarifying questions about costs, timelines, and policy implications. Administrator Leonard noted the county likely won't meet the $670,743 threshold for state disaster aid but expects Ringle will qualify. The resolution passed unanimously." },
    ],
    publicComment: "Two members of the public were granted special dispensation to speak on the landfill tipping fee resolution. Jessica Toasty asked Marathon County to waive all fees entirely for six months, noting the state, DNR, and Ringle Township had waived their portions, and that private businesses had donated up to $40,000 in cleanup efforts. Matt Haybeck spoke on behalf of residents whose homes must be demolished, requesting fee waivers for underinsured homeowners and an extended timeline since many insurance adjusters haven't yet visited affected properties.",
    actionItems: [
      ...
      "Resolution 24-26 approving out of home placement reserve increase adopted",
      "Resolution 25-26 amending social services 2026 budget adopted",
      "Resolution 26-26 reducing landfill tipping fees to $36.94\/ton for certified disaster debris through June 17, 2025 adopted unanimously",
      "Administrator Leonard to explore partnership with Community Foundation for reimbursing unreimbursed insurance costs for individual landowners",
      "Solid Waste Management Board to develop long-term policy on disaster-related fee reductions within six months",
      "Staff to continue tracking certified disaster debris and coordinate with Ringle Township on fee waivers",
    ],
  },
  {
    ...
    isAgendaOnly: false,
    badge: "new",
    overview: "The Marathon County Environmental Resources Committee approved two rezoning petitions and voted to forward a modified fee waiver resolution to the county board that would only cover reconnect fees for properties impacted by the April 17, 2026 tornado. The committee also received department overviews from Solid Waste, Parks Recreation and Forestry, and Conservation Planning and Zoning.",
    agenda: [
      { time:"0:00", item:"Call to order and Pledge of Allegiance" },
      { time:"0:45", item:"Public comment" },
      { time:"0:55", item:"Approval of March 31st, 2026 committee minutes" },
      { time:"1:15", item:"Public hearing - Rezoning petition for James Offer and David Tract (Urban Residential\/General Agriculture to Rural Residential, Town of Green Valley)" },
      { time:"13:45", item:"Public hearing - Rezoning petition for Jeffrey and Cynthia Schmidtz (Conservancy Recreation to General Agriculture, Town of McMillan)" },
      ...
      { time:"1:19:50", item:"Educational presentation - Parks, Recreation and Forestry Department overview" },
      { time:"1:35:02", item:"Educational presentation - Conservation Planning and Zoning Department overview" },
    ],
    discussions: [
      { item:"Approval of March 31st, 2026 committee minutes", body:"Supervisor Sefeld made a motion to approve the minutes with Supervisor Drebeck seconding. The motion carried with no opposition on a voice vote." },
      { item:"Rezoning petition for James Offer and David Tract", body:"Land Use Specialist Garrett Pogle presented the staff report for rezoning from Urban Residential and General Agriculture to Rural Residential in the Town of Green Valley. The Town Board recommended approval on March 10, 2026. No public testimony was offered. Supervisor Drebeck moved to approve based on findings of fact and the town's approval, seconded by Supervisor Kurt. Motion carried unanimously." },
      { item:"Rezoning petition for Jeffrey and Cynthia Schmidtz", body:"Garrett Pogle presented the petition to rezone from Conservancy Recreation to General Agriculture in the Town of McMillan. Supervisor Leur asked about the conservancy designation, and Pogle explained the property has a home and horse riding stable, and the rezone would make the structures conforming uses. The Town Board recommended approval on April 20, 2026. Supervisor Sefeld moved to approve, seconded by Supervisor Drew. Motion carried unanimously." },
      { item:"Fee waivers for April 17, 2026 severe weather victims", body:"Director Lori Mskimmons presented a proposal to waive county zoning and septic fees for properties damaged by the tornado affecting Ringle, Kronenwetter, Easton, and Weston. Supervisor Drew questioned where to draw the line for future events. Supervisor Drebeck expressed concerns about fairness to others who face disasters without emergency declarations. After discussion, Supervisor Drebeck moved to amend the resolution to only waive reconnect fees ($160) for existing septic systems, not other zoning or new system fees. Supervisor Kurt seconded the amendment. The amendment passed on a voice vote. The amended resolution then passed to forward to the county board, though not unanimously." },
      { item:"Solid Waste Department overview", body:"Director Dave Hagen Busher provided an educational presentation covering landfill operations, the new renewable natural gas partnership with Vidi Energy generating royalties for the county, significant capital expenses including $6 million for cell construction, and upcoming leachate treatment requirements by 2032. He noted lithium-ion battery fires occur about once a week at the facility." },
      { item:"Parks, Recreation and Forestry overview", body:"County Forest Administrator Tom Lovelin presented on behalf of Director Jamie, covering the department's 44 full-time and 120 seasonal employees serving both county and city of Wausau parks. He noted Nine Mile County Forest generates $3.25 million for the local economy from out-of-town visitors. Supervisor Sefeld announced Tom Lovelin is retiring June 1st after nearly 30 years of service, with Joe Tucker selected as his replacement." },
    ],
    publicComment: "No public comment was offered.",
    actionItems: [
      "Rezoning for James Offer and David Tract approved and forwarded to County Board",
      "Rezoning for Jeffrey and Cynthia Schmidtz approved and forwarded to County Board",
      "Modified fee waiver resolution covering only septic reconnect fees forwarded to County Board for consideration",
      "Staff to track costs and requests related to tornado fee waivers for future policy development",
      "New county forest administrator Joe Tucker to replace retiring Tom Lovelin effective June 1st",
    ],
  },
  {
    ...
    isAgendaOnly: false,
    badge: "new",
    overview: "The Village of Weston Community Life and Public Safety Committee approved amendments to Chapter 50 nuisances and recommended an e-bike ordinance that prohibits emotos on roadways, sidewalks, and trails. The committee also approved fire inspection requirements for mobile food vendors and authorized demolition proceedings for an abandoned structure at 4104 Shore Avenue.",
    agenda: [
      ...
      { time:"50:00", item:"Crosswalk request on Alderson Street" },
      { time:"62:00", item:"Mobile food vendors fire inspection requirements" },
      { time:"70:00", item:"Address corrections for E911 compliance" },
    ],
    discussions: [
      { item:"Public Comments", body:"Jim Senalt spoke regarding several agenda items. He criticized the new farmers market location at the park, predicting the grass would be destroyed by summer's end. He questioned the legality of parking on grass in parks, noted ADA accessibility concerns with handicap parking on grass rather than asphalt, and questioned the need for fire inspections on food trucks. He also expressed concern about accountability on long-standing code violations." },
      { item:"Department Reports", body:"Code enforcement reported that 3020 Mountain View Avenue will be removed from the code enforcement roll after the property sale was completed and new owner submitted repair permits. Chief Hunt reported the police department had 2,394 calls in March (77 per day), 410 traffic stops, and 281 citations. The department has hired its 40th officer, with the 38th starting last week, 39th starting in May, and 40th around January. Two SROs work on zoning violations during summer for all three municipalities. Motion to acknowledge reports 5, 6, and 7 passed unanimously." },
      { item:"Chapter 50 Nuisances Amendments", body:"The committee reviewed final amendments including tree limb height requirements over streets and walkways (14 and 10 feet were switched as discussed in previous meeting) and language requiring compliance with jurisdiction authority. Motion by Olsen, seconded by Campkey, to recommend approval to the board of trustees passed unanimously." },
      { item:"E-Bicycle Ordinance", body:"Chief Hunt recommended prohibiting emotos (electric dirt bike-style vehicles) from roadways, sidewalks, and trails, comparing them to unlicensed dirt bikes. Discussion addressed electric scooters used by children, with the committee agreeing to leave officer discretion for those situations. The committee debated definitions and decided to add language specifically prohibiting emotos on roadways, matching the existing prohibition on sidewalks. Motion by Olsen to recommend approval with the emoto prohibition added, seconded by Sherwanka, passed unanimously." },
      { item:"Overnight Parking Regulations", body:"Trustee Tolson presented research showing Weston's 12-hour parking restriction (4 AM to 4 PM) is far outside what other municipalities have (most have 5-hour windows). Chief Hunt opposed eliminating overnight parking entirely, noting it gives officers time to clear vehicles before plowing. DPW Director Michael indicated residential streets aren't typically plowed until 7-8 AM anyway. The committee discussed potentially signing specific problem areas (6-8 locations) with even\/odd restrictions while using shorter overnight restrictions elsewhere. Item was tabled for Michael to develop a proposal on specific exception areas for the July meeting." },
      { item:"Crosswalk Request on Alderson Street", body:"Mount Olive Church requested a crosswalk between the church and DC Everest parking lot. Staff estimated a basic crosswalk would cost about $2,000, while a lighted system would be $25,000-$30,000. The committee discussed that no accidents have occurred at the location. Motion by Olsen that if Mount Olive is willing to cover the cost, the committee recommends board approval, seconded by Sherwanka, passed unanimously. Michael will contact Mount Olive to determine their willingness to pay." },
      { item:"Mobile Food Vendors Fire Inspection", body:"Chief Hunt explained a regional program with Wisconsin Rapids, Marshfield, Stevens Point, Plover, Rib Mountain, and Weston where any participating department's inspection is valid for all jurisdictions. Fire Marshal Marty already inspected one truck that failed due to improper LP piping and unsecured propane cylinders. Wausau opted out to do their own inspections. Motion by Sherwanka to approve Ordinance 26-8, seconded by Campkey, passed unanimously." },
      { item:"Address Corrections for E911 Compliance", body:"Staff presented three addressing errors: 5915 Delicoski Street (duplex needing two addresses), Ross Avenue addresses out of sequence with a newly discovered apartment unit, and 2211 Radkey Avenue needing correction for a new duplex. Chief Hunt added another property on Delicoski (Weston Villa Apartments) with eight apartments having separate addresses plus a utility room address that needs review. Motion to recommend board approval passed unanimously." },
      { item:"Raze Order for 4104 Shore Avenue", body:"Staff requested authorization to begin demolition proceedings for an abandoned structure. The property has been abandoned since 2010-2011, was posted since 2021, and a planned fire department training burn was cancelled because the structure was too deteriorated to be safe. The current owners, who are up to date on taxes, previously housed chickens in the structure. Demolition costs will be placed on the tax roll. Motion by Olsen, seconded by Campkey, passed unanimously." },
    ],
    publicComment: "Jim Senalt spoke for approximately 4 minutes criticizing the new farmers market location, questioning grass parking legality, raising ADA concerns about handicap parking placement on grass, questioning the need for food truck fire inspections, and expressing concern about lack of follow-up on long-standing code violations.",
    actionItems: [
      "Chapter 50 nuisances amendments recommended to board of trustees for approval",
      "E-bicycle ordinance with emoto prohibition on roadways, sidewalks, and trails recommended to board of trustees",
      "Michael to develop proposal for specific parking restriction areas for July meeting",
      "Michael to contact Mount Olive Church regarding willingness to pay for crosswalk installation",
      "Ordinance 26-8 for mobile food vendor fire inspections approved",
      "Address corrections for three properties plus Weston Villa Apartments to be processed",
      "Staff authorized to begin raze order proceedings for 4104 Shore Avenue",
      "Staff to investigate property concern at Sternberg and South Timber with furniture and dumpster outside",
    ],
  },
  {
