...
const MEETINGS = [
  {
    ...
    isAgendaOnly: false,
    badge: "new",
    overview: "The Wausau City Council approved a major development agreement for 11 Scott Street (Waterside Place) by a 6-3 vote, which will convert a vacant 100,000 square foot building into 52 mid-priced apartment units. The council also recognized city employees for their response to a record 30.9-inch snowstorm and presented the 2026 Sustainability Award to Colby and Colby Millwork for their solar panel installation and recycling initiatives.",
    agenda: [
      ...
      { time:"4:02", item:"Mayoral citation for DPW snow removal crews" },
      { time:"10:15", item:"Sustainability Award presentation to Colby and Colby Millwork" },
      { time:"16:50", item:"Approval of March 10, 2026 meeting minutes" },
      { time:"17:20", item:"Public comment period" },
      { time:"19:00", item:"Consent agenda" },
      { time:"19:30", item:"Development agreement for 11 Scott Street\/Waterside Place" },
      { time:"30:45", item:"Mayoral appointments to Plan Commission, Affordable Housing Task Force, and BID Board" },
      { time:"31:15", item:"Solid waste and recycling service agreement with Harter's Fox Valley Disposal" },
      { time:"32:00", item:"Various resolutions and ordinances including budget modifications" },
    ],
    discussions: [
      { item:"11 Scott Street\/Waterside Place Development Agreement", body:"The council approved a joint resolution from economic development and infrastructure committees for a development agreement with 11 Scott Street LLC by a 6-3 vote. Developer Mark Craig (3246 North 8th Street) and Raleigh Lray spoke in support, noting the $10 million project would create 52 mid-priced residential units in a building vacant for 3 years. Alder Rasmusson supported the project citing the need to replace downtown workers with residents and return parking spaces to public use. Alder Neil emphasized the project would generate $55,000 annually in parking revenue and help close TID 8 within 5 years. Alder Larson was the dissenting voice, objecting to discounting city parking assets. Alder Tierney questioned the city's obligation to provide 150 alternative parking spaces within 300 yards if the ramp closes, with Economic Development Director Randy Feifer explaining this reduced an existing commitment from 480 to 150 spaces." },
      { item:"DPW Snow Removal Recognition", body:"Mayor Denny presented a mayoral citation recognizing the Department of Public Works plow crews and municipal fleet staff for their response to the record 30.9-inch snowfall from March 14-16, 2026. Kevin Kester, street supervisors Dustin and Josh, storeroom manager Mitch Harris, and mechanic Jieven Matah were specifically mentioned. Kester noted that four municipal fleet technicians worked 12-hour shifts providing 24-hour breakdown support, with two volunteering on Saturday for downtown snow removal. By week's end, these technicians will have worked 12 straight days without a day off." },
      { item:"Sustainability Award to Colby and Colby Millwork", body:"Christine Daniels from the Sustainability, Energy and Environment Committee presented the 2026 City of Wausau Sustainability Award to Colby and Colby Millwork. Representatives Mike Thompson and Keith Kaning accepted the award, describing their over 2,000 solar panel installation on their 11th Avenue manufacturing facility that became operational in July 2025, generating enough power for approximately 120 homes. They also highlighted LED lighting upgrades and recycling initiatives for wood, aluminum, glass, vinyl, cardboard, and other materials." },
      { item:"Solid Waste and Recycling Agreement", body:"The council approved a resolution from finance committee for a 7-year residential solid waste and recycling service agreement with Harter's Fox Valley Disposal. The mayor noted there had been confusion about whether the term was 7 or 10 years, confirming the corrected 7-year term as approved by public health and safety. Passed 9-0." },
      { item:"Legal Settlement - David Holes vs City of Wausau", body:"Assistant City Attorney Vincent Bonito explained a resolution to release claims related to a 2022 bus accident. Transit Mutual insurance paid the initial claim, and the individual who struck the bus later filed a personal injury claim. The city's counter claim and third-party complaint against the individual's insurer resulted in a settlement where the insurer agreed to pay damages for the bus. Alder Neil clarified this settlement is separate from any ongoing personal injury claim. Passed 8-1 without need for closed session." },
    ],
    publicComment: "Two speakers addressed the council during public comment. Raleigh Lray spoke in support of the 11 Scott Street project, describing it as a green sustainable repurposing of a vacant building that would add mid-priced apartments downtown. Mark Craig (3246 North 8th Street) joined to emphasize the project's challenges, noting it exceeds $10 million with the residential component alone at $8.3 million, and urged council support.",
    actionItems: [
      "Development agreement for 11 Scott Street\/Waterside Place approved 6-3, moving forward with 52-unit residential conversion",
      ...
      "Municipal Code Chapter 6.44 solid waste disposal ordinance repealed and recreated to align with state code",
  ...
  },
  {
    ...
    isAgendaOnly: false,
    badge: "new",
    overview: "The Marathon County Board held an educational meeting featuring presentations on PFAS litigation opportunities and renewable energy regulatory authority. No votes were taken as this was an informational session, but supervisors heard from attorneys about joining multi-district litigation against PFAS chemical manufacturers and learned about county options for responding to proposed wind energy projects in the county.",
    agenda: [
      { time:"0:00", item:"Call to order and Pledge of Allegiance" },
      { time:"0:45", item:"Reading of the notice" },
      { time:"1:15", item:"Roll call" },
      { time:"2:00", item:"Public comment period" },
      { time:"12:30", item:"Presentation on PFAS multi-district litigation opportunity" },
      { time:"45:00", item:"Presentation on renewable energy regulatory authority and county options" },
    ],
    discussions: [
      { item:"Public Comment", body:"Five residents spoke during public comment. Cindy Nelson from Stratford\/Oplane Township reported going to 200 houses regarding wind turbine projects, stating nobody she spoke with wants wind turbines and residents lack information about current projects. Wendy Rowski from Green Valley urged the board to vote no on advancing the comprehensive plan draft, objecting to the term 'wind farm' and requesting it be called 'industrial wind energy development.' Barb Newton from Rib Mountain reiterated support for speed reduction on Double N road with 75 petition signatures. Heidi Pesky from Town of McMillan argued against joint development agreements for wind projects, listing numerous concerns including long-term county obligations. Cindy Hogan from Rib Mountain supported the Double N speed reduction petition." },
      { item:"PFAS Multi-District Litigation Presentation", body:"Attorney Carrie McDougall from Baron and Bud Law Firm presented via WebEx on opportunities for Marathon County to join nationwide PFAS litigation. McDougall explained the MDL process, noting a $12-13 billion settlement from 3M and $3-5 billion from DuPont for water providers has been approved. He stated soil-based claims and airport claims are expected to be next. The litigation is on contingency fee (25%) with no upfront costs to the county. Supervisor Robinson asked multiple questions about scope, including whether landowners affected by biosolids spreading could be included. Attorney Andy Phillips clarified claims must be unique to Marathon County's injuries. Vice Chair Dickinson noted the airport has no known current PFAS contamination. Supervisor Mash asked about costs, and McDougall confirmed the county pays nothing unless there's a recovery." },
      { item:"Renewable Energy Regulatory Authority Presentation", body:"Attorney Rebecca Roker from Atolis Law, representing Wisconsin Counties Association, presented on county authority regarding wind and solar projects. She reviewed the Hub City Wind project from Alliant Energy (no PSC filing yet), Marathon Wind LLC (purchased by Hub City), and Stormark Wind Energy Center. Roker explained that PSC has approved 33 of 33 solar projects with no denials, and projects over 100 megawatts fall under PSC jurisdiction. She outlined four options for counties: do nothing, negotiate a Joint Development Agreement (JDA), intervene in PSC proceedings, or litigate. Roker strongly recommended JDAs as the most effective tool to protect county interests, noting they can address liability, environmental concerns, road damage, decommissioning, and emergency response training that state law does not otherwise require." },
    ],
    publicComment: "Five residents provided public comment: Cindy Nelson (Stratford) opposed wind turbines citing lack of public information; Wendy Rowski (Green Valley) objected to comprehensive plan language calling industrial energy facilities 'farms'; Barb Newton and Cindy Hogan (Rib Mountain) supported speed reduction on Double N road with 75 petition signatures; Heidi Pesky (Town of McMillan) argued against joint development agreements for wind projects, citing concerns about long-term county obligations and liability.",
    actionItems: [
      "Board to consider resolution on PFAS litigation at next week's meeting",
      "County to potentially engage in PFAS testing at airport, landfill, and wastewater facilities to assess claims",
      "Board to consider options for responding to proposed wind energy projects including potential JDA negotiations",
      "Speed reduction recommendation for Double N road forwarded from infrastructure committee for board consideration",
    ],
  },
  {
    ...
    isAgendaOnly: false,
    badge: "new",
    overview: "The Wausau Board of Public Works approved the lowest bid for the 26th Street construction project, approved a change order for unexpected infrastructure issues on the Rolph Street\/Cherry Street project, and issued a concrete license. All items passed unanimously with no opposition or public comment.",
    agenda: [
      ...
      { time:"1:37", item:"2025 Street Construction Project A - Rolph Street, Cherry Street Change Order 1" },
      { time:"3:29", item:"2025 Street Construction Project A - Pay Estimate Number 9" },
      { time:"3:52", item:"Portland cement concrete license for KSK Incorporated" },
      { time:"4:16", item:"Adjournment" },
    ],
    discussions: [
      { item:"March 10th Board of Public Works Minutes", body:"Minutes from the March 10th regular meeting were considered. A motion was made and seconded, passing unanimously with all in favor." },
      { item:"26th Street Construction Project Bids", body:"Seven bids were opened for the 26th Street construction project. Switlick submitted the lowest bid at $1,279,089.75, narrowly beating Hos at $1,280,877.96. Other bidders included A1 ($1,374,600), Francis Melvin ($1,385,383), Steen ($1,489,126), James Peterson ($1,570,698.56), and Earth ($1,686,078.75). A board member noted the 'tight bids' between the top two. Motion to approve Switlick passed unanimously." },
      { item:"North 8th Avenue Bid Opening", body:"This item was postponed as the bid opening was extended. It will come back to a future meeting." },
      { item:"Rolph Street\/Cherry Street Change Order 1", body:"Staff presented Change Order 1 totaling $14,436.50 for Haw Suns Incorporated. The change order covered four items: an inside manhole drop ($4,856) due to an unrecorded large diameter sanitary service, water main tie-in modifications ($2,317.50) after discovering 6-inch pipe instead of expected 8-inch, miscellaneous storm sewer work ($5,016) for private tie-ins, and geogrid installation ($2,247) near Thomas Jefferson Elementary due to poor soil conditions. Change Order 2 regarding liquidated damages was deferred pending further discussions. Motion to approve passed unanimously." },
      { item:"Rolph Street\/Cherry Street Pay Estimate 9", body:"Pay Estimate Number 9 for Haw Suns Incorporated was presented for work completed through year end, totaling $535,114.20. Motion to approve passed unanimously." },
      { item:"Portland Cement Concrete License - KSK Incorporated", body:"A board member named Vinnie confirmed he reviewed the license application and everything was in order. Motion to approve the Portland cement concrete license for KSK, Inc. passed unanimously." },
    ],
    publicComment: "No public comment was offered.",
    actionItems: [
      "Switlick awarded 26th Street construction project contract at $1,279,089.75",
      "Change Order 1 approved for Rolph Street\/Cherry Street project ($14,436.50)",
      "Pay Estimate 9 approved for Haw Suns Incorporated ($535,114.20)",
      "Portland cement concrete license approved for KSK Incorporated",
      "North 8th Avenue bid opening postponed to future meeting",
      "Change Order 2 with liquidated damages for Rolph Street project to return for future consideration",
    ],
    civicItems: [
  ...
  },
  {
    ...
    isAgendaOnly: false,
    badge: "new",
    overview: "The Finance and Human Resources Committee debated employee clothing allowances after canceling a uniform service contract, ultimately recommending $400 for 2026 and $500 annually starting 2027 plus a washer\/dryer purchase. The committee also received a detailed presentation on public works operations showing the department operates below average costs compared to similar communities.",
    agenda: [
      { time:"0:00", item:"Call to order and Pledge of Allegiance" },
      { time:"0:30", item:"Roll call" },
      { time:"0:45", item:"Public comments" },
      { time:"2:30", item:"Approval of minutes from February 16, 2026" },
      { time:"3:00", item:"February financial report acknowledgment" },
      { time:"3:45", item:"T1 and T2 detail reports for February" },
      { time:"4:15", item:"Legal details for February" },
      { time:"4:45", item:"Educational presentation: Public works operations and budget" },
      { time:"32:00", item:"Discussion and action on clothing and equipment allowance amendments" },
      { time:"55:00", item:"Staff and committee remarks, future items" },
      { time:"56:30", item:"Adjournment" },
    ],
    discussions: [
      { item:"Public Works Operations and Budget Presentation", body:"Public Works Director Michael delivered an extensive presentation showing the department manages 119.5 centerline miles of road, over 50 pieces of equipment, and significant underground infrastructure. He emphasized the 2026 budget decreased by $26,000 (1.1%) from 2025. Michael noted Weston spends approximately $9,700 less per mile than the average central Wisconsin community, making them the third lowest spending community per mile in the region. He also discussed the March 15 snow event that cost approximately $50,000 and required staff to work 16-17 hour shifts, with the county applying for disaster relief funds." },
      { item:"Clothing and Equipment Allowance Amendments", body:"Extensive debate occurred over increasing employee clothing allowances after canceling the Cintas uniform contract. Michael advocated for $600 to maintain equivalent benefits, noting employees work with chemicals and hazardous materials that damage clothing. Committee member Daniels argued for fiscal restraint given the upcoming fire department referendum, stating she was comfortable with $300-$400. The initial motion for $600 failed 3-3 on roll call (Daniels-no, Armain-no, Olsson-yes, My-no, Satai-yes). A $400 motion also failed. A $500 with washer\/dryer motion failed. Finally, a motion for $400 remainder of 2026, $500 annually starting 2027 with washer\/dryer purchase passed with one opposed." },
      { item:"February Financial Reports", body:"Steve made a motion to acknowledge the February 2026 financial reports for all funds. Motion passed unanimously." },
      { item:"Minutes Approval", body:"Steve moved to approve minutes from February 16, 2026, seconded by Stephanie. Motion passed unanimously." },
    ],
    publicComment: "Lisa Beck of 1808 Cortez Lane offered public comment praising Public Works Director Michael for work during the recent storm, but expressed concern about the proposed clothing allowance increase. She questioned why the village would increase the stipend to the highest proposed amount rather than choosing a lesser amount, suggesting the money saved from canceling Cintas should be saved rather than spent.",
    actionItems: [
      ...
      "Marathon County disaster relief application pending for March snow event costs (approximately $50,000 for village)",
  ...
  },
  {
    ...
    isAgendaOnly: false,
    badge: "new",
    overview: "The Village of Weston Board of Trustees approved multiple rezoning ordinances, modified a speed limit ordinance for Weston Avenue after debate, and received updates on the April 2026 referendum for fire department funding. The board also approved a 10-year baseball\/softball field maintenance agreement and deferred action on remote meeting attendance policy to the next meeting when newly elected officials will be seated.",
    agenda: [
      { time:"0:00", item:"Call to order and Pledge of Allegiance" },
      ...
      { time:"35:00", item:"Resolution - Final plat of Hinter Springs Second Edition" },
      { time:"36:00", item:"Referendum informational sessions update" },
      { time:"40:00", item:"New business items including parking restrictions, intersection signage, field agreements" },
    ],
    discussions: [
      { item:"Public Comment - Fire Department Funding", body:"Jim Pensel of 5002 Aerrol Street spoke passionately about SAFER fire department staffing issues after attending the citizen academy. He criticized the board's approach of using referendums instead of prioritizing fire department funding in the budget, arguing spending on artificial turf and the aquatic center are 'wants' while fire\/EMS is a 'need.' He called on the board to 'stop looking for the easy way out through referendums and start making the hard choices.'" },
      { item:"Finance Director Response to Public Comment", body:"Finance Director Jessica responded that the village cannot borrow for additional firefighters - only operating revenue can fund them, which is why a referendum is needed. She noted the turf at Kennedy Park was funded through approved borrowing, not operating funds. She expressed frustration with criticism, noting the village is 'the cheapest' and 'most efficient' but cannot continue without more revenue, and suggested her position may be open in a couple months." },
      { item:"Ordinance 26-00006 - Speed Limits on Weston Avenue", body:"Significant debate occurred over the proposed 35 mph speed limit on Weston Avenue from Von Kennel to Ryan Street. Trustee Maloney argued the road is too good and wide for 35 mph compared to other village roads. The original motion to approve failed 4-3 with Maloney, Jordan, and the President voting no. An amended motion by Maloney was approved changing Von Kennel to Highway J back to 45 mph while keeping Camp Phillips to Von Kennel at 35 mph." },
      { item:"Intersection Signage at Community Center Drive and Birch Street", body:"Motion to change stop sign to yield sign was amended after Trustee Hooang raised safety concerns about bicyclists coming off the pedestrian bridge at 15-20 mph with no signage requiring them to stop. A friendly amendment was accepted to add a stop sign for bicyclists on the path. Motion passed unanimously as amended." },
      { item:"Baseball\/Softball Field Maintenance Agreement", body:"The board approved a 10-year agreement with youth baseball and softball organizations for field maintenance at Kennedy Park. Parks staff explained the long term protects the village's investment and provides stability despite leadership changes in organizations. The agreement requires organizations to maintain fields in lieu of fees. Passed unanimously." },
      ...
      { item:"Microsoft Teams for Trustee Communication", body:"Board approved using Microsoft Teams for trustee communication starting next term to replace text messaging between trustees. Staff will provide training for new board members. Passed unanimously." },
    ],
    publicComment: "Jim Pensel of 5002 Aerrol Street spoke about fire department staffing, criticizing the referendum approach and calling for budget reprioritization to fully fund SAFER. He attended the department's inaugural citizen academy and emphasized the exhaustion and understaffing he witnessed.",
    actionItems: [
      "Approved rezoning of portion of 8905 Bert Street from RR5 to SFS (per planning commission)",
      "Approved rezoning of portion of 7105 Christensen Avenue from SL to SFS (per planning commission)",
      "Approved amended speed limit ordinance: Camp Phillips to Von Kennel at 35 mph, Von Kennel to Highway J at 45 mph",
      "Approved final plat of Hinter Springs Second Edition subdivision",
      "Tabled e-bike\/euro ordinance until county finalizes their process",
      "Approved removal of no parking restrictions on west side of Alderson Street along Kennedy Park",
      "Approved yield sign at Community Center Drive\/Birch Street with addition of stop sign for bicyclists on path",
      ...
      "Approved Microsoft Teams for trustee communication starting next term",
  ...
  },
  {
    ...
    isAgendaOnly: false,
    badge: "new",
    overview: "The Marathon County Board of Supervisors adopted the 2026 Comprehensive Plan after approving nine amendments addressing renewable energy terminology, data centers, AI technology, and energy policy. The board also authorized phase 2 design services for a new highway facility, approved engaging outside counsel for PFAS litigation, and ratified a local state of emergency declaration following a major blizzard.",
    agenda: [
      { time:"0:00", item:"Call to order, pledge of allegiance, and moment of reflection" },
      { time:"1:15", item:"Reading of the notice and roll call" },
      { time:"2:45", item:"Standing committee reports" },
      { time:"3:00", item:"Consent agenda items C8 through C13 B2" },
      { time:"3:45", item:"D14 - Adopting Marathon County Comprehensive Plan 2026 (Ordinance 0-13-26)" },
      { time:"45:30", item:"E15 - Establishing salaries for elected officials (Resolution 12-26)" },
      { time:"46:15", item:"E16 - Highway facility phase 2 design services (Resolution 13-26)" },
      { time:"48:00", item:"E17 - Authorizing PFAS litigation counsel (Resolution 14-26)" },
      { time:"52:30", item:"E18-E19 - Budget carry forwards and capital asset thresholds" },
      { time:"54:00", item:"F20 - Law enforcement drug trafficking grant" },
      { time:"55:00", item:"G21 - Ratification of local state of emergency declaration" },
      { time:"59:00", item:"H22 - County Administrator performance evaluation" },
      { time:"1:02:00", item:"Announcements and adjournment" },
    ],
    discussions: [
      { item:"Comprehensive Plan 2026 (Ordinance 0-13-26)", body:"Administrator Leonard presented nine proposed amendments compiled from supervisor feedback. The board voted on each amendment separately after Supervisor Crawl successfully moved to separate amendments 2, 3, and 4 which had been bundled together. Amendment 1 (livability standards) passed unanimously. Amendments 2, 3, and 4 (changing 'renewable energy farms' to 'energy systems' terminology) each passed but were not unanimous, with Supervisor Crawl voting no. Amendment 5 (data centers and battery storage background) passed non-unanimously after Supervisor Leur noted it was 'too ideological.' Amendment 6 (radon and lead remediation) passed unanimously. Amendment 7 (regulate energy projects when allowed by law) passed non-unanimously. Amendment 8 (AI and automation language proposed by Supervisor Leur) passed unanimously after she explained the goal was transparency and ethical oversight of AI decisions. Amendment 9 was significantly debated - Supervisor Sindellski's original language promoting 'clean coal, natural gas, and nuclear' was amended by Supervisor Boots to read 'promote coal and natural gas until a long-term sustainable and reliable energy source can be found that does not adversely affect agricultural land.' Supervisors Robinson and Rosenberg opposed, with Rosenberg stating 'there is no such thing as clean coal.' The amended version passed non-unanimously. A late amendment by Supervisor Sindellski regarding industrial classification of utility-scale wind and solar was debated extensively, with a motion by Supervisor Jeang to refer to committee defeated. The amendment itself was ultimately defeated. The final comprehensive plan as amended passed but was not unanimous." },
      { item:"Highway Facility Phase 2 Design Services (Resolution 13-26)", body:"Supervisor Robinson moved and Supervisor V seconded authorizing phase 2 design services. Supervisor Soyber requested future information about plans for the old facility. Supervisor Sindellski asked about the $53 million cost estimate, and Chair Gibbs clarified that cost was not part of this approval. The resolution passed unanimously." },
      { item:"PFAS Litigation Counsel (Resolution 14-26)", body:"The board authorized engaging outside counsel on contingency basis for PFAS contamination lawsuits. Two amendments were adopted: Supervisor Robinson's amendment directing the county administrator to evaluate past and present practices that may have resulted in PFAS exposure to determine risk (passed unanimously), and Vice Chair Dickinson's amendment modifying airport-specific language to reference county property generally (passed unanimously). The resolution as amended passed unanimously." },
      { item:"Local State of Emergency Ratification (Resolution 22-26)", body:"Administrator Leonard explained the ratification was needed to preserve potential reimbursement opportunities after the governor's emergency declaration expired on the 16th during the blizzard event. He praised county staff extensively, noting facilities and parks logged over 600 hours of additional call-in time in 24 hours, highway workers worked 12-16 hour shifts sleeping on cots, and staff slept at the courthouse to ensure shift changes for dispatch and corrections. Supervisor Fifer echoed the thanks as infrastructure committee chair. Passed unanimously." },
    ...
    publicComment: "No public comment was offered.",
    actionItems: [
      "Comprehensive Plan 2026 adopted with nine amendments (Ordinance 0-13-26)",
      ...
      "Outside counsel authorized on contingency basis for PFAS litigation (Resolution 14-26)",
  ...
  },
  {
    ...
    isAgendaOnly: false,
    badge: "new",
    overview: "The Parks Committee approved Rettler Corporation to develop the master plan for Mock Mueller Park, discussed increasing park impact fees to align with neighboring communities, and reviewed the successful Yellow Banks kayak launch project that came in significantly under budget due to grants. The committee also discussed ice rink operations at Kennedy Park and potential future hockey facility improvements.",
    agenda: [
      { time:"0:00", item:"Call to order and Pledge of Allegiance" },
      { time:"0:30", item:"Roll call" },
      ...
      { time:"19:30", item:"Request for proposals for Mock Mueller Park master plan" },
      { time:"24:15", item:"Review of Yellow Banks kayak launch expenses" },
      { time:"29:30", item:"Components of operations for ice rink at Kennedy Park" },
      { time:"42:00", item:"Future items and next meeting date" },
      { time:"44:30", item:"Remarks from staff and committee members" },
      { time:"47:00", item:"Adjournment" },
    ],
    discussions: [
      ...
      { item:"Parks and Recreation Impact Fee Discussion", body:"Jennifer presented information on park impact fees, noting that the 2020 study allowed fees up to $761 for single family units but the village only charges $300. Neighboring communities charge $600-650. Committee members expressed support for a moderate increase to align with neighbors. Katrina stated she would be 'more in the moderate increase bracket instead of the maximum.' The committee provided feedback that fees should be consistent with neighboring communities while remaining competitive. No formal action was taken; information will go back to Plan Commission." },
      { item:"Request for Proposals for Mock Mueller Park Master Plan", body:"Staff received seven proposals for the park master plan, which were reviewed and rated by four staff members. The two lowest cost proposals were from JSD ($[inaudible]) and Rettler Corporation, both with village experience. Roger made a motion to select Rettler Corporation, seconded by Katrina. The motion passed unanimously." },
      { item:"Yellow Banks Kayak Launch Expenses", body:"Jessica presented a detailed breakdown of the kayak launch project expenses and grant funding. The project received grants from DNR and Marathon County Transportation, with Marathon County covering the full expense for the ADA-accessible dock. Lisa Beck praised the RFC during public comment as 'super well written.' Committee members commended Jessica and Dan Hagenbotham for grant writing work. Katrina noted it was 'a huge success' with significant cost reduction through grants. No formal action required; informational only." },
      { item:"Ice Rink Operations at Kennedy Park", body:"Staff presented information on ice rink operations requested by Katrina. The warming house has been unattended since 2020 due to COVID and subsequent staffing shortages. Sean noted Everest Youth Hockey has provided cost estimates for a covered rink structure and remains interested in improvements. Discussion included potential impacts from Marathon Park hockey facility changes. Katrina stated she wanted to ensure hockey doesn't 'get forgotten about' amid baseball-focused Kennedy Park discussions. Committee requested more historical attendance data and user feedback for next meeting." },
    ],
    publicComment: "Jim Pinsel spoke expressing frustration about not receiving responses to questions submitted at the previous meeting regarding playground equipment installation, Kennedy Park fundraising updates, and ice rink costs. He argued the true cost of operating the ice rink is $20,000-$30,000 when factoring in staff hours, not just the $1,320.98 presented. Lisa Beck thanked staff for snow removal efforts during the recent blizzard and praised the Yellow Banks RFC for being well-written with detailed expense information. A written response to Jim Benson's previous email was submitted and will be included in the minutes.",
    actionItems: [
      "Rettler Corporation selected to develop Mock Mueller Park master plan and budget estimates",
      "Jennifer to present park impact fee comparison data from neighboring communities to Plan Commission next month",
      "Staff to compile historical ice rink attendance data from 2018-2019 seasons for next meeting",
  ...
  },
  {
    ...
    isAgendaOnly: false,
    badge: "new",
    overview: "The Marathon County Executive Committee approved placing County Administrator on year six of the pay scale retroactive to January, and ratified a local state of emergency declaration related to a recent snow emergency. The committee also received an overview of 68 rules review recommendations that will be discussed at the April 9th meeting.",
    agenda: [
      { time:"0:00", item:"Call to order and Pledge of Allegiance" },
      { time:"0:30", item:"Performance review of the administrator (3A1)" },
      { time:"1:45", item:"Closed session for administrator evaluation" },
      { time:"2:00", item:"Return to open session - Administrator pay scale approval" },
      { time:"2:45", item:"Ratification of declaration of state and local emergency (3B1)" },
      { time:"4:30", item:"Rules review recommendations - educational overview" },
      { time:"6:15", item:"Adjournment" },
    ],
    discussions: [
      { item:"Performance review of the administrator", body:"The committee voted unanimously to go into closed session to discuss the administrator's performance evaluation. Roll call vote was taken with all members (Gibbs, Dickinson, Arstead, Boots, Drebeck, Fifick, Mask, Ritter, Morash, and Robinson) voting aye. The executive committee had rated the administrator on three criteria: needs improvement, successful, and exceptional, with scores averaged on a 0-5 scale." },
      { item:"Administrator pay scale approval", body:"Upon returning to open session, Supervisor Mask moved to approve placing the administrator on year six of the pay scale and approve the evaluation. Supervisor Arstead seconded. The chair clarified this would be retroactive to January, consistent with county implementation. Motion carried with no opposition on voice vote." },
      { item:"Ratification of declaration of state and local emergency", body:"The administrator explained that following the governor's emergency declaration for the recent snow emergency, a local state of emergency was declared. HR reported hundreds of extra hours worked by parks, recreation, forestry, and capital management staff over approximately 24 hours. Highway department employees were described as sleeping on cots and running 12-16 hour shifts. The ratification preserves the county's ability to request reimbursement through emergency funds. Supervisor Robinson moved to ratify, seconded by Supervisor Fifick. Motion carried unanimously on voice vote." },
      { item:"Rules review recommendations overview", body:"The vice chair provided an educational overview of the rules review committee's work. Of 68 items submitted, 31 were approved, 31 rejected, and 3 placed in a parking lot. Key changes include clarifications of existing practices, changes to chair and vice chair appointments, expense reimbursement approvals allowing more freedom for WCA professional development, restructuring of the forestry recreation committee, and sunsetting of the TIF and broadband task forces. The committee decided to retain two meetings rather than consolidating to one. No action was taken; further discussion scheduled for April 9th, 2026." },
    ],
    publicComment: "No public comment was offered.",
    actionItems: [
      "Administrator placed on year six of pay scale, retroactive to January 2026",
      "Declaration of local state of emergency ratified and moved to full board for consideration",
      "County to compile information for potential emergency fund reimbursement requests",
      "Rules review recommendations to be discussed at April 9, 2026 executive committee meeting",
    ],
  },
  {
    ...
    isAgendaOnly: false,
    badge: "new",
    overview: "The Marathon County HR, Finance, and Property Committee approved several key items including a claim disallowance related to a child's death in foster care, revised property values for public auction, carry forward funds totaling over $1.5 million, and a capital assets threshold policy change. The committee also received introductions from new healthcare consultants and detailed financial updates on 2025 year-end and 2026 budgets.",
    agenda: [
      { time:"0:00", item:"Meeting in progress - previous motion carried" },
      { time:"0:08", item:"Claim disallowance - Mercedes Holmes" },
      { time:"1:52", item:"Revised property values for public auction parcels" },
      { time:"3:45", item:"Resolution to approve carry forward funds" },
      { time:"7:45", item:"Resolution to amend capital assets threshold policy" },
      { time:"8:45", item:"Introduction of healthcare consultants - National Insurance Services" },
      { time:"24:30", item:"Audited 2025 year-end fiscal update" },
      { time:"45:00", item:"2026 year-to-date budget update" },
      { time:"47:30", item:"Finance Department quarterly update" },
      { time:"55:00", item:"County Treasurer update" },
    ],
    discussions: [
      { item:"Claim disallowance - Mercedes Holmes", body:"Corporation Counsel presented a claim received December 5th from Mercedes Holmes regarding the death of her 3-year-old child Zalen Bernett, who was placed in a treatment foster care home licensed through another agency in Dunn County. The death was determined to be natural causes with no wrongdoing found through law enforcement and social services investigations. Outside counsel and insurance carrier WMIK recommended formal disallowance. Chair Gibbs moved to disallow the claim, seconded by Supervisor Lemer. Motion carried unanimously." },
      { item:"Revised property values for public auction", body:"Two parcels at 529 Mullen Street and 738 South 3rd Avenue had failed to sell twice on Wisconsin Surplus with bids not reaching appraised value. Staff recommended revised minimum sale prices of $9,000 and $7,500 respectively. Chair Gibbs moved to approve the revised prices, seconded by Supervisor Lemer. Motion carried unanimously. Chair Robinson asked about bidders who made errors, and staff confirmed they are marked as non-pay and barred from future auctions." },
      { item:"Resolution to approve carry forward funds (R20-2026)", body:"Finance Director Sam presented carry forward requests including program revenues for multi-year projects and veterans relief fund replenishment. Discussion included questions about veteran service commission oversight (answered by County Administrator Lance that a three-member commission considers requests), redacted records funds for Register of Deeds (to be researched further), and $142,731 for administration including $75,000 for homelessness contract. Chair Gibbs moved to approve, seconded by Supervisor Hart. Motion carried unanimously." },
      { item:"Capital assets threshold policy amendment", body:"Finance Director Sam explained the proposal to increase the capitalization threshold from $5,000 to $10,000, noting the original threshold was set in 2006 following GFOA guidance and had been considered for increase in 2022. Supervisor Hart moved to approve and send to full county board, seconded by Chair Gibbs. Motion carried unanimously." },
      { item:"Introduction of healthcare consultants - National Insurance Services", body:"HR Director Candace introduced NIS representatives following an RFP award. Steve Zimmermann (28 years experience) and Jordan Stanley presented their team and approach. They discussed evaluating the near-site ATA clinic, exploring fully insured vs. self-insured vs. level funded models, and improving transparency with the committee. Vice Chair Marshall asked about family plan costs compared to other employers and strategies for reducing ER use. Chair Gibbs asked about evaluation processes for insurance models. The consultants committed to providing data-driven analysis and regular updates." },
      { item:"Audited 2025 year-end fiscal update", body:"Finance Director Sam provided detailed department-by-department review of 2025 fiscal year, noting ongoing year-end closing processes. Key items included: treasurer received $257,238 TID closure check from City of Wausau and $222,752 in unclaimed property; opioid fund received $352,389 in settlements with total cash now at $2.2 million; parks fund saw $70,000 increase in ice revenue; ARPA funds nearly exhausted with $800,000+ interest to be moved to different fund. Chair Robinson asked about projected fund balance surplus but Sam indicated she would provide that at next meeting pending capital assets reconciliation." },
      { item:"Finance Department quarterly update", body:"Sam reported the department is fully staffed since mid-December with a new systems financial analyst for payroll. Accomplishments include quarterly closeouts with departments, uniform countywide training, year-end processes including W-2s addressing the 'big beautiful bill' no-tax-on-overtime calculations, random cash audits (all successful), and policy development. County Administrator Lance praised Sam and her team extensively for their work on W-2s and year-end close, noting the amount of work cannot be overstated. Multiple committee members expressed appreciation for improved reporting and transparency." },
      { item:"County Treasurer update", body:"Treasurer Connie reported on tax collection activities including 1,582 delinquent tax notices sent (down from 1,786 last year), year-end procedures, lottery credit processing, and ongoing challenges with municipal treasurer errors. Discussion addressed payment agreements (no longer offered due to high default rates), eviction processes for tax-delinquent properties, and the need for better municipal treasurer training. Chair Robinson praised the improved tax delinquency process that now protects homeowner equity rather than allowing debt to accumulate." },
    ],
    publicComment: "No public comment was offered.",
    actionItems: [
      ...
      "Capital assets threshold policy amendment approved for full county board consideration",
      "Register of Deeds to provide information on redacted records fund history and potential repurposing at future meeting",
      "Healthcare consultants to provide update before budget assumptions process in early summer",
      "Finance to bring fund balance surplus projection to next meeting after capital assets reconciliation",
      "Social services reserve account increase to be brought forward for consideration due to rising placement costs",
  ...
  },
  {
    ...
    isAgendaOnly: false,
    badge: "new",
    overview: "The Wausau Plan Commission approved a Conditional Use Permit for a 70-unit, 7-story apartment building at 731 N 1st Street and approved a Transportation Project Plat for Grand Avenue signal replacements. A public hearing was held on a proposed personal storage facility at 218 South 4th Street.",
    agenda: [
    ...
    discussions: [
      ...
      { item:"February 18, 2026 Regular Plan Commission Minutes", body:"The minutes from the February 18, 2026 meeting were approved. The motion passed, though specific vote count and mover\/seconder were not recorded." },
      { item:"Public Hearing: Conditional Use Permit for 218 South 4th Street (Dunwoody Storage)", body:"A public hearing was held on a Conditional Use Permit to allow construction of a Personal Storage Facility in the Light Industrial Zoning District. No vote was taken as this was a public hearing item only." },
    ...
    actionItems: [
      ...
      "Public hearing held on Dunwoody Storage Conditional Use Permit for 218 South 4th Street - further action may be pending",
    ],
    civicItems: [
  ...
  },
  {
    ...
    isAgendaOnly: false,
    badge: "new",
    overview: "The Public Health and Safety Committee approved all action items including license applications, a revised solid waste disposal ordinance, repeal of a hand-held device ordinance now covered by state law, and a solar energy partnership with MREA. The committee also received the Wausau Fire Department's 2025 annual report and other informational updates.",
    agenda: [
    ...
    discussions: [
      ...
      { item:"Repealing and recreating Wausau Municipal Code Chapter 6.44 Solid Waste Disposal", body:"The committee approved the new solid waste disposal provision. The vote passed." },
      { item:"Repealing Wausau Municipal Code Section 10.01.012 Use of Hand-Held Mobile Telephones and Mobile Electronic Devices While Driving Prohibited", body:"The committee voted to repeal this code section. The vote passed." },
      { item:"Approving Memorandum of Understanding between the City of Wausau and MREA for Grow Solar Central Wisconsin Group Buy Program", body:"The committee approved the partnership memorandum with the Midwest Renewable Energy Association. The vote passed." },
      { item:"Wausau Fire Department 2025 Annual Report", body:"The Fire Department's 2025 annual report was presented to the committee as a discussion item. No vote was required." },
      ...
      { item:"Community Outreach Update", body:"A community outreach update was provided to the committee as a discussion item. No vote was required." },
    ],
    ...
    actionItems: [
      ...
      "New Wausau Municipal Code Chapter 6.44 Solid Waste Disposal provision to move forward",
  ...
  },
  {
    ...
    discussions: [
      ...
      { item:"Alleged Claim for Recovery of Unlawful Tax for Green Acres at Greenwood Hills, LLC - Outlot 1", body:"The committee denied the claim for recovery of unlawful tax. The motion to approve failed." },
      { item:"Consent to transfer title to buildings at 939 Woods Place", body:"The committee approved the consent to transfer title to buildings and improvements and waiver of first right of refusal at 939 Woods Place. The motion passed." },
      { item:"Terminating Airport Ground Lease with Wynn O. Jones at 939 Woods Place", body:"The committee approved terminating the airport ground lease with Wynn O. Jones. The motion passed." },
      { item:"Airport Ground Lease with Owen Jones at 939 Woods Place", body:"The committee approved the new airport ground lease with Owen Jones at the same 939 Woods Place property. The motion passed." },
      ...
      { item:"Six Remnant Defendants National Opioid Settlement Agreement", body:"The committee voted to postpone consideration of participation in the National Opioid Settlement Agreement to the next scheduled meeting. The motion to postpone passed." },
      { item:"Budget amendment for Wausau Water Works 2025 Lead Service Line Replacement", body:"The committee voted to postpone consideration of this budget amendment for costs not funded by the WDNR subsidized loan to the next meeting. The motion to postpone passed." },
      ...
      { item:"Review of 2025 Motor Pool Fund financial results", body:"This item was on the agenda for review. No vote record was provided for this item." },
      ...
      { item:"Purchasing properties at Adolph Street and Myron Street for DPW Streets Division", body:"The committee voted to postpone consideration of purchasing properties at 108, 112, 112-1\/2 Adolph Street and 233 Myron Street until the next meeting. The motion to postpone passed." },
    ],
    ...
    actionItems: [
      ...
      "Airport ground lease transfers at 939 Woods Place approved - termination with Wynn O. Jones and new lease with Owen Jones",
      ...
      "2025-2026 fund carryover budget amendment approved",
      "2026 General Obligation Promissory Note for Capital Improvements approved to calendar",
      "2025 General Fund transfer approved",
      "DPW property purchases at Adolph Street and Myron Street postponed to next meeting",
    ],
    civicItems: [
      { number:"1", name:"Public comment on agenda items and reading of the City of Wausau Public Comment Statement.", votes:[], docs:[], children:[] },
  ...
  },
  {
    ...
    isAgendaOnly: true,
    badge: "new",
    overview: "The Wausau School District Board of Education Committee of the Whole meeting addressed facility fee amendments for artificial fields, a referendum budget update, renewal of the Wisconsin School Nutrition Purchasing Cooperative membership, and an extensive review of over 60 NEOLA policy updates including new AI policies and Act 57 compliance changes.",
    agenda: [
      { time:"0:00", item:"Call to Order" },
    ...
    discussions: [
      ...
      { item:"NEOLA UPDATE", body:"The committee reviewed proposed changes to numerous district policies ranging from technical corrections to substantive updates. Key policy areas included board member conduct, reading instruction goals, cell phone policies, artificial intelligence use, student supervision and welfare related to Act 57 compliance, and school support organization policies." },
    ],
