...
const MEETINGS = [
  {
    ...
    date: "May 14, 2026", shortDate: "MAY 14",
    ...
    isAgendaOnly: false,
    badge: "new",
    overview: "The Marathon County Health & Human Services Committee held an educational orientation meeting for new and returning members, featuring presentations from department heads on the Health Department, Social Services, Veteran Services, and Aging & Disability Resource Center. The only formal action was approval of April 1st meeting minutes. No policy votes or major decisions were made as this was primarily an informational session.",
    agenda: [
      { time:"0:00", item:"Call to order and remote participation confirmation" },
      { time:"0:32", item:"Pledge of Allegiance" },
      ...
      { time:"10:45", item:"Health Department overview presentation" },
      { time:"25:04", item:"Social Services Department overview" },
      { time:"45:01", item:"Veteran Services Department overview" },
      { time:"1:15:00", item:"Aging & Disability Resource Center overview" },
      { time:"1:30:00", item:"Next meeting date and adjournment" },
    ],
    discussions: [
      { item:"Approval of April 1st meeting minutes", body:"Supervisor Cavelli made a motion to approve the minutes, seconded by Vice Chair Rosenberg. The motion carried unanimously with no discussion." },
      { item:"Standing Committee Ordinance Review", body:"Administrator Lance Leonard explained the committee's structure under ordinance section 2.04 subsection 5, including jurisdiction over the Veteran Service Department, Social Services Department, Health Department, North Central Health Care, and the Aging Disability Resource Center. He outlined reporting relationships with statutory bodies including the Social Services Board, Veteran Service Commission, Transportation Coordinating Committee, and Board of Health." },
      { item:"Health Department Overview", body:"Health Officer Caitlyn Suginaka presented the department's mission to prevent disease, promote health, and protect from environmental hazards. The department has 37.6 FTE staff across four divisions: environmental health (managing 1,200+ licenses), nursing\/communicable disease, community health improvement, and administration. She highlighted the Nurse Family Partnership program's first graduates, public health vending machines stocked with free resources including tick kits, and a new homeless system response position. Approximately half of the $5 million budget is tax levy, with significant intergovernmental grants and public charges for services." },
      { item:"Social Services Department Overview", body:"Administrator Leonard presented on behalf of Director Christa (not present), describing the department as the county's second largest with nearly 140 FTE. The department covers child welfare, youth justice, children's long-term support, economic support, and child support. Of the $22 million budget, about $7 million is tax levy. Leonard highlighted the successful Family Keys housing stability pilot program addressing housing instability among child welfare and youth justice populations." },
      { item:"Veteran Services Department Overview", body:"Veteran Service Officer Aaron Galindo reported the department increased to 3.0 FTE in 2025. Customer interactions jumped from 5,900 to 8,149 in 2025. The department brought $44 million annually to local veterans with $2.6 million in retroactive payments in 2025. Key initiatives include surviving spouse benefits outreach, housing stability work with Center for Veterans Issues establishing a local office, and suicide prevention efforts noting 7 of Marathon County's 30 suicides in 2025 were veterans. Galindo noted staff average 20-30 daily interactions and are exploring the Staff Sergeant Gordon Fox suicide prevention grant." },
      { item:"Aging & Disability Resource Center Overview", body:"Executive Director Mike Ray explained the four-county regional ADRC (Marathon, Lincoln, Langlade, Wood) serves as a one-stop shop for aging and disability services. The organization has about 60 FTE plus 385-400 volunteers. About 11% of budget is county levy. Ray noted significant financial challenges with federal funding flat since 2024 while nutrition program costs increased 40-45% over four years, requiring reductions in meals served, service days, and staffing. The organization hadn't requested a levy increase from 2011 until 2024." },
    ],
    ...
    actionItems: [
      ...
      "Health Officer Suginaka to provide locations of public health vending machines to Supervisor Cavelli",
      "Next meeting corrected to Tuesday June 3rd at 3 PM (not May 29th as initially stated)",
    ],
  },
  {
    ...
    isAgendaOnly: false,
    badge: "new",
    overview: "The Marathon County Board of Supervisors held an adjourned organizational meeting where they approved committee appointments, elected Supervisors Hapa and Arstead to the Executive Committee, and unanimously passed a resolution to reduce landfill tipping fees for debris related to the recent tornado and severe weather disaster. The tipping fee reduction was a key focus, with public comment from affected Ringle residents requesting additional relief.",
    agenda: [
      { time:"0:00", item:"Pledge of Allegiance and moment of reflection" },
      { time:"0:30", item:"Reading of the notice" },
      { time:"1:00", item:"Roll call and sign-in" },
      ...
      { time:"20:45", item:"Resolution approving out-of-home placement reserve increase (Item D15)" },
      { time:"21:30", item:"Resolution to amend social services budget (Item D16)" },
      { time:"22:00", item:"Resolution approving modification to landfill tipping fees (Item E17)" },
      { time:"1:15:00", item:"Announcements and adjournment" },
    ],
    discussions: [
      { item:"Committee appointments", body:"Chair Gibbs presented committee appointments developed with Vice Chair Boots, emphasizing goals of increasing diverse perspectives, developing new supervisors as leaders, and honoring supervisor preferences. Chair Gibbs noted over 34% of the board is in their first or second term. The appointments were moved by Supervisor Cavelli, seconded by Supervisor Crims, and carried but was not unanimous." },
      { item:"Election of at-large Executive Committee members", body:"Three supervisors were nominated: Supervisor Hapa (nominated by Supervisor Mask), Supervisor Leur (nominated by Supervisor Rosenberg), and Supervisor Arstead (nominated by Vice Chair Boots). Supervisor Rosenberg explained she nominated Supervisor Leur because she has seen her advocate for the county's youngest children and oldest elders. After paper ballot voting, Supervisors Hapa and Arstead were elected to the Executive Committee." },
      { item:"Consent agenda", body:"Items C10 through C14A were moved by Supervisor Cavelli and seconded by Supervisor Drebeck. The motion carried unanimously." },
      { item:"Resolution approving out-of-home placement reserve increase (Resolution 24-26)", body:"Moved by Supervisor Morash and seconded by Supervisor Robinson. The motion carried but was not unanimous." },
      { item:"Resolution to amend social services budget (Resolution 25-26)", body:"Moved by Supervisor P and seconded by Supervisor Robinson. The motion carried but was not unanimous." },
      { item:"Resolution approving modification to landfill tipping fees (Resolution 26-26)", body:"Administrator Leonard and Director Hagen Busher explained the proposal from the Solid Waste Management Board to reduce tipping fees for disaster-related debris following severe weather in Ringle and other areas. The state is waiving its $13.10 fee and Ringle its $2.33 fee. The county proposal reduces the rate to approximately $36.94 per ton (covering costs) for certified storm debris. Public comment was allowed from Jessica Toasty and Matt Haybeck, who requested the county waive fees entirely and extend the period to six months. Multiple supervisors asked clarifying questions about eligibility, timelines, and budget impact. The board voted unanimously to suspend rules to bring the resolution forward, then passed Resolution 26-26 unanimously." },
    ],
    publicComment: "Two residents were granted special permission to speak on the tipping fee resolution. Jessica Toasty from Ringle asked Marathon County to waive its landfill fees entirely for disaster debris, noting the state, DNR, and Ringle are waiving their fees and that private businesses have donated significant resources. She requested a six-month waiver period. Matt Haybeck spoke on behalf of homeowners needing house demolitions, noting many are underinsured and waiting on insurance adjusters, and asked for relief and more time for the fee waiver.",
    actionItems: [
      ...
      "Resolution 24-26 approving out-of-home placement reserve increase approved",
      "Resolution 25-26 amending social services budget approved",
      "Resolution 26-26 approving reduced landfill tipping fees for disaster-related debris approved unanimously",
      "Administrator Leonard to continue discussions with the Community Foundation regarding a reimbursement mechanism for unreimbursed insurance costs",
      "Solid Waste Management Board to develop a formal policy for handling similar disaster situations within six months",
      "Board to revisit tipping fee waiver timeline at May meeting if extension is needed",
    ],
  },
  {
    ...
    isAgendaOnly: false,
    badge: "new",
    overview: "The Marathon County Environmental Resources Committee approved two rezoning petitions and voted to forward a modified fee waiver resolution to the county board that would only cover septic system reconnect fees for properties impacted by the April 17, 2026 tornado. The committee also received educational presentations from the Solid Waste, Parks Recreation and Forestry, and Conservation Planning and Zoning departments.",
    agenda: [
      ...
      { time:"56:15", item:"Solid Waste Department overview presentation" },
      { time:"1:16:30", item:"Parks, Recreation and Forestry Department overview presentation" },
      { time:"1:35:00", item:"Conservation Planning and Zoning Department overview presentation" },
    ],
    discussions: [
      { item:"Approval of March 31st, 2026 committee minutes", body:"Supervisor Sefeld made a motion to approve the minutes with Supervisor Drebeck providing the second. The motion carried unanimously with no discussion." },
      { item:"Tim Veland rezoning petition - Town of Green Valley", body:"Land Use Specialist Garrett Pogle presented the staff report for rezoning from urban residential and general agriculture to rural residential for a proposed land division. The Town of Green Valley Town Board recommended approval on March 10, 2026. No public testimony was offered for or against. Supervisor Drebeck moved to approve based on findings of fact, conclusions of law, and town approval. Supervisor Kurt seconded. Motion carried unanimously." },
      { item:"Jeffrey and Cynthia Schmidtz rezoning petition - Town of McMillan", body:"Staff presented the petition to rezone from conservancy recreation to general agriculture. Supervisor Leur asked about the conservancy nature of the property; Garrett Pogle explained the property contains a home and horse riding stable, and the rezoning would make the structures conforming uses rather than non-conforming. No natural areas would be lost. The Town of McMillan recommended approval on April 20, 2026. No public testimony was offered. Supervisor Sefeld moved to approve and forward to county board; Supervisor Drew seconded. Motion carried unanimously." },
      { item:"Fee waivers for April 17, 2026 severe weather impacted properties", body:"Director Lori Mskimmons presented a proposal to waive county zoning and septic system fees for properties damaged by the April 17 tornado affecting towns of Ringle, Easton, and villages of Kronenwetter and Weston. Supervisor Drew questioned where to draw the line for future events. Supervisor Drebeck questioned fairness compared to individual tornado victims not in declared disaster areas. Eric Vogel asked whether insurance would cover fees. After significant debate, Supervisor Sefeld moved to forward the resolution; Supervisor Leur seconded. Supervisor Drebeck then amended the motion to only waive reconnect fees ($160) for septic systems, not other zoning or septic fees. Supervisor Kurt seconded the amendment. The amendment passed. The amended motion to forward to county board passed but was noted as not unanimous." },
      { item:"Solid Waste Department overview", body:"Director David Hagenbusher presented on department operations including the landfill facility active since 1980, the renewable natural gas partnership with Vidi Energy launched in 2023, leachate treatment challenges due to PFAS regulations requiring treatment by 2032, and upcoming $6 million expansion projects. Marilyn Bend praised the department for keeping private landfill costs competitive. Supervisor Brew asked about grant funding; Hagenbusher reported their Clean Water Fund application was deemed incomplete and they will reapply for 2027 funding." },
      { item:"Parks, Recreation and Forestry Department overview", body:"County Forest Administrator Tom Lovelin presented on behalf of Director Jamie, covering the joint city-county park system operational since 1924, 17 county parks, 30,700 acres of county forest, and Nine Mile County Forest which generates $3.25 million annually for the local economy from out-of-town visitors. Supervisor Sefeld announced that Tom Lovelin is retiring June 1st after nearly 30 years of service. Chair Ritterder thanked him for his years of service." },
    ],
    publicComment: "No public comment was offered.",
    actionItems: [
      "Rezoning from urban residential and general agriculture to rural residential for James Offer and David Tract property in Town of Green Valley approved and forwarded to county board",
      "Rezoning from conservancy recreation to general agriculture for Jeffrey and Cynthia Schmidtz property in Town of McMillan approved and forwarded to county board",
      "Modified resolution to waive only septic system reconnect fees ($160) for tornado-impacted properties forwarded to county board for consideration",
      "Town of Green Valley should update comprehensive plan to reflect zoning change if applicable",
      "Town of McMillan should update comprehensive plan to reflect zoning change if applicable",
    ],
  },
  {
