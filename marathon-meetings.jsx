...
const MEETINGS = [
  {
    ...
    date: "May 20, 2026", shortDate: "MAY 20",
    committee: "Public Works", duration: "~1h",
    url: "https://www.youtube.com/watch?v=j64Gj2ean2k",
    docUrl: null,
    isAgendaOnly: false,
    badge: "new",
    overview: "The Village of Weston Public Works Committee approved several contracts and agreements, including a $126,900 recycled asphalt crushing contract with King Gravel, a construction agreement with Village of Rothschild for Military Road improvements costing approximately $94,860, and construction service proposals for two road projects. The committee also directed staff to develop enforcement language for sanitary sewer discharge violations with fines starting at $100 per day.",
    agenda: [
      { time:"0:09", item:"Call to order" },
      { time:"0:25", item:"Pledge of Allegiance" },
      { time:"0:52", item:"Guest attendance" },
      { time:"1:08", item:"Roll call" },
      { time:"1:22", item:"Public comment" },
      { time:"1:28", item:"Approval of April 13, 2026 meeting minutes" },
      { time:"1:43", item:"Acknowledge April 2026 water and sewer permits" },
      { time:"2:00", item:"CIP update" },
      { time:"18:58", item:"Street operations update" },
      { time:"29:34", item:"Utility operations update" },
      { time:"43:35", item:"Review 2025 Water Utility PSC annual reports" },
      { time:"48:30", item:"Resolution 2026-014 transportation funding" },
      { time:"52:48", item:"Recycled base course production" },
      { time:"56:30", item:"Sanitary sewer discharge violation discussion" },
      { time:"71:20", item:"Water and sewer connection agreement for Radkey Avenue" },
      { time:"76:40", item:"Military Road construction agreement" },
      { time:"81:25", item:"Construction service proposals for Alderson\/Jelnik and Bladel projects" },
    ],
    discussions: [
      { item:"CIP Update", body:"Michael reported the village received a Local Road Improvement Grant for Birch Street reconstruction between Schofield Avenue and Community Center Drive, covering over 50% of the estimated $1.5 million project. This 2029 project may be moved to 2028. He noted the village has received over $9 million in grant funding over the past 4-5 years. Updates were given on Weston Avenue repairs by Integrity Grading and Excavating, and upcoming repairs on Schofield Avenue and Fuller Street addressing manhole settlements." },
      { item:"Street Operations Update", body:"Staff reported road limits were removed April 29th. Significant dewatering operations occurred near Weston Avenue tributary for approximately one week due to heavy rain. Spring sweeping, patching with hot mix, storm damage cleanup, and culvert repairs on Jones Street were completed. Discussion ensued about potential permanent pump solutions for recurring flooding issues near Crane Meadows area." },
      { item:"Utility Operations Update", body:"Josh reported on water service repairs, well maintenance, and significant clear water infiltration issues. April sanitary flows showed 53-54 million gallons treated versus only 37 million gallons of water pumped into the system, indicating approximately 15 million gallons of clear water infiltration. Staff caught residents with sump pumps illegally connected to sanitary sewers. InPipe Technologies will be conducting an infiltration study." },
      { item:"2025 Water Utility PSC Annual Reports", body:"Michael reviewed the annual report showing net operating income of $482,911 for 2025, consistent with the prior year. Water loss was 6%. The utility value reached nearly $34 million with $6.7 million in infrastructure placed in service. Additional non-operating revenue of $1.44 million came from PFAS settlement funds. Motion to acknowledge passed unanimously." },
      { item:"Resolution 2026-014 Transportation Funding", body:"The committee discussed a League of Wisconsin Municipalities resolution supporting long-term state transportation funding solutions. Michael noted local communities subsidize transportation costs with general tax dollars due to insufficient state funding. The committee voted to recommend village board adoption of Resolution 2026-014. Passed unanimously." },
      { item:"Recycled Base Course Production", body:"Michael presented the annual asphalt crushing contract, noting King Gravel was low bidder at $4.23\/ton for an estimated 30,000 tons totaling $126,900. He demonstrated the program saves approximately $11 per cubic yard compared to City of Wausau costs, equating to roughly $130,000 savings on this year's projects. Motion to award to King Gravel passed unanimously." },
      { item:"Sanitary Sewer Discharge Violations", body:"Committee discussed enforcement of sewer discharge violations, particularly illegal sump pump connections. After debate about willful versus unknowing violations, the committee directed staff to develop enforcement language with fines of $100 per day for violations. Trustee Zagami suggested waiting for InPipe Technologies' study results before sending violation notices. Motion passed unanimously." },
      { item:"Radkey Avenue Water\/Sewer Connection Agreement", body:"Michael presented an agreement allowing a duplex developer to temporarily connect to water and sewer mains via long lateral services until Radkey Avenue reconstruction. Committee amended the agreement to specify reconstruction would occur no later than 2029, at which time the property owner would pay assessments for main extensions. Motion passed unanimously." },
      { item:"Military Road Construction Agreement", body:"The committee reviewed an intergovernmental agreement with Village of Rothschild for Military Road construction. Weston's share for water main relocation and sanitary sewer work is estimated at $94,860. Steam Construction is the contractor. Motion to recommend board approval passed unanimously." },
      { item:"Construction Services for Alderson\/Jelnik and Bladel Projects", body:"Michael presented proposals for construction inspection services. For Alderson\/Jelnik intersection, MSA proposed $37,315 versus Clark Dietz at $48,910. For Bladel Avenue, MSA proposed $70,400 versus Clark Dietz at $73,730. Staff recommended MSA for the roundabout project and Clark Dietz for Bladel due to having full-time experienced staff versus an intern. Motion passed unanimously." },
    ],
    ...
    actionItems: [
      ...
      "Direct staff to develop sanitary sewer discharge violation enforcement language with $100\/day fines",
      "Authorize staff to enter water\/sewer connection agreement for 2230 Radkey Avenue with 2029 reconstruction deadline",
      "Recommend board approve Military Road construction agreement with Rothschild ($94,860 Weston share)",
      "Award construction services to MSA for Alderson\/Jelnik project and Clark Dietz for Bladel Avenue project",
      "Schedule special assessment meeting for Bladel Avenue on Thursday, May 28, 2026 at 6:00 PM",
      "Norcon to begin Schofield Avenue concrete repairs starting Wednesday\/Thursday",
    ],
  },
  {
    ...
    isAgendaOnly: false,
    badge: "new",
    overview: "The Village of Weston Plan Commission approved a site plan for the new Mountain Bay Metropolitan Police Department and Municipal Court facility at 3600 Community Drive, and adopted a new salt storage shed inspection program for wellhead protection areas. Both items passed unanimously with all commissioners present voting in favor.",
    agenda: [
      { time:"0:01", item:"Call to order and roll call" },
      { time:"1:23", item:"Open public comment period" },
      { time:"4:47", item:"Approval of April 13, 2026 meeting minutes" },
      ...
      { time:"19:22", item:"Creation of salt storage shed inspection program for Wellhead Protection District" },
      { time:"27:45", item:"April 2026 staff approved certified survey maps and site plans" },
      { time:"28:03", item:"April 2026 building permits" },
      { time:"28:18", item:"Planning and development department monthly project update report" },
      { time:"30:08", item:"Commissioner remarks" },
      { time:"30:45", item:"Future agenda items and adjournment" },
    ],
    discussions: [
      { item:"Mountain Bay Metro Police Department and Municipal Court facility site plan", body:"Staff presented the site plan for the new police department and municipal court at 3600 Community Center Drive. The project meets all B2 district zoning requirements. Police Chief Jeremy explained the building was rotated to face east due to a gas pipeline easement running under the parking lot, which significantly reduced fill costs. The building will accommodate 50-60 officers (current staffing is 40 officers plus 4 clerical staff) with potential for future expansion to the north. An alternate storage shed is proposed but may be built later depending on bid costs. Commissioner Garant moved to recommend approval subject to staff conditions 2-5. Motion passed unanimously." },
      { item:"Salt storage shed inspection program for Wellhead Protection District", body:"Staff proposed a biannual inspection program for salt storage facilities within wellhead protection areas - one inspection in warm weather focusing on structural integrity and one in winter focusing on operational practices. The program uses a standardized inspection worksheet similar to DOT requirements. Staff noted one existing facility near the Sternberg Road well has never gone through the wellhead protection conditional use process and they will reach out to bring it into compliance. Motion to approve the program with reporting back to both Plan Commission and Public Works Committee passed unanimously." },
      ...
      { item:"Monthly project update and future items", body:"Staff announced the first joint Plan Commission\/Village Board steering committee meeting for the comprehensive plan is scheduled for Monday, June 1st at 5:00 p.m. Discussion arose about potential residential TIF districts for workforce housing, with staff noting Ehlers has prepared a presentation on qualifications that could be shared with commissioners or incorporated into comprehensive plan discussions." },
    ],
    publicComment: "Jim Pensel of 5002 Arrow Street, Weston, spoke via remote connection. He urged the commission to exercise common sense regarding landscaping requirements for the police department project, asking that taxpayer dollars not be spent on excessive landscaping points similar to the Green Heck Turner building. He also requested that the salt shed inspection program include annual reporting on site visits and findings, noting some zoning complaints are years old and get 'lost in the sauce.'",
    actionItems: [
      "Site plan for Mountain Bay Metro Police Department and Municipal Court facility at 3600 Community Center Drive approved and forwarded to Board of Trustees",
      "Salt storage shed inspection program adopted with biannual inspections beginning summer 2026",
      "Staff to report inspection findings to Plan Commission and Public Works Committee around May 2027",
      "Staff to reach out to existing salt storage facility near Sternberg Road well regarding wellhead protection compliance",
  ...
  },
  {
    ...
    isAgendaOnly: false,
    badge: "new",
    overview: "The Marathon County Health & Human Services Committee held an introductory meeting for new board members, providing educational presentations on the Health Department, Social Services, Veteran Services, and Aging Disability Resource Center. The committee approved the April 1st meeting minutes unanimously and received detailed briefings on department missions, budgets, and current initiatives including homelessness response, veteran suicide prevention, and nutrition services for seniors.",
    agenda: [
      { time:"0:00", item:"Call to order and confirmation of remote participants" },
      { time:"0:30", item:"Pledge of Allegiance" },
      { time:"1:07", item:"Approval of April 1st committee meeting minutes" },
      { time:"1:45", item:"Operational functions required by statute (no items)" },
      { time:"3:30", item:"Review of standing committee ordinance, missions, duties and responsibilities" },
      { time:"11:55", item:"Health Department presentation" },
      { time:"25:04", item:"Social Services Department overview" },
      { time:"50:01", item:"Veteran Service Department presentation" },
      { time:"1:15:00", item:"Aging Disability Resource Center presentation" },
      { time:"1:30:00", item:"Next meeting date and adjournment" },
    ],
    discussions: [
      { item:"Approval of April 1st meeting minutes", body:"Supervisor Cavalli made a motion to approve the minutes, seconded by Vice Chair Rosenberg. The motion carried unanimously with all in favor." },
      { item:"Review of standing committee ordinance and structure", body:"Administrator Lance Leonard explained the committee's jurisdiction including oversight of the Health Department, Social Services, Veteran Services, and affiliated multi-county entities North Central Health Care and the Aging Disability Resource Center. He outlined the committee's relationship with various statutory boards including the Social Services Board, Veteran Service Commission, and Board of Health, noting these bodies provide input but don't directly supervise department heads." },
      { item:"Health Department presentation", body:"Health Officer Caitlyn Suginaka presented the department's mission of preventing disease, promoting health, and protecting against environmental hazards. She highlighted over 1,200 licenses the department oversees, the nurse family partnership program now graduating its first two-year-olds, public health vending machines stocked with free resources including tick kits, and a new FTE position for homeless system response. The department has approximately 37.6 FTE with a budget around $5 million, of which about half is tax levy. Supervisor Kremes asked about pandemic preparedness, and Suginaka confirmed the department has plans in place, conducts regular training exercises, and has practiced measles response scenarios." },
      { item:"Social Services Department overview", body:"Administrator Leonard presented on behalf of absent Director Christa, describing the department's divisions including child welfare, youth justice, children's long-term support, economic support, and child support. The department has nearly 140 FTE with a budget over $22 million but only about $7 million in tax levy. He highlighted the successful Family Keys pilot program addressing housing instability, noting significant numbers of clients had never had a bank account or been on a formal lease before entering the program." },
      { item:"Veteran Service Department presentation", body:"Veteran Service Officer Aaron Galindo reported his office now has 3.0 FTE after a recent increase. In 2025, the office had 8,149 interactions (up from 5,900). Veterans in Marathon County received $2.6 million in retroactive VA payments and $44 million annually in total compensation. Galindo highlighted priorities including surviving spouse benefits (dependency and indemnity compensation can provide $1,800-2,400\/month tax-free), housing stability through HUD-VASH partnerships, and suicide prevention noting Marathon County had 30 suicides in 2025 with 7 being veterans. He's pursuing the Staff Sergeant Gordon Fox suicide prevention grant. Supervisor Kremes asked about regional coordination; Galindo explained state statute requires each county to have a VSO and described strong working relationships with neighboring counties." },
      { item:"Aging Disability Resource Center presentation", body:"Executive Director Mike Ray explained the ADRC serves four counties (Marathon, Lincoln, Langlade, and Wood) providing one-stop services for aging and disability resources, including Meals on Wheels. He noted the organization has about 60 FTEs plus 385-400 volunteers. Ray highlighted significant financial challenges: federal funding has remained flat while nutrition costs increased 40-45% in four years. The organization hadn't requested a levy increase from 2011 until 2024. Marathon County's 2026 contribution is $413,135. Vice Chair Rosenberg thanked the program, noting her volunteer experience at the Hmong American Center meal site." },
    ],
    publicComment: "No public comment was offered.",
    actionItems: [
      "April 1st committee meeting minutes approved unanimously",
      "North Central Healthcare to be scheduled for separate full presentation before the committee",
      "ADRC Executive Director Mike Ray to present annual report with 2025 data to full county board",
      "Committee members to email Chair Boots and Administrator Leonard with items for future agendas",
      "Strategic plan discussion to be added to upcoming agenda",
      "Next meeting scheduled for Wednesday, June 3rd at 3:00 PM (corrected from originally stated May 29th)",
    ],
  },
  {
    ...
    isAgendaOnly: false,
    badge: "new",
    overview: "The Marathon County Board held an adjourned organizational meeting where they approved committee appointments, elected Supervisors Hapa and Arstead to at-large executive committee positions, and unanimously approved a resolution to reduce landfill tipping fees for storm debris following the recent tornado and flooding disaster. The tipping fee reduction allows affected residents to dispose of disaster-related debris at $36.94 per ton instead of the standard $65 rate.",
    agenda: [
      { time:"0:00", item:"Pledge of Allegiance and moment of reflection" },
      { time:"0:35", item:"Reading of meeting notice" },
      { time:"1:15", item:"Roll call (with technical difficulties)" },
      { time:"5:01", item:"Committee appointments discussion and Chair remarks" },
      ...
      { time:"22:00", item:"Resolution 25-26: Social services budget amendment" },
      { time:"23:00", item:"Resolution 26-26: Modification to landfill tipping fees" },
      { time:"1:15:00", item:"Announcements and adjournment" },
    ],
    discussions: [
      { item:"Committee Appointments", body:"Chair Gibbs outlined the goals guiding committee appointments, including increasing diversity of perspective, ensuring leadership development opportunities for newer supervisors (34% in first or second term), and honoring supervisor preferences. He thanked Vice Chair Boots for assistance in developing appointments. The motion by Supervisor Cavelli, seconded by Supervisor Crims, was carried but not unanimous." },
      { item:"Election of At-Large Executive Committee Members", body:"Three supervisors were nominated: Supervisor Hapa (nominated by Supervisor Mask), Supervisor Leur (nominated by Supervisor Rosenberg, who cited her advocacy for young children and elderly residents), and Supervisor Arstead (nominated by Vice Chair Boots). Paper ballots were distributed for supervisors to select two candidates. Supervisors Hapa and Arstead were elected to the executive committee." },
      { item:"Consent Agenda", body:"Items C10 through C14A were approved on motion by Supervisor Cavelli, seconded by Supervisor Drebeck. The motion carried unanimously." },
      { item:"Resolution 24-26: Out of Home Placement Reserve Increase", body:"Motion by Supervisor Morash, seconded by Supervisor Robinson. The motion carried but was not unanimous." },
      ...
      { item:"Resolution 26-26: Modification to Landfill Tipping Fees", body:"Administrator Leonard and Solid Waste Director Hagen Busher presented the proposal from the Solid Waste Management Board to reduce tipping fees for disaster-related debris from $65\/ton to $36.94\/ton (after state waives $13.10 and Ringle waives $2.33). The rules were suspended unanimously to bring the resolution directly from the Solid Waste Management Board. Public speakers Jessica Toasty and Matt Haybeck requested the county waive fees entirely, noting 44 homes affected and many awaiting insurance adjusters. Supervisor Robinson suggested tracking costs and potentially revisiting the policy. Administrator Leonard mentioned exploring partnership with the Community Foundation for reimbursing unreimbursed insurance costs. Motion by Supervisor Arstead, seconded by Supervisor Morash, passed unanimously." },
    ],
    publicComment: "Special dispensation was granted for two speakers on the landfill tipping fee resolution. Jessica Toasty asked the county to fully waive fees, noting the state, DNR, and Ringle are waiving their portions, and that businesses have donated up to $40,000 in cleanup services. She requested a six-month waiver period. Matt Haybeck spoke on behalf of residents whose homes must be demolished, noting some of the 44 affected homes are still awaiting insurance adjusters and requested extended relief.",
    actionItems: [
      ...
      "Landfill tipping fees reduced to $36.94\/ton for disaster-related debris through June 17, 2025",
      "Administrator Leonard to explore partnership with Community Foundation for reimbursing unreimbursed insurance costs for disaster victims",
      "Solid Waste Management Board to develop long-term policy for handling disaster situations within six months",
      "Staff to track disaster-related waste separately and certify debris through signed forms",
    ],
  },
  {
    ...
    isAgendaOnly: false,
    badge: "new",
    overview: "The Marathon County Environmental Resources Committee approved two rezoning petitions and voted to forward a modified fee waiver proposal to the county board that would waive only reconnect fees for septic systems for properties damaged by the April 17, 2026 tornado. The committee also received department overviews from Solid Waste, Parks Recreation and Forestry, and Conservation Planning and Zoning.",
    agenda: [
      ...
      { time:"19:45", item:"Consideration of fee waivers for properties impacted by April 17, 2026 severe weather" },
      { time:"56:30", item:"Solid Waste Department overview presentation" },
      { time:"1:15:45", item:"Parks, Recreation and Forestry Department overview presentation" },
      { time:"1:34:30", item:"Conservation Planning and Zoning Department overview presentation" },
    ],
    discussions: [
      { item:"Approval of March 31, 2026 committee minutes", body:"Supervisor Sefeld made a motion to approve the minutes with Supervisor Drebeck seconding. The motion carried with no opposition." },
      { item:"Tim Veland rezoning petition - Town of Green Valley", body:"Land Use Specialist Garrett Pogle presented the staff report for rezoning from urban residential and general agriculture to rural residential for a proposed land division. The Town of Green Valley recommended approval on March 10, 2026. No public testimony was offered. Supervisor Drebeck moved to approve based on findings of fact, conclusions of law, and town approval. Supervisor Kurt seconded. Motion carried unanimously." },
      { item:"Jeffrey and Cynthia Schmidtz rezoning petition - Town of McMillan", body:"Garrett Pogle presented the rezoning request from conservancy\/recreation to general agriculture. Supervisor Leur asked about the conservancy nature of the property; Pogle explained it currently has a home and horse riding stable, and the rezoning would make the home a conforming use rather than non-conforming. No natural areas are being lost. The Town of McMillan recommended approval on April 20, 2026. No public testimony was offered. Supervisor Sefeld moved to approve, Supervisor Drew seconded. Motion carried unanimously." },
      { item:"Fee waivers for April 17, 2026 severe weather damage", body:"Director Lori Mskimmons presented a proposal to waive county zoning and septic system fees for properties damaged by the April 17 tornado affecting the towns of Ringle, Easton, and villages of Kronenwetter and Weston. Supervisor Drew questioned where to draw the line for future events. Supervisor Leur asked about tracking costs. Supervisor Drebeck raised fairness concerns about properties not in declared disaster areas. After debate, Supervisor Drebeck proposed an amendment to limit the waiver to only reconnect fees ($160) for septic systems, excluding other zoning and septic fees. Supervisor Kurt seconded the amendment. The amendment carried. The amended motion to forward to the county board then passed, though not unanimously." },
      { item:"Solid Waste Department overview", body:"Director Dave Hagen Busher presented an overview of the solid waste operation, explaining the landfill serves Marathon, Portage, and Shawano counties, accepting about 1,000 tons daily. He highlighted the renewable natural gas partnership with Vidi Energy that began injecting gas into pipelines in September 2025, upcoming leachate treatment requirements by 2032 due to PFAS regulations, and significant capital expenses including a $6 million 11-acre expansion project." },
      { item:"Parks, Recreation and Forestry Department overview", body:"County Forest Administrator Tom Lovelin presented on behalf of Director Jamie, covering the joint city-county operation with 44 full-time and 120 seasonal employees. He noted Nine Mile County Forest generates $3.25 million annually for the local economy from out-of-town visitors. Supervisor Sefeld announced that Tom Lovelin is retiring June 1st after nearly 30 years of service, with Joe Tucker selected as the new county forest administrator." },
    ],
    publicComment: "No public comment was offered.",
    actionItems: [
      "Rezoning petition for James Offer and David Tract approved and forwarded to Marathon County Board of Supervisors",
      "Rezoning petition for Jeffrey and Cynthia Schmidtz approved and forwarded to Marathon County Board of Supervisors",
      "Modified fee waiver resolution (reconnect fees only for septic systems) forwarded to county board for properties damaged by April 17, 2026 severe weather",
      "CPZ staff to track costs and requests related to the fee waiver program",
  ...
  },
  {
    ...
    isAgendaOnly: false,
    badge: "new",
    overview: "The Village of Weston Community Life and Public Safety Committee met on May 4th to advance several ordinance changes and address community safety matters. Key actions included recommending approval of nuisance code amendments, an e-bike ordinance with emoto restrictions, mobile food vendor fire inspections, address corrections, and a raze order for an abandoned property at 4104 Shore Avenue.",
    agenda: [
      ...
      { time:"6:00", item:"Written communications received" },
      { time:"6:30", item:"Code enforcement report" },
      { time:"8:00", item:"Fire\/EMS Safer report" },
      { time:"8:45", item:"Police department report" },
      { time:"11:30", item:"Proposed amendments to Chapter 50 nuisances" },
      { time:"13:00", item:"E-bicycle ordinance in Chapter 82" },
      { time:"34:30", item:"Overnight parking regulations discussion" },
      { time:"50:30", item:"Crosswalk request for Alderson Street" },
      { time:"62:00", item:"Mobile food vendor fire inspection ordinance" },
      { time:"70:00", item:"Address corrections for E911 compliance" },
      { time:"75:00", item:"Raze order for 4104 Shore Avenue" },
    ],
    discussions: [
      { item:"Public Comment", body:"Jim Senalt provided extensive public comment criticizing the new farmers market location at Veteran's Memorial Park, expressing concerns that grass parking will destroy the park and that ADA accessible spaces placed on grass violate requirements for firm surfaces. He questioned the origin of new fire inspections for food trucks and noted that several code enforcement cases have been pending for years without visible progress." },
      { item:"Code Enforcement Report", body:"Roman and Audrey presented the code enforcement report. Staff noted that cases with enforcement suspended may move back to pending status now that construction season has begun. Good news was reported that 3020 Mountain View Avenue will be removed from the code enforcement roll after the property sale was completed and the new owner submitted permits for repairs." },
      { item:"Police Department Report", body:"Chief Hunt reported 2,394 calls for March (77 per day, 3.2 per hour), 410 traffic stops, and 281 citations issued. The department has hired its 40th officer, with the 38th starting last week, 39th starting in May, and 40th around January. Two SROs work with zoning violations during summer for all three municipalities, also handling pet licensing compliance." },
      { item:"Chapter 50 Nuisance Amendments", body:"Committee discussed final copy of proposed nuisance code amendments, including the tree limb height requirements (14 feet over streets, 10 feet over walkways) that were switched as discussed previously. Motion to recommend approval to board of trustees made by Olsen, seconded by Kimi. Passed unanimously." },
      { item:"E-Bicycle Ordinance", body:"Extensive discussion on e-bike regulations. Chief Hunt strongly recommended prohibiting emotos (electric dirt bikes) from roadways, sidewalks, and trails due to safety concerns, comparing them to unlicensed dirt bikes. Committee debated whether to also restrict electric scooters but decided to leave officer discretion for children's play scooters. Motion by Olsen to recommend approval with addition that emotos are prohibited from operating on roadways, sidewalks, trails, or any public property in the Village of Weston. Seconded by Chwanka. Passed unanimously." },
      { item:"Overnight Parking Regulations", body:"Brent Tolson presented research showing Weston's 12-hour overnight parking window (4am-4pm, October 31-May 1) is far outside other municipalities which typically have 4-5 hour windows. Michael (Public Works) suggested either eliminating the regulation entirely and signing specific problem areas, or matching Rothschild's regulations. Chief Hunt preferred keeping overnight restrictions to give officers time to clear cars before plowing. Committee decided to table the item until July, directing Michael to identify specific problem areas and develop logistics for a more targeted approach." },
      { item:"Crosswalk Request on Alderson Street", body:"Mount Olive Church requested a crosswalk between their property and DC Everest administrative parking lot. Michael estimated a basic crosswalk would cost approximately $2,000-$3,000, while a lighted system would cost $25,000-$30,000. Committee members expressed reluctance to pay for crosswalks requested by private entities. Motion by Olsen that if Mount Olive is willing to cover the cost of installation, committee recommends board approval. Seconded by Chwanka. Passed unanimously. Michael to contact Mount Olive regarding cost-sharing." },
      { item:"Mobile Food Vendor Fire Inspections", body:"Chief presented ordinance 26-8 creating a regional fire inspection program for food trucks involving Wisconsin Rapids, Marshfield, Stevens Point, Plover, Rib Mountain, and Safer. Inspections would be valid across all participating municipalities with a sticker system. Wausau opted not to participate, preferring their own system. Chief noted one recent inspection failed due to galvanized steel LP piping and improperly secured propane containers. Motion by Chwanka to approve ordinance 26-8, seconded by Campkey. Passed unanimously." },
      { item:"Address Corrections", body:"Staff presented three address correction requests for E911 compliance: 5915 Delicoski Street (duplex needing separate addresses), properties on Ross Avenue that are out of sequence, and 2211 Radkey Avenue for a new duplex on a private drive. Chief Hunt added another address issue at Weston Villa Apartments on Delicoski where an 8-plex has nine separate addresses. Motion to recommend approval passed unanimously." },
      { item:"Raze Order for 4104 Shore Avenue", body:"Staff requested authorization to begin raze proceedings on an abandoned structure at 4104 Shore Avenue. The property has been abandoned since 2010-2011 and was too deteriorated for a fire training burn. Previous owners had housed chickens inside the structure. Current owners are up to date on taxes and preferred the raze approach. Costs will be added to the tax roll. Motion by Olsen, seconded by Campkey. Passed unanimously." },
    ],
    publicComment: "Jim Senalt spoke during public comment, criticizing the new farmers market location at Veteran's Memorial Park. He raised concerns about vehicles parking on grass potentially violating village code, ADA accessible spaces being placed on grass rather than asphalt, the origin of new fire inspection requirements for food trucks, and the lack of progress on long-standing code enforcement cases. He suggested the committee should receive regular updates on older enforcement cases.",
    actionItems: [
      ...
      "Michael (Public Works) to develop list of specific areas needing special parking signage for overnight parking discussion in July",
      "Michael to contact Mount Olive Church regarding willingness to pay for crosswalk installation on Alderson Street",
      "Recommend approval of ordinance 26-8 for mobile food vendor fire inspections to board of trustees",
      "Recommend approval of address corrections for E911 compliance to board of trustees",
      "Authorize staff to begin raze order proceedings on 4104 Shore Avenue",
      "Staff to investigate property condition issue at Sternberg and South Timber",
