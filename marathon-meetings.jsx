...
const MEETINGS = [
  {
    ...
    isAgendaOnly: false,
    badge: "new",
    overview: "The Wausau City Council approved a major $10 million development agreement for 11 Scott Street (Wateride Place) by a 6-3 vote, which will convert a vacant 100,000 square foot building into 52 mid-priced residential units downtown. The council also recognized public works crews for their response to a record-breaking 30.9-inch snowfall and presented the 2026 Sustainability Award to Colby and Colby Millwork for their solar energy initiatives.",
    agenda: [
      ...
      { time:"19:15", item:"Public comment period" },
      { time:"21:00", item:"Consent agenda" },
      { time:"21:30", item:"Development agreement for 11 Scott Street\/Wateride Place" },
      { time:"35:00", item:"Mayoral appointments to Plan Commission, Affordable Housing Task Force, and BID Board" },
      { time:"36:00", item:"Solid waste and recycling service agreement with Harter's Fox Valley Disposal" },
      { time:"37:30", item:"Settlement resolution - David Holes vs City of Wausau" },
      { time:"40:00", item:"Announcements and adjournment" },
    ],
    discussions: [
      { item:"Development Agreement for 11 Scott Street\/Wateride Place (File 25-1011)", body:"The council debated a joint resolution from economic development and infrastructure committees for a $10+ million project to convert a vacant 100,000 square foot building into 52 mid-priced residential units. Developers Raleigh Lray and Mark Craig spoke in public comment urging support. Alder Rasmusson emphasized the project would return parking spaces to public use and add downtown vibrancy. Alder Neil cited $55,000 annual parking revenue and TID 8 closure benefits. Alder Larson dissented, arguing against discounting city assets during budget cuts. Alder Tierney questioned parking obligations if the ramp closes, with Economic Development Director Randy Feifer explaining the agreement reduces required spaces from 480 to 150. Motion passed 6-3." },
      { item:"Mayoral Citation for Public Works Snow Response", body:"Mayor Denny presented a citation recognizing DPW plow crews and municipal fleet staff for responding to a historic 30.9-inch snowfall from March 14-16, 2026. Street Supervisor Kevin Kester accepted the award, praising the mechanics and plow operators. Kester noted fleet technicians worked 12 straight days without a day off and maintained 12-hour shifts for 24-hour breakdown support. Two technicians volunteered on Saturday for downtown snow removal." },
      { item:"2026 Sustainability Award to Colby and Colby Millwork", body:"Sustainability Committee member Christine Daniels presented the award to Keith Kaning and Mike Thompson from Colby and Colby Millwork. Thompson explained the company installed over 2,000 solar panels on their 11th Avenue facility, operational since July 2025, generating enough power for about 120 homes. The company also converted to LED high bay lighting and recycles all manufacturing scrap materials including wood, aluminum, glass, and vinyl." },
      { item:"Solid Waste and Recycling Service Agreement (File 92-109)", body:"The council approved a 7-year residential solid waste and recycling service agreement with Harter's Fox Valley Disposal. Mayor Denny noted a prior mix-up between 7-year and 10-year terms had been corrected to match the Public Health and Safety Committee's recommendation. Approved 9-0." },
      { item:"Settlement Resolution - David Holes vs City of Wausau (File 26-0307)", body:"Assistant City Attorney Vincent Bonito explained a 2022 bus accident where Transit Mutual insurance paid the claim, then the individual who hit the bus filed a personal injury claim. The city filed a counter claim and the insurer agreed to pay bus damages. Alder Neil clarified this settlement is separate from the individual's ongoing injury claim. Approved 8-1 without need for closed session." },
      { item:"Suspension of Rules Items", body:"Council suspended rules by 7-2 vote to consider several items: an ordinance recreating Municipal Code Chapter 6.44 on solid waste disposal to align with state code (passed 9-0), paid duty time for out-of-country police training (passed 9-0), and community outreach professional shelter operations duty premium differential (passed 9-0)." },
    ],
    publicComment: "Two speakers addressed the council. Raleigh Lray from 11 Scott Street LLC requested support for the Wateride Place project, describing it as a green sustainable repurposing of a vacant building with mid-priced apartments. Mark Craig of 3246 North 8th Street joined her, noting the $10+ million project has been discussed extensively and acknowledged the previous 7-4 term sheet vote, asking for support to move the project forward.",
    actionItems: [
      ...
      "Municipal Code Chapter 6.44 on solid waste disposal recreated to align with state code",
      "Paid duty time approved for out-of-country police training",
      "Shelter operations duty premium differential approved",
...
,
  {
    ...
    isAgendaOnly: false,
    badge: "new",
    overview: "The Wausau Board of Public Works approved construction bids and change orders for multiple street projects. Key decisions included awarding the 26th Street\/North 8th Avenue construction project to Switlick, the lowest bidder by less than $1,000, and approving a $14,436.50 change order for the Rolph Street\/Cherry Street project to address unexpected underground conditions.",
    agenda: [
      { time:"0:00", item:"Call to order" },
      { time:"0:07", item:"Consideration of March 10th regular Board of Public Works minutes" },
      { time:"0:22", item:"Open bids for 26th Street construction project B, North 8th Avenue" },
      { time:"1:30", item:"Open bids for additional project (postponed)" },
      { time:"1:42", item:"2025 Street Construction Project A - Rolph Street, Cherry Street - Change Order 1" },
      { time:"3:41", item:"2025 Street Construction Project A - Pay Estimate Number 9" },
      { time:"4:02", item:"Portland cement concrete license for KSK Incorporated" },
      { time:"4:26", item:"Adjournment" },
    ],
    discussions: [
      { item:"March 10th Board of Public Works minutes", body:"Minutes from the March 10th meeting were presented for approval. A motion was made and seconded, passing with unanimous approval." },
      { item:"26th Street Construction Project B, North 8th Avenue - Bid Opening", body:"Seven bids were opened and read aloud. Switlick submitted the lowest bid at $1,279,089.75, narrowly beating Hos at $1,280,877.96 by less than $1,000. Other bids ranged up to $1,686,708.75 from Earth. A board member noted the remarkably tight bids. Motion to approve Switlick passed unanimously." },
      { item:"2025 Street Construction Project A - Change Order 1", body:"Staff presented four items totaling $14,436.50 for unexpected field conditions: an inside drop on a manhole ($4,856) due to an unrecorded large diameter sanitary service, water main connection adjustment ($2,317.50) when an 8-inch main was actually 6-inch, miscellaneous storm sewer tie-ins ($5,016), and geogrid installation ($2,247) for poor soils near Thomas Jefferson Elementary. Change Order 2 regarding liquidated damages was postponed pending further discussions. Motion to approve passed unanimously." },
      { item:"2025 Street Construction Project A - Pay Estimate Number 9", body:"Pay estimate for work completed through year-end was presented in the amount of $535,114.02 for Haw Suns Incorporated. Motion to approve passed unanimously." },
    ...
    actionItems: [
      ...
      "Approve Pay Estimate #9 for Haw Suns Incorporated at $535,114.02",
      "Issue Portland cement concrete license to KSK Incorporated",
      "Return with Change Order 2 after liquidated damages discussions are completed",
      "Return with postponed bid opening at future meeting",
    ],
    civicItems: [
...
,
  {
    ...
    isAgendaOnly: false,
    badge: "new",
    overview: "The Finance and Human Resources Committee debated and ultimately approved a modified employee clothing allowance policy after canceling the Cintas uniform contract. After three failed votes, the committee approved $400 for remainder of 2026 and $500 annually starting 2027, plus a one-time washer\/dryer purchase. The meeting also featured a detailed presentation on public works operations and budget.",
    agenda: [
      { time:"0:00", item:"Call to order and Pledge of Allegiance" },
      ...
      { time:"35:00", item:"Old business: Discussion and action on reimbursement for clothing and equipment allowance" },
      { time:"1:05:00", item:"Staff and committee remarks, future agenda items" },
      { time:"1:07:00", item:"Adjournment" },
    ],
    discussions: [
      { item:"Public Works Operation and Budget Presentation", body:"Public Works Director Michael delivered an extensive presentation on department operations, noting the 2026 budget decreased by nearly $26,000 (1.1% decrease) from 2025. He highlighted the department manages 119.5 centerline miles of road, 114 miles of water main, 103 miles of sanitary sewer, and 70 miles of storm sewer. Michael emphasized that Weston spends approximately $9,700 less per mile than the average central Wisconsin community. He noted the recent major snowstorm on March 15 cost approximately $50,000 and that staff worked 16-17 hour shifts, with the highest being 17.5 hours. The department currently has 9 employees with a 10th starting Wednesday, down from 11 when Michael started in 2010." },
      { item:"Reimbursement for Clothing and Equipment Allowance", body:"The committee engaged in extensive debate over increasing the employee clothing allowance from $300 to $600 after canceling the Cintas uniform contract. Committee member Stephanie questioned whether saved money should automatically be spent elsewhere given the upcoming fire department referendum needs. Michael argued staff deserve the benefit given their demanding work conditions and that the village already provides good value compared to other communities. The initial motion for $600 failed 3-3 on roll call (Daniels-yes, Armain-no, Love-yes, My-no, Sober-no, Chair-yes). A motion for $400 annually also failed 3-3. A motion for $500 annually with washer\/dryer failed. Finally, a motion for $400 for remainder of 2026 and $500 annually starting 2027 with one-time washer\/dryer purchase passed with one opposed." },
      { item:"February Financial Reports and Work Products", body:"All February financial reports, T1 and T2 detail reports, and legal details were acknowledged unanimously without discussion." },
      { item:"Minutes Approval", body:"Minutes from February 16, 2026 were approved unanimously. Motion by Steve, second by Stephanie." },
    ],
    publicComment: "Lisa Beck of 1808 Cortez Lane offered public comment. She praised Michael and public works staff for their response to the recent storm, stating she tries to recognize him at every meeting. She also expressed concern about the proposed clothing allowance increase, questioning why the village would give the highest proposed amount when savings were the goal of canceling Cintas, suggesting a lesser amount or no increase would be more fiscally responsible.",
    actionItems: [
      ...
      "Marathon County disaster relief application to be followed up with specific cost documentation for March 15 snowstorm",
      "Next meeting scheduled for Tuesday, April 21, 2026 at 5:00 PM due to new board member swearing-in",
    ],
  },
,
  {
    ...
    isAgendaOnly: false,
    badge: "new",
    overview: "The Village of Weston Board of Trustees approved multiple rezoning ordinances, modified a speed limit ordinance for Weston Avenue after debate, and received updates on the April 2026 fire department referendum. A resident criticized the board's approach to fire department funding, calling for budget prioritization over referendum reliance.",
    agenda: [
      { time:"0:00", item:"Call to order and Pledge of Allegiance" },
      { time:"0:45", item:"Roll call" },
      ...
      { time:"22:00", item:"Consent agenda - Vouchers and appointment changes" },
      { time:"24:00", item:"Ordinances - Rezoning and speed limit changes" },
      { time:"35:00", item:"Resolution - Hinter Springs subdivision final plat" },
      { time:"36:00", item:"Unfinished business - Referendum informational sessions update" },
      { time:"40:00", item:"New business - E-bike ordinance, parking restrictions, intersection signage, park agreements, fees" },
    ],
    discussions: [
      { item:"Public Comment - Fire Department Funding", body:"Jim Pensel of 5002 Aerrol Street praised Safer fire department staff after attending their citizen academy, but criticized the board's approach to funding. He argued the referendum lacks a sunset date and won't address long-term cost increases, stating 'We don't have a revenue problem here in Weston. We have a priority problem.' He urged the board to prioritize fire\/EMS over items like artificial turf and the aquatic center." },
      { item:"Finance Director Response to Public Comment", body:"Finance Director Jessica responded that the village cannot borrow for additional firefighters - the Kennedy Park turf was borrowed funds which cannot be used for operating expenses like staffing. She noted public works was understaffed during the recent blizzard, stating 'We're the cheapest. We do things the most efficiently. We can't do it anymore.' She expressed frustration with critics who 'don't acknowledge the good job that the staff here at the Village Western does.'" },
      { item:"Ordinance 26-00006 - Speed Limits on Weston Avenue", body:"The original ordinance to set Weston Avenue from Von Kennel to Ryan at 35 mph failed 3-4, with Maloney, Jordan, and the President voting no. Trustee Maloney argued the road conditions didn't warrant 35 mph compared to other village roads. An amended motion was made to keep Von Kennel to Camp Phillips at 35 mph but restore Von Kennel to Jay at 45 mph. The amended ordinance passed with Trustee Kerns voting yes on the amendment." },
      { item:"Rezoning Ordinances", body:"Ordinance 26-00004 rezoning portion of 8905 Bert Street from RR5 to SFS was approved unanimously as recommended by Planning Commission. Ordinance 26-00005 rezoning portion of 7105 Christensen Avenue from SL to SFS was also approved unanimously per Planning Commission recommendation." },
      { item:"April 2026 Referendum Update", body:"Administrator Keith provided an update that two informational presentations have been completed with videos available on the website. Two remaining sessions on March 31st (4:30-6 PM) and April 2nd (12-1:30 PM) will be open house format for questions. Chief confirmed the sessions have gone well with good questions." },
      { item:"Intersection Signage at Community Center Drive and Birch Street", body:"The board approved changing the stop sign to a yield sign, with an amendment to add a stop sign for bicyclists coming off the pedestrian bridge. Trustee Hooang raised safety concerns about cyclists coming off the bridge at 15-20 mph, leading to the friendly amendment requiring cyclists to stop. Motion passed unanimously with the amendment." },
      { item:"Baseball\/Softball Field Maintenance Agreement", body:"A 10-year agreement with youth baseball and softball organizations was approved. The committee recommended the long term to protect the village's investment at Kennedy Park and ensure organizations maintain commitment. In lieu of fees, the organizations will handle field maintenance responsibilities." },
      { item:"Remote Meeting Attendance Policy", body:"Trustee Lewis recommended postponing this item until the next meeting so the newly elected board can make the decision. Motion to defer passed unanimously." },
      { item:"Microsoft Teams for Communication", body:"The board approved using Microsoft Teams for trustee communications starting next term. A training session will be held when the new board convenes. This will replace text messaging between trustees for non-email communications." },
      { item:"Hospital Area Repaving Change Order #4", body:"Approved unanimously. Trustee Maloney asked about the approximately 8-9% increase due to additional deteriorated curb removal. Public Works Director Michael confirmed he directed the additional curb removal after observing more deterioration than originally scoped." },
    ],
    publicComment: "Jim Pensel of 5002 Aerrol Street spoke about fire department funding. He praised Safer staff after attending the citizen academy but criticized the board's referendum approach, arguing it lacks a sunset date and doesn't solve long-term funding issues. He urged the board to prioritize fire and EMS funding over discretionary spending like artificial turf and the aquatic center.",
    actionItems: [
      "Ordinance 26-00006 approved with amendment: Weston Avenue speed limit 35 mph from Von Kennel to Camp Phillips, 45 mph from Von Kennel to Highway J",
      "Rezoning ordinances 26-00004 and 26-00005 approved as recommended by Planning Commission",
...
,
  {
    ...
    isAgendaOnly: false,
    badge: "new",
    overview: "The Marathon County Board of Supervisors adopted the comprehensive plan for 2026 after approving nine amendments addressing topics including renewable energy terminology, data centers, AI technology, and energy policy. The board also established salaries for elected officials, authorized phase 2 design for a new highway facility, approved outside counsel for PFAS litigation, and ratified a local state of emergency declaration following a major blizzard.",
    agenda: [
      { time:"0:00", item:"Call to order, pledge of allegiance, and moment of reflection" },
      { time:"1:30", item:"Reading of the notice and roll call" },
      { time:"3:15", item:"Standing committee reports" },
      { time:"3:30", item:"Consent agenda items C8 through C13 B2" },
      { time:"4:15", item:"D14 - Adopting Marathon County Comprehensive Plan 2026 (Ordinance 0-13-26)" },
      { time:"42:00", item:"E15 - Establishing salaries for clerk of courts, sheriff, and elected department heads (Resolution 12-26)" },
      { time:"42:45", item:"E16 - Authorizing phase 2 design services for new highway facility (Resolution 13-26)" },
      { time:"44:30", item:"E17 - Authorizing outside counsel for PFAS litigation (Resolution 14-26)" },
      { time:"48:00", item:"E18-E19 - Budget amendments and capital asset threshold resolutions" },
      { time:"50:00", item:"F20 - Law enforcement drug trafficking response grant" },
      { time:"51:00", item:"G21 - Ratification of local state of emergency declaration (Resolution 22-26)" },
      { time:"54:30", item:"H22 - Administrator performance evaluation" },
      { time:"57:00", item:"Announcements and adjournment" },
    ],
    discussions: [
      { item:"Adopting Marathon County Comprehensive Plan 2026", body:"Administrator Leonard presented nine proposed amendments compiled from supervisor feedback. Amendment 1 (livability standards) passed unanimously. Amendments 2, 3, and 4 (changing renewable energy terminology to 'energy systems' for large-scale wind and solar) were separated at Supervisor Crawl's request and each passed but not unanimously. Amendment 5 (adding data centers and battery storage systems language) passed not unanimously despite Supervisor Leur voting no citing it was 'too ideological.' Amendment 6 (radon and lead remediation) passed unanimously. Amendment 7 (regulate energy projects when allowed by law) passed not unanimously. Amendment 8 (AI and automation language for chapters 10 and 12) passed unanimously after Supervisor Leur explained the need for transparency and ethics in AI decision-making. Amendment 9 was significantly debated - Supervisor Sindellski's original language promoting clean coal, natural gas, and nuclear was amended by Supervisor Boots to read 'promote coal and natural gas until a long-term sustainable and reliable energy source can be found that does not adversely affect agricultural land.' Supervisors Robinson and Rosenberg opposed, with Rosenberg stating 'there is no such thing as clean coal' from his experience at Weston Power Plant. The amended version passed not unanimously. Supervisor Sindellski offered a late amendment regarding utility-scale wind, solar and battery storage as industrial uses, but after discussion about PSC jurisdiction and a failed motion by Supervisor Jeang to refer to committee, the amendment was defeated. The comprehensive plan as amended was then adopted, not unanimously." },
      ...
      { item:"Local state of emergency ratification", body:"Resolution 22-26 ratifying the declaration of local state of emergency following a blizzard was approved unanimously. Administrator Leonard explained ratification preserves the county's opportunity for potential reimbursement. He thanked county staff extensively, noting facilities and parks had over 600 hours of call-in time in 24 hours, highway workers worked 12-16 hour shifts sleeping on cots, and staff slept at the courthouse to ensure dispatch and corrections shift changes. Supervisor Fifer echoed thanks as infrastructure committee chair." },
      { item:"Administrator performance evaluation", body:"The executive committee had completed the administrator's evaluation based on board input summarized the previous Thursday. Supervisor Robinson moved to accept the executive committee's recommendation on salary and performance evaluation without going into closed session. Passed unanimously." },
    ],
    publicComment: "No public comment was offered.",
    actionItems: [
      "Comprehensive Plan 2026 adopted as amended with nine amendments incorporated",
      ...
      "Outside counsel authorized on contingency basis to pursue PFAS litigation",
      "County administrator directed to evaluate past and present PFAS-related practices",
      "Carry forwards and associated budget amendments approved",
      "Capital asset threshold of $10,000 for general assets and $50,000 for infrastructure assets approved",
      ...
      "Administrator performance evaluation and salary placement finalized",
      "Departing supervisors (Crawl, Fifick, Marshall, Rosenberg, Hardinger, V, and Reynolds) recognized for service",
    ],
  },
,
  {
    ...
    isAgendaOnly: false,
    badge: "new",
    overview: "The Parks and Recreation Committee approved minutes, selected Rettler Corporation for the Mock Mueller Park master plan, and discussed park impact fees, the Yellow Banks kayak launch project expenses, and ice rink operations at Kennedy Park. The committee provided feedback supporting moderate increases to park impact fees to align with neighboring communities.",
    agenda: [
      { time:"0:00", item:"Call to order and Pledge of Allegiance" },
      ...
      { time:"18:30", item:"Discussion on requests for proposals for Mock Mueller Park master plan" },
      { time:"24:00", item:"Review of Yellow Banks kayak launch expenses" },
      { time:"30:15", item:"Discussion on ice rink operations at Kennedy Park" },
      { time:"43:00", item:"Future items and next meeting date" },
      { time:"46:30", item:"Staff and committee remarks and adjournment" },
    ],
    discussions: [
      { item:"Approval of minutes", body:"A motion to accept the February 23rd, 2026 minutes was made and seconded. The motion passed unanimously with no discussion." },
      { item:"Public comments", body:"Jim Pinsel expressed frustration about not receiving responses to his previous three-page submission regarding playground equipment installation issues and questioned the ice rink cost analysis, arguing true costs including labor hours are closer to $20,000-$30,000 rather than the stated $1,320.98. Lisa Beck praised staff for handling the recent blizzard and complimented the Yellow Banks RFC documentation. A written response to Jim Benson's previous email was submitted for inclusion in the minutes." },
      { item:"Parks and recreation impact fee discussion", body:"Jennifer presented information on park impact fees, explaining the 2020 study recommended $761 for single family units but the village only raised fees from $244 to $300. Neighboring communities charge $603-$650 for single family homes. Committee members Katrina and Roger supported a moderate increase to align with neighboring communities. The discussion will continue at Plan Commission with comparative data from other municipalities." },
      { item:"Mock Mueller Park master plan RFP selection", body:"Staff received seven proposals for the park master plan. After four staff members reviewed and rated proposals based on firm experience, personnel, project understanding, and cost, the two lowest bidders were JSD and Rettler Corporation. Roger made a motion to select Rettler Corporation, seconded by Katrina. The motion passed unanimously." },
      { item:"Yellow Banks kayak launch expenses", body:"Jessica presented a detailed breakdown of the kayak launch project showing grants secured from DNR and Marathon County Transportation that significantly reduced out-of-pocket costs. The project had unforeseen expenses including poor subgrade conditions and an unknown well casing. Committee members praised Jessica and Dan Hagenbotham for grant writing work, and noted PGA donated labor and MTS donated site planning. The item was informational only." },
      { item:"Ice rink operations at Kennedy Park", body:"Staff presented information on the ice rink operations. The warming house has been unattended since 2020 due to COVID and subsequent staffing recruitment difficulties. Everest Youth Hockey remains interested in improvements including a covered structure but has not finalized plans. Katrina, who requested this discussion, expressed concern about not losing sight of hockey needs amid Kennedy Park baseball focus. Staff will bring back attendance numbers from 2018-19 seasons and labor hour costs for future discussion." },
    ],
    publicComment: "Jim Pinsel spoke about his frustration with not receiving responses to previous comments regarding playground equipment installation and questioned the ice rink cost analysis methodology. Lisa Beck thanked Michael for handling the recent blizzard and praised Sean and Jessica for the well-written Yellow Banks RFC documentation. A written response to Jim Benson regarding a previous email was also submitted.",
    actionItems: [
      "Rettler Corporation selected for Mock Mueller Park master plan (approved unanimously)",
      "Jennifer to present park impact fee comparative data from neighboring communities to Plan Commission next month",
      "Staff to bring back ice rink attendance numbers from 2018-19 seasons and labor hour costs",
...
,
  {
    ...
    isAgendaOnly: false,
    badge: "new",
    overview: "The Marathon County HR, Finance, and Property Committee approved several key items including a claim disallowance related to a child's death in foster care, revised property values for public auction, carry forward funds totaling over $1.4 million, and a capital assets threshold policy change from $5,000 to $10,000. The committee also received introductions from new healthcare consultants and detailed fiscal updates for 2025 year-end and 2026.",
    agenda: [
      { time:"0:00", item:"Call to order and roll call" },
      { time:"0:08", item:"Claim disallowance - Mercedes Holmes" },
      { time:"1:52", item:"Revised property values for public auction - 529 Mullen Street and 738 South 3rd Avenue" },
      { time:"4:05", item:"Resolution to approve carry forward funds (R20-2026)" },
      { time:"8:45", item:"Resolution to amend capital assets threshold policy" },
      { time:"9:45", item:"Introduction of healthcare consultants - National Insurance Services" },
      { time:"30:15", item:"Audited 2025 year-end fiscal update" },
      { time:"52:00", item:"2026 year-to-date fiscal update" },
      { time:"54:30", item:"Finance department quarterly update" },
      { time:"1:05:00", item:"County Treasurer update" },
      { time:"1:25:30", item:"Announcements and adjournment" },
    ],
    discussions: [
      { item:"Claim disallowance - Mercedes Holmes", body:"Corporation Counsel presented a claim received December 5th from Mercedes Holmes regarding the death of her 3-year-old child, Zalen Bernett, who was placed in a treatment foster care home licensed through another agency in Dunn County. The death was determined to be natural causes with no wrongdoing found through law enforcement and social services investigations. Outside counsel and insurance carrier Wimik recommended disallowance. Chair Gibbs moved to disallow the claim per the insurance carrier's recommendation. Motion passed unanimously." },
      { item:"Revised property values for public auction", body:"Staff presented two parcels that failed to sell twice on Wisconsin Surplus auctions, with bids not reaching appraised values. Requested revised minimum sale prices of $9,000 for 529 Mullen Street and $7,500 for 738 South 3rd Avenue. Chair Robinson asked about a bidding error, and staff confirmed the non-paying bidder was marked and banned from future auctions. Chair Gibbs moved to approve the revised prices. Motion passed unanimously." },
      { item:"Resolution to approve carry forward funds", body:"Finance Director Sam presented resolution R20-2026 for program revenues and multi-year projects requiring carryover to 2026. Notable items included veterans relief fund replenishment (approximately three years of funding), administration special projects ($142,731 including $75,000 for homelessness contract), and register of deeds redaction funds. Vice Chair Marshall asked about the redaction fund purpose. Administrator Lance Leonhard explained the veterans relief fund process involves a commission that considers submissions from residents. Chair Gibbs moved to approve. Motion passed unanimously." },
      { item:"Capital assets threshold policy amendment", body:"Finance Director Sam explained the proposal to increase the capitalization threshold from $5,000 to $10,000, following GFOA guidance from 2006. This determines whether items are expensed or recorded as depreciating capital assets. Supervisor Hart moved to approve and forward to full county board. Motion passed unanimously." },
      { item:"Introduction of healthcare consultants - National Insurance Services", body:"HR Director Candace introduced NIS representatives following the completed RFP process. Mark (28 years experience) and Jordan Stanley presented their team's background, emphasizing public sector specialization. They discussed evaluating the county's near-site ATA clinic, assessing fully insured vs. self-insured funding models, and improving transparency with the committee. Vice Chair Marshall asked about family plan costs compared to other employers and emergency room utilization strategies. Chair Gibbs asked about self-insured evaluation methodology and risk tolerance considerations. No action taken; informational item." },
      { item:"2025 year-end fiscal update", body:"Finance Director Sam provided extensive unaudited year-end review covering all departments. Key items included: TID closure check from city of Wausau for $257,238; unclaimed property from state of $222,752; opioid fund cash balance of approximately $2.2 million with $3.5 million in anticipated future settlements; parks fund ice revenue up $70,000; ARPA funds nearly exhausted with $800,000+ in interest to be moved to different fund. Multiple departments still require reconciliation including capital assets and depreciation entries. When asked about fund balance surplus, Sam indicated she would provide a number at the next meeting after capital asset reconciliation, noting 'it won't be zero.'" },
      { item:"Finance department quarterly update", body:"Sam reported the finance team welcomed a new payroll analyst, is now fully staffed since mid-December. Accomplishments included W-2 processing (complicated by 'big beautiful bill' overtime tax changes), 1099 processing, random cash audits (all successful), quarterly closeout preparations, and countywide training initiatives. First quarter 2026 will close May 31st, with monthly closeouts thereafter on a two-month lag. Administrator Leonhard praised Sam's team extensively for handling W-2 challenges and announced plans to recommend increasing the $400,000 social services reserve account due to rising correctional care placement costs." },
      { item:"County Treasurer update", body:"Treasurer Connie reported on tax collections, delinquent parcel monitoring, and year-end procedures. The office mailed 1,582 delinquent tax notices in March (down from 1,786 last year). She detailed ongoing issues with municipal treasurers making receiving errors, particularly with lottery credits and short payments. Supervisor Lomer asked about poverty trends; Connie explained resources offered to struggling taxpayers including referrals to veterans office. Administrator Leonhard clarified the county no longer offers payment agreements due to high default rates and NSF checks, noting that elongating payments increases interest\/penalty burden (18% rate) and erodes homeowner equity." },
    ],
    publicComment: "No public comment was offered.",
    actionItems: [
      "Claim of Mercedes Holmes disallowed per insurance carrier recommendation",
      "Revised minimum sale prices set at $9,000 for 529 Mullen Street and $7,500 for 738 South 3rd Avenue for Wisconsin Surplus auction",
      "Resolution R20-2026 approved for carry forward funds to 2026 budget",
      "Capital assets threshold policy amendment approved and forwarded to full county board (threshold increased from $5,000 to $10,000)",
      "Register of Deeds to provide future update on redaction fund usage and potential repurposing",
      ...
      "Finance Director to report final fund balance surplus at next meeting after capital asset reconciliation",
      "Next committee meeting scheduled for April 8th before new board takes office",
    ],
  },
,
  {
    ...
    isAgendaOnly: false,
    badge: "new",
    overview: "The Marathon County Executive Committee approved moving Administrator Lance Leonhard to year six of the pay scale following his performance evaluation, and ratified the declaration of a local state of emergency related to a recent snow emergency. The committee also received a preview of 68 rules review recommendations that will be discussed further at the April 9th meeting.",
    agenda: [
      { time:"0:00", item:"Call to order and Pledge of Allegiance" },
      { time:"0:30", item:"Performance review of the administrator (3A1)" },
      { time:"1:45", item:"Closed session for administrator evaluation discussion" },
      ...
      { time:"5:15", item:"Rules review recommendations - educational overview" },
      { time:"7:00", item:"Adjournment" },
    ],
    discussions: [
      { item:"Performance review of the administrator", body:"The committee voted unanimously to enter closed session to discuss the administrator's performance evaluation. Roll call vote included Supervisors Gibbs, Dickinson, Arstead, Boots, Drebeck, Fifick, Mask, Ritter, Morash, and Robinson, all voting aye. The evaluation used a 0-5 scale with criteria of needs improvement, successful, and exceptional." },
      { item:"Administrator pay scale approval", body:"Upon returning to open session, Supervisor Mask moved to approve placing the administrator on year six of the pay scale and approve the evaluation. Supervisor Arstead seconded. The chair clarified this would be retroactive to January, consistent with county implementation practices. The motion passed unanimously by voice vote." },
      { item:"Ratification of declaration of state and local emergency", body:"The administrator explained the snow emergency declaration, noting the governor had declared an emergency and the county followed with a local declaration. He praised staff efforts, noting parks, recreation, forestry, and capital management staff worked hundreds of extra hours in about 24 hours, with highway department employees sleeping on cots and working 12-16 hour shifts. Supervisor Robinson moved to ratify, seconded by Supervisor Fifick. The ratification preserves the county's ability to seek reimbursement through available emergency funds under Chapter 323 of the statutes. Motion passed unanimously." },
      { item:"Rules review recommendations", body:"The vice chair provided an overview of the rules review committee's work, which considered 68 items: 31 approved, 31 rejected, and 3 placed in a parking lot. Key proposed changes include clarifications of existing practices, changes to committee chair\/vice chair appointments, expense reimbursement approvals allowing more freedom for WCA professional development, restructuring of the forestry recreation committee, and sunsetting of the TIF and broadband task forces. The committee decided to retain two meetings rather than consolidating to one. No vote was taken; further discussion scheduled for April 9, 2026." },
    ],
    publicComment: "No public comment was offered.",
    actionItems: [
      "Administrator Lance Leonhard placed on year six of pay scale, retroactive to January",
      "Declaration of local state of emergency ratified and forwarded to full board",
      "County to compile information for potential emergency fund reimbursement request",
...
,
  {
    ...
    isAgendaOnly: false,
    badge: "new",
    overview: "The Marathon County Board held an educational meeting featuring presentations on PFAS litigation opportunities and renewable energy regulation. The board heard from attorneys about joining multi-district litigation against chemical manufacturers for PFAS contamination, and received extensive information about the county's limited authority to regulate large-scale wind and solar projects under Wisconsin law. No votes were taken as this was an educational session.",
    agenda: [
      { time:"0:00", item:"Call to order and pledge of allegiance" },
      { time:"0:45", item:"Reading of the notice" },
      { time:"1:30", item:"Roll call" },
      { time:"2:15", item:"Public comment period" },
      { time:"10:45", item:"Presentation on PFAS multi-district litigation opportunity" },
      { time:"44:30", item:"Presentation on renewable energy regulatory authority and joint development agreements" },
    ],
    discussions: [
      { item:"Public Comment", body:"Five residents spoke during public comment. Cindy Nelson from Stratford\/Oplane Township spoke against wind turbines, stating she visited 200 homes and found no support for the projects. Wendy Rowski from Green Valley asked the board to vote no on the comprehensive plan draft, objecting to the term 'wind farm' instead of 'industrial wind energy development.' Barb Newton from Rib Mountain supported reducing speed limits on Double N Road, noting 75 residents signed a petition. Heidi Pesky from McMillan argued against joint development agreements for wind projects, citing concerns about long-term county obligations. Cindy Hogan from Rib Mountain also supported the Double N Road speed reduction." },
      { item:"PFAS Multi-District Litigation Presentation", body:"Attorney Carrie McDougall from Baron & Bud Law Firm explained via WebEx the ongoing PFAS litigation, describing a $12-13 billion settlement with 3M and $3-5 billion with DuPont for water contamination cases. He explained Marathon County could file claims for airport soil contamination, landfill contamination, and wastewater issues. The legal services would be on a 25% contingency fee basis with no upfront costs to the county. Supervisor Robinson asked about land spreading impacts and Vice Chair Dickinson noted the airport has no known contamination currently. Supervisor Mash questioned the compensation structure, which was confirmed as contingency-based with expense recovery only upon successful settlement or verdict." },
      { item:"Renewable Energy Regulation Presentation", body:"Attorney Rebecca Roker from Atollis Law, representing Wisconsin Counties Association, explained that projects over 100 megawatts fall under PSC jurisdiction, significantly limiting county authority. She noted PSC has approved 33 solar projects with zero denials. She outlined four options for Marathon County: do nothing, negotiate a Joint Development Agreement (JDA), intervene in PSC proceedings, or litigate. She strongly recommended JDAs as the most effective tool to protect county interests regarding liability, road damage, decommissioning, emergency response training, and environmental impacts. She noted the Hub City Wind project and Stormark Wind Energy Center are proposed but no applications have been filed with PSC yet." },
    ],
    publicComment: "Five speakers addressed the board: Cindy Nelson (Stratford) opposed wind turbines citing lack of community support from 200 home visits; Wendy Rowski (Green Valley) requested the comprehensive plan use 'industrial wind energy development' instead of 'wind farm'; Barb Newton (Rib Mountain) supported speed limit reduction on Double N Road with 75-signature petition; Heidi Pesky (McMillan) argued against joint development agreements for wind projects; Cindy Hogan (Rib Mountain) supported the Double N Road speed reduction.",
    actionItems: [
      "Board to consider resolution on joining PFAS litigation at next week's meeting",
      "County to evaluate potential PFAS contamination at airport, landfill, and wastewater facilities for possible claims",
      "Board to consider options for responding to Hub City Wind project and Stormark Wind Energy Center proposals",
...
,
  {
    ...
    discussions: [
      ...
      { item:"Consideration of the minutes of the February 18, 2026 Regular Plan Commission Meeting", body:"The minutes from the February 18, 2026 meeting were approved. Specific vote count and motion makers were not recorded." },
      { item:"Public Hearing: Conditional Use Permit for 218 South 4th Street (Dunwoody Storage)", body:"A public hearing was held on a conditional use permit to allow construction of a personal storage facility in the Light Industrial zoning district. This was a hearing item; no action vote was recorded." },
      { item:"Conditional Use Permit for 731 N 1st Street (Beacon Resources, LLC)", body:"The conditional use permit for a 70-unit, 7-story apartment building at 731 N 1st Street was approved. The motion passed, though specific vote count and motion makers were not recorded." },
      { item:"Transportation Project Plat for Grand Avenue signal replacements", body:"The transportation project plat for Project 370-40-40, covering Grand Avenue signal replacements at Sturgeon Eddy Road and Townline Road, was approved. The motion passed, though specific vote count and motion makers were not recorded." },
    ],
    ...
    actionItems: [
      ...
      "Public hearing held on conditional use permit for Dunwoody Storage personal storage facility at 218 South 4th Street",
    ],
    civicItems: [
...
,
  {
    ...
    isAgendaOnly: false,
    badge: "new",
    overview: "The Board of Public Works awarded the 2026 Asphalt Paving Project 'A' contract to RC Pavers, LLC for $824,146.34. The brief meeting concluded with a unanimous adjournment vote.",
    agenda: [
      { time:"N\/A", item:"Open bids and make recommendation for 2026 Asphalt Paving Project 'A'" },
    ],
    discussions: [
      { item:"Open bids and make recommendation for 2026 Asphalt Paving Project 'A'", body:"The board voted to award the contract for the 2026 Asphalt Paving Project 'A' to RC Pavers, LLC in the amount of $824,146.34. The motion passed, though the specific vote count and movers were not recorded in the vote records." },
      { item:"Adjournment", body:"The meeting was adjourned with a 2-0 vote. The motion was moved by Vincent Bonino and seconded by Eric Lindman. Both Lindman and Bonino voted yes." },
    ],
...
,
  {
    ...
    isAgendaOnly: false,
    badge: "new",
    overview: "The Wausau Public Health and Safety Committee approved all action items including license applications (with one exception for Theodore Davis), a rewrite of the Solid Waste Disposal code, repeal of the local cell phone driving ordinance, and a solar energy partnership with MREA. The committee also received discussion items including the Fire Department's 2025 annual report.",
    agenda: [
    ...
    discussions: [
      ...
      { item:"Repealing and recreating Wausau Municipal Code Chapter 6.44 Solid Waste Disposal", body:"The committee voted to approve the new solid waste disposal provisions, repealing and recreating Chapter 6.44 of the Municipal Code. The motion passed." },
      { item:"Repealing Wausau Municipal Code Section 10.01.012 Use of Hand-Held Mobile Telephones and Mobile Electronic Devices While Driving Prohibited", body:"The committee voted to repeal this local ordinance prohibiting hand-held mobile phone use while driving. The motion passed." },
      ...
      { item:"Wausau Fire Department 2025 Annual Report", body:"The Fire Department's 2025 annual report was presented as a discussion item. No vote was taken." },
      { item:"Tavern Activities Report from February 2026", body:"The February 2026 tavern activities report was presented as a discussion item. No vote was taken." },
      { item:"Community Outreach Update", body:"A community outreach update was presented as a discussion item. No vote was taken." },
    ],
    ...
    actionItems: [
      ...
      "Solid Waste Disposal Code Chapter 6.44 to be repealed and recreated with new provisions",
      "Municipal Code Section 10.01.012 on hand-held mobile device driving restrictions to be repealed",
      "MOU with Midwest Renewable Energy Association approved for Grow Solar Central Wisconsin Group Buy Program",
    ],
    civicItems: [
...
,
  {
    ...
    isAgendaOnly: false,
    badge: "new",
    overview: "The Wausau Finance Committee denied a tax recovery claim for Green Acres at Greenwood Hills LLC, while approving multiple airport ground lease transactions and postponing action on the National Opioid Settlement and several budget items. The committee approved a 2026 General Obligation Promissory Note for capital improvements and a budget amendment for fund carryover from 2025 to 2026.",
    agenda: [
      { time:"N\/A", item:"Public comment on agenda items" },
      ...
      { time:"N\/A", item:"Considering purchasing properties at Adolph Street and Myron Street for Department of Public Works Streets Division" },
    ...
    discussions: [
      ...
      { item:"Alleged Claim for Recovery of Unlawful Tax for Green Acres at Greenwood Hills, LLC - Outlot 1", body:"The committee denied approval of the alleged claim for recovery of unlawful tax. The motion to approve the claim failed." },
      { item:"Consent to transfer title at 939 Woods Place", body:"The committee approved the consent to transfer title to buildings and improvements and waiver of first right of refusal to purchase at 939 Woods Place." },
      { item:"Terminating Airport Ground Lease with Wynn O. Jones at 939 Woods Place", body:"The committee approved termination of the airport ground lease with Wynn O. Jones at 939 Woods Place." },
      ...
      { item:"Approving Airport Ground Lease with Cole Lundberg", body:"The committee approved the airport ground lease with Cole Lundberg." },
      { item:"Six Remnant Defendants National Opioid Settlement Agreement", body:"The committee voted to postpone consideration of the city's participation in the Six Remnant Defendants National Opioid Settlement Agreement to the next scheduled meeting." },
      { item:"Budget amendment for Wausau Water Works Lead Service Line Replacement", body:"The committee voted to postpone consideration of the budget amendment for the 2025 Lead Service Line Replacement project to the next meeting." },
      ...
      { item:"Review of 2025 Motor Pool Fund financial results", body:"This item was on the agenda for review. No vote record indicates official action was taken." },
      { item:"2026 General Obligation Promissory Note for Capital Improvements", body:"The committee approved the 2026 General Obligation Promissory Note for Capital Improvements, forwarding it to the calendar." },
      ...
      { item:"Properties for Department of Public Works Streets Division", body:"The committee voted to postpone consideration of purchasing properties at 108 Adolph Street, 112 Adolph Street, 112-1\/2 Adolph Street and 233 Myron Street until the next meeting." },
    ],
    ...
    actionItems: [
      ...
      "Airport ground lease with Wynn O. Jones terminated; new leases approved with Owen Jones and Cole Lundberg at 939 Woods Place",
      ...
      "2026 General Obligation Promissory Note for Capital Improvements approved and forwarded to calendar",
...
,
  {
    ...
    isAgendaOnly: true,
    badge: "new",
    overview: "The Wausau School District Board of Education Committee of the Whole meeting addressed facility fee updates for artificial fields, a referendum budget update, and an extensive NEOLA policy review covering over 60 policies including those related to cell phones, AI, child abuse reporting, and school support organizations. The meeting also included recognition of Stettin Elementary and renewal of the Wisconsin School Nutrition Purchasing Cooperative membership.",
    agenda: [
      { time:"0:00", item:"Call to Order" },
    ...
    discussions: [
      { item:"Wisconsin School Nutrition Purchasing Cooperative Agreement (WiSNP)", body:"The Wausau School District Nutrition Service Department currently belongs to the Wisconsin School Nutrition Purchasing Cooperative and is requesting Board approval for continued membership for the 2026-2027 school year. The cooperative group is asking member districts to approve a resolution for continued participation." },
      { item:"Facility Fees", body:"Ryan Urmanski, Director of Buildings and Grounds, presented information to amend the current Wausau School District Facility Use Fee Schedule to reflect costs for use of artificial fields and field lighting for requested events. The Board is considering immediate approval of the updated fee schedule." },
      { item:"Referendum Budget Update", body:"Elizabeth Channel, Interim Assistant Superintendent of Operations, shared an update on the status of the Referendum Budget. A memo dated March 23, 2026 was provided summarizing the current budget status." },
      { item:"NEOLA UPDATE", body:"The Committee reviewed proposed changes to numerous district policies, ranging from small technical corrections to more substantial revisions. The review covered 39 policies in the main update section including definitions, board member conduct, reading instruction goals, cell phone use, AI policies, and academic honesty. Additional sections addressed school support organization policies, technical corrections to 18 existing policies, and Act 57 related policies concerning student supervision, welfare, and child abuse and neglect reporting." },
    ],
    publicComment: "No public comment period was included on this agenda.",
    actionItems: [
      "Approval of Wisconsin School Nutrition Purchasing Cooperative Agreement (WiSNP) for 2026-2027 school year",
      "Approval of amended Facility Use Fee Schedule for artificial fields and field lighting",
      "Approval of NEOLA policy updates including 39 general policies, 9 school support organization policies, 18 technical corrections, and 4 Act 57 related policies",
    ],
  }
];
