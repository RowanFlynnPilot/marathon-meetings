...
const MEETINGS = [
  {
    ...
    date: "May 12, 2026", shortDate: "MAY 12",
  ...
  },
  {
    ...
    discussions: [
      ...
      { item:"Resolution 26-26: Landfill Tipping Fee Modification for Disaster Debris", body:"Administrator Leonard and Solid Waste Director Hagen Busher presented a proposal to reduce tipping fees for debris from the severe weather emergency. The state waived $13.10\/ton, Ringle waived $2.33\/ton, and the county proposed reducing from the $65 gate rate to $36.94\/ton (commercial rate minus waivers) through June 17th. Brown and Dane counties only dropped state fees. Supervisor Rosenberg requested public comment; Jessica Toasty asked the county to waive fees entirely and extend relief to six months, noting private businesses donated $40,000+ in cleanup. Matt Haybeck requested fee waivers for underinsured residents, noting some still await insurance adjusters. Multiple supervisors asked clarifying questions about fee calculations and eligibility. The board first voted unanimously to suspend rules to consider the resolution without standing committee review, then approved Resolution 26-26 unanimously on motion by Supervisor Arstead, seconded by Supervisor Morash." },
    ],
    publicComment: "Two residents were granted special dispensation to speak on the landfill tipping fee resolution. Jessica Toasty requested Marathon County waive fees entirely for six months, noting the state, DNR, and Ringle all waived their fees, and that private businesses contributed over $40,000 in cleanup assistance. Matt Haybeck spoke on behalf of homeowners with demolished houses, requesting fee waivers for underinsured residents and more time for relief as some insurance adjusters have not yet visited affected homes.",
    actionItems: [
      ...
      "Resolution 26-26 approved: Reduced landfill tipping fees to $36.94\/ton for certified disaster debris through June 17, 2025",
      "Administrator Leonard to work with Community Foundation on potential reimbursement mechanism for unreimbursed out-of-pocket debris disposal costs",
      "Solid Waste Management Board to develop policy within six months on handling similar emergency situations in the future",
      "Solid Waste Management Board to continue evaluating timeline needs and public input on disaster debris relief",
    ],
  },
  {
    ...
    isAgendaOnly: false,
    badge: "new",
    overview: "The Marathon County Environmental Resources Committee approved two rezoning petitions unanimously and voted to forward a modified fee waiver resolution for tornado-affected properties to the county board. The committee also received educational presentations from the Solid Waste, Parks Recreation and Forestry, and Conservation Planning and Zoning departments.",
    agenda: [
      { time:"0:00", item:"Call to order and Pledge of Allegiance" },
      { time:"1:15", item:"Public comment" },
      { time:"1:25", item:"Approval of March 31st, 2026 committee minutes" },
      { time:"1:45", item:"Public hearing - Tim Veland rezoning petition (urban residential\/general agriculture to rural residential, Town of Green Valley)" },
      ...
      { time:"56:30", item:"Educational presentation - Solid Waste Department overview" },
      { time:"1:15:30", item:"Educational presentation - Parks, Recreation and Forestry Department overview" },
    ...
    discussions: [
      ...
      { item:"Tim Veland rezoning petition - Town of Green Valley", body:"Garrett Pogle presented the staff report for rezoning from urban residential and general agriculture to rural residential for a land division. The Town of Green Valley recommended approval on March 10, 2026. No public testimony was offered for, against, or as interested. Supervisor Drebeck moved to approve based on findings of fact, conclusions of law, and town approval, seconded by Supervisor Kurt. Motion carried unanimously." },
      { item:"Jeffrey and Cynthia Schmidtz rezoning petition - Town of McMillan", body:"Garrett Pogle presented the petition to rezone from Conservancy Recreation to General Agriculture. Supervisor Leur asked about the conservancy designation; staff explained the property contains a home and horse riding stable, and the rezone makes the existing structures conforming uses rather than non-conforming. The Town of McMillan recommended approval on April 20, 2026. No public testimony was offered. Supervisor Sefeld moved to approve and forward to county board, seconded by Supervisor Drew. Motion carried unanimously." },
      { item:"Fee waiver for April 17, 2026 severe weather impacted properties", body:"Director Lori Mskimmons presented a proposal to waive county zoning and septic fees for properties damaged by the April 17th tornado affecting the Town of Ringle, Village of Kronenwetter, Town of Easton, and Village of Weston. Significant debate ensued. Supervisor Drew questioned where to draw the line for future events. Supervisor Drebeck questioned fairness to individual disaster victims not in declared disaster areas. Marilyn Bend asked about septic hookup costs. Eric Vogel asked whether homeowners insurance would cover fees. Supervisor Sefeld moved to approve, seconded by Supervisor Leur. Supervisor Drebeck then amended the motion to limit the fee waiver to only reconnect fees for septic systems ($160), excluding all other zoning and septic fees. Supervisor Kurt seconded the amendment. The amendment passed. The amended motion to forward to the county board passed, but not unanimously." },
      { item:"Solid Waste Department presentation", body:"Director David Hagenbusher provided an overview of the department's operations, including the 600-acre landfill facility, renewable natural gas partnership with Vidi Energy generating royalties for the county, leachate treatment challenges due to PFAS regulations requiring on-site treatment by 2032, and upcoming capital projects totaling millions of dollars. Marilyn Bend praised the department for keeping private landfill costs in line." },
      { item:"Parks, Recreation and Forestry Department presentation", body:"Tom Lovelin, County Forest Administrator, presented on behalf of Director Jamie. The department operates both city and county park systems with 44 full-time and 120 seasonal employees, manages 17 county parks and 30,700 acres of county forest. Nine Mile County Forest generates $3.25 million annually for the local economy from out-of-town visitors. Supervisor Sefeld announced Tom Lovelin is retiring June 1st after nearly 30 years of service, and Joe Tucker has been selected as his replacement." },
    ],
    publicComment: "No public comment was offered.",
    actionItems: [
      "Two rezoning petitions forwarded to Marathon County Board of Supervisors for approval",
      "Modified fee waiver resolution (reconnect fees only) forwarded to county board for consideration",
      "Staff directed to track costs and requests related to any fee waivers implemented",
...
const WESTON_UPCOMING = [
  { date:"2026-05-12", time:"", name:"S.A.F.E.R. Board of Directors", url:"https://www.westonwi.gov/AgendaCenter/ViewFile/Agenda/_05122026-1915", source:"weston" },
