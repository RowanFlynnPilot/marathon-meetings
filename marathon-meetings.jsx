...
const MEETINGS = [
  {
    ...
    date: "May 21, 2026", shortDate: "MAY 21",
    committee: "Public Works", duration: "~1h",
    url: "https://www.youtube.com/watch?v=j64Gj2ean2k",
    docUrl: "https://www.westonwi.gov/AgendaCenter/ViewFile/Agenda/_05212026-1919",
    isAgendaOnly: false,
    badge: "new",
    overview: "The Public Works Committee approved several key items including a resolution supporting state transportation funding, awarded a recycled asphalt crushing contract to King Gravel for $126,900, and directed staff to develop enforcement language for sanitary sewer discharge violations at $100\/day. The committee also approved construction agreements for the Military Road project and construction services for upcoming road projects.",
    agenda: [
      { time:"0:09", item:"Call to order" },
      { time:"0:24", item:"Pledge of allegiance" },
      { time:"0:58", item:"Roll call" },
      { time:"1:12", item:"Public comment" },
      { time:"1:18", item:"Approval of April 13, 2026 meeting minutes" },
      { time:"1:35", item:"Acknowledge April 2026 water and sewer permits" },
      { time:"1:50", item:"CIP update" },
      { time:"20:01", item:"Street operation update" },
      { time:"30:01", item:"Utility operating update" },
      { time:"45:01", item:"Review 2025 Water Utility Public Service Commission annual reports" },
      { time:"50:00", item:"Resolution 2026-014 supporting state transportation funding" },
      { time:"55:04", item:"Recycled asphalt base course production" },
      { time:"1:05:00", item:"Sanitary sewer discharge violation discussion" },
      { time:"1:15:02", item:"Water and sewer connection agreement for Radkey Avenue duplex" },
      { time:"1:20:01", item:"Military Road construction agreement" },
      { time:"1:25:01", item:"Construction service proposals for Alderson\/Jelnik and Bladel Avenue projects" },
    ],
    discussions: [
      { item:"CIP Update", body:"Michael reported the village received a Local Road Improvement Grant for Birch Street reconstruction between Schofield Avenue and Community Center Drive, originally a 2029 project that will likely move to 2028. The grant covers about 50% of the estimated $1.5 million project cost. Michael noted the village has received over $9 million in grant funding over the past 4-5 years. Discussion also covered Weston Avenue repairs by Integrity Grading and Excavating for settlement issues over sanitary sewer trenches, and upcoming repairs on Schofield Avenue by HOS Construction for manhole and pavement issues." },
      { item:"Street Operation Update", body:"Staff reported on removal of road limits on April 29th, spring curb line sweeping, hot mix patching, storm damage cleanup from East Nick, culvert failures on Jones Street requiring additional 18-inch culvert installation, and equipment maintenance including transitioning plow trucks for summer use. Discussion addressed flooding issues near Weston Avenue and the need for a potential permanent pump solution near Crane Meadows area." },
      { item:"Utility Operating Update", body:"Josh reported on water service repairs, well maintenance, and significant clear water infiltration issues in the sanitary system. In April, the village put 37 million gallons of water into the distribution system but treated nearly 54 million gallons at the wastewater facility - approximately 15 million gallons of clear water from infiltration or illegal sump pump connections. The Kathleen lift station was identified as having issues with residents discharging sump pumps into sanitary sewers." },
      { item:"2025 Water Utility PSC Annual Report", body:"Michael presented the annual report showing operating revenues of approximately $3 million, net operating income of $482,911 (compared to $490,000 in 2024), and water loss at 6%. The utility value increased to nearly $34 million with $6.7 million in infrastructure placed in service. The utility has approximately 6,100 customers total: 5,250 in Weston, 830 in Rothschild, and 5 in other areas. Approved unanimously." },
      { item:"Resolution 2026-014 State Transportation Funding", body:"Michael explained this League of Wisconsin Municipalities sample resolution supports long-term sustainable funding for state transportation, noting that while grant funding helps one-time costs, recurring annual payments for street maintenance and snow plowing remain underfunded. Motion by Mumper to recommend adoption, seconded, approved unanimously." },
      { item:"Recycled Asphalt Crushing Contract", body:"Michael explained the Ryan Street site recycling program and presented quotes, with King Gravel as low bidder at $4.23\/ton for an estimated 30,000 tons totaling $126,900. Analysis showed the village saves approximately $11 per cubic yard compared to City of Wausau costs, resulting in about $130,000 savings on this year's three projects. Motion approved unanimously to award to King Gravel." },
      { item:"Sanitary Sewer Discharge Violations", body:"Discussion focused on establishing enforcement for illegal sump pump discharges into sanitary sewers. Staff sought guidance on fine amounts within the $100-$1,000 per day range allowed by code. Committee members distinguished between unknowing and willful violations, agreeing that $100\/day is appropriate for first offenses. Motion approved to direct staff to create enforcement language not to exceed $100\/day." },
      { item:"Radkey Avenue Connection Agreement", body:"Michael explained a builder needs to connect a duplex on lot one to water and sewer mains that currently dead-end on Radkey Avenue. The proposal allows temporary long lateral service until Radkey Avenue reconstruction, when the property would be assessed for main extension costs. Committee added language requiring reconstruction no later than 2029. Motion approved unanimously." },
      { item:"Military Road Construction Agreement", body:"Michael presented an intergovernmental agreement with Village of Rothschild for Military Road construction from Wolfman Street to Helin Street. Steam Construction is the contractor. Weston's share for utility relocation (water main and sanitary sewer) is estimated at $94,860. The water main requires relocation due to conflicts with storm sewer improvements. Motion approved unanimously." },
      { item:"Construction Services Proposals", body:"Michael presented proposals for construction inspection services for upcoming projects. For Alderson\/Jelnik roundabout, MSA was lower at $37,315 vs Clark Dietz at $48,910. For Bladel Avenue, MSA was $70,400 and Clark Dietz was $73,730. Michael recommended MSA for the roundabout and Clark Dietz for Bladel due to having full-time experienced staff versus an intern. Motion approved unanimously." },
    ],
    publicComment: "No public comment was offered.",
    actionItems: [
      "Approve Resolution 2026-014 supporting state transportation funding (to Village Board)",
      "Award recycled asphalt crushing contract to King Gravel at $4.23\/ton, estimated $126,900",
      "Create enforcement language for sanitary sewer discharge violations at $100\/day maximum",
      "Execute water\/sewer connection agreement for 2230 Radkey Avenue with 2029 reconstruction deadline",
      "Approve Military Road construction agreement with Village of Rothschild for $94,860",
      "Award construction services: MSA for Alderson\/Jelnik project ($37,315), Clark Dietz for Bladel Avenue ($73,730)",
      "Special assessment meeting for Bladel Avenue scheduled May 28, 2026 at 6:00 PM",
      "Staff to research cost impact of clear water infiltration for next meeting",
      "Staff to provide street lighting update for future meeting",
      "Norcon to begin Schofield Avenue concrete repairs Wednesday\/Thursday this week",
    ],
  },
  {
    ...
    isAgendaOnly: false,
    badge: "new",
    overview: "The Village of Weston Plan Commission approved the site plan for the new Mountain Bay Metropolitan Police Department and Municipal Court facility at 3600 Community Center Drive, and adopted a new salt storage shed inspection program for wellhead protection areas. Both items passed unanimously with the commission addressing concerns about future building expansion and groundwater protection.",
    agenda: [
      { time:"0:01", item:"Call to order and roll call" },
      { time:"1:18", item:"Open public comment period" },
      { time:"4:48", item:"Approval of April 13, 2026 meeting minutes" },
      { time:"5:22", item:"Site plan review - Mountain Bay Metro Police Department and Municipal Court facility at 3600 Community Center Drive (Item 6 taken first)" },
      { time:"19:43", item:"Unfinished business - Creation of salt storage shed inspection program for Wellhead Protection District (Item 5)" },
      { time:"28:15", item:"April 2026 staff approved certified survey maps and site plans" },
      { time:"28:28", item:"April 2026 building permits" },
      { time:"28:40", item:"Planning and Development department monthly project update report" },
      { time:"30:24", item:"Commissioner remarks" },
      { time:"31:06", item:"Future agenda items" },
      { time:"34:28", item:"Adjournment" },
    ],
    discussions: [
      { item:"Site plan review - Mountain Bay Metro Police Department and Municipal Court facility", body:"Staff presented the site plan for the new police department and municipal court at 3600 Community Center Drive. Police Chief Jeremy explained the building was rotated to face east due to a 36-inch gas pipeline running through the property. The building is designed for current staffing of approximately 40 officers and 4 clerical staff but has capacity for 50-60 officers. An alternate storage shed may be added later depending on bid costs. Discussion addressed future expansion possibilities (to the north, away from the gas line), landscaping compliance with current code, and shed placement considerations. Motion was made to recommend approval to the Board of Trustees subject to staff conditions 2-5. Passed unanimously." },
      { item:"Salt storage shed inspection program for Wellhead Protection District", body:"Staff presented a program for twice-annual inspections of salt storage sheds within wellhead protection areas - a warm weather inspection focused on structural integrity and a winter inspection focused on operational practices. The program includes a standardized inspection worksheet similar to DOT standards. Staff noted one existing facility near Sternberg has never gone through the wellhead protection conditional use process. Commission agreed staff should reach out to bring that facility into compliance. Motion to approve the program with reporting back to both Plan Commission and Public Works Committee passed unanimously." },
      { item:"April 2026 meeting minutes", body:"Motion to approve minutes as presented passed unanimously with no discussion." },
      ...
      { item:"Planning and Development department monthly project update", body:"Staff announced the first meeting of the joint Plan Commission\/Village Board steering committee for the comprehensive plan is scheduled for Monday, June 1st at 5:00 p.m. Staff will send email invitations and calendar events." },
    ],
    publicComment: "Jim Pensel of 5002 Arrow Street, Weston, spoke via online connection. He asked the Plan Commission to exercise common sense regarding landscaping requirements for the police department project, urging staff to waive excessive landscaping standards similar to what was done for the Greenheck Turner building. He also requested the commission require annual reporting on the salt shed inspection program, noting some zoning complaints have gone unresolved for years.",
    actionItems: [
      "Mountain Bay Metro Police Department and Municipal Court facility site plan recommended for Board of Trustees approval subject to staff conditions 2-5",
      "Salt storage shed inspection program adopted for implementation within wellhead protection district",
      "Staff to report inspection findings to both Plan Commission and Public Works Committee annually",
      "Staff to reach out to existing salt storage facility on Sternberg that has not gone through wellhead protection conditional use process",
      "First comprehensive plan steering committee meeting scheduled for June 1st at 5:00 p.m.",
      "Staff to send email and calendar invitations for steering committee meeting",
  ...
  },
  {
    ...
    isAgendaOnly: false,
    badge: "new",
    overview: "The Marathon County Health & Human Services Committee held an organizational\/educational meeting for new board members, featuring presentations from the Health Department, Veteran Services, and Aging Disability Resource Center. The only action taken was approval of April 1st meeting minutes. Department heads provided overviews of their missions, budgets, and key initiatives including homelessness response, veteran suicide prevention, and nutrition programs facing funding challenges.",
    agenda: [
      { time:"0:00", item:"Call to order and roll call (Chair Boots and Vice Chair Rosenberg attending remotely)" },
      { time:"0:30", item:"Pledge of Allegiance" },
      { time:"1:00", item:"Approval of April 1st committee meeting minutes" },
      { time:"1:45", item:"Operational functions required by statute (no items for this meeting)" },
      { time:"3:15", item:"Review of standing committee ordinance, missions, duties and responsibilities" },
      { time:"8:00", item:"Health Department presentation by Health Officer Caitlyn Suginaka" },
      { time:"20:00", item:"Social Services Department overview by Administrator Leonard" },
      { time:"45:01", item:"Veteran Services Department presentation by VSO Erin Galindo" },
      { time:"1:15:00", item:"Aging Disability Resource Center presentation by Executive Director Mike Ray" },
      { time:"1:30:00", item:"Next meeting date discussion and adjournment" },
    ],
    discussions: [
      { item:"Approval of April 1st meeting minutes", body:"Supervisor Cavelli made a motion to approve the minutes. Vice Chair Rosenberg seconded. The motion passed unanimously with all members voting aye." },
      { item:"Standing Committee Ordinance Review", body:"Administrator Lance Leonard explained the committee's structure under section 2.04 sub5, outlining jurisdiction over Health Department, Social Services, and Veteran Services as direct county departments, plus North Central Health Care and Aging Disability Resource Center as multi-county entities. He explained the committee's relationship to subordinate bodies including the Social Services Board, Veteran Service Commission, Transportation Coordinating Committee, Board of Health, and North Central Community Action Program." },
      { item:"Health Department Presentation", body:"Health Officer Caitlyn Suginaka presented the department's mission of preventing disease, promoting health, and protecting from environmental hazards. The department has 37.6 FTE across four divisions: environmental health (1,200+ licenses), nursing\/communicable disease, community health improvement, and administration. She highlighted public health vending machines with free tick kits and harm reduction supplies, the Nurse Family Partnership program graduating its first two-year-olds, and the new homelessness system response FTE position created from the previous session's task force. About half of the $5 million budget is tax levy, with environmental health designed to be self-supporting through fees." },
      { item:"Social Services Department Overview", body:"Administrator Leonard presented on behalf of Director Christa (not present), describing the department's nearly 140 FTE covering child welfare, youth justice, children's long-term support, economic support, and child support. Of the $22 million budget, approximately $7 million is tax levy. He highlighted the successful Family Keys pilot program addressing housing instability, noting the program was substantively changed based on board feedback and has been very successful helping families who had never had bank accounts or been on leases." },
      { item:"Veteran Services Department Presentation", body:"VSO Erin Galindo reported his 3.0 FTE department had 8,149 interactions in 2025, up from 5,900 the previous year. Veterans received $44 million annually in benefits plus $2.6 million in retroactive payments in 2025. Key initiatives include surviving spouse benefits outreach (DIC can provide $1,800-$2,400\/month tax-free), housing stability partnerships with Center for Veterans Issues establishing a local office, and suicide prevention efforts noting that of Marathon County's 30 suicides in 2025, seven were veterans. The department is exploring the Staff Sergeant Gordon Fox VA suicide prevention grant. Supervisor Kremes asked about regional coordination; Galindo explained state statute requires each county have a VSO but veterans can work with any county's office." },
      { item:"Aging Disability Resource Center Presentation", body:"Executive Director Mike Ray described the four-county ADRC (Marathon, Lincoln, Langlade, Wood) serving as the one-stop shop for aging and disability services with approximately 60 FTE and 385-400 volunteers. About 11% of budget is county levy ($413,135 from Marathon County for 2026). He emphasized severe financial challenges in the nutrition\/Meals on Wheels program, with federal funding flat since 2024 while food costs increased 40-45% over four years, forcing reduced meals and service days. Wisconsin is number one in falls and falls-related injuries nationally. Vice Chair Rosenberg praised the culturally appropriate meal program at the Hmong American Center." },
      { item:"Next Meeting Date", body:"The agenda incorrectly listed May 29th as a Wednesday. Vice Chair Rosenberg and Supervisor Kremes caught the error. The correct next meeting date was confirmed as Wednesday, June 3rd at 3 PM." },
    ],
    publicComment: "No public comment was offered.",
    actionItems: [
      ...
      "ADRC Executive Director Mike Ray to present full annual report with 2025 data to full county board",
      ...
      "Next meeting scheduled for Wednesday, June 3rd at 3 PM",
    ],
  },
  {
    ...
    agenda: [
      ...
      { time:"5:01", item:"Committee appointments discussion and approval" },
      { time:"10:01", item:"Election of at-large executive committee members" },
      { time:"20:00", item:"Consent agenda items C10-C14A" },
      { time:"21:00", item:"Resolution D15 - Out of home placement reserve increase" },
      { time:"22:00", item:"Resolution D16 - Social services budget amendment" },
      { time:"23:00", item:"Resolution E17 - Landfill tipping fees modification" },
      { time:"1:15:01", item:"Announcements and adjournment" },
    ],
    discussions: [
      { item:"Committee Appointments", body:"Chair Gibbs presented committee appointments developed with Vice Chair Boots, emphasizing goals of increasing perspective diversity, developing supervisor leadership, and accommodating preferences. The appointments were approved with a motion by Supervisor Cavelli and second by Supervisor Crims. The motion carried but was not unanimous. Supervisor Sybert noted the system marked him absent but he wished to be recorded as an 'aye' vote." },
      { item:"Election of At-Large Executive Committee Members", body:"Three supervisors were nominated for two at-large executive committee positions: Supervisor Hapa (nominated by Supervisor Mask), Supervisor Leur (nominated by Supervisor Rosenberg), and Supervisor Arstead (nominated by Vice Chair Boots). Supervisor Rosenberg spoke in support of Supervisor Leur, citing her advocacy for children and elders. Paper ballots were distributed and counted. Supervisors Hapa and Arstead were elected to the executive committee." },
      { item:"Consent Agenda", body:"Items C10 through C14A were approved on consent with a motion by Supervisor Cavelli and second by Supervisor Drebeck. The motion carried unanimously." },
      { item:"Resolution D15 - Out of Home Placement Reserve Increase", body:"Resolution 24-26 was moved by Supervisor Morash and seconded by Supervisor Robinson. The motion carried but was not unanimous." },
      { item:"Resolution D16 - Social Services Budget Amendment", body:"Resolution 25-26 was moved by Supervisor P and seconded by Supervisor Robinson. The motion carried but was not unanimous." },
      { item:"Resolution E17 - Landfill Tipping Fees Modification for Disaster Debris", body:"Administrator Leonard and Solid Waste Director Hagen Busher presented a proposal to reduce tipping fees for debris from the severe weather emergency. The state is waiving its $13.10 fee, the Town of Ringle is waiving its $2.33 fee, and the county proposed reducing to $36.94 per ton (commercial rate minus state and local fees) to cover costs. Two residents, Jessica Toasty and Matt Haybeck, were granted special permission to speak and requested the county waive fees entirely, citing the 44 affected homes and ongoing insurance delays. Multiple supervisors asked questions about fee calculations, timeline flexibility, and coverage scope. The board first voted unanimously to suspend rules to consider the resolution, then unanimously approved Resolution 26-26 to modify tipping fees through June 17th." },
    ],
    publicComment: "Two residents were granted special dispensation to speak on the landfill tipping fee resolution. Jessica Toasty requested Marathon County wave fees entirely, noting the state, DNR, and Ringle are waiving their fees, and that private businesses have donated significant resources while the county has provided limited financial assistance. Matt Haybeck spoke on behalf of the approximately 44 homes affected, requesting fee relief for underinsured residents and an extended timeline since many insurance adjusters have not yet arrived.",
    actionItems: [
      ...
      "Resolution 26-26 approved reducing landfill tipping fees to approximately $36.94 per ton for certified disaster debris through June 17th",
      ...
      "Solid waste management board directed to develop clear policy for handling similar disaster situations within six months",
      "Board to revisit fee structure at May meeting if extension beyond state declaration period is needed",
    ],
  },
  {
    ...
    isAgendaOnly: false,
    badge: "new",
    overview: "The Marathon County Environmental Resources Committee approved two rezoning petitions and voted to forward a modified fee waiver resolution to the county board. The committee amended the severe weather fee waiver proposal to cover only septic system reconnect fees ($160) rather than all zoning and pouts fees for properties damaged in the April 17, 2026 tornado.",
    agenda: [
      { time:"0:00", item:"Call to order and Pledge of Allegiance" },
      { time:"1:18", item:"Public comment" },
      { time:"1:30", item:"Approval of March 31, 2026 committee minutes" },
      { time:"1:55", item:"Public hearing: Tim Veland rezoning petition (Urban Residential\/General Agriculture to Rural Residential, Town of Green Valley)" },
      ...
      { time:"1:15:01", item:"Department overview: Parks, Recreation, and Forestry" },
      { time:"1:35:02", item:"Department overview: Conservation, Planning, and Zoning" },
    ],
    discussions: [
      ...
      { item:"Tim Veland rezoning petition (Town of Green Valley)", body:"Land Use Specialist Garrett Pogle presented the staff report for rezoning from Urban Residential and General Agriculture to Rural Residential. The Town of Green Valley recommended approval on March 10, 2026. No public testimony was offered for or against. Supervisor Drebeck moved to approve based on findings of fact, conclusions of law, and town approval, seconded by Supervisor Kurt. Motion carried unanimously." },
      { item:"Jeffrey and Cynthia Schmidtz rezoning petition (Town of McMillan)", body:"Garrett Pogle presented the petition to rezone from Conservancy Recreation to General Agriculture. Supervisor Leur asked about the conservancy nature, and Pogle explained the property contains a home and horse riding stable, with the rezoning intended to make the home a conforming use rather than non-conforming. The Town of McMillan recommended approval on April 20, 2026. No public testimony was offered. Supervisor Sefeld moved to approve, seconded by Supervisor Drew. Motion carried unanimously." },
      { item:"Fee waiver for April 17, 2026 severe weather damage", body:"Director Lori Mskimmons presented a proposal to waive county zoning and pouts fees for tornado-damaged properties. Significant debate ensued. Supervisor Drew questioned where to draw the line for future events. Supervisor Drebeck expressed concerns about fairness to those not in declared disaster areas. Supervisor Sefeld moved to approve the full resolution, seconded by Supervisor Leur. Supervisor Drebeck then proposed an amendment to limit the waiver to only reconnect fees ($160) for pouts systems, excluding all other fees. The amendment was seconded by Supervisor Kurt and passed. The amended resolution then passed on a non-unanimous vote to forward to the county board." },
    ],
    publicComment: "No public comment was offered.",
    actionItems: [
      "Forward amended fee waiver resolution to county board covering only pouts reconnect fees ($160) for properties damaged in April 17, 2026 severe weather",
      "Two rezoning petitions approved and forwarded to Marathon County Board of Supervisors",
      "Staff to track costs and requests related to fee waiver implementation",
      "Conservation department educational presentation to be scheduled for summer meeting",
    ],
  },
  {
    ...
    isAgendaOnly: false,
    badge: "new",
    overview: "The Village of Weston Community Life and Public Safety Committee met on May 4th, approving amendments to the nuisance ordinance (Chapter 50), recommending an e-bike ordinance with restrictions on emotos, and authorizing a raze order for a deteriorated structure at 4104 Shore Avenue. The committee also discussed overnight parking regulations and a potential crosswalk near Mount Olive Church, deferring both items for further research.",
    agenda: [
      ...
      { time:"33:30", item:"Overnight parking regulations discussion" },
      { time:"50:01", item:"Crosswalk request on Alderson Street" },
      { time:"1:00:02", item:"Mobile food vendors fire inspection ordinance" },
      { time:"1:10:00", item:"Address corrections for E911 compliance" },
      { time:"1:15:00", item:"Raze order for 4104 Shore Avenue" },
    ],
    discussions: [
      { item:"Public Comment", body:"Jim Senalt spoke extensively about concerns with the new farmers market location at Kennedy Park, predicting grass damage from vehicle parking. He questioned whether parking on grass violates village code and raised ADA accessibility concerns about handicap spaces being on grass rather than asphalt. He also questioned the need for new fire inspections on food trucks and criticized the age of some code enforcement cases, noting some have been pending for years without visible progress." },
      { item:"Department Reports", body:"Code Enforcement reported that 3020 Mountain View Avenue will be removed from the enforcement list after the property sale was completed and the new owner submitted repair permits. Chief Hunt reported the police department had 2,394 calls in March (77 per day). The department has hired its 40th officer, with the 38th starting last week, 39th starting in May, and 40th around January. Two SROs work on zoning violations during summer for Weston, Rothschild, and Schofield. Motion to acknowledge reports 5, 6, and 7 passed unanimously." },
      { item:"Chapter 50 Nuisance Amendments", body:"The committee reviewed final amendments to the nuisance ordinance, including previously discussed changes to tree limb heights over streets and walkways (14 and 10 feet) and compliance with jurisdictional authority requirements. Motion by Olsen, seconded by Campkey, to recommend approval to the Board of Trustees passed unanimously." },
      { item:"E-Bicycle Ordinance", body:"Extensive discussion occurred regarding the proposed e-bike ordinance. Chief Hunt strongly advocated for prohibiting emotos (electric dirt bikes) from roadways and sidewalks, comparing them to unlicensed dirt bikes. Committee members discussed whether electric scooters used by children should be restricted, with Chief Hunt suggesting officer discretion for 'kids play scooters.' The committee noted Rothschild was considering the ordinance, Wausau was making adjustments, and Schofield declined. Motion by Olsen, seconded by Sherwanka, to recommend approval with the addition that emotos are prohibited from roadways, sidewalks, trails, and public property passed unanimously." },
      { item:"Overnight Parking Regulations", body:"Trustee Tolson presented research showing Weston's 12-hour parking restriction (4 AM to 4 PM, October 31-May 1) is significantly longer than surrounding municipalities, which typically have 4-5 hour windows. Michael Wodalski from Public Works noted the even\/odd system was implemented because plowing typically doesn't start until 4 AM and residential streets aren't reached until 7-8 AM. Chief Hunt preferred keeping overnight restrictions to give officers time to clear vehicles before plowing. The committee decided to defer the item, asking Wodalski to identify 6-8 specific problem areas for targeted signage rather than village-wide restrictions." },
      { item:"Crosswalk on Alderson Street", body:"Mount Olive Church requested a crosswalk to connect their facility with DC Everest school parking they use during services. Staff estimated a basic crosswalk would cost approximately $2,000, while a lighted system would be $25,000-$30,000. Committee members expressed reluctance to set a precedent of paying for requested crosswalks. Motion by Olsen, seconded by Sherwanka, that if Mount Olive agrees to cover the installation cost, the committee recommends board approval. Motion passed unanimously." },
      { item:"Mobile Food Vendor Fire Inspections", body:"Chief Hunt explained a regional fire inspection program involving Wisconsin Rapids, Marshfield, Stevens Point, Plover, Rib Mountain, and Weston Safer departments. Food trucks inspected by any participating department receive a sticker valid across all jurisdictions, eliminating redundant inspections. Wausau opted out to maintain their own system. Chief Hunt noted a recent inspection failed a vendor due to improper galvanized steel LP piping and unsecured propane cylinders. Motion by Sherwanka, seconded by Campkey, to approve Ordinance 26-8 passed unanimously." },
      { item:"Address Corrections", body:"Staff presented three address corrections needed for E911 compliance: 5915 Delicoski Street (duplex needing separate addresses), Ross Avenue addresses out of sequence near an apartment building, and 2211 Radkey Avenue for a new duplex on a private drive. Chief Hunt added there's another issue on Delicoski at Weston Villa Apartments where an 8-plex has 9 separate addresses including a utility room. Motion passed unanimously to recommend corrections to the Board." },
      { item:"Raze Order for 4104 Shore Avenue", body:"Staff requested authorization to begin raze proceedings for an abandoned structure at 4104 Shore Avenue. The property has been abandoned since 2010-2011 and was deemed too deteriorated for a fire department training burn. Staff discovered chickens were being housed inside the structure after receiving reports of lights on in the building. The current owners, who are current on taxes, prefer the village proceed with demolition. Costs will be recovered through the tax roll. Motion by Olsen, seconded by Campkey, passed unanimously." },
    ],
    publicComment: "Jim Senalt provided extensive public comment criticizing the new farmers market location at Kennedy Park, raising concerns about grass damage from parking, ADA accessibility issues with handicap spaces on grass, questions about the origin of new food truck fire inspection requirements, and lack of progress on long-standing code enforcement cases. He stated some cases are 'almost old enough to vote' and requested the committee receive progress updates on older cases.",
    actionItems: [
      "Chapter 50 nuisance amendments recommended to Board of Trustees for approval",
      "E-bike ordinance with emoto prohibition on roadways, sidewalks, trails, and public property recommended to Board of Trustees",
      "Michael Wodalski to identify 6-8 specific problem areas for targeted overnight parking signage and return to committee in July",
      "Michael Wodalski to contact Mount Olive Church regarding cost-sharing for crosswalk installation",
      "Ordinance 26-8 for mobile food vendor fire inspections approved",
      "Address corrections for Delicoski Street, Ross Avenue, and Radkey Avenue recommended to Board",
      "Raze order for 4104 Shore Avenue authorized",
...
const WESTON_UPCOMING = [
  { date:"2026-05-21", time:"", name:"Mountain Bay Metropolitan Police Oversight Board", url:"https://www.westonwi.gov/AgendaCenter/ViewFile/Agenda/_05212026-1919", source:"weston" },
