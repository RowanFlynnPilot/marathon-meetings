...
const MEETINGS = [
  {
    ...
    isAgendaOnly: true,
    badge: "new",
    overview: "Based on the published agenda, the Village of Weston Board of Trustees was scheduled to meet on March 23, 2026, to address multiple rezoning ordinances, a subdivision final plat approval, parks-related matters including shelter fees and field maintenance agreements, and various infrastructure projects. The agenda included significant items affecting residential development, public parking restrictions, and utility engineering services.",
    agenda: [
    ...
    discussions: [
      { item:"Ordinance No. 26-004: Rezoning of 8905 Birch Street", body:"The Board was scheduled to consider rezoning a portion of 8905 Birch Street from RR-5 (Rural Residential-5 Acre) to SF-S (Single Family Residential-Small Lot) zoning district. This rezoning was expected to enable higher-density residential development on the property." },
      { item:"Ordinance No. 26-005: Rezoning of 7105 Christiansen Avenue", body:"The Board was set to review rezoning a portion of 7105 Christiansen Avenue from SF-L (Single Family Residential-Large Lot) to SF-S (Single Family Residential-Small Lot). This change was expected to allow for smaller lot residential development in the area." },
      { item:"Ordinance No. 26-006: Speed Limits Amendment", body:"The Board was scheduled to consider amendments to Chapter 82.600 of the Municipal Code regarding speed limits. The specific streets and speed changes were expected to be detailed in the full ordinance document." },
      { item:"Resolution No. 2026-008: Final Plat of Hinner Springs Second Addition", body:"The Board was expected to take action on approving the final plat for the Hinner Springs Second Addition Subdivision. This approval would set the stage for residential development in this subdivision." },
      { item:"April 2026 Referendum Informational Sessions Update", body:"The Board was scheduled to discuss updates on informational sessions planned for an April 2026 referendum. This was listed as discussion only with no action expected." },
      { item:"Proposed E-Bicycle and E-Moto Ordinance Dialogue", body:"The Board was set to consider referring discussion of a proposed ordinance regarding e-bicycles and e-motos to the Community Life and Public Safety Committee. This would address regulation of electric-powered personal vehicles in the Village." },
      { item:"Removal of No Parking Restrictions", body:"The Board was expected to consider removing no parking restrictions on Alta Verde Street south of Jelinek Avenue and on Alderson Street along Kennedy Park. This change could affect parking availability near the park." },
      { item:"Intersection Signage at Community Center Drive and Birch St", body:"The Board was scheduled to discuss and potentially take action on signage improvements at the intersection of Community Center Drive and Birch Street. This was expected to address traffic safety concerns at this location." },
      { item:"Baseball\/Softball Field Maintenance and User Agreement", body:"The Board was set to review a maintenance and user agreement for baseball and softball fields. This agreement was expected to outline responsibilities and terms for organizations using Village athletic facilities." },
      { item:"Purchase of Commercial Rotary Mower", body:"The Board was scheduled to consider the purchase of a commercial rotary mower for Village use. This equipment purchase was expected to support parks and grounds maintenance operations." },
      { item:"Park Shelter Fees and Field Rental Costs", body:"The Board was expected to discuss and potentially adjust fees for park shelter rentals and field usage. This review could affect pricing for residents and organizations using Village recreation facilities." },
      { item:"Eagle Scout Project at Machmueller Park", body:"The Board was scheduled to consider an Eagle Scout project proposed for Machmueller Park. Eagle Scout projects typically involve community improvement work completed by scouts pursuing their Eagle rank." },
      { item:"Remote Meeting Attendance Policy Review", body:"The Board was set to review the remote meeting attendance policy contained in the Elected and Appointed Officials' Handbook. This discussion was expected to address rules governing virtual participation in Village meetings." },
      { item:"Military Road Utility Engineering Services Contract", body:"The Board was scheduled to consider a contract for utility engineering services on Military Road. This was expected to support infrastructure planning or improvements along this corridor." },
      { item:"Bus 51 Storm Pond Engineering Services Contract Amendment", body:"The Board was expected to review an amendment to the engineering services contract for the Bus 51 storm pond project. This amendment may address changes in scope or cost for stormwater management work." },
      { item:"2026 Annual Street Maintenance Plan and Budget", body:"The Board was scheduled to discuss and potentially approve the 2026 annual street maintenance plan and associated budget. This plan was expected to outline roadway repair and maintenance priorities for the year." },
      { item:"Well 2 Rehabilitation", body:"The Board was set to consider rehabilitation work for Well 2, part of the Village's water supply infrastructure. This project was expected to address maintenance needs for the municipal water system." },
    ],
    publicComment: "Public comment period was scheduled at the beginning of the meeting, allowing persons to address the Board for up to three minutes on non-agenda items.",
    actionItems: [
  ...
  },
  {
    ...
    isAgendaOnly: true,
    badge: "new",
    overview: "Based on the published agenda, the Village of Weston Board of Trustees was scheduled to meet on March 23, 2026, to consider multiple rezoning ordinances, approve a subdivision final plat, discuss an upcoming April referendum, and address numerous infrastructure and parks-related items including street maintenance, utility engineering contracts, and park shelter fees.",
    agenda: [
      { time:"6:00 p.m.", item:"Public Comments" },
      { time:"N\/A", item:"Approval of February 16, 2026, Board of Trustees Meeting Minutes" },
      ...
      { time:"N\/A", item:"Ordinance No. 26-006: Amending Speed Limits Chapter 82.600" },
      { time:"N\/A", item:"Resolution No. 2026-008: Final Plat of Hinner Springs Second Addition Subdivision" },
      { time:"N\/A", item:"April 2026 Referendum Informational Sessions Update" },
      { time:"N\/A", item:"Proposed E-Bicycle and E-Moto Ordinance Dialogue" },
      { time:"N\/A", item:"Removal of No Parking Restrictions on Alta Verde St and Alderson Street" },
    ...
    discussions: [
      { item:"Ordinance No. 26-004: Rezoning of 8905 Birch Street", body:"The Board was scheduled to consider rezoning a portion of property at 8905 Birch Street from Rural Residential-5 Acre (RR-5) to Single Family Residential-Small Lot (SF-S). This change was expected to allow for higher-density residential development on the parcel." },
      { item:"Ordinance No. 26-005: Rezoning of 7105 Christiansen Avenue", body:"The Board was set to review rezoning a portion of property at 7105 Christiansen Avenue from Single Family Residential-Large Lot (SF-L) to Single Family Residential-Small Lot (SF-S). This would permit smaller lot residential development on the site." },
      { item:"Ordinance No. 26-006: Speed Limits Amendment", body:"The Board was expected to consider amendments to Chapter 82.600 of the Municipal Code regarding speed limits in the Village. The specific roads or speed changes were not detailed in the agenda." },
      { item:"Resolution No. 2026-008: Hinner Springs Second Addition Final Plat", body:"The Board was scheduled to take action on approving the final plat for the Hinner Springs Second Addition Subdivision. This approval would allow the subdivision development to proceed." },
      { item:"April 2026 Referendum Informational Sessions Update", body:"The Board was set to discuss updates regarding informational sessions planned for an April 2026 referendum. This was listed as discussion only with no action expected." },
      { item:"E-Bicycle and E-Moto Ordinance Dialogue", body:"The Board was expected to discuss a proposed ordinance addressing e-bicycles and e-motos, with dialogue to occur at the Community Life and Public Safety Committee. This item could involve potential regulations for electric-powered personal vehicles." },
      { item:"2026 Annual Street Maintenance Plan and Budget", body:"The Board was scheduled to review and potentially take action on the Village's 2026 street maintenance plan and associated budget. This would outline road repair and maintenance priorities for the year." },
      { item:"Military Road Utility Engineering Services Contract", body:"The Board was set to consider a contract for engineering services related to utilities on Military Road. This infrastructure project would involve professional engineering work for utility improvements." },
      { item:"Park Shelter Fees and Field Rental Costs", body:"The Board was expected to review and potentially adjust fees for park shelter rentals and field usage. Changes could affect costs for residents and organizations using Village park facilities." },
      { item:"Well 2 Rehabilitation", body:"The Board was scheduled to consider action on rehabilitation work for Well 2, part of the Village's water supply infrastructure. This maintenance project would help ensure continued water service reliability." },
    ],
    publicComment: "Public comments were scheduled at the beginning of the meeting, with speakers allowed up to three minutes for non-agenda items, with time extensions at the Chief Presiding Officer's discretion.",
    actionItems: [
      "Scheduled to vote on Ordinance No. 26-004 rezoning 8905 Birch Street from RR-5 to SF-S",
      "Scheduled to vote on Ordinance No. 26-005 rezoning 7105 Christiansen Avenue from SF-L to SF-S",
      "Scheduled to vote on Ordinance No. 26-006 amending speed limits",
  ...
  },
  {
    ...
    isAgendaOnly: true,
    badge: "new",
    overview: "Based on the published agenda, the Village of Weston Board of Trustees was scheduled to address multiple rezoning ordinances, a final plat approval for Hinner Springs Second Addition, and numerous infrastructure and parks-related items. The meeting also included discussion of an upcoming April 2026 referendum and potential e-bicycle regulations.",
    agenda: [
      { time:"N\/A", item:"Approval of February 16, 2026 Board of Trustees Meeting Minutes" },
      { time:"N\/A", item:"Acknowledge Reports\/Minutes from Boards, Committees, Commissions" },
      { time:"N\/A", item:"Acknowledge Reports from Departments" },
      { time:"N\/A", item:"Work Product Transmittals including February Building Permits, Budget Status, and Code Enforcement Reports" },
      { time:"N\/A", item:"Consent Agenda including Vouchers and Appointment of Agent Change for Reliance Fuel LLC" },
      { time:"N\/A", item:"Ordinance No. 26-004: Rezoning of Portion of 8905 Birch Street from RR-5 to SF-S" },
      { time:"N\/A", item:"Ordinance No. 26-005: Rezoning of Portion of 7105 Christiansen Avenue from SF-L to SF-S" },
    ...
    discussions: [
      { item:"Ordinance No. 26-004: Rezoning of 8905 Birch Street", body:"The Board was scheduled to consider rezoning a portion of 8905 Birch Street from RR-5 (Rural Residential-5 Acre) to SF-S (Single Family Residential-Small Lot) zoning district. This change was expected to allow for higher-density residential development on the property." },
      { item:"Ordinance No. 26-005: Rezoning of 7105 Christiansen Avenue", body:"The Board was set to review rezoning a portion of 7105 Christiansen Avenue from SF-L (Single Family Residential-Large Lot) to SF-S (Single Family Residential-Small Lot). This rezoning was expected to permit smaller lot residential development." },
      { item:"Ordinance No. 26-006: Speed Limits Amendment", body:"The Board was scheduled to consider amendments to Chapter 82.600 of the Municipal Code regarding speed limits. The specific street locations and speed changes were to be addressed during the meeting." },
      { item:"Resolution No. 2026-008: Hinner Springs Second Addition Final Plat", body:"The Board was expected to consider approval of the final plat for Hinner Springs Second Addition Subdivision. This action was set to formalize the subdivision layout and allow development to proceed." },
      { item:"April 2026 Referendum Informational Sessions Update", body:"The Board was scheduled for discussion only regarding updates on informational sessions related to an April 2026 referendum. This was expected to provide status on community outreach efforts." },
      { item:"E-Bicycle and E-Moto Ordinance Dialogue", body:"The Board was set to discuss a proposed ordinance addressing e-bicycles and e-motos, with the matter potentially being referred to the Community Life and Public Safety Committee for further review." },
      { item:"No Parking Restrictions Removal", body:"The Board was expected to consider removing no parking restrictions on Alta Verde Street south of Jelinek Avenue and on Alderson Street along Kennedy Park. This change could affect parking availability near the park." },
      { item:"Baseball\/Softball Field Maintenance and User Agreement", body:"The Board was scheduled to discuss maintenance responsibilities and user agreements for baseball and softball fields. This item was expected to address ongoing field upkeep and terms for groups using Village facilities." },
      { item:"Park Shelter Fees and Field Rental Costs", body:"The Board was set to review and potentially adjust fees for park shelter rentals and field usage. This discussion was expected to address pricing for community use of Village recreational facilities." },
      { item:"Eagle Scout Project at Machmueller Park", body:"The Board was scheduled to consider an Eagle Scout project proposed for Machmueller Park. Details of the project and any Village support needed were expected to be discussed." },
      { item:"Remote Meeting Attendance Policy", body:"The Board was set to review the Elected and Appointed Officials' Handbook regarding remote meeting attendance policy. This was expected to address guidelines for officials participating in meetings via Zoom or other platforms." },
      { item:"Microsoft Teams for Communication", body:"The Board was scheduled to discuss adopting Microsoft Teams as a communication tool. This item was expected to address internal communication methods for Village officials and staff." },
      { item:"Military Road Utility Engineering Services Contract", body:"The Board was expected to consider an engineering services contract for Military Road utilities. This infrastructure project was set for review regarding professional services needed." },
      { item:"Bus 51 Storm Pond Engineering Services Contract Amendment", body:"The Board was scheduled to review an amendment to the engineering services contract for the Bus 51 Storm Pond project. This was expected to address additional work or changes to the original contract scope." },
      { item:"2026 Annual Street Maintenance Plan and Budget", body:"The Board was set to discuss and potentially approve the 2026 Annual Street Maintenance Plan and associated budget. This comprehensive plan was expected to outline roadway maintenance priorities for the year." },
      { item:"Hospital Area Repaving Change Order #4", body:"The Board was scheduled to consider the fourth change order for the Hospital Area Repaving project. This was expected to address modifications to the original project scope or costs." },
      { item:"Well 2 Rehabilitation", body:"The Board was expected to discuss rehabilitation work needed for Well 2, part of the Village's water infrastructure. This item was set to address maintenance of water supply facilities." },
      { item:"Sign Encroachment Agreement with Macco's Floor Covering", body:"The Board was scheduled to consider a sign encroachment agreement with 7th Floor Investments, LLC for Macco's Floor Covering at 3111 Schofield Avenue. This agreement was expected to address signage extending into Village right-of-way." },
    ],
    publicComment: "Public comment was on the agenda, allowing persons to address the Board for up to three minutes regarding non-agenda items, with time extensions permitted at the Chief Presiding Officer's discretion.",
    actionItems: [
      "Scheduled to vote on approval of February 16, 2026 meeting minutes",
      "Expected to consider Ordinance No. 26-004 rezoning portion of 8905 Birch Street to SF-S",
      "Expected to consider Ordinance No. 26-005 rezoning portion of 7105 Christiansen Avenue to SF-S",
      "Expected to consider Ordinance No. 26-006 amending speed limits",
      "Scheduled to vote on Resolution No. 2026-008 approving Hinner Springs Second Addition final plat",
      "Expected to consider consent agenda including vouchers and agent change for Reliance Fuel LLC",
      "Scheduled to consider removal of no parking restrictions on Alta Verde St and Alderson Street",
      "Expected to consider intersection signage at Community Center Drive and Birch St",
      "Scheduled to consider Baseball\/Softball Field Maintenance and User Agreement",
      "Expected to consider purchase of Commercial Rotary Mower",
      "Scheduled to consider Park Shelter Fees and Field Rental Costs",
      "Expected to consider Eagle Scout Project at Machmueller Park",
      "Scheduled to review Remote Meeting Attendance Policy",
      "Expected to consider use of Microsoft Teams for Communication",
      "Scheduled to consider Military Road Utility Engineering Services Contract",
      "Expected to consider Bus 51 Storm Pond Engineering Services Contract Amendment",
      "Scheduled to consider Sewer Televising Software Contract",
      "Expected to consider 2026 Annual Street Maintenance Plan and Budget",
      "Scheduled to consider Hospital Area Repaving Change Order #4",
      "Expected to consider Well 2 Rehabilitation",
      "Scheduled to consider Sign Encroachment Agreement with Macco's Floor Covering",
    ],
  },
  {
    ...
    isAgendaOnly: false,
    badge: "new",
    overview: "The Board of Public Works awarded a $1,279,989.75 contract to Switlick & Sons, Inc. for the 2026 Street Construction Project on North 8th Avenue, but rejected bids for the 2026 Asphalt Paving Project. The board also approved change orders and a pay estimate totaling over $549,000 for the ongoing Randolph Street\/Cherry Street project.",
    agenda: [
    ...
    discussions: [
      ...
      { item:"2026 Asphalt Paving Project A", body:"The board opened bids for the 2026 Asphalt Paving Project A. The motion to approve failed." },
      { item:"2025 Street Construction Project A - Randolph Street\/Cherry Street Change Orders", body:"The board approved Change Order #1 in the amount of $14,436.50 for the Haas Sons, Inc. contract on the Randolph Street\/Cherry Street project. The motion passed." },
      { item:"2025 Street Construction Project A - Randolph Street\/Cherry Street Pay Estimate #9", body:"The board approved Pay Estimate #9 in the amount of $535,011.42 for Haas Sons, Inc. The motion passed." },
    ...
    actionItems: [
      "Contract for 2026 Street Construction Project B - North 8th Avenue awarded to Switlick & Sons, Inc. for $1,279,989.75",
      "2026 Asphalt Paving Project A bids rejected - project may require rebidding or further review",
  ...
  },
  {
    ...
    discussions: [
      ...
      { item:"February 18, 2026 Regular Plan Commission Minutes", body:"The minutes from the February 18, 2026 Regular Plan Commission meeting were approved. The specific vote count and movers\/seconders were not recorded." },
      { item:"Conditional Use Permit for 218 South 4th Street - Personal Storage Facility (Dunwoody Storage)", body:"A public hearing was held on the Conditional Use Permit for 218 South 4th Street to allow construction of a Personal Storage Facility in the Light Industrial Zoning District. No vote was recorded for this item, indicating it may have been for discussion only or action was deferred." },
      { item:"Conditional Use Permit for 731 N 1st Street - 70 unit apartment building (Beacon Resources, LLC)", body:"The commission approved a Conditional Use Permit for a 70-unit, 7-story apartment building at 731 N 1st Street proposed by Beacon Resources, LLC. The motion passed, though specific vote count and movers\/seconders were not recorded." },
      { item:"Transportation Project Plat for Project 370-40-40, Grand Avenue signal replacements", body:"The commission approved the Transportation Project Plat for Project 370-40-40, which includes Grand Avenue signal replacements at Sturgeon Eddy Road and Townline Road. The motion passed, though specific vote count and movers\/seconders were not recorded." },
    ],
    ...
    actionItems: [
      ...
      "Transportation Project Plat approved for Grand Avenue signal replacements at Sturgeon Eddy Road and Townline Road (Project 370-40-40)",
      "Public hearing held on Conditional Use Permit for personal storage facility at 218 South 4th Street - action pending",
    ],
    civicItems: [
  ...
  },
  {
    ...
    isAgendaOnly: false,
    badge: "new",
    overview: "The Wausau Board of Public Works awarded the 2026 Asphalt Paving Project 'A' contract to RC Pavers, LLC for $824,146.34. The board opened bids and made the recommendation during the brief meeting.",
    agenda: [
      { time:"N\/A", item:"Open bids and make recommendation for 2026 Asphalt Paving Project 'A'" },
    ],
    discussions: [
      { item:"2026 Asphalt Paving Project 'A'", body:"The board opened bids and voted to award the contract to RC Pavers, LLC in the amount of $824,146.34. The motion passed. Adjournment was moved by Vincent Bonino and seconded by Eric Lindman, passing 2-0." },
    ],
    publicComment: "Not indicated on agenda.",
    actionItems: [
  ...
  },
  {
    ...
    isAgendaOnly: false,
    badge: "new",
    overview: "The Public Health and Safety Committee approved all action items on the agenda, including various license applications, a rewrite of the solid waste disposal code, repeal of the hand-held mobile phone ordinance, and a solar energy partnership with MREA. The committee also received discussion items including the Fire Department's 2025 annual report.",
    agenda: [
      { time:"N\/A", item:"Public comment on agenda items and reading of the City of Wausau Public Comment Statement" },
    ...
    discussions: [
      ...
      { item:"Approval or denial of various license applications", body:"The committee passed two separate votes: one to approve a parklet permit and another to approve or deny licenses as indicated by staff with the exception of Theodore Davis. Both motions passed." },
      { item:"Repealing and recreating Wausau Municipal Code Chapter 6.44 Solid Waste Disposal", body:"The committee approved the new solid waste disposal code provision. The motion to approve passed." },
      { item:"Repealing Wausau Municipal Code Section 10.01.012 Use of Hand-Held Mobile Telephones and Mobile Electronic Devices While Driving Prohibited", body:"The committee voted to repeal the city ordinance prohibiting hand-held mobile phone use while driving. The motion to repeal passed." },
      { item:"Approving Memorandum of Understanding between the City of Wausau and the Midwest Renewable Energy Association (MREA)", body:"The committee approved the MOU to partner with MREA in operating the Grow Solar Central Wisconsin Group Buy Program. The motion to approve passed." },
      { item:"Wausau Fire Department 2025 Annual Report", body:"The Fire Department's 2025 annual report was presented as a discussion item. No vote was taken as this was informational only." },
      { item:"Tavern Activities Report from February 2026", body:"The February 2026 tavern activities report was presented as a discussion item. No vote was required." },
      { item:"Community Outreach Update", body:"A community outreach update was provided as a discussion item. No vote was taken." },
    ],
    ...
    actionItems: [
      "Various license applications approved as recommended by staff, with exception of Theodore Davis",
      ...
      "Wausau Municipal Code Section 10.01.012 regarding hand-held mobile devices while driving repealed",
      "Memorandum of Understanding with Midwest Renewable Energy Association approved for Grow Solar Central Wisconsin Group Buy Program",
    ],
    civicItems: [
  ...
  },
  {
    ...
    isAgendaOnly: false,
    badge: "new",
    overview: "The Wausau Finance Committee denied a tax recovery claim for Green Acres at Greenwood Hills while approving multiple airport ground lease transfers at 939 Woods Place. Several items including the National Opioid Settlement Agreement, Water Works budget amendment, and property purchases on Adolph Street were postponed to the next meeting.",
    agenda: [
      ...
      { time:"N\/A", item:"Approving consent to transfer title to buildings and improvements and waiver of first right of refusal to purchase at 939 Woods Place" },
      ...
      { time:"N\/A", item:"Closed Session for deliberating property purchases for DPW Streets Division" },
    ],
    discussions: [
      ...
      { item:"Approving consent to transfer title to buildings and improvements at 939 Woods Place", body:"The committee approved the consent to transfer title to buildings and improvements and waiver of first right of refusal to purchase at 939 Woods Place. The motion passed." },
      ...
      { item:"Wausau Water Works 2025 Lead Service Line Replacement budget amendment", body:"The committee voted to postpone consideration of the budget amendment for costs not funded by the WDNR subsidized loan to the next meeting. The motion to postpone passed." },
      ...
      { item:"Approving 2026 General Obligation Promissory Note for Capital Improvements", body:"The committee approved forwarding the 2026 General Obligation Promissory Note for Capital Improvements to the calendar. The motion passed." },
      { item:"Review of 2025 General Fund Financial Results", body:"The committee approved the transfer of funds related to the 2025 General Fund financial results. The motion passed." },
    ...
    actionItems: [
      "Tax recovery claim for Green Acres at Greenwood Hills denied",
      "Three airport ground lease actions at 939 Woods Place approved: title transfer consent, termination of Wynn O. Jones lease, new lease with Owen Jones",
      ...
      "Adolph Street and Myron Street property purchases postponed to next meeting",
    ],
    civicItems: [
      { number:"1", name:"Public comment on agenda items and reading of the City of Wausau Public Comment Statement.", votes:[], docs:[], children:[] },
  ...
  },
  {
    ...
    isAgendaOnly: false,
    badge: "new",
    overview: "The Wausau Common Council approved all items on its March 24, 2026 agenda, including a new residential solid waste and recycling service agreement with Harter's Fox Valley Disposal LLC, a development agreement for Waterside Place at 11 Scott Street, and a budget modification allowing the police department to use proceeds from selling a Thompson sub-machinegun to purchase red-dot optics. The council also suspended procedural rules (7-2) to consider late items including settlement of a property damage lawsuit.",
    agenda: [
      ...
      { time:"N\/A", item:"Resolution Adopting 2026 Budget Modification for Police Department to Purchase Red-Dot Optics" },
      ...
      { time:"N\/A", item:"Resolution Approving Paid Duty Time for Out of Country Police Training" },
    ...
    discussions: [
      { item:"March 10, 2026 Regular Common Council Minutes", body:"Approved 9-0. Motion by Sarah Watson, seconded by Vicki Tierney. All nine council members present voted in favor." },
      { item:"Consent Agenda - Ordinance Amending Fires, Fireworks, Firearms, Missiles and Parking Lot Lease Renewal", body:"Approved 9-0. Motion by Sarah Watson, seconded by Chad Henke. The consent agenda included the Parks & Recreation Committee ordinance amending Section 9.20.070 and the Finance Committee resolution renewing the parking lot lease with Colonial Property 4, LLC." },
      { item:"Confirming Mayoral Appointments", body:"Approved. The council confirmed Mayor Diny's appointments to the Plan Commission, Affordable Housing Task Force, and Business Improvement District Board. Vote count details not recorded." },
      { item:"Residential Solid Waste and Recycling Service Agreement", body:"Approved. The Finance Committee resolution authorizing a service agreement with Harter's Fox Valley Disposal LLC passed. Vote count details not recorded." },
      { item:"Airspace Obstruction Removal Agreements", body:"Approved. Two Finance Committee resolutions were passed authorizing airspace obstruction removal agreements with Schofield Ridgeland Legacy LLC for properties at 724 and 732 Ridgeland Avenue, and with Zachary Lange for 811 Ridgeland Avenue, including related budget modifications. Vote count details not recorded." },
      { item:"Police Department Budget Modification for Red-Dot Optics", body:"Approved. The Finance Committee resolution allowing the Wausau Police Department to use proceeds from the sale of a Thompson sub-machinegun to purchase red-dot optics passed. Vote count details not recorded." },
      { item:"Waterside Place Development Agreement at 11 Scott Street", body:"Approved. The joint resolution from the Economic Development Committee and Infrastructure & Facilities Committee authorizing a development agreement and amended parking agreement with 11 Scott Street, LLC for Waterside Place passed. Vote count details not recorded." },
      { item:"Suspension of Procedural Rules", body:"Approved 7-2. Motion by Lisa Rasmussen, seconded by Sarah Watson. Terry Kilian and Vicki Tierney voted no. The suspension allowed consideration of late items including the solid waste disposal ordinance and settlement resolution." },
      { item:"Solid Waste Disposal Ordinance", body:"Approved. The Public Health & Safety Committee ordinance repealing and recreating Wausau Municipal Code Chapter 6.44 Solid Waste Disposal passed. Vote count details not recorded." },
      { item:"Settlement of David Hoelzel Lawsuit", body:"Approved. The resolution approving release of all claims for property damage settlement in the counterclaim and third party complaint in David Hoelzel v. City of Wausau (Marathon Co. Case No. 25-CV-594) passed. Vote count details not recorded." },
      { item:"Paid Duty Time for Out of Country Police Training", body:"Approved. The joint resolution from Human Resources and Finance committees authorizing paid duty time for a Wausau Police Department officer's out of country training passed. Vote count details not recorded." },
      { item:"Community Outreach Professional Shelter Operations Premium", body:"Approved. The joint resolution from Human Resources and Finance committees establishing a shelter operations duty premium differential for community outreach professionals passed. Vote count details not recorded." },
    ],
    publicComment: "Public comment was on the agenda both before the business meeting (preregistered citizens) and after (citizens present during public comment).",
    actionItems: [
      "Implement new residential solid waste and recycling service agreement with Harter's Fox Valley Disposal LLC",
      "Execute airspace obstruction removal agreements with Schofield Ridgeland Legacy LLC and Zachary Lange with associated budget modifications",
      "Police Department to proceed with purchase of red-dot optics using Thompson sub-machinegun sale proceeds",
      "Finalize development agreement and parking agreement for Waterside Place at 11 Scott Street",
      "Implement revised Chapter 6.44 Solid Waste Disposal ordinance",
      "Process settlement release for David Hoelzel property damage case",
      "Arrange paid duty time for police officer's out of country training",
  ...
  },
  {
    ...
    discussions: [
      { item:"4K Program Agreement", body:"The district's four-year-old kindergarten program is seeking approval to continue partnership agreements with six community collaboration sites for the 2026-2027 school year, including Wausau Child Care, Mountain View Montessori, Woodson YMCA, Newman Catholic Schools, and Marathon County Head Start. These partnerships have been in place since 2002, and 4K Principal Kara Rakowski and Director of Elementary Education Julie Schell will present the agreement details." },
      { item:"Annual Safety Update \/ Drill Debrief", body:"The district is implementing the I Love U Guys Standard Response Protocol with standardized vocabulary (HOLD, SECURE, LOCKDOWN, EVACUATE, SHELTER) for consistent emergency responses across schools. Safety highlights include secure building entrances, Visitor Aware System, security cameras, locked exterior doors, and district-wide drills conducted in September and October with strong Wausau Police Department partnership." },
      { item:"Neola Policies Update", body:"The committee will review proposed changes to 43 attached policies covering a wide range of topics including board member conduct, student entrance age, third grade promotion and retention, academic honesty, drug policies, drone use, school safety, food service, wellness, and volunteer policies. The update includes both substantive policy changes and technical corrections to existing policies." },
    ],
  ...
  },
  {
    ...
    isAgendaOnly: true,
    badge: "new",
    overview: "This special meeting of the Wausau School District Board of Education focused on closed session matters including real estate negotiations and the superintendent evaluation. The board planned to potentially take action following the closed session discussions.",
    agenda: [
      { time:"0:00", item:"Call to Order" },
    ...
    discussions: [
      { item:"Discussion regarding the Competitive Negotiations of a Purchase\/Sale of Real Estate", body:"The board entered closed session under Wisconsin statute 19.85(1)(e) to discuss competitive negotiations related to the purchase or sale of real estate. This exemption allows boards to meet privately when public discussion could compromise the district's negotiating position." },
      ...
      { item:"Reconvene in Open Session, and if Necessary, Take Action as a Result of the Closed Session", body:"Following the closed session discussions, the board planned to reconvene publicly and potentially vote on matters related to the real estate negotiations or superintendent evaluation discussed in closed session." },
    ],
  ...
  },
  {
    ...
    isAgendaOnly: true,
    badge: "new",
    overview: "The Wausau School District Board of Education held its regular meeting covering elementary school referendum construction updates at 50% completion, a Red Granite Charter School status update, and approval of multiple policy updates. The meeting also addressed 4K program partnership agreements for 2026-2027 and received the annual school safety update from the Wausau Police Department.",
    agenda: [
      { time:"0:00", item:"Call to Order" },
      ...
      { time:"0:57", item:"New Business - Neola Policies Update" },
    ...
    discussions: [
      ...
      { item:"4K Program Agreement", body:"The Wausau School District four-year-old kindergarten program sought approval to enter into Program Agreements with community collaboration partner sites for the 2026-2027 school year, including Wausau Child Care, Mountain View Montessori, Woodson YMCA, Newman Catholic Schools, and Marathon County Child Development Agency Head Start Program." },
      ...
      { item:"Neola Policies Update", body:"Proposed changes to 43 district policies were reviewed at the November Education\/Operations Committee meeting, covering topics including definitions, board member conduct, student privacy, interscholastic athletics, food service, wellness, and school safety." },
    ],
    publicComment: "A public and student comment period was included on the agenda.",
    actionItems: [
      ...
      "4K Program Agreement approval for 2026-2027 partner sites",
  ...
  },
  {
    ...
    discussions: [
      { item:"Audit of the Bills", body:"The committee reviewed the December 2025 audit of bills document dated December 9, 2025. This item involves committee members examining and verifying the district's expenditures and financial obligations for the period." },
    ],
    publicComment: "No public comment period was included on this agenda.",
    actionItems: [
  ...
  },
  {
    ...
    discussions: [
      { item:"Approve Administrator Contracts and Discuss Performance and Employment of a Staff Member", body:"The board entered closed session under Wisconsin Statute 19.85(1)(c) to discuss and potentially approve administrator contracts and to address performance and employment matters concerning one or more staff members. This statute allows closed sessions for considering employment, promotion, compensation, or performance evaluation data of public employees." },
      { item:"Discussion regarding the Competitive Negotiations of a Purchase\/Sale of Real Estate", body:"The board conducted closed session discussions under Wisconsin Statute 19.85(1)(e) regarding competitive negotiations for the purchase or sale of real estate. This exemption protects the district's negotiating position in property transactions." },
      { item:"Resolution of Commendation: Ellie Mason", body:"The board formally recognized Ellie Mason with a Resolution of Commendation. Supporting documentation for this recognition was attached to the agenda packet." },
    ],
    publicComment: "No public comment period was included on this agenda.",
    actionItems: [
      "Approve Administrator Contracts",
      "Take action if necessary following closed session discussions",
  ...
  },
  {
    ...
    isAgendaOnly: true,
    badge: "new",
    overview: "The Wausau School District Education\/Operations Committee meeting focused on open enrollment seat availability for 2026-2027, snow day communication procedures, and athletic co-op renewals for hockey and lacrosse programs. The meeting also featured a student performance and presentation highlighting John Muir Middle School's excellence, followed by a tour of recent school updates.",
    agenda: [
      { time:"0:00", item:"Call to Order" },
    ...
    discussions: [
      { item:"Open Enrollment Seat Availability", body:"Wendy Cartledge presented the Open Enrollment Space Determinations for the 2026-2027 school year. This item determines how many seats will be available for students outside the district to enroll through Wisconsin's open enrollment program." },
      { item:"Snow Day Communication & Procedures", body:"Diana White and Dr. Katie Colwell presented information on communications and procedures for snow days. The presentation addressed what happens beyond the standard three snow days allocated in the school calendar." },
      { item:"Approve Co-Ops", body:"Athletic Directors BJ Brandt and Darci Mick Beversdorf presented information on athletic co-op renewals including boys hockey with East\/Merrill\/Newman Catholic, girls lacrosse with East\/West\/DCE\/Mosinee, and girls STORM hockey with East\/West\/DCE\/Mosinee adding Merrill and Stratford for the 2026-27 and 2027-28 school years." },
    ],
    publicComment: "A public and student comment period was included on the agenda.",
    actionItems: [
  ...
  },
  {
    ...
    isAgendaOnly: true,
    badge: "new",
    overview: "This special meeting of the Wausau School District Board of Education focused primarily on personnel matters, including a closed session hearing regarding employee termination and deliberation on administrator contracts. The meeting addressed routine staff appointments and separations while also handling sensitive employment matters requiring closed session proceedings.",
    agenda: [
      { time:"0:00", item:"CALL TO ORDER" },
    ...
    discussions: [
      { item:"Convene into closed session - Employee Conduct Hearing", body:"The board convened into closed session to receive evidence concerning allegations regarding employee conduct and an administrative recommendation for the employee's termination from employment. The board deliberated regarding evidence received during a quasi-judicial hearing and may have considered an employee resignation agreement." },
      { item:"Approve Administrator Contracts and Discuss Performance", body:"The board entered closed session pursuant to Wisconsin Statute 19.85(1)(c) to discuss and approve administrator contracts and to discuss the performance and employment of staff members. The board was to reconvene in open session to take further action if necessary." },
    ],
    publicComment: "No public comment period was included on this agenda.",
    actionItems: [
  ...
  },
  {
    ...
    isAgendaOnly: true,
    badge: "new",
    overview: "The Wausau School District Board of Education Regular Meeting covers the approval of the 2024-25 audit report, WASB delegate voting instructions, and a discussion about replacing the chiller system at Wausau West High School. The meeting also addresses athletic co-op renewals, open enrollment seat availability, and includes closed session items regarding potential litigation and superintendent evaluation.",
    agenda: [
      { time:"0:00", item:"Call to Order" },
      { time:"0:02", item:"Roll Call" },
    ...
    discussions: [
      ...
      { item:"WASB Resolutions", body:"The Board will review proposed Wisconsin Association of School Boards Resolutions and direct the WASB Delegate on how to vote on behalf of the District. A late addition includes Resolution 13 proposing an amendment to WASB bylaws." },
      ...
      { item:"Wisconsin Investment Series Cooperative Resolution", body:"Assistant Superintendent of Operations Elizabeth Channel is presenting a resolution to allow the District to continue its membership in the Wisconsin Investment Series Cooperative. This updates the most recent authorization, which is over ten years old, in accordance with best practice." },
      { item:"Open Enrollment Seat Availability", body:"Following the December Education\/Operations Committee Meeting presentation by Wendy Cartledge, the Board will consider the Open Enrollment Space Determinations for the 2026-2027 school year." },
      { item:"Approve Co-Ops", body:"The Board will consider athletic co-op renewals including boys hockey East\/Merrill\/Newman Catholic, girls lacrosse East\/West\/DCE\/Mosinee, and girls STORM hockey East\/West\/DCE\/Mosinee with additions of Merrill and Stratford, all for the 2026-27 and 2027-28 school years." },
    ],
  ...
  },
  {
    ...
    isAgendaOnly: true,
    badge: "new",
    overview: "This Audit of the Bills Committee meeting focused on reviewing and approving financial expenditures for the Wausau School District. The committee examined bills documentation dated January 22, 2026 as part of routine fiscal oversight responsibilities.",
    agenda: [
      { time:"0:00", item:"Call to Order" },
      { time:"0:02", item:"Audit of the Bills" },
      { time:"0:07", item:"Adjourn" },
    ...
    discussions: [
      { item:"Audit of the Bills", body:"The committee reviewed financial documentation attached as 'AuditofbillsJanuary26' which was prepared on January 22, 2026. This item involved examining district expenditures and bills for approval as part of standard financial oversight procedures." },
    ],
    publicComment: "No public comment period was included on this agenda.",
    actionItems: [
      "Approval of audited bills for January 26, 2026",
    ],
  },
  {
    ...
    isAgendaOnly: true,
    badge: "new",
    overview: "The Wausau School District Education\/Operations Committee meeting addressed significant referendum construction projects, with 95% design approvals requested for four elementary schools. The meeting also covered financial planning, student demographics, and potential governance restructuring of board committees.",
    agenda: [
      { time:"0:00", item:"Call to Order" },
      { time:"0:02", item:"Approve the Minutes" },
    ...
    discussions: [
      { item:"Franklin, Rib Mountain, Lincoln & John Marshall 95% Design", body:"As referendum projects reach 95% design completion, the Board is reviewing designs and budgets for Franklin, Rib Mountain, Lincoln, and John Marshall Elementary schools. The Committee is being asked to approve these plans for soliciting competitive bids." },
      { item:"Legal Expenses for 2nd Quarter of 2025-2026", body:"Interim Assistant Superintendent Elizabeth Channel presented a summary report of all legal counsel expenses incurred during the second quarter. The report breaks down expenses by law firm and type of legal advice sought, requiring no action." },
      { item:"Approve 2026-2027 District Calendar", body:"Diana White presented a draft of the 2026-2027 school year calendar for Board review. The Committee is being asked to consider approval of the calendar." },
      ...
      { item:"2025-2026 Student Demographic Report", body:"Director of Technology Ralph Williams presented the Demographics Report for the 2025-2026 school year. The presentation included student demographic data and analysis." },
      { item:"Governance Model Option", body:"The Board continued discussion about potentially changing the Audit of the Bills Committee and clarifying the purpose of the Education\/Operations Committee with a potential rename. This item may result in action." },
    ],
    publicComment: "A public and student comment period was included on the agenda.",
    actionItems: [
  ...
  },
  {
    ...
    isAgendaOnly: true,
    badge: "new",
    overview: "This special meeting of the Wausau School District Board of Education focused on personnel matters through the consent agenda, approval of the 2026-2027 district calendar, and a closed session for the evaluation of the Superintendent of Schools. The meeting addressed routine staffing changes and finalized the upcoming school year calendar.",
    agenda: [
      { time:"0:00", item:"Call to Order" },
    ...
    discussions: [
      { item:"Approve 2026-2027 District Calendar", body:"Diana White previously presented a draft of the 2026-2027 school year calendar for School Board review at an earlier meeting. The board was asked to formally approve the calendar at this special meeting, with an estimated presentation time of just one minute." },
      { item:"Evaluation of Superintendent of Schools", body:"The board entered closed session pursuant to Wisconsin State Statute s. 19.85 (1)(c) to conduct the evaluation of the Superintendent of Schools. This personnel matter required confidential discussion before potentially reconvening in open session to take any necessary action." },
    ],
    publicComment: "No public comment period was included on this agenda.",
    actionItems: [
      "Approve Consent Agenda including appointments, separations, leaves of absence, and retirements",
  ...
  },
  {
    ...
    isAgendaOnly: true,
    badge: "new",
    overview: "The Wausau School District Board of Education regular meeting covered referendum project design approvals for four elementary schools, a chiller system replacement at Wausau West, and an update on the Wausau East hockey program following the disbandment of a cooperative agreement. The meeting also addressed governance structure changes and financial projection planning for the district.",
    agenda: [
      { time:"0:00", item:"Call to Order" },
      { time:"0:02", item:"Roll Call" },
      { time:"0:04", item:"Pledge of Allegiance" },
    ...
    actionItems: [
      "Approve Consent Agenda including appointments, separations, leaves of absence, retirements, meeting minutes, payment of bills, and donations",
      "Approve Franklin, Rib Mountain, Lincoln & John Marshall Elementary Schools 95% design plans for competitive bidding",
  ...
  },
  {
    ...
    isAgendaOnly: true,
    badge: "new",
    overview: "This special meeting of the Wausau School District Board of Education focused on personnel matters through a consent agenda and entered closed session to discuss potential litigation. The meeting addressed staff appointments, separations, leaves of absence, and retirements.",
    agenda: [
      { time:"0:00", item:"Call to Order" },
  ...
  },
  {
    ...
    isAgendaOnly: true,
    badge: "new",
    overview: "The Wausau School District Board of Education Committee of the Whole meeting covered a comprehensive five-year fiscal forecast, AGR schools mid-year update, and extensive policy revisions through NEOLA. The meeting also featured Excellence in Action presentations highlighting the district's Planetarium and Wausau West High School, with a facility tour following adjournment.",
    agenda: [
      { time:"0:00", item:"Call to Order" },
      { time:"0:02", item:"Approve the Minutes" },
    ...
    discussions: [
      { item:"Five Year Fiscal Forecast", body:"The Board was presented with a five-year fiscal forecast model for the District, which will be applied over the next three months to aid in constructing the 2026-27 budget reconciliation plan. Administration noted that projections result from many variables that change periodically, and significant changes will be communicated to the Board as they occur." },
      { item:"AGR Annual Report", body:"This mid-year update provided the Board with AGR student outcome scores required by the DPI, including screening results. The presentation featured work being done in each of the three AGR schools to strengthen organizational systems and demonstrate how these schools are evolving practices to improve student achievement." },
      { item:"NEOLA UPDATE", body:"The Committee reviewed proposed changes to numerous policies ranging from technical corrections to more substantive updates. Policy areas covered include definitions, board member conduct, district administrator relationships, reading instructional goals, student policies on cell phones and academics, financial policies, and school support organization related policies." },
      { item:"Referendum Budget Update", body:"As the April 2022 referendum funded facility improvements continue to develop, construction and budget updates were presented. These updates will continue routinely until all projects are completed." },
    ],
    publicComment: "Public and Student Comment period was included on the agenda.",
    actionItems: [
      "Approve the Minutes",
      "Audit of the Bills",
      "NEOLA policy updates approval for policies covering definitions, board member conduct, district administrator relationships, reading instruction, parent engagement, athletics, student policies, financial policies, and school support organizations",
    ],
  },
  {
  ...
  },
  {
    ...
    isAgendaOnly: true,
    badge: "new",
    overview: "This special meeting brought together the Elementary Task Force members one year after the elementary consolidation process to reflect on the implementation and outcomes. The meeting was informational in nature with no Board action taken, though a quorum of the Board of Education may have been present.",
    agenda: [
    ...
    discussions: [
      { item:"Summary of Elementary Consolidation", body:"This item provided an overview of the elementary school consolidation process that was implemented in the Wausau School District. The summary likely covered the changes made and outcomes of the consolidation effort." },
      { item:"Task Force Member Reflectives: One Year Later", body:"Task Force members shared their reflections on the elementary consolidation one year after implementation. Members likely discussed lessons learned, challenges encountered, and the impact of the consolidation on the district." },
    ],
    publicComment: "No public comment period was included on this agenda.",
    actionItems: [
  ...
  },
  {
    ...
    isAgendaOnly: true,
    badge: "new",
    overview: "This meeting was a WEA-sponsored candidate meet and greet event for Wausau School District Board of Education candidates. While a quorum of the Board may have been present, no official board action was taken at this event.",
    agenda: [
      { time:"0:00", item:"WEA Sponsored WSD School Board Candidates Meet & Greet Event" },
    ],
    discussions: [
      { item:"WEA Sponsored WSD School Board Candidates Meet & Greet Event", body:"This was a candidate meet and greet event sponsored by the Wausau Education Association for Wausau School District Board candidates. A quorum of current board members may have attended, but the event was informational only with no board action taken." },
    ],
    publicComment: "No public comment period was included on this agenda.",
    actionItems: [
  ...
  },
  {
    ...
    isAgendaOnly: true,
    badge: "new",
    overview: "The Wausau School District Board of Education held a regular meeting covering routine consent agenda items, a referendum budget update, and a proposal to switch middle school devices from Chromebooks to iPads. The meeting also included presentations on the district's five-year fiscal forecast and AGR (Achievement Gap Reduction) annual report showing student outcome scores.",
    agenda: [
      { time:"0:00", item:"Call to Order" },
      { time:"0:02", item:"Roll Call" },
      { time:"0:04", item:"Pledge of Allegiance" },
      ...
      { time:"0:13", item:"Public and Student Comment" },
      { time:"0:23", item:"Approve Consent Agenda" },
      { time:"0:28", item:"Old\/Recurring Business - Committee of the Whole Meeting" },
      { time:"0:33", item:"New Business - iPads Presentation" },
      { time:"0:55", item:"New Business - Committee of the Whole Meeting" },
      { time:"1:02", item:"Open Forum" },
      { time:"1:12", item:"Adjourn" },
    ],
    discussions: [
      { item:"Referendum Budget Update", body:"An update on the April 2022 referendum-funded facility improvements was presented, continuing routine construction and budget updates until projects are completed. The presentation shared at the February Committee of the Whole Meeting was included as an attachment." },
      { item:"iPads Presentation", body:"The district presented information on switching one-to-one devices at the middle school level from Chromebooks to iPads. This 20-minute presentation outlined the proposed technology transition for middle school students." },
      { item:"Five Year Fiscal Forecast", body:"The Committee reviewed a five-year fiscal forecast model for the District that will be used over the next three months to construct the 2026-27 budget reconciliation plan. Administration noted that projections are based on many variables that change periodically and will update the Board on significant changes." },
      { item:"AGR Annual Report", body:"The mid-year AGR student outcome scores required by DPI were presented, featuring screening results and the work being done in the three AGR schools to strengthen organizational systems. The report demonstrated how these schools are evolving their practices to improve student achievement." },
    ],
    publicComment: "A public and student comment period was included on the agenda.",
    actionItems: [
  ...
  },
  {
    ...
    isAgendaOnly: true,
    badge: "new",
    overview: "The Wausau School District Board of Education Committee of the Whole meeting addressed routine business including approval of a nutrition cooperative agreement and facility fee schedule updates, along with a referendum budget update and extensive policy revisions through NEOLA. The meeting featured recognition of Stettin Elementary through the Excellence in Action program.",
    agenda: [
      { time:"0:00", item:"Call to Order" },
      { time:"0:02", item:"Approve the Minutes" },
      { time:"0:05", item:"Audit of the Bills" },
    ...
    discussions: [
      ...
      { item:"NEOLA UPDATE", body:"The Committee will review proposed changes to numerous district policies, ranging from technical corrections to substantive updates. Policy areas include board member conduct, district administrator relationships, reading instructional goals, student policies on cell phones and academic honesty, financial policies, and new policies on artificial intelligence. Additionally, Act 57 related policies addressing child abuse reporting and student supervision are included." },
    ],
    publicComment: "No public comment period was included on this agenda.",
    actionItems: [
      ...
      "Approve NEOLA policy updates including definitions, board member conduct, student policies, financial policies, and Act 57 related policies",
