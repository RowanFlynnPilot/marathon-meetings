...
const MEETINGS = [
  {
    ...
    isAgendaOnly: false,
    badge: "new",
    overview: "The Wausau City Council approved a major development agreement for 11 Scott Street (6-3 vote), recognized city workers for their response to a record 30.9-inch snowfall, and presented a sustainability award to Colby and Colby Millwork. The council also approved a 7-year solid waste agreement with Harter's and several other resolutions unanimously.",
    agenda: [
      { time:"0:00", item:"Call to order and Pledge of Allegiance" },
      { time:"0:45", item:"Roll call" },
      { time:"1:15", item:"Proclamation - Sarah Rafi Day (March 31st)" },
      { time:"5:30", item:"Mayoral citation for Public Works snow response" },
      { time:"12:30", item:"Sustainability Award presentation to Colby and Colby Millwork" },
      { time:"20:15", item:"Approval of March 10, 2026 meeting minutes" },
      { time:"21:00", item:"Public comment period" },
      { time:"23:00", item:"Consent agenda" },
      { time:"23:45", item:"Development agreement for 11 Scott Street\/Waterside Place" },
      { time:"38:00", item:"Various resolutions including solid waste agreement, airspace obstruction agreements, police department budget modification" },
      { time:"45:00", item:"Announcements and adjournment" },
    ],
    discussions: [
      { item:"Development Agreement for 11 Scott Street\/Waterside Place", body:"The council debated a joint resolution approving a development agreement and amended parking agreement with 11 Scott Street LLC. Developer representatives Raleigh Lray and Mark Craig spoke during public comment, noting the $10 million project would create 52 mid-priced residential units. Alder Rasmussen supported the project, emphasizing it would return the building to taxable status and release parking spaces for public use. Alder Neil highlighted multiple benefits including $55,000 annual parking revenue and helping TID 8 reach valuation goals. Alder Larson dissented, arguing the city should not discount its assets during budget cuts. Alder Tierney questioned how the city could provide 150 parking spaces within 300 yards if the ramp closed. Economic Development Director Randy Feifer explained the agreement reduces their parking allocation from 480 to 150 spaces and generates revenue where none existed before. The motion passed 6-3." },
      { item:"Mayoral Citation for Public Works Snow Response", body:"Mayor Denny presented a citation recognizing the Department of Public Works for their response to a record-breaking 30.9-inch snowfall from March 14-16, 2026. Street Supervisor Kevin Kester accepted the award and praised the plow operators and mechanics, stating 'you kicked its ass.' The citation noted fleet technicians worked 12-hour shifts providing 24-hour breakdown support, with two volunteering on Saturday for downtown snow removal. By Friday, these workers will have worked 12 straight days without a day off." },
      ...
      { item:"Solid Waste and Recycling Service Agreement", body:"The council approved a 7-year residential solid waste and recycling service agreement with Harter's Fox Valley Disposal. Mayor Denny noted there had been a mix-up on whether the term was 7 or 10 years, confirming it was corrected to 7 years as Public Health and Safety had put forward. Approved 9-0." },
      { item:"Settlement of Counter Claim - David Holes vs City of Wausau", body:"Assistant City Attorney Vincent Bonito explained a 2022 bus accident where Transit Mutual insurance paid the claim, but the individual who crashed into the bus later filed a personal injury claim. The city filed a counter claim and third-party complaint. The insurer agreed to pay bus damages, and the resolution approves release of the city's claims. Alder Neil clarified this does not affect the individual's separate injury claim. Passed 8-1 without need for closed session." },
    ],
    publicComment: "Two speakers addressed the council regarding the 11 Scott Street project. Raleigh Lray spoke in support, describing it as a green sustainable project repurposing a vacant building to add mid-priced apartments downtown. Mark Craig of 3246 North 8th Street emphasized the $10 million project's difficulty, noting it would create 52 mid-priced residential units costing $8.3 million, and urged council support.",
    actionItems: [
      ...
      "7-year solid waste agreement with Harter's Fox Valley Disposal approved",
      "Airspace obstruction removal agreements for 724\/732 Ridgeland Ave and 11 Ridgeland Ave in Schofield approved",
      "2026 budget modification approved for Police Department to use Thompson submachine gun sale proceeds for Red Dot Optics",
  ...
  },
  {
    ...
    isAgendaOnly: false,
    badge: "new",
    overview: "The Wausau Board of Public Works approved a street construction contract to Switlick as the lowest bidder by less than $1,000 over the second bidder, approved a change order for unexpected underground utility conditions, and processed a pay estimate for an ongoing street project. All items passed unanimously with no opposition.",
    agenda: [
      ...
      { time:"1:26", item:"North 8th Avenue bid opening - postponed" },
      { time:"1:36", item:"2025 Street Construction Project A - Rolph Street, Cherry Street - Change Order One" },
      { time:"3:42", item:"2025 Street Construction Project A - Pay Estimate Number Nine" },
      { time:"4:05", item:"Portland cement concrete license for KSK Incorporated" },
      { time:"4:30", item:"Adjournment" },
    ],
    discussions: [
      { item:"March 10th Board of Public Works Minutes", body:"Minutes from the previous meeting were presented for approval. A motion was made and seconded. The minutes were approved unanimously." },
      { item:"26th Street Construction Project Bid Opening", body:"Seven bids were opened for the project. Switlick submitted the lowest bid at $1,279,889.75, narrowly beating Hos at $1,280,877.96 by less than $1,000. Other bidders included A1 ($1,374,600), Francis Melvin ($1,385,383), Steen ($1,489,126), James Peterson ($1,570,698.56), and Earth ($1,686,078.75). A board member noted the 'tight bids' between the top two. Motion to approve Switlick passed unanimously." },
      ...
      { item:"2025 Street Construction Project A - Change Order One", body:"Staff presented change order one totaling $14,436.50 for four items caused by unexpected field conditions: an inside drop on a manhole due to an unrecorded large diameter sanitary service ($4,856), water main tie-in modification from 8-inch to 6-inch ($2,317.50), miscellaneous storm sewer tie-ins ($5,016), and geogrid installation near Thomas Jefferson Elementary due to poor soils ($2,247). Change order two regarding liquidated damages was deferred pending further discussions. Motion to approve passed unanimously." },
      { item:"Pay Estimate Number Nine - Rolph Street, Cherry Street", body:"Staff recommended approval of pay estimate number nine from Haw Suns Incorporated for work completed through the end of the year in the amount of $535,114.22. Motion to approve passed unanimously." },
    ...
    actionItems: [
      "Award 26th Street construction project contract to Switlick at $1,279,889.75",
      "Approve change order one for Rolph Street\/Cherry Street project at $14,436.50",
      "Continue discussions on change order two regarding liquidated damages for Haw Suns contract",
      "Process pay estimate of $535,114.22 to Haw Suns Incorporated",
      "Issue Portland cement concrete license to KSK Incorporated",
      "Bring North 8th Avenue bids to future meeting",
    ],
    civicItems: [
  ...
  },
  {
    ...
    isAgendaOnly: false,
    badge: "new",
    overview: "The Finance and Human Resources Committee held extensive discussions about public works operations, budget comparisons, and employee clothing allowances. After multiple failed votes on increasing the clothing stipend from $300 to $600 following the cancellation of a Cintas uniform contract, the committee ultimately approved a compromise of $400 for 2026 and $500 annually starting in 2027, plus a washer and dryer for staff use.",
    agenda: [
      { time:"0:00", item:"Call to order and Pledge of Allegiance" },
      ...
      { time:"4:00", item:"Acknowledge T-1 and T-2 detail reports for February" },
      { time:"4:30", item:"Acknowledge legal details for February" },
      { time:"5:00", item:"Educational presentation: Public Works operations and budget by Michael" },
      { time:"35:00", item:"Old business: Amendments to Chapter 5 clothing and equipment allowance" },
      { time:"1:05:00", item:"New business, staff remarks, and adjournment" },
    ],
    discussions: [
      { item:"Public Works Operations and Budget Presentation", body:"Public Works Director Michael delivered a comprehensive presentation on department operations, covering 119.5 centerline miles of road, 114 miles of water main, 103 miles of sanitary sewer, and 70 miles of storm sewer. He noted the 2026 budget decreased by $26,000 (1.1%) compared to 2025. Michael highlighted that Weston spends about $9,700 less per mile than the average central Wisconsin community on street maintenance. He discussed the recent major snow event where employees worked up to 17.5 hours, with estimated costs around $50,000, and noted the county is pursuing disaster relief funding from the state. Committee member Steve asked about street lighting standards and development requirements." },
      { item:"Clothing and Equipment Allowance Amendment", body:"Extended debate occurred over increasing the employee clothing stipend from $300 to $600 following cancellation of the Cintas uniform contract. Committee member Daniels argued for fiscal restraint given the upcoming fire department referendum, stating she was comfortable with $300-$400. Michael defended the increase, emphasizing employee retention, workplace culture, and that staff deal with hazardous materials. The original motion for $600 failed 2-3 (Daniels yes, Manel no, Olsson no, My no, one yes). A $400 motion failed 2-3. A $500 motion with washer\/dryer failed. Finally, a motion for $400 in 2026, $500 annually starting 2027, plus washer and dryer purchase passed with majority approval." },
      { item:"Salt Budget Discussion", body:"In response to a question about the salt budget, Michael explained they reduced it by about $50,000 this past year and may need to increase it next year. The village ordered 1,500 tons through the state cooperative purchase program, with about 1,000 tons currently on hand and storage capacity of 2,000 tons. He noted the state contract prohibits reselling salt for profit." },
    ],
    publicComment: "Lisa Beck of 1808 Cortez Lane offered public comment. She praised Public Works Director Michael for the department's work during the recent storm, stating she plans to call him out at every meeting. She also expressed concern about the proposed clothing allowance increase, suggesting the village consider a lesser amount rather than the highest proposed amount to save money, noting she doesn't know other companies offering such benefits.",
    actionItems: [
      "Minutes from February 16, 2026 approved unanimously",
      "February 2026 financial reports acknowledged unanimously",
      "T-1 and T-2 detail reports for February acknowledged unanimously",
      "Legal details for February acknowledged unanimously",
      "Clothing allowance amendment approved: $400 for remainder of 2026, $500 annually starting 2027, plus one-time purchase of washer and dryer for staff use - to be recommended to Village Board",
  ...
  },
  {
    ...
    isAgendaOnly: false,
    badge: "new",
    overview: "The Village of Weston Board of Trustees approved multiple rezoning ordinances, modified a speed limit ordinance for Weston Avenue after debate, and received updates on the April 2026 fire department referendum. A resident criticized the board's approach to fire department funding, arguing the referendum is inadequate and urging budget reprioritization.",
    agenda: [
      { time:"0:00", item:"Call to order and Pledge of Allegiance" },
      { time:"0:45", item:"Roll call" },
      ...
      { time:"22:00", item:"Consent agenda - Vouchers and appointment of agent change" },
      { time:"24:00", item:"Ordinances - Rezoning and speed limits" },
      { time:"35:00", item:"Resolutions - Final plat approval" },
      { time:"36:00", item:"Unfinished business - Referendum informational sessions update" },
      { time:"40:00", item:"New business - E-bike ordinance, parking restrictions, intersection signage, park fees, contracts" },
    ],
    discussions: [
      { item:"Public Comment - Fire Department Funding", body:"Jim Pensel of 5002 Aerrol Street spoke critically of the board's approach to funding the fire department. He praised SAFER staff but argued the referendum approach is shortsighted, noting the $600,000 levy has no sunset date and won't keep pace with rising costs. He urged the board to reprioritize spending, calling artificial turf and the aquatic center 'wants' versus fire\/EMS as 'needs.' Finance Director Jessica responded that the village cannot borrow for additional firefighters, hence the need for referendum operating revenue, and expressed frustration with criticism of staff efforts." },
      { item:"Ordinance 26-00006 - Speed Limits on Weston Avenue", body:"The board debated the proposed 35 mph speed limit on Weston Avenue from Von Kennel to Ryan Street. Trustee Maloney and Trustee Jordan objected, arguing the road design and sparse development warranted 45 mph. The original motion failed 4-3 (Maloney, Jordan, and the President voting no). A subsequent motion by Maloney to keep 45 mph from Von Kennel to Highway J while maintaining 35 mph from Von Kennel to Camp Phillips passed with only Trustee Karns voting no." },
      { item:"Rezoning Ordinances", body:"Ordinance 26-00004 (rezoning portion of 8905 Bert Street from RR5 to SFS) and Ordinance 26-00005 (rezoning portion of 7105 Christensen Avenue from SL to SFS) were both approved unanimously as recommended by the Planning Commission." },
      { item:"April 2026 Referendum Informational Sessions Update", body:"Administrator provided an update that two informational presentations have been completed with links available on the village website. Two more sessions remain: March 31st (4:30-6:00 PM) and April 2nd (12:00-1:30 PM), both formatted as open house Q&A sessions rather than presentations." },
      { item:"E-bike and E-uro Ordinance", body:"The board voted to table the proposed e-bike ordinance until the county finalizes their process. Motion to table passed unanimously." },
      { item:"Intersection Signage at Community Center Drive and Birch Street", body:"The board approved changing the stop sign to a yield sign. Trustee Hooang raised concerns about bicyclists coming off the pedestrian bridge at high speeds. A friendly amendment was added to install a stop sign for bicyclists on the path. Motion passed unanimously as amended." },
      { item:"Baseball\/Softball Field Maintenance Agreement", body:"The 10-year agreement with youth baseball and softball organizations was approved unanimously. Discussion noted the long term protects the village's investment at Kennedy Park and provides stability for the organizations." },
      ...
      { item:"Microsoft Teams for Communication", body:"The board approved using Microsoft Teams for trustee communications starting next term. A training session will be held when the new board is seated. Passed unanimously." },
    ],
    publicComment: "Jim Pensel of 5002 Aerrol Street spoke regarding fire department funding. He praised SAFER staff but criticized the board's referendum approach as shortsighted, arguing it lacks a sunset date and won't address long-term cost increases. He urged the board to reprioritize the budget, citing artificial turf and aquatic center spending as 'wants' versus public safety as 'needs.'",
    actionItems: [
      "Ordinance 26-00004 rezoning approved unanimously",
      "Ordinance 26-00005 rezoning approved unanimously",
      "Speed limit ordinance approved with amendment: Von Kennel to J remains 45 mph, Von Kennel to Camp Phillips set at 35 mph",
      ...
      "Yield sign approved for Community Center Drive at Birch Street with stop sign added for bicyclists on path",
      ...
      "Microsoft Teams adoption approved for trustee communications",
  ...
  },
  {
    ...
    isAgendaOnly: false,
    badge: "new",
    overview: "The Marathon County Board of Supervisors adopted the comprehensive plan for 2026 with multiple amendments addressing renewable energy language, AI\/automation technology, and coal\/natural gas energy, while also approving elected official salaries, authorizing phase 2 design for a new highway facility, and initiating PFAS contamination lawsuits. The board ratified an emergency declaration related to a recent blizzard and recognized seven departing supervisors at their final meeting.",
    agenda: [
      { time:"0:00", item:"Call to order, pledge of allegiance, and silent reflection" },
      { time:"1:30", item:"Roll call and welcome to visitors" },
      { time:"2:45", item:"Consent agenda items C8 through C13 B2" },
      { time:"3:30", item:"D14 - Adopting Marathon County Comprehensive Plan 2026 (Ordinance O-13-26)" },
      { time:"37:00", item:"E15 - Establishing salaries for elected officials (Resolution 12-26)" },
      { time:"37:45", item:"E16 - Highway facility phase 2 design services (Resolution 13-26)" },
      { time:"39:30", item:"E17 - Authorizing PFAS litigation (Resolution 14-26)" },
      { time:"43:00", item:"E18 - Approving carry forwards and budget amendments (Resolution R-20-26)" },
      { time:"44:00", item:"E19 - Capital asset threshold approval (Resolution 21-26)" },
      { time:"45:00", item:"F20 - Law enforcement drug trafficking grant (Resolution R-17-26)" },
      { time:"46:00", item:"G21 - Ratification of local emergency declaration (Resolution 22-26)" },
      { time:"49:00", item:"H22 - Administrator performance evaluation" },
      { time:"52:00", item:"Announcements and adjournment" },
    ],
    discussions: [
      { item:"Comprehensive Plan 2026 (Ordinance O-13-26)", body:"The board considered 10 proposed amendments compiled by staff based on supervisor feedback. Amendment 1 (livability standards) passed unanimously. Amendments 2, 3, and 4 (alternative energy language changes proposed by Vice Chair Dickinson) were separated at Supervisor Crawl's request and each passed but not unanimously, with Supervisor Crawl voting no. Amendment 5 (data centers and battery storage background) passed but not unanimously, with Supervisor Leur voting no citing ideological concerns. Amendment 6 (radon and lead remediation) passed unanimously. Amendment 7 (regulate energy projects when allowed by law) passed but not unanimously. Amendment 8 (AI, automation, and data analytics language proposed by Supervisor Leur) passed unanimously after she explained the goal was transparency and ethical use of AI in government operations. Amendment 9 (promoting coal, natural gas, and nuclear) was amended by Supervisor Boots to read 'promote coal and natural gas until a long-term sustainable and reliable energy source can be found that does not adversely affect agricultural land' - this amended version passed but not unanimously after debate where Supervisor Rosenberg argued there's no such thing as clean coal and Supervisor Robinson opposed nuclear due to water concerns. A late amendment by Supervisor Sundulski regarding utility-scale wind\/solar as industrial uses was debated; a motion to refer it to committee failed and the amendment itself was defeated. The comprehensive plan as amended was adopted but not unanimously." },
      { item:"Establishing salaries for elected officials (Resolution 12-26)", body:"Resolution establishing salaries for clerk of courts, sheriff, and elected department heads for the upcoming term of office was approved. Motion by Supervisor Conway, second by Supervisor Rosenberg. Passed with no discussion." },
      { item:"Highway facility phase 2 design services (Resolution 13-26)", body:"Authorization for phase 2 design services for new highway facility was approved unanimously. Supervisor Soyber requested future information about plans for the old facility. Supervisor Sundulski asked about the $53 million cost figure but Chair Gibbs clarified that cost approval was not part of this resolution. Motion by Supervisor Robinson, second by Supervisor V." },
      { item:"PFAS litigation authorization (Resolution 14-26)", body:"The board authorized engaging outside counsel on contingency basis to initiate PFAS contamination lawsuits. Two amendments were adopted unanimously: Supervisor Robinson's amendment directing the county administrator to evaluate past and present practices that may have resulted in PFAS release or exposure to determine county risk, and Vice Chair Dickinson's amendment modifying airport-related language to reference county property generally. The resolution as amended passed unanimously." },
      { item:"Ratification of emergency declaration (Resolution 22-26)", body:"The board unanimously ratified the local state of emergency declaration related to the recent blizzard. Administrator Leonard explained the declaration preserves the county's opportunity for reimbursement and praised staff extensively, noting facilities and parks had over 600 hours of call-in time in 24 hours, highway workers worked 12-16 hour shifts sleeping on cots, and staff from multiple departments kept critical operations running. Supervisor Fifer echoed thanks as infrastructure committee chair." },
      { item:"Administrator performance evaluation", body:"The board accepted the executive committee's recommendation for the administrator's performance evaluation and salary placement under the new pay structure. Chair Gibbs noted the executive committee had finalized the evaluation using board input with no wording changes from the summary presented the previous Thursday. Motion by Supervisor Robinson, second by Supervisor Cavalli. Passed unanimously without going into closed session." },
    ],
    publicComment: "No public comment was offered.",
    actionItems: [
      "Comprehensive Plan 2026 adopted with amendments addressing energy language, AI\/automation, and coal\/natural gas promotion",
      ...
      "Outside counsel authorized for PFAS contamination lawsuits; administrator directed to evaluate county PFAS exposure risks",
      ...
      "Local emergency declaration ratified for blizzard response",
      "Administrator performance evaluation and salary placement approved",
  ...
  },
  {
    ...
    isAgendaOnly: false,
    badge: "new",
    overview: "The Parks Committee discussed increasing park impact fees to align with neighboring communities, selected Rettler Corporation for the Muehlfeld Park master plan, and reviewed the Yellow Banks kayak launch project which came in significantly under budget due to grant funding. The committee also discussed ice rink operations at Kennedy Park and potential future hockey facility improvements.",
    agenda: [
      { time:"0:00", item:"Call to order and Pledge of Allegiance" },
      { time:"0:30", item:"Roll call" },
      ...
      { time:"21:45", item:"Requests for proposals for Muehlfeld Park master plan" },
      { time:"27:30", item:"Review of Yellow Banks kayak launch expenses" },
      { time:"33:00", item:"Components of operations for ice rink at Kennedy Park" },
      { time:"45:30", item:"Future items and next meeting date" },
      { time:"48:00", item:"Remarks from staff and committee members" },
    ],
    discussions: [
      { item:"Approval of minutes", body:"Minutes from February 23rd, 2026 meeting were approved. A motion to accept was made and seconded, passing unanimously with all present voting in favor." },
      { item:"Public comments", body:"Jim Pinsel expressed frustration about receiving no response to questions submitted at the previous meeting regarding playground equipment installation, Kennedy Park fundraising updates, and ice rink costs. He criticized the staff report for not translating man-hours into dollar costs, estimating true ice rink costs at $20,000-$30,000 versus the stated $1,320.98. Lisa Beck thanked Michael for handling the recent blizzard and praised Sean and Jessica for the well-written Yellow Banks RFC detailing expenses and grant funding." },
      { item:"Parks and recreation impact fee discussion", body:"Jennifer presented information on park impact fees, noting current fees of $300 for single family units are significantly below the $761 recommended in the 2020 study and below neighboring communities (Kronenwetter at $603, Rib Mountain at $650). The plan commission requested committee input before deciding. Committee members supported a moderate increase to align with neighboring communities. Katrina stated she'd be 'more in the moderate increase bracket instead of the maximum.' The committee consensus was to keep fees consistent with neighbors while remaining competitive. No formal vote was taken; feedback will be provided to plan commission." },
      { item:"Muehlfeld Park master plan RFP selection", body:"Seven proposals were received for the park master plan, reviewed by four staff members. JSD and Rettler Corporation were the two lowest bids and most qualified based on experience. Roger moved to select Rettler Corporation, Katrina seconded. Motion passed unanimously." },
      { item:"Yellow Banks kayak launch expenses review", body:"Jessica presented a detailed breakdown of expenses and grant funding for the completed kayak launch. Grants from DNR, Marathon County Transportation Coordinating Committee, and others significantly reduced village costs. Additional unforeseen expenses included subgrade issues and an abandoned well casing discovery. PGA Construction, Dan Higginbotham, and MTS donated time and services. Katrina praised the staff work on grant applications and suggested formal recognition for Dan Higginbotham. The project was highlighted as a success with significant cost savings through grants." },
      { item:"Ice rink operations at Kennedy Park", body:"Staff presented information requested by Katrina on ice rink operations. The rink has been unattended since 2020 due to COVID and subsequent staffing shortages, though it remains well-used. Everest Youth Hockey has expressed interest in improvements including a covered structure and potentially more than just an outdoor rink. Sean noted that formal hockey organizations don't have scheduled use but frequently asked about rink availability this winter. Katrina emphasized not wanting hockey to be forgotten amid baseball-focused Kennedy Park discussions. Committee requested additional historical attendance data and user feedback for future discussion." },
    ],
    publicComment: "Two speakers offered public comment. Jim Pinsel (3 pages submitted at prior meeting) criticized lack of response to his previous questions about playground equipment costs, Kennedy Park updates, and ice rink true costs which he estimated at $20,000-$30,000 annually including labor. Lisa Beck (1808 Cortez Lane) praised Michael for handling the recent blizzard and commended Sean and Jessica for the well-written Yellow Banks RFC. A written response to Jim Benson regarding an email from last month was also submitted and will be included in minutes.",
    actionItems: [
      "Rettler Corporation selected for Muehlfeld Park master plan - motion passed unanimously",
  ...
  },
  {
    ...
    isAgendaOnly: false,
    badge: "new",
    overview: "The Marathon County HR, Finance, and Property Committee approved several key items including a claim disallowance related to a child's death, revised property values for public auction, carry forward funds resolution, and a capital assets threshold policy change. The committee also received introductions from new healthcare consultants and detailed financial updates on 2025 year-end and 2026 budgets.",
    agenda: [
      { time:"0:00", item:"Claim disallowance - Mercedes Holmes" },
      { time:"2:15", item:"Revised property values for parcels for public auction" },
      { time:"4:30", item:"Resolution to approve carry forward funds (R20-2026)" },
      { time:"10:45", item:"Resolution to amend capital assets threshold policy" },
      { time:"12:00", item:"Introduction of healthcare consultants - National Insurance Services" },
      { time:"28:30", item:"Audited 2025 year-end fiscal update" },
      { time:"50:00", item:"2026 year-to-date budget update" },
    ...
    discussions: [
      { item:"Claim disallowance - Mercedes Holmes", body:"Corporation Counsel explained that Mercedes Holmes filed a claim on December 5th related to the death of her 3-year-old child Zalen Bernett, who was placed in a treatment foster care home licensed through another agency in Dunn County. The death was determined to be from natural causes with no wrongdoing found through law enforcement and social services investigations. Outside counsel and insurance carrier recommended disallowance. Chair Gibbs moved to disallow the claim, seconded by Supervisor Lur. Motion carried unanimously." },
      { item:"Revised property values for public auction", body:"Staff explained two parcels on Mullen Street and South Third Avenue failed to sell twice on Wisconsin Surplus because bids didn't reach appraised values. One bidder was marked as non-pay and banned from future auctions. Chair Gibbs moved to set revised minimum sale prices of $9,000 for 529 Mullen Street and $7,500 for 738 South Third Avenue. Seconded by Supervisor Lur. Motion carried unanimously." },
      { item:"Resolution to approve carry forward funds", body:"Sam presented R20-2026 for program revenues and multi-year projects needing carryover. Notable items included replenishing veterans relief funds using 2025 budget excess (providing approximately 3 years of funding), and $142,731 for administration special projects including $75,000 for homelessness contract. Vice Chair Marshall asked about the redacted records fund for Register of Deeds; staff agreed to provide more information at a future meeting. Chair Gibbs moved approval, seconded by Supervisor Hart. Motion carried unanimously." },
      { item:"Capital assets threshold policy amendment", body:"Sam explained the policy would increase the capitalization threshold from $5,000 to $10,000, following GFOA guidance from 2006. This was previously considered in 2022 but not completed. Supervisor Hart moved to approve and forward to county board, seconded by Chair Gibbs. Motion carried unanimously." },
      { item:"Introduction of healthcare consultants - National Insurance Services", body:"NIS representatives introduced themselves following their selection through RFP process. The team of five includes consultants with extensive public sector experience. They outlined plans to evaluate the near-site ATA clinic's return on investment, assess funding models (fully insured vs. self-insured vs. level funded), and provide regular reporting to the committee. Vice Chair Marshall asked about comparable employer costs and strategies to reduce emergency room use for non-emergent care. Chair Gibbs inquired about evaluation processes for insurance funding models and risk tolerance considerations." },
      { item:"2025 year-end fiscal update", body:"Finance Director Sam provided detailed department-by-department review of unaudited year-end figures. Notable items included: $257,238 TID closure check from City of Wausau, $222,752 in unclaimed property from the state, sales tax of approximately $2 million, opioid fund balance of $2.2 million with $3.49 million in future settlements expected, and parks fund ice revenue up $70,000. Various transfers and reconciliations are still in process. When asked about projected fund balance surplus, Sam indicated she would provide numbers at the next meeting after capital assets reconciliation." },
      { item:"Finance Department quarterly update", body:"Sam reported the department is fully staffed since mid-December with a new financial analyst for payroll. The team has been working on quarterly closeouts, countywide training on uniform practices, W-2 processing including the 'big beautiful bill' no tax on overtime calculations, 1099s, random cash audits (all successful), and balance sheet reconciliations. First quarter will close May 31st with monthly closeouts thereafter. Administrator Lance praised Sam and her team for handling W-2 challenges and recommended increasing the social services reserve account above $400,000 due to rising correctional care placement costs." },
      { item:"County Treasurer update", body:"Treasurer Connie reported on tax collections, delinquent parcel monitoring, year-end procedures, and processing of 1,582 delinquent tax notices (down from 1,786 last year). She discussed ongoing challenges with municipal treasurer errors in receiving payments and lottery credits. The office no longer offers payment agreements due to past defaults. Supervisor Lur asked about poverty trends; Connie explained they work with residents individually and refer veterans to veterans services. Administrator Lance clarified the county's eviction process relates to tax delinquent parcels under ordinance 3.20 and emphasized the accelerated process protects homeowner equity." },
    ],
    publicComment: "No public comment was offered.",
    actionItems: [
      "Claim of Mercedes Holmes disallowed",
      "Revised minimum sale prices set for 529 Mullen Street ($9,000) and 738 South Third Avenue ($7,500)",
      "Resolution R20-2026 approved for carry forward funds to 2026",
      "Capital assets threshold policy amendment approved and forwarded to county board",
      "Register of Deeds to provide information on redacted records fund at future meeting",
      "Finance to provide fund balance surplus projection at next meeting",
      "Consider increasing social services reserve account above $400,000",
  ...
  },
  {
    ...
    isAgendaOnly: false,
    badge: "new",
    overview: "The Marathon County Executive Committee approved moving County Administrator Lance Leonhard to year six of the administrator pay scale retroactive to January, following a performance evaluation conducted in closed session. The committee also ratified the declaration of a local state of emergency related to a recent snow emergency to preserve eligibility for state reimbursement funds.",
    agenda: [
      { time:"0:00", item:"Call to order and Pledge of Allegiance" },
      { time:"0:25", item:"Performance review of the administrator (3A1)" },
      { time:"1:45", item:"Closed session for administrator evaluation" },
      { time:"2:30", item:"Return to open session - administrator pay scale motion" },
      ...
      { time:"7:45", item:"Adjournment" },
    ],
    discussions: [
      { item:"Performance review of the administrator", body:"The committee voted unanimously to go into closed session to discuss the administrator's performance evaluation. Corporation counsel provided a summary of the appraisal using a 0-5 scale based on three criteria: needs improvement, successful, and exceptional. Roll call vote to enter closed session: Gibbs, Dickinson, Arstead, Boots, Drebeck, Fifick, Mask, Ritter, Morash, and Robinson all voted aye." },
      { item:"Administrator pay scale approval", body:"Upon returning to open session, Supervisor Mask made a motion to approve the pay scale for six years of service for the administrator and approve the evaluation. Supervisor Arstead seconded. The chair clarified the motion would make the pay adjustment retroactive to January, consistent with county implementation practices. Motion carried by voice vote with no opposition." },
      { item:"Ratification of declaration of state and local emergency", body:"County Administrator Lance Leonhard presented information about the recent snow emergency, noting the governor declared an emergency and the county followed with a local declaration. He highlighted staff efforts, stating parks, recreation, forestry, and capital management staff worked hundreds of extra hours over approximately 24 hours, with highway department employees sleeping on cots and working 12-16 hour shifts. The declaration enables requests for state reimbursement under Chapter 323 of state statutes. Supervisor Robinson moved to ratify, Supervisor Fifick seconded. Motion carried unanimously by voice vote." },
      { item:"Rules review recommendations", body:"The vice chair provided an overview of the rules review committee's work, noting 68 items were submitted with 31 approvals, 31 rejections, and 3 parking lot items. Key proposed changes include: clarifications of existing practices, changes to chair and vice chair appointment processes, expense reimbursement approval changes allowing more flexibility for WCA professional development, restructuring of the Forestry Recreation Committee, and sunsetting of the TIF and broadband task forces. The committee decided to retain two meetings rather than consolidating to one. No action was taken; further discussion scheduled for April 9, 2026." },
    ],
    publicComment: "No public comment was offered.",
    actionItems: [
      ...
      "County to compile information for potential emergency reimbursement requests to the state",
  ...
  },
  {
    ...
    isAgendaOnly: false,
    badge: "new",
    overview: "This Marathon County Board educational meeting focused on two major presentations: PFAS contamination litigation opportunities and renewable energy regulation authority. Attorney Carrie McDougall explained how the county could join multi-district litigation against chemical manufacturers to recover costs for PFAS contamination at county facilities, while Rebecca Roker from Atollis Law outlined options for protecting county interests in large-scale wind and solar energy projects, emphasizing that joint development agreements may be the most effective tool given state preemption of local authority.",
    agenda: [
      { time:"0:00", item:"Call to order and Pledge of Allegiance" },
      { time:"0:45", item:"Reading of the notice" },
      { time:"1:30", item:"Roll call and sign-in" },
      { time:"2:15", item:"Public comment period" },
      { time:"12:30", item:"PFAS multi-district litigation presentation by Baron and Budd Law Firm" },
      { time:"37:00", item:"Questions from board members on PFAS litigation" },
      { time:"55:00", item:"Renewable energy regulation presentation by Atollis Law" },
      { time:"1:05:00", item:"PSC process and county authority overview" },
      { time:"1:20:00", item:"Joint development agreement options discussion" },
    ],
    discussions: [
      { item:"Public Comment", body:"Five residents spoke during public comment. Cindy Nelson from Stratford reported speaking to 200 households about wind turbine projects, stating none supported the projects and residents don't want the county board making decisions for them. Wendy Rowski from Green Valley urged the board to vote no on the comprehensive plan next week, objecting to the term 'wind farm' as misleading for industrial energy facilities. Barb Newton from Rib Mountain reiterated support for speed limit reduction on Double N with 75 petition signatures. Heidi Pesky from Town of McMillan argued joint development agreements are not required for counties to regulate wind projects and outlined numerous concerns about JDAs locking counties into unfavorable terms. Cindy Hogan supported the Double N speed reduction." },
      { item:"PFAS Multi-District Litigation Presentation", body:"Attorney Carrie McDougall from Baron and Budd explained the history of PFAS litigation, noting the firm filed the first case six years ago and now serves as co-lead counsel in the multi-district litigation before Judge Richard Gergel in Charleston, South Carolina. He reported that water provider settlements totaling approximately $12-13 billion from 3M and $3-5 billion from DuPont have been approved. McDougall explained that airport and soil-based claims were specifically excluded from the water settlement, meaning Marathon County could pursue claims for contamination at its airport, landfill, and wastewater facilities. The legal services would be on a 25% contingency fee basis with no upfront costs to the county." },
      { item:"Board Questions on PFAS Litigation", body:"Supervisor Robinson asked multiple questions about claim scope, including whether settlements would restrict future claims and whether the county could include land spreading impacts. Attorney Andy Phillips clarified that claims are against original chemical manufacturers only, not spreaders, and any settlement proceeds would have no restrictions on use unlike opioid litigation. Vice Chair Dickinson clarified that the airport has no known PFAS contamination currently and has transitioned to F3 foam. Supervisor Mash asked about costs, and McDougall confirmed the 25% contingency fee plus expense reimbursement only if there is a recovery." },
      { item:"Renewable Energy Regulation Presentation", body:"Attorney Rebecca Roker from Atollis Law, representing Wisconsin Counties Association, explained that projects over 100 megawatts fall under PSC jurisdiction, significantly limiting county regulatory authority. She noted the Hub City Wind project from Alliant Energy has no PSC filing yet, and the Marathon Wind LLC project (Town of Brighton case) has been purchased as part of Hub City. Roker emphasized that PSC has approved all 33 solar projects submitted with none denied, and she is unaware of any denied wind projects. She outlined four options for the county: do nothing, negotiate a joint development agreement, intervene in PSC proceedings, or litigate, recommending JDAs as the most effective tool to protect county interests in areas like road damage, decommissioning, emergency response training, and liability." },
    ],
    publicComment: "Five residents offered public comment. Cindy Nelson (Stratford\/Oplane Township) spoke against wind turbine projects, claiming none of the 200 residents she contacted support them. Wendy Rowski (Green Valley) urged the board to vote no on the comprehensive plan, objecting to 'farm' terminology for industrial energy facilities. Barb Newton (Rib Mountain) supported speed limit reduction on Double N road with 75 petition signatures, citing near head-on collisions. Heidi Pesky (Town of McMillan) argued against joint development agreements for wind projects, citing numerous risks including liability, decommissioning costs, and loss of county flexibility. Cindy Hogan (Rib Mountain) briefly supported the Double N speed reduction.",
    actionItems: [
      ...
      "County to consider testing for PFAS contamination at airport, landfill, and wastewater facilities if pursuing litigation",
      "Closed session scheduled regarding county administrator",
    ],
  },
  {
    ...
    isAgendaOnly: false,
    badge: "new",
    overview: "The Wausau Plan Commission approved a Conditional Use Permit for a 70-unit, 7-story apartment building at 731 N 1st Street and a Transportation Project Plat for Grand Avenue signal replacements. A public hearing was held on a Conditional Use Permit for a personal storage facility at 218 South 4th Street, though no final action vote was recorded for that item.",
    agenda: [
    ...
    discussions: [
      { item:"Election of a Vice Chair", body:"Election of a Vice Chair was on the agenda. No vote record was provided indicating the outcome or who was elected." },
      { item:"Consideration of the minutes of the February 18, 2026 Regular Plan Commission Meeting", body:"The minutes from the February 18, 2026 Regular Plan Commission meeting were approved. The motion passed." },
      { item:"Public Hearing: Conditional Use Permit for 218 South 4th Street (Dunwoody Storage)", body:"A public hearing was held on a Conditional Use Permit for 218 South 4th Street to authorize construction of a Personal Storage Facility in the Light Industrial Zoning District. No final action vote was recorded for this item, as it appears to have been a hearing only." },
      { item:"Conditional Use Permit for 731 N 1st Street (Beacon Resources, LLC)", body:"The Plan Commission approved a Conditional Use Permit for 731 N 1st Street to allow for a 70-unit, 7-story apartment building. The motion passed." },
      { item:"Transportation Project Plat for Grand Avenue Signal Replacements", body:"The Plan Commission approved the Transportation Project Plat for Project 370-40-40, covering Grand Avenue signal replacements at Sturgeon Eddy Road and Townline Road. The motion passed." },
    ],
    ...
    actionItems: [
      "Conditional Use Permit approved for 70-unit, 7-story apartment building at 731 N 1st Street by Beacon Resources, LLC",
      ...
      "Public hearing held on Conditional Use Permit for Dunwoody Storage at 218 South 4th Street; final action may be pending",
    ],
    civicItems: [
  ...
  },
  {
    ...
    isAgendaOnly: false,
    badge: "new",
    overview: "The Wausau Board of Public Works awarded the 2026 Asphalt Paving Project 'A' contract to RC Pavers, LLC for $824,146.34. The board concluded its brief meeting with a 2-0 vote to adjourn.",
    agenda: [
  ...
  },
  {
    ...
    isAgendaOnly: false,
    badge: "new",
    overview: "The Public Health and Safety Committee approved all action items on the agenda, including various license applications, a recreated solid waste disposal ordinance, repeal of a mobile phone driving ordinance, and a solar energy partnership with MREA. The committee also received reports from the Fire Department and on tavern activities.",
    agenda: [
    ...
    discussions: [
      ...
      { item:"Approval or denial of various license applications", body:"The committee passed two motions: one approving a parklet permit and another approving licenses as indicated by staff with the exception of Theodore Davis. Both motions passed." },
      { item:"Repealing and recreating Wausau Municipal Code Chapter 6.44 Solid Waste Disposal", body:"The committee approved the new solid waste disposal provision, recreating Chapter 6.44 of the Municipal Code. The motion passed." },
      { item:"Repealing Wausau Municipal Code Section 10.01.012 Use of Hand-Held Mobile Telephones and Mobile Electronic Devices While Driving Prohibited", body:"The committee voted to repeal this code section prohibiting hand-held mobile phone use while driving. The motion passed." },
      ...
      { item:"Wausau Fire Department 2025 Annual Report", body:"The Fire Department presented its 2025 Annual Report to the committee. This was a discussion item with no action taken." },
      { item:"Tavern Activities Report from February 2026", body:"The committee received the February 2026 Tavern Activities Report. This was a discussion item with no action taken." },
      { item:"Community Outreach Update", body:"The committee received a community outreach update. This was a discussion item with no action taken." },
    ],
    ...
    actionItems: [
      ...
      "Chapter 6.44 Solid Waste Disposal ordinance recreated with new provisions",
      "Municipal Code Section 10.01.012 on mobile phone use while driving repealed",
  ...
  },
  {
    ...
    isAgendaOnly: false,
    badge: "new",
    overview: "The Wausau Finance Committee denied a tax recovery claim for Green Acres at Greenwood Hills LLC and postponed three items including the National Opioid Settlement Agreement and a lead service line budget amendment. The committee approved multiple airport ground lease transfers and a 2026 General Obligation Promissory Note for capital improvements.",
    agenda: [
      { time:"N\/A", item:"Public comment on agenda items and reading of the City of Wausau Public Comment Statement" },
      ...
      { time:"N\/A", item:"Closed Session pursuant to Wisconsin State Statute § 19.85(1)(e) for deliberating or negotiating property purchases" },
    ],
    discussions: [
      { item:"March 10, 2026 Regular Finance Committee Minutes", body:"The minutes from the March 10, 2026 meeting were approved 4-0. Sarah Watson moved approval with Aaron Griner seconding the motion." },
      { item:"Alleged Claim for Recovery of Unlawful Tax for Green Acres at Greenwood Hills, LLC - Outlot 1", body:"The committee denied the alleged claim for recovery of unlawful tax. The motion to approve the claim failed." },
      { item:"Consent to transfer title to buildings at 939 Woods Place", body:"The committee approved the consent to transfer title to buildings and improvements and waiver of first right of refusal for the property at 939 Woods Place." },
      ...
      { item:"Airport Ground Lease with Owen Jones at 939 Woods Place", body:"The committee approved a new airport ground lease with Owen Jones for the property at 939 Woods Place." },
      { item:"Airport Ground Lease with Cole Lundberg", body:"The committee approved an airport ground lease with Cole Lundberg." },
      { item:"Six Remnant Defendants National Opioid Settlement Agreement", body:"The committee voted to postpone consideration of the opioid settlement agreement to the next scheduled meeting." },
      { item:"Budget amendment for Wausau Water Works Lead Service Line Replacement", body:"The committee voted to postpone consideration of this budget amendment for the 2025 Lead Service Line Replacement project to the next meeting." },
      { item:"Budget amendment for carryover of funds from 2025 to 2026", body:"The committee approved the budget amendment for carryover of funds from 2025 to 2026." },
      { item:"Review of 2025 Motor Pool Fund financial results", body:"This item was on the agenda for review. No vote was recorded for this item." },
      { item:"2026 General Obligation Promissory Note for Capital Improvements", body:"The committee approved the 2026 General Obligation Promissory Note for Capital Improvements to the calendar." },
      { item:"Review of 2025 General Fund Financial Results", body:"The committee reviewed the 2025 General Fund Financial Results and approved the transfer of funds." },
      { item:"Purchase of properties on Adolph Street and Myron Street", body:"The committee voted to postpone consideration of purchasing properties at 108 Adolph Street, 112 Adolph Street, 112-1\/2 Adolph Street and 233 Myron Street until the next meeting." },
    ],
    ...
    actionItems: [
      ...
      "Six Remnant Defendants National Opioid Settlement Agreement postponed to next meeting",
      ...
      "Airport ground leases with Owen Jones and Cole Lundberg approved",
      "Transfer of title for 939 Woods Place approved",
    ],
    civicItems: [
      { number:"1", name:"Public comment on agenda items and reading of the City of Wausau Public Comment Statement.", votes:[], docs:[], children:[] },
  ...
  },
  {
    ...
    isAgendaOnly: true,
    badge: "new",
    overview: "The Wausau School District Board of Education Committee of the Whole meeting covered a comprehensive NEOLA policy update affecting over 60 district policies, a referendum budget update, new facility fees for artificial fields, and renewal of the school nutrition purchasing cooperative membership. The meeting included recognition of Stettin Elementary through the Excellence in Action segment.",
    agenda: [
      { time:"0:00", item:"Call to Order" },
    ...
    discussions: [
      { item:"Wisconsin School Nutrition Purchasing Cooperative Agreement (WiSNP)", body:"The Wausau School District Nutrition Service Department is seeking board approval for continued membership in the Wisconsin School Nutrition Purchasing Cooperative for the 2026-2027 school year. The WiSNP Co-op is requesting all member districts to present the cooperative's resolution to their respective boards for approval." },
      { item:"Facility Fees", body:"Ryan Urmanski, Director of Buildings and Grounds, presented information to amend the current Wausau School District Facility Use Fee Schedule to add costs for use of artificial fields and field lighting for requested events. The board is being asked to approve the fee schedule for immediate implementation." },
      { item:"Referendum Budget Update", body:"Elizabeth Channel, Interim Assistant Superintendent of Operations, provided an update on the status of the Referendum Budget. A memo summarizing the referendum budget status was included in the meeting materials." },
      { item:"NEOLA UPDATE", body:"The committee reviewed proposed changes to numerous district policies ranging from technical corrections to substantive updates. Policies addressed include board member conduct, district administrator relationships, reading instruction, cell phones, student fees, academic honesty, artificial intelligence, school support organizations, and Act 57 related policies on child abuse and neglect and student supervision." },
    ],
    publicComment: "No public comment period was included on this agenda.",
    actionItems: [
      "Approve continued membership in the Wisconsin School Nutrition Purchasing Cooperative (WiSNP) for 2026-2027 school year",
      "Approve amended Facility Use Fee Schedule for artificial fields and field lighting",
      "Approve NEOLA policy updates including definitions, board member policies, administrative guidelines, reading instruction, Title I engagement, athletics, advanced learning, job expenses, academic honesty, homeless students, entrance age, cell phones, third grade promotion, student parking, intoxicants policy, student employment, electronic fund transfers, debt management, returned checks, fee waivers, fund balance, purchasing, accounting systems, property disposition, digital accessibility, and artificial intelligence",
      "Approve school support organization related policies including fund-raising, crowdfunding, accountability oversight, gifts and grants, and advertising",
