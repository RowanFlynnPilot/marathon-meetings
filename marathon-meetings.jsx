...
const MEETINGS = [
  {
    ...
    isAgendaOnly: false,
    badge: "new",
    overview: "The Wausau Common Council met on March 24, 2026, passing several resolutions including a contentious 6-3 approval of a development agreement for 11 Scott Street to convert a vacant office building into 52 mid-priced apartments. The council also honored city workers for their response to a record 30.9-inch snowfall and recognized Kolbe & Kolbe Millwork with a sustainability award.",
    agenda: [
      ...
      { time:"12:00", item:"Sustainability Award presentation to Kolbe & Kolbe Millwork" },
    ...
    discussions: [
      { item:"Development Agreement for 11 Scott Street\/Waterside Place", body:"The council debated a joint resolution approving a development agreement and amended parking agreement with 11 Scott Street LLC for converting a vacant 100,000 sq ft office building into 52 mid-priced residential units. Alder Rasmusson strongly supported the project, noting it would return parking spaces for public use and address the 'missing middle' housing need. Alder Neil outlined benefits including $55,000 annual parking revenue and helping close TID 8. Alder Larson dissented, arguing the city shouldn't discount its parking assets. Alder Tyranny questioned how the city could provide alternative parking within 300 yards if the ramp closed. Economic Development Director Randy Feifer explained the agreement reduces parking obligation from 480 to 150 spaces. The motion passed 6-3." },
      { item:"Mayoral Citation for DPW Snow Response", body:"Mayor Denny presented citations recognizing city employees who responded to the record 30.9-inch snowfall from March 14-16, 2026. Street Supervisor Kevin Kester spoke emotionally, praising the plow crews and mechanics, saying 'you kicked its ass' and noting mechanics maintained 12-hour shifts providing 24-hour breakdown support. Four fleet technicians will have worked 12 straight days by Friday. The citation specifically honored DPW plow crews, municipal fleet staff, and support teams." },
      { item:"Sustainability Award to Kolbe & Kolbe Millwork", body:"Sustainability Committee member Christine Daniels presented the 2026 City of Wausau Sustainability Award to Kolbe & Kolbe Millwork. Representatives Mike Thompson and Keith Kaning accepted, describing their solar panel installation of over 2,000 panels that became operational in July 2025, generating enough power for about 120 homes. They also highlighted LED lighting upgrades, high-efficiency air compressors, and recycling initiatives for wood, aluminum, glass, vinyl, cardboard, and other materials." },
      { item:"Solid Waste and Recycling Agreement", body:"Resolution approving a 7-year residential solid waste and recycling service agreement with Harter's Fox Valley Disposal was corrected from an earlier version that incorrectly stated 10 years. Passed unanimously 9-0." },
      { item:"Police Department Thompson Submachine Gun Proceeds", body:"Resolution approved using proceeds from the sale of a Thompson submachine gun to purchase Red Dot Optics for the Wausau Police Department. The mayor noted the money had been 'sitting in the safe a long time.' Passed unanimously 9-0." },
      { item:"Settlement Resolution - David Holes vs. City of Wausau", body:"Assistant City Attorney Vincent Bonito explained a 2022 bus accident where Transit Mutual paid the claim, then the individual who hit the bus filed a personal injury claim. The city's counter claim and third-party complaint against the driver's insurer resulted in a settlement where the insurer pays bus damages. Alder Neil clarified this doesn't affect the separate ongoing injury claim. Passed 8-1 without need for closed session." },
    ],
    publicComment: "Two speakers addressed the council. Raleigh Lray spoke in support of the 11 Scott Street project, describing it as a green sustainable project repurposing a vacant building and adding mid-priced apartments downtown. Mark Craig (3246 North 8th Street) joined to advocate for the project, noting it's over $10 million with $8.3 million for the residential component alone, stating 'Without your help, it won't happen.'",
    actionItems: [
      "Development agreement and parking agreement for 11 Scott Street approved 6-3",
      "March 31st proclaimed as Sarah Rafi Day in Wausau",
      "Seven-year solid waste agreement with Harter's Fox Valley Disposal approved",
      "Mayoral appointments to Plan Commission, Affordable Housing Task Force, and Business Improvement District Board confirmed",
      "Airspace obstruction removal agreements approved for Scofield properties",
      ...
      "Community outreach shelter operations duty premium differential approved",
      "Settlement of counter claim in David Holes vs. City of Wausau approved 8-1",
      "Solid waste disposal code chapter 6.44 repealed and recreated to align with state code",
    ],
  },
  {
    ...
    agenda: [
      ...
      { time:"1:00", item:"Public hearing on conditional use permit for 218 South Fourth Street (Done Storage personal storage facility)" },
    ...
    discussions: [
      ...
      { item:"Public hearing on conditional use permit for 218 South Fourth Street (Done Storage)", body:"Jason Dunwy and Melinda Don Woody spoke in support of the proposed personal storage facility in the light industrial district. They noted that downtown Wausau has approved over 400 new apartment units recently, including the 153-unit Foundry on Third and 102-unit Evergreen Landing projects, creating demand for storage options that currently don't exist downtown. No action was taken at this meeting; it was a public hearing only." },
      { item:"Conditional use permit for 731 North First Street (Beacon Resources 70-unit apartment building)", body:"Motion to approve made by Bornman, seconded by Bugamin. No discussion or questions were raised by commissioners. The motion passed unanimously by voice vote, authorizing the 70-unit, 7-story apartment building." },
      ...
      { item:"Next meeting date", body:"Staff indicated the next regular meeting would be April 21st (third Tuesday), but noted it may need to be moved due to the election and council meeting. The commission will be notified if the date changes." },
    ],
    publicComment: "One written comment was submitted by Linda Lawrence on March 12th supporting the Beacon Resources apartment proposal, stating housing of this capacity will be good for downtown small businesses and expressing confidence in the developer's track record. Jason Dunwy and Melinda Don Woody spoke during the public hearing on the storage facility item, advocating for the project.",
    actionItems: [
      "Conditional use permit approved for 731 North First Street 70-unit, 7-story apartment building (Beacon Resources LLC)",
      ...
      "Staff to confirm April 21st meeting date or notify of changes due to election\/council meeting",
    ],
  },
  {
    ...
    isAgendaOnly: false,
    badge: "new",
    overview: "The Marathon County Board of Supervisors held an educational meeting focused on two major presentations: potential litigation against PFAS chemical manufacturers and county regulatory authority over renewable energy projects. No votes were taken as this was an educational session, but the board received detailed information about joining multi-district PFAS litigation and options for responding to proposed wind energy projects in the county.",
    agenda: [
      ...
      { time:"50:02", item:"Questions from supervisors on PFAS litigation" },
      ...
      { time:"1:30:01", item:"Options for county response to renewable energy projects" },
    ],
    discussions: [
      { item:"PFAS Multi-District Litigation Presentation", body:"Attorney Carrie McDougall from Baron and Budd Law Firm presented via WebEx on the opportunity for Marathon County to join national litigation against PFAS chemical manufacturers. McDougall explained the litigation history, noting a $12-13 billion settlement with 3M and $3-5 billion from DuPont for water provider claims. He emphasized this is a contingency fee arrangement (25%) where the county pays nothing unless there is recovery. The presentation covered potential claims related to the county airport, landfill, and wastewater systems." },
      { item:"PFAS Litigation Questions from Supervisors", body:"Supervisor Robinson asked multiple questions about the scope of potential claims, including whether settlements would restrict future litigation for landfill contamination and land spreading impacts. Vice Chair Dickinson clarified that the airport has no known PFAS contamination currently and has transitioned to F3 foam. Supervisor Mash asked about compensation structure, confirming the 25% contingency fee plus reimbursement of advanced expenses only if recovery is obtained. Attorney Phillips emphasized the county is not alleging wrongdoing by the airport." },
      { item:"Renewable Energy Regulatory Authority Presentation", body:"Attorney Rebecca Roker from Atollis Law presented on county options for responding to proposed wind projects including Hub City Wind (Alliant Energy) and Stormark Wind Energy Center. She explained that PSC has jurisdiction over projects over 100 megawatts and has approved 33 solar projects with zero denials. Roker outlined four options: do nothing, negotiate a Joint Development Agreement (JDA), intervene in PSC proceedings, or litigate. She strongly recommended JDAs as the most effective tool to protect county interests including road damage, decommissioning costs, emergency response training, and environmental protections." },
      { item:"Town of Brighton Case Discussion", body:"Roker discussed the Town of Brighton case where the town's wind energy ordinance was upheld by circuit court, but the developer (EDP Renewables\/Marathon Wind LLC) dismissed its appeal after the project was purchased as part of the Hub City project. She noted this case brought unique elements to the regulatory discussion but cautioned that litigation is expensive and rarely stops projects given PSC's track record of approvals." },
    ],
    publicComment: "Five residents provided public comment. Cindy Nielson (Stratford\/Oplane Township) spoke against wind turbine projects, stating she visited 200 houses and found no support for turbines, citing concerns about setbacks (1,250 ft from her home) and impacts on Marshfield and Stratford industrial park. Wendy Rowski (Green Valley) urged the board to vote no on the comprehensive plan draft, objecting to the term 'wind farm' and requesting it be replaced with 'industrial wind energy development.' Barb Newton (Rib Mountain) reiterated support for speed reduction and no-passing zone on Double N, noting 75 residents signed a petition and describing near-collision incidents. Heidi Pesky (Town of McMillan) argued against Joint Development Agreements, listing 12 concerns including loss of county neutrality, liability risks, and inadequate decommissioning assurances. Cindy Hogan (Rib Mountain) supported the Double N speed reduction petition.",
    actionItems: [
      "Resolution regarding PFAS litigation participation to be considered for vote at next week's meeting",
      "Board members directed to contact chair, administrator, or corporation counsel with additional PFAS litigation questions",
      "County to consider options for responding to Hub City Wind and Stormark Wind Energy Center projects",
      "Speed limit reduction and no-passing zone on Double N to be considered (referenced from previous infrastructure committee recommendation)",
    ],
  },
  {
    ...
    isAgendaOnly: false,
    badge: "new",
    overview: "The Board of Public Works opened bids for the 2026 asphalt paving project and awarded the contract to RC Pavers, the lower of two bidders at $824,146.34. The meeting was brief, lasting approximately one minute.",
    agenda: [
    ...
    discussions: [
      { item:"2026 Asphalt Paving Project Bid Opening", body:"Two bids were opened for the asphalt paving project. RC Pavers submitted the low bid at $824,146.34, while American submitted a bid of $849,872.10. A motion was made to approve RC Pavers as the contractor, which was seconded and passed unanimously with 'aye' votes." },
    ],
  ...
  },
  {
    ...
    isAgendaOnly: false,
    badge: "new",
    overview: "The Board of Public Works approved construction bids, a change order, and a pay estimate for ongoing street projects. The 26th Street construction project was awarded to Switlick as the low bidder in a very close competition, and a change order for unexpected site conditions on the Randolph\/Cherry Street project was approved.",
    agenda: [
      ...
      { time:"1:15", item:"Open bids for North 8th Avenue (postponed)" },
      { time:"1:30", item:"2025 Street Construction Project A - Change Order One" },
    ...
    discussions: [
      { item:"March 10th Board of Public Works Minutes", body:"The minutes from the March 10th regular meeting were approved. A motion was made and seconded, passing with all in favor." },
      { item:"26th Street Construction Project Bids", body:"Seven bids were opened for the 26th Street construction project. Switlick submitted the low bid at $1,279,089.75, barely edging out Hos at $1,280,877.96. Other bidders included A1 ($1,374,600), Francis Melvin ($1,385,383), Steen ($1,489,126), James Peterson ($1,570,698.56), and Earth ($1,686,078.75). A member remarked on how tight the top two bids were. Motion to approve Switlick passed unanimously." },
      ...
      { item:"2025 Street Construction Project A - Change Order One", body:"Change order one for the Randolph\/Cherry Street project was presented, totaling $14,436.50 for four items: an inside drop on a manhole ($4,856) due to an unrecorded large diameter sanitary service; water main tie-in modifications ($2,317.50) after finding 6-inch instead of expected 8-inch main; miscellaneous storm sewer connections ($5,016) at $66 per lineal foot; and geogrid installation ($2,247) for about 750 square yards near Thomas Jefferson Elementary due to poor soil conditions. Change order two regarding liquidated damages was deferred pending further discussions. Motion to approve passed unanimously." },
      { item:"2025 Street Construction Project A - Pay Estimate Number Nine", body:"Pay estimate number nine from Haw Suns Incorporated for work completed through the end of the year was recommended for approval in the amount of $535,114.42. Motion to approve passed unanimously." },
      { item:"Portland Cement Concrete License - KSK Incorporated", body:"Vinnie confirmed the application was reviewed and everything was in order. A motion to approve the license for KSK Inc. was made and passed unanimously." },
    ],
    publicComment: "No public comment was offered.",
    actionItems: [
      ...
      "Change order two for liquidated damages to return at future meeting",
      "Pay estimate #9 of $535,114.42 approved for Haw Suns Incorporated",
  ...
  },
  {
    ...
    isAgendaOnly: false,
    badge: "new",
    overview: "The Village of Weston Finance and Human Resource Committee debated a proposed employee clothing allowance increase after canceling a Cintas uniform contract. After multiple failed motions, the committee approved $400 annually for clothing plus a one-time washer\/dryer purchase for staff. Public Works Director Michael presented a comprehensive report showing the department operates below regional averages in spending.",
    agenda: [
      ...
      { time:"3:45", item:"February financial reports acknowledgment" },
    ...
    discussions: [
      { item:"Public Works Operations and Budget Presentation", body:"Public Works Director Michael presented a comprehensive overview of department operations, noting the 2026 budget decreased by $26,000 (1.1%) compared to 2025. He highlighted the department manages 119.5 centerline miles of road, 114 miles of water main, 103 miles of sanitary sewer, and 70 miles of storm sewer. Michael emphasized the village spends approximately $9,700 less per mile than the average central Wisconsin community and is second lowest in per capita spending. He discussed the recent major snow event where staff worked 16-17 hour shifts, with estimated costs around $50,000, and noted the county is applying for disaster relief funds. Transportation aids have been recovering after dropping significantly between 2011-2020." },
      { item:"Clothing and Equipment Reimbursement Amendments", body:"Extended debate occurred over increasing employee clothing allowance from $300 to $600 after canceling the Cintas uniform contract. Committee member My (identified phonetically) argued against the increase citing fiscal responsibility and the upcoming fire department referendum. Public Works Director Michael advocated for the increase, emphasizing employee retention and that the department already operates below regional averages. Initial motion for $600 failed (Daniels-yes, Armain-no, Olsson-yes, My-no, Satai-no). Motion for $400 also failed 3-3. Motion for $500 with washer\/dryer failed. Final motion for $400 annually with one-time washer\/dryer purchase passed with one opposed." },
      { item:"Minutes and Financial Reports", body:"February 16, 2026 meeting minutes approved unanimously on motion by Steve, seconded by Stephanie. February financial reports for all funds acknowledged unanimously. T1 and T2 detail reports and legal details for February were all acknowledged unanimously." },
    ],
    publicComment: "Lisa Beck of 1808 Cortez Lane offered public comment. She praised Public Works Director Michael for the department's work during the recent major storm. She also expressed concerns about the proposed clothing allowance increase, questioning whether the village should provide the highest proposed amount and suggesting a lesser amount to save money.",
    actionItems: [
      "Recommend to village board: Employee clothing allowance of $400 annually (remainder of 2026 and going forward) with one-time purchase of washer and dryer for staff",
      "Marathon County disaster relief application pending for recent snow storm costs (approximately $50,000 estimated)",
      "New public works employee starting Wednesday to bring staff to 10",
      "Next committee meeting scheduled for Tuesday, April 21st at 5:00 PM",
    ],
  },
  {
    ...
    agenda: [
      ...
      { time:"22:00", item:"Repealing Municipal Code Section 10.01.012 - Handheld mobile device ban while driving" },
    ...
    discussions: [
      { item:"Westider Diner and Lounge Parklet Permit", body:"Owner Tyler Vote presented detailed mockups for a parklet extending 4 feet into the street and 4 feet on the sidewalk at 628 North Third Avenue. He explained it would provide sunny seating for breakfast customers and take up less space than two parked cars. Larson noted initial skepticism but was convinced by the presentation. The permit was approved unanimously for a trial through October 2026, with Vote asked to return in November to report on how it went." },
      { item:"License Denial Recommendations", body:"Theodore Davis appeared regarding his bartender license denial recommendation related to a 20-year-old offense. His boyfriend Matthew Prieb spoke in support, emphasizing Davis has not reoffended and is a good person. The committee held action on Davis's application pending Chief Barnes' review of rehabilitation evidence Davis had submitted. Joanna Gregory did not appear; her denial was included in the batch approval of remaining licenses." },
      { item:"License Applications Batch", body:"The liquor license review subcommittee reported unanimous approval recommendations for Oasis Arcade, the rebranded Whiskey River Bar and Grill, and new ownership at Hayawa. Summer event permits for Wings over Wausau, Concerts on the Square, Chalkfest, Memorial Day parade, Hope on the Block, and Jazz on the River were also recommended for approval. Motion by Larson, seconded by Watson, passed unanimously excluding Theodore Davis's application." },
      { item:"Municipal Code Chapter 6.44 - Solid Waste Disposal", body:"Assistant City Attorney Vinnie Bonino explained the chapter was repealed and recreated to comply with state-level changes that evolved over time. Motion by Larson, seconded by Watson, passed unanimously with no discussion." },
      { item:"Municipal Code Section 10.01.012 - Cell Phone Ban Repeal", body:"Bonino explained that state inattentive driving statutes have been amended to regulate cell phone usage more narrowly, making the local ordinance redundant since the city already adopts state traffic code. Motion by Watson, seconded by Larson, passed unanimously." },
      { item:"Midwest Renewable Energy Solar Program Partnership", body:"Carrie from the planning department reported the sustainability committee voted unanimously on March 5th to move this forward. Alder Sarah endorsed the partnership from personal experience with solar installation, praising MREA's expertise. Motion by Watson, seconded by Larson, passed unanimously." },
      { item:"Fire Department 2025 Annual Report", body:"Fire Chief reported the department achieved over 7,200 calls averaging 20 per day, setting new records. He announced Friday that Wausau was confirmed as ISO Class 2 status for the next four years. Three upcoming public information sessions were announced: March 31st at 1:00 PM at the tech, April 1st at 5:00 PM at station two, and April 3rd at station one, related to the April 7th referendum." },
      { item:"Shelter Transition to Bridge Street Mission", body:"Tracy Durante reported 415 unduplicated guests served since opening and over 740 volunteer hours in February. James Torensson, new Director of Homeless Services at Bridge Street Mission, explained the emergency shelter transition is expected around April 20th, pending contractor announcement on April 1st. The WMC shelter contract with First United Methodist Church was extended through April 19th to ensure no service gap. The committee expressed interest in touring the new facility at the ribbon cutting ceremony." },
    ],
    publicComment: "Carrie Mor Everest of 1025 Everest Boulevard spoke during late public comment about concerns with how 911 responders have treated unhoused individuals at the shelter during emergencies. She stated she has witnessed multiple incidents over 10 months where people were not treated ethically or professionally, and her complaints have not been addressed. The chair noted the Police and Fire Commission handles such complaints through formal processes.",
    actionItems: [
      "Parklet permit approved for Westider Diner and Lounge through October 2026; owner to report back in November",
      ...
      "Fire Department to hold three public information sessions before April 7th referendum",
      "Council to tour Bridge Street Mission shelter at ribbon cutting ceremony after opening around April 20th",
    ],
  },
  {
    ...
    isAgendaOnly: false,
    badge: "new",
    overview: "The Village of Weston Board of Trustees approved multiple ordinances including rezoning requests and a modified speed limit ordinance, after rejecting the original proposal that would have lowered Weston Avenue speeds to 35 mph from Von Kennel to J. The board also approved a 10-year baseball\/softball field maintenance agreement, park fee changes, and various infrastructure contracts while deferring action on a remote meeting attendance policy until the new board is seated.",
    agenda: [
      { time:"0:01", item:"Call to order and Pledge of Allegiance" },
      ...
      { time:"35:02", item:"New business - E-bike ordinance, parking restrictions, park agreements, infrastructure contracts" },
    ],
    discussions: [
      { item:"Public Comment - Fire Department Funding", body:"Jim Pensel of 5002 Aerrol Street spoke critically of the board's approach to funding the fire department. He praised SAFER staff after attending their citizen academy but criticized the referendum approach as 'kicking the can down the road' since it has no sunset date. He urged the board to prioritize fire\/EMS funding over 'wants' like artificial turf and the aquatic center, stating 'We have the money. You just need to have the courage to spend it where it actually matters.'" },
      { item:"Finance Director Response to Public Comment", body:"Finance Director Jessica responded firmly that the village cannot borrow for additional firefighters - only for capital projects like the Kennedy Park turf. She noted the village is 'the cheapest' and 'most efficient' but cannot fund more staff, referencing complaints about snow removal response despite staff working 17-18 hour days. She expressed frustration with 'naysayers' and stated 'maybe in a couple months my position will be open' at $150,000." },
      { item:"Speed Limit Ordinance 26-006", body:"The original ordinance to change speed limits on Weston Avenue failed with four 'no' votes from Maloney, Jordan, Kerning, and the president. Trustee Maloney argued the 35 mph limit from Von Kennel to Ryan was excessive given sparse development, comparing it unfavorably to Ross and Scoffield Avenues. A revised motion by Maloney was then approved keeping Von Kennel to Camp Phillips at 35 mph but returning Von Kennel to Highway J to 45 mph, with all other changes intact." },
      ...
      { item:"Baseball\/Softball Field Maintenance Agreement", body:"The board approved a 10-year agreement with youth baseball and softball organizations for field maintenance at Kennedy Park. The extended term was justified because the organizations are investing money in the facilities, and the agreement formalizes that the village determines when fields can be used. Youth organizations perform maintenance in lieu of fees." },
      { item:"Intersection Signage at Community Center Drive", body:"The board approved changing the stop sign to a yield sign with a friendly amendment adding a stop sign for bicyclists exiting the pedestrian bridge. Trustee Hooang raised safety concerns about cyclists coming off the bridge at 15-20 mph, leading to the addition of a bicycle stop sign at the bridge landing." },
      { item:"Remote Meeting Attendance Policy", body:"Trustee Lewis recommended deferring this item until the next meeting so the new seated board can make the decision. The motion to defer passed unanimously." },
      { item:"E-bike and Euro Ordinance", body:"The board voted to table the proposed e-bike ordinance until the county finalizes their process and it can be brought back from the MPO committee. The motion to table passed unanimously." },
    ],
    publicComment: "Jim Pensel of 5002 Aerrol Street spoke about fire department funding. He praised SAFER staff after attending their citizen academy but criticized the board's referendum approach as inadequate, arguing the village has 'a priority problem' not a revenue problem. He urged redirecting funds from 'wants' like artificial turf and the aquatic center to fully fund fire and EMS services.",
    actionItems: [
      "Minutes from February 16th approved unanimously",
      ...
      "Speed limit ordinance approved as amended: Von Kennel to Camp Phillips at 35 mph, Von Kennel to Highway J at 45 mph",
  ...
  },
  {
    ...
    isAgendaOnly: false,
    badge: "new",
    overview: "The Marathon County Board of Supervisors adopted the comprehensive plan 2026 with multiple amendments addressing renewable energy language, AI\/automation references, and energy policy. The board also approved several resolutions including salaries for elected officials, a highway facility design phase, PFAS litigation authorization, and ratified a local state of emergency declaration following a major blizzard.",
    agenda: [
      { time:"0:12", item:"Call to order, pledge of allegiance, and silent reflection" },
      ...
      { time:"55:02", item:"Resolution establishing salaries for clerk of courts, sheriff, and elected department heads (R-12-26)" },
      { time:"1:20:01", item:"Authorization for phase 2 design services for new highway facility (R-13-26)" },
      { time:"1:22:00", item:"Authorizing outside counsel for PFAS litigation (R-14-26)" },
      { time:"1:28:00", item:"Resolution approving carry forwards and budget amendments (R-20-26)" },
      { time:"1:30:01", item:"Ratification of local state of emergency declaration (R-22-26)" },
      { time:"1:35:00", item:"Administrator performance evaluation and salary" },
    ],
    discussions: [
      { item:"Comprehensive Plan 2026 Amendments", body:"The board considered 10 proposed amendments to the comprehensive plan. Amendment 1 (livability standards) passed unanimously. Amendments 2, 3, and 4 (alternative energy language changes proposed by Vice Chair Dickinson) were separated at Supervisor Crawl's request and each passed but not unanimously. Amendment 5 (data centers and battery storage) passed but not unanimously, with Supervisor Leur voting no citing ideological concerns. Amendment 6 (radon and lead references) passed unanimously. Amendment 7 (regulate energy when allowed by law) passed but not unanimously. Amendment 8 (AI and automation language proposed by Supervisor Leur) passed unanimously. Amendment 9 (coal, natural gas, nuclear energy) was amended by Supervisor Boots to read 'promote coal and natural gas until a long-term sustainable and reliable energy source can be found that does not adversely affect agricultural land' - the amended version passed but not unanimously. Supervisor Sundulski offered a late amendment regarding utility-scale wind, solar, and battery facilities as industrial uses; Supervisor Jeang moved to refer it to committee but that motion was defeated; the amendment itself was then defeated. The final comprehensive plan as amended passed but was not unanimous." },
      { item:"Salaries for Elected Officials", body:"Resolution 12-26 establishing salaries for clerk of courts, sheriff, and elected department heads for the upcoming term was approved. Motion by Supervisor Conway, second by Supervisor Rosenberg. The motion carried." },
      { item:"Highway Facility Phase 2 Design", body:"Resolution 13-26 authorizing phase 2 design services for the new highway facility was approved unanimously. Supervisor Soyber requested future information about plans for the old facility. Chair Gibbs noted this would be addressed by HR Finance and Property Committee in the future." },
      ...
      { item:"Local State of Emergency Ratification", body:"Resolution 22-26 ratifying the emergency declaration following a major blizzard passed unanimously. Administrator Leonard explained the ratification preserves opportunities for state reimbursement and praised county staff across facilities, parks, highway, sheriff's office, and airport who worked 12-16 hour shifts during the event, with over 600 hours of additional call-in time in a 24-hour span." },
      { item:"Administrator Performance Evaluation", body:"The board accepted the executive committee's recommendation on Administrator Leonard's performance evaluation and salary placement under the new pay structure. Motion by Supervisor Robinson, second by Supervisor Cavalli. Passed unanimously without going into closed session." },
    ],
    publicComment: "No public comment was offered.",
    actionItems: [
      "Comprehensive Plan 2026 adopted with amendments addressing energy language, AI\/automation, radon\/lead, data centers, and energy policy",
      ...
      "Administrator performance evaluation finalized with salary placement approved",
  ...
  },
  {
    ...
    isAgendaOnly: false,
    badge: "new",
    overview: "The Village of Weston Parks and Recreation Committee approved minutes, selected Rettler Corporation to develop a master plan for Mock Mueller Park, and discussed park impact fee increases. The committee also reviewed Yellow Banks kayak launch expenses showing significant grant funding success and discussed the future of the Kennedy Park ice rink.",
    agenda: [
      ...
      { time:"25:15", item:"Discussion on requests for proposals for Mock Mueller Park master plan" },
    ...
    discussions: [
      ...
      { item:"Parks and Recreation Impact Fee Discussion", body:"Jennifer presented information on park impact fees, noting the current single-family fee is $300 compared to neighboring communities charging $600-$650. The 2020 study recommended fees up to $761 for single-family homes. Committee members Katrina and others expressed support for a moderate increase to be more in line with neighboring communities like Kronenwetter ($603) and Rib Mountain ($650). The committee's feedback was to keep fees consistent with neighbors while remaining competitive. No formal action was taken; Jennifer will present this feedback along with neighboring community data to the Plan Commission next month." },
      ...
      { item:"Yellow Banks Kayak Launch Expenses Review", body:"Jessica presented a detailed breakdown of the kayak launch project expenses and grant funding. The project had unexpected costs including poor subgrade and an unknown well casing. Grants were secured from DNR, Marathon County Transportation, and others, with Dan Higginbotham and MTS donating site planning services. Katrina praised the RFC documentation and highlighted this as a success story where out-of-pocket costs were significantly reduced through grant work. Lisa Beck also commended the expense report during public comment. No formal action was required; informational only." },
      { item:"Ice Rink Operations at Kennedy Park", body:"Staff presented information requested by committee member Katrina regarding ice rink operations. The warming house has been unattended since 2020 due to COVID and subsequent staffing shortages. Discussion included Everest Youth Hockey's interest in potentially building a covered structure, with Michael noting they have cost estimates ready. Katrina expressed concern about not losing sight of hockey amid baseball-focused Kennedy Park discussions. The committee requested additional historical attendance data from 2018-19 seasons and user feedback for future meetings. No action was taken." },
    ],
    publicComment: "Jim Pinsel expressed frustration about receiving no response to questions submitted at the previous meeting regarding playground equipment installation issues and Kennedy Park fundraising updates. He criticized the ice rink cost analysis as incomplete, arguing true costs including labor hours are closer to $20,000-$30,000 rather than the stated $1,320.98. Lisa Beck (1808 Cortez Lane) thanked Michael for snow plow work during the recent blizzard and praised Sean and Jessica for the well-written Yellow Banks RFC documentation. A written response to Jim Benson's previous email was also submitted and will be included in the minutes.",
    actionItems: [
      ...
      "Staff to gather user feedback on ice rink for future meeting",
  ...
  },
  {
    ...
    isAgendaOnly: false,
    badge: "new",
    overview: "The Wausau Finance Committee denied a tax recovery claim related to ongoing Greenwood Hills litigation, approved multiple airport ground lease transfers, and postponed decisions on a national opioid settlement and lead service line funding while reviewing strong 2025 general fund results showing a $540,000 surplus.",
    agenda: [
    ...
    discussions: [
      { item:"Alleged claim for recovery of unlawful tax for Greenwood Hills LLC", body:"This assessment is part of ongoing litigation with Greenwood Hills. Rick Rubble from assessments was present. The chair explained that a motion to approve followed by a 'no' vote would deny the claim. Watson moved to approve, Griner seconded. The motion failed when members voted 'no' to deny the claim." },
      { item:"Airport ground lease transfers at 939 Woods Place", body:"Three related items involved transferring a hangar from Win O. Jones to Owen Jones. Watson moved to approve consent to transfer title, seconded by Griner, passed unanimously. Tierney moved to terminate the lease with Win O. Jones, seconded by Watson, passed unanimously. Watson moved to approve the new lease with Owen Jones, seconded by Tierney, passed unanimously." },
      { item:"Airport ground lease with Cole Lundberg", body:"Griner moved to approve the airport ground lease with Cole Lundberg, seconded by Watson. The motion passed unanimously with no discussion." },
      { item:"National opioid settlement agreement participation", body:"The committee discussed joining a class action lawsuit against six opioid defendants. Alder Maloney questioned where this came from, stating it 'dropped from heaven.' Assistant City Attorney Vincent explained it came via letter from a law firm seeking potential plaintiffs. Members expressed discomfort proceeding without more information, noting they would sign away future individual action. Griner moved to postpone to the next meeting, seconded by Tierney. Motion passed unanimously." },
      { item:"Budget amendment for lead service line replacement", body:"Eric from Public Works explained the DNR changed funding terms, resulting in $709,000 in non-construction costs not covered by the subsidized loan. Finance Director Marian presented options including using general fund surplus, PFAS settlement money, or borrowing. Tierney stated opposition to adding more debt. Discussion explored splitting the $283,868 homeowner side from the $425,803 utility side with different funding sources. Watson moved to postpone to the next meeting, seconded by Griner. Motion passed unanimously." },
      { item:"Budget amendment for carryover funds 2025 to 2026", body:"Finance Director noted the large carryover amount includes 10 transit buses funded by VW mitigation grant money. Several projects including city hall chimney liner, public safety roof, and DPW fence replacement had not yet started. Watson moved to approve, seconded by Griner. Motion passed unanimously." },
      { item:"Review of 2025 motorpool fund financial results", body:"Finance Director presented that after transferring $191,000 GMT money, the motorpool would show $150,000 profit. However, pending capital purchases would create a $177,000 cash shortfall that could potentially be covered by ARPA savings and sale proceeds. Solomon from Motorpool explained two dump trucks from 2023 are still awaiting upfits but are now second and third in line. This was informational only with no action required." },
      { item:"Review of 2025 general fund financial results", body:"The general fund showed a $1.2 million surplus driven by strong building permits, GMT money, and investment income. After allocating full motorpool charges, public works, fire, and police departments were over budget. CCITC was over $194,000 due to communication problems including duplicate 95% personnel budget entries and unbudgeted Office 365 upgrades. After proposed transfers to recycling, airport, and parking funds, the surplus would be $540,000. Tierney moved to approve the transfers, seconded by Watson. Motion passed unanimously." },
      { item:"2026 general obligation promissory note for capital improvements", body:"Finance Director presented the borrowing calendar showing $10 million in new borrowing against $12 million retiring debt. Phil Cawson from Ehlers will present parameters resolution at the next meeting. Watson moved to approve the calendar, the chair seconded. Motion passed unanimously. The lead service line amendment could be added at the next meeting." },
      { item:"Considering purchase of properties for DPW Streets Division", body:"Properties at 108 Adolf Street, 112 Adolf Street, 112.5 Adolf Street, and 233 Myron Street were scheduled for closed session discussion. Due to time constraints before council meeting and lack of urgency, Watson moved to postpone to the next meeting, seconded by Tierney. Motion passed unanimously." },
    ],
    publicComment: "No public comment was offered.",
    actionItems: [
      "Denied tax recovery claim for Green Acres at Greenwood Hills LLC (vote failed)",
      "Approved consent to transfer title of buildings at 939 Woods Place",
      "Terminated airport ground lease with Win O. Jones at 939 Woods Place",
      "Approved airport ground lease with Owen Jones at 939 Woods Place",
      ...
      "Postponed lead service line budget amendment to next meeting for funding source determination",
      "Approved carryover funds budget amendment from 2025 to 2026",
      "Approved transfers to recycling, airport, and parking funds from general fund surplus",
      "Approved 2026 borrowing calendar with parameters resolution to follow at next meeting",
  ...
  },
  {
    ...
    isAgendaOnly: false,
    badge: "new",
    overview: "The Marathon County Executive Committee held a brief meeting that quickly moved into closed session to discuss the performance review of the county administrator. The committee voted unanimously to enter closed session, with all members present voting in favor.",
    agenda: [
      { time:"0:00", item:"Call to order" },
  ...
  },
  {
    ...
    isAgendaOnly: false,
    badge: "new",
    overview: "The Marathon County HR and Finance Committee approved several items including a claim disallowance related to a child's death in foster care, revised property values for public auction, carry forward funds resolution, and a capital assets threshold policy amendment. The committee also received introductions from new healthcare consultants National Insurance Services and detailed fiscal updates for 2025 year-end and 2026 year-to-date.",
    agenda: [
      { time:"0:00", item:"Claim disallowance - Mercedes Holmes" },
      { time:"2:25", item:"Revised property values for public auction" },
    ...
    discussions: [
      { item:"Claim disallowance - Mercedes Holmes", body:"The committee considered a claim filed December 5th by Mercedes Holmes related to the death of her 3-year-old child Zalen Bernett, who was placed in a treatment foster care home licensed through another agency in Dunn County. The death was determined to be natural causes with no wrongdoing found through law enforcement and social service investigations. Outside counsel and insurance carrier WIMIK recommended disallowance. Chair Gibbs moved to disallow the claim in conjunction with the insurance carrier's recommendation, seconded by Supervisor Lemer. Motion carried unanimously." },
      { item:"Revised property values for public auction", body:"Two parcels that failed to sell twice on Wisconsin Surplus were presented for revised minimum sale prices. The parcel at 529 Mullen Street was set at $9,000 and 738 South 3rd Avenue at $7,500. Staff noted that a non-paying bidder from a previous auction was marked as non-pay and banned from future Wisconsin Surplus auctions. Chair Gibbs moved to approve, seconded by Supervisor Lemer. Motion carried unanimously." },
      { item:"Resolution to approve carry forward funds (R2026)", body:"Finance Director Sam presented Resolution R20-2026 for program revenues and multi-year project funds to be carried forward to 2026. Notable items included veterans relief fund replenishment (providing approximately three years of funding), Register of Deeds redaction funds, and $142,731 for administration special projects including $75,000 for homelessness contract. Vice Chair Marshall inquired about the redacted records fund purpose. Chair Gibbs moved to approve, seconded by Supervisor Hart. Motion carried unanimously." },
      { item:"Capital assets threshold policy amendment", body:"Finance Director Sam presented a resolution to increase the capitalization threshold from $5,000 to $10,000 for general assets, following GFOA guidance from 2006. The change had been considered in 2022 but not completed. Supervisor Hart moved to approve and forward to full county board, seconded by Chair Gibbs. Motion carried unanimously." },
      { item:"Introduction of National Insurance Services healthcare consultants", body:"NIS representatives introduced themselves as the county's new healthcare consulting firm following an RFP process. Key staff include a consultant with 28 years experience, account manager Jordan Stanley, Perry Gilfoil (plan analytics), Zack Cunningham (support), and Adam Cook (retirement income). They outlined their focus on evaluating the near-site ATA clinic, assessing fully insured vs self-insured funding models, and improving communication with the board. Vice Chair Marshall asked about per-member costs compared to other employers and strategies to reduce emergency room use. Chair Gibbs inquired about evaluation processes for different insurance funding models." },
      { item:"2025 year-end fiscal update", body:"Finance Director Sam provided a detailed department-by-department review of unaudited year-end figures. Notable items included: TID closure check of $257,238 from City of Wausau, unclaimed state property of $222,752, sales tax of approximately $2 million, opioid settlement funds of $352,389 with total cash of $2.2 million, and parks fund ice revenue increase of $70,000. Various transfers and reclassifications were noted as still pending. When asked about fund balance surplus, Sam indicated she would provide that figure at the next meeting after capital assets are reconciled." },
      { item:"Finance Department quarterly update", body:"Sam reported the department is fully staffed since mid-December with a new systems financial analyst for payroll. Accomplishments include quarterly closeouts with departments, countywide training on reports and uniform practices, W-2 processing including the 'big beautiful bill' overtime calculations, 1099 processing, random cash audits (all successful), and continued budget meetings with larger departments. Upcoming work includes payroll budget preparations, policy and procedure updates for accounts receivable and fixed assets, and first quarter closeout by May 31st with monthly closeouts thereafter. County Administrator Lance commended Sam and her team for their extensive work on year-end processing." },
      { item:"County Treasurer update", body:"Treasurer Connie reported on tax collection activities including 1,582 delinquent tax notice letters sent in March (down from 1,786 last year), completion of 2024 tax year closeout, February settlement payments processing, and ongoing work with DOR on corrections. She noted significant issues with municipal receiving errors affecting lottery credits and tax payments. The committee discussed resources for struggling taxpayers and the discontinuation of payment agreements due to high default rates. Administrator Lance clarified that evictions referenced are specifically related to county tax delinquent parcel proceedings, not general evictions." },
    ],
    publicComment: "No public comment was offered.",
    actionItems: [
      "Disallowed claim of Mercedes Holmes related to child death in foster care",
      "Set revised minimum sale prices for two parcels for Wisconsin Surplus auction ($9,000 and $7,500)",
      ...
      "Finance to provide fund balance surplus figure at next meeting after capital assets reconciliation",
      "Register of Deeds to provide future update on redaction fund history and potential repurposing",
      "NIS healthcare consultants to provide update prior to budget assumption development in early summer",
      "Finance to bring recommendation to increase Social Services reserve account from current $400,000 level",
  ...
  },
  {
    ...
    isAgendaOnly: false,
    badge: "new",
    overview: "The Economic Development Committee met to consider several property disposition matters including survey results for 1300 Cleveland Avenue, a Habitat for Humanity purchase offer for 921 S. 19th Avenue, and residential infill proposals for Thomas Street properties. No vote counts or motion outcomes are recorded in the official records for this meeting.",
    agenda: [
    ...
    discussions: [
      { item:"Non-Industrial Land Use Preference Survey for 1300 Cleveland Avenue", body:"This item was on the agenda for discussion and possible action regarding survey results for land use preferences at 1300 Cleveland Avenue. No vote count or motion outcome is recorded in the official records." },
      { item:"Habitat for Humanity property disposition offer for 921 S. 19th Avenue", body:"The committee considered a property disposition offer to purchase from Habitat for Humanity of Wausau for the property at 921 S. 19th Avenue. No vote count or motion outcome is recorded in the official records." },
      { item:"Thomas St residential infill Request for Interest (206, 212, 226, and 230 E Thomas St)", body:"The committee discussed a Request for Interest for residential infill development on four East Thomas Street properties. No vote count or motion outcome is recorded in the official records." },
      { item:"Thomas St and McCleary St vacant lots redevelopment (237, 241 and 249 E Thomas St)", body:"The committee discussed redevelopment of vacant lots at 237, 241, and 249 E Thomas Street near McCleary Street. No vote count or motion outcome is recorded in the official records." },
    ],
    publicComment: "Public comment was on the agenda as the first item, including reading of the City of Wausau Public Comment Statement.",
    actionItems: [
      "Review of survey results for 1300 Cleveland Avenue land use preferences was discussed",
      "Habitat for Humanity purchase offer for 921 S. 19th Avenue was under consideration",
      "Request for Interest for Thomas Street residential infill properties (206, 212, 226, 230 E Thomas St) was reviewed",
      "Redevelopment options for Thomas St and McCleary St vacant lots (237, 241, 249 E Thomas St) were discussed",
    ],
    civicItems: [
  ...
  },
  {
    ...
    isAgendaOnly: false,
    badge: "new",
    overview: "The Wausau Board of Public Works approved most agenda items including contractor pay estimates and licenses, but notably failed to approve Pay Estimates #24 and #25 with Community Infrastructure Partners for lead service line replacement. The board also approved a closed session to deliberate on claims and passed minutes from previous meetings.",
    agenda: [
    ...
    discussions: [
      { item:"March 17, 2026 and March 19, 2026 Regular Board of Public Works Minutes", body:"The board approved the minutes from the March 17, 2026 and March 19, 2026 meetings. The motion passed." },
      { item:"Open Quotations for Storm Sewer Materials", body:"The board opened quotations for storm sewer materials. No vote outcome was recorded for this item, indicating it was an informational opening of bids." },
      ...
      { item:"Pay Estimate #24 and Pay Estimate #25 with Community Infrastructure Partners for replacement of lead service lines", body:"The board voted to deny Pay Estimates #24 and #25 with Community Infrastructure Partners for lead service line replacement work. The motion to approve failed." },
      ...
      { item:"Closed Session for deliberating on claims", body:"The board voted to convene in closed session pursuant to Wisconsin State Statute §19.85(1)(g) for the purpose of deliberating on claims. The motion passed." },
    ],
    publicComment: "Not indicated on agenda.",
    actionItems: [
      "Pay Estimates #24 and #25 for Community Infrastructure Partners lead service line work denied - requires follow-up or resubmission",
      "J.F. Ahern Co. to receive $104,405.00 for Pay Estimate #12",
      "Robinson Brothers Environmental to receive final payment of $1,000",
      "The MRD Group to receive $62,272.50 for Pay Estimate #2",
      "Haas Sons, Inc. contract extensions approved per Change Order #2",
      "SD Ellenbecker, Inc., Lewis Construction, Inc., and Kell Contracting issued respective licenses",
    ],
    civicItems: [
  ...
  },
  {
    ...
    isAgendaOnly: false,
    badge: "new",
    overview: "The Wausau Water Works Commission approved minutes from the March meeting and received updates on multiple water infrastructure projects. The meeting adjourned with a unanimous 5-0 vote, with discussions covering lead service line replacement, PFAS testing, and ongoing wastewater projects.",
    agenda: [
    ...
    discussions: [
      ...
      { item:"Wastewater Update on Headworks Screening Project, Cherry Street Lift Station Project, and Status of Class A Biosolids from WDNR", body:"The commission received updates on the Headworks Screening Project, Cherry Street Lift Station Project, and the status of Class A Biosolids from the Wisconsin DNR. This was an informational report with no vote taken." },
      { item:"LSL Replacement Project for 2026", body:"The commission discussed the lead service line replacement project for 2026 and the nationwide cost impacts of new regulations. This was a discussion item with no vote recorded." },
      { item:"Corrosion Control Treatment Optimization Study", body:"A report on the Corrosion Control Treatment Optimization Study submitted to the WDNR was presented. This was an informational item with no vote taken." },
      { item:"Influent, Effluent and Biosolids PFAS Testing", body:"The commission received an update on PFAS testing for influent, effluent, and biosolids. This was a discussion item with no vote recorded." },
    ],
    publicComment: "Not indicated on agenda.",
    actionItems: [
  ...
  },
  {
    ...
    isAgendaOnly: false,
    badge: "new",
    overview: "The Infrastructure & Facilities Committee rejected most action items on the agenda, with parking restrictions on S. 9th Ave\/S. 10th Ave area, increased parking signage, snow plowing policy changes, special assessments for 2025 street projects, and the bike rack request form all failing. Only parking restrictions on N 2nd St (400, 500, and 600 blocks) and the March 12 meeting minutes were approved.",
    agenda: [
    ...
    discussions: [
      ...
      { item:"Parking restrictions on S. 9th Ave, S. 10th Ave, and Bopf Street area", body:"Two separate motions regarding parking restrictions in this area both failed. The committee did not approve changes to parking restrictions on S. 9th Ave between Thomas Street and Chellis Street, S. 10th Ave between Thomas Street and Chellis Street, or Bopf Street between S. 9th Ave and S. 10th Ave." },
      { item:"Increased parking restriction signs on S 9th Ave and\/or S 10th Ave", body:"The motion to approve increased parking restriction signage on S 9th Ave and\/or S 10th Ave failed. No additional signage was authorized." },
      { item:"Snow plowing policy", body:"Three separate motions related to snow plowing policy all failed. The committee did not approve any changes to the current snow plowing policy." },
      { item:"Final Resolution to levy special assessments for the 2025 Street Construction Projects", body:"The motion to approve the final resolution for special assessments related to 2025 street construction projects failed. The special assessments were not authorized." },
      { item:"City bike rack request form", body:"The motion to approve the City bike rack request form failed. The form was not adopted." },
      { item:"Parking Restrictions on N 2nd St: the 400, 500, and 600 blocks", body:"The motion to approve parking restrictions on N 2nd St covering the 400, 500, and 600 blocks passed. This was one of only two action items approved during the meeting." },
      { item:"Sherman Street Overlay from 3rd Ave to 8th Ave", body:"This item was listed for discussion only with no action taken. The committee discussed the Sherman Street overlay project spanning from 3rd Ave to 8th Ave." },
    ],
    publicComment: "Public comment on agenda items was included on the agenda.",
    actionItems: [
      "Parking restrictions on N 2nd St (400, 500, and 600 blocks) approved and will move forward for implementation",
      "Parking restrictions on S. 9th Ave, S. 10th Ave, and Bopf Street area denied - no changes to current restrictions",
      "Snow plowing policy remains unchanged after three failed motions",
      "Special assessments for 2025 Street Construction Projects not levied - may require further action",
      "City bike rack request form not approved - may be revised and reconsidered",
    ],
    civicItems: [
      { number:"1", name:"Public comment on agenda items and reading of the City of Wausau Public Comment Statement.", votes:[], docs:[], children:[] },
      { number:"2", name:"Consideration of the minutes of the preceding meeting(s).", votes:[], docs:[], children:[
  ...
  },
  {
    ...
    isAgendaOnly: true,
    badge: "new",
    overview: "Based on the published agenda, the Marathon County Environmental Resources Committee was scheduled to meet on March 31, 2026. The specific agenda items were not provided in the available documentation, limiting details about what topics were set for discussion.",
    agenda: [
      { time:"N\/A", item:"Agenda details not provided in source document" },
    ],
    discussions: [
      { item:"Agenda content unavailable", body:"The full agenda content was not included in the provided source material. The meeting packet link was referenced but specific agenda items were not detailed in the available text." },
    ],
    publicComment: "Not indicated on agenda.",
    actionItems: [
  ...
  },
  {
    ...
    isAgendaOnly: true,
    badge: "new",
    overview: "Based on the published agenda, the Marathon County Extension, Education, and Economic Development Committee was scheduled to meet on April 2, 2026. Without access to the detailed agenda document, specific items cannot be confirmed, but this committee typically addresses matters related to UW-Extension programs, educational initiatives, and economic development efforts in Marathon County.",
    agenda: [
      { time:"N\/A", item:"Committee business items as outlined in the meeting packet" },
    ],
    discussions: [
      { item:"Committee Business", body:"The committee was scheduled to address matters related to extension services, education programs, and economic development initiatives in Marathon County. Specific discussion items were outlined in the linked meeting packet." },
    ],
    publicComment: "Not indicated on agenda.",
    actionItems: [
      "Committee was expected to consider items outlined in the meeting packet available at the provided link",
    ],
  },
  {
    ...
    discussions: [
      { item:"Meeting Agenda", body:"The specific discussion items for this committee meeting were not included in the provided source material. The full agenda packet was scheduled to be available through the Marathon County website link." },
    ],
    publicComment: "Not indicated on agenda.",
    actionItems: [
  ...
  },
  {
    ...
    isAgendaOnly: true,
    badge: "new",
    overview: "Based on the published agenda, the Marathon County Executive Committee was scheduled to meet on 4\/9\/26, though specific agenda items are not available from the provided information. This committee typically addresses county administrative and policy matters affecting Marathon County residents.",
    agenda: [
      { time:"N\/A", item:"Agenda items not available - only meeting packet link provided" },
    ],
    discussions: [
      { item:"Meeting Agenda", body:"The specific agenda items for this Executive Committee meeting were not included in the provided information. Only a link to the full meeting packet was available, which would contain the detailed agenda and supporting documents." },
    ],
    publicComment: "Not indicated on agenda.",
    actionItems: [
      "Specific action items not available from provided agenda information",
  ...
  },
  {
    ...
    isAgendaOnly: true,
    badge: "new",
    overview: "Based on the published agenda, the Wausau School District Board of Education Committee of the Whole was scheduled to address several significant items including a referendum budget update, facility fee amendments for artificial fields, and an extensive policy review covering over 60 NEOLA policies. Key action items included approval of the Wisconsin School Nutrition Purchasing Cooperative membership for 2026-2027 and updates to policies related to Act 57 child welfare provisions and artificial intelligence use.",
    agenda: [
    ...
    discussions: [
      { item:"Excellence in Action: Stettin Elementary", body:"Stettin Elementary was scheduled to be recognized as part of the district's Excellence in Action presentation series, highlighting achievements or programs at the school." },
      { item:"Wisconsin School Nutrition Purchasing Cooperative Agreement (WiSNP)", body:"The district's Nutrition Service Department was expected to request approval for continued membership in the WiSNP Co-op for the 2026-2027 school year. This presentation was estimated to take 5 minutes and would involve the Board approving a resolution for cooperative membership." },
      { item:"Facility Fees", body:"Ryan Urmanski, Director of Buildings and Grounds, was scheduled to present information to amend the Wausau School District Facility Use Fee Schedule over approximately 10 minutes. The proposed changes were expected to reflect costs for use of artificial fields and field lighting for requested events, with immediate implementation requested upon approval." },
      { item:"Referendum Budget Update", body:"Elizabeth Channel, Interim Assistant Superintendent of Operations, was scheduled to present a 10-minute update on the status of the Referendum Budget. A memo summarizing the referendum budget status was included in the meeting packet." },
      { item:"NEOLA UPDATE - Policies", body:"The Committee was scheduled to review proposed changes to approximately 35 policies over an estimated 20 minutes, ranging from technical corrections to more substantive updates. Notable policies included updates to cell phone and personal communication devices (5136), artificial intelligence use (7540.08), reading instructional goals and kindergarten assessment (2131.01), and third grade promotion (5411)." },
      { item:"NEOLA - School Support Organization Related Policies", body:"The Board was expected to review nine policies related to school support organizations, including student fund-raising (5830), crowdfunding (6605), gifts and bequests (7230), and advertising and commercial activities (9700.01)." },
      { item:"NEOLA - Act 57 Related Policies", body:"The Committee was scheduled to review updates to four policies related to Act 57, which pertains to child abuse and neglect reporting. These included policies on student supervision and welfare for administrators (1213), professional staff (3213), and support staff (4213), as well as the main child abuse and neglect policy (8462)." },
    ],
    publicComment: "No public comment period was included on this agenda.",
    actionItems: [
      "Board was expected to vote on continued membership in the Wisconsin School Nutrition Purchasing Cooperative for 2026-2027 school year",
      ...
      "Board was expected to vote on proposed changes to NEOLA policies including governance, student, financial, and operational policies",
      "Action was requested on school support organization related policies covering fundraising, crowdfunding, and gifts",
      "Board was expected to approve technical corrections to 18 policies",
      "Action was requested on Act 57 related policies regarding student supervision, welfare, and child abuse reporting",
    ],
  },
  {
    ...
    isAgendaOnly: true,
    badge: "new",
    overview: "Based on the published agenda, this special meeting of the Wausau School District Board of Education was scheduled to address the verification of school board election results from the April 2026 elections. This procedural meeting represents an important step in certifying newly elected board members and ensuring the democratic transition of school board governance.",
    agenda: [
      { time:"N\/A", item:"Verify School Board Election Results" },
    ],
    discussions: [
      { item:"Verify School Board Election Results", body:"The board was scheduled to review and verify the results of the recent school board elections. This procedural item was expected to formally confirm the election outcomes and certify the winners who will serve on the Wausau School District Board of Education." },
    ],
    publicComment: "No public comment period was included on this agenda.",
    actionItems: [
  ...
  },
  {
    ...
    isAgendaOnly: true,
    badge: "new",
    overview: "Based on the published agenda, this Special Meeting of the Wausau School District Board of Education was scheduled to convene in closed session to hold a pupil expulsion hearing. The Board was expected to deliberate privately on the matter and potentially take action in either closed or open session regarding the student discipline case.",
    agenda: [
      { time:"N\/A", item:"Call To Order" },
    ...
    discussions: [
      { item:"Closed Session - Pupil Expulsion Hearing", body:"The Board was scheduled to convene in closed session pursuant to Wisconsin Statutes s. 19.85(1)(a), (f), and (g), as well as s. 118.125, to hold a pupil expulsion hearing. Following the hearing, the Board was expected to deliberate privately and potentially take action in closed session if necessary. The Board was scheduled to reconvene into open session following the closed session and may have taken further action." },
    ],
    publicComment: "No public comment period was included on this agenda.",
    actionItems: [
      "Board was expected to vote on motion to convene in closed session for the expulsion hearing",
  ...
  },
  {
    ...
    isAgendaOnly: true,
    badge: "new",
    overview: "Based on the published agenda, the Wausau School District Board of Education's April 13, 2026 regular meeting was scheduled to address significant capital planning matters, including a 10-Year Capital Improvement Plan presentation and transferring property sale revenue to Fund 46 for future improvements. The board was also expected to consider multiple athletic co-op agreements, facility fee updates, and a comprehensive NEOLA policy update covering over 60 policies including new provisions for artificial intelligence and cell phone use.",
    agenda: [
      { time:"N\/A", item:"Call to Order" },
      ...
      { time:"N\/A", item:"New Business - Transfer Funds to Fund 46 (Action Requested)" },
      { time:"N\/A", item:"New Business - Recommendation for 2026-27 Capital Projects (Action Requested)" },
      { time:"N\/A", item:"New Business - Boys and Girls LaCrosse Co-Op (Action Requested)" },
      { time:"N\/A", item:"New Business - Alpine Ski Co-Op (Action Requested)" },
    ...
    discussions: [
      { item:"Excellence in Action: WAVE", body:"The board was scheduled to recognize WAVE as part of the district's Excellence in Action recognition program highlighting student and staff achievements." },
      { item:"Excellence in Action: South Mountain Elementary", body:"South Mountain Elementary was scheduled to be recognized as part of the Excellence in Action program celebrating district accomplishments." },
      ...
      { item:"Transfer Funds to Fund 46", body:"Elizabeth Channel, Assistant Superintendent of Operations, was scheduled to present a five-minute proposal to move revenue generated from three property sales to Fund 46 for future capital improvements. Action was requested from the board." },
      { item:"Recommendation for 2026-27 Capital Projects", body:"Ryan Urmanski, Director of Buildings and Grounds, was expected to present the 10-Year Capital Improvement Plan for district facilities in a 15-minute presentation. The board was scheduled to consider action on capital project recommendations for the 2026-27 school year." },
      { item:"Boys and Girls LaCrosse Co-Op", body:"Jon Tomski, BJ Brandt, and Darci Mick Beversdorf were scheduled to present Boys and Girls LaCrosse Co-Ops for board consideration in a five-minute presentation. Supporting documentation included cooperative team signature pages from Wausau West." },
      { item:"Alpine Ski Co-Op", body:"Jon Tomski, BJ Brandt, and Darci Mick Beversdorf were expected to present the Alpine Skiing Co-Op for board consideration in a five-minute presentation covering the 2026-2028 period." },
      { item:"East \/ Newman JV Baseball Co Op", body:"Wausau East was scheduled to present a Co-Op agreement with Newman for JV baseball in a five-minute presentation. The agenda noted that the extra players would allow for a full JV\/JV2 season and that no official action was needed." },
      { item:"Wisconsin School Nutrition Purchasing Cooperative Agreement (WiSNP)", body:"The district's Nutrition Service Department was expected to seek board approval for continued membership in the Wisconsin School Nutrition Purchasing Cooperative for the 2026-2027 school year in a two-minute presentation." },
      { item:"Facility Fees", body:"Ryan Urmanski, Director of Buildings and Grounds, was scheduled to present amendments to the Wausau School District Facility Use Fee Schedule to reflect costs for use of artificial fields and field lighting for requested events. If approved, changes would be effective immediately." },
      { item:"NEOLA Policy Update", body:"The board was expected to consider a comprehensive 10-minute policy update covering over 60 policies reviewed at the March Committee of the Whole meeting. Updates included policies on definitions, board member behavior, reading instruction, cell phones, artificial intelligence, student fund-raising, crowdfunding, child abuse and neglect reporting under Act 57, and various technical corrections." },
      { item:"Closed Session - Preliminary Notice of Non-renewal", body:"The board was scheduled to enter closed session pursuant to Wisconsin Statutes section 19.85(1)(c) to consider contracts for preliminary notice of non-renewal, with potential reconvening in open session to take further action if necessary." },
    ],
    ...
    actionItems: [
      ...
      "Board was expected to consider approval of the 2026-27 Capital Projects recommendation",
      ...
      "Board was expected to vote on amended Facility Use Fee Schedule for artificial fields and field lighting",
      "Action was requested for comprehensive NEOLA policy updates covering over 60 policies",
