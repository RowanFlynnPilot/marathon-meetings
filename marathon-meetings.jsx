...
const MEETINGS = [
  {
    ...
    date: "May 8, 2026", shortDate: "MAY 8",
    ...
    isAgendaOnly: false,
    badge: "new",
    overview: "The Marathon County Health & Human Services Committee held an introductory meeting for new board members, providing educational presentations from department heads on the Health Department, Social Services, Veteran Services, and the Aging Disability Resource Center. The committee approved the April 1st meeting minutes unanimously and received detailed briefings on department missions, budgets, and current initiatives.",
    agenda: [
      { time:"0:00", item:"Call to order and remote attendance confirmation" },
      ...
      { time:"11:50", item:"Health Department educational presentation" },
      { time:"25:04", item:"Social Services Department overview" },
      { time:"50:01", item:"Veteran Services Department presentation" },
      { time:"1:15:00", item:"Aging Disability Resource Center presentation" },
      { time:"1:30:00", item:"Next meeting date and adjournment" },
    ],
    discussions: [
      { item:"Approval of April 1st meeting minutes", body:"Supervisor Cavalli made a motion to approve the minutes, seconded by Vice Chair Rosenberg. The motion passed unanimously with all members voting in favor." },
      { item:"Review of standing committee ordinance and jurisdiction", body:"Administrator Lance Leonard provided an overview of the committee's structure under section 2.04 sub5, explaining reporting relationships with county departments (Health, Social Services, Veterans) and affiliated entities (North Central Health Care, Aging Disability Resource Center). He explained the committee's role in relation to the Social Services Board, Veteran Service Commission, Transportation Coordinating Committee, and Board of Health. Chair Boots noted the upcoming strategic plan development expected to be completed by December." },
      { item:"Health Department presentation", body:"Health Officer Caitlyn Suginaka presented an overview of the department's four divisions: environmental health, nursing (communicable disease and family health), community health improvement, and administration. The department has 37.6 FTE staff. She highlighted programs including over 1,200 licenses for restaurants and pools, public health vending machines with free tick kits, the Nurse Family Partnership program with first graduates, and a new homeless system response position. The department's 2026 budget is approximately $5 million with about half from tax levy." },
      { item:"Social Services Department overview", body:"Administrator Leonard presented on behalf of Director Christa who was absent. The department has nearly 140 FTE and a 2026 revenue budget of over $22 million with approximately $7 million in tax levy. He highlighted the successful Family Keys housing stability pilot program and noted potential restructuring requests for child support and other units due to increased need." },
      { item:"Veteran Services Department presentation", body:"Veteran Service Officer Erin Galindo reported the department increased from 2.75 to 3.0 FTE this year. Customer interactions jumped from 5,900 to 8,149 in 2025. Veterans in Marathon County receive $44 million annually in benefits, with $2.6 million in retroactive payments in 2025. Key initiatives include housing stability through HUD-VASH partnerships with Center for Veterans Issues, and suicide prevention efforts following 7 veteran suicides among 30 total county suicides in 2025. The department is exploring the Staff Sergeant Gordon Fox VA suicide prevention grant." },
      { item:"Aging Disability Resource Center presentation", body:"Executive Director Mike Ray presented on the four-county ADRC serving Marathon, Lincoln, Langlade, and Wood counties. The organization has about 60 FTEs plus 385-400 volunteers. Marathon County's 2026 contribution is $413,135. He noted significant financial challenges with nutrition program costs increasing 40-45% over four years while federal funding has remained flat due to the Older American Act not being reauthorized since 2024. The organization had not requested a levy increase from 2011 until 2024." },
    ],
    publicComment: "No public comment was offered.",
    actionItems: [
      "Minutes from April 1st committee meeting approved",
      "North Central Healthcare to be scheduled for a separate full presentation",
      ...
      "Committee members to email agenda suggestions to Chair Boots and Administrator Leonard",
  ...
  },
  {
    ...
    isAgendaOnly: false,
    badge: "new",
    overview: "The Marathon County Board of Supervisors held an adjourned organizational meeting where they approved committee appointments, elected Supervisors Hapa and Arstead to the Executive Committee at-large positions, and unanimously approved a resolution to reduce landfill tipping fees for disaster-related debris following severe weather that devastated parts of the county, particularly the Town of Ringle. The board also approved several budget-related resolutions on the consent agenda.",
    agenda: [
    ...
    discussions: [
      { item:"Committee Appointments", body:"Chair Gibbs presented committee appointments developed with Vice Chair Boots, emphasizing goals of increasing diverse perspectives, developing new supervisors as leaders, and honoring supervisor preferences. He noted 34% of the board is in their first or second term. The motion by Supervisor Cavelli, seconded by Supervisor Crims, included both county board chair and administrator appointments. The motion carried but was not unanimous." },
      { item:"Election of At-Large Executive Committee Members", body:"Three supervisors were nominated: Supervisor Hapa (nominated by Supervisor Mask), Supervisor Leur (nominated by Supervisor Rosenberg), and Supervisor Arstead (nominated by Vice Chair Boots). Supervisor Rosenberg explained her nomination of Supervisor Leur, citing her advocacy for the county's youngest children and oldest elders. Paper ballots were used for the vote. Supervisors Hapa and Arstead were elected to the Executive Committee." },
      { item:"Resolution 26-26: Landfill Tipping Fees Modification", body:"Administrator Leonard and Solid Waste Director Hagen Busher presented a proposal to reduce tipping fees for disaster debris following severe weather that impacted Ringle, Kronenwetter, and other communities. The state is waiving $13.10 per ton, Ringle is waiving $2.33, and the county proposes reducing fees to $36.94 per ton (covering costs only). Two residents, Jessica Toasty and Matt Haybeck, were granted special permission to speak, requesting the county waive fees entirely for affected homeowners. Extensive board discussion addressed insurance reimbursement, timeline concerns, and potential community foundation partnerships. The board first voted unanimously to suspend rules to hear the resolution directly, then passed Resolution 26-26 unanimously." },
      { item:"Consent Agenda and Budget Resolutions", body:"The consent agenda (items C10-C14A) was approved unanimously on motion by Supervisor Cavelli, seconded by Supervisor Drebeck. Resolution 24-26 for out of home placement reserve increase passed but was not unanimous, with motion by Supervisor Morash and second by Supervisor Robinson. Resolution 25-26 to amend the social services budget also passed but was not unanimous." },
    ],
    publicComment: "Two residents were granted special permission to speak on the landfill tipping fee resolution. Jessica Toasty requested Marathon County waive all fees for six months, noting that the state, DNR, and Town of Ringle were all waiving their fees, and emphasized that residents are dealing with insurance deductibles and uncovered expenses. Matt Haybeck spoke on behalf of residents whose homes must be demolished, requesting fee waivers for underinsured homeowners and noting that some insurance adjusters haven't yet arrived. He mentioned approximately 44 homes were affected.",
    actionItems: [
      "Reduced landfill tipping fees to $36.94 per ton for certified disaster-related debris through June 17, 2025",
      "Administrator Leonard to continue discussions with Community Foundation about potential reimbursement mechanism for unreimbursed disposal costs",
      "Solid waste department to develop clear long-term policy on handling similar disaster situations within six months",
      "Supervisors Hapa and Arstead appointed to Executive Committee at-large positions",
  ...
  },
  {
    ...
    isAgendaOnly: false,
    badge: "new",
    overview: "The Marathon County Environmental Resources Committee approved two rezoning petitions unanimously and voted to forward a modified fee waiver proposal for tornado-damaged properties to the full county board. The committee amended the fee waiver resolution to only cover septic system reconnect fees rather than the broader waiver originally proposed by staff.",
    agenda: [
      ...
      { time:"2:00", item:"Public hearing: Tim Veland rezoning petition (urban residential\/general agriculture to rural residential) - Town of Green Valley" },
      ...
      { time:"20:00", item:"Consideration of fee waiver modification for properties impacted by April 17, 2026 severe weather" },
      { time:"55:02", item:"Introduction and background regarding departments appearing before the committee" },
      { time:"57:30", item:"Solid Waste Department overview presentation" },
      { time:"1:20:00", item:"Parks, Recreation, and Forestry Department overview presentation" },
      { time:"1:35:02", item:"Conservation, Planning, and Zoning Department overview presentation" },
    ],
    discussions: [
      ...
      { item:"Tim Veland rezoning petition - Town of Green Valley", body:"Land Use Specialist Garrett Pogle presented the staff report for rezoning from urban residential and general agriculture to rural residential for a land division. The Town of Green Valley recommended approval on March 10, 2026. No public comment was offered. Supervisor Drebeck moved to approve based on findings of fact, conclusions of law, and town approval, seconded by Supervisor Kurt. Motion carried unanimously." },
      { item:"Jeffrey and Cynthia Schmidtz rezoning petition - Town of McMillan", body:"The petition sought to rezone from Conservancy Recreation to General Agriculture. Supervisor Lever asked about the conservancy nature of the property. Garrett Pogle explained the property contains a home and horse riding stable, and the rezone would make currently non-conforming uses conforming. He confirmed no natural areas would be lost. The Town of McMillan recommended approval on April 20, 2026. Supervisor Sefeld moved to approve, seconded by Supervisor Drew. Motion carried unanimously." },
      { item:"Fee waiver for April 17, 2026 severe weather impacted properties", body:"Director Lori Mskimmons presented a proposal to waive county zoning and septic fees for properties damaged by the tornado affecting Towns of Ringle, Eastston, and villages of Kronenwetter and Weston. Supervisor Drew questioned where to draw the line on future disasters. Supervisor Drebeck expressed concern about fairness to those not in declared disaster areas. Marilyn Bend asked about mound system costs. After discussion, Supervisor Sefeld moved to forward the resolution. Supervisor Drebeck then amended the motion to only waive reconnect fees ($160) for pouts systems, not other fees. The amendment passed, and the amended resolution was approved to forward to the county board, though the vote was not unanimous." },
      { item:"Solid Waste Department overview", body:"Director David Hagenbusher presented a comprehensive overview of solid waste operations, including the landfill's 45-year history, the new renewable natural gas partnership with Vidi Energy that began injecting gas in September 2025, and upcoming leachate treatment requirements by 2032. He noted April hauling costs were nearly $90,000 due to significant rainfall and discussed the $6 million expansion project starting this year." },
      { item:"Parks, Recreation, and Forestry Department overview", body:"Tom Lovelin, County Forest Administrator, presented on behalf of Director Jamie who had an emergency. He discussed the department serving both city and county with 44 full-time and 120 seasonal employees, the 17 county parks, and 30,700-acre county forest system. A Nine Mile County Forest study showed out-of-town visitors generate $3.25 million for the local economy. Supervisor Sefeld announced that Tom Lovelin is retiring June 1st after nearly 30 years, with Joe Tucker selected as successor." },
    ],
    publicComment: "No public comment was offered. The chair noted no one had signed up for public comment.",
    actionItems: [
      "Rezoning petition for James Offer and David Tract approved - forwarded to Marathon County Board of Supervisors",
      "Rezoning petition for Jeffrey and Cynthia Schmidtz approved - forwarded to Marathon County Board of Supervisors",
      "Modified fee waiver resolution (covering only pouts reconnect fees for tornado-damaged properties) forwarded to county board for consideration",
      "Town of Green Valley recommended to update comprehensive plan to reflect zoning change if applicable",
      "Town of McMillan recommended to update comprehensive plan to reflect zoning change if applicable",
    ],
  },
  {
