...
const MEETINGS = [
  {
    ...
    isAgendaOnly: true,
    badge: "new",
    overview: "Based on the published agenda, the Village of Weston Board of Trustees was scheduled to meet on March 23, 2026 to consider multiple rezoning ordinances, approve a subdivision final plat, discuss an upcoming April referendum, and address numerous public works and parks matters including street maintenance, utility projects, and park fees.",
    agenda: [
    ...
    discussions: [
      { item:"Ordinance No. 26-004: Rezoning 8905 Birch Street", body:"The Board was scheduled to consider rezoning a portion of 8905 Birch Street from Rural Residential-5 Acre to Single Family Residential-Small Lot zoning district. This change was expected to allow for higher-density residential development on the property." },
      { item:"Ordinance No. 26-005: Rezoning 7105 Christiansen Avenue", body:"The Board was set to review a rezoning request to change a portion of 7105 Christiansen Avenue from Single Family Residential-Large Lot to Single Family Residential-Small Lot. This ordinance was expected to permit smaller lot sizes for residential development." },
      { item:"Ordinance No. 26-006: Speed Limits Amendment", body:"The Board was scheduled to consider amendments to Chapter 82.600 of the Municipal Code regarding speed limits. The specific street locations and proposed speed changes were expected to be detailed in the ordinance." },
      { item:"Resolution No. 2026-008: Hinner Springs Second Addition Subdivision", body:"The Board was expected to consider approval of the final plat for Hinner Springs Second Addition Subdivision. This resolution would allow the subdivision development to proceed if approved." },
      { item:"April 2026 Referendum Informational Sessions Update", body:"The Board was scheduled to discuss the status of informational sessions planned for an upcoming April 2026 referendum. This item was listed for discussion only with no action expected." },
      { item:"E-Bicycle and E-Moto Ordinance", body:"The Board was set to discuss a proposed ordinance regarding e-bicycles and e-motos, with dialogue expected to be referred to the Community Life and Public Safety Committee for further review." },
      { item:"No Parking Restrictions Removal", body:"The Board was expected to consider removing no parking restrictions on Alta Verde Street south of Jelinek Avenue and on Alderson Street along Kennedy Park. This change could affect parking availability for park users." },
      { item:"2026 Annual Street Maintenance Plan and Budget", body:"The Board was scheduled to review and potentially act on the 2026 annual street maintenance plan and associated budget. This item was expected to outline the village's roadway maintenance priorities for the year." },
      { item:"Military Road Utility Engineering Services Contract", body:"The Board was set to consider a contract for engineering services related to Military Road utility work. The scope of the utility project was expected to be detailed in the contract." },
      { item:"Well 2 Rehabilitation", body:"The Board was scheduled to discuss and potentially approve rehabilitation work for Well 2. This infrastructure project was expected to address maintenance or upgrade needs for the village's water supply system." },
      { item:"Park Shelter Fees and Field Rental Costs", body:"The Board was expected to review and potentially adjust fees for park shelter rentals and field usage. This item could affect costs for residents and organizations using village park facilities." },
    ],
    publicComment: "Public comment was on the agenda, allowing up to three minutes per person for non-agenda items at the discretion of the Chief Presiding Officer.",
    actionItems: [
  ...
  },
  {
    ...
    isAgendaOnly: true,
    badge: "new",
    overview: "Based on the published agenda, the Village of Weston Board of Trustees was scheduled to meet on March 23, 2026, to consider multiple rezoning ordinances, approve a subdivision final plat, and address numerous infrastructure and operational matters including street maintenance planning, utility projects, and park-related policies. The meeting also included an update on April 2026 referendum informational sessions and potential action on e-bicycle regulations.",
    agenda: [
      { time:"N\/A", item:"Approval of February 16, 2026, Board of Trustees Meeting" },
      { time:"N\/A", item:"Acknowledge Reports\/Minutes from Boards, Committees, Commissions" },
      { time:"N\/A", item:"Acknowledge Reports from Departments" },
    ...
    discussions: [
      { item:"Ordinance No. 26-004: Rezoning of 8905 Birch Street", body:"The Board was scheduled to consider rezoning a portion of property at 8905 Birch Street from Rural Residential-5 Acre (RR-5) to Single Family Residential-Small Lot (SF-S). This rezoning was expected to enable higher-density residential development on the property." },
      { item:"Ordinance No. 26-005: Rezoning of 7105 Christiansen Avenue", body:"The Board was set to review a rezoning request for a portion of 7105 Christiansen Avenue from Single Family Residential-Large Lot (SF-L) to Single Family Residential-Small Lot (SF-S). This change was expected to allow for smaller lot residential development." },
      { item:"Ordinance No. 26-006: Speed Limits Amendment", body:"The Board was scheduled to consider amendments to Chapter 82.600 of the Municipal Code regarding speed limits. The specific streets and speed limit changes were to be addressed during the meeting." },
      { item:"Resolution No. 2026-008: Hinner Springs Second Addition Subdivision Final Plat", body:"The Board was expected to consider approval of the final plat for the Hinner Springs Second Addition Subdivision. This action would represent the final step in the subdivision approval process for this development." },
      { item:"April 2026 Referendum Informational Sessions Update", body:"The Board was scheduled to receive a discussion-only update on informational sessions planned for an April 2026 referendum. This item was expected to address community outreach efforts regarding the upcoming ballot measure." },
      { item:"E-Bicycle and E-Moto Ordinance Dialogue", body:"The Board was set to discuss the development of regulations for electric bicycles and electric mopeds, with the matter being referred to the Community Life and Public Safety Committee. This reflects growing concerns about regulating these vehicles in the community." },
      { item:"2026 Annual Street Maintenance Plan and Budget", body:"The Board was scheduled to review and potentially take action on the village's comprehensive street maintenance plan and associated budget for 2026. This planning document was expected to guide road repair and maintenance priorities for the year." },
      { item:"Military Road Utility Engineering Services Contract", body:"The Board was expected to consider a contract for engineering services related to utilities on Military Road. This infrastructure project was set to address utility needs in that corridor." },
      { item:"Well 2 Rehabilitation", body:"The Board was scheduled to discuss and potentially take action on rehabilitation work for the village's Well 2 water supply facility. This maintenance project was expected to ensure continued reliable water service." },
      { item:"Park Shelter Fees and Field Rental Costs", body:"The Board was set to review park shelter fees and field rental costs for village facilities. This discussion was expected to address pricing for public use of recreational amenities." },
      { item:"Baseball\/Softball Field Maintenance and User Agreement", body:"The Board was scheduled to consider a maintenance and user agreement for baseball and softball fields. This agreement was expected to outline responsibilities and terms for field use and upkeep." },
    ],
    publicComment: "Public comment was scheduled on the agenda, allowing persons to address the Board for up to three minutes regarding non-agenda items, with time extensions at the Chief Presiding Officer's discretion.",
    actionItems: [
      ...
      "Expected to consider Military Road Utility Engineering Services Contract",
      "Expected to consider Well 2 Rehabilitation project",
      "Expected to consider parking restriction removals on Alta Verde St and Alderson Street",
      "Expected to consider park fee and rental cost changes",
    ],
  },
  {
    ...
    discussions: [
      { item:"March 10, 2026 Regular Board of Public Work Minutes", body:"The minutes from the March 10, 2026 meeting were approved. Specific vote count not recorded." },
      { item:"2026 Street Construction Project 'B' - North 8th Avenue", body:"The board approved awarding the contract to Switlick & Sons, Inc. in the amount of $1,279,989.75. The motion passed; specific vote count not recorded." },
      { item:"2026 Asphalt Paving Project 'A'", body:"The bid recommendation for this project failed. The motion did not pass; specific vote count and reason for failure not recorded." },
      { item:"2025 Street Construction Project 'A' - Change Orders", body:"The board approved Change Order #1 in the amount of $14,436.50. The vote passed; Change Order #2 outcome not separately recorded." },
      { item:"2025 Street Construction Project 'A' - Pay Estimate #9", body:"Pay Estimate #9 in the amount of $535,011.42 for Haas Sons, Inc. was approved. The motion passed; specific vote count not recorded." },
      { item:"Portland Cement Concrete License: KSK, Inc.", body:"The board approved the Portland Cement Concrete License for KSK, Inc. The motion passed; specific vote count not recorded." },
    ],
    ...
    actionItems: [
      ...
      "2026 Asphalt Paving Project 'A' bid recommendation denied - may require rebidding or further review",
      ...
      "Portland Cement Concrete License granted to KSK, Inc.",
    ],
    civicItems: [
  ...
  },
  {
    ...
    discussions: [
      { item:"Election of a Vice Chair", body:"The election of a Vice Chair was on the agenda. The outcome of this item is not recorded in the vote records." },
      ...
      { item:"Public Hearing: Conditional Use Permit for 218 South 4th Street (Dunwoody Storage)", body:"A public hearing was held regarding a conditional use permit for Dunwoody Storage to construct a personal storage facility at 218 South 4th Street in the Light Industrial zoning district. No action vote was recorded for this public hearing item." },
      { item:"Conditional Use Permit for 731 N 1st Street (Beacon Resources, LLC)", body:"The conditional use permit for Beacon Resources, LLC to construct a 70-unit, 7-story apartment building at 731 N 1st Street was approved. Specific vote count and mover\/seconder not recorded in the vote records." },
      { item:"Transportation Project Plat for Grand Avenue Signal Replacements", body:"The Transportation Project Plat for Project 370-40-40, covering Grand Avenue signal replacements at Sturgeon Eddy Road and Townline Road, was approved. Specific vote count and mover\/seconder not recorded in the vote records." },
    ],
  ...
  },
  {
    ...
    isAgendaOnly: false,
    badge: "new",
    overview: "The Wausau Board of Public Works awarded the 2026 Asphalt Paving Project 'A' contract to RC Pavers, LLC for $824,146.34. The board conducted one substantive item of business before adjourning with a 2-0 vote.",
    agenda: [
      { time:"N\/A", item:"Open bids and make recommendation for 2026 Asphalt Paving Project 'A'" },
    ],
    discussions: [
      { item:"2026 Asphalt Paving Project 'A' Contract Award", body:"The board opened bids and voted to award the contract for the 2026 Asphalt Paving Project 'A' to RC Pavers, LLC in the amount of $824,146.34. The motion passed. Adjournment was moved by Vincent Bonino and seconded by Eric Lindman, passing 2-0." },
    ],
    publicComment: "Not indicated on agenda.",
    actionItems: [
  ...
  },
  {
    ...
    isAgendaOnly: false,
    badge: "new",
    overview: "The Public Health and Safety Committee approved all action items including license applications, a solid waste disposal code overhaul, repeal of the hand-held mobile device driving ordinance, and a solar energy partnership with MREA. The committee also received discussion items including the Fire Department's 2025 annual report and tavern activities.",
    agenda: [
    ...
    discussions: [
      { item:"Approval or denial of various license applications", body:"The committee passed two separate motions on license applications. A parklet permit was approved, and licenses were approved as indicated by staff with the exception of Theodore Davis. Specific vote counts were not recorded." },
      { item:"Repealing and recreating Wausau Municipal Code Chapter 6.44 Solid Waste Disposal", body:"The committee approved the new solid waste disposal provision, replacing the existing Chapter 6.44 of the Municipal Code. The motion passed without recorded opposition." },
      { item:"Repealing Wausau Municipal Code Section 10.01.012 Use of Hand-Held Mobile Telephones and Mobile Electronic Devices While Driving Prohibited", body:"The committee voted to repeal the city's hand-held mobile device driving prohibition ordinance. The motion passed without recorded opposition." },
      { item:"Approving Memorandum of Understanding with MREA for Grow Solar Central Wisconsin Group Buy Program", body:"The committee approved the MOU partnering with the Midwest Renewable Energy Association for the solar group buy program. The motion passed without recorded opposition." },
    ...
    actionItems: [
      "License applications approved as indicated by staff except for Theodore Davis",
      "Parklet permit approved",
      "New Solid Waste Disposal code (Chapter 6.44) to move forward for adoption",
      "Hand-held mobile device driving ordinance (Section 10.01.012) to be repealed",
      "MOU with MREA for Grow Solar Central Wisconsin Group Buy Program approved",
    ],
    civicItems: [
  ...
  },
  {
    ...
    isAgendaOnly: false,
    badge: "new",
    overview: "The Finance Committee denied a claim for recovery of unlawful tax for Green Acres at Greenwood Hills LLC and postponed several items including the National Opioid Settlement Agreement and a lead service line replacement budget amendment. The committee approved multiple airport ground lease transactions and a 2026 General Obligation Promissory Note for capital improvements.",
    agenda: [
    ...
    discussions: [
      { item:"Approval of Minutes", body:"The minutes from the March 10, 2026 Regular Finance Committee Meeting were approved 4-0. Sarah Watson moved and Aaron Griner seconded the motion." },
      { item:"Approving Alleged Claim for Recovery of Unlawful Tax for Green Acres at Greenwood Hills, LLC - Outlot 1", body:"The motion to approve the claim for recovery of unlawful tax failed. Specific vote count was not recorded in the official records." },
      ...
      { item:"Budget amendment for Wausau Water Works Lead Service Line Replacement project", body:"The committee voted to postpone consideration of this budget amendment to the next meeting. The motion to postpone passed." },
      ...
      { item:"Review of 2025 Motor Pool Fund financial results and related budget amendment", body:"This item was on the agenda for review. No specific vote action was recorded for this item." },
      { item:"Approving 2026 General Obligation Promissory Note for Capital Improvements", body:"The committee approved moving the 2026 General Obligation Promissory Note for Capital Improvements to the calendar. The motion passed." },
      ...
      { item:"Purchasing properties for Department of Public Works Streets Division", body:"The committee voted to postpone consideration of purchasing properties at 108 Adolph Street, 112 Adolph Street, 112-1\/2 Adolph Street and 233 Myron Street until the next meeting. The motion to postpone passed." },
    ],
    ...
    actionItems: [
      ...
      "Airport ground lease with Wynn O. Jones at 939 Woods Place terminated",
      "New airport ground leases approved for Owen Jones at 939 Woods Place and Cole Lundberg",
      "Transfer of title to buildings at 939 Woods Place approved",
  ...
  },
  {
    ...
    isAgendaOnly: false,
    badge: "new",
    overview: "The Wausau Common Council approved all items on the agenda, including a new residential solid waste and recycling agreement with Harter's Fox Valley Disposal LLC, a development agreement for Waterside Place at 11 Scott Street, and a budget modification allowing the Police Department to use proceeds from selling a Thompson sub-machinegun to purchase red-dot optics. The council also suspended procedural rules (7-2) to consider late-filed items including solid waste disposal code changes and personnel premium differentials.",
    agenda: [
      ...
      { time:"N\/A", item:"Resolution Adopting 2026 Budget Modification for Police Department Thompson Sub-Machinegun Sale Proceeds" },
    ...
    discussions: [
      { item:"March 10, 2026 Regular Common Council Minutes", body:"Approved 9-0. Motion by Sarah Watson, seconded by Vicki Tierney. All council members present voted in favor." },
      { item:"Consent Agenda - Parks Ordinance and Parking Lot Lease", body:"Approved 9-0. Motion by Sarah Watson, seconded by Chad Henke. The consent agenda included an ordinance amending Section 9.20.070 regarding fires, fireworks, firearms, and missiles, plus renewal of the parking lot lease with Colonial Property 4, LLC for Grant and 3rd Streets." },
      { item:"Mayoral Appointments Confirmation", body:"Approved by the council. The appointments confirmed were to the Plan Commission, Affordable Housing Task Force, and Business Improvement District Board." },
      { item:"Residential Solid Waste and Recycling Service Agreement", body:"Approved by the council. The resolution authorizes a service agreement with Harter's Fox Valley Disposal LLC for residential solid waste and recycling collection." },
      { item:"Airspace Obstruction Removal Agreements", body:"Both resolutions approved. The agreements with Schofield Ridgeland Legacy LLC (724 and 732 Ridgeland Avenue) and Zachary Lange (811 Ridgeland Avenue) include related budget modifications for obstruction removal near the airport." },
      { item:"Police Department Budget Modification for Red-Dot Optics", body:"Approved by the council. The 2026 budget modification allows the Wausau Police Department to use proceeds from the sale of a Thompson sub-machinegun to purchase red-dot optics equipment." },
      { item:"Waterside Place Development Agreement", body:"Approved by the council. The joint resolution from Economic Development and Infrastructure & Facilities committees approves a development agreement and amended parking agreement with 11 Scott Street, LLC for the Waterside Place project." },
      { item:"Suspension of Procedural Rules", body:"Approved 7-2. Motion by Lisa Rasmussen, seconded by Sarah Watson. Terry Kilian and Vicki Tierney voted no. The suspension allowed consideration of late-filed items including solid waste code changes and personnel resolutions." },
      { item:"Solid Waste Disposal Code Overhaul", body:"Approved by the council. The ordinance from Public Health & Safety Committee repeals and recreates Wausau Municipal Code Chapter 6.44 governing solid waste disposal." },
      { item:"David Hoelzel Settlement Release", body:"Approved by the council. The resolution authorizes release of all claims for property damage settlement in the counterclaim and third party complaint in Marathon County Case No. 25-CV-594." },
      { item:"Police Officer Out of Country Training", body:"Approved by the council. The joint resolution from Human Resources and Finance committees authorizes paid duty time for a Wausau Police Department officer to attend training outside the country." },
      { item:"Shelter Operations Premium Differential", body:"Approved by the council. The joint resolution establishes a duty premium differential for Community Outreach Professional shelter operations." },
    ],
    ...
    actionItems: [
      ...
      "Implement development agreement and parking agreement for Waterside Place at 11 Scott Street",
      "Process budget modification for Police Department red-dot optics purchase from sub-machinegun sale proceeds",
      ...
      "Process settlement release for David Hoelzel litigation",
  ...
  },
  {
    ...
    isAgendaOnly: true,
    badge: "new",
    overview: "The Wausau School District Education\/Operations Committee meeting addressed 4K program partnerships for 2026-2027, reviewed annual safety protocols and drill results, and considered updates to 43 Neola policies. The meeting featured recognition of John Marshall Elementary and focused on district safety improvements including the Standard Response Protocol system.",
    agenda: [
    ...
    discussions: [
      { item:"4K Program Agreement", body:"The district's four-year-old kindergarten program is seeking approval for 2026-2027 program agreements with six community partner sites: Wausau Child Care, Mountain View Montessori, Woodson YMCA Wausau Branch, Newman Catholic Schools, and Marathon County Child Development Agency Head Start Program at Barrington Center. These partnerships have been in place since 2002 and will be presented by the 4K Principal and Director of Elementary Education." },
      { item:"Annual Safety Update \/ Drill Debrief", body:"The district is implementing the I Love U Guys Standard Response Protocol using standardized vocabulary (HOLD, SECURE, LOCKDOWN, EVACUATE, SHELTER) for consistent emergency responses. Safety highlights include secure building entrances, Visitor Aware System, security cameras, locked exterior doors, and recent district-wide LOCKDOWN and EVACUATION drills conducted in partnership with Wausau Police Department and School Resource Officers." },
      { item:"Neola Policies Update", body:"The committee will review proposed changes to 43 policies covering a wide range of topics including board member conduct, employment procedures, student entrance age, third grade promotion and retention, academic honesty, drug policies, drone use, school safety, food service, wellness, and visitor policies. The updates include both substantive Volume 34 Number 2 changes and technical corrections." },
    ],
  ...
  },
  {
    ...
    isAgendaOnly: true,
    badge: "new",
    overview: "This special meeting of the Wausau School District Board of Education focused primarily on closed session matters, including discussions about a real estate purchase or sale and the evaluation of the Superintendent of Schools. The board planned to reconvene in open session to take any necessary action resulting from the closed discussions.",
    agenda: [
      { time:"0:00", item:"Call to Order" },
    ...
    discussions: [
      { item:"Discussion regarding the Competitive Negotiations of a Purchase\/Sale of Real Estate", body:"The board entered closed session to discuss competitive negotiations related to the purchase or sale of real estate, as permitted under Wisconsin State Statute 19.85(1)(e). This statute allows closed sessions when discussing negotiating strategies for real property transactions." },
      { item:"Evaluation of Superintendent of Schools", body:"The board conducted a closed session evaluation of the Superintendent of Schools pursuant to Wisconsin State Statute 19.85(1)(c). This statute permits closed sessions for considering employment, promotion, compensation, or performance evaluation of public employees." },
    ],
  ...
  },
  {
    ...
    discussions: [
      { item:"50% Updates for Elementary Referendum Construction", body:"The Board received updates on referendum-funded improvement plans as designs reach 50% completion. Current plans for John Marshall, Rib Mountain, Franklin Elementaries, and Lincoln Early Learning Academy were shared with the Board." },
      { item:"Red Granite Update", body:"Red Granite Principal Maud Mangin and Governance Board President Amanda Molin shared an update on the status of the Red Granite Charter School. This presentation was estimated to take approximately 5 minutes." },
      { item:"4K Program Agreement", body:"The district's four-year-old kindergarten program sought approval to enter into agreements with community collaboration sites for the 2026-2027 school year. Partner sites include Wausau Child Care, Mountain View Montessori, Woodson YMCA Wausau Branch, Newman Catholic Schools, and Marathon County Child Development Agency Head Start Program." },
      { item:"Annual Safety Update \/ Drill Debrief", body:"At the November Education\/Operations Committee Meeting, Andy Grimm and members of the Wausau Police Department shared the annual safety update. They also provided information about the partnership between the Wausau Police Department and the district, especially with School Resource Officers." },
      { item:"Neola Policies Update", body:"The Board reviewed proposed changes to 43 policies that were presented at the November Education\/Operations Committee meeting. The policies cover a wide range of topics including board member conduct, employment procedures, student policies, school safety, food service, and wellness." },
    ],
  ...
  },
  {
    ...
    isAgendaOnly: true,
    badge: "new",
    overview: "The Audit of the Bills Committee Meeting for the Wausau School District focused on reviewing and approving district expenditures. This routine financial oversight meeting ensures proper accountability for district spending.",
    agenda: [
      { time:"0:00", item:"Call to Order" },
    ...
    discussions: [
      { item:"Audit of the Bills", body:"The committee reviewed the December 2025 bills for the district as documented in the attached audit report dated December 9, 2025. This routine financial review ensures all district expenditures are properly documented and authorized." },
    ],
    publicComment: "No public comment period was included on this agenda.",
    actionItems: [
      "Approval of December 2025 bills as presented in the audit report",
    ],
  },
  {
    ...
    discussions: [
      { item:"Approve Administrator Contracts and Discuss Performance and Employment of a Staff Member", body:"The board will enter closed session under Wisconsin Statute 19.85(1)(c) to discuss administrator contracts and the performance and employment status of staff members. This allows the board to deliberate on personnel matters in private." },
      { item:"Discussion regarding the Competitive Negotiations of a Purchase\/Sale of Real Estate", body:"Under Wisconsin Statute 19.85(1)(e), the board will discuss competitive negotiations related to the purchase or sale of real estate. This closed session protects the district's negotiating position in property transactions." },
      { item:"Resolution of Commendation: Ellie Mason", body:"The board will consider a resolution of commendation recognizing Ellie Mason. An attachment with details of the resolution was included in the board packet dated December 12, 2025." },
    ],
    publicComment: "No public comment period was included on this agenda.",
    actionItems: [
      "Approve Administrator Contracts",
      "Approve Resolution of Commendation for Ellie Mason",
      "Take action on closed session matters if necessary upon reconvening in open session",
    ],
  },
  {
    ...
    isAgendaOnly: true,
    badge: "new",
    overview: "The Wausau School District Education\/Operations Committee meeting addressed open enrollment space determinations for 2026-2027, snow day communication procedures, and athletic co-op renewals for hockey and lacrosse programs. The meeting also featured a performance by John Muir Middle School and highlighted the school through an Excellence in Action presentation, followed by a tour of recent school updates.",
    agenda: [
      { time:"0:00", item:"Call to Order" },
    ...
    discussions: [
      { item:"Open Enrollment Seat Availability", body:"Wendy Cartledge presented the Open Enrollment Space Determinations for the 2026-2027 school year. This determines available seats for students from outside the district who wish to enroll in Wausau schools." },
      ...
      { item:"Approve Co-Ops", body:"Athletic Directors BJ Brandt and Darci Mick Beversdorf presented information on athletic cooperative renewals including boys hockey with East\/Merrill\/Newman Catholic, girls lacrosse with East\/West\/DCE\/Mosinee, and girls STORM hockey with East\/West\/DCE\/Mosinee adding Merrill and Stratford for the 2026-27 and 2027-28 school years." },
    ],
  ...
  },
  {
    ...
    isAgendaOnly: true,
    badge: "new",
    overview: "This special meeting of the Wausau School District Board of Education focused primarily on personnel matters, including routine staff appointments and separations, as well as two closed sessions to address employee termination proceedings and administrator contracts. The meeting's significance lies in the quasi-judicial hearing regarding employee conduct allegations and potential termination.",
    agenda: [
      { time:"0:00", item:"Call to Order" },
  ...
  },
  {
    ...
    isAgendaOnly: true,
    badge: "new",
    overview: "This regular meeting of the Wausau School District Board of Education covers the approval of the 2024-25 audit report, WASB resolutions voting direction, facilities discussion regarding Wausau West chiller replacement, and various cooperative athletics agreements. The board will also address open enrollment seat availability and enter closed session for potential litigation discussion and superintendent evaluation.",
    agenda: [
      { time:"0:00", item:"Call to Order" },
      { time:"0:02", item:"Roll Call" },
    ...
    discussions: [
      ...
      { item:"Wisconsin Investment Series Cooperative Resolution", body:"Assistant Superintendent of Operations Elizabeth Channel is presenting a resolution to allow the District to continue its membership in the Wisconsin Investment Series Cooperative. This updates authorization that is over ten years old in accordance with best practice." },
      { item:"Open Enrollment Seat Availability", body:"Following the December Education\/Operations Committee Meeting, Wendy Cartledge presented the Open Enrollment Space Determinations for the 2026-2027 school year for board approval." },
      { item:"Approve Co-Ops", body:"The board will consider cooperative athletics renewals including boys hockey East\/Merrill Newman Catholic, girls lacrosse East\/West\/DCE\/Mosinee, and girls STORM hockey East\/West\/DCE\/Mosinee with the addition of Merrill and Stratford, all for the 2026-27 and 2027-28 school years." },
    ],
  ...
  },
  {
    ...
    isAgendaOnly: true,
    badge: "new",
    overview: "The Audit of the Bills Committee met to review and approve the district's financial expenditures for January 2026. This routine financial oversight meeting ensures proper review of school district payments and expenses.",
    agenda: [
      { time:"0:00", item:"Call to Order" },
      { time:"0:02", item:"Audit of the Bills" },
      { time:"0:07", item:"Adjourn" },
    ...
    discussions: [
      { item:"Audit of the Bills", body:"Committee members reviewed the January 26, 2026 audit of bills document, which details the district's financial expenditures requiring approval. The attachment was prepared on January 22, 2026 and includes itemized bills for committee review and verification." },
    ],
    publicComment: "No public comment period was included on this agenda.",
    actionItems: [
      "Review and approve the January 26, 2026 audit of bills",
    ],
  },
  {
    ...
    isAgendaOnly: true,
    badge: "new",
    overview: "The Wausau School District Education\/Operations Committee meeting focused on advancing referendum-related school construction projects, with four elementary schools reaching 95% design completion ready for bid solicitation. The meeting also addressed financial planning, student demographics, and potential governance restructuring.",
    agenda: [
      { time:"0:00", item:"Call to Order" },
      { time:"0:02", item:"Approve the Minutes" },
    ...
    discussions: [
      ...
      { item:"Presentation of Financial Projection Model Assumptions", body:"Interim Assistant Superintendent Elizabeth Channel shared key variables for the District's multi-year financial projection model. The baseline model uses 2025-2026 budget numbers with percentages and dollar amounts projected forward, with the complete projection to be presented at a future meeting." },
      { item:"2025-2026 Student Demographic Report", body:"Director of Technology Ralph Williams presented the annual Demographics Report for the 2025-2026 school year, providing data on student population characteristics across the district." },
      { item:"Governance Model Option", body:"The Board continued discussion about potentially restructuring the Audit of the Bills Committee and clarifying the purpose of the Education\/Operations Committee, including a potential renaming of the meeting." },
    ],
    publicComment: "A public and student comment period was included on the agenda.",
    actionItems: [
      "Approve minutes from December 15, 2025 meeting",
      "Approve 95% design plans for Franklin, Rib Mountain, Lincoln & John Marshall Elementary schools for bid solicitation",
      "Approve 2026-2027 District Calendar",
      "Consider governance model changes regarding committee structure",
    ],
  },
  {
    ...
    isAgendaOnly: true,
    badge: "new",
    overview: "This special meeting of the Wausau School District Board of Education focused on personnel matters, approval of the 2026-2027 district calendar, and a closed session to evaluate the Superintendent of Schools. The meeting addressed routine staffing changes and finalized the academic calendar for the upcoming school year.",
    agenda: [
      { time:"0:00", item:"Call to Order" },
      ...
      { time:"0:08", item:"Reconvene in Open Session and Take Action if Necessary" },
      { time:"0:10", item:"Adjourn" },
    ],
    discussions: [
      { item:"Approve 2026-2027 District Calendar", body:"Diana White previously presented a draft of the 2026-2027 school year calendar at a prior meeting for School Board review. The board was asked to give final approval to the calendar at this special meeting." },
    ],
    publicComment: "No public comment period was included on this agenda.",
    actionItems: [
      "Approve Consent Agenda including appointments, separations, leaves of absence, and retirements",
      "Approve 2026-2027 District Calendar",
      "Conduct closed session evaluation of Superintendent of Schools",
      "Take action as a result of closed session if necessary",
    ],
  },
  {
  ...
  },
  {
    ...
    discussions: [
      ...
      { item:"Preliminary Discussion Regarding Potential Litigation", body:"The board entered closed session under Wisconsin State Statute 19.85(g) to discuss preliminary matters regarding potential litigation. This statute allows closed sessions for conferring with legal counsel concerning litigation strategy." },
    ],
    publicComment: "No public comment period was included on this agenda.",
    actionItems: [
      "Approve Consent Agenda including appointments, separations, leaves of absence, and retirements",
  ...
  },
  {
    ...
    isAgendaOnly: true,
    badge: "new",
    overview: "The Wausau School District Board of Education Committee of the Whole meeting covered financial planning with a five-year fiscal forecast, mid-year academic progress reports for AGR schools, and a comprehensive review of over 60 district policies requiring updates. The meeting also included recognition segments for the district planetarium and Wausau West High School, with a facility tour scheduled following adjournment.",
    agenda: [
      { time:"0:00", item:"Call to Order" },
      { time:"0:02", item:"Approve the Minutes" },
    ...
    discussions: [
      { item:"Five Year Fiscal Forecast", body:"The Board was presented with a five-year fiscal forecast model for the District to aid in constructing the 2026-27 budget reconciliation plan. Administration noted that projections result from many variables that change periodically, and significant changes will be communicated to the Board as they occur." },
      { item:"AGR Annual Report", body:"This presentation provided the Board with mid-year AGR student outcome scores required by DPI, including screening results. The report featured work being done in each of the three AGR schools to strengthen organizational systems and demonstrate how practices are evolving to improve student achievement." },
      { item:"NEOLA UPDATE", body:"The Committee reviewed proposed changes to numerous district policies, ranging from minor technical corrections to more substantial revisions. Policy updates covered areas including board member conduct, student supervision, academic honesty, cell phones, homeless students, third grade promotion, purchasing, and school support organizations." },
      { item:"Referendum Budget Update", body:"As the April 2022 referendum funded facility improvements continue to develop, construction and budget updates are routinely presented. This update provided current status on ongoing projects until completion." },
    ],
    publicComment: "A Public and Student Comment period was included on the agenda.",
    actionItems: [
      "Approve the Minutes from January 26, 2026 Ed.Ops meeting",
      "Approve Audit of the Bills for February 2026",
      "Approve NEOLA policy updates including 60+ policies covering definitions, board member conduct, student supervision, reading instruction, athletics, cell phones, homeless students, third grade promotion, purchasing, fund balance, and school support organizations",
    ],
  },
  {
    ...
    isAgendaOnly: true,
    badge: "new",
    overview: "This special meeting of the Wausau School District Board of Education was convened to conduct a pupil expulsion hearing in closed session. The Board was authorized to deliberate privately and take action as necessary regarding the student disciplinary matter.",
    agenda: [
      { time:"0:00", item:"Call To Order" },
    ...
    discussions: [
      { item:"Closed Session - Pupil Expulsion Hearing", body:"The Board convened in closed session to conduct a pupil expulsion hearing under Wisconsin Statutes provisions protecting student privacy. The Board was authorized to deliberate privately at the conclusion of the hearing and take action in closed session if necessary. Following the closed session, the Board could reconvene in open session to take further action if appropriate." },
    ],
    publicComment: "No public comment period was included on this agenda.",
    actionItems: [
  ...
  },
  {
    ...
    isAgendaOnly: true,
    badge: "new",
    overview: "This special public meeting brought together members of the Elementary Task Force to reflect on the elementary school consolidation process one year after implementation. The meeting served as a reunion for task force members to share their perspectives on the consolidation outcomes. No official Board action was taken at this meeting.",
    agenda: [
    ...
    discussions: [
      { item:"Summary of Elementary Consolidation", body:"A presentation summarizing the elementary school consolidation process that was implemented in the Wausau School District. This provided context and background for the task force reunion discussion." },
      { item:"Task Force Member Reflectives: One Year Later", body:"Task force members shared their reflections and perspectives on the elementary consolidation one year after its implementation. Members discussed outcomes and observations from the consolidation process." },
    ],
    publicComment: "No public comment period was included on this agenda.",
    actionItems: [
  ...
  },
  {
    ...
    isAgendaOnly: true,
    badge: "new",
    overview: "This meeting was a WEA (Wausau Education Association) sponsored Meet & Greet event for Wausau School District Board of Education candidates. While a quorum of board members may have been present, no official board action was taken during this informal gathering.",
    agenda: [
      { time:"0:00", item:"WEA Sponsored WSD School Board Candidates Meet & Greet Event" },
    ],
    discussions: [
      { item:"WEA Sponsored WSD School Board Candidates Meet & Greet Event", body:"This was an informal event sponsored by the Wausau Education Association where school board candidates could meet with community members. A quorum of current board members may have attended, but the agenda explicitly noted that no board action would be taken." },
    ],
    publicComment: "No public comment period was included on this agenda.",
    actionItems: [
  ...
  },
  {
    ...
    isAgendaOnly: true,
    badge: "new",
    overview: "The Wausau School District Board of Education held a regular meeting covering ongoing referendum-funded facility improvements, a proposal to switch middle school devices from Chromebooks to iPads, and presentations on the district's five-year fiscal forecast and AGR school performance. The meeting included routine consent agenda items including personnel changes, bill payments, and approval of a CESA 9 shared services contract.",
    agenda: [
      { time:"0:00", item:"Call to Order" },
      { time:"0:02", item:"Roll Call" },
      { time:"0:04", item:"Pledge of Allegiance" },
    ...
    discussions: [
      ...
      { item:"Five Year Fiscal Forecast", body:"The Committee was presented with a five-year fiscal forecast model for the District, which will be applied during the next three months to aid in constructing the 2026-27 budget reconciliation plan. Administration noted that projections depend on many variables that change periodically and will bring significant changes to the Board's attention." },
      { item:"AGR Annual Report", body:"The Committee was presented with mid-year AGR student outcome scores required by the DPI. The report featured screening results and the work being done in each of the three AGR schools to strengthen organizational systems and improve student achievement." },
    ],
    publicComment: "A public and student comment period was included on the agenda.",
    actionItems: [
  ...
  },
  {
    ...
    isAgendaOnly: true,
    badge: "new",
    overview: "The Wausau School District Board of Education Committee of the Whole meeting addressed operational matters including nutrition service cooperative membership, facility fee schedules for artificial fields, and a referendum budget update. The meeting featured an extensive policy review session covering over 60 NEOLA policies including new AI guidelines and Act 57 compliance updates.",
    agenda: [
      { time:"0:00", item:"Call to Order" },
      { time:"0:02", item:"Approve the Minutes" },
    ...
    discussions: [
      { item:"Wisconsin School Nutrition Purchasing Cooperative Agreement (WiSNP)", body:"The Nutrition Service Department currently belongs to the WiSNP Co-op and is seeking board approval for continued membership for the 2026-2027 school year. The cooperative is requesting member districts to present the resolution to their respective boards for approval." },
      ...
      { item:"Referendum Budget Update", body:"Elizabeth Channel, Interim Assistant Superintendent of Operations, shared an update on the status of the Referendum Budget. The presentation included a memo summarizing the current budget status." },
      { item:"NEOLA UPDATE", body:"The committee reviewed proposed changes to numerous district policies, ranging from technical corrections to more substantial updates. Key policy areas included board member conduct, reading instruction goals, cell phone use, academic honesty, artificial intelligence guidelines, school support organizations, crowdfunding accountability, and Act 57-related student supervision and child abuse reporting policies." },
    ],
    publicComment: "No public comment period was included on this agenda.",
    actionItems: [
      ...
      "Approve NEOLA policy updates including definitions, board member conduct, reading instruction goals, cell phone policy, AI policy, school support organization policies, and Act 57 compliance policies",
    ],
  },
  {
    id: "D7R7a0G0WTA", source: "weston",
    title: "D7R7a0G0WTA",
    date: "March 29, 2026", shortDate: "MAR 29",
    committee: "Village of Weston Parks and Recreation Committee", duration: "~1h",
    url: "https://www.youtube.com/watch?v=D7R7a0G0WTA",
    docUrl: null,
    isAgendaOnly: false,
    badge: "new",
    overview: "The Village of Weston Parks and Recreation Committee approved minutes, selected Rettler Corporation for the Mock Mueller Park master plan, reviewed successful grant funding for the Yellow Banks kayak launch, and discussed park impact fees and ice rink operations. Key decisions included awarding a $20,600 consulting contract and providing feedback supporting moderate increases to park impact fees.",
    agenda: [
      ...
      { time:"26:09", item:"Discussion on RFP for Mock Mueller Park master plan" },
      { time:"31:16", item:"Review of Yellow Banks kayak launch expenses" },
      { time:"36:52", item:"Discussion on ice rink operations at Kennedy Park" },
      { time:"50:18", item:"Future meeting date and topics" },
      { time:"50:38", item:"Staff remarks" },
      { time:"51:13", item:"Committee member remarks and adjournment" },
    ],
    discussions: [
      { item:"Approval of minutes from February 23, 2026", body:"Motion to accept the minutes was made and seconded. The motion passed unanimously with all present voting in favor. Roll call noted Karn was absent and excused; Esker, Clark, and Teacher were present." },
      { item:"Review of parks and recreation impact fee discussion", body:"Jennifer presented information on park impact fees, noting the village currently charges $300 for single family homes while neighboring communities charge $600-$650. A 2020 study supported fees up to $761 for single family units. Committee members expressed support for a moderate increase to be consistent with neighboring communities. Katrina stated she would support the moderate increase bracket rather than maximum. The committee provided feedback for Jennifer to take to the Plan Commission, which will make the final decision along with the village board." },
      { item:"RFP for Mock Mueller Park master plan", body:"Staff reported receiving seven proposals for the park master plan, which were reviewed by four staff members based on firm experience, personnel experience, project understanding, and cost. The two lowest bids were JSD at $20,400 and Rettler Corporation at $20,600. Roger made a motion to select Rettler Corporation, seconded by Katrina. The motion passed unanimously. Staff noted Rettler has done the village's comprehensive outdoor recreation plan and most recent master plans including Kennedy Park." },
      { item:"Review of Yellow Banks kayak launch expenses", body:"Jessica's report showed the kayak launch project received significant grant funding from DNR and Marathon County Transportation, with the county covering the full expense for the ADA-accessible dock. Total project costs included unforeseen expenses like poor subgrade and an unknown well casing. Lisa Beck praised the RFC as well-written. Committee member Katrina thanked Jessica and Dan Higginbotham for their grant writing work, calling it a huge success where out-of-pocket costs were significantly decreased through grants." },
      { item:"Discussion on ice rink operations at Kennedy Park", body:"Staff presented information on Kennedy Park ice rink operations. The warming house has been unattended since 2020 due to COVID and subsequent staffing challenges. Everest Youth Hockey has been in discussions about potential improvements including a covered structure to extend the ice season. Staff noted Kennedy Park has the only full-size outdoor hockey rink in the area. Committee requested additional information including historical attendance figures from 2018-19 seasons and community feedback for the next meeting." },
    ],
    publicComment: "Jim Pinsel spoke expressing frustration about not receiving responses to questions submitted at the February meeting regarding playground equipment installation issues, Kennedy Park fundraising updates, and ice rink costs. He argued the ice rink cost analysis was incomplete, estimating true costs at $20,000-$30,000 when labor hours are included versus the stated $1,320.98. Lisa Beck (1808 Cortez Lane) thanked staff for snow removal work during the recent blizzard and praised the Yellow Banks RFC as well-written. A written response to Jim Benson regarding his previous email was submitted and will be included in the minutes.",
    actionItems: [
      "Rettler Corporation selected for Mock Mueller Park master plan at $20,600",
      ...
      "Quarterly Kennedy Park project update scheduled for April board meeting including Glow Games financial figures",
      "Next Parks and Recreation Committee meeting scheduled for April 27, 2026",
    ],
  },
  {
