...
const MEETINGS = [
  {
    ...
    date: "May 25, 2026", shortDate: "MAY 25",
    committee: "Public Works", duration: "~1h",
    url: "https://www.youtube.com/watch?v=j64Gj2ean2k",
    docUrl: null,
    isAgendaOnly: false,
    badge: "new",
    overview: "The Village of Weston Public Works Committee approved several items including awarding a recycled asphalt crushing contract to King Gravel for $126,900, directing staff to create enforcement language for sewer discharge violations with fines up to $100\/day, and recommending approval of construction agreements for Military Road and two local street projects. The committee also acknowledged grant funding success with over $9 million received in the past 4-5 years.",
    agenda: [
      { time:"0:09", item:"Call to order" },
      { time:"0:22", item:"Pledge of Allegiance" },
      { time:"0:52", item:"Roll call" },
      { time:"1:10", item:"Public comment" },
      { time:"1:18", item:"Approval of April 13, 2026 meeting minutes" },
      { time:"1:35", item:"Acknowledge April 2026 water and sewer permits" },
      { time:"1:52", item:"CIP update" },
      { time:"18:22", item:"Street operation update" },
      { time:"29:08", item:"Utility operating update" },
      { time:"44:20", item:"Review 2025 Water Utility PSC annual report" },
      { time:"49:15", item:"Resolution 2026-014 transportation funding" },
      { time:"52:30", item:"Recycled base course production" },
      { time:"56:00", item:"Sanitary sewer discharge violation discussion" },
      { time:"1:11:45", item:"Water and sewer connection agreement for Radkey Avenue" },
      { time:"1:18:30", item:"Military Road construction agreement" },
    ],
    discussions: [
      { item:"CIP Update", body:"Michael reported the village received a Local Road Improvement Grant for Birch Street reconstruction between Scofield Avenue and Community Center Drive, originally a 2029 project that will likely move to 2028. The grant covers over 50% of the estimated $1.5 million cost. Michael noted the village has received over $9 million in grant funding over the past 4-5 years. Discussion also covered Weston Avenue repairs by Integrity Grading and Excavating for pavement settling over sanitary sewer trenches, and upcoming repairs on Scofield Avenue and Fuller Street for manhole adjustments and concrete work." },
      { item:"Street Operation Update", body:"Staff reported on spring activities including removal of road limits, mailbox and sign repairs, curb line sweeping, and hot mix patching. Flooding issues required dewatering pumps near Weston Avenue for about a week to protect Crane Meadows area. Committee discussed need for permanent pump solutions. Culverts failed on Jones Street requiring installation of a third 18-inch pipe. Shop repairs included transitioning plow trucks to summer use and servicing mowing equipment. A new tandem axle chassis has been ordered with upfitter items being coordinated through Scott's Repair." },
      { item:"Utility Operating Update", body:"Josh reported on water service repairs, well maintenance, and ongoing lift station issues. Significant clear water infiltration was identified - in April, 37 million gallons of water entered the system but 53-54 million gallons were treated, indicating approximately 15 million gallons of clear water infiltration. Staff identified homeowners with sump pumps illegally connected to sanitary sewers on smaller lift stations like Kathleen. The INI study by In-Pipe Technologies will help identify problem areas once dry weather arrives." },
      { item:"2025 Water Utility PSC Annual Report", body:"Michael presented the annual report showing net operating income of $482,911 for 2025, consistent with 2024's $490,000. Water loss was 6%. Utility value increased to nearly $34 million with $6.7 million in infrastructure placed in service. The utility has approximately 6,100 customers total. PAS settlement funds of $1.44 million were received for future treatment costs. Motion to acknowledge passed unanimously." },
      { item:"Resolution 2026-014 Transportation Funding", body:"Michael explained this League of Wisconsin Municipalities sample resolution supports long-term transportation funding solutions. He noted grant funding helps one-time costs but recurring operational funding is inadequate, requiring general tax subsidies. Wisconsin remains affordable compared to neighboring states for automobile ownership. Motion to recommend village board adoption passed unanimously." },
      { item:"Recycled Base Course Production", body:"Michael presented the contract for crushing recycled concrete and asphalt at the Ryan Street site. King Gravel was low bidder at $4.23\/ton for an estimated 30,000 tons totaling $126,900. Analysis showed the village saves approximately $11\/cubic yard compared to City of Wausau costs, representing about $130,000 savings across this year's three projects. Motion to award to King Gravel passed unanimously." },
      { item:"Sanitary Sewer Discharge Violation Discussion", body:"Committee discussed enforcement of sewer ordinance violations for illegal sump pump connections. Current code allows fines of $100-$1,000 per day. Committee member Mumper distinguished between unknowing and willful violations. Committee directed staff to create enforcement language starting at $100\/day for first offenses, with the understanding that repeat offenders would face escalating penalties. Staff will also include notices in monthly bills and newsletters. Motion passed unanimously." },
      { item:"Radkey Avenue Water\/Sewer Connection Agreement", body:"Michael explained a duplex builder needs temporary water and sewer connection via long lateral through Outlot 1 until Radkey Avenue reconstruction. Committee added language requiring reconstruction and assessment payment no later than 2029. Motion to recommend approval with the timeline addition passed unanimously." },
      { item:"Military Road Construction Agreement", body:"Agreement with Village of Rothschild for Military Road reconstruction from Wolfman Street to Helin Street. Weston's utility costs are $94,860 ($6,156 sanitary sewer, $88,704 water main). Water main must be relocated due to storm sewer conflicts. Steam Construction is the contractor. Motion to recommend approval passed unanimously." },
      { item:"Construction Services Proposals", body:"Due to vacant engineering tech position, Michael sought proposals for construction inspection services. For Alderson\/Jelnik roundabout project, MSA was selected at $37,315 over Clark Dietz's $48,910. For Bladel Avenue, Clark Dietz was recommended at $73,730 over MSA's $70,400 because MSA proposed using a summer intern while Clark Dietz offered full-time experienced staff. Motion to recommend both selections passed unanimously." },
    ],
    ...
    actionItems: [
      ...
      "Staff to create enforcement language for sanitary sewer discharge violations with fines starting at $100\/day",
      "Recommend village board approve Radkey Avenue temporary utility connection agreement with reconstruction deadline of 2029",
      "Recommend village board approve Military Road construction agreement with Rothschild for estimated $94,860",
      "Recommend MSA for Alderson\/Jelnik roundabout construction services ($37,315) and Clark Dietz for Bladel Avenue project ($73,730)",
      "Staff to look into street lighting for Scofield Avenue from Birch Street to Camp Phillips Road as part of future CIP",
      "Norcon to begin concrete repairs on Scofield Avenue eastbound lanes starting Wednesday\/Thursday",
  ...
  },
  {
    ...
    isAgendaOnly: false,
    badge: "new",
    overview: "The Village of Weston Plan Commission approved the site plan for the new Mountain Bay Metropolitan Police Department and Municipal Court facility at 3600 Community Center Drive, and adopted a new salt storage shed inspection program for wellhead protection areas. Both items passed unanimously with all commissioners present voting in favor.",
    agenda: [
      { time:"0:01", item:"Call to order and roll call" },
      { time:"1:23", item:"Open public comment period" },
      { time:"4:28", item:"Breath and communication disclosure and recusal" },
      { time:"4:45", item:"Approval of April 13, 2026 meeting minutes" },
      ...
      { time:"19:00", item:"Unfinished business - Creation of salt storage shed inspection program for wellhead protection district" },
      { time:"28:10", item:"April 2026 staff approved certified survey maps and site plans" },
      { time:"28:25", item:"April 2026 building permits" },
      { time:"28:40", item:"Planning and development department monthly project update report" },
      { time:"30:30", item:"Commissioner remarks" },
      { time:"31:15", item:"Future agenda items" },
      { time:"34:40", item:"Adjournment" },
    ],
    discussions: [
      { item:"Site plan review - Mountain Bay Metro Police Department and Municipal Court facility", body:"Staff presented the site plan for the new police department and municipal court at 3600 Community Center Drive. The building orientation was changed to face east due to a gas pipeline running under the parking lot area. Chief Jeremy explained the building has capacity for 50-60 officers (up from current 40) for future growth. An alternate storage shed is proposed but may be added later depending on bid costs. Commissioner Jordan asked about future expandability, which would be possible to the north or south. Discussion included ensuring the shed placement doesn't impede future expansion. Motion to approve passed unanimously with conditions 2-5 as listed by staff." },
      { item:"Salt storage shed inspection program for wellhead protection district", body:"Jennifer presented the proposed inspection program requiring two annual inspections per facility - one in warm weather focusing on structural integrity and one in winter focusing on operations. A standardized inspection worksheet similar to DOT standards was developed. Staff identified at least one existing facility near the Sternberg well that predates the wellhead protection ordinance and never went through the conditional use process. Commission agreed staff should reach out to bring them into compliance. Motion to approve the program with reporting back to both Plan Commission and Public Works passed unanimously." },
      { item:"April 2026 meeting minutes", body:"Motion to approve the April 13, 2026 meeting minutes as presented. Passed unanimously without discussion." },
      { item:"April 2026 staff approved certified survey maps and site plans", body:"Approved unanimously without discussion." },
      { item:"April 2026 building permits", body:"Approved unanimously without discussion." },
      { item:"Planning and development department monthly update", body:"Jennifer announced the first meeting of the joint Plan Commission\/Village Board steering committee for the comprehensive plan update is scheduled for Monday, June 1st at 5:00 p.m. Commissioners requested email notification and calendar invites." },
    ],
    publicComment: "Jim Pensson of 5002 Arrow Street, Weston, spoke via remote connection. He asked the commission to exercise common sense regarding landscaping requirements for the police department project, referencing previous relaxed standards for the Greenheck Turner building. He also requested that the salt shed inspection program include annual reporting on site visits and findings, noting some zoning complaints are years old.",
    actionItems: [
      "Site plan for Mountain Bay Metro Police Department and Municipal Court facility at 3600 Community Center Drive approved with staff conditions 2-5",
      "Salt storage shed inspection program adopted for wellhead protection district with two annual inspections per facility",
      "Staff to report inspection findings back to Plan Commission and Public Works committee next year",
      "Staff to reach out to existing salt storage facility near Sternberg well that has not gone through conditional use process",
      "First comprehensive plan steering committee meeting scheduled for Monday, June 1st at 5:00 p.m.",
      "Staff to send email and calendar invite for steering committee meeting",
      "Electric vehicle charging station regulations to be future agenda item in fall",
      "Next regular meeting Monday, June 8th, 2026 at 6:00 p.m.",
    ],
  },
  {
    ...
    isAgendaOnly: false,
    badge: "new",
    overview: "The Marathon County Health & Human Services Committee held an educational orientation meeting for new and returning members, featuring presentations from department heads on the Health Department, Social Services, Veteran Service Office, and Aging Disability Resource Center. No action items were voted on beyond approving April 1st meeting minutes; the meeting focused on familiarizing committee members with departmental missions, budgets, and services.",
    agenda: [
      { time:"0:00", item:"Call to order and remote participation confirmation" },
      { time:"0:30", item:"Pledge of Allegiance" },
      { time:"1:15", item:"Approval of April 1st committee meeting minutes" },
      { time:"2:00", item:"Review of operational functions required by statute" },
      { time:"3:30", item:"Review of standing committee ordinance section 2.04 - missions, duties, responsibilities" },
      { time:"15:03", item:"Health Department overview presentation" },
      { time:"25:04", item:"Health Department budget discussion" },
      { time:"40:00", item:"Social Services Department overview" },
      { time:"50:01", item:"Veteran Service Department overview presentation" },
      { time:"1:15:00", item:"Aging Disability Resource Center (ADRC) overview presentation" },
      { time:"1:30:00", item:"Next meeting date confirmation and adjournment" },
    ],
    discussions: [
      { item:"Approval of April 1st meeting minutes", body:"Supervisor Cavelli made a motion to approve the minutes, seconded by Vice Chair Rosenberg. The motion carried unanimously with all in favor." },
      { item:"Review of standing committee ordinance", body:"Administrator Lance Leonard provided an overview of the committee's jurisdiction under section 2.04 sub 5, explaining reporting relationships with departments (Health, Social Services, Veterans), multi-county entities (North Central Health Care, ADRC), and subordinate boards (Social Services Board, Veteran Service Commission, Board of Health). Chair Boots noted the committee will focus on developing and monitoring the new strategic plan through December." },
      { item:"Health Department overview", body:"Health Officer Caitlyn Suginaka presented the department's mission of preventing disease, promoting health, and protecting from environmental hazards. She highlighted over 1,200 licenses overseen, public health vending machines stocked with free resources including tick kits, the Nurse Family Partnership program graduating its first two-year-olds, and a new homeless system response position funded through the county and City of Wausau partnership. The department has approximately 37.6 FTE with about half of its $5 million budget from tax levy." },
      { item:"Social Services Department overview", body:"Administrator Leonard presented on behalf of Director Christa, describing the department's divisions including child welfare, youth justice, children's long-term support, economic support, and child support. He highlighted the successful Family Keys pilot program addressing housing instability, which was substantially modified based on board feedback. The department has about 140 FTE with a $22 million budget, of which approximately $7 million is tax levy." },
      { item:"Veteran Service Department overview", body:"Veteran Service Officer Aaron Galindo reported the department grew to 3.0 FTE and had 8,149 client interactions in 2025. He highlighted $44 million annually in benefits flowing to Marathon County veterans, with $2.6 million in retroactive payments in 2025 alone. Key initiatives include surviving spouse benefits outreach, housing stability partnerships with Center for Veterans Issues and HUDVASH, and suicide prevention efforts noting 7 of 30 county suicides in 2025 were veterans. Supervisor Kremes asked about staffing adequacy; Galindo acknowledged they don't have enough time but are managing well." },
      { item:"Aging Disability Resource Center overview", body:"Executive Director Mike Ray explained the ADRC serves four counties (Marathon, Lincoln, Langlade, Wood) as a one-stop shop for aging and disability services. He described significant financial challenges with nutrition program costs up 40-45% over four years while federal funding remained flat. The organization has about 60 FTEs plus 385-400 volunteers. Vice Chair Rosenberg praised the culturally appropriate nutrition program at the Hmong American Center. Ray noted the ADRC hadn't requested a levy increase from 2011 until 2024." },
      { item:"Next meeting date correction", body:"Vice Chair Rosenberg caught an error in the announced next meeting date. The committee confirmed the next meeting will be Tuesday, June 3rd at 3 PM, not May 29th as initially stated." },
    ],
    publicComment: "No public comment was offered.",
    actionItems: [
      ...
      "Committee members to email Chair Boots and Administrator Leonard with agenda item suggestions",
      "Next meeting scheduled for Tuesday, June 3rd at 3 PM",
    ],
  },
  {
    ...
    isAgendaOnly: false,
    badge: "new",
    overview: "The Marathon County Board of Supervisors held an adjourned organizational meeting where they approved committee appointments, elected two at-large members to the executive committee (Supervisors Hapa and Arstead), and unanimously approved a resolution to reduce landfill tipping fees for disaster-related debris following severe tornado and flood damage in the Ringle area. The board also heard public comment from affected residents requesting additional fee relief.",
    agenda: [
      { time:"0:00", item:"Pledge of Allegiance and moment of reflection" },
      { time:"1:30", item:"Reading of meeting notice" },
      { time:"2:00", item:"Roll call" },
      { time:"5:01", item:"Committee appointments discussion and vote" },
      { time:"10:01", item:"Election of at-large executive committee members" },
      { time:"20:00", item:"Consent agenda (Items C10-C14A)" },
      { time:"21:00", item:"Resolution 24-26: Out of home placement reserve increase" },
      { time:"22:00", item:"Resolution 25-26: Amend social services budget" },
      { time:"23:00", item:"Resolution 26-26: Modification to landfill tipping fees" },
      { time:"1:10:02", item:"Announcements and adjournment" },
    ],
    discussions: [
      { item:"Committee appointments", body:"Chair Gibbs presented committee appointments developed with Vice Chair Boots, emphasizing goals of increasing diversity of perspective, developing leadership among newer supervisors (noting 34% are in first or second terms), and honoring supervisor preferences. The appointments included both county board chair and administrator appointments. Motion by Supervisor Cavelli, seconded by Supervisor Crims. The motion carried but was not unanimous. Supervisor Mask noted the system marked him absent but didn't allow him to vote, clarifying he was an 'I' on the vote." },
      { item:"Election of at-large executive committee members", body:"Three supervisors were nominated: Supervisor Hapa (nominated by Supervisor Mask), Supervisor Leur (nominated by Supervisor Rosenberg, who cited her advocacy for 'smallest children and oldest elders'), and Supervisor Arstead (nominated by Supervisor Boots). Paper ballots were distributed for supervisors to select two names. Supervisors Hapa and Arstead were elected to the executive committee." },
      { item:"Consent agenda", body:"Items C10 through C14A were moved by Supervisor Cavelli and seconded by Supervisor Drebeck. The motion carried unanimously by voice vote." },
      { item:"Resolution 24-26: Out of home placement reserve increase", body:"Motion by Supervisor Morash, seconded by Supervisor Robinson. No discussion occurred. The motion carried but was not unanimous." },
      { item:"Resolution 25-26: Amend social services budget", body:"Motion by Supervisor P, seconded by Supervisor Robinson. No discussion occurred. The motion carried but was not unanimous." },
      { item:"Resolution 26-26: Modification to landfill tipping fees", body:"Administrator Leonard and Director Hagen Busher presented the proposal from the Solid Waste Management Board to reduce tipping fees for disaster-related debris following severe weather that particularly impacted Ringle. The state is waiving its $13.10 fee, Ringle is waiving its $2.33 fee, and the county proposed reducing to $36.94 per ton (commercial rate minus state and local fees) through June 17. About 400 tons of debris has been processed. Public comment was allowed from Jessica Toasty and Matt Haybeck, who requested the county fully waive fees for affected residents. Multiple supervisors asked clarifying questions about fee calculations, coverage areas, and future policy. The board first voted unanimously to suspend rules to consider the resolution without standing committee review, then voted unanimously to approve Resolution 26-26." },
    ],
    publicComment: "Two residents were granted special dispensation to speak on the landfill tipping fee resolution. Jessica Toasty requested Marathon County wave its fees entirely for six months, noting the state, DNR, and Ringle are waiving their fees, and that local businesses have donated up to $40,000 in cleanup assistance. She emphasized residents are paying deductibles and uncovered expenses. Matt Haybeck spoke on behalf of homeowners facing demolition, noting some insurance adjusters haven't yet arrived and requesting more time and relief for the approximately 44 affected homes.",
    actionItems: [
      ...
      "Resolution 24-26 approved for out of home placement reserve increase",
      "Resolution 25-26 approved to amend social services budget",
      "Resolution 26-26 approved to reduce landfill tipping fees for disaster-related debris through June 17",
      "Administrator Leonard to continue discussions with Community Foundation regarding potential reimbursement mechanism for unreimbursed insurance costs",
  ...
  },
  {
    ...
    isAgendaOnly: false,
    badge: "new",
    overview: "The Marathon County Environmental Resources Committee approved two rezoning petitions and voted to forward a modified fee waiver resolution to the county board that will only waive reconnect fees for septic systems for properties damaged by the April 17, 2026 tornado. The committee also received educational presentations from the Solid Waste, Parks Recreation and Forestry, and Conservation Planning and Zoning departments.",
    agenda: [
      ...
      { time:"13:00", item:"Public hearing: Jeffrey and Cynthia Schmidtz rezoning petition (conservancy recreation to general agriculture) - Town of McMillan" },
      { time:"19:30", item:"Consideration of fee waiver for properties impacted by April 17, 2026 severe weather" },
      { time:"55:00", item:"Department introductions and ERC roles overview" },
      { time:"57:00", item:"Solid Waste Department presentation" },
      { time:"1:15:30", item:"Parks, Recreation and Forestry Department presentation" },
      { time:"1:35:00", item:"Conservation Planning and Zoning Department presentation" },
    ],
    discussions: [
      ...
      { item:"Tim Veland rezoning petition - Town of Green Valley", body:"Garrett Pogle presented the staff report for rezoning from urban residential and general agriculture to rural residential for a proposed land division. The Town of Green Valley recommended approval on March 10, 2026. No public testimony was offered for, against, or as interested. Supervisor Drebeck moved to approve based on findings of fact and conclusions of law, seconded by Supervisor Kurt. Motion carried unanimously." },
      { item:"Jeffrey and Cynthia Schmidtz rezoning petition - Town of McMillan", body:"The petition sought to rezone from conservancy recreation to general agriculture. Supervisor Leur asked about the conservancy nature of the property; Garrett Pogle explained the property contains a home and horse riding stable, and the rezoning would make these conforming uses rather than non-conforming. He confirmed no natural areas would be lost. The Town of McMillan recommended approval on April 20, 2026. No public testimony was offered. Supervisor Sefeld moved to approve, seconded by Supervisor Drew. Motion carried unanimously." },
      { item:"Fee waiver for April 17, 2026 severe weather victims", body:"Director Lori Mskimmons presented a proposal to waive county zoning and septic system fees for properties damaged by the tornado affecting Ringle, Kronenwetter, Easton, and Weston. Supervisor Drew questioned whether this creates precedent for future weather events. Supervisor Leur asked about tracking costs and potential levy impacts. Administrator Lance Pliml noted this was triggered by the governor's emergency declaration and staff costs are already budgeted. Supervisor Drebeck expressed concern about fairness to individual tornado victims not in declared disaster areas. After debate, Supervisor Sefeld moved to forward the resolution; Supervisor Leur seconded. Supervisor Drebeck then amended the motion to only waive reconnect fees for septic systems (not other zoning or pouts fees). Supervisor K seconded the amendment. The amendment carried, and the amended motion to forward to county board passed but was not unanimous." },
      { item:"Solid Waste Department presentation", body:"Director Dave Hagenbusher provided an overview of the landfill operations, explaining the facility accepts about 1,000 tons daily from Marathon, Portage, and Shawano counties. He highlighted the renewable natural gas partnership with Vidi Energy that began injecting gas into the pipeline in September 2025, the significant capital expenses including $6 million for 11-acre expansion, and the requirement to install leachate treatment by 2032 due to PFAS concerns. Marilyn Bend praised the department for keeping private landfill costs competitive." },
      { item:"Parks, Recreation and Forestry Department presentation", body:"Tom Lovelin, County Forest Administrator, presented on behalf of Director Jamie. He noted the department operates both city and county park systems with 44 full-time and 120 seasonal employees. He highlighted that Nine Mile County Forest generates $3.25 million annually for the county economy from out-of-town visitors. Supervisor Sefeld announced Tom's retirement effective June 1st after nearly 30 years of service. Chair Ritterder thanked him for his years of service." },
    ],
    publicComment: "No public comment was offered.",
    actionItems: [
      "Rezoning from urban residential\/general agriculture to rural residential for James Offer and David Tract property in Town of Green Valley approved - forwarded to county board",
      "Rezoning from conservancy recreation to general agriculture for Jeffrey and Cynthia Schmidtz property in Town of McMillan approved - forwarded to county board",
      "Modified fee waiver resolution (reconnect fees only) for April 17, 2026 tornado victims forwarded to county board for consideration",
  ...
  },
  {
    ...
    isAgendaOnly: false,
    badge: "new",
    overview: "The Village of Weston Community Life and Public Safety Committee recommended approval of nuisance code amendments and an e-bike ordinance (with emoto restrictions added), discussed but tabled overnight parking regulation changes until July, and authorized demolition proceedings for a condemned property. The committee also approved fire inspection requirements for mobile food vendors and addressed several property addressing corrections.",
    agenda: [
      { time:"0:15", item:"Call to order and Pledge of Allegiance" },
      { time:"0:45", item:"Roll call" },
      { time:"1:00", item:"Public comments" },
      { time:"5:00", item:"Minutes approval from previous meeting" },
      { time:"5:30", item:"Acknowledgment of department reports (Code Enforcement, Fire\/EMS, Police)" },
      { time:"11:00", item:"Proposed amendments to Chapter 50 nuisances" },
      { time:"13:00", item:"E-bike ordinance in Chapter 82 traffic and vehicles" },
      { time:"34:00", item:"Overnight parking regulations October 31st to May 1st" },
      { time:"51:00", item:"Crosswalk request on Alderson Street" },
      { time:"1:01:00", item:"Mobile food vendors fire inspection requirements" },
      { time:"1:10:00", item:"Address corrections for E911 compliance" },
      { time:"1:15:00", item:"Raze request for 4104 Shore Avenue" },
    ],
    discussions: [
      { item:"Public Comments", body:"Jim Senalt spoke extensively about concerns with the new farmers market location, stating it was 'a terrible execution' and predicting the park grass would be destroyed by summer. He raised concerns about vehicles parking on grass potentially violating village code, ADA-compliant handicap parking being on grass instead of asphalt, questioned the origin of new fire inspections for food trucks, and criticized the age of some code enforcement cases, noting some have been pending for years with no visible progress." },
      { item:"Minutes and Department Reports", body:"Minutes were approved unanimously with motion by Olsen and second by Shawanka. Code Enforcement reported that 3020 Mountain View Avenue will be removed from the enforcement roll after the property sold at auction and the new owner submitted repair permits. Police Chief Hunt reported 2,394 calls for March (77 per day), 410 traffic stops, and 281 citations. The department has hired its 40th officer, with the 38th starting last week, 39th in May, and 40th around January. Two SROs work with zoning during summer handling violations and pet licensing. Reports were acknowledged unanimously." },
      { item:"Chapter 50 Nuisance Amendments", body:"The committee reviewed final amendments including the tree limb height requirements (14 and 10 feet) that were switched in text per previous meeting direction, plus language about compliance with jurisdiction authority. Motion to recommend approval to the board of trustees was made by Olsen, seconded by Campey, and passed unanimously." },
      { item:"E-bike Ordinance", body:"Significant discussion focused on emotos (electric dirt bike-style vehicles). Chief Hunt strongly advocated prohibiting emotos on roadways and sidewalks, comparing them to unlicensed dirt bikes. Committee member Mike Compi raised concerns about electric scooters being included in the emoto definition, noting many middle schoolers use them. The committee decided to leave officer discretion for kid scooters. Motion by Olsen to recommend approval with the addition prohibiting emotos on roadways, sidewalks, trails, and public property was seconded by Shawanka and passed unanimously." },
      { item:"Overnight Parking Regulations", body:"Trustee Tolson presented research showing Weston's 12-hour no-parking window (4am-4pm) is far outside the norm compared to surrounding municipalities which typically use 4-5 hour overnight windows. Public Works Director Michael noted they rarely plow before 4-5am and residential streets aren't reached until 7-8am. Chief Hunt opposed eliminating overnight parking, preferring uniformity with other municipalities. The committee decided to table the item until July, directing Michael to identify 6-8 problem areas that could be specifically signed for alternating-side parking." },
      { item:"Crosswalk Request on Alderson Street", body:"Mount Olive Church requested a crosswalk between their property and DC Everest school parking lot. Staff estimated $2,000-3,000 for a basic crosswalk, $25,000-30,000 for a lighted system. Committee members expressed reluctance to set precedent of paying for every crosswalk request. Motion by Olsen, seconded by Shawanka, passed unanimously: if Mount Olive is willing to cover the installation cost, the board should approve it. Michael will contact Mount Olive to determine their willingness." },
      { item:"Mobile Food Vendors Fire Inspection", body:"Fire department presented a regional fire inspection program with Wisconsin Rapids, Marshfield, Stevens Point, Plover, Rib Mountain, and SAFER. One inspection would be valid across all participating municipalities. Fire Marshal Marty already inspected one truck that failed due to improper LP piping and unsecured propane cylinders. Wausau opted out to do their own inspections. Motion by Shawanka, seconded by Campey, to approve ordinance 26-8 passed unanimously." },
      { item:"Address Corrections", body:"Staff presented three addressing corrections: 5915 Delicowski Street (duplex needing split address, owners agreed), Ross Avenue properties out of sequence due to discovered apartment unit, and 2211 Radkey Avenue private drive with out-of-sequence apartment complex. Chief Hunt added another issue at Weston Villa Apartments on Delicowski where an 8-plex has separate addresses for each unit plus a utility room. Motion passed unanimously to recommend approval to the board." },
      { item:"Raze Request for 4104 Shore Avenue", body:"Property has been abandoned since 2010-2011 and posted for demolition since 2021. A planned fire training burn was cancelled because the structure was too deteriorated for safe training. Staff discovered chickens being housed inside the structure. Current owners are up to date on taxes and preferred the village proceed with demolition, with costs added to their tax roll. Motion by Olsen, seconded by Campey, passed unanimously to authorize demolition proceedings." },
    ],
    publicComment: "Jim Senalt spoke during public comment, criticizing the new farmers market location execution and predicting damage to park grass. He raised concerns about grass parking violating village code, ADA compliance for handicap spaces on grass rather than asphalt, questioned the need for new food truck fire inspections, and criticized the lack of progress on long-standing code enforcement cases.",
    actionItems: [
      "Recommend Chapter 50 nuisance amendments to board of trustees for approval",
      "Recommend e-bike ordinance to board with emoto prohibition on roadways, sidewalks, trails, and public property",
      "Public Works Director to identify 6-8 specific problem areas for potential alternating-side parking signage and bring back in July",
      "Public Works Director to contact Mount Olive Church regarding willingness to pay for crosswalk installation",
      "Approve ordinance 26-8 requiring fire inspections for mobile food vendors",
      "Recommend address corrections to board of trustees",
      "Begin raze order proceedings for 4104 Shore Avenue",
      "Staff to investigate property at Sternberg and South Timber with furniture and dumpster outside",
      "Next meeting scheduled for Monday, July 7th at 5:00 p.m.",
    ],
  },
  {
