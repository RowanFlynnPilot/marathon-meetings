...
const MEETINGS = [
  {
    ...
    isAgendaOnly: false,
    badge: "new",
    overview: "The Marathon County Health & Human Services Committee held an orientation meeting for new board members, featuring educational presentations from department heads including the Health Department, Social Services (presented by Administrator Leonard), Veterans Service Office, and Aging Disability Resource Center. The only formal action was approval of the April 1st meeting minutes. No policy decisions or substantive votes were taken.",
    agenda: [
      { time:"0:00", item:"Call to order and roll call (noting remote participation)" },
      ...
      { time:"10:01", item:"Health Department presentation by Health Officer Caitlyn Suginaka" },
      { time:"25:04", item:"Social Services Department overview by Administrator Leonard" },
      { time:"40:00", item:"Veterans Service Office presentation by VSO Aaron Galindo" },
    ...
    discussions: [
      { item:"Approval of April 1st Meeting Minutes", body:"Supervisor Cavelli made a motion to approve the minutes, seconded by Vice Chair Rosenberg. The motion passed unanimously with all members voting in favor." },
      { item:"Standing Committee Ordinance Review", body:"Administrator Leonard explained the committee's structure under ordinance section 2.04 sub5, covering jurisdiction over the Health Department, Social Services, Veterans Service Office, North Central Health Care, and Aging Disability Resource Center. He outlined statutory responsibilities and relationships with subordinate boards including the Social Services Board, Veterans Service Commission, Transportation Coordinating Committee, and Board of Health." },
      { item:"Health Department Presentation", body:"Health Officer Caitlyn Suginaka presented the department's mission of preventing disease, promoting health, and protecting from environmental hazards. She highlighted over 1,200 licenses overseen, the Nurse Family Partnership program with first graduates at age 2, a new homeless system response position funded through partnership with the City of Wausau, and public health vending machines stocked with free resources including tick kits. The department has 37.6 FTE across four teams. Supervisor Kremes asked about pandemic preparedness; Suginaka confirmed plans are in place with staff trained in emergency response." },
      { item:"Social Services Department Overview", body:"Administrator Leonard presented on behalf of Director Christa Kiernan. The department has nearly 140 FTE handling child welfare, youth justice, children's long-term support, economic support, and child support. He highlighted the successful Family Keys housing stability pilot program conducted with state partners, noting many clients served had never had credit accounts, bank accounts, or formal leases before entering the program." },
      { item:"Veterans Service Office Presentation", body:"VSO Aaron Galindo reported the office increased from 2.75 to 3.0 FTE in 2025 and saw customer interactions jump from 5,900 to 8,149. He noted $44 million in annual VA compensation flows to Marathon County veterans, plus $2.6 million in retroactive payments in 2025. Key initiatives include surviving spouse benefits outreach, housing stability partnerships with Center for Veterans Issues, and suicide prevention efforts (7 of 30 county suicides in 2025 were veterans). Supervisor Kremes asked about regional cooperation; Galindo explained good relationships exist with neighboring counties and veterans can work with any CVSO statewide." },
      { item:"ADRC Presentation", body:"Executive Director Mike Ray explained the four-county regional organization (Marathon, Lincoln, Langlade, Wood) serves as the one-stop shop for aging and disability resources. The ADRC handles functional eligibility for Family Care and Iris programs, caregiver support, dementia care, falls prevention, and meals on wheels. Ray noted significant financial challenges with federal funding flat since 2024 while nutrition program costs increased 40-45% over four years, forcing meal reductions. Marathon County's contribution is $413,135 annually. The organization relies on approximately 385-400 volunteers." },
    ],
    publicComment: "No public comment was offered.",
    actionItems: [
      "Schedule North Central Health Care for a separate full presentation before the committee",
      "Chair Boots to bring strategic plan updates to future meetings",
      "Health Officer Suginaka to confirm second public health vending machine location for Supervisor Conway",
      "ADRC Executive Director Mike Ray to present annual report with 2025 data to the full board",
      "Next meeting scheduled for Wednesday, June 3rd at 3:00 PM (date corrected from initially stated May 29th)",
    ],
  },
  {
    ...
    isAgendaOnly: false,
    badge: "new",
    overview: "The Marathon County Board of Supervisors held an adjourned organizational meeting where they approved committee appointments, elected Supervisors Hapa and Arstead to the Executive Committee, and unanimously approved a resolution reducing landfill tipping fees for disaster debris following the recent tornado and flooding that devastated the Ringle area. The board also approved several budget amendments and heard from affected residents requesting additional fee relief.",
    agenda: [
      { time:"0:00", item:"Pledge of Allegiance and moment of reflection" },
      { time:"1:30", item:"Reading of notice and roll call" },
      { time:"5:01", item:"Committee appointments by County Board Chair" },
      { time:"10:01", item:"Election of at-large Executive Committee members" },
      { time:"20:00", item:"Consent agenda (Items C10-C14A)" },
      { time:"20:45", item:"Resolution approving out-of-home placement reserve increase" },
      { time:"21:30", item:"Resolution to amend social services budget" },
      { time:"22:00", item:"Resolution approving modification to landfill tipping fees" },
      { time:"1:15:01", item:"Announcements and adjournment" },
    ],
    discussions: [
      { item:"Committee Appointments", body:"Chair Gibbs presented committee appointments developed with Vice Chair Boots, emphasizing goals of increasing diverse perspectives, developing supervisor leadership, and honoring supervisor preferences. Chair Gibbs noted that 34% of the board is in its first or second term. Motion by Supervisor Cavelli, seconded by Supervisor Crims. The motion carried but was not unanimous." },
      ...
      { item:"Consent Agenda (Items C10-C14A)", body:"Motion by Supervisor Cavelli, seconded by Supervisor Drebeck. The motion carried unanimously." },
      { item:"Resolution Approving Out-of-Home Placement Reserve Increase (Resolution 24-26)", body:"Motion by Supervisor Morash, seconded by Supervisor Robinson. The motion carried but was not unanimous." },
      { item:"Resolution to Amend Social Services Budget (Resolution 25-26)", body:"Motion by Supervisor P, seconded by Supervisor Robinson. The motion carried but was not unanimous." },
      { item:"Modification to Landfill Tipping Fees (Resolution 26-26)", body:"County Administrator Leonard and Solid Waste Director Dave Hagen Busher presented the proposal following the April tornado and flooding. Leonard explained that approximately 400 tons of debris have been processed, and the state emergency declaration allows waiving the $13.10 state fee. The town of Ringle is waiving its $2.33 fee. The Solid Waste Management Board proposed reducing fees to $36.94 per ton (covering costs) for certified disaster debris. Residents Jessica Toasty and Matt Haybeck were granted special permission to speak, requesting the county waive all fees and extend the timeline beyond 60 days. Supervisor Gao questioned fee structures, and Supervisor Rosenberg requested continued discussion. The board first voted unanimously to suspend rules to consider the resolution, then voted unanimously to approve Resolution 26-26." },
    ],
    publicComment: "Two residents were granted special permission to address the board regarding the landfill tipping fee resolution. Jessica Toasty asked the county to completely waive fees for disaster debris, noting the state, DNR, and Ringle are waiving their fees, and requesting a six-month timeline. She stated one business has spent $40,000 on hauling and cleanup. Matt Haybeck spoke on behalf of homeowners whose houses must be demolished, noting that many of the approximately 44 affected homes are still waiting for insurance adjusters and requested extended relief.",
    actionItems: [
      ...
      "Resolution 26-26 approved reducing landfill tipping fees to $36.94 per ton for certified disaster debris through June 17, 2025",
      "Solid Waste Management Board directed to develop long-term policy on disaster-related tipping fees within six months",
      "Administrator Leonard to continue discussions with Community Foundation regarding reimbursement mechanism for uninsured debris disposal costs",
    ],
  },
  {
    ...
    isAgendaOnly: false,
    badge: "new",
    overview: "The Marathon County Environmental Resources Committee approved two rezoning petitions unanimously and voted to forward a modified fee waiver resolution to the county board that will only waive reconnect fees for properties impacted by the April 17, 2026 tornado. The committee also received educational presentations from the Solid Waste, Parks Recreation and Forestry, and Conservation Planning and Zoning departments.",
    agenda: [
      ...
      { time:"15:01", item:"Public hearing: Jeffrey and Cynthia Schmidtz rezoning petition (Conservancy Recreation to General Agriculture, Town of McMillan)" },
    ...
    discussions: [
      { item:"Approval of March 31, 2026 committee minutes", body:"Supervisor Sefeld moved to approve the minutes with Supervisor Drebeck seconding. The motion carried unanimously with no discussion." },
      { item:"Tim Veland rezoning petition (Town of Green Valley)", body:"Land Use Specialist Garrett Pogle presented the staff report for rezoning from Urban Residential and General Agriculture to Rural Residential. The Town of Green Valley recommended approval on March 10, 2026. No public testimony was offered for or against. Supervisor Drebeck moved to approve based on findings of fact and conclusions of law. Supervisor Kurt seconded. Motion carried unanimously." },
      { item:"Jeffrey and Cynthia Schmidtz rezoning petition (Town of McMillan)", body:"Garrett Pogle presented the petition to rezone from Conservancy Recreation to General Agriculture. Supervisor Leur asked about the conservancy nature and potential loss of natural areas. Pogle explained the property contains a home and horse riding stable, and rezoning would make the structures conforming uses. The Town of McMillan recommended approval on April 20, 2026. No public testimony was offered. Supervisor Sefeld moved to approve. Supervisor Drew seconded. Motion carried unanimously." },
      { item:"Fee waiver for April 17, 2026 severe weather impacts", body:"Director Lori Mskimmons presented a proposal to waive county zoning and pouts fees for tornado-damaged properties. Supervisors Drebeck and Drew expressed concerns about fairness to future disaster victims and precedent-setting. Eric Vogel asked if homeowner insurance would cover fees. After significant debate, Supervisor Sefeld moved to forward the resolution. Supervisor Leur seconded. Supervisor Drebeck then amended the motion to only waive reconnect fees (not other zoning or pouts fees). Supervisor Kurt seconded the amendment. The amendment passed, and the amended resolution passed on a non-unanimous vote to forward to the full county board." },
      { item:"Solid Waste Department overview", body:"Director Dave Hagen Busher presented on department operations including the landfill facility, renewable natural gas partnership with Vidi Energy, leachate treatment challenges, and upcoming capital projects. He noted the department operates as an enterprise fund with 11 FTE staff processing about 1,000 tons of waste daily." },
      { item:"Parks, Recreation and Forestry Department overview", body:"County Forest Administrator Tom Lovelin presented on behalf of Director Jamie. He covered the joint city-county park system, 17 county parks, 30,700 acres of county forest, and the Nine Mile County Forest recreation area. Supervisor Sefeld announced Tom Lovelin is retiring June 1st after nearly 30 years of service. The committee thanked him for his service." },
    ],
    publicComment: "No public comment was offered.",
    actionItems: [
      "Forward amended fee waiver resolution to county board (waiving only pouts reconnect fees for tornado-impacted properties)",
      "Forward James Offer\/David Tract rezoning approval to county board",
      "Forward Jeffrey and Cynthia Schmidtz rezoning approval to county board",
      "CPZ staff to track costs and requests related to fee waiver program",
      "Town of Green Valley and Town of McMillan to update comprehensive plans to reflect zoning changes if applicable",
    ],
  },
  {
