...
const MEETINGS = [
  {
    ...
    isAgendaOnly: true,
    badge: "new",
    overview: "Based on the published agenda, the Village of Weston Board of Trustees was scheduled to meet on March 23, 2026 to consider multiple rezoning ordinances, approve a subdivision final plat, and address various infrastructure and parks-related matters including baseball field agreements, park shelter fees, and an Eagle Scout project. The meeting also included discussion items on e-bicycle regulations, street maintenance planning, and utility engineering contracts.",
    agenda: [
    ...
    discussions: [
      { item:"Ordinance No. 26-004: Rezoning of 8905 Birch Street", body:"The Board was scheduled to consider rezoning a portion of property at 8905 Birch Street from Rural Residential-5 Acre (RR-5) to Single Family Residential-Small Lot (SF-S). This rezoning was expected to allow for higher density residential development on the property." },
      { item:"Ordinance No. 26-005: Rezoning of 7105 Christiansen Avenue", body:"The Board was set to review a rezoning request for a portion of 7105 Christiansen Avenue from Single Family Residential-Large Lot (SF-L) to Single Family Residential-Small Lot (SF-S). This change was expected to permit smaller lot residential development." },
      { item:"Ordinance No. 26-006: Speed Limits Amendment", body:"The Board was scheduled to consider amendments to Chapter 82.600 of the Municipal Code regarding speed limits. The specific streets or speed changes were not detailed in the agenda." },
      { item:"Resolution No. 2026-008: Hinner Springs Second Addition Final Plat", body:"The Board was expected to consider approval of the final plat for the Hinner Springs Second Addition Subdivision. This would represent a key step in advancing this residential development project." },
      { item:"April 2026 Referendum Informational Sessions Update", body:"The Board was scheduled for discussion only regarding updates on informational sessions planned for an April 2026 referendum. No action was expected on this item." },
      { item:"Proposed E-Bicycle and E-Moto Ordinance Dialogue", body:"The Board was set to discuss potential regulations for e-bicycles and e-motos, with dialogue expected to occur at the Community Life and Public Safety Committee level. This reflects growing local interest in regulating electric mobility devices." },
      { item:"Removal of No Parking Restrictions", body:"The Board was scheduled to consider removing no parking restrictions on Alta Verde Street south of Jelinek Avenue and on Alderson Street along Kennedy Park. This could affect parking availability near the park area." },
      { item:"Baseball\/Softball Field Maintenance and User Agreement", body:"The Board was expected to consider a maintenance and user agreement for baseball and softball fields. This would establish terms for field maintenance responsibilities and usage by community groups." },
      { item:"Purchase of Commercial Rotary Mower", body:"The Board was scheduled to consider the purchase of a commercial rotary mower for parks maintenance operations. The specific cost was not indicated in the agenda." },
      { item:"Park Shelter Fees and Field Rental Costs", body:"The Board was set to review and potentially adjust fees for park shelter rentals and field usage. This could affect pricing for community members and organizations using village park facilities." },
      { item:"Eagle Scout Project at Machmueller Park", body:"The Board was expected to consider an Eagle Scout project proposed for Machmueller Park. Eagle Scout projects typically involve community improvement initiatives completed by scouts pursuing the Eagle rank." },
      { item:"2026 Annual Street Maintenance Plan and Budget", body:"The Board was scheduled to review the annual street maintenance plan and associated budget for 2026. This comprehensive planning item would outline priorities and funding for road maintenance throughout the village." },
      { item:"Military Road Utility Engineering Services Contract", body:"The Board was expected to consider a contract for engineering services related to utilities on Military Road. This represents infrastructure planning work for the road corridor." },
      { item:"Bus 51 Storm Pond Engineering Services Contract Amendment", body:"The Board was set to review an amendment to an existing engineering services contract for the Bus 51 storm pond project. This suggests ongoing stormwater management work in the area." },
      { item:"Well 2 Rehabilitation", body:"The Board was scheduled to consider rehabilitation work for Well 2, part of the village's water supply infrastructure. This maintenance would help ensure reliable water service to residents." },
      { item:"Sign Encroachment Agreement", body:"The Board was expected to consider a sign encroachment agreement with 7th Floor Investments, LLC for Macco's Floor Covering at 3111 Schofield Avenue. This would formalize arrangements for signage that extends onto village property or right-of-way." },
    ],
    ...
    actionItems: [
      ...
      "Expected to consider consent agenda including vouchers and licensing agent change",
      ...
      "Expected to consider removal of no parking restrictions near Kennedy Park",
    ],
  },
  {
    ...
    isAgendaOnly: true,
    badge: "new",
    overview: "Based on the published agenda, the Village of Weston Board of Trustees was scheduled to meet on March 23, 2026 to consider multiple rezoning ordinances, a subdivision final plat approval, infrastructure projects including utility engineering and street maintenance, and various policy matters including e-bicycle regulations and park facility fees. The meeting included an extensive new business section with items affecting public works, parks, and village administration.",
    agenda: [
    ...
    discussions: [
      { item:"Ordinance No. 26-004: Rezoning of 8905 Birch Street", body:"The Board was scheduled to consider rezoning a portion of property at 8905 Birch Street from RR-5 (Rural Residential-5 Acre) to SF-S (Single Family Residential-Small Lot) zoning district. This zoning change was expected to allow for higher-density residential development on the property." },
      { item:"Ordinance No. 26-005: Rezoning of 7105 Christiansen Avenue", body:"The Board was set to review a rezoning request for a portion of 7105 Christiansen Avenue from SF-L (Single Family Residential-Large Lot) to SF-S (Single Family Residential-Small Lot). This was expected to permit smaller lot residential development in this area." },
      { item:"Ordinance No. 26-006: Speed Limits Amendment", body:"The Board was expected to consider amendments to Chapter 82.600 of the Municipal Code regarding speed limits within the Village of Weston. Specific speed limit changes were scheduled to be addressed in this ordinance." },
      { item:"Resolution No. 2026-008: Hinner Springs Second Addition Subdivision Final Plat", body:"The Board was scheduled to vote on final plat approval for the Hinner Springs Second Addition Subdivision. This approval would be expected to allow the development to proceed with lot sales and construction." },
      { item:"April 2026 Referendum Informational Sessions Update", body:"As unfinished business, the Board was set to receive a discussion-only update on informational sessions planned for an upcoming April 2026 referendum. No action was indicated on the agenda for this item." },
      { item:"E-Bicycle and E-Moto Ordinance Dialogue", body:"The Board was scheduled to discuss a proposed ordinance addressing e-bicycles and e-motos, with dialogue to occur at the Community Life and Public Safety Committee level. This was expected to address regulations for electric-powered personal transportation devices." },
      { item:"Parking Restriction Removal on Alta Verde St and Alderson Street", body:"The Board was set to consider removing no parking restrictions on Alta Verde Street south of Jelinek Avenue and on Alderson Street along Kennedy Park. This could affect parking availability for park users and nearby residents." },
      { item:"Baseball\/Softball Field Maintenance and User Agreement", body:"The Board was expected to consider terms for maintaining baseball and softball fields and agreements with user groups. This was scheduled to address responsibilities and costs for athletic field upkeep." },
      { item:"Park Shelter Fees and Field Rental Costs", body:"The Board was scheduled to discuss and potentially take action on fee structures for park shelter rentals and field usage costs. This could affect pricing for residents and organizations using Village park facilities." },
      { item:"Eagle Scout Project at Machmueller Park", body:"The Board was set to consider an Eagle Scout project proposed for Machmueller Park. This community service project was expected to require Board approval before proceeding." },
      { item:"Remote Meeting Attendance Policy Review", body:"The Board was scheduled to review the Elected and Appointed Officials' Handbook regarding remote meeting attendance policies. This was expected to address guidelines for officials participating in meetings via electronic means." },
      { item:"Military Road Utility Engineering Services Contract", body:"The Board was set to consider an engineering services contract for utility work on Military Road. This infrastructure project was expected to address utility improvements in that corridor." },
      { item:"Bus 51 Storm Pond Engineering Services Contract Amendment", body:"The Board was scheduled to review a contract amendment for engineering services related to a storm pond project in the Bus 51 area. This was expected to modify existing engineering service agreements." },
      { item:"2026 Annual Street Maintenance Plan and Budget", body:"The Board was expected to consider the annual street maintenance plan and associated budget for 2026. This was scheduled to outline roadway repair and maintenance priorities for the year." },
      { item:"Hospital Area Repaving Change Order #4", body:"The Board was set to review Change Order #4 for the hospital area repaving project. This was expected to address modifications to the existing paving contract scope or costs." },
      { item:"Well 2 Rehabilitation", body:"The Board was scheduled to discuss and potentially take action on rehabilitation work for Well 2, part of the Village's water supply infrastructure. This was expected to address maintenance or upgrades to this water system component." },
      { item:"Sign Encroachment Agreement with 7th Floor Investments, LLC", body:"The Board was set to consider a sign encroachment agreement with 7th Floor Investments, LLC for Macco's Floor Covering at 3111 Schofield Avenue. This was expected to address signage that extends into Village right-of-way." },
    ],
    publicComment: "Public comment was on the agenda, allowing any person to address the Board for up to three minutes regarding non-agenda items, with time extension permitted per the Chief Presiding Officer's discretion.",
    actionItems: [
      "Scheduled to vote on Ordinance No. 26-004 rezoning 8905 Birch Street",
      "Scheduled to vote on Ordinance No. 26-005 rezoning 7105 Christiansen Avenue",
      "Scheduled to vote on Ordinance No. 26-006 amending speed limits",
      "Scheduled to vote on Resolution No. 2026-008 approving Hinner Springs Second Addition Subdivision final plat",
      "Expected to consider consent agenda including voucher approval and Reliance Fuel LLC agent change",
      "Expected to consider Baseball\/Softball Field Maintenance and User Agreement",
      "Expected to consider purchase of Commercial Rotary Mower",
      "Expected to consider Park Shelter Fees and Field Rental Costs",
      "Expected to consider Military Road Utility Engineering Services Contract",
  ...
  },
  {
    ...
    isAgendaOnly: true,
    badge: "new",
    overview: "Based on the published agenda, the Village of Weston Board of Trustees was scheduled to meet on March 23, 2026, to consider multiple rezoning ordinances, approve a subdivision final plat, and address numerous infrastructure and operational matters including street maintenance, utility projects, and park-related items. The meeting also included an update on April 2026 referendum informational sessions and discussion of a proposed e-bicycle ordinance.",
    agenda: [
      { time:"N\/A", item:"Public Comments" },
      { time:"N\/A", item:"Approval of February 16, 2026, Board of Trustees Meeting" },
      { time:"N\/A", item:"Acknowledge Reports\/Minutes from Boards, Committees, Commissions" },
    ...
    discussions: [
      { item:"Ordinance No. 26-004: Rezoning of 8905 Birch Street", body:"The Board was scheduled to consider rezoning a portion of 8905 Birch Street from Rural Residential-5 Acre (RR-5) to Single Family Residential-Small Lot (SF-S) zoning district. This rezoning was expected to potentially allow for increased residential density on the property." },
      { item:"Ordinance No. 26-005: Rezoning of 7105 Christiansen Avenue", body:"The Board was set to review a rezoning request for a portion of 7105 Christiansen Avenue from Single Family Residential-Large Lot (SF-L) to Single Family Residential-Small Lot (SF-S). This change was expected to allow for smaller lot development on the property." },
      { item:"Ordinance No. 26-006: Speed Limit Amendments", body:"The Board was scheduled to consider amendments to Chapter 82.600 of the Municipal Code regarding speed limits. The specific speed limit changes were not detailed in the agenda." },
      { item:"Resolution No. 2026-008: Hinner Springs Second Addition Subdivision Final Plat", body:"The Board was expected to consider approval of the final plat for Hinner Springs Second Addition Subdivision. This action would authorize the official recording of the subdivision plat." },
      ...
      { item:"Proposed E-Bicycle and E-Moto Ordinance", body:"The Board was set to discuss a proposed ordinance regarding e-bicycles and e-motos, with dialogue expected to be referred to the Community Life and Public Safety Committee. This item may address regulations for electric-powered personal transportation devices." },
      { item:"Removal of No Parking Restrictions", body:"The Board was scheduled to consider removing no parking restrictions on Alta Verde Street south of Jelinek Avenue and on Alderson Street along Kennedy Park. This could affect parking availability for park users." },
      { item:"Baseball\/Softball Field Maintenance and User Agreement", body:"The Board was expected to discuss and potentially take action on a maintenance and user agreement for baseball and softball fields. This may establish responsibilities and terms for field usage." },
      { item:"Purchase of Commercial Rotary Mower", body:"The Board was scheduled to consider the purchase of a commercial rotary mower for village operations. The specific cost and specifications were not detailed in the agenda." },
      { item:"Park Shelter Fees and Field Rental Costs", body:"The Board was set to review and potentially adjust fees for park shelter rentals and field usage. This could affect costs for residents and organizations using village park facilities." },
      { item:"Eagle Scout Project at Machmueller Park", body:"The Board was scheduled to consider an Eagle Scout project proposed for Machmueller Park. Such projects typically involve community improvement efforts by scouts seeking their Eagle rank." },
      { item:"Remote Meeting Attendance Policy", body:"The Board was expected to review the Remote Meeting Attendance Policy in the Elected and Appointed Officials' Handbook. This may address guidelines for virtual participation in official meetings." },
      { item:"Military Road Utility Engineering Services Contract", body:"The Board was scheduled to consider an engineering services contract for Military Road utilities. This project likely involves infrastructure planning or improvements along Military Road." },
      { item:"Bus 51 Storm Pond Engineering Services Contract Amendment", body:"The Board was set to review a contract amendment for engineering services related to the Bus 51 storm pond project. This suggests ongoing stormwater management work in that area." },
      { item:"Sewer Televising Software Contract", body:"The Board was expected to consider a contract for sewer televising software. This technology is used to inspect and assess the condition of sewer infrastructure." },
      { item:"2026 Annual Street Maintenance Plan and Budget", body:"The Board was scheduled to review and potentially approve the 2026 annual street maintenance plan and associated budget. This would establish priorities and funding for road repairs throughout the year." },
      { item:"Hospital Area Repaving Change Order #4", body:"The Board was set to consider the fourth change order for the hospital area repaving project. Change orders typically address modifications to scope, timeline, or cost of construction projects." },
      { item:"Well 2 Rehabilitation", body:"The Board was scheduled to discuss and potentially take action on rehabilitation of Well 2. This project would address maintenance or improvements to part of the village's water supply infrastructure." },
      { item:"Sign Encroachment Agreement with 7th Floor Investments, LLC", body:"The Board was expected to consider a sign encroachment agreement with 7th Floor Investments, LLC for Macco's Floor Covering at 3111 Schofield Avenue. This would authorize signage that extends into village right-of-way." },
    ],
    publicComment: "Public comment period was included on the agenda, allowing persons to address the Board for up to three minutes regarding non-agenda items.",
    actionItems: [
      ...
      "Expected to consider agent change appointment for Reliance Fuel LLC",
      "Expected to consider removal of no parking restrictions on Alta Verde St and Alderson Street",
      "Expected to consider Baseball\/Softball Field Maintenance and User Agreement",
      "Expected to consider purchase of Commercial Rotary Mower",
      "Expected to consider Park Shelter Fees and Field Rental Costs",
      "Expected to consider Eagle Scout Project at Machmueller Park",
      "Expected to consider Remote Meeting Attendance Policy revisions",
  ...
  },
  {
    ...
    isAgendaOnly: false,
    badge: "new",
    overview: "The Board of Public Works awarded a $1,279,989.75 contract to Switlick & Sons, Inc. for the 2026 North 8th Avenue Street Construction Project, but rejected bids for the 2026 Asphalt Paving Project 'A'. The board also approved change orders and a pay estimate totaling over $549,000 for the ongoing Randolph Street\/Cherry Street construction project.",
    agenda: [
      { time:"N\/A", item:"Consideration of the minutes of the preceding meeting(s) - March 10, 2026 Regular Board of Public Work Minutes" },
    ...
    discussions: [
      ...
      { item:"2026 Street Construction Project 'B' - North 8th Avenue", body:"The board opened bids and awarded the contract to Switlick & Sons, Inc. in the amount of $1,279,989.75. The motion passed." },
      { item:"2026 Asphalt Paving Project 'A'", body:"The board opened bids for the 2026 Asphalt Paving Project 'A' but the motion to approve failed. The project was not awarded." },
      { item:"2025 Street Construction Project 'A' - Randolph Street\/Cherry Street Change Orders", body:"The board approved Change Order #1 in the amount of $14,436.50 for Haas Sons, Inc. The motion passed. Change Order #2 was also on the agenda but specific details were not recorded in the vote record." },
      { item:"2025 Street Construction Project 'A' - Randolph Street\/Cherry Street Pay Estimate #9", body:"The board approved Pay Estimate #9 for Haas Sons, Inc. in the amount of $535,011.42. The motion passed." },
    ...
    actionItems: [
      "Contract awarded to Switlick & Sons, Inc. for $1,279,989.75 for North 8th Avenue construction project",
      "2026 Asphalt Paving Project 'A' bids rejected; project will require rebidding or reconsideration",
      "Change Order #1 of $14,436.50 approved for Haas Sons, Inc. on Randolph Street\/Cherry Street project",
      "Pay Estimate #9 of $535,011.42 approved for Haas Sons, Inc.",
  ...
  },
  {
    ...
    discussions: [
      { item:"Election of a Vice Chair", body:"Election of a Vice Chair was on the agenda. No vote outcome was recorded in the official records." },
      { item:"Consideration of the minutes of the February 18, 2026 Regular Plan Commission Meeting", body:"The minutes from the February 18, 2026 Regular Plan Commission Meeting were approved. The motion passed, though individual vote counts were not recorded." },
      { item:"Public Hearing: Conditional Use Permit for 218 South 4th Street (Dunwoody Storage)", body:"A public hearing was held on a Conditional Use Permit to authorize construction of a Personal Storage Facility in the Light Industrial Zoning District. No vote was recorded for this item, indicating it may have been discussion only at this meeting." },
      { item:"Conditional Use Permit for 731 N 1st Street (Beacon Resources, LLC)", body:"The Commission approved a Conditional Use Permit for a 70-unit, 7-story apartment building at 731 N 1st Street. The motion passed, though individual vote counts were not recorded in the official records." },
      { item:"Transportation Project Plat for Grand Avenue signal replacements", body:"The Commission approved the Transportation Project Plat for Project 370-40-40, covering Grand Avenue signal replacements at Sturgeon Eddy Road and Townline Road. The motion passed." },
    ],
    ...
    actionItems: [
      "Conditional Use Permit approved for 70-unit apartment building at 731 N 1st Street - Beacon Resources, LLC may proceed with project",
      "Transportation Project Plat approved for Grand Avenue signal replacements at Sturgeon Eddy Road and Townline Road",
      "Conditional Use Permit for Dunwoody Storage at 218 South 4th Street had public hearing - may require future action",
    ],
    civicItems: [
  ...
  },
  {
    ...
    isAgendaOnly: false,
    badge: "new",
    overview: "The Wausau Board of Public Works awarded the 2026 Asphalt Paving Project 'A' contract to RC Pavers, LLC for $824,146.34. The board completed its business with a 2-0 vote to adjourn.",
    agenda: [
      { time:"N\/A", item:"Open bids and make recommendation for 2026 Asphalt Paving Project 'A'" },
    ],
    discussions: [
      { item:"Open bids and make recommendation for 2026 Asphalt Paving Project 'A'", body:"The board opened bids and voted to award the contract to RC Pavers, LLC in the amount of $824,146.34. The motion passed." },
    ],
    publicComment: "Not indicated on agenda.",
    actionItems: [
  ...
  },
  {
    ...
    isAgendaOnly: false,
    badge: "new",
    overview: "The Public Health and Safety Committee approved all action items including license applications with one exception for Theodore Davis, repealed the hand-held mobile phone ordinance, recreated the solid waste disposal code, and approved a solar energy partnership with MREA. The Wausau Fire Department presented its 2025 annual report during discussion items.",
    agenda: [
    ...
    discussions: [
      { item:"Approval or denial of various license applications", body:"The committee approved a parklet permit and approved licenses as indicated by staff with the exception of Theodore Davis. Both votes passed." },
      ...
      { item:"Approving Memorandum of Understanding with Midwest Renewable Energy Association", body:"The committee approved the MOU to partner with MREA in operating the Grow Solar Central Wisconsin Group Buy Program. The motion passed." },
      { item:"Wausau Fire Department 2025 Annual Report", body:"The Fire Department presented its 2025 annual report. This was a discussion item with no action taken." },
      { item:"Tavern Activities Report from February 2026", body:"The February 2026 tavern activities report was presented. This was a discussion item with no action taken." },
      { item:"Community Outreach Update", body:"A community outreach update was provided. This was a discussion item with no action taken." },
    ],
    ...
    actionItems: [
      ...
      "Wausau Municipal Code Chapter 6.44 Solid Waste Disposal repealed and recreated with new provision",
      "Wausau Municipal Code Section 10.01.012 on hand-held mobile phone use while driving repealed",
  ...
  },
  {
    ...
    discussions: [
      { item:"Minutes of March 10, 2026 Regular Finance Committee Meeting", body:"Approved 4-0. Motion moved by Sarah Watson and seconded by Aaron Griner. Michael Martens, Vicki Tierney, Sarah Watson, and Aaron Griner voted yes." },
      { item:"Alleged Claim for Recovery of Unlawful Tax for Green Acres at Greenwood Hills, LLC - Outlot 1", body:"The motion to approve the claim for recovery failed. Specific vote count was not recorded in the official records." },
      { item:"Consent to transfer title to buildings and improvements at 939 Woods Place", body:"Approved. The committee voted to approve the consent to transfer title to buildings and waiver of first right of refusal. Specific vote count not recorded." },
      { item:"Terminating Airport Ground Lease with Wynn O. Jones at 939 Woods Place", body:"Approved. The committee voted to terminate the existing airport ground lease with Wynn O. Jones. Specific vote count not recorded." },
      { item:"Approving Airport Ground Lease with Owen Jones at 939 Woods Place", body:"Approved. The committee voted to approve a new airport ground lease with Owen Jones at the same location. Specific vote count not recorded." },
      { item:"Approving Airport Ground Lease with Cole Lundberg", body:"Approved. The committee voted to approve an airport ground lease with Cole Lundberg. Specific vote count not recorded." },
      { item:"Six Remnant Defendants National Opioid Settlement Agreement", body:"Postponed. The committee voted to postpone consideration of participating in the national opioid settlement agreement to the next scheduled meeting." },
      { item:"Budget amendment for Wausau Water Works Lead Service Line Replacement project", body:"Postponed. The committee voted to postpone consideration of the budget amendment to cover costs not funded by the WDNR subsidized loan to the next meeting." },
      { item:"Budget amendment for carryover of funds from 2025 to 2026", body:"Approved. The committee voted to approve the budget amendment for the carryover of funds. Specific vote count not recorded." },
      { item:"Review of 2025 Motor Pool Fund financial results and related budget amendment", body:"Item was on the agenda for review. No vote record indicated for this item." },
      { item:"2026 General Obligation Promissory Note for Capital Improvements", body:"Approved to the calendar. The committee voted to advance the promissory note for capital improvements. Specific vote count not recorded." },
      { item:"Review of 2025 General Fund Financial Results", body:"Approved to transfer the funds. The committee voted following their review of the 2025 General Fund financial results. Specific vote count not recorded." },
      { item:"Purchasing properties for DPW Streets Division", body:"Postponed. The committee voted to postpone consideration of purchasing properties at 108 Adolph Street, 112 Adolph Street, 112-1\/2 Adolph Street, and 233 Myron Street until the next meeting." },
    ],
    ...
    actionItems: [
      ...
      "Transfer of title and airport lease changes at 939 Woods Place approved - transition from Wynn O. Jones to Owen Jones",
      "Airport ground lease with Cole Lundberg approved",
      "Opioid settlement participation to be reconsidered at next meeting",
      "Lead service line replacement budget amendment to be reconsidered at next meeting",
      ...
      "DPW property purchases on Adolph Street and Myron Street to be reconsidered at next meeting",
    ],
    civicItems: [
      { number:"1", name:"Public comment on agenda items and reading of the City of Wausau Public Comment Statement.", votes:[], docs:[], children:[] },
  ...
  },
  {
    ...
    isAgendaOnly: false,
    badge: "new",
    overview: "The Wausau Common Council approved all items on its agenda, including a residential solid waste and recycling service agreement with Harter's Fox Valley Disposal LLC, a development agreement for Waterside Place at 11 Scott Street, and a budget modification allowing the Police Department to use proceeds from selling a Thompson sub-machinegun to purchase red-dot optics. The council also suspended procedural rules on a 7-2 vote to consider several late-filed resolutions.",
    agenda: [
      ...
      { time:"N\/A", item:"Resolution Adopting 2026 Budget Modification for Wausau Police Department to Purchase Red-Dot Optics" },
      ...
      { time:"N\/A", item:"Resolution Approving Settlement Release in David Hoelzel v. City of Wausau" },
    ...
    discussions: [
      { item:"March 10, 2026 Regular Common Council Minutes", body:"Approved 9-0. Motion by Sarah Watson, seconded by Vicki Tierney." },
      { item:"Consent Agenda", body:"The consent agenda was approved 9-0, including an ordinance amending Section 9.20.070 regarding fires, fireworks, firearms, and missiles, and a resolution renewing the parking lot lease with Colonial Property 4, LLC for Grant and 3rd Streets. Motion by Sarah Watson, seconded by Chad Henke." },
      ...
      { item:"Residential Solid Waste and Recycling Service Agreement with Harter's Fox Valley Disposal LLC", body:"Approved. The Finance Committee's resolution for the solid waste and recycling service agreement was passed by the council." },
      { item:"Airspace Obstruction Removal Agreement with Schofield Ridgeland Legacy LLC", body:"Approved. The resolution covers properties at 724 and 732 Ridgeland Avenue, Schofield, including a related budget modification." },
      { item:"Airspace Obstruction Removal Agreement with Zachary Lange", body:"Approved. The resolution covers property at 811 Ridgeland Avenue, Schofield, with a related budget modification." },
      { item:"2026 Budget Modification for Police Department Red-Dot Optics", body:"Approved. The budget modification allows the Wausau Police Department to use proceeds from the sale of a Thompson sub-machinegun to purchase red-dot optics." },
      { item:"Development Agreement for Waterside Place at 11 Scott Street", body:"Approved. The joint resolution from the Economic Development Committee and Infrastructure & Facilities Committee approves the development agreement and amended parking agreement with 11 Scott Street, LLC." },
      { item:"Suspension of Council Rules", body:"Approved 7-2. Motion by Lisa Rasmussen, seconded by Sarah Watson. Terry Kilian and Vicki Tierney voted no. The suspension allowed consideration of late-filed items." },
      { item:"Ordinance Repealing and Recreating Municipal Code Chapter 6.44 Solid Waste Disposal", body:"Approved. The Public Health & Safety Committee's ordinance updating the solid waste disposal chapter was passed." },
      { item:"Settlement of David Hoelzel v. City of Wausau", body:"Approved. The council approved the release of all claims for property damage settlement in Marathon County Case No. 25-CV-594." },
      { item:"Paid Duty Time for Out of Country Training for Police Officer", body:"Approved. The joint resolution from Human Resources and Finance Committees was passed." },
      { item:"Community Outreach Professional Shelter Operations Duty Premium Differential", body:"Approved. The joint resolution from Human Resources and Finance Committees establishing the duty premium differential was passed." },
    ],
    publicComment: "Public comment was on the agenda both before and after the business meeting, with a formal reading of the City of Wausau Public Comment Statement.",
    actionItems: [
      "Execute residential solid waste and recycling service agreement with Harter's Fox Valley Disposal LLC",
      "Process airspace obstruction removal agreements with Schofield Ridgeland Legacy LLC and Zachary Lange with related budget modifications",
      "Implement 2026 budget modification for Police Department red-dot optics purchase",
      "Execute development agreement and amended parking agreement for Waterside Place at 11 Scott Street",
      "Implement updated Municipal Code Chapter 6.44 for solid waste disposal",
      "Process settlement release in David Hoelzel v. City of Wausau case",
      "Implement paid duty time for out of country police officer training",
      "Implement Community Outreach Professional Shelter Operations duty premium differential",
    ],
    civicItems: [
  ...
  },
  {
    ...
    isAgendaOnly: true,
    badge: "new",
    overview: "The Education\/Operations Committee meeting addressed the Wausau School District's 4K program partnership agreements for 2026-2027, received an annual safety update including drill debriefs, and reviewed 43 Neola policy updates covering topics from board conduct to student drug use to school safety protocols.",
    agenda: [
      { time:"0:00", item:"Call to Order" },
      { time:"0:02", item:"Approve the Minutes" },
      { time:"0:04", item:"Public and Student Comment" },
      { time:"0:14", item:"Excellence in Action: John Marshall Elementary" },
      { time:"0:24", item:"4K Program Agreement (Action Requested)" },
      { time:"0:29", item:"Annual Safety Update \/ Drill Debrief" },
      { time:"0:49", item:"Neola Policies Update (Action Requested)" },
      { time:"1:09", item:"Adjourn" },
    ],
    discussions: [
      { item:"4K Program Agreement", body:"The district's four-year-old kindergarten program is seeking approval to renew program agreements with six community collaboration sites for the 2026-2027 school year, continuing partnerships that have existed since 2002. Partner sites include Wausau Child Care, Mountain View Montessori, Woodson YMCA Wausau Branch, Newman Catholic Schools, and Marathon County Child Development Agency Head Start Program." },
      { item:"Annual Safety Update \/ Drill Debrief", body:"The district is implementing the I Love U Guys Standard Response Protocol using standardized vocabulary (HOLD, SECURE, LOCKDOWN, EVACUATE, SHELTER) for consistent emergency responses. Security measures include secure building entrances, Visitor Aware System, security cameras, locked exterior doors, and recent district-wide LOCKDOWN and EVACUATION drills conducted in partnership with the Wausau Police Department and School Resource Officers." },
      { item:"Neola Policies Update", body:"The committee reviewed proposed changes to 43 district policies covering a wide range of topics including board member conduct, employment of substitutes, student drug and intoxicant policies, school safety, drone use, wellness, free and reduced price meals, and various technical corrections to existing policies." },
    ],
    ...
    actionItems: [
      ...
      "Approve Neola Policies Update containing 43 policy revisions and technical corrections",
  ...
  },
  {
    ...
    isAgendaOnly: true,
    badge: "new",
    overview: "This special meeting of the Wausau School District Board of Education focused on closed session discussions regarding real estate negotiations and the evaluation of the Superintendent of Schools. The meeting addressed confidential matters requiring executive session under Wisconsin state statutes.",
    agenda: [
      { time:"0:00", item:"Call to Order" },
      ...
      { time:"0:20", item:"Evaluation of Superintendent of Schools s. 19.85 (1)(c)" },
      { time:"0:40", item:"Reconvene in Open Session, and if Necessary, Take Action as a Result of the Closed Session" },
      { time:"0:45", item:"Adjourn" },
    ],
    discussions: [
      { item:"Discussion regarding the Competitive Negotiations of a Purchase\/Sale of Real Estate", body:"The board entered closed session to discuss competitive negotiations related to the purchase or sale of real estate under Wisconsin Statute 19.85(1)(e). This exemption allows boards to meet privately when public discussion could compromise the district's bargaining position in real estate transactions." },
  ...
  },
  {
    ...
    discussions: [
      ...
      { item:"Red Granite Update", body:"Red Granite Principal Maud Mangin and Red Granite Governance Board President Amanda Molin shared an update on the status of the Red Granite Charter School. This presentation was estimated to take 5 minutes." },
      { item:"4K Program Agreement", body:"The Wausau School District four-year-old kindergarten program sought approval to enter into agreements with community collaboration partner sites for the 2026-2027 school year. Partners include Wausau Child Care, Mountain View Montessori, Woodson YMCA Wausau Branch, Newman Catholic Schools, and Marathon County Child Development Agency Head Start Program - Barrington Center." },
      { item:"Annual Safety Update \/ Drill Debrief", body:"At the November Education\/Operations Committee Meeting, Andy Grimm and members of the Wausau Police Department shared the annual safety update. They also provided information about the partnership between the Wausau Police Department and School Resource Officers." },
      { item:"Neola Policies Update", body:"At the November Education\/Operations Committee meeting, proposed changes to 43 attached policies were reviewed. These updates include policies on definitions, board member conduct, employment, student entrance age, academic honesty, school safety, wellness, and various other administrative matters." },
    ],
  ...
  },
  {
    ...
    isAgendaOnly: true,
    badge: "new",
    overview: "The Audit of the Bills Committee met to review and approve the district's financial expenditures for December 2025. This routine fiscal oversight meeting ensures proper review of Wausau School District bills before payment authorization.",
    agenda: [
      { time:"0:00", item:"Call to Order" },
    ...
    discussions: [
      { item:"Audit of the Bills", body:"Committee members reviewed the December 2025 audit of bills document, which details the district's expenditures requiring approval. The attachment dated December 9, 2025 contains itemized bills for committee examination and verification before payment processing." },
    ],
    publicComment: "No public comment period was included on this agenda.",
    actionItems: [
  ...
  },
  {
    ...
    isAgendaOnly: true,
    badge: "new",
    overview: "This special meeting of the Wausau School District Board of Education focuses primarily on closed session matters including administrator contracts, staff employment discussions, and real estate negotiations. The board will also recognize Ellie Mason with a resolution of commendation.",
    agenda: [
      { time:"0:00", item:"Call to Order" },
      { time:"0:02", item:"Request for Closed Session Pursuant to State Statutes" },
    ...
    discussions: [
      { item:"Approve Administrator Contracts and Discuss Performance and Employment of a Staff Member", body:"The board will meet in closed session under Wisconsin Statute 19.85(1)(c) to discuss and potentially approve administrator contracts. This session will also address performance and employment matters related to staff members." },
      { item:"Discussion regarding the Competitive Negotiations of a Purchase\/Sale of Real Estate", body:"The board will discuss real estate transactions in closed session under Wisconsin Statute 19.85(1)(e), which permits private deliberations on competitive negotiations for property purchases or sales." },
      { item:"Resolution of Commendation: Ellie Mason", body:"The board will consider a resolution of commendation honoring Ellie Mason. Supporting documentation for this recognition was attached to the agenda." },
    ],
    publicComment: "No public comment period was included on this agenda.",
    actionItems: [
  ...
  },
  {
    ...
    isAgendaOnly: true,
    badge: "new",
    overview: "The Education\/Operations Committee meeting featured a performance by John Muir Middle School students and focused on key administrative decisions including open enrollment seat availability for 2026-2027 and athletic co-op renewals. The meeting also addressed snow day communication procedures and concluded with a tour of recent updates to John Muir Middle School.",
    agenda: [
      { time:"0:00", item:"Call to Order" },
    ...
    discussions: [
      ...
      { item:"Snow Day Communication & Procedures", body:"Diana White and Dr. Katie Colwell presented information on communications and procedures for snow days. The presentation included information about what happens beyond the standard three snow days allotted to the district." },
      { item:"Approve Co-Ops", body:"Athletic Directors BJ Brandt and Darci Mick Beversdorf presented information on several athletic co-op renewals for the 2026-27 and 2027-28 school years, including boys hockey with East\/Merrill\/Newman Catholic, girls lacrosse with East\/West\/DCE\/Mosinee, and girls STORM hockey adding Merrill and Stratford to the existing co-op." },
    ],
    publicComment: "A public and student comment period was included on the agenda.",
    actionItems: [
  ...
  },
  {
    ...
    isAgendaOnly: true,
    badge: "new",
    overview: "This special meeting of the Wausau School District Board of Education focused on personnel matters including staff appointments, separations, and retirements. The board also convened closed sessions to address employee termination proceedings and administrator contracts.",
    agenda: [
      { time:"0:00", item:"Call to Order" },
    ...
    discussions: [
      { item:"Convene into closed session pursuant to Wis. Stat. 19.85(1)(b)", body:"The board convened into closed session to receive evidence concerning allegations regarding employee conduct and an administrative recommendation for termination. The board deliberated on evidence received during a quasi-judicial hearing and may have considered an employee resignation agreement." },
      { item:"Approve Administrator Contracts", body:"The board met in closed session to discuss and approve administrator contracts and to discuss the performance and employment of staff members under Wisconsin Statute 19.85(1)(c)." },
    ],
    publicComment: "No public comment period was included on this agenda.",
    actionItems: [
      "Approve Consent Agenda including appointments, separations, leaves of absence, and retirements",
      "Take action on employee termination or resignation agreement following closed session deliberations",
  ...
  },
  {
    ...
    isAgendaOnly: true,
    badge: "new",
    overview: "This regular meeting of the Wausau School District Board of Education covered the approval of the 2024-25 audit report, WASB delegate voting directions, a discussion on replacing the Wausau West chiller system, and several cooperative athletic agreements. The board also addressed open enrollment seat availability for the upcoming school year and planned closed session discussions regarding potential litigation and superintendent evaluation.",
    agenda: [
      { time:"0:00", item:"Call to Order" },
    ...
    discussions: [
      { item:"Approve the 2024-25 Audit Report", body:"Amber Ebert from Hawkins Ash CPAs presented the results of the Wausau School District's June 30, 2025 Audited Financial Statements to the Board. This presentation was estimated to take 15 minutes." },
      ...
      { item:"Resolution Authorizing Entry into Wisconsin Investment Series Cooperative Agreement", body:"Assistant Superintendent of Operations Elizabeth Channel presented a resolution to allow the District to continue its membership in the Wisconsin Investment Series Cooperative. The District has been a member for many years, and this resolution updates authorization that is over ten years old." },
      { item:"Open Enrollment Seat Availability", body:"Following the December Education\/Operations Committee Meeting presentation by Wendy Cartledge, the Board considered the Open Enrollment Space Determinations for the 2026-2027 school year." },
      { item:"Approve Co-Ops", body:"The Board considered renewal of several athletic cooperative agreements including boys hockey East\/Merrill with Newman Catholic, girls lacrosse East\/West\/DCE\/Mosinee, and girls STORM hockey East\/West\/DCE\/Mosinee with the addition of Merrill and Stratford for the 26-27 and 27-28 school years." },
    ],
  ...
  },
  {
    ...
    isAgendaOnly: true,
    badge: "new",
    overview: "This Audit of the Bills Committee meeting focused on reviewing and approving financial expenditures for the Wausau School District. The meeting was a routine financial oversight session to ensure proper accounting of district funds.",
    agenda: [
      { time:"0:00", item:"Call to Order" },
      { time:"0:02", item:"Audit of the Bills" },
      { time:"0:07", item:"Adjourn" },
    ...
    discussions: [
      { item:"Audit of the Bills", body:"The committee reviewed the district's bills and expenditures as documented in the January 26 attachment. This routine financial review ensures proper oversight of district spending and accounting practices." },
    ],
    publicComment: "No public comment period was included on this agenda.",
    actionItems: [
      "Review and approval of audited bills for January 26, 2026",
    ],
  },
  {
    ...
    isAgendaOnly: true,
    badge: "new",
    overview: "The Wausau School District Education\/Operations Committee meeting addressed major referendum construction projects reaching the 95% design phase for four elementary schools, reviewed quarterly legal expenses, and considered the 2026-2027 school calendar. The meeting also covered financial projection modeling assumptions and student demographic data for the current school year.",
    agenda: [
      { time:"0:00", item:"Call to Order" },
      { time:"0:02", item:"Approve the Minutes" },
    ...
    discussions: [
      { item:"Franklin, Rib Mountain, Lincoln & John Marshall 95% Design", body:"Referendum projects for Franklin, Rib Mountain, Lincoln, and John Marshall Elementary schools have reached 95% design completion. The Board reviewed the designs and budgets and was asked to approve these plans to be issued for competitive bidding." },
    ...
    actionItems: [
      ...
      "Approve Franklin, Rib Mountain, Lincoln & John Marshall Elementary 95% designs for competitive bidding",
      "Approve 2026-2027 District Calendar",
      "Consider governance model changes regarding Audit of the Bills Committee and Education\/Operations Committee renaming",
    ],
  },
  {
    ...
    isAgendaOnly: true,
    badge: "new",
    overview: "This special meeting of the Wausau School District Board of Education focused on personnel matters through the consent agenda, approval of the 2026-2027 district calendar, and a closed session for the Superintendent's evaluation. The meeting addressed routine staffing changes and finalized the upcoming school year calendar previously presented to the board.",
    agenda: [
      { time:"0:00", item:"Call to Order" },
    ...
    discussions: [
      { item:"Approve 2026-2027 District Calendar", body:"Diana White previously presented a draft of the 2026-2027 school year calendar at an earlier meeting for School Board review. This item brings the calendar back for formal board approval with an estimated presentation time of one minute." },
      { item:"Evaluation of Superintendent of Schools", body:"The board entered closed session pursuant to Wisconsin Statute s. 19.85 (1)(c) to conduct the evaluation of the Superintendent of Schools. The board may reconvene in open session to take action resulting from the closed session discussion." },
    ],
    publicComment: "No public comment period was included on this agenda.",
    actionItems: [
  ...
  },
  {
    ...
    isAgendaOnly: true,
    badge: "new",
    overview: "The Wausau School District Board of Education held a regular meeting covering referendum project designs for four elementary schools, a chiller system replacement at Wausau West, and an update on the disbanded East\/Merrill Boys Hockey Co-Op. The meeting also addressed financial projections, governance model changes, and included a closed session for real estate negotiations.",
    agenda: [
      { time:"0:00", item:"Call to Order" },
      { time:"0:02", item:"Roll Call" },
      { time:"0:04", item:"Pledge of Allegiance" },
    ...
    discussions: [
      ...
      { item:"Wausau West Chiller System", body:"Interim Assistant Superintendent of Operations Elizabeth Channel and Director of Buildings and Grounds Ryan Urmanski presented a request to approve the bid for replacement of the chiller system at Wausau West High School." },
    ...
    actionItems: [
      ...
      "Closed session action regarding competitive negotiations of real estate purchase\/sale",
    ],
  },
  {
    ...
    agenda: [
      ...
      { time:"0:26", item:"Reconvene in Open Session, to take further action if necessary and appropriate" },
      { time:"0:28", item:"Adjourn" },
    ],
    discussions: [
      { item:"Preliminary Discussion Regarding Potential Litigation 19.85 (g)", body:"The board entered closed session under Wisconsin State Statute 19.85(g) to conduct preliminary discussions regarding potential litigation against or on behalf of the district. This statute allows for confidential deliberation when litigation is possible or pending." },
    ],
    publicComment: "No public comment period was included on this agenda.",
    actionItems: [
  ...
  },
  {
    ...
    isAgendaOnly: true,
    badge: "new",
    overview: "The Wausau School District Board of Education's Committee of the Whole meeting addressed significant financial planning through a five-year fiscal forecast, reviewed mid-year AGR school performance data, and considered extensive policy updates through NEOLA. The meeting also featured recognition segments for the district planetarium and Wausau West High School, with a tour following adjournment.",
    agenda: [
      { time:"0:00", item:"Call to Order" },
      { time:"0:02", item:"Approve the Minutes" },
      ...
      { time:"0:23", item:"Public and Student Comment" },
      { time:"0:35", item:"Five Year Fiscal Forecast" },
      { time:"0:50", item:"AGR Annual Report" },
      { time:"1:00", item:"NEOLA UPDATE (Action Requested)" },
      { time:"1:20", item:"Referendum Budget Update" },
      { time:"1:30", item:"Adjourn" },
    ],
    discussions: [
      { item:"Five Year Fiscal Forecast", body:"The Board received a five-year fiscal forecast model for the District, which will be used over the next three months to develop the 2026-27 budget reconciliation plan and final budget. Administration noted that projections involve many variables that change periodically, and significant changes will be communicated to the Board as they occur." },
      { item:"AGR Annual Report", body:"This mid-year update presented AGR student outcome scores required by DPI, including screening results from the three AGR schools. The report highlighted systemic improvements and organizational changes being implemented at each school to strengthen practices and improve student achievement." },
      { item:"NEOLA UPDATE", body:"The Committee reviewed proposed changes to numerous policies ranging from board member conduct and district administrator relationships to student policies on cell phones, academic honesty, homeless students, and third grade promotion. Additional policies addressed school support organizations, fundraising, crowdfunding, and technical corrections across various administrative areas." },
      { item:"Referendum Budget Update", body:"The Board received an update on the April 2022 referendum-funded facility improvements, with construction and budget updates to continue routinely until projects are completed. Following adjournment, board members were invited to tour recent updates at Wausau West High School and the Planetarium." },
    ],
    publicComment: "A Public and Student Comment period was included on the agenda.",
    actionItems: [
      "NEOLA policy updates approval for policies including definitions, board member conduct, student supervision, reading instruction goals, cell phone policy, third grade promotion, debt management, fund balance, and school support organization policies",
    ],
  },
  {
    ...
    isAgendaOnly: true,
    badge: "new",
    overview: "This special meeting of the Wausau School District Board of Education was convened to conduct a pupil expulsion hearing in closed session. The Board was authorized to deliberate privately and potentially take action regarding the student matter under Wisconsin Statutes governing student records and closed sessions.",
    agenda: [
      { time:"0:00", item:"Call To Order" },
      { time:"0:02", item:"Motion to convene in closed session for pupil expulsion hearing pursuant to s. 19.85(1)(a), (f), and (g) and s. 118.125 of Wisconsin Statutes" },
      { time:"0:05", item:"Adjournment" },
    ],
    discussions: [
      { item:"Closed Session - Pupil Expulsion Hearing", body:"The Board convened in closed session pursuant to Wisconsin Statutes sections 19.85(1)(a), (f), and (g), and section 118.125 to conduct a pupil expulsion hearing. The Board was authorized to deliberate privately following the hearing and could take action in closed session if necessary. Upon reconvening in open session, further action could be taken if appropriate." },
    ],
    publicComment: "No public comment period was included on this agenda.",
    actionItems: [
      "Motion to convene in closed session for pupil expulsion hearing",
      "Motion to reconvene into open session",
      "Potential action on pupil expulsion matter",
      "Motion to adjourn",
    ],
  },
  {
    ...
    isAgendaOnly: true,
    badge: "new",
    overview: "This public meeting brought together the Elementary Task Force one year after the elementary school consolidation process to reflect on the changes implemented in the Wausau School District. The reunion focused on summarizing the consolidation outcomes and gathering reflections from task force members on the process.",
    agenda: [
    ...
    discussions: [
      { item:"Summary of Elementary Consolidation", body:"This item provided an overview of the elementary school consolidation process that was implemented in the Wausau School District. The summary likely covered the outcomes, changes made, and impacts of consolidating elementary schools." },
      { item:"Task Force Member Reflectives: One Year Later", body:"Task force members shared their reflections on the consolidation process one year after implementation. Members provided perspectives on how the changes have affected students, staff, and the community since the consolidation took effect." },
    ],
    publicComment: "No public comment period was included on this agenda.",
    actionItems: [
  ...
  },
  {
    ...
    isAgendaOnly: true,
    badge: "new",
    overview: "This was a WEA-sponsored event allowing the public to meet school board candidates for the upcoming election. A quorum of the Board of Education may have been present, but no official board action was taken as this was an informational meet and greet event.",
    agenda: [
      { time:"0:00", item:"WEA Sponsored WSD School Board Candidates Meet & Greet Event" },
    ],
    discussions: [
      { item:"WEA Sponsored WSD School Board Candidates Meet & Greet Event", body:"This event was sponsored by the WEA (Wausau Education Association) to provide an opportunity for the public to meet candidates running for the Wausau School District Board of Education. While a quorum of current board members may have attended, no official board business or action was conducted." },
    ],
    publicComment: "No public comment period was included on this agenda.",
    actionItems: [
  ...
  },
  {
    ...
    isAgendaOnly: true,
    badge: "new",
    overview: "The Wausau School District Board of Education regular meeting addressed routine consent agenda items including personnel matters and bill payments, while also considering a proposal to switch middle school one-to-one devices from Chromebooks to iPads. The meeting included updates on the 2022 referendum-funded facility improvements, a five-year fiscal forecast, and Achievement Gap Reduction (AGR) program annual report.",
    agenda: [
      { time:"0:00", item:"Call to Order" },
      { time:"0:02", item:"Roll Call" },
      { time:"0:04", item:"Pledge of Allegiance" },
      ...
      { time:"0:55", item:"New Business - Committee of the Whole Meeting Items" },
    ...
    discussions: [
      ...
      { item:"iPads Presentation", body:"Information on switching one-to-one devices at the middle school from Chromebooks to iPads was presented, with an estimated 20 minutes allocated for the presentation." },
      ...
      { item:"AGR Annual Report", body:"The Committee was presented with mid-year AGR student outcome scores required by DPI, featuring screening results and work being done in each of the three AGR schools to strengthen organizational systems. The update demonstrated how these schools are evolving their practices to improve student achievement." },
    ],
    ...
    actionItems: [
      ...
      "Vote on iPads Presentation proposal to switch middle school devices from Chromebooks to iPads",
    ],
  },
  {
    ...
    isAgendaOnly: true,
    badge: "new",
    overview: "The Wausau School District Board of Education Committee of the Whole meeting addressed facility fee updates for artificial fields, a referendum budget update, and an extensive NEOLA policy review covering over 60 policies including cell phone use, AI policy, child abuse reporting under Act 57, and school support organizations. The meeting also included recognition of Stettin Elementary and approval of continued membership in the Wisconsin School Nutrition Purchasing Cooperative.",
    agenda: [
      { time:"0:00", item:"Call to Order" },
      { time:"0:02", item:"Approve the Minutes" },
    ...
    discussions: [
      ...
      { item:"NEOLA UPDATE", body:"The Committee reviewed proposed changes to numerous district policies, ranging from small technical corrections to more lengthy substantive changes. Policies reviewed covered areas including board member conduct, district administrator relationships, reading instruction goals, student cell phones, academic honesty, AI usage, homeless students, third grade promotion, purchasing, child abuse and neglect under Act 57, and school support organizations." },
    ],
    publicComment: "No public comment period was included on this agenda.",
    actionItems: [
      ...
      "Review and approve NEOLA policy updates including definitions, board member conduct, reading instruction goals, cell phone policy, AI policy, and Act 57 related child abuse reporting policies",
