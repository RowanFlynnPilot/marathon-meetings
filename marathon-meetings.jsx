...
const MEETINGS = [
  {
    ...
    date: "May 16, 2026", shortDate: "MAY 16",
    ...
    isAgendaOnly: false,
    badge: "new",
    overview: "The Marathon County Health & Human Services Committee held an organizational meeting to orient new members, reviewing committee structure, ordinances, and receiving educational presentations from four county departments. Minutes from April 1st were unanimously approved, and no action items were taken as this was primarily an informational session.",
    agenda: [
      { time:"0:00", item:"Call to order and roll call (noting remote attendance)" },
      { time:"0:30", item:"Pledge of Allegiance" },
      { time:"1:15", item:"Approval of April 1st committee meeting minutes" },
      { time:"1:58", item:"Operational functions required by statute (no items this meeting)" },
      { time:"3:30", item:"Review of standing committee ordinances, mission, duties and jurisdiction" },
      { time:"12:45", item:"Health Department presentation by Health Officer Caitlyn Suginaka" },
    ...
    discussions: [
      { item:"Approval of April 1st meeting minutes", body:"Supervisor Cavelli made a motion to approve the minutes, seconded by Vice Chair Rosenberg. The motion passed unanimously with all members voting aye." },
      { item:"Review of committee ordinances and jurisdiction", body:"Administrator Lance Leonard explained the committee's structure under ordinance section 2.04 sub 5, covering jurisdiction over Health Department, Social Services, and Veteran Services. He outlined reporting relationships with multi-county entities including North Central Health Care and the Aging Disability Resource Center, as well as statutory boards like the Social Services Board and Veterans Service Commission. Chair Boots noted the upcoming strategic plan development expected to be completed by December." },
      { item:"Health Department presentation", body:"Health Officer Caitlyn Suginaka presented the department's mission of preventing disease, promoting health, and protecting from environmental hazards. She highlighted 1,200+ licenses overseen, a new tick kit public health vending machine initiative, the Nurse Family Partnership program graduating its first two-year-olds after three years, and a new FTE position for homeless system response. The department has 37.6 FTE across four divisions. Administrator Leonard noted approximately half of the $5 million budget is tax levy, with environmental health services designed to be self-supporting through fees." },
      { item:"Social Services Department overview", body:"Administrator Leonard presented on behalf of Director Christa (not present), describing the department's nearly 140 FTE staff covering child welfare, youth justice, children's long-term support, economic support, and child support. He highlighted the successful Family Keys housing stability pilot program, one of three counties selected statewide to address housing instability among child welfare and youth justice families. The department's 2026 budget shows $22 million total with approximately $7 million in tax levy." },
      { item:"Veteran Services Department presentation", body:"VSO Erin Galindo reported his department increased from 2.75 to 3.0 FTE as of 2025. Customer interactions jumped from 5,900 in 2024 to 8,149 in 2025. He highlighted that veterans received $44 million annually in benefits plus $2.6 million in retroactive payments in 2025. Key initiatives include surviving spouse benefits outreach, partnership with Center for Veterans Issues for veteran housing (serving 30-70 veterans), and suicide prevention efforts following 7 veteran suicides among 30 total county suicides in 2025. He noted the department is working toward the Staff Sergeant Gordon Fox suicide prevention grant." },
      { item:"ADRC presentation", body:"Executive Director Mike Ray explained the four-county regional model serving Marathon, Lincoln, Langlade, and Wood counties with about 60 FTEs and 385-400 volunteers. He described services including meals on wheels, Medicare\/Medicaid assistance, falls prevention, and dementia care. Ray noted significant financial challenges with federal nutrition funding flat since 2024 while food costs increased 40-45% over four years, forcing meal and service reductions. Marathon County's 2026 contribution is $413,135. The ADRC had not requested a levy increase from 2011 until 2024." },
    ],
    ...
    actionItems: [
      ...
      "Next meeting scheduled for Tuesday, June 3rd at 3 PM (date corrected from originally stated May 29th)",
      "Committee members invited to submit agenda items via email to Chair Boots and Administrator Leonard",
    ],
  },
  {
    ...
    isAgendaOnly: false,
    badge: "new",
    overview: "The Marathon County Board of Supervisors held an adjourned organizational meeting where they approved committee appointments, elected Supervisors Hapa and Arstead to the Executive Committee, and unanimously passed a resolution reducing landfill tipping fees for storm debris following the April severe weather that devastated parts of Ringle and other communities. The board heard emotional public testimony from affected residents requesting additional fee relief.",
    agenda: [
      ...
      { time:"5:01", item:"Chair remarks on committee appointments and leadership philosophy" },
      { time:"10:01", item:"Election of at-large Executive Committee members" },
      { time:"20:00", item:"Consent agenda (Items C10-C14A)" },
      { time:"20:45", item:"Resolution D15 - Out of home placement reserve increase" },
      { time:"21:30", item:"Resolution D16 - Social services budget amendment" },
      { time:"22:00", item:"Resolution E17 - Landfill tipping fee modification for storm debris" },
      { time:"1:10:02", item:"Vote on tipping fee resolution" },
      { time:"1:13:00", item:"Announcements and adjournment" },
    ],
    discussions: [
      { item:"Committee Appointments", body:"Chair Gibbs presented committee appointments developed with Vice Chair Boots, emphasizing goals of increasing diversity of perspective, developing new supervisors as leaders, and honoring supervisor preferences. The motion was made by Supervisor Cavelli, seconded by Supervisor Crims. The motion carried but was not unanimous, with technical issues noted where Supervisor [name unclear] was marked absent but wished to be recorded as voting aye." },
      { item:"Election of At-Large Executive Committee Members", body:"Three supervisors were nominated for two at-large positions: Supervisor Hapa (nominated by Supervisor Mask), Supervisor Leur (nominated by Supervisor Rosenberg), and Supervisor Arstead (nominated by Vice Chair Boots). Supervisor Rosenberg explained her nomination of Supervisor Leur, citing her advocacy for 'our county's smallest children and our oldest elders.' After paper ballot voting, Supervisors Hapa and Arstead were elected to the Executive Committee." },
      { item:"Consent Agenda", body:"Items C10 through C14A were approved on consent agenda. Motion by Supervisor Cavelli, seconded by Supervisor Drebeck. The motion carried unanimously." },
      { item:"Out of Home Placement Reserve Increase (Resolution 24-26)", body:"Motion by Supervisor Morash, seconded by Supervisor Robinson. The motion carried but was not unanimous." },
      ...
      { item:"Landfill Tipping Fee Modification for Storm Debris (Resolution 26-26)", body:"Administrator Leonard and Solid Waste Director Hagen Busher presented a proposal from the Solid Waste Management Board to reduce tipping fees for debris from the April severe weather emergency. The standard $65\/ton gate rate would be reduced to approximately $36.94\/ton by removing the $13.10 state fee (waived by emergency declaration), the $2.33 Ringle fee (town is waiving), and reducing to the commercial contract rate. Leonard noted the county will not meet the $670,743 threshold for state disaster aid, but expects Ringle to qualify. Two residents, Jessica Tolesie and Matt Haybeck, were granted special permission to speak, requesting the county waive all fees entirely and extend relief for six months, citing ongoing insurance delays and the hardship on affected families. Director Hagen Busher cautioned about Dane County's experience in the 1990s where waiving fees entirely resulted in FEMA denying reimbursement. The board voted unanimously to suspend rules to consider the resolution, then passed Resolution 26-26 unanimously." },
    ],
    publicComment: "Two residents were granted special permission to address the board regarding the tipping fee resolution. Jessica Tolesie requested Marathon County waive fees entirely for six months, noting businesses have donated up to $40,000 in cleanup efforts and that the state, DNR, and Ringle are all waiving their portions. She stated 'We did not see anyone from Marathon County' during cleanup and asked for equal contribution from the county. Matt Haybeck spoke on behalf of residents with demolished homes, noting some of the approximately 44 affected homes are still waiting for insurance adjusters and requesting extended fee relief.",
    actionItems: [
      ...
      "Resolution 26-26 approved reducing landfill tipping fees for storm debris through June 17, 2025",
      "Administrator Leonard to continue discussions with Community Foundation regarding potential reimbursement mechanism for unreimbursed cleanup costs",
      "Solid Waste Management Board to develop long-term policy on handling disaster-related fee reductions within six months",
      "Board will revisit tipping fee extension at May meeting if needed",
    ],
  },
  {
    ...
    isAgendaOnly: false,
    badge: "new",
    overview: "The Marathon County Environmental Resources Committee approved two rezoning petitions unanimously and voted to forward a modified tornado relief fee waiver proposal to the county board. The committee amended the fee waiver to cover only septic system reconnect fees ($160) rather than the broader waiver originally proposed by staff for properties impacted by the April 17, 2026 tornado.",
    agenda: [
      ...
      { time:"13:30", item:"Public hearing: Jeffrey and Cynthia Schmidtz rezoning petition (conservancy recreation to general agriculture, Town of McMillan)" },
      { time:"19:00", item:"Consideration of fee waiver for properties impacted by April 17, 2026 severe weather" },
      { time:"55:00", item:"Educational presentations: Department overviews" },
      { time:"57:00", item:"Solid Waste Department presentation by Dave Hagen Busher" },
      { time:"1:15:30", item:"Parks, Recreation and Forestry presentation by Tom Lovelin" },
      { time:"1:35:00", item:"Conservation, Planning and Zoning presentation by Lori Mskimmons" },
    ],
    discussions: [
      { item:"Approval of March 31, 2026 minutes", body:"Supervisor Sefeld moved to approve the minutes, seconded by Supervisor Drebeck. The motion carried unanimously with no discussion." },
      { item:"Tim Veland rezoning petition (Town of Green Valley)", body:"Garrett Pogle presented the staff report for rezoning from urban residential and general agriculture to rural residential for a proposed land division. The Town of Green Valley recommended approval on March 10, 2026. No public testimony was offered. Supervisor Drebeck moved to approve based on findings of fact and town approval, seconded by Supervisor Kurt. Motion carried unanimously." },
      { item:"Jeffrey and Cynthia Schmidtz rezoning petition (Town of McMillan)", body:"The petition sought to rezone from conservancy recreation to general agriculture. Supervisor Leur asked about the conservancy designation, and Garrett Pogle explained the property contains a home and horse riding stable, with the rezoning needed to make the home a conforming use. The Town of McMillan recommended approval on April 20, 2026. Supervisor Sefelt moved to approve, seconded by Supervisor Drew. Motion carried unanimously." },
      { item:"Tornado relief fee waiver consideration", body:"Director Lori Mskimmons presented a proposal to waive county zoning and septic system fees for properties damaged by the April 17, 2026 tornado. Significant debate ensued. Supervisor Drew questioned where to draw the line for future disasters. Supervisor Drebeck expressed concern about fairness to individuals hit by disasters not declared emergencies. Supervisor Sefelt questioned staff time costs and potential levy impacts. Administrator Lance Leonhard clarified this wouldn't require a budget amendment. Supervisor Sefelt moved to approve the full resolution; Supervisor Leur seconded. Supervisor Drebeck then amended the motion to limit fee waivers to only reconnect permits ($160) for existing septic systems, not new system installations or zoning fees. Supervisor Kurt seconded the amendment. The amendment carried. The amended motion then passed, though not unanimously." },
    ],
    publicComment: "No public comment was offered.",
    actionItems: [
      "Forward amended resolution to county board waiving only septic system reconnect fees ($160) for properties damaged by April 17, 2026 tornado",
      "Two rezoning petitions forwarded to Marathon County Board of Supervisors for final approval",
