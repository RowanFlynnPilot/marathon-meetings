...
const MEETINGS = [
  {
    ...
    isAgendaOnly: false,
    badge: "new",
    overview: "The Wausau City Council approved a development agreement for the 11 Scott Street\/Waterside Place project (6-3 vote), recognized city workers for their response to a record 30.9-inch snowfall, and presented sustainability awards to Colby and Colby Millwork. The council also approved a 7-year solid waste contract with Harter's Fox Valley Disposal and handled several routine matters.",
    agenda: [
      ...
      { time:"21:00", item:"Approval of March 10, 2026 meeting minutes" },
      { time:"21:30", item:"Public Comment" },
      { time:"23:30", item:"Consent Agenda" },
      { time:"24:00", item:"Development Agreement - 11 Scott Street LLC" },
      { time:"36:00", item:"Appointments to Plan Commission and other boards" },
      { time:"37:02", item:"Solid Waste Agreement with Harter's Fox Valley Disposal" },
    ],
    discussions: [
      { item:"Sarah Rafi Day Proclamation", body:"Mayor Denny read a proclamation declaring March 31st as Sarah Rafi Day in Wausau. Rafi, a local attorney diagnosed with stage 4 brain cancer (glioblastoma) in July, was recognized for her contributions as an attorney, author, and community leader. The mayor noted Brad Gessel also recently passed from the same disease." },
      { item:"DPW Snow Response Recognition", body:"Mayor Denny presented a mayoral citation to the Department of Public Works for their response to the record 30.9-inch snowfall from March 14-16, 2026. Kevin Kester, Dustin, Josh (street supervisors), Mitch Harris (storeroom manager), and fleet technicians including Jieven Matah were recognized. Kester emotionally thanked the plow crews, stating 'you kicked its ass' and noting some staff worked 12 straight days without a day off." },
      { item:"Sustainability Award - Colby and Colby Millwork", body:"Christine Daniels of the Sustainability, Energy and Environment Committee presented the 2026 City of Wausau Sustainability Award to Colby and Colby Millwork. Keith Kaning and Mike Thompson accepted, describing their 2,000+ solar panel installation (operational since July 2025) that generates enough power for about 120 homes, plus LED lighting upgrades and recycling initiatives for wood, aluminum, glass, and vinyl scrap." },
      { item:"11 Scott Street Development Agreement", body:"The council approved the development agreement and amended parking agreement for the Waterside Place project at 11 Scott Street by a 6-3 vote. Developer Mark Craig and Raleigh Lray spoke in support of the $10+ million project to convert a vacant 100,000 sq ft building into 52 mid-priced apartments. Alder Rasmusson supported adding downtown residents and reclaiming parking spaces. Alder Neil cited $55,000 annual parking revenue and TID 8 closure timeline benefits. Alder Larson dissented, arguing against discounting city assets. Alder Tyranny questioned the city's obligation to provide 150 parking spaces within 300 yards if the ramp closes. Economic Development Director Randy Feifer explained this reduced existing commitments from 480 to 150 spaces and the ramp has 50+ years of expected life." },
      { item:"Solid Waste Agreement with Harter's Fox Valley Disposal", body:"The council unanimously approved (9-0) a 7-year residential solid waste and recycling service agreement with Harter's Fox Valley Disposal, correcting the previously confused term length from the Public Health and Safety Committee's recommendation." },
      { item:"Settlement Resolution - David Holes vs City of Wausau", body:"Assistant City Attorney Vincent Bonito explained a 2022 bus accident settlement. Transit Mutual (insurer) had paid the claim, and the individual's insurer agreed to pay bus damages. The council approved the release of claims 8-1 without needing closed session." },
    ],
    publicComment: "Two speakers addressed the council during public comment. Raleigh Lray asked for support for the 11 Scott Street green sustainable project converting a vacant building to mid-priced apartments. Mark Craig (3246 North 8th Street) joined her, noting the $10+ million project creating 52 residential units won't happen without council support, referencing the previous 7-4 term sheet vote.",
    actionItems: [
      "Development agreement and parking agreement for 11 Scott Street LLC approved (6-3)",
      "7-year solid waste contract with Harter's Fox Valley Disposal approved",
      "Sarah Rafi Day proclaimed for March 31st",
      ...
      "2026 budget modification approved for Police Department Red Dot Optics purchase",
      ...
      "Settlement release approved for David Holes case (8-1)",
    ],
    civicItems: [
  ...
  },
  {
    ...
    title: "knWZO4dON-8",
    date: "April 3, 2026", shortDate: "APR 3",
    committee: "Plan Commission", duration: "~1h",
    url: "https://www.youtube.com/watch?v=knWZO4dON-8",
    docUrl: null,
    isAgendaOnly: false,
    badge: "new",
    overview: "The Plan Commission approved two significant items: a conditional use permit for a 70-unit, 7-story apartment building at 731 North First Street for Beacon Resources LLC, and a transportation project plat for Grand Avenue signal replacements. A public hearing was held regarding a personal storage facility at 218 South Fourth Street, with the applicants citing growing downtown residential development as justification for the need.",
    agenda: [
    ...
    discussions: [
      ...
      { item:"Public hearing on conditional use permit for 218 South Fourth Street (personal storage facility)", body:"Jason Dunwy and Melinda Don Woody spoke in favor of the storage facility, noting that downtown Wausau has added over 400 new apartment units recently including the 153-unit Foundry on Third and 102-unit Evergreen Landing projects. They argued apartment living provides limited storage and there are currently no convenient downtown storage options, forcing residents to travel to areas like Kroner. No vote was taken on this item during this meeting; only the public hearing was held." },
      { item:"Conditional use permit for 731 North First Street (70-unit, 7-story apartment building)", body:"Motion to approve made by Bornman, seconded by Bugamin. No discussion or questions were raised by commissioners. The permit for Beacon Resources LLC passed unanimously by voice vote." },
      { item:"Transportation project plat for Grand Avenue signal replacements at Sturgeon and Townline Road", body:"Motion to approve made by Bugamin, seconded by Balkan. No discussion was held. The project plat (Project 370-40-40) passed unanimously by voice vote." },
    ],
    publicComment: "One email comment was submitted by Linda Lawrence on March 12th expressing support for the Beacon Resources apartment proposal, stating housing of this capacity will benefit downtown small businesses and she would personally live there. Jason Dunwy and Melinda Don Woody spoke in person during the public hearing on the storage facility item, advocating for downtown storage options to serve new apartment residents.",
    actionItems: [
  ...
  },
  {
    ...
    isAgendaOnly: false,
    badge: "new",
    overview: "The Marathon County Board of Supervisors held an educational meeting featuring presentations on PFAS contamination litigation and renewable energy regulation. The board heard from attorneys about opportunities to join multi-district litigation against chemical manufacturers for PFAS cleanup costs, and received extensive education on county authority regarding wind and solar energy projects proposed in the county.",
    agenda: [
      ...
      { time:"1:01:30", item:"Presentation on renewable energy regulatory authority for Wisconsin counties" },
      { time:"1:45:00", item:"Discussion of county options for wind\/solar project negotiations" },
    ],
    discussions: [
      { item:"Public Comment", body:"Five residents spoke during public comment. Cindy Nelson from Stratford reported going door-to-door to 200 houses about wind turbine projects and stated no one she spoke with wants wind turbines. Wendy Rowski from Green Valley urged the board to vote no on advancing the comprehensive plan in its current form, specifically objecting to the use of the term 'farm' for industrial-scale energy facilities. Barb Newton and Cindy Hogan from Rib Mountain spoke in support of reducing speed limits and establishing a no-passing zone on Double N Road, noting 75 residents signed a petition. Heidi Pesky from McMillan argued against joint development agreements for wind projects, citing numerous potential risks to the county." },
      { item:"PFAS Multi-District Litigation Presentation", body:"Attorney Carrie McDougall from Baron and Bud Law Firm presented via WebEx on the PFAS litigation opportunity. He explained the firm serves as co-lead counsel in the nationwide MDL consolidated in Charleston, South Carolina before Judge Richard Gurgle. The water provider settlement totaled approximately $12-13 billion from 3M and $3-5 billion from DuPont. McDougall explained that soil-based claims (airports, landfills, wastewater) were excluded from the water settlement and may be next for litigation. The contingency fee arrangement is 25% with no upfront costs to the county. Vice Chair Dickinson noted the airport has no known PFAS contamination currently. Supervisor Robinson asked detailed questions about scope of claims and recovery potential. The presentation was informational with a resolution scheduled for potential action next week." },
      { item:"Renewable Energy Regulatory Authority Presentation", body:"Attorney Rebecca Roker from Atolis Law, representing Wisconsin Counties Association, presented on county authority regarding wind and solar projects. She explained that projects over 100 megawatts fall under PSC jurisdiction, significantly limiting local control. Roker noted the PSC has approved 33 solar projects with zero denials. She discussed the Hub City Wind project from Alliant Energy and the Stormark Wind Energy Center as proposed projects affecting Marathon County. She outlined four options for counties: do nothing, negotiate a joint development agreement (JDA), intervene in PSC proceedings, or litigate. Roker strongly recommended JDAs as the most effective tool to protect county interests, noting they can address liability, environmental protection, noise, roads, decommissioning, and emergency response - protections not otherwise available under state law." },
    ],
    publicComment: "Five speakers addressed the board: Cindy Nelson (Stratford\/Oplane Township) opposed wind turbines, reporting 200 residents she surveyed were against them; Wendy Rowski (Green Valley) urged the board to reject the comprehensive plan draft and change terminology from 'wind\/solar farms' to 'industrial energy facilities'; Barb Newton (Rib Mountain) supported speed reduction on Double N Road citing near head-on collisions; Heidi Pesky (McMillan) argued against joint development agreements for wind projects, listing numerous potential risks; Cindy Hogan (Rib Mountain) supported the Double N Road speed reduction and no-passing zone, noting 75 petition signatures.",
    actionItems: [
      "Board to consider resolution on joining PFAS multi-district litigation at next week's meeting",
      "Comprehensive plan draft scheduled for vote next week - public urged board to send back for revisions",
      "County to identify potential PFAS exposure sites for testing (airport, landfill, wastewater) if litigation is pursued",
      "County leadership to consider options for engaging with proposed wind energy projects including possible JDA negotiations",
    ],
  },
  {
    ...
    isAgendaOnly: false,
    badge: "new",
    overview: "The Board of Public Works held a brief meeting to open bids for the 2026 asphalt paving project. RC Pavers was awarded the contract with a bid of $824,146.34, beating out American's higher bid.",
    agenda: [
    ...
    discussions: [
      { item:"2026 Asphalt Paving Project Bid Opening", body:"Two bids were opened for the asphalt paving project. RC Pavers submitted the low bid at $824,146.34, while American submitted a bid of $849,872.10. A motion was made to approve RC Pavers as the winning bidder, which was seconded and passed unanimously with all members voting 'aye.'" },
    ],
  ...
  },
  {
    ...
    isAgendaOnly: false,
    badge: "new",
    overview: "The Board of Public Works approved several construction contracts and pay estimates, including awarding the 26th Street construction project to Switlick as the lowest bidder at $1,279,894.75, and approving a change order for the Rolph Street\/Cherry Street project. The meeting was brief with all items passing unanimously.",
    agenda: [
      ...
      { time:"1:42", item:"North 8th Avenue bid opening - postponed" },
      { time:"1:55", item:"2025 Street Construction Project A - Rolph Street, Cherry Street Change Order One" },
    ...
    discussions: [
      { item:"March 10th Board of Public Works Minutes", body:"The minutes from the March 10th regular meeting were considered. A motion was made and seconded. Approved unanimously with all members voting aye." },
      { item:"26th Street Construction Project Bid Opening", body:"Seven bids were opened and read aloud. Switlick submitted the lowest bid at $1,279,894.75, followed very closely by Haas at $1,280,877.96. Other bidders included A1 ($1,374,600), Francis Melvin ($1,385,383), Steen ($1,489,126), James Peterson ($1,570,698.56), and Earth ($1,686,784.75). A motion to approve Switlick was made and seconded, noting the remarkably tight bids. Approved unanimously." },
      ...
      { item:"Rolph Street\/Cherry Street Change Order One", body:"Staff presented change order one totaling $14,436.50 for Haas Suns Incorporated. The change order covered four items: an inside drop on a manhole for $4,856 due to an unrecorded large diameter sanitary service; water main connection changes for $2,317.50 due to finding 6-inch pipe instead of the expected 8-inch; miscellaneous storm sewer tie-ins at $66 per lineal foot totaling $5,016; and geogrid installation for $2,247 due to poor soils near Thomas Jefferson Elementary. Change order two regarding liquidated damages was deferred for further discussion. Motion approved unanimously." },
      { item:"Rolph Street\/Cherry Street Pay Estimate Number Nine", body:"Staff recommended approval of pay estimate number nine from Haas Suns Incorporated for work completed through the end of the year in the amount of $535,114.20. Motion approved unanimously." },
      { item:"Portland Cement Concrete License - KSK Incorporated", body:"A member named Vinnie confirmed he reviewed the license application and everything was in order. Motion to approve the concrete license for KSK Inc. was made and approved unanimously." },
    ],
    publicComment: "No public comment was offered.",
    actionItems: [
      "Award 26th Street construction project to Switlick at $1,279,894.75",
      "Approve change order one for Rolph Street\/Cherry Street project totaling $14,436.50 to Haas Suns Incorporated",
      "Approve pay estimate #9 for $535,114.20 to Haas Suns Incorporated",
      "Issue Portland cement concrete license to KSK Incorporated",
      "North 8th Avenue bid opening to be rescheduled for future meeting",
      "Change order two for Rolph Street\/Cherry Street to return for consideration after liquidated damages discussions",
    ],
  },
  {
    ...
    isAgendaOnly: false,
    badge: "new",
    overview: "The Finance and Human Resources Committee debated and ultimately approved a modified employee clothing allowance policy after canceling a Cintas uniform contract. After three failed motions, the committee approved $500 annually (starting 2027) plus a washer\/dryer for staff, with $400 for the remainder of 2026. The meeting also featured an extensive presentation on public works operations showing the village spends less per mile on streets than comparable communities.",
    agenda: [
      ...
      { time:"4:30", item:"T1 and T2 detail reports for February" },
      { time:"5:00", item:"Legal details for February" },
    ...
    discussions: [
      { item:"Public works operation and budget presentation", body:"Public Works Director Michael delivered an extensive presentation on department operations, noting the 2026 budget decreased by $26,000 (1.1%) from 2025. He highlighted that Weston spends approximately $9,700 less per mile on streets than the average central Wisconsin community, and is the third lowest spending community per mile in the region. Michael emphasized staff worked 16-17 hour shifts during a recent major storm event, with estimated costs of $50,000 for that single event. He noted the department has one fewer employee than in 2010 despite increased road miles." },
      { item:"Clothing and equipment allowance amendments", body:"The committee engaged in extensive debate over increasing the employee clothing allowance after canceling the Cintas uniform contract. Committee member Daniels argued against the $600 increase, citing fiscal responsibility and the upcoming fire department referendum needs. Public Works Director Michael defended the increase, noting employees deal with hazardous materials and work long hours in difficult conditions. After the initial $600 motion failed (2-3 roll call vote with Daniels, Olsson, and one other opposed), a $400 motion also failed 3-3. A $500 motion with washer\/dryer also failed. Finally, a motion for $400 remainder of 2026, $500 annually starting 2027, plus a one-time washer\/dryer purchase passed with one opposed." },
      { item:"Financial reports acknowledgment", body:"The committee acknowledged the February 2026 financial reports for all funds, T1 and T2 detail reports, and legal details for February. All motions to acknowledge passed unanimously with voice votes." },
      { item:"Minutes approval", body:"Minutes from the February 16, 2026 meeting were approved unanimously. Motion by Steve, seconded by Stephanie." },
    ],
    publicComment: "Lisa Beck of 1808 Cortez Lane spoke during public comment. She praised Public Works Director Michael for the department's work during the recent storm. She also questioned the proposed clothing allowance increase, noting employees already receive safety apparel, shirts, hats, and $300 for boots\/pants, and suggested the village consider a lesser amount rather than the highest proposed amount to save money.",
    actionItems: [
      ...
      "Marathon County disaster relief application to be followed up with actual cost documentation for recent storm event",
  ...
  },
  {
    ...
    isAgendaOnly: false,
    badge: "new",
    overview: "The Wausau Public Health and Safety Committee approved a parklet permit for Westider Diner and Lounge after the owner presented detailed plans, approved multiple license applications and summer events, updated the solid waste disposal ordinance, and repealed the city's cell phone ban as state law now covers the issue. The committee also received updates on the fire department's 2025 operations and the upcoming transition of the homeless shelter from WMC to Bridge Street Mission.",
    agenda: [
      { time:"0:00", item:"Call to order and public comment" },
      { time:"1:23", item:"Approval of February 16, 2026 meeting minutes" },
      { time:"1:48", item:"License applications - Westider Diner and Lounge parklet permit" },
      { time:"10:00", item:"License applications - Denial recommendations (Theodore Davis, Joanna Gregory)" },
      { time:"18:45", item:"Approval of summer events and other license applications" },
      { time:"20:01", item:"Repealing and recreating solid waste disposal ordinance (Chapter 6.44)" },
      { time:"21:15", item:"Repealing handheld mobile phone ordinance (Section 10.01.012)" },
      { time:"23:00", item:"Grow Solar Central Wisconsin Group Buy Program MOU" },
      { time:"25:45", item:"Wausau Fire Department 2025 Annual Report" },
      { time:"32:45", item:"Tavern Activities Report - February 2026" },
      { time:"36:30", item:"Community Outreach Update and Bridge Street Mission transition" },
      { time:"44:00", item:"Public comment and adjournment" },
    ],
    discussions: [
      { item:"Westider Diner and Lounge Parklet Permit", body:"Owner Tyler Vote presented detailed mockups of a proposed parklet extending 4 feet into the street and 4 feet on the sidewalk along Qua Street. He explained it would accommodate breakfast customers seeking sun and warmth, similar to the parklet he previously operated at Malarkey's Pub. Committee member Sarah asked about materials and visibility concerns; Vote confirmed he would use fiberglass panels and lighting. Alderperson Lou requested reflective materials for nighttime visibility. Larson stated he was initially against the proposal but changed his mind after seeing the layout. Motion by Watson, second by Larson. Approved unanimously with the expectation of a November report-back on how the summer trial went." },
      { item:"License Denial - Theodore Davis", body:"Theodore Davis appeared before the committee regarding his bartender license denial recommendation. He acknowledged his record was accurate and explained he made a 'really bad mistake' 20 years ago as a minor that has followed him. He stated he completed therapy and registry requirements and is seeking employment at Emerald Nightclub. His boyfriend Matthew Prieb spoke in support, emphasizing Davis has not reoffended since and is a good person. Deputy Chief Baiton was unfamiliar with rehabilitation documents submitted to Chief Barnes. The committee voted to hold the item until the next meeting to allow Chief Barnes to review the evidence of rehabilitation and potentially change his recommendation." },
      { item:"License Denial - Joanna Gregory", body:"Joanna Gregory did not appear at the meeting. Her denial was included in the batch motion for license actions." },
      { item:"License Applications Batch Approval", body:"The committee approved various license applications including summer events (Wings over Wausau, Concerts on the Square, Chalkfest, Memorial Day parade, Hope on the Block, Jazz on the River), liquor licenses for Oasis Arcade, the rebranded Whiskey River Bar and Grill, new ownership of Hayawa, and Class A retailers. The liquor license review subcommittee had unanimously recommended approval for all three applicants reviewed earlier that evening. Motion by Larson, second by Watson. Approved unanimously with Theodore Davis held for next meeting." },
      { item:"Solid Waste Disposal Ordinance Update", body:"Assistant City Attorney Vinnie Bonino was available for questions on the repeal and recreation of Chapter 6.44 to comply with state-level changes. No questions were raised by committee members. Motion by Larson, second by Watson. Approved unanimously." },
      { item:"Repeal of Handheld Mobile Phone Ordinance", body:"The committee discussed repealing the city's cell phone ban ordinance as state inattentive driving statutes have been amended to regulate cell phone usage more narrowly, making the local ordinance redundant. Attorney Bonino confirmed the city already adopts state traffic code. Motion by Watson, second by Larson. Approved unanimously." },
      { item:"Grow Solar Central Wisconsin Group Buy Program", body:"Carrie from the planning department reported the sustainability committee voted unanimously on March 5th to move this item forward. The MOU with Midwest Renewable Energy provides vetting of solar installers, cost savings for homeowners, and technical assistance sessions. Committee member Sarah, who has solar on her house, praised the partnership with MREA as valuable given the complexity of solar installation. Motion by Watson, second by Larson. Approved unanimously." },
      { item:"Fire Department 2025 Annual Report", body:"Fire Chief reported the department achieved over 7,200 calls in 2025, averaging 20 per day. He announced that as of Friday, Wausau regained ISO Class 2 status for the next four years. The committee discussed upcoming public information sessions on March 31st, April 1st (Station 2 at 5 PM), and April 3rd (Station 1) related to the April 7th referendum. Chief mentioned radio appearances and a podcast posted on the city website. The report was placed on file." },
      { item:"Tavern Activities Report - February 2026", body:"Deputy Chief Baiton presented what was described as a routine month. Sarah asked about Trace Armanos, noting the business appeared closed despite having liquor signs; staff confirmed they have a Class B license but are not classified as a tavern. Discussion included recognition of patrol officers making impaired driving arrests during the recent blizzard. The chair noted a citizen inquiry about possible omitted demerit points for Days establishment. Report placed on file." },
      { item:"Community Outreach Update - Homeless Shelter Transition", body:"Tracy Durante reported 415 unduplicated guests served since the WMC shelter opened, with over 740 volunteer hours in February. Catholic Charities reported 99 unduplicated guests since November 1st. James Torensson, new Director of Homeless Services at Bridge Street Mission, explained the emergency shelter transition is expected around April 20th, pending contractor announcement on April 1st. The WMC shelter extended its contract with First United Methodist Church through April 19th to ensure no service gap. The committee expressed interest in touring the new facility, possibly during the ribbon cutting ceremony." },
    ],
    publicComment: "Carrie Mor Everest of 1025 Everest Boulevard spoke during late public comment about concerns with how unhoused individuals are treated during 911 emergency responses at the shelter. She stated she has volunteered at the shelter since it opened and witnessed multiple incidents where people were not treated ethically or professionally. She expressed frustration that complaints over 10 months have not been addressed and only recently learned about the Police and Fire Commission citizen complaint process. The chair acknowledged her remarks and directed her to the formal PFC complaint process.",
    actionItems: [
      "Approved parklet permit for Westider Diner and Lounge at 628 North Third Street for summer 2026 trial; owner to report back in November",
      ...
      "Approved MOU with Midwest Renewable Energy for Grow Solar Central Wisconsin Group Buy Program",
      "Staff to verify status of demerit points for Days establishment on tavern report",
      "Staff to check on Trace Armanos business status",
      "Committee to schedule tour of Bridge Street Mission shelter, potentially at ribbon cutting ceremony",
    ],
    civicItems: [
  ...
  },
  {
    ...
    isAgendaOnly: false,
    badge: "new",
    overview: "The Village of Weston Board of Trustees approved multiple ordinances including rezonings and a modified speed limit ordinance for Weston Avenue, approved a 10-year baseball\/softball field maintenance agreement, and received updates on the April 2026 referendum informational sessions. A resident spoke critically about fire department funding priorities, prompting an emotional response from the Finance Director about budget constraints.",
    agenda: [
      { time:"0:01", item:"Call to order and Pledge of Allegiance" },
      ...
      { time:"55:02", item:"Sewer televising software contract" },
    ],
    discussions: [
      { item:"Public Comment - Fire Department Funding", body:"Jim Pensel of 5002 Aerrol Street spoke about attending the SAFER Citizen Academy and praised fire department staff while criticizing the board's approach to funding. He argued the department is severely understaffed and criticized the upcoming referendum as having no sunset date. He urged the board to prioritize fire\/EMS funding over items like artificial turf at Kennedy Park and the aquatic center, stating 'We have a priority problem.' Finance Director Jessica responded emotionally, explaining the village cannot borrow for additional firefighters and defending staff efforts, noting public works received complaints despite 17-18 hour days during the recent blizzard." },
      { item:"Speed Limits Ordinance 26-00006", body:"The original motion to approve speed limit changes including 35 mph on Weston Avenue from Von Kennel to Ryan failed 4-3, with Maloney, Jordan, and the President voting no. Trustee Maloney argued the stretch from Von Kennel to J should remain 45 mph due to sparse driveways and better road conditions compared to other 35 mph roads. An amended motion was then approved changing only Camp Phillips to Von Kennel to 35 mph while keeping Von Kennel to Highway J at 45 mph, passing with Trustee Karns as the only no vote." },
      { item:"Rezoning Ordinances", body:"Ordinance 26-00004 rezoning a portion of 8905 Bert Street from RR5 to SFS was approved unanimously as recommended by the planning commission. Ordinance 26-00005 rezoning a portion of 7105 Christensen Avenue from SL to SFS was also approved unanimously per planning commission recommendation." },
      { item:"Baseball\/Softball Field Maintenance Agreement", body:"The board approved a 10-year maintenance and user agreement for baseball\/softball fields at Kennedy Park. The extended term was justified to protect the village's investment should youth organizations decide to pull out, and to provide stability despite leadership changes on various boards. Two highlighted additions included the 10-year term and village determination of when fields can be used. Passed unanimously." },
      { item:"Intersection Signage at Community Center Drive and Birch Street", body:"Motion to change stop sign to yield sign was approved with a friendly amendment adding a stop sign for bicyclists coming off the pedestrian bridge. Trustee Hooang raised concerns about cyclists traveling 15-20 mph off the bridge without any signage, prompting the addition. The amended motion passed unanimously." },
      { item:"Remote Meeting Attendance Policy", body:"Trustee Lewis recommended postponing this discussion until the next meeting so the newly seated board could make the decision. Motion to defer passed unanimously." },
      { item:"E-bike and Euro Ordinance", body:"The board tabled the proposed e-bike ordinance until the county finalizes their process, then it will return to the board. Passed unanimously." },
      { item:"April 2026 Referendum Update", body:"Administrator provided an update on referendum informational sessions. Two presentation-style sessions have been completed with recordings available online. Two remaining sessions on March 31st (4:30-6:00 PM) and April 2nd (12:00-1:30 PM) will be open house format for individual Q&A. This was discussion only with no action taken." },
    ],
    publicComment: "Jim Pensel of 5002 Aerrol Street spoke for approximately 4 minutes praising SAFER fire department staff after attending their citizen academy, but criticized the board's approach to funding the department. He called the referendum approach 'short-sighted' due to no sunset date, argued the village has 'a priority problem' not a revenue problem, and urged the board to fund fire\/EMS over wants like artificial turf and the aquatic center.",
    actionItems: [
      "Speed limit ordinance approved with modification: 35 mph from Camp Phillips to Von Kennel, 45 mph from Von Kennel to Highway J",
      ...
      "Yield sign to replace stop sign on Community Center Drive at Birch Street",
  ...
  },
  {
    ...
    isAgendaOnly: false,
    badge: "new",
    overview: "The Marathon County Board of Supervisors adopted the comprehensive plan for 2026 with multiple amendments addressing renewable energy terminology, data centers, AI technology, and coal\/natural gas promotion. The board also approved salaries for elected officials, authorized phase 2 design for a new highway facility, approved outside legal counsel for PFAS litigation, and ratified an emergency declaration related to a recent blizzard.",
    agenda: [
      { time:"0:12", item:"Call to order, pledge of allegiance, and moment of reflection" },
      { time:"1:07", item:"Reading of the notice and roll call" },
      ...
      { time:"1:24:00", item:"E17 - PFAS litigation outside counsel authorization, Resolution 14-26" },
      { time:"1:28:00", item:"E18 - Carry forwards and budget amendments, Resolution R-20-26" },
      { time:"1:30:01", item:"F20\/G21 - Drug trafficking grant and emergency declaration ratification" },
    ],
    discussions: [
      { item:"Consent Agenda Items C8 through C13 B2", body:"Motion by Supervisor Rosenberg, second by Supervisor V. No discussion was held. The motion carried unanimously." },
      { item:"Adopting Marathon County Comprehensive Plan 2026, Ordinance 0-13-26", body:"Administrator Leonard presented 10 proposed amendments compiled from supervisor feedback. Amendment 1 (livability standards) was offered by Vice Chair Dickinson and passed unanimously. Amendments 2, 3, and 4 (alternative energy systems language changes) were separated at Supervisor Crawl's request and each passed but not unanimously. Amendment 5 (data centers and battery storage background) passed but not unanimously, with Supervisor Leur voting no citing ideological concerns. Amendment 6 (radon and lead references) passed unanimously. Amendment 7 (regulate when allowed by law) passed but not unanimously. Amendment 8 (AI, automation, data analytics) offered by Supervisor Leur passed unanimously. Amendment 9 was extensively debated regarding coal, natural gas, and nuclear energy. Supervisor Boots offered an amendment to the amendment changing language to 'promote coal and natural gas until a long-term sustainable and reliable energy source can be found that does not adversely affect agricultural land.' This amendment to the amendment passed but not unanimously. The amended Amendment 9 then passed but not unanimously. Supervisor Sundulski offered a late amendment regarding utility-scale wind, solar, and battery storage as industrial uses. Supervisor Jeang moved to refer to ERC committee with July reporting date, but this was defeated. The amendment itself was defeated. The final comprehensive plan as amended passed but was not unanimous." },
      { item:"Establishing salaries for elected officials, Resolution 12-26", body:"Motion by Supervisor Conway, second by Supervisor Rosenberg for salaries for clerk of courts, sheriff, and elected department heads for the upcoming term. No discussion. Motion carried." },
      { item:"Highway facility phase 2 design services, Resolution 13-26", body:"Motion by Supervisor Robinson, second by Supervisor V. Supervisor Soyber requested future information on plans for the old facility. Chair Gibbs noted this would be addressed years down the road. Supervisor Sundulski asked about the $53 million cost estimate but was clarified this vote does not approve that amount. Motion carried unanimously." },
      { item:"PFAS litigation outside counsel authorization, Resolution 14-26", body:"Motion by Supervisor Robinson, second by Supervisor Sefelt. Two amendments were adopted unanimously: Supervisor Robinson's amendment directing the county administrator to evaluate past and present practices regarding PFAS exposure in county operations, and Vice Chair Dickinson's amendment modifying airport-related language to reference county property. The resolution as amended passed unanimously." },
      { item:"Capital asset threshold resolution, Resolution 21-26", body:"Motion by Supervisor Robinson, second by Supervisor Mask to approve $10,000 threshold for general capital assets and $50,000 for infrastructure assets. No discussion. Motion carried but not unanimous." },
      { item:"Emergency declaration ratification, Resolution 22-26", body:"Administrator Leonard explained the local emergency declaration was needed after the governor's declaration expired during the blizzard to preserve reimbursement opportunities. He praised county staff across facilities, parks, highway, sheriff's office, and airport for working 12-16 hour shifts during the event, with over 600 hours of call-in time. Supervisor Fifer echoed thanks to staff. Motion carried unanimously." },
      { item:"Administrator performance evaluation", body:"Chair Gibbs explained the executive committee completed the administrator's evaluation based on board input from the previous Thursday meeting with no wording changes. Supervisor Robinson moved to accept the executive committee's recommendation on salary and performance evaluation. Motion by Supervisor Robinson, second by Supervisor Cavalli. Motion carried unanimously." },
    ],
    publicComment: "No public comment was offered.",
    actionItems: [
      ...
      "Outside legal counsel authorized on contingency basis for PFAS litigation",
      ...
      "Capital asset thresholds set at $10,000 general and $50,000 infrastructure",
  ...
  },
  {
    ...
    isAgendaOnly: false,
    badge: "new",
    overview: "The Parks Committee approved minutes, selected Rettler Corporation for the Mock Mueller Park master plan, and discussed park impact fees with general support for moderate increases to match neighboring communities. The committee also reviewed Yellow Banks kayak launch expenses showing significant grant funding success and discussed Kennedy Park ice rink operations with interest in gathering more community feedback.",
    agenda: [
      ...
      { time:"25:45", item:"Discussion on Mock Mueller Park master plan RFP proposals" },
      ...
      { time:"50:15", item:"Future agenda items and remarks" },
    ...
    discussions: [
      ...
      { item:"Public comments", body:"Jim Pinsel expressed frustration about receiving no response to his previous three-page submission of questions regarding playground equipment installation issues from 2024, Kennedy Park fundraising transparency, and ice rink costs. He argued the true cost of operating the ice rink is $20,000-$30,000 when staff hours are included, not just the $1,320.98 presented. Lisa Beck praised Michael for snow removal during the recent blizzard and commended Sean and Jessica for the well-written Yellow Banks RFC detailing expenses and grant funding." },
      { item:"Parks and recreation impact fee discussion", body:"Jennifer presented information on park impact fees, noting the 2020 study recommended $761 for single-family units but the village only raised fees from $244 to $300 in 2022. Neighboring communities charge $600-$650 for single-family homes. Committee members expressed support for moderate increases to be consistent with neighboring communities. Katrina stated she would support the moderate increase bracket. The plan commission will make the final decision; no formal action was taken by this committee." },
      { item:"Mock Mueller Park master plan RFP selection", body:"Seven proposals were received for the park master plan, reviewed by four staff members based on firm experience, personnel, project understanding, and cost. JSD and Rettler Corporation were the two lowest bidders with similar qualifications. Roger made a motion to select Rettler Corporation, seconded by Katrina. The motion passed unanimously." },
      { item:"Yellow Banks kayak launch expenses review", body:"Jessica presented a comprehensive breakdown of the kayak launch project expenses and grant funding. The project received grants from DNR and Marathon County Transportation, with Marathon County covering the full expense for the ADA-accessible dock. PGA Construction provided favorable pricing, and Dan Higginbotham and MTS donated site planning work. Committee members praised the transparency and grant-writing efforts, with Katrina suggesting formal recognition for Dan Higginbotham. No action was required; informational only." },
      { item:"Ice rink operations at Kennedy Park", body:"Staff presented information on ice rink operations per committee member Katrina's request. The warming house has been unstaffed since 2020 due to COVID and subsequent recruitment difficulties. Everest Youth Hockey remains interested in improvements including a covered rink structure and has provided cost estimates. Sean noted Marathon Park's potential changes may increase demand for ice facilities. Katrina expressed concern about hockey being forgotten amid baseball-focused Kennedy Park discussions. The committee requested additional historical attendance data from 2018-19 seasons and community feedback for future meetings." },
    ],
    publicComment: "Jim Pinsel spoke expressing frustration about lack of response to his previous written questions regarding playground equipment issues, Kennedy Park transparency, and ice rink true costs. Lisa Beck complimented staff on snow removal during the blizzard and praised the Yellow Banks RFC documentation. A written response to Jim Pinsel's previous email was submitted and will be included in the minutes.",
    actionItems: [
      "Rettler Corporation selected for Mock Mueller Park graphic master plan - motion passed unanimously",
      ...
      "Staff to gather community feedback on ice rink usage for next meeting",
      "Quarterly Kennedy Park project update scheduled for April board meeting",
      "Dan Higginbotham expected to return to committee regarding Great Pineries Heritage Waterway signage",
    ],
  },
  {
    ...
    isAgendaOnly: false,
    badge: "new",
    overview: "The Wausau Finance Committee approved several airport ground lease transfers, postponed decisions on a national opioid settlement and lead service line funding pending more information, and approved budget amendments for 2025-2026 carryover funds. The committee also reviewed 2025 financial results showing a $540,000 surplus in the general fund after transfers.",
    agenda: [
      { time:"2:01", item:"Call to order and public comment" },
      { time:"2:28", item:"Approval of March 10, 2026 meeting minutes" },
    ...
    discussions: [
      { item:"Approval of March 10, 2026 meeting minutes", body:"Alder Watson moved to approve the minutes, seconded by Alder Griner. The motion passed unanimously with no discussion." },
      { item:"Alleged claim for recovery of unlawful tax for Green Acres at Greenwood Hills LLC", body:"This item relates to ongoing litigation with Greenwood Hills. Alder Watson moved to approve the claim, seconded by Alder Griner. The chair explained a 'no' vote would deny the claim. The motion failed, effectively denying the tax recovery claim." },
      { item:"Airport ground lease transfers for 939 Woods Place", body:"Three related items handled the transfer of a hangar from Win O. Jones to Owen Jones. Alder Watson moved to approve the consent to transfer title, passed unanimously. Alder Tierney moved to terminate the lease with Win O. Jones, passed unanimously. Alder Watson moved to approve the new lease with Owen Jones, passed unanimously." },
      { item:"Airport ground lease with Cole Lundberg", body:"Alder Griner moved to approve the ground lease with Cole Lundberg, seconded by Watson. The motion passed unanimously." },
      { item:"National opioid settlement agreement participation", body:"Committee members expressed concerns about joining the class action settlement without more information. Alder Tierney and Alder Malini questioned where the request originated and wanted more details before committing. Assistant City Attorney Vincent explained the city received notice as a potential class member. Alder Griner moved to postpone to the next meeting, seconded by Tierney. Motion passed unanimously. Deadline to participate is May 4th." },
      { item:"Budget amendment for Wausau Waterworks lead service line replacement", body:"Public Works Director Eric explained the DNR changed funding terms, resulting in $709,000 in non-construction costs not covered by the subsidized loan. Finance Director Marian outlined options including borrowing, using general fund reserves, or PFAS settlement money. Alder Tierney opposed adding more debt given current debt levels. Discussion included splitting costs between homeowner side ($283,868) and water utility side ($425,803). Alder Watson moved to postpone to the next meeting, seconded by Griner. Motion passed unanimously." },
      { item:"Budget amendment for 2025-2026 carryover funds", body:"The carryover includes funds for uncompleted projects including 10 transit buses funded by VW mitigation grants and various airport projects. Finance Director noted some projects like city hall chimney liner and public safety roof have not yet started. Alder Watson moved to approve, seconded by Griner. Motion passed unanimously." },
      { item:"Review of 2025 motorpool fund financial results", body:"Finance Director reported the motorpool fund shows a net loss of $41,373 before GMT transfer. After transferring $191,000 in GMT money, there would be a $150,000 profit. However, a cash flow shortfall of approximately $177,000 exists due to pending vehicle purchases from 2023-2025 supply chain delays. Solomon from MotorPool explained two dump trucks from 2023 are awaiting spreader upfits and should arrive shortly. This was informational only; no action taken." },
      { item:"Review of 2025 general fund financial results", body:"Finance Director Marian reported a surplus of approximately $1.2 million driven by strong building permits, investment income, and GMT money. After motorpool charges and proposed transfers to recycling, airport, and parking funds, the surplus would be $540,000. CCITC was over budget by $194,000 due to communication issues and an unbudgeted Office 365 upgrade. Alder Tierney moved to approve transfers to recycling, airport, and parking funds, seconded by Watson. Motion passed unanimously." },
      { item:"2026 general obligation promissory note for capital improvements", body:"Finance Director presented the borrowing calendar for 2026 capital improvements totaling approximately $10 million, with various amortization schedules. The debt utilization percentage will decrease by about $2 million. Alder Watson moved to approve the calendar, seconded by the chair. Motion passed unanimously. Phil Cawson from Ehlers will present parameters resolution at the next meeting." },
      { item:"Considering purchase of properties for DPW Streets Division", body:"Properties at 108 Adolf Street, 112 Adolf Street, 112.5 Adolf Street, and 233 Myron Street were on the agenda for closed session discussion. Due to time constraints with council meeting starting at 6:30 PM, Alder Watson moved to postpone to the next meeting, seconded by Tierney. Motion passed unanimously." },
    ],
    publicComment: "No public comment was offered.",
    actionItems: [
      ...
      "Postponed national opioid settlement participation decision pending more information from City Attorney",
  ...
  },
  {
    ...
    isAgendaOnly: false,
    badge: "new",
    overview: "The Marathon County Executive Committee convened briefly before entering closed session to discuss the performance review of the county administrator. The committee voted unanimously to go into closed session, with all members voting in favor.",
    agenda: [
      { time:"0:00", item:"Call to order" },
  ...
  },
  {
    ...
    agenda: [
      ...
      { time:"37:30", item:"Audited 2025 year-end fiscal update" },
    ...
    discussions: [
      { item:"Claim disallowance - Mercedes Holmes", body:"Corporation Counsel presented a claim received December 5th from Mercedes Holmes relating to the death of her 3-year-old child Zalen Bernett, who was placed in a treatment foster care home licensed through another agency in Dunn County. Law enforcement and social service investigations found no wrongdoing and determined natural causes. Outside counsel and insurance carrier recommended disallowance. Chair Gibbs moved to disallow the claim, seconded by Supervisor Lemer. Motion carried." },
      { item:"Revised property values for public auction", body:"Staff reported two parcels at 529 Mullen Street and 738 South 3rd Avenue failed to sell twice on Wisconsin Surplus at appraised values. Staff recommended revised minimum sale prices of $9,000 and $7,500 respectively. Chair Gibbs moved approval, seconded by Supervisor Lemer. Motion carried unanimously. Committee Chair Robinson asked about non-paying bidders; staff confirmed they are marked as 'non-pay' and banned from future auctions." },
      { item:"Resolution to approve carry forward funds", body:"Finance Director Sam presented resolution R20-2026 for program revenues and multi-year project funds to carry forward to 2026, including veterans relief fund replenishment expected to provide about three years of funding. Vice Chair Marshall asked about the redacted records fund for Register of Deeds; staff committed to bringing more information at a future meeting. The administration special projects carryover of $142,731.39 includes $75,000 previously approved for homelessness contract. Chair Gibbs moved approval, seconded by Supervisor Hart. Motion carried." },
      { item:"Capital assets threshold policy amendment", body:"Finance Director Sam explained the GFOA guidance from 2006 established $5,000 threshold for general assets. Staff recommended increasing to $10,000. Supervisor Hart moved approval, seconded by Chair Gibbs. Motion carried unanimously and will move to full county board." },
      { item:"Introduction of National Insurance Services", body:"HR Director Candace introduced NIS representatives who won the healthcare consulting RFP. Tim (28 years experience) and Jordan Stanley presented their team and approach. They discussed evaluating the near-site ATA clinic, assessing fully insured versus self-insured funding models, and improving communication with the committee. Vice Chair Marshall asked about per-member costs compared to other employers and strategies for reducing emergency room misuse. Chair Gibbs asked about evaluation processes for insurance funding models. NIS committed to quarterly or biannual updates." },
      { item:"2025 year-end fiscal update", body:"Finance Director Sam provided detailed department-by-department review of unaudited year-end figures. Key items included: county treasurer received $257,238 TID closure check from City of Wausau and $222,752 in unclaimed property from state; opioid fund has $2.2 million cash with $3.5 million in future settlements expected; ARPA funds nearly exhausted with $800,000 interest to be moved. Final fund balance surplus number will be provided at next meeting after capital assets reconciliation." },
      { item:"Finance Department quarterly update", body:"Sam reported the department is fully staffed since mid-December, implemented quarterly closeouts with departments, conducted uniform training, processed W-2s with new 'big beautiful bill' overtime tax calculations, performed random cash audits with successful results, and plans first quarter closeout by May 31st with monthly closeouts thereafter. Administrator Lance praised Sam and her team's exceptional work during challenging year-end processes." },
      { item:"County Treasurer update", body:"Treasurer Connie reported 1,582 delinquent tax notices sent in March (down from 1,786 last year), ongoing work with municipalities on lottery credit processing and receiving errors, and attendance at eviction hearings. Discussion addressed resources for struggling taxpayers and clarification that payment agreements were discontinued due to high default rates. Administrator Lance clarified evictions referenced are related to county tax deed processes, not general evictions." },
    ],
    publicComment: "No public comment was offered.",
    actionItems: [
      ...
      "Capital assets threshold policy amendment to increase from $5,000 to $10,000 approved and forwarded to county board",
      "Register of Deeds redacted records fund information to be presented at future meeting",
      "NIS to provide healthcare cost update before summer budget assumptions development",
      "Finance to bring final 2025 fund balance surplus figure at next meeting",
      "Administration to bring recommendation for increasing Social Services reserve account above current $400,000",
      "Next meeting scheduled for April 8, 2025",
    ],
  },
  {
    id: "AoUiBt_A4Hc", source: "marathon",
    title: "Marathon County Environmental Resources Meeting",
    ...
    isAgendaOnly: true,
    badge: "new",
    overview: "Based on the published agenda, the Marathon County Environmental Resources Committee was scheduled to meet on March 31, 2026. The specific agenda items were not available in the provided document, as only a link to the full agenda packet was included.",
    agenda: [
      { time:"N\/A", item:"Agenda items not available - only packet link provided" },
    ],
    discussions: [
      { item:"Agenda Not Available", body:"The full agenda content was not provided in the source document. Only a link to the Marathon County agenda packet was included, preventing detailed analysis of scheduled discussion items." },
    ],
    publicComment: "Not indicated on agenda.",
    actionItems: [
      "Unable to determine expected action items - full agenda content not available in provided document",
    ],
  },
  {
    id: "5-FN0TmHLZU", source: "marathon",
    title: "Marathon County Extension, Education, and Economic Development Meeting",
    ...
    isAgendaOnly: true,
    badge: "new",
    overview: "Based on the published agenda, the Marathon County Extension, Education, and Economic Development Committee was scheduled to meet on April 2, 2026. The specific agenda items were not available in the provided document, limiting details about the topics planned for discussion.",
    agenda: [
      { time:"N\/A", item:"Agenda details not available from provided document" },
    ],
    discussions: [
      { item:"Meeting Content", body:"The specific discussion items were not available in the provided agenda document. The committee typically addresses matters related to UW-Extension programs, educational initiatives, and economic development efforts in Marathon County." },
    ],
    publicComment: "Not indicated on agenda.",
    actionItems: [
      "Specific action items not available from provided agenda document",
    ],
  },
  {
    ...
    discussions: [
      { item:"Excellence in Action: Stettin Elementary", body:"The meeting was scheduled to recognize Stettin Elementary through the district's Excellence in Action program, which highlights achievements and initiatives at individual schools." },
      { item:"Wisconsin School Nutrition Purchasing Cooperative Agreement (WiSNP)", body:"With an estimated 5-minute presentation, the district's Nutrition Service Department was expected to request Board approval for continued membership in the Wisconsin School Nutrition Purchasing Cooperative for the 2026-2027 school year. The WiSNP Co-op requires member districts to obtain board approval of a resolution for continued participation." },
      { item:"Facility Fees", body:"Ryan Urmanski, Director of Buildings and Grounds, was scheduled to present a 10-minute proposal to amend the Wausau School District Facility Use Fee Schedule to add costs for artificial field use and field lighting for requested events. The administration was expected to request immediate approval of the updated fee schedule." },
      { item:"Referendum Budget Update", body:"Elizabeth Channel, Interim Assistant Superintendent of Operations, was scheduled to provide a 10-minute update on the status of the Referendum Budget. A memo dated March 22, 2026 was included in the meeting packet with budget summary details." },
      { item:"NEOLA UPDATE", body:"The Committee was scheduled to review proposed changes to numerous district policies during a 20-minute session. The updates ranged from technical corrections to more substantive revisions across multiple policy categories including board governance, student policies on cell phones and academic honesty, financial policies, and a new Artificial Intelligence policy. Additional policy groups addressed school support organizations, crowdfunding, and Act 57-related policies concerning student supervision and child abuse reporting." },
    ],
    publicComment: "No public comment period was included on this agenda.",
    actionItems: [
      "Board was expected to vote on approval of minutes from the February 23, 2026 meeting",
      ...
      "Action was requested to amend the Facility Use Fee Schedule to include artificial field and lighting costs with immediate implementation",
      "Action was requested on NEOLA policy updates covering definitions, board member conduct, district administrator relationships, reading instruction, Title I programs, interscholastic athletics, advanced learning, student policies including cell phones and third grade promotion, financial policies, and artificial intelligence",
      "Action was requested on school support organization related policies including student fundraising, crowdfunding, and advertising",
      "Action was requested on Act 57 related policies concerning student supervision and child abuse and neglect reporting",
    ],
  },
  {
...
const WESTON_UPCOMING = [
  { date:"2026-04-06", time:"", name:"Community, Life and Public Safety (CLPS) Committee", url:"https://www.westonwi.gov/AgendaCenter/ViewFile/Agenda/_04062026-1899", source:"weston" },
