...
const MEETINGS = [
  {
    ...
    isAgendaOnly: false,
    badge: "new",
    overview: "The Wausau City Council approved a major development agreement for 11 Scott Street (Wateride Place) by a 6-3 vote, which will convert a vacant 100,000 square foot building into 52 mid-priced residential units downtown. The council also recognized city employees for their response to a record 30.9-inch snowstorm and presented a sustainability award to Colby & Colby Millwork for their solar energy initiatives.",
    agenda: [
      { time:"0:00", item:"Call to order and Pledge of Allegiance" },
      { time:"0:45", item:"Roll call" },
      { time:"1:10", item:"Proclamation - Sarah Rafi Day (March 31st)" },
      { time:"4:45", item:"Mayoral citation for DPW snow response team" },
      { time:"11:30", item:"Sustainability Award presentation to Colby & Colby" },
      { time:"18:00", item:"Approval of March 10, 2026 meeting minutes" },
      { time:"18:45", item:"Public comment period" },
      { time:"20:30", item:"Consent agenda" },
      { time:"21:00", item:"11 Scott Street development agreement (moved up)" },
      { time:"35:00", item:"Mayoral appointments to Plan Commission and BID Board" },
      { time:"36:00", item:"Solid waste and recycling service agreement with Harter's Fox Valley" },
      { time:"37:30", item:"Announcements and adjournment" },
    ],
    discussions: [
      { item:"11 Scott Street Development Agreement", body:"Developers Raleigh Lray and Mark Craig spoke during public comment, noting the $10+ million project to convert a vacant building into 52 mid-priced apartments. Alder Rasmussen supported the project, citing the need to replace downtown workers with residents and fill the 'missing middle' housing gap. Alder Neil outlined benefits including $55,000 annual parking revenue and helping TID 8 reach valuation goals for potential closure in 5 years. Alder Larson dissented, arguing against discounting city parking assets during budget cuts. Alder Tyranny questioned the city's ability to provide 150 alternative parking spaces within 300 yards if the ramp closed; Economic Development Director Randy Feifer explained this replaced an existing agreement reducing spots from 480 to 150. The resolution passed 6-3." },
      { item:"DPW Snow Response Recognition", body:"Mayor Denny presented a mayoral citation to the Department of Public Works crews who responded to a record-setting 30.9-inch snowstorm from March 14-16, 2026. Street supervisors Kevin Kester, Dustin, and Josh were recognized, along with fleet technicians including Jieven Matah who worked 12 straight days. Kevin Kester addressed the council, praising the plow operators and mechanics, stating 'you kicked its ass' regarding the storm response." },
      { item:"Sustainability Award to Colby & Colby", body:"Christine Daniels from the Sustainability, Energy and Environment Committee presented the 2026 City of Wausau Sustainability Award to Colby & Colby Millwork. Keith Kaning explained their 2,000+ solar panel installation on their manufacturing facility became operational in July, generating enough power for approximately 120 homes and exceeding expectations. Mike Thompson noted their recycling initiatives for wood, aluminum, glass, vinyl scraps, and other waste streams." },
      { item:"Solid Waste and Recycling Agreement", body:"The council approved a seven-year residential solid waste and recycling service agreement with Harter's Fox Valley Disposal. Mayor Denny noted there had been confusion about whether the term was seven or ten years, confirming it was corrected to seven years as approved by public health and safety. Passed 9-0." },
      { item:"David Holes Settlement Resolution", body:"Assistant City Attorney Vincent Bonito explained this resolved a counter claim from a 2022 bus accident. Transit Mutual paid the initial claim, and now the other party's insurer agreed to pay damages for the bus. Alder Neil confirmed this has no bearing on any separate personal injury claim. Passed 8-1 without need for closed session." },
    ],
    publicComment: "Two speakers addressed the council during public comment. Raleigh Lray spoke in support of the 11 Scott Street project, describing it as a green sustainable repurposing of a vacant building that would add mid-priced apartments downtown. Mark Craig (3246 North 8th Street) joined her, noting the project exceeds $10 million and without council support 'it won't happen,' referencing the previous 7-4 term sheet vote.",
    actionItems: [
      ...
      "2026 budget modification for police Red Dot Optics from Thompson submachine gun sale approved 9-0",
  ...
  },
  {
    ...
    isAgendaOnly: false,
    badge: "new",
    overview: "The Wausau Board of Public Works approved street construction bids and change orders in a brief meeting. Key decisions included awarding the 26th Street construction project to Switlick Construction as the low bidder at $1,279,189.75, and approving a $14,436.50 change order for unexpected utility conditions on the Rolph Street\/Cherry Street project.",
    agenda: [
      { time:"0:00", item:"Call to order" },
      { time:"0:05", item:"Consideration of March 10th regular Board of Public Works minutes" },
      { time:"0:20", item:"Open bids for 26th Street construction project" },
      { time:"1:25", item:"North 8th Avenue bid opening (postponed)" },
      { time:"1:35", item:"2025 Street Construction Project A - Rolph Street\/Cherry Street Change Order 1" },
      { time:"3:45", item:"2025 Street Construction Project A - Pay Estimate #9" },
      { time:"4:10", item:"Portland cement concrete license for KSK Incorporated" },
      { time:"4:35", item:"Adjournment" },
    ],
    discussions: [
      { item:"March 10th Board of Public Works Minutes", body:"Minutes from the March 10th meeting were approved. A motion was made and seconded, passing with unanimous approval." },
      { item:"26th Street Construction Project Bids", body:"Seven bids were opened for the 26th Street construction project. Switlick was the low bidder at $1,279,189.75, narrowly beating Hos at $1,280,877.96 - a difference of less than $1,000. Other bidders included A1 ($1,374,600), Francis Melvin ($1,385,383), Steen ($1,489,126), James Peterson ($1,570,698.56), and Earth ($1,686,718.75). A motion to approve Switlick as the contractor passed unanimously." },
      { item:"North 8th Avenue Bid Opening", body:"This item was postponed as the bid opening was extended. It will return to a future meeting." },
      { item:"Rolph Street\/Cherry Street Change Order 1", body:"Staff presented four items totaling $14,436.50 for unexpected field conditions: an inside drop on a manhole ($4,856) for a large sanitary service not in records, water main tee connection ($2,317.50) due to finding 6-inch main instead of expected 8-inch, miscellaneous storm sewer tie-ins ($5,016 at $66\/linear foot), and geogrid installation ($2,247) for poor soils near Thomas Jefferson Elementary. Change Order 2 regarding liquidated damages was held for future discussion. The motion to approve passed unanimously." },
      { item:"Pay Estimate #9 - Rolph Street\/Cherry Street", body:"Pay estimate number nine for work completed through the end of the year was approved in the amount of $535,114.20. Motion passed unanimously." },
      { item:"Portland Cement Concrete License - KSK Incorporated", body:"Vinnie confirmed the license application was reviewed and everything was in order. The license for KSK Incorporated was approved unanimously." },
    ],
    publicComment: "No public comment was offered.",
    actionItems: [
      "Award 26th Street construction project to Switlick Construction for $1,279,189.75",
      "Approve Change Order 1 for Rolph Street\/Cherry Street project totaling $14,436.50",
      "Process pay estimate #9 for Hawsuns Incorporated in the amount of $535,114.20",
  ...
  },
  {
    ...
    isAgendaOnly: false,
    badge: "new",
    overview: "The Finance and Human Resources Committee heard a comprehensive presentation on public works operations and budget, then debated and ultimately approved a modified employee clothing allowance policy. After the committee rejected both $600 and $400 annual allowance proposals, they approved $400 for remainder of 2026, $500 annually starting 2027, plus a one-time washer\/dryer purchase for staff use.",
    agenda: [
      { time:"0:00", item:"Call to order and Pledge of Allegiance" },
      { time:"0:30", item:"Roll call" },
      { time:"0:50", item:"Public comments" },
      { time:"2:45", item:"Approval of minutes from February 16th, 2026" },
      { time:"3:10", item:"Acknowledge February 2026 financial reports" },
      { time:"3:45", item:"Acknowledge T1 and T2 detail reports for February" },
      { time:"4:15", item:"Acknowledge legal details for February" },
      { time:"4:45", item:"Educational presentation: Public works operations and budget" },
      { time:"37:00", item:"Old business: Reimbursement for clothing and equipment allowance amendments" },
      { time:"1:06:00", item:"Remarks from staff and committee members" },
      { time:"1:07:30", item:"Adjournment" },
    ],
    discussions: [
      { item:"Public works operations and budget presentation", body:"Public Works Director Michael delivered an extensive presentation on department operations, covering 119.5 centerline miles of roads, 50+ pieces of equipment, and utility infrastructure. He noted the 2026 public works budget decreased by $26,000 (1.1%) from 2025. Michael emphasized staff perform crack sealing, concrete work, tree trimming, and road reconstruction in-house to save costs. He showed the village spends $9,700 less per mile than the average central Wisconsin community. Discussion included the recent major snow event where staff worked 16-17 hour shifts, with estimated costs around $50,000 for that single storm. The county is applying for disaster relief funds." },
      { item:"Reimbursement for clothing and equipment allowance amendments", body:"Committee debated canceling the Cintas uniform contract and adjusting the employee clothing allowance. Michael advocated for $600 annually, noting the contract cancellation saves money and employees need work clothes. Committee member Daniels argued against increasing to $600, citing fiscal responsibility and the upcoming fire department referendum, stating 'if I have to choose spending $600 on giving someone clothes to wear, spend $600 on getting bodies to respond to 911 calls.' The initial motion for $600 failed on roll call vote (Daniels-yes, Armain-no, Love-yes, My-no, Sober-no). A motion for $400 annually also failed 3-3. A motion for $500 annually with washer\/dryer failed. Finally, a motion for $400 for remainder of 2026, $500 annually starting 2027, plus a one-time washer\/dryer purchase passed with one opposed." },
      { item:"Approval of minutes and financial reports", body:"Minutes from February 16, 2026 were approved unanimously on motion by Steve, seconded by Stephanie. February 2026 financial reports, T1 and T2 detail reports, and legal details were all acknowledged unanimously." },
    ],
    publicComment: "Lisa Beck of 1808 Cortez Lane offered public comment. She praised Mike for public works' response to the recent storm and questioned the proposed clothing allowance increase, asking why the village would implement the highest proposed amount rather than a lesser amount. She noted employees already receive safety apparel, shirts, hats, and $300 for boots\/pants.",
    actionItems: [
      ...
      "Marathon County disaster relief application in process for recent snow storm costs",
  ...
  },
  {
    ...
    isAgendaOnly: false,
    badge: "new",
    overview: "The Village of Weston Board of Trustees approved multiple rezoning ordinances, modified a speed limit ordinance for Weston Avenue after debate, and received updates on the April 2026 referendum for fire department funding. A resident criticized the board's approach to funding the fire department, calling for budget prioritization over referendums.",
    agenda: [
      { time:"0:00", item:"Call to order and Pledge of Allegiance" },
      { time:"0:45", item:"Roll call" },
      { time:"1:15", item:"Public comments" },
      { time:"5:45", item:"Minutes from February 16th meeting" },
      ...
      { time:"24:30", item:"Consent agenda - Vouchers and appointment of agent change" },
      { time:"26:00", item:"Ordinances - Rezoning and speed limit amendments" },
      { time:"38:00", item:"Resolution - Hinter Springs Second Edition subdivision final plat" },
      { time:"39:00", item:"April 2026 referendum informational sessions update" },
      { time:"42:00", item:"New business items including e-bike ordinance, parking restrictions, field maintenance agreements, and utility contracts" },
    ],
    discussions: [
      { item:"Public Comment - Fire Department Funding", body:"Jim Pensel of 5002 Aerrol Street spoke critically about the board's approach to fire department funding. He praised SAFER staff after attending their citizen academy but criticized the referendum approach, noting it has no sunset date and the $600,000 levy increase won't keep pace with future costs. He urged the board to prioritize fire and police funding over wants like artificial turf at Kennedy Park and the aquatic center, stating 'We have the money. You just need to have the courage to spend it where it actually matters.'" },
      { item:"Finance Director Response to Public Comment", body:"Finance Director Jessica responded that the village cannot borrow for additional firefighters - the Kennedy Park turf was borrowed funds which cannot be used for operations. She emphasized the village needs additional operating revenue, noting they are 'the cheapest' and 'do things the most efficiently' but cannot fund more staff. She expressed frustration with criticism, noting public works received complaints about snow removal despite 17-18 hour days during the recent blizzard." },
      { item:"Ordinance 26-00006 - Speed Limits on Weston Avenue", body:"Significant debate occurred over the proposed 35 mph speed limit on Weston Avenue from Von Kennel to Ryan Street. Trustee Maloney argued the road is wide with sparse driveways and should remain 45 mph, comparing it unfavorably to slower roads like Scofield Avenue. Staff noted the road was designed for 40 mph with 35 mph recommended. The original motion failed 4-3 (Maloney, Jordan, and the president voting no). A substitute motion by Maloney to keep Von Kennel to Camp Phillips at 35 mph but restore Von Kennel to Highway J to 45 mph passed with only Trustee Karns opposed." },
      ...
      { item:"April 2026 Referendum Update", body:"Administrator provided an update that two informational presentations have been completed with information available on the village website. Two remaining sessions will be facilitated Q&A open houses on March 31st (4:30-6:00 PM) and April 2nd (12:00-1:30 PM) at the village building. Fire Chief confirmed the sessions have gone well with good questions." },
      { item:"E-bike and E-uro Ordinance", body:"The board voted to table the proposed e-bike ordinance until the county finalizes their process, then bring it back. Motion to table passed unanimously." },
      { item:"Removal of No Parking Restrictions at Kennedy Park", body:"Approved to remove no parking restrictions on the west side of Alderson Street along Kennedy Park. Staff explained the original restrictions were implemented when the high school used fields for soccer. Removal will allow additional parking for farmers market and events, and help during upcoming roundabout construction. Passed unanimously." },
      { item:"Intersection Signage at Community Center Drive and Birch Street", body:"Motion to change stop sign to yield sign was amended after Trustee Hooang expressed concern about bicyclists coming off the pedestrian bridge at 15-20 mph with no signage. The board added a friendly amendment to install a stop sign for bicyclists on the path. Passed unanimously as amended." },
      { item:"Baseball\/Softball Field Maintenance Agreement", body:"Approved 10-year agreement with youth baseball and softball organizations. The committee recommended the long term to protect the village's investment at Kennedy Park and provide stability despite leadership changes. Organizations will maintain fields in lieu of fees. Passed unanimously." },
      ...
      { item:"Microsoft Teams for Communication", body:"Approved using Microsoft Teams for trustee communication starting next term, eliminating text messaging between trustees. Staff will provide training for new board members. Passed unanimously." },
    ],
    publicComment: "Jim Pensel of 5002 Aerrol Street spoke for approximately 4 minutes criticizing the board's approach to fire department funding. He praised SAFER staff after attending their citizen academy but argued the referendum approach is short-sighted, has no sunset date, and won't keep pace with rising costs. He urged the board to prioritize fire and police over discretionary spending like artificial turf and the aquatic center.",
    actionItems: [
      "Approved Ordinance 26-00004 rezoning portion of 8905 Bert Street from RR5 to SFS",
      "Approved Ordinance 26-00005 rezoning portion of 7105 Christensen Avenue from SL to SFS",
      "Approved modified Ordinance 26-00006 with Weston Avenue speed limit at 35 mph from Camp Phillips to Von Kennel and 45 mph from Von Kennel to Highway J",
      "Approved Resolution 2026-008 for Hinter Springs Second Edition subdivision final plat",
      ...
      "Two referendum Q&A open houses scheduled: March 31st 4:30-6:00 PM and April 2nd 12:00-1:30 PM",
  ...
  },
  {
    ...
    isAgendaOnly: false,
    badge: "new",
    overview: "The Parks Committee approved selecting Rettler Corporation to develop a master plan for Mack Mueller Park, discussed potential increases to park impact fees to better fund amenities, and reviewed the successful Yellow Banks kayak launch project which came in significantly under budget due to grants. The committee also discussed the future of the Kennedy Park ice rink and its potential connection to youth hockey plans.",
    agenda: [
      { time:"0:00", item:"Call to order and Pledge of Allegiance" },
      ...
      { time:"23:30", item:"Request for proposals for Mack Mueller Park master plan and budget estimates" },
      { time:"30:00", item:"Review of Yellow Banks kayak launch expenses" },
      { time:"36:30", item:"Components of operations for ice rink at Kennedy Park" },
      { time:"50:00", item:"Future items and possible next meeting date" },
      { time:"52:00", item:"Remarks from staff and committee members" },
      { time:"55:00", item:"Adjournment" },
    ],
    discussions: [
      ...
      { item:"Review of parks and recreation impact fee discussion", body:"Jennifer presented information on park impact fees, explaining that the 2020 study allowed fees up to $761 for single family units, but the village only charges $300. Neighboring communities charge $600-$900. Katrina supported a moderate increase to fund amenities, and Roger agreed to stay consistent with neighboring communities. The committee consensus was to support a moderate increase to remain competitive while improving parks. No formal action was taken; the information will go to Plan Commission." },
      { item:"Request for proposals for Mack Mueller Park master plan", body:"Staff received seven proposals for the park master plan. Four staff members reviewed and rated them based on firm experience, personnel experience, similar projects, understanding of scope, and cost. Roger moved to select Rettler Corporation, noting they were close in price to JSD and had park planning expertise. Katrina seconded. The motion passed unanimously." },
      { item:"Review of Yellow Banks kayak launch expenses", body:"Jessica presented a detailed breakdown of the kayak launch project expenses and grant funding. The project received grants from DNR and Marathon County Transportation, with the county covering the full expense for the ADA-accessible dock. Lisa Beck praised the RFC during public comment. Katrina commended staff for the grant writing work and asked about formally recognizing Dan Higenbotham who donated site planning work. PGA and MTS also donated labor and services. Information only, no action required." },
      { item:"Components of operations for ice rink at Kennedy Park", body:"Discussion was initiated at Katrina's request to prepare the committee for potential proposals from Everest Youth Hockey. Staff reported the rink is well-used but has been unattended since COVID due to staffing difficulties. Youth hockey organizations are interested in improvements including a roof structure to extend ice availability. Sean noted discussions are ongoing with hockey groups but they're hesitant to share details until plans are finalized. Staff will bring back attendance numbers from 2018-19 seasons for the next meeting." },
    ],
    publicComment: "Jim Pinsel (Street not specified) expressed frustration about not receiving responses to his previous comments regarding playground equipment installation issues and Kennedy Park fundraising updates. He criticized the ice rink cost analysis, arguing actual costs are closer to $20,000-$30,000 when labor hours are included, not the $1,320 stated. Lisa Beck (1808 Cortez Lane) thanked Michael for snow removal work during the recent blizzard and praised the Yellow Banks RFC as well-written. A written response to Jim Pinsel from staff regarding last month's email was submitted and will be included in the minutes.",
    actionItems: [
      "Rettler Corporation selected for Mack Mueller Park master plan development",
      "Jennifer to present park impact fee comparisons with neighboring communities to Plan Commission next month",
      "Staff to bring back ice rink attendance numbers from 2018-19 seasons to next meeting",
      "Staff to provide labor hour costs for ice rink operations at future meeting",
  ...
  },
  {
    ...
    isAgendaOnly: false,
    badge: "new",
    overview: "The Wausau Plan Commission approved a Conditional Use Permit for a 70-unit, 7-story apartment building at 731 N 1st Street and approved a Transportation Project Plat for Grand Avenue signal replacements. A public hearing was held on a Conditional Use Permit for a personal storage facility at 218 South 4th Street, though no vote was recorded for that item.",
    agenda: [
    ...
    discussions: [
      ...
      { item:"Consideration of Minutes", body:"The February 18, 2026 Regular Plan Commission minutes were approved. The motion passed, though specific vote count and mover\/seconder were not recorded." },
      { item:"Public Hearing: Conditional Use Permit for 218 South 4th Street (Dunwoody Storage)", body:"A public hearing was held on a Conditional Use Permit to authorize construction of a Personal Storage Facility in the Light Industrial Zoning District. No vote was recorded as this was a public hearing item." },
      { item:"Conditional Use Permit for 731 N 1st Street (Beacon Resources, LLC)", body:"The Conditional Use Permit for a 70-unit, 7-story apartment building at 731 N 1st Street was approved. The motion passed, though specific vote count and mover\/seconder were not recorded." },
      { item:"Transportation Project Plat for Grand Avenue Signal Replacements", body:"The Transportation Project Plat for Project 370-40-40, covering Grand Avenue signal replacements at Sturgeon Eddy Road and Townline Road, was approved. The motion passed, though specific vote count and mover\/seconder were not recorded." },
    ],
    publicComment: "Public comment on agenda items was included on the agenda as Item 2, along with reading of the City of Wausau Public Comment Statement.",
    actionItems: [
      ...
      "Public hearing completed for Dunwoody Storage Conditional Use Permit at 218 South 4th Street - action may be pending",
    ],
    civicItems: [
  ...
  },
  {
    ...
    isAgendaOnly: false,
    badge: "new",
    overview: "The Wausau Board of Public Works awarded the 2026 Asphalt Paving Project 'A' contract to RC Pavers, LLC for $824,146.34. The board conducted bid opening and made their recommendation during the brief meeting.",
    agenda: [
      { time:"N\/A", item:"Open bids and make recommendation for 2026 Asphalt Paving Project 'A'" },
    ],
    discussions: [
      { item:"2026 Asphalt Paving Project 'A' Bid Award", body:"The board opened bids and voted to award the contract to RC Pavers, LLC in the amount of $824,146.34. The motion passed. The adjournment motion was moved by Vincent Bonino and seconded by Eric Lindman, passing 2-0." },
    ],
  ...
  },
  {
    ...
    isAgendaOnly: false,
    badge: "new",
    overview: "The Wausau Public Health and Safety Committee approved all action items on the agenda, including license applications with one exception for Theodore Davis, a complete rewrite of solid waste disposal regulations, repeal of the city's hand-held mobile phone driving ordinance, and a solar energy partnership with the Midwest Renewable Energy Association. The committee also received informational reports from the Fire Department and on tavern activities.",
    agenda: [
      { time:"N\/A", item:"Public comment on agenda items" },
      { time:"N\/A", item:"Consideration of the minutes of the February 16, 2026 meeting" },
    ...
    discussions: [
      { item:"Consideration of minutes", body:"The minutes from the February 16, 2026 meeting were approved 3-0. Sarah Watson moved and Lou Larson seconded the motion." },
      { item:"Approval or denial of various license applications", body:"The committee approved a parklet permit and approved licenses as recommended by staff with the exception of Theodore Davis. Both motions passed." },
      { item:"Repealing and recreating Wausau Municipal Code Chapter 6.44 Solid Waste Disposal", body:"The committee approved the new solid waste disposal provision, replacing the existing Chapter 6.44 of the municipal code. The motion passed." },
      { item:"Repealing Wausau Municipal Code Section 10.01.012 Use of Hand-Held Mobile Telephones and Mobile Electronic Devices While Driving Prohibited", body:"The committee voted to repeal the city's ordinance prohibiting hand-held mobile phone use while driving. The motion passed." },
      { item:"Approving MOU with Midwest Renewable Energy Association", body:"The committee approved the memorandum of understanding to partner with MREA for the Grow Solar Central Wisconsin Group Buy Program. The motion passed." },
      ...
      { item:"Community Outreach Update", body:"A community outreach update was provided to the committee. This was a discussion item with no action required." },
    ],
    ...
    actionItems: [
      ...
      "License applications approved as recommended by staff, with exception for Theodore Davis",
      "New Wausau Municipal Code Chapter 6.44 Solid Waste Disposal approved",
      "Wausau Municipal Code Section 10.01.012 on hand-held mobile devices while driving repealed",
      "MOU with Midwest Renewable Energy Association for Grow Solar program approved",
    ],
    civicItems: [
  ...
  },
  {
    ...
    isAgendaOnly: false,
    badge: "new",
    overview: "The Wausau Finance Committee denied a tax recovery claim for Green Acres at Greenwood Hills LLC and postponed several significant items including the National Opioid Settlement Agreement, a Water Works budget amendment, and property purchases for the Public Works Streets Division. The committee approved multiple airport ground lease transactions and a 2026 General Obligation Promissory Note for capital improvements.",
    agenda: [
      { time:"N\/A", item:"Public comment on agenda items" },
    ...
    discussions: [
      ...
      { item:"Alleged Claim for Recovery of Unlawful Tax for Green Acres at Greenwood Hills, LLC - Outlot 1", body:"The committee denied the tax recovery claim. The motion to approve the claim failed." },
      { item:"Consent to transfer title to buildings at 939 Woods Place", body:"The committee approved the consent to transfer title to buildings and improvements and waiver of first right of refusal at 939 Woods Place." },
      { item:"Terminating Airport Ground Lease with Wynn O. Jones at 939 Woods Place", body:"The committee approved terminating the airport ground lease with Wynn O. Jones at 939 Woods Place." },
      { item:"Airport Ground Lease with Owen Jones at 939 Woods Place", body:"The committee approved the new airport ground lease with Owen Jones at 939 Woods Place." },
      { item:"Airport Ground Lease with Cole Lundberg", body:"The committee approved the airport ground lease with Cole Lundberg." },
      { item:"Six Remnant Defendants National Opioid Settlement Agreement", body:"The committee voted to postpone this item to the next scheduled meeting." },
      { item:"Budget amendment for Wausau Water Works 2025 Lead Service Line Replacement project", body:"The committee voted to postpone consideration of this budget amendment to the next meeting." },
      ...
      { item:"Review of 2025 Motor Pool Fund financial results", body:"The item was on the agenda for review. No vote outcome was recorded in the records." },
      { item:"2026 General Obligation Promissory Note for Capital Improvements", body:"The committee approved the 2026 General Obligation Promissory Note for Capital Improvements to proceed to the calendar." },
      { item:"Review of 2025 General Fund Financial Results", body:"The committee approved the transfer of funds related to the 2025 General Fund financial results." },
      { item:"Purchasing properties for Public Works Streets Division", body:"The committee voted to postpone consideration of purchasing properties at 108 Adolph Street, 112 Adolph Street, 112-1\/2 Adolph Street, and 233 Myron Street until the next meeting. The committee then adjourned to closed session to discuss negotiations." },
    ],
    publicComment: "Public comment on agenda items was included on the agenda as Item 1.",
    actionItems: [
      "Tax recovery claim for Green Acres at Greenwood Hills LLC denied",
      "Airport ground lease with Wynn O. Jones terminated; new leases approved for Owen Jones and Cole Lundberg at 939 Woods Place",
      "National Opioid Settlement Agreement postponed to next meeting",
      "Water Works Lead Service Line Replacement budget amendment postponed to next meeting",
      "2025 to 2026 fund carryover budget amendment approved",
  ...
  },
  {
    ...
    isAgendaOnly: true,
    badge: "new",
    overview: "Based on the published agenda, the Marathon County Board was scheduled to hold an education meeting. The specific content and topics to be covered were not detailed in the available agenda information, but education meetings typically provide board members with informational presentations and training on county matters.",
    agenda: [
      { time:"N\/A", item:"Education Meeting Part 1" },
    ],
    discussions: [
      { item:"Education Meeting Part 1", body:"The Marathon County Board was scheduled to convene for the first part of an education meeting. The specific topics and presentations to be covered were not detailed in the available agenda summary, though such meetings typically involve informational sessions for board members." },
    ],
    publicComment: "Not indicated on agenda.",
    actionItems: [
      "No specific action items indicated in available agenda information",
    ],
  },
  {
    ...
    isAgendaOnly: true,
    badge: "new",
    overview: "Based on the published agenda, this Marathon County Board Education Meeting (Part 3) was scheduled as a continuation of board member education sessions. The meeting was set to provide ongoing training and informational content for county board supervisors.",
    agenda: [
      { time:"N\/A", item:"Board Education Session Part 3" },
    ],
    discussions: [
      { item:"Board Education Session Part 3", body:"This session was scheduled as the third part of an ongoing education series for Marathon County Board members. The meeting was expected to continue providing board supervisors with training and informational materials relevant to their governance responsibilities." },
    ],
    publicComment: "Not indicated on agenda.",
    actionItems: [
      "No action items indicated - meeting appears to be educational\/informational in nature",
    ],
  },
  {
    ...
    isAgendaOnly: true,
    badge: "new",
    overview: "Based on the published agenda, the Marathon County HR, Finance, and Property Committee was scheduled to meet on 3\/24\/26 to address human resources, financial, and property matters for the county. The specific agenda items were not detailed in the provided information, though the full agenda packet was made available through the county website.",
    agenda: [
      { time:"N\/A", item:"Committee business as outlined in agenda packet" },
    ],
    discussions: [
      { item:"Committee Business", body:"The committee was scheduled to address matters related to human resources, finance, and property for Marathon County. Specific discussion items were to be detailed in the linked agenda packet available on the county website." },
    ],
    publicComment: "Not indicated on agenda.",
    actionItems: [
      "Committee was expected to consider items detailed in the full agenda packet available at the county website",
    ],
  },
  {
    ...
    isAgendaOnly: true,
    badge: "new",
    overview: "Based on the published agenda, the Marathon County Executive Committee was scheduled to meet on March 24, 2026. Without access to the detailed agenda document, the specific items set for discussion cannot be confirmed, but Executive Committee meetings typically address county administrative matters, budget oversight, and policy recommendations.",
    agenda: [
      { time:"N\/A", item:"Agenda items not available - document link provided but content not accessible" },
    ],
    discussions: [
      { item:"Executive Committee Business", body:"The committee was scheduled to conduct regular business as outlined in the meeting packet. Specific discussion items were set to be addressed as detailed in the linked agenda document at marathoncounty.gov." },
    ],
    publicComment: "Not indicated on agenda.",
    actionItems: [
      "Specific action items were scheduled as outlined in the full agenda packet available at the provided link",
    ],
  },
  {
    ...
    isAgendaOnly: true,
    badge: "new",
    overview: "Based on the published agenda, the Marathon County Executive Committee was scheduled to continue its meeting from an earlier session on March 24, 2026. The specific agenda items for this continuation meeting were not detailed in the available documentation, suggesting this was a procedural continuation of prior business.",
    agenda: [
      { time:"N\/A", item:"Continuation of Executive Committee Meeting" },
    ],
    discussions: [
      { item:"Executive Committee Business", body:"This was scheduled as Part 2 of the Executive Committee meeting, indicating continuation of items from an earlier session. The specific matters to be addressed were referenced in the linked agenda packet available on the Marathon County website." },
    ],
    publicComment: "Not indicated on agenda.",
    actionItems: [
      "Committee members were expected to continue deliberations from Part 1 of the meeting",
    ],
  },
  {
    ...
    isAgendaOnly: true,
    badge: "new",
    overview: "Based on the published agenda, the Marathon County Board was scheduled to hold a regular meeting on March 24, 2026. The specific agenda items were not provided in the source document, which only contained a link to the full meeting agenda and packet on the Marathon County website.",
    agenda: [
      { time:"N\/A", item:"Agenda details not available - document contained only a link to the full agenda packet" },
    ],
    discussions: [
      { item:"Full Agenda Not Available", body:"The source document provided only a link to the Marathon County website where the complete agenda and packet were published. Specific discussion items were not included in the provided text." },
    ],
    publicComment: "Not indicated on agenda.",
    actionItems: [
      "Specific action items not available - full agenda document was not provided",
    ],
  },
  {
    ...
    isAgendaOnly: true,
    badge: "new",
    overview: "The Wausau School District Board of Education Committee of the Whole meeting covered routine business including bill audits, a presentation recognizing Stettin Elementary, and action items on nutrition cooperative membership and facility fees. The meeting featured significant discussion on a comprehensive NEOLA policy update covering over 60 policies including new AI guidelines, cell phone policies, and Act 57 compliance changes, as well as a referendum budget update.",
    agenda: [
      { time:"0:00", item:"Call to Order" },
    ...
    discussions: [
      { item:"Wisconsin School Nutrition Purchasing Cooperative Agreement (WiSNP)", body:"The Wausau School District Nutrition Service Department currently belongs to the Wisconsin School Nutrition Purchasing Cooperative. The WiSNP Co-op is requesting member districts to approve continued membership for the 2026-2027 school year." },
      { item:"Facility Fees", body:"Director of Buildings and Grounds Ryan Urmanski will present information to amend the current facility use fee schedule to reflect costs for use of artificial fields and field lighting for requested events. If approved, the new fee schedule would take effect immediately." },
      { item:"Referendum Budget Update", body:"Interim Assistant Superintendent of Operations Elizabeth Channel will share an update on the status of the Referendum Budget. The memo was posted the day before the meeting." },
      { item:"NEOLA UPDATE - Policies", body:"The Committee will review proposed changes to 39 policies covering definitions, board member behavior, administrator relationships, reading instruction, athletics, cell phones, student employment, purchasing, and a new artificial intelligence policy. Some changes are technical corrections while others are more substantive." },
      { item:"NEOLA UPDATE - School Support Organization Related Policies", body:"The Committee will review nine policies related to school support organizations including student fund-raising, crowdfunding, accountability and oversight, gifts and grants, and advertising and commercial activities." },
      { item:"NEOLA UPDATE - Technical Corrections", body:"The Committee will review technical corrections to 18 policies covering board qualifications, medication administration, suspension and expulsion, video surveillance, crisis intervention, school safety, and pandemic protective equipment." },
      { item:"NEOLA UPDATE - Act 57 Related Policies", body:"The Committee will review four policies related to Act 57 compliance regarding student supervision and welfare for administrators, professional staff, and support staff, as well as child abuse and neglect reporting requirements." },
    ],
    ...
    actionItems: [
      ...
      "Approve NEOLA policy updates including new policies on AI, cell phones, and Act 57 compliance",
    ],
  },
  {
    ...
    isAgendaOnly: true,
    badge: null,
    overview: "The Education\/Operations Committee meeting addressed the 4K Program Agreement renewals with community partners for 2026-2027, received an annual safety update including drill debriefs, and reviewed extensive Neola policy updates covering 43 different policies ranging from board member conduct to student drug policies and school safety protocols.",
    agenda: [
      { time:"0:00", item:"Call to Order" },
      { time:"0:02", item:"Approve the Minutes" },
    ...
    discussions: [
      { item:"4K Program Agreement", body:"The district's four-year-old kindergarten program seeks approval to renew Program Agreements with community collaboration sites for the 2026-2027 school year. Partner sites include Wausau Child Care, Mountain View Montessori, Woodson YMCA Wausau Branch, Newman Catholic Schools, and Marathon County Child Development Agency Head Start Program at Barrington Center." },
      { item:"Annual Safety Update \/ Drill Debrief", body:"The district is implementing the I Love U Guys Standard Response Protocol using standardized vocabulary (HOLD, SECURE, LOCKDOWN, EVACUATE, SHELTER) for consistent emergency responses. Security highlights include secure building entrances, Visitor Aware System, security cameras, and locked exterior doors, with district-wide LOCKDOWN drills in September and EVACUATION drills in October conducted in partnership with the Wausau Police Department and School Resource Officers." },
      { item:"Neola Policies Update", body:"The committee reviewed proposed changes to 43 policies covering a wide range of topics including board member behavior and code of conduct, employment of substitutes, student drug use policies, drone usage, school safety, food service and wellness programs, and technical corrections to existing policies regarding nondiscrimination, student privacy, and pandemic-related protocols." },
    ],
    publicComment: "A public and student comment period was included on this agenda.",
    actionItems: [
      "Approve 4K Program Agreement with community partner sites for 2026-2027 school year",
      "Approve Neola Policies Update covering 43 policy changes and technical corrections",
...
,
  {
    ...
    isAgendaOnly: true,
    badge: null,
    overview: "This special meeting of the Wausau School District Board of Education focused on two closed session items: competitive negotiations related to real estate purchase\/sale and the evaluation of the Superintendent of Schools. The board may take action following the closed session discussions.",
    agenda: [
      { time:"0:00", item:"Call to Order" },
    ...
    discussions: [
      { item:"Discussion regarding the Competitive Negotiations of a Purchase\/Sale of Real Estate", body:"The board planned to enter closed session under Wisconsin statute 19.85(1)(e) to discuss competitive negotiations involving the purchase or sale of real estate. This exemption allows boards to meet privately when public knowledge of negotiations could compromise the district's bargaining position." },
      { item:"Evaluation of Superintendent of Schools", body:"The board planned to conduct a performance evaluation of the Superintendent of Schools in closed session under Wisconsin statute 19.85(1)(c). This statute permits closed sessions for considering employment, promotion, compensation, or performance evaluation data of public employees." },
    ],
    publicComment: "No public comment period was included on this agenda.",
    actionItems: [
...
,
  {
    ...
    isAgendaOnly: true,
    badge: null,
    overview: "This Regular Meeting of the Wausau School District Board of Education covers referendum construction updates for elementary schools at 50% design completion, a charter school status report from Red Granite, and extensive policy updates. The board will also consider 4K program agreements with community partners and receive an annual safety update.",
    agenda: [
      { time:"0:00", item:"Call to Order" },
    ...
    discussions: [
      { item:"50% Updates for Elementary Referendum Construction", body:"As referendum-funded improvement plans develop for each facility, the Board will receive updates when designs reach 50% completion. Current plans for John Marshall, Rib Mountain, Franklin Elementaries, and Lincoln Early Learning Academy will be shared with the Board." },
      { item:"Red Granite Update", body:"Red Granite Principal Maud Mangin and Red Granite Governance Board President Amanda Molin will share an update on the status of the Red Granite Charter School." },
      { item:"4K Program Agreement", body:"The Wausau School District four-year-old kindergarten program is seeking approval to enter into agreements with community collaboration partner sites for the 2026-2027 school year, including Wausau Child Care, Mountain View Montessori, Woodson YMCA, Newman Catholic Schools, and Marathon County Child Development Agency Head Start Program." },
      { item:"Annual Safety Update \/ Drill Debrief", body:"At the November Education\/Operations Committee Meeting, Andy Grimm and members of the Wausau Police Department shared the annual safety update and information about the partnership between the Wausau Police Department and School Resource Officers." },
      { item:"Neola Policies Update", body:"The board will review proposed changes to 43 policies that were presented at the November Education\/Operations Committee meeting, covering topics including board member conduct, student supervision, entrance age, academic honesty, drug policies, drones, volunteers, school safety, and food service." },
    ],
    publicComment: "A public and student comment period is included on the agenda following the Resolution of Commendation.",
    actionItems: [
...
,
  {
    ...
    isAgendaOnly: true,
    badge: null,
    overview: "The Wausau School District Board of Education's Audit of the Bills Committee met to review and approve district expenditures for December 2025. This routine financial oversight meeting ensures proper accountability for school district spending.",
    agenda: [
      { time:"0:00", item:"Call to Order" },
    ...
    discussions: [
      { item:"Audit of the Bills", body:"The committee reviewed the December 2025 audit of bills document, which details district expenditures requiring approval. The attachment dated December 9, 2025 contains itemized bills for committee examination and authorization." },
    ],
    publicComment: "No public comment period was included on this agenda.",
    actionItems: [
      "Approve the December 2025 audit of bills",
    ],
  },
,
,
...
,
  {
    ...
    isAgendaOnly: true,
    badge: null,
    overview: "This special meeting of the Wausau School District Board of Education focused primarily on closed session items regarding administrator contracts, staff employment matters, and real estate negotiations. The board also recognized Ellie Mason with a Resolution of Commendation.",
    agenda: [
      { time:"0:00", item:"Call to Order" },
      { time:"0:02", item:"Request for Closed Session Pursuant to State Statutes" },
    ...
    discussions: [
      ...
      { item:"Discussion regarding the Competitive Negotiations of a Purchase\/Sale of Real Estate", body:"The board held closed session discussions under Wisconsin Statute 19.85(1)(e) regarding competitive negotiations for the purchase or sale of real estate. This exemption allows boards to discuss property transactions without public disclosure during active negotiations." },
      { item:"Resolution of Commendation: Ellie Mason", body:"The board considered a Resolution of Commendation to recognize Ellie Mason for her contributions to the district. An attachment with the full resolution details was included in the meeting packet." },
    ],
    publicComment: "No public comment period was included on this agenda.",
    actionItems: [
...
,
  {
    ...
    discussions: [
      { item:"Open Enrollment Seat Availability", body:"Wendy Cartledge presented the Open Enrollment Space Determinations for the 2026-2027 school year. This determines how many seats will be available for students outside the district to enroll in Wausau schools." },
      { item:"Snow Day Communication & Procedures", body:"Diana White and Dr. Katie Colwell presented information on communications and procedures for snow days. The presentation addressed what happens beyond the three allocated snow days in the school calendar." },
      { item:"Approve Co-Ops", body:"Athletic Directors BJ Brandt and Darci Mick Beversdorf presented information on multiple cooperative athletic team renewals for 2026-2028, including boys hockey co-op with East\/Merrill\/Newman Catholic, girls lacrosse co-op with East\/West\/DCE\/Mosinee, and girls STORM hockey adding Merrill and Stratford to the existing East\/West\/DCE\/Mosinee partnership." },
    ],
...
,
  {
    ...
    isAgendaOnly: true,
    badge: null,
    overview: "This special meeting of the Wausau School District Board of Education focused primarily on personnel matters, including staff appointments, separations, and two closed sessions addressing employee conduct allegations with potential termination and administrator contract discussions. The meeting indicates significant personnel actions requiring board attention outside of regular meeting schedules.",
    agenda: [
      { time:"0:00", item:"Call to Order" },
      ...
      { time:"0:35", item:"Request for Closed Session Pursuant to State Statutes - Administrator Contracts" },
      { time:"0:55", item:"Adjourn" },
    ],
    discussions: [
      { item:"Consent Agenda", body:"The consent agenda includes personnel actions covering new staff appointments, replacement staff, contract increases, resignations, contract decreases, terminations, leaves of absence, and retirements. These routine personnel matters were bundled for efficient board approval." },
      { item:"Closed Session - Employee Conduct", body:"The board convened into closed session to receive evidence concerning allegations of employee conduct and consider administrative recommendation for termination. This quasi-judicial hearing allowed the board to deliberate on evidence and potentially consider an employee resignation agreement." },
      { item:"Closed Session - Administrator Contracts", body:"The board entered a second closed session to approve administrator contracts and discuss the performance and employment of staff members under Wisconsin Statute 19.85(1)(c), which permits private deliberation on employee evaluations and compensation." },
    ],
    publicComment: "No public comment period was included on this agenda.",
    actionItems: [
      "Approve Consent Agenda including appointments, separations, leaves of absence, and retirements",
      "Take action if necessary following closed session on employee conduct allegations and potential termination",
...
,
  {
    ...
    isAgendaOnly: true,
    badge: null,
    overview: "The Wausau School District Board of Education held a regular meeting covering the 2024-25 audit report presentation, WASB delegate voting directions, discussion of replacing the Wausau West chiller system, and various cooperative athletics agreements. The meeting also included closed session items regarding potential litigation and superintendent evaluation.",
    agenda: [
      { time:"0:00", item:"Call to Order" },
      { time:"0:02", item:"Roll Call" },
      ...
      { time:"0:18", item:"Approve Consent Agenda (Action Requested)" },
      { time:"0:23", item:"Old\/Recurring Business - Education\/Operations Committee Meeting" },
      { time:"0:28", item:"New Business - Approve the 2024-25 Audit Report (Action Requested)" },
      { time:"0:43", item:"New Business - WASB Resolutions (Action Required)" },
      { time:"0:53", item:"New Business - Wausau West Chiller Discussion (Possible Action)" },
      { time:"1:08", item:"New Business - Resolution Authorizing Entry into Intergovernmental Cooperation Agreement Relating to Wisconsin Investment Series Cooperative (Action Requested)" },
      { time:"1:13", item:"New Business - Education\/Operations Committee Meeting - Open Enrollment Seat Availability (Action Requested)" },
      { time:"1:14", item:"New Business - Education\/Operations Committee Meeting - Approve Co-Ops (Action Requested)" },
      { time:"1:19", item:"Open Forum" },
      { time:"1:29", item:"Request for Closed Session Pursuant to State Statutes" },
      { time:"1:34", item:"Adjourn" },
    ],
    discussions: [
      { item:"Approve the 2024-25 Audit Report", body:"Amber Ebert from Hawkins Ash CPAs will present to the Board the results of the Wausau School District's June 30, 2025 Audited Financial Statements. The presentation is estimated to take 15 minutes." },
      { item:"WASB Resolutions", body:"The Board will review proposed WASB Resolutions and direct the WASB Delegate on how to vote on behalf of the District. A late addition includes Resolution 13 regarding a proposed amendment to the WASB Bylaws." },
      { item:"Wausau West Chiller Discussion", body:"Elizabeth Channel, Interim Assistant Superintendent of Operations, and Ryan Urmanski, Director of Buildings and Grounds, will present a request to solicit bids for the replacement of the chiller system at Wausau West. The presentation is estimated to take 15 minutes." },
      { item:"Resolution Authorizing Entry into Intergovernmental Cooperation Agreement Relating to Wisconsin Investment Series Cooperative", body:"Assistant Superintendent of Operations Elizabeth Channel is presenting a resolution to allow the District to continue its membership in the Wisconsin Investment Series Cooperative. This resolution updates the most recent authorization, which is over ten years old, in accordance with best practice." },
      ...
      { item:"Approve Co-Ops", body:"The Board will consider co-op renewals including boys hockey East\/Merrill\/Newman Catholic, girls lacrosse East\/West\/DCE\/Mosinee, and girls STORM hockey East\/West\/DCE\/Mosinee with the addition of Merrill and Stratford for the 26-27 and 27-28 school years." },
      { item:"Closed Session - Preliminary Discussion Regarding Potential Litigation", body:"The Board will enter closed session pursuant to state statute 19.85(g) to discuss preliminary matters regarding potential litigation." },
      { item:"Closed Session - Evaluation of Superintendent of Schools", body:"The Board will conduct an evaluation of the Superintendent of Schools pursuant to state statute 19.85(1)(c)." },
    ],
    publicComment: "Public and Student Comment period was included on the agenda as item V.",
    actionItems: [
      "Approve Consent Agenda including appointments, separations, leaves of absence, retirements, meeting minutes, payment of bills\/budget status, and donations",
      "Approve the 2024-25 Audit Report",
      "Direct WASB Delegate voting on proposed WASB Resolutions",
      ...
      "Possible action following closed session regarding potential litigation and superintendent evaluation",
    ],
  },
,
,
...
,
  {
    ...
    isAgendaOnly: true,
    badge: null,
    overview: "This Audit of the Bills Committee meeting focused on reviewing and approving district expenditures for the Wausau School District. The committee examined financial documentation to ensure proper oversight of district spending.",
    agenda: [
      { time:"0:00", item:"Call to Order" },
      { time:"0:02", item:"Audit of the Bills" },
      { time:"0:07", item:"Adjourn" },
    ...
    discussions: [
      { item:"Audit of the Bills", body:"The committee reviewed the bills and expenditures for the district as documented in the January 26 audit attachment. This routine financial oversight ensures all district payments are properly authorized and accounted for." },
    ],
    publicComment: "No public comment period was included on this agenda.",
    actionItems: [
...
,
  {
    ...
    isAgendaOnly: true,
    badge: null,
    overview: "The Wausau School District Education\/Operations Committee meeting covered significant referendum project designs for four elementary schools reaching 95% completion, financial planning including legal expenses and projection model assumptions, and a student demographic report. The committee also considered the 2026-2027 school calendar and potential governance model changes.",
    agenda: [
      { time:"0:00", item:"Call to Order" },
      { time:"0:02", item:"Approve the Minutes" },
    ...
    discussions: [
      { item:"Franklin, Rib Mountain, Lincoln & John Marshall 95% Design", body:"As referendum projects for four elementary schools reach the end of the design phase at 95% completion, the Board reviewed the designs and budgets. The Committee was asked to consider approval of these plans to be issued for competitive bidding." },
      ...
      { item:"Approve 2026-2027 District Calendar", body:"Diana White presented a draft of the 2026-2027 school year calendar for School Board review. The committee was asked to approve the proposed calendar." },
      { item:"Presentation of Financial Projection Model Assumptions", body:"Interim Assistant Superintendent of Operations Elizabeth Channel shared key variables contributing to the District's multi-year financial projection model. The model represents a baseline using current 2025-2026 budget numbers with percentages and dollar amounts cast forward, with the full projection model to be presented at a later date." },
      { item:"2025-2026 Student Demographic Report", body:"Director of Technology Ralph Williams presented the Demographics Report for the 2025-2026 school year. The presentation included detailed student demographic data for the district." },
      { item:"Governance Model Option", body:"The Board continued discussion about potentially changing the Audit of the Bills Committee and clarifying the purpose of the Education\/Operations Committee with a potential rename of the meeting. This item may result in action." },
    ],
    publicComment: "A public and student comment period was included on the agenda.",
    actionItems: [
      "Approve 95% design plans for Franklin, Rib Mountain, Lincoln & John Marshall Elementary schools for bidding",
...
,
  {
    ...
    isAgendaOnly: true,
    badge: null,
    overview: "This special meeting of the Wausau School District Board of Education focused on personnel matters through the consent agenda, approval of the 2026-2027 district calendar, and a closed session for the evaluation of the Superintendent of Schools. The meeting addressed routine staffing changes and set the academic calendar for the upcoming school year.",
    agenda: [
      { time:"0:00", item:"Call to Order" },
    ...
    discussions: [
      { item:"Approve 2026-2027 District Calendar", body:"Diana White had previously presented a draft of the 2026-2027 school year calendar at a prior meeting for School Board review. The Board was asked to take action on final approval of the calendar for the upcoming academic year." },
      { item:"Evaluation of Superintendent of Schools", body:"The Board entered closed session pursuant to Wisconsin State Statute 19.85(1)(c) to conduct an evaluation of the Superintendent of Schools. The Board planned to reconvene in open session afterward and take any necessary action resulting from the closed session discussion." },
    ],
    publicComment: "No public comment period was included on this agenda.",
    actionItems: [
      "Approve Consent Agenda including appointments, separations, leaves of absence, and retirements",
...
,
  {
    ...
    isAgendaOnly: true,
    badge: null,
    overview: "The Wausau School District Board of Education's February 9, 2026 regular meeting addressed significant facilities matters including approval of 95% designs for four elementary schools under referendum projects, a chiller system replacement at Wausau West, and an update on the disbanded East\/Merrill Boys Hockey Co-Op. The meeting also covered financial projections, governance model changes, and included a closed session on real estate negotiations.",
    agenda: [
      { time:"0:00", item:"Call to Order" },
      { time:"0:02", item:"Roll Call" },
      { time:"0:04", item:"Pledge of Allegiance: Jim Bouch, President" },
      ...
      { time:"0:43", item:"Old\/Recurring Business - Education\/Operations Committee Meeting" },
      { time:"0:45", item:"Franklin, Rib Mountain, Lincoln & John Marshall 95% Design (Action Requested)" },
      { time:"0:47", item:"Legal Expenses for 2nd Quarter of 2025-2026" },
      { time:"0:49", item:"2025-2026 Student Demographic Report" },
      { time:"0:51", item:"New Business - Wausau West Chiller System (Action Requested)" },
      ...
      { time:"1:18", item:"Governance Model Option (Possible Action)" },
      { time:"1:20", item:"Open Forum" },
      { time:"1:30", item:"Request for Closed Session Pursuant to State Statutes" },
      { time:"1:35", item:"Adjourn" },
    ],
    discussions: [
      { item:"Franklin, Rib Mountain, Lincoln & John Marshall 95% Design", body:"As referendum projects reach the end of design phase at 95% completion, the Board reviews designs and budgets for Franklin, Rib Mountain, Lincoln, and John Marshall Elementary schools. The Board is asked to approve these plans for issuing competitive bids." },
      { item:"Legal Expenses for 2nd Quarter of 2025-2026", body:"Interim Assistant Superintendent of Operations Elizabeth Channel presented a summary report of all legal counsel expenses incurred during the second quarter of 2025-2026. The report is broken down by law firm and type of legal advice sought and requires no action." },
      ...
      { item:"Discussion regarding the Competitive Negotiations of a Purchase\/Sale of Real Estate", body:"Closed session pursuant to Wisconsin Statute s. 19.85 (1)(e) regarding competitive negotiations for purchase or sale of real estate." },
    ],
    publicComment: "A public and student comment period was included on this agenda.",
    actionItems: [
      ...
      "Approve Franklin, Rib Mountain, Lincoln & John Marshall Elementary Schools 95% Design for competitive bidding",
      "Approve Wausau West Chiller System replacement bid",
      "Possible action on Governance Model Option regarding committee restructuring",
      "Possible action following closed session on real estate negotiations",
    ],
  },
,
,
...
,
  {
    ...
    isAgendaOnly: true,
    badge: null,
    overview: "This special meeting of the Wausau School District Board of Education focused on routine personnel matters and a closed session regarding potential litigation. The meeting addressed staff appointments, separations, leaves of absence, and retirements through the consent agenda.",
    agenda: [
      { time:"0:00", item:"Call to Order" },
      { time:"0:02", item:"Approve Consent Agenda (Action Requested) - Appointments, Separations, Leaves of Absence, Retirements" },
    ...
    discussions: [
      ...
      { item:"Preliminary Discussion Regarding Potential Litigation", body:"The board planned to enter closed session under Wisconsin Statute 19.85(g) to conduct preliminary discussions regarding potential litigation facing the district. The board would reconvene in open session afterward to take further action if necessary and appropriate." },
    ],
    publicComment: "No public comment period was included on this agenda.",
    actionItems: [
      "Approve Consent Agenda including appointments, separations, leaves of absence, and retirements",
...
,
  {
    ...
    isAgendaOnly: true,
    badge: null,
    overview: "The Wausau School District Board of Education Committee of the Whole meeting addressed fiscal planning with a five-year forecast, reviewed AGR school performance data, and considered extensive policy updates through NEOLA. The meeting also featured recognition of the district planetarium and Wausau West High School, with a facility tour scheduled afterward.",
    agenda: [
      { time:"0:00", item:"Call to Order" },
      { time:"0:02", item:"Approve the Minutes" },
      { time:"0:05", item:"Audit of the Bills" },
    ...
    discussions: [
      { item:"Five Year Fiscal Forecast", body:"The Board received a five-year fiscal forecast model for the District to aid in constructing the 2026-27 budget reconciliation plan. The projection model incorporates many variables that change periodically, and administration will notify the Board of significant changes as they occur." },
      { item:"AGR Annual Report", body:"This mid-year update provided AGR student outcome scores required by DPI, including screening results from the district's three AGR schools. The report featured work being done to strengthen organizational systems and demonstrated how these schools are evolving practices to improve student achievement." },
      { item:"NEOLA UPDATE", body:"The Committee reviewed proposed changes to numerous district policies, ranging from minor technical corrections to more substantial revisions. Policy areas covered included board member conduct, student supervision, cell phones, academic honesty, homeless students, purchasing, fund balance, and school support organizations." },
      { item:"Referendum Budget Update", body:"The Board received an update on the April 2022 referendum-funded facility improvements. These construction and budget updates will continue to be presented routinely until all projects are completed." },
    ],
    publicComment: "A Public and Student Comment period was included on the agenda.",
    actionItems: [
      "Approve the Minutes",
      "Approve NEOLA policy updates including policies on definitions, board member behavior, student supervision, cell phones, homeless students, third grade promotion, purchasing, fund balance, and school support organizations",
    ],
  },
,
,
