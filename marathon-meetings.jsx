...
const MEETINGS = [
  {
    ...
    agenda: [
      ...
      { time:"24:00", item:"Consent agenda" },
      { time:"24:30", item:"Development agreement for 11 Scott Street\/Waterside Place" },
    ...
    discussions: [
      { item:"Development agreement for 11 Scott Street\/Waterside Place", body:"The council approved the joint resolution from Economic Development and Infrastructure committees for the $10+ million project to convert the vacant building into 52 mid-priced residential units. Alder Rasmusson spoke in favor, noting it would return the building to taxable status and free up parking spaces. Alder Neil supported it citing TID 8 closure timeline, $55,000 annual parking revenue, and downtown vitality. Alder Larson was the main dissent, arguing against discounting city parking assets during budget cuts. Alder Tierney questioned how the city would provide 150 parking spaces within 300 yards if the ramp closed; Economic Development Director Randy Feifer explained they reduced existing obligations from 480 to 150 spaces. Approved 6-3." },
      { item:"Mayoral citation for Public Works snow response", body:"Mayor Denny presented a citation recognizing Department of Public Works plow crews and municipal fleet staff for responding to a record-shattering 30.9 inches of snowfall from March 14-16, 2026. Kevin Kester, Dustin, Josh (street supervisor), and Mitch Harris were specifically mentioned. Fleet technicians worked 12-hour shifts providing continuous 24-hour breakdown support, with two volunteering on Saturday. Kester addressed the council saying 'you kicked its ass' regarding the storm response." },
      ...
      { item:"Solid waste and recycling service agreement", body:"Resolution approving a seven-year residential solid waste and recycling service agreement with Harter's Fox Valley Disposal was clarified as corrected from a previous mix-up between 7-year and 10-year terms. Passed unanimously 9-0." },
      { item:"Settlement resolution - David Holes vs. City of Wausau", body:"Assistant City Attorney Vincent Bonito explained a 2022 bus accident where Transit Mutual paid the initial claim, then the individual who crashed into the bus filed a personal injury claim. The city filed a counter claim and third-party complaint against the insurer. The insurer agreed to pay damages for the bus. Alder Neil clarified this settlement does not affect the separate ongoing personal injury claim. Approved 8-1 without need for closed session." },
    ],
    publicComment: "Two speakers addressed the council regarding the 11 Scott Street project. Raleigh Lray asked for support for the green sustainable project converting the vacant building to mid-priced apartments. Mark Craig of 3246 North 8th Street emphasized the project is over $10 million and challenging, stating 'Without your help, it won't happen' and noted the previous term sheet vote was 7-4.",
    actionItems: [
      "Development agreement and amended parking agreement for 11 Scott Street\/Waterside Place approved",
      ...
      "2026 budget modification approved for Police Department to purchase Red Dot Optics from Thompson submachine gun sale proceeds",
      ...
      "Settlement release approved in David Holes vs. City of Wausau case",
  ...
  },
  {
    ...
    discussions: [
      { item:"Minutes from February 18th", body:"Motion to approve made by Bugamman, seconded by Balkan. Minutes passed unanimously with all in favor." },
      { item:"Public hearing on conditional use permit for 218 South Fourth Street storage facility", body:"Jason Dunwy and Melinda Don Woody spoke in support of allowing a personal storage facility in the light industrial district. They noted that downtown Wausau has added over 400 new apartment units recently, including 153 units at Foundry on Third and 102 units at Evergreen Landing, and argued that apartment residents need convenient storage options to keep spending in Wausau rather than surrounding areas. The public hearing was closed but no action was taken on this item." },
      { item:"Conditional use permit for 731 North First Street apartment building", body:"Motion to approve made by Bornman, seconded by Bugamin. The permit authorizes Beacon Resources LLC to construct a 70-unit, 7-story apartment building. No questions or comments were raised. Motion passed unanimously." },
      { item:"Transportation project plat for Grand Avenue signal replacements", body:"Motion to approve made by Bugamin, seconded by Balkan. The project involves signal replacements at Sturgeon and Townline Road (Project 370-40-40). No discussion occurred. Motion passed unanimously." },
      { item:"Next meeting date", body:"Staff indicated the next regular meeting would be April 21st (third Tuesday), but noted it may need to be moved due to election and council meeting scheduling. Staff will notify commissioners if the date changes." },
    ],
    publicComment: "One written comment was submitted by Linda Lawrence on March 12th expressing support for a developer's proposal, stating housing capacity will benefit downtown small businesses and expressing personal willingness to live at the location. Jason Dunwy and Melinda Don Woody provided in-person comment during the public hearing for the storage facility, advocating for the project to serve new downtown apartment residents.",
    actionItems: [
      ...
      "Staff to confirm April 21st meeting date or notify of changes due to election scheduling",
    ],
    civicItems: [
  ...
  },
  {
    ...
    isAgendaOnly: false,
    badge: "new",
    overview: "The Marathon County Board held an educational meeting featuring presentations on PFAS contamination litigation and renewable energy regulation. No votes were taken as this was an informational session, but the board received detailed information about options to join multi-district PFAS litigation and tools available to negotiate with wind energy developers proposing projects in the county.",
    agenda: [
      ...
      { time:"1:10:01", item:"Overview of proposed wind projects in Marathon County" },
    ...
    discussions: [
      { item:"Public Comment", body:"Five residents spoke during public comment. Cindy Nielson from Stratford reported visiting 200 homes about wind turbine projects, stating no one she spoke with wants the turbines and residents lack information about current proposals. Wendy Rowski from Green Valley urged the board to vote no on the comprehensive plan next week, objecting to the term 'farm' being used for industrial energy facilities. Barb Newton and Sydney Hogan from Rib Mountain supported a petition with 75 signatures requesting speed reduction and no-passing zone on Double N Road. Heidi Pesky from McMillan argued that joint development agreements are not required for counties to regulate wind projects and listed numerous concerns about JDA provisions." },
      { item:"PFAS Multi-District Litigation Presentation", body:"Attorney Carrie McDougall from Baron and Budd Law Firm explained the nationwide PFAS litigation, noting his firm is lead counsel in the MDL consolidated in Charleston, South Carolina. He described the $12-13 billion settlement from 3M and $3-5 billion from DuPont for water contamination claims, emphasizing that airport and soil-based claims were specifically excluded from that settlement and remain viable. The contingency fee structure is 25% with no upfront costs to the county. Supervisor Robinson asked about scope of claims including landfill and land-spreading impacts. Vice Chair Dickinson clarified the airport currently has no known PFAS contamination. Supervisor Mash questioned the compensation structure, which McDougall confirmed is contingency-based with shared expenses across the MDL." },
      { item:"Renewable Energy Regulatory Authority Presentation", body:"Attorney Rebecca Roker from Atollus Law, representing Wisconsin Counties Association, explained that projects over 100 megawatts fall under PSC jurisdiction, significantly limiting county regulatory authority. She noted the Hub City Wind project from Alliant Energy has no PSC filings yet, giving the county time to prepare. Roker highlighted that PSC has approved 33 solar projects with zero denials. She presented four options for counties: do nothing, negotiate a joint development agreement (JDA), intervene in PSC proceedings, or litigate. She strongly recommended JDAs as the most effective tool to protect county interests including liability, environmental protection, road damage, decommissioning, and emergency response training, noting these protections are not otherwise available under state law." },
    ],
    publicComment: "Five speakers addressed the board: Cindy Nielson (Stratford) spoke against wind turbines, reporting opposition from 200 households she visited; Wendy Rowski (Green Valley) requested revisions to the comprehensive plan's terminology for energy facilities; Barb Newton and Sydney Hogan (Rib Mountain) supported a petition with 75 signatures for speed reduction on Double N Road; Heidi Pesky (McMillan) argued against joint development agreements for wind projects, citing concerns about county neutrality and long-term obligations.",
    actionItems: [
      ...
      "County to conduct PFAS testing at airport and landfill locations to assess potential claims",
      "County leadership to identify concerns about specific wind energy projects and potential impacts",
      "Speed reduction and no-passing zone request for Double N Road to proceed through infrastructure committee process",
    ],
  },
  {
    ...
    isAgendaOnly: false,
    badge: "new",
    overview: "The Wausau Board of Public Works held a brief meeting to open bids and award the 2026 asphalt paving project. RC Pavers was awarded the contract with a low bid of $824,146.34, beating American's bid of $849,872.10.",
    agenda: [
  ...
  },
  {
    ...
    isAgendaOnly: false,
    badge: "new",
    overview: "The Wausau Board of Public Works approved a low bid of $1,279,089.75 from Switlick for the 26th Street construction project, approved a change order for the Randolph\/Cherry Street project totaling $14,436.50, and approved a pay estimate of $535,114.20. All items passed unanimously in a brief meeting.",
    agenda: [
      ...
      { time:"2:23", item:"2025 Street Construction Project A - Randolph\/Cherry Street Change Orders" },
      { time:"5:01", item:"2025 Street Construction Project A - Pay Estimate #9" },
      { time:"5:32", item:"Portland cement concrete license for KSK Incorporated" },
      { time:"6:05", item:"Adjournment" },
    ],
    discussions: [
      { item:"March 10th Board of Public Works Minutes", body:"The minutes from the March 10th regular meeting were presented for approval. A motion was made and seconded, passing unanimously with all members voting aye." },
      { item:"26th Street Construction Project Bids", body:"Seven bids were opened and read aloud. Switlick submitted the low bid at $1,279,089.75, extremely close to Hos at $1,280,877.96. Other bidders included A1 ($1,374,600), Francis Melvin ($1,385,383), Steen ($1,489,126), James Peterson ($1,570,698.56), and Earth ($1,686,780.75). A board member noted 'tight bids' between the top two. Motion to approve Switlick as low bidder passed unanimously." },
      ...
      { item:"2025 Street Construction Project A - Change Order 1", body:"Staff presented four items in change order one: an inside drop on a manhole ($4,856) due to an undocumented large diameter sanitary service; water main tie-in adjustment ($2,317.50) when an expected 8-inch main was actually 6-inch; miscellaneous storm sewer work ($5,016) at $66 per lineal foot; and geogrid installation ($2,247) for approximately 750 square yards near Thomas Jefferson Elementary due to poor soil conditions. Change order two regarding liquidated damages was deferred pending further discussions. Total change order one of $14,436.50 was approved unanimously." },
      { item:"2025 Street Construction Project A - Pay Estimate #9", body:"Pay estimate number nine from Haw Suns Incorporated for work completed through the end of the year was presented in the amount of $535,114.20. Motion to approve passed unanimously." },
    ...
    actionItems: [
      ...
      "Approve Change Order 1 for Randolph\/Cherry Street project at $14,436.50",
      "Change Order 2 with liquidated damages discussion to return at future meeting",
      "Approve Pay Estimate #9 for $535,114.20 to Haw Suns Incorporated",
  ...
  },
  {
    ...
    isAgendaOnly: false,
    badge: "new",
    overview: "The Finance and Human Resources Committee debated and ultimately approved a modified employee clothing and equipment allowance policy after canceling the Centas uniform contract. Following multiple failed votes, the committee approved $400 annually plus a washer\/dryer purchase for staff, rather than the originally proposed $600. The committee also received a detailed presentation on public works operations showing the department operates below average spending compared to peer communities.",
    agenda: [
      ...
      { time:"4:15", item:"T1 and T2 detail reports for February acknowledgment" },
      { time:"4:40", item:"Legal details for February acknowledgment" },
      ...
      { time:"1:12:30", item:"Staff and committee remarks" },
      { time:"1:15:01", item:"Discussion of next meeting date (April 21, 2026)" },
      { time:"1:16:00", item:"Adjournment" },
    ],
    discussions: [
      { item:"Public Works Operations and Budget Presentation", body:"Public Works Director Michael presented a comprehensive overview of department operations covering 119.5 centerline miles of road, 114 miles of water main, 103 miles of sanitary sewer, and 70 miles of storm sewer. He noted the 2026 public works budget decreased by $26,000 (1.1%) from 2025. Michael emphasized that Weston spends approximately $9,700 less per mile than the average central Wisconsin community, making them the third lowest spending community per mile in the region. He discussed the recent major snow event where staff worked up to 17.5 hours, estimating costs around $50,000, and noted the county is pursuing disaster relief funds. Michael mentioned public works has 10 full-time members (down from 11 when he started in 2010) with a new hire starting Wednesday." },
      { item:"Clothing and Equipment Reimbursement Policy Amendments", body:"Extensive debate occurred over the proposed increase from $300 to $600 annual clothing allowance following cancellation of the Centas uniform contract. Committee member Brad questioned spending increases given the upcoming fire department referendum needs. Trustee Stephanie Armell argued for maintaining current benefits, noting employees shouldn't lose what they already receive. Michael defended the proposal, stating employees work in harsh conditions with chemicals and materials that destroy clothing, and emphasized staff retention concerns. The original motion for $600 failed on roll call vote (Daniels yes, Armell no, Love yes, My no, Soper no). A $400 motion also failed 3-3. Barbara Ermeling moved for $500 annually with washer\/dryer, which also failed. The final approved motion was $400 for remainder of 2026 and annually thereafter, plus a one-time washer\/dryer purchase, which passed with one opposed." },
      { item:"Approval of Previous Meeting Minutes and Financial Reports", body:"The committee unanimously approved minutes from February 16, 2026, and acknowledged the February 2026 financial reports, T1 and T2 detail reports, and legal details. All items passed without discussion via voice votes." },
    ],
    publicComment: "Lisa Beck of 1808 Cortez Lane offered public comment. She praised Mike for his work during the recent storm event. She also questioned the proposed clothing allowance increase, suggesting if Centas was cancelled to save money, the village should actually save money rather than spending it elsewhere, and recommended considering a lesser amount than the proposed $600.",
    actionItems: [
      "Approved employee clothing allowance of $400 for remainder of 2026 and $400 annually thereafter, with one-time purchase of washer and dryer for staff use - recommendation to village board",
      "February 2026 financial reports acknowledged",
      "Minutes from February 16, 2026 approved",
      "Next meeting scheduled for Tuesday, April 21, 2026 at approximately 5:00 PM",
      "Marathon County pursuing disaster relief funds for March snow event - public works to submit detailed cost documentation",
    ],
  },
  {
    ...
    isAgendaOnly: false,
    badge: "new",
    overview: "The Wausau Public Health and Safety Committee approved a parklet permit for Westider Diner and Lounge after the owner presented detailed plans, approved multiple license applications and summer events, and updated municipal code sections on solid waste disposal and cell phone use while driving. The committee also heard updates on the WMC shelter's transition to Bridge Street Mission, expected around April 20th.",
    agenda: [
      ...
      { time:"37:00", item:"Community outreach update and shelter transition to Bridge Street Mission" },
    ],
    discussions: [
      { item:"Meeting minutes approval", body:"The minutes from the February 16th, 2026 meeting were approved. Watson made the motion, Larson seconded. The motion passed unanimously with no opposition." },
      { item:"Westider Diner and Lounge parklet permit", body:"Owner Tyler Vote presented detailed mockups for a parklet extending 4 feet into the street and 4 feet onto the sidewalk at 628 North Third Ave. He explained it would provide sunny seating for breakfast customers and be lit with lights and decorated with flowers. Committee members asked about visibility and safety concerns near the alley exit. Larson noted initial skepticism but was convinced by the presentation. Watson moved to approve, Larson seconded, and the motion passed unanimously as a one-year trial with a November follow-up planned." },
      { item:"License denial recommendations - Theodore Davis", body:"Theodore Davis appeared regarding his bartender license denial recommendation related to a 20-year-old offense. He stated he had completed registry requirements and is in ongoing therapy. His boyfriend Matthew Prieb spoke in support, emphasizing Davis has not reoffended and is a good person. Deputy Chief Baiton indicated Chief Barnes had received rehabilitation evidence but hadn't reviewed the updated recommendation. The committee voted to hold the matter until the next meeting to allow Chief Barnes to complete his review." },
      { item:"License denial recommendations - Joanna Gregory", body:"Joanna Gregory did not appear for her denial recommendation hearing. The record noted her absence." },
      { item:"Batch license approvals", body:"The committee approved multiple items including summer events (Wings over Wausau, Concerts on the Square, Chalkfest, Memorial Day parade, Hope on the Block, Jazz on the River), liquor licenses for Oasis Arcade, Whiskey River Bar and Grill (new ownership), and Hayawa (new owner), plus class A retailers. All were unanimously recommended by the liquor license review subcommittee. Larson moved, Watson seconded, passed unanimously." },
      { item:"Municipal Code Chapter 6.44 - Solid waste disposal", body:"Assistant City Attorney Vinnie Bonino presented the repeal and recreation of the solid waste chapter to comply with state-level changes. Larson moved to approve, Watson seconded, passed unanimously with no discussion." },
      { item:"Municipal Code section 10.01.012 - Cell phone ban repeal", body:"Bonino explained the local cell phone ordinance is now redundant since state inattentive driving statutes have been amended to regulate cell phone usage more narrowly. Watson moved to repeal, Larson seconded, passed unanimously." },
      { item:"Midwest Renewable Energy partnership - Grow Solar program", body:"Carrie from the planning department reported the sustainability committee unanimously approved this March 5th. Alder Sarah noted her positive personal experience with solar installation and praised partnering with MREA as experts. Watson moved to approve, Larson seconded, passed unanimously." },
      { item:"Fire Department 2025 Annual Report", body:"Fire Chief reported the department handled over 7,200 calls, averaging 20 per day. He announced the department regained ISO Class 2 status as of Friday, which will remain for four years. Committee discussed upcoming referendum informational sessions on March 31st, April 1st, and April 3rd at various locations. The report was placed on file." },
      { item:"Tavern activities report - February 2026", body:"Deputy Chief Baiton presented a routine month. Alder Sarah asked about Trace Armanos, which has a Class B beer and liquor license but isn't listed as a tavern since they serve food with alcohol. Discussion noted an increase in impaired driving arrests during the recent blizzard. The report was placed on file." },
      { item:"Community outreach update - Shelter transition", body:"Tracy Durante reported 415 unduplicated guests served since the WMC shelter opened, with over 740 volunteer hours in February. Catholic Charities saw 99 unduplicated guests since November 1st. James Torensson, new Director of Homeless Services at Bridge Street Mission, explained the transition is expected around April 20th, with WMC shelter extending through April 19th to avoid gaps. The committee expressed interest in touring the new facility at the ribbon cutting ceremony." },
    ],
    publicComment: "Carrie Mor Everest of 1025 Everest Boulevard spoke during late public comment about concerns with emergency response treatment of unhoused individuals at the shelter. She stated she has volunteered throughout the shelter's operation and witnessed multiple 911 calls where people were not treated ethically or professionally. She expressed frustration that her complaints over 10 months have not been addressed and recently learned complaints should go to the police and fire commission. The chair acknowledged the formal complaint process exists through the Police and Fire Commission.",
    actionItems: [
      "Parklet permit approved for Westider Diner and Lounge at 628 North Third Ave for summer 2026 trial; owner to return in November to report",
      "Theodore Davis bartender license decision held until next meeting pending Chief Barnes' review of rehabilitation evidence",
      "Joanna Gregory bartender license denial upheld (applicant did not appear)",
      "Multiple licenses and summer event permits approved as recommended",
      ...
      "Memorandum of understanding with Midwest Renewable Energy for Grow Solar program approved",
      "Fire Department 2025 Annual Report placed on file",
      "February 2026 tavern activities report placed on file",
      "Committee to tour Bridge Street Mission shelter at ribbon cutting ceremony (date TBD around April 20th)",
      "Staff to verify demerit point totals for Days establishment on running calendar",
    ],
    civicItems: [
  ...
  },
  {
    ...
    isAgendaOnly: false,
    badge: "new",
    overview: "The Village of Weston Board of Trustees conducted regular business including approving rezoning ordinances, modifying a speed limit ordinance for Weston Avenue after debate, and approving a 10-year baseball\/softball field maintenance agreement. A resident criticized the board's approach to fire department funding, arguing they should prioritize public safety over amenities like turf fields and the aquatic center rather than relying on a referendum.",
    agenda: [
      { time:"0:01", item:"Call to order and Pledge of Allegiance" },
      ...
      { time:"44:00", item:"Baseball\/softball field maintenance agreement and other business items" },
    ],
    discussions: [
      { item:"Public Comment - Fire Department Funding", body:"Jim Pensel of 5002 Aerrol Street spoke critically about the board's approach to fire department staffing and funding. He praised SAFER department personnel but criticized the board for using 'band-aids' rather than fully funding the department through budget prioritization. Pensel argued that spending on artificial turf at Kennedy Park and the aquatic center should be deprioritized compared to public safety, and criticized the proposed referendum for lacking a sunset date while costs will continue to increase." },
      { item:"Finance Director Response", body:"Finance Director Jessica responded to public comment, explaining that the village cannot borrow for additional firefighter positions - borrowing was only approved for the Kennedy Park turf project. She noted that public works is the largest general fund expenditure and staff struggled during the recent blizzard due to understaffing. She expressed frustration with 'naysayers' and stated the village is 'the cheapest' and 'most efficient' but cannot continue without more revenue." },
      { item:"Ordinance 26-006 - Speed Limits on Weston Avenue", body:"The original ordinance proposing 35 mph from Von Kennel to Ryan Street failed 4-3, with Maloney, Jordan, and the presiding officer voting no. Trustee Maloney argued the road conditions between Von Kennel and Ryan don't justify 35 mph compared to other village roads. A substitute motion was made by Maloney to keep Camp Phillips to Von Kennel at 35 mph but return Von Kennel to Highway J to 45 mph, leaving other ordinance changes intact. This amended motion passed with Trustee Kern voting no." },
      ...
      { item:"Intersection Signage at Community Center Drive and Birch Street", body:"Motion to change stop sign to yield sign was approved with a friendly amendment adding a stop sign for bicyclists coming off the pedestrian bridge. Trustee Hoang expressed safety concerns about cyclists traveling 15-20 mph off the bridge with no signage requiring them to stop. The amended motion passed unanimously." },
      { item:"Baseball\/Softball Field Maintenance Agreement", body:"The board approved a 10-year maintenance agreement with youth baseball and softball organizations. The extended term was justified to protect the village's investment at Kennedy Park and provide stability for the organizations. The agreement requires the organizations to perform field maintenance in lieu of fees. Passed unanimously." },
      ...
      { item:"Microsoft Teams for Communication", body:"The board approved using Microsoft Teams for trustee communication starting with the next term. This would replace text messaging between trustees. A training session will be held when the new board is seated. Passed unanimously." },
      { item:"E-bike and Euro Ordinance", body:"The board voted to table the proposed e-bike ordinance until the county finalizes their process, then bring it back for consideration. Motion to table passed unanimously." },
    ],
    publicComment: "Jim Pensel of 5002 Aerrol Street spoke for approximately 4 minutes criticizing the board's approach to fire department funding. He attended the inaugural SAFER citizen academy and witnessed department understaffing firsthand. He argued the board should prioritize public safety funding over amenities like artificial turf and the aquatic center rather than relying on a referendum that lacks a sunset date.",
    actionItems: [
      "Speed limit on Weston Avenue from Von Kennel to Highway J remains at 45 mph; Camp Phillips to Von Kennel set at 35 mph",
      "Yield sign to be installed at Community Center Drive\/Birch Street intersection; stop sign to be added for bicyclists on pedestrian bridge",
      ...
      "Microsoft Teams to be implemented for trustee communication with training session for new board",
      ...
      "Various engineering contracts and change orders approved for Military Road utility, storm pond, sewer televising software, hospital area repaving, and well rehabilitation",
      "Two additional referendum Q&A sessions scheduled: March 31st 4:30-6pm and April 2nd 12-1:30pm",
  ...
  },
  {
    ...
    isAgendaOnly: false,
    badge: "new",
    overview: "The Marathon County Board of Supervisors adopted the 2026 Comprehensive Plan with ten amendments addressing renewable energy terminology, data centers, AI technology, and energy policy. The board also approved salaries for elected officials, authorized phase 2 design for a new highway facility, approved PFAS litigation, and ratified a local emergency declaration for a recent blizzard.",
    agenda: [
      ...
      { time:"3:00", item:"Adopting Marathon County Comprehensive Plan 2026 - Ordinance O-13-26" },
      ...
      { time:"1:24:00", item:"Authorizing outside counsel for PFAS litigation - Resolution 14-26" },
      ...
      { time:"1:38:00", item:"Announcements and recognition of departing supervisors" },
    ],
    discussions: [
      { item:"Consent Agenda Items C8-C13 B2", body:"Motion by Supervisor Rosenberg, second by Supervisor V. Passed unanimously with no discussion." },
      { item:"Marathon County Comprehensive Plan 2026 - Ordinance O-13-26", body:"Administrator Leonard presented ten proposed amendments compiled from supervisor feedback. Amendment 1 (livability standards) passed unanimously. Amendments 2, 3, and 4 (alternative energy systems terminology changes suggested by Vice Chair Dickinson) were separated at Supervisor Crawl's request and each passed but not unanimously. Amendment 5 (data centers and battery storage background) passed not unanimously after Supervisor Leur expressed concerns about ideological wording. Amendment 6 (radon and lead remediation) passed unanimously. Amendment 7 (regulate energy projects when allowed by law) passed not unanimously. Amendment 8 (AI and automation language by Supervisor Leur) passed unanimously. Amendment 9 by Supervisor Sindellski on promoting coal\/natural gas\/nuclear was amended by Supervisor Boots to remove 'clean coal' and 'nuclear' references, reading 'promote coal and natural gas until a long-term sustainable and reliable energy source can be found that does not adversely affect agricultural land' - passed not unanimously. Supervisor Rosenberg stated 'clean coal is a marketing promotional thing' and opposed. A late amendment by Supervisor Sindellski regarding utility-scale wind\/solar as industrial uses was debated but defeated after Supervisor Jeang's motion to refer to committee also failed. The comprehensive plan as amended passed but not unanimously." },
      { item:"Salaries for Elected Officials - Resolution 12-26", body:"Motion by Supervisor Conway, second by Supervisor Rosenberg establishing salaries for clerk of courts, sheriff, and elected department heads for the upcoming term. Passed with no discussion." },
      { item:"Highway Facility Phase 2 Design - Resolution 13-26", body:"Motion by Supervisor Robinson, second by Supervisor V. Supervisor Soyber requested future information on plans for the old facility. Supervisor Sindellski asked about the $53 million projected cost; Chair Gibbs clarified that cost approval was not part of this resolution. Passed unanimously." },
      { item:"PFAS Litigation Authorization - Resolution 14-26", body:"Motion by Supervisor Robinson, second by Supervisor Sefelt. Two amendments were adopted: Supervisor Robinson's amendment directing the county administrator to evaluate past and present practices that may have resulted in PFAS release or exposure passed unanimously. Vice Chair Dickinson's amendment modifying airport-related language to reference county property passed unanimously. The resolution as amended passed unanimously." },
      { item:"Budget Carry Forwards - Resolution R-20-26", body:"Motion by Supervisor Morash, second by Supervisor Arstead approving carry forwards and associated budget amendments. Passed with no discussion." },
      { item:"Capital Asset Threshold - Resolution 21-26", body:"Motion by Supervisor Robinson, second by Supervisor Mask setting $10,000 threshold for general capital assets and $50,000 for infrastructure assets. Passed but not unanimous." },
      { item:"Law Enforcement Drug Trafficking Grant - Resolution R-17-26", body:"Motion by Supervisor Jeang, second by Supervisor P to amend 2026 budget to accept the grant. Passed unanimously." },
      { item:"Local Emergency Declaration Ratification - Resolution 22-26", body:"Motion by Supervisor Sefeld, second by Supervisor Arstead. Administrator Leonard explained the ratification preserves opportunities for state reimbursement following a blizzard event. He praised county staff including facilities, parks, highway, sheriff's office, and airport, noting over 600 hours of call-in time and staff working 12-16 hour shifts. Supervisor Fifer echoed thanks to staff. Passed unanimously." },
    ...
    publicComment: "No public comment was offered.",
    actionItems: [
      "Adopted Marathon County Comprehensive Plan 2026 with ten amendments (Ordinance O-13-26)",
      "Established salaries for clerk of courts, sheriff, and elected department heads for upcoming term",
      "Authorized staff to proceed with phase 2 design services for new highway facility",
      "Authorized engagement of outside counsel for PFAS litigation on contingency basis",
      "County administrator directed to evaluate past and present practices regarding PFAS exposure",
      "Approved budget carry forwards and associated amendments",
      "Set capital asset thresholds at $10,000 general and $50,000 infrastructure",
      "Accepted law enforcement drug trafficking response grant and budget amendment",
      "Ratified local state of emergency declaration for blizzard response",
      "Accepted administrator performance evaluation and salary placement per new pay structure",
      "Recognized departing supervisors: Crawl, Fifick, Marshall, Rosenberg, Hardinger, V, and Reynolds",
    ],
  },
  {
    ...
    isAgendaOnly: false,
    badge: "new",
    overview: "The Parks Committee approved minutes, selected Rettler Corporation for the Mock Mueller Park master plan project, and discussed park impact fees with general support for moderate increases to align with neighboring communities. The committee also reviewed Yellow Banks kayak launch expenses showing significant grant funding success and discussed ice rink operations at Kennedy Park.",
    agenda: [
      ...
      { time:"26:00", item:"Discussion on requests for proposals for Mock Mueller Park master plan" },
    ...
    discussions: [
      { item:"Approval of minutes", body:"Minutes from February 23rd, 2026 meeting were approved. Motion to accept was made with a second, passed unanimously with no discussion." },
      { item:"Parks and recreation impact fee discussion", body:"Jennifer presented information on park impact fees, noting the 2020 study allowed fees up to $761 for single family but the village only raised to $300. Neighboring communities charge $600-650 for single family homes. Committee members Katrina and others expressed support for a moderate increase to align with neighbors rather than maximum increase. The fees fund amenities like trails in new subdivisions. Michael noted a mile of multi-use path costs roughly $100,000. No formal action taken; information will go to Plan Commission." },
      { item:"Mock Mueller Park master plan RFP selection", body:"Seven proposals were received for the park master plan. Four staff members reviewed and rated proposals based on firm experience, personnel, similar projects, scope understanding, and cost. Roger made a motion to select Rettler Corporation, noting their local experience and park planning expertise. Katrina seconded. Motion passed unanimously. JSD and Rettler were the two lowest bidders and most qualified." },
      { item:"Yellow Banks kayak launch expenses review", body:"Jessica presented detailed expense breakdown showing the project received significant grant funding from DNR, Marathon County Transportation, and other sources. Lisa Beck praised the RFC presentation during public comment. Committee members commended Jessica and Dan Higginbotham for grant writing efforts. PGA Construction donated labor and equipment time. MTS donated site planning. Katrina suggested formal recognition for Dan Higginbotham. No formal action required; informational item only." },
      { item:"Ice rink operations at Kennedy Park", body:"Staff presented information on ice rink operations per committee request. The warming house has been unattended since 2020 due to COVID and subsequent staffing recruitment failures. Everest Youth Hockey has expressed interest in improvements including a roofed structure. Discussion touched on Marathon Park changes creating potential increased need for ice facilities. Katrina requested the discussion to ensure hockey users aren't forgotten amid Kennedy Park baseball focus. Committee requested additional historical attendance figures and user feedback for future meetings." },
    ],
    publicComment: "Jim Pinsel spoke expressing frustration about not receiving responses to questions submitted at the previous meeting regarding playground equipment installation issues, Kennedy Park fundraising updates, ice rink costs, and requesting full cost accounting including staff hours for ice rink operations. Lisa Beck (1808 Cortez Lane) thanked Michael for snow removal work during the blizzard and praised Sean and Jessica for the well-written Yellow Banks RFC documentation. A written response to Jim Pinsel's previous comments was noted for inclusion in minutes.",
    actionItems: [
  ...
  },
  {
    ...
    isAgendaOnly: false,
    badge: "new",
    overview: "The Wausau Finance Committee approved several routine items including airport ground leases and budget carryovers, while postponing decisions on joining a national opioid settlement and funding a lead service line replacement project shortfall. The committee also denied a tax recovery claim related to ongoing Greenwood Hills litigation and approved transfers from the general fund to cover shortfalls in recycling, airport, and parking funds.",
    agenda: [
      ...
      { time:"47:35", item:"2026 general obligation promissory note for capital improvements" },
      { time:"54:30", item:"Consideration of purchasing properties for DPW Streets Division" },
    ],
    discussions: [
      { item:"March 10, 2026 meeting minutes", body:"Minutes were approved without discussion. Motion by Watson, second by Griner. Passed unanimously." },
      { item:"Green Acres at Greenwood Hills LLC tax claim", body:"This item involves ongoing litigation with Greenwood Hills. The chair explained that a motion to approve would be made, but a 'no' vote would deny the claim. Watson moved to approve, Griner seconded. The motion failed when members voted 'no' to deny the claim." },
      { item:"Airport ground lease transfers at 939 Woods Place", body:"Three related items facilitated transfer of a hangar from Win O. Jones to Owen Jones. All three motions (consent to transfer title, terminating old lease, approving new lease) passed unanimously with motions from Watson and Tierney." },
      { item:"Airport ground lease with Cole Lundberg", body:"Motion by Griner, second by Watson. Passed unanimously without discussion." },
      { item:"National opioid settlement agreement", body:"Committee members expressed discomfort proceeding without more information about the class action lawsuit. Alder Malini asked where the request originated. Assistant City Attorney Vincent explained a law firm sent notice that the city may qualify as a class member. Alder Tierney and others wanted more details before committing. Griner moved to postpone to the next meeting, seconded by Tierney. Passed unanimously. Decision deadline is May 4th." },
      { item:"Lead service line replacement budget amendment", body:"Public Works Director Eric explained the DNR changed funding terms, resulting in $709,000 in non-construction costs not covered by the subsidized loan. Finance Director Marian outlined options including borrowing, using general fund reserves, or PFAS settlement money. Alder Tierney opposed adding more debt. Committee discussed splitting funding sources - $283,868 for private side from general fund, $425,803 for public side potentially from PFAS settlement. Watson moved to postpone to next meeting for more information. Passed unanimously." },
      { item:"2025-2026 carryover funds budget amendment", body:"Finance Director explained the large number includes $10 million for transit buses funded by VW mitigation grants. Other items include airport projects awaiting grant draws and contracts in progress. Watson moved to approve, Griner seconded. Passed unanimously." },
      { item:"Motorpool fund financial results", body:"Finance Director reported the motorpool fund would show a $150,000 net profit after transferring GMT money. However, there's a $177,000 cash flow shortfall when paying for vehicles ordered as far back as 2023 due to supply chain issues. Solomon from Motorpool reported two dump trucks ordered in 2023 are finally near the front of the line. ARPA savings may cover the shortfall. This was informational only - no action required." },
      { item:"General fund financial results", body:"The general fund showed a surplus of approximately $1.2 million driven by strong revenues from building permits, GMT money, and investment income. After full motorpool charges, surplus is $125,000. The finance director explained CCITC was over budget by $194,000 due to communication issues and an Office 365 upgrade. After proposed transfers to recycling, airport, and parking funds, surplus would be $540,000. Tierney moved to approve the transfers, Watson seconded. Passed unanimously." },
      { item:"2026 general obligation promissory note calendar", body:"Finance Director presented the borrowing schedule for 2026 capital projects including street projects, motorpool, and TID district items. Watson noted debt utilization will decrease slightly even with new issuance. Watson moved to approve the calendar, chair seconded. Passed unanimously. Phil Cawson from Ehlers will present parameters resolution at the next meeting." },
      { item:"DPW property purchases", body:"Committee was prepared to enter closed session but decided to postpone due to time constraints before council meeting. Watson moved to postpone to next meeting, Tierney seconded. Passed unanimously." },
    ],
    publicComment: "No public comment was offered.",
    actionItems: [
      ...
      "Postponed lead service line funding decision to next meeting pending further analysis",
      "Approved $10+ million budget amendment for 2025-2026 carryover funds",
  ...
  },
  {
    ...
    isAgendaOnly: false,
    badge: "new",
    overview: "The Marathon County Executive Committee met briefly before going into closed session to conduct the performance review of the County Administrator. All members present voted unanimously to enter closed session for this personnel matter.",
    agenda: [
      { time:"0:00", item:"Call to order" },
    ...
    discussions: [
      { item:"Performance review of the administrator", body:"The chair explained the committee had the option to go into closed session to discuss the final review of the County Administrator, incorporating board feedback received the previous Thursday. The chair noted the executive committee had rated the administrator on various questions using three criteria: needs improvement, successful, and exceptional, with scores averaged on a 0-5 scale. Corporation counsel was asked to provide a summary. A motion was made and seconded to go into closed session, passing unanimously with all members voting aye: Gibbs, Dickinson, Arstead, Boots, Drebeck, Fifick, Mask, Ritter, Morash, and Robinson." },
    ],
    publicComment: "No public comment was offered.",
    actionItems: [
  ...
  },
  {
    ...
    isAgendaOnly: false,
    badge: "new",
    overview: "The Marathon County HR, Finance, and Property Committee approved several key items including disallowing a claim related to a child's death, setting revised property values for public auction, approving carry forward funds, and amending the capital assets threshold policy. The committee also received introductions from new healthcare consultants and detailed financial updates for 2025 year-end and 2026 year-to-date.",
    agenda: [
    ...
    discussions: [
      { item:"Claim disallowance - Mercedes Holmes", body:"Corporation Counsel presented a claim received December 5th from Mercedes Holmes relating to the death of her 3-year-old child Zalen Bernett, who was in a treatment foster care home licensed through another agency in Dunn County. Law enforcement and social service investigations found no wrongdoing and the death was determined natural causes. Outside counsel recommended formal disallowance. Chair Gibbs moved to disallow the claim per the insurance carrier's recommendation. Supervisor Lur seconded. Motion carried unanimously." },
      { item:"Revised property values for public auction", body:"Staff explained two parcels at 529 Mullen Street and 738 South Third Avenue failed to sell at Wisconsin Surplus twice, with bids not reaching appraised values. Staff requested revised minimum sale prices of $9,000 and $7,500 respectively. Chair Gibbs moved to set the revised prices, Supervisor Lmer seconded. Motion carried unanimously. Committee Chair Robinson asked about bidders who made errors - staff confirmed they are marked as non-pay and banned from future auctions." },
      { item:"Resolution to approve carry forward funds (R20-2026)", body:"Sam from Finance presented program revenues and restricted funds requiring carryover to 2026, including veterans relief fund replenishment from 2025 excess budget (providing approximately three years of funding). Discussion included questions about veterans relief fund discretion (managed by a three-member veteran service commission per statute) and the register of deeds redacted records fund. The $142,731 administration special projects carryover includes $75,000 for homelessness contract. Chair Gibbs moved approval, Supervisor Hart seconded. Motion carried unanimously." },
      { item:"Resolution to amend capital assets threshold policy", body:"Sam explained the capital asset threshold has been $5,000 since 2006 per GFOA guidance. The resolution proposes increasing it to $10,000 for general assets. Supervisor Hart moved approval, Chair Gibbs seconded. Motion carried unanimously to forward to full county board." },
      { item:"Introduction of healthcare consultants - National Insurance Services", body:"HR Director Candace introduced NIS representatives following their selection through RFP process. NIS representative with 28 years experience explained their public sector specialization and five-person team serving Marathon County. They outlined priorities: evaluating the near-site ATA clinic for return on investment, evaluating medical funding models (fully insured vs self-insured vs level funded), and providing increased transparency to the committee. Vice Chair Marshall asked about comparative costs with other employers and strategies to reduce emergency room usage. Chair Gibbs discussed self-insurance risk tolerance considerations." },
      { item:"Audited 2025 year-end fiscal update", body:"Finance Director Sam provided detailed department-by-department review of unaudited 2025 year-end figures, noting various transfers pending, carryovers, and reconciliation items still in process. Key items included: sales tax transfer of $2.147 million to debt service, opioid fund cash at $2.2 million with $3.49 million in future settlements expected, and parks fund receiving increased ice revenue of $70,000. Final fund balance surplus number will be provided at next meeting after capital assets reconciliation." },
      { item:"2026 year-to-date fiscal update", body:"Sam reported 2026 is progressing as expected with some reclassification entries needed. First quarter will close May 31st, then monthly closeouts thereafter with two-month lag to ensure accurate reporting." },
      { item:"Finance department quarterly update", body:"Sam reported welcoming a new financial analyst for payroll, achieving full staffing since mid-December. Department conducted quarterly closeout training, countywide report training, and random cash audits (all successful). Administrator Lance Leonhard praised Sam and her team for handling W-2 processing challenges related to the 'big beautiful bill' overtime tax changes while being short-staffed. Chair Gibbs and Vice Chair Marshall thanked Sam for improved reporting and transparency." },
      { item:"County treasurer update", body:"Treasurer Connie reported on tax collection activities including 1,582 delinquent tax notices mailed (down from 1,786 last year), processing February settlements, working with DOR on lottery credit corrections, and addressing municipal receipting errors. Discussion covered educational outreach to municipal treasurers, lottery credit processing confusion, and resources for struggling taxpayers. Administrator Leonhard explained the county no longer offers payment agreements as they often resulted in NSF checks and increased interest penalties, and clarified that evictions referenced are specifically related to county tax deed processes, not general evictions." },
    ],
    publicComment: "No public comment was offered.",
    actionItems: [
      "Disallowed claim of Mercedes Holmes per insurance carrier recommendation",
      "Set revised minimum sale prices for 529 Mullen Street ($9,000) and 738 South Third Avenue ($7,500) for Wisconsin Surplus auction",
      ...
      "Finance to provide final 2025 fund balance surplus at next meeting after capital asset reconciliation",
      "Research register of deeds redacted records fund usage and potential repurposing options",
      "Healthcare consultants to provide update before summer budget assumptions development",
      "Consider increasing social services reserve account beyond current $400,000 due to anticipated correctional care cost increases",
      "Explore centralized training with Transcendent\/Ascent for municipal treasurers on receipting and lottery credits",
  ...
  },
  {
    ...
    discussions: [
      ...
      { item:"NEOLA UPDATE", body:"The Committee was scheduled to spend approximately 20 minutes reviewing proposed changes to over 60 district policies across multiple categories. The policy updates ranged from small technical corrections to more substantive changes, including policies on cell phones, artificial intelligence, academic honesty, reading instruction, student fees, and child abuse reporting under Act 57." },
    ],
    ...
    actionItems: [
      ...
      "Action was requested for continued membership in the Wisconsin School Nutrition Purchasing Cooperative for the 2026-2027 school year",
      ...
      "Action was requested for approval of NEOLA policy updates including policies on definitions, board member conduct, district administrator relationships, reading instruction, parent engagement, athletics, cell phones, student fees, purchasing, AI usage, and school support organizations",
      "Action was requested for technical corrections to 18 policies",
      "Action was requested for Act 57 related policy updates regarding child abuse and neglect reporting and student supervision",
    ],
  },
  {
