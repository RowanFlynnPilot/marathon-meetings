...
const MEETINGS = [
  {
    ...
    isAgendaOnly: false,
    badge: "new",
    overview: "The Public Works Committee approved several routine items and made key decisions including awarding a recycled asphalt crushing contract to King Gravel for $126,900, adopting a resolution supporting state transportation funding, directing staff to create enforcement language for sanitary sewer discharge violations at $100\/day fines, and approving construction service proposals for upcoming road projects. The committee also discussed significant clear water infiltration issues costing the village approximately $30,000-$42,000 monthly in excess treatment costs.",
    agenda: [
      { time:"0:09", item:"Call to order" },
      { time:"0:22", item:"Pledge of allegiance" },
      { time:"0:50", item:"Roll call" },
      { time:"1:05", item:"Public comment" },
      { time:"1:10", item:"Approval of April 13, 2026 meeting minutes" },
      { time:"1:25", item:"Acknowledge April 2026 water and sewer permits" },
      { time:"1:40", item:"CIP update" },
      { time:"17:55", item:"Street operation update" },
      { time:"29:40", item:"Utility operating update" },
      { time:"41:20", item:"2025 Water Utility PSC annual report" },
      { time:"48:05", item:"Resolution 2026-014 transportation funding" },
      { time:"50:55", item:"Recycled asphalt base course production" },
      { time:"55:10", item:"Sanitary sewer discharge violation discussion" },
    ],
    discussions: [
      { item:"CIP Update", body:"Michael reported the village received a Local Road Improvement Grant for Birch Street reconstruction between Scofield Avenue and Community Center Drive, covering over 50% of the estimated $1.5 million project cost. This 2029 project will likely be moved to 2028. He noted the village has received over $9 million in grant funding over the past 4-5 years. Discussion also covered Weston Avenue repairs by Integrity Grading and Excavating for road settling over sanitary sewer trenches, with agreement the contractor must return if issues recur. Scofield Avenue manhole repairs with HOS Construction and Fuller Street repairs with Melvin were also discussed." },
      { item:"Street Operations Update", body:"Staff reported on spring activities including road limit removal, mailbox and sign repairs, curb line sweeping, and hot mix patching. Significant flooding mitigation occurred near Weston Avenue tributary requiring a week of dewatering pumps. Jones Street culvert failures required installation of a third 18-inch culvert. Shop repairs included transitioning plow trucks for summer use with fluid film anti-rust treatment. A new Mac tandem axle chassis has been ordered with upfitter items being coordinated through Scott's Repair." },
      { item:"Utility Operating Update", body:"Josh reported on service repairs at Caribou Coffee and ongoing lift station maintenance due to power and phase failures. The committee discussed significant clear water infiltration issues - April saw 37 million gallons pumped into the system but 54 million gallons treated at the wastewater plant, indicating approximately 15 million gallons of clear water from infiltration or illegal sump pump discharges. In-pipe Technologies will conduct an INI study to identify problem areas. The Kathleen lift station was cited as an example where one house's sump pump caused the station to run nearly continuously." },
      { item:"2025 Water Utility PSC Annual Report", body:"Michael presented the annual report showing operating revenues of approximately $3 million with net operating income of $482,911 for 2025, consistent with 2024's $490,000. Water loss was 6%. The utility's total value reached nearly $34 million, an increase of 6.7% from infrastructure placed in service including Wells 7 and 8 and water mains from Weston Avenue project. The utility serves 6,100 customers total with 5,250 in Weston and 830 in Rothschild. Approved unanimously on motion to acknowledge." },
      { item:"Resolution 2026-014 Transportation Funding", body:"Michael explained this League of Wisconsin Municipalities sample resolution supports long-term funding solutions for state transportation. The resolution addresses the gap between grant funding for one-time costs versus recurring annual needs for street maintenance and snow plowing that are currently subsidized by general tax dollars. Wisconsin remains affordable compared to neighboring states for automobile ownership costs. Approved unanimously to recommend village board adoption." },
      { item:"Recycled Asphalt Base Course Production", body:"Michael presented quotes for crushing recycled concrete and asphalt at the Ryan Street site. King Gravel submitted the low bid at $4.23\/ton for an estimated 30,000 tons totaling $126,900. He demonstrated cost savings by comparing the village's $17.11\/cubic yard cost versus City of Wausau's $28\/cubic yard, resulting in approximately $130,000 savings across three 2026 projects. Approved unanimously to award contract to King Gravel." },
      { item:"Sanitary Sewer Discharge Violation Discussion", body:"Staff sought guidance on enforcement of sewer discharge violations, particularly for residents illegally connecting sump pumps to sanitary sewers. Current code allows fines of $100-$1,000 per day. Committee members distinguished between unknowing versus willful violations. Discussion included waiting for In-Pipe Technologies study results before issuing violation notices. The committee directed staff to create enforcement language with fines not to exceed $100 per day, approved unanimously." },
      { item:"Water and Sewer Connection Agreement - Radkkey Avenue", body:"Michael explained a builder wants to construct a duplex on Lot 1 at 2230 Radkkey Avenue, which lacks frontage on a water main. Staff proposed allowing temporary long lateral connection until Radkkey Avenue reconstruction extends mains, at which point the owner would pay assessment. Committee directed adding language specifying reconstruction \"no later than 2029.\" Approved unanimously with the date modification." },
      { item:"Military Road Construction Agreement", body:"The committee reviewed an intergovernmental agreement with Village of Rothschild for Military Road construction from Wolfman Street to Helin Street. Weston's share covers water main relocation ($88,704) and sanitary sewer ($6,156) for total utility costs of $94,860. Steam Construction is the contractor. Water main requires relocation due to conflict with storm sewer improvements. Approved unanimously." },
      { item:"Construction Service Proposals - Alderson\/Jelnik and Bladel Projects", body:"Michael presented proposals for construction inspection services. For Alderson\/Jelnik roundabout project, MSA proposed $37,315 versus Clark Dietz at $48,910; MSA recommended due to lower cost and roundabout design involvement. For Bladel Avenue, MSA proposed $70,400 versus Clark Dietz at $73,730; Clark Dietz recommended despite higher cost because they would provide experienced full-time staff versus MSA's summer intern. Approved unanimously to use MSA for roundabout and Clark Dietz for Bladel." },
    ],
    ...
    actionItems: [
      ...
      "Recommend village board adopt Resolution 2026-014 supporting state transportation funding",
      "Direct staff to create enforcement language for sanitary sewer discharge violations at $100\/day maximum fine",
      "Enter agreement with 2230 Radkkey Avenue property owner for temporary utility connection with assessment due upon Radkkey Avenue reconstruction no later than 2029",
      "Approve intergovernmental agreement with Rothschild for Military Road construction with Weston utility costs of $94,860",
      "Award construction services to MSA for Alderson\/Jelnik project ($37,315) and Clark Dietz for Bladel Avenue project ($73,730)",
      "Schedule special assessment meeting for Bladel Avenue on Thursday, May 28, 2026 at 6:00 PM",
      "Staff to provide cost analysis of clear water infiltration treatment expenses for next meeting",
      "Norcon to begin Scofield Avenue concrete repairs in eastbound lanes starting Wednesday\/Thursday",
    ],
  },
  {
    ...
    date: "May 18, 2026", shortDate: "MAY 18",
    committee: "Village of Weston Plan Commission", duration: "~1h",
    url: "https://www.youtube.com/watch?v=eX7VOuywzb8",
    docUrl: "https://www.westonwi.gov/AgendaCenter/ViewFile/Agenda/_05182026-1918",
    isAgendaOnly: false,
    badge: "new",
    overview: "The Village of Weston Plan Commission approved the site plan for the new Mountain Bay Metro Police Department and Municipal Court facility at 3600 Community Center Drive, and adopted a new salt storage shed inspection program for wellhead protection areas. Both items passed unanimously with the commission addressing technical details about gas line easements and future building expansion possibilities.",
    agenda: [
      { time:"0:01", item:"Call to order and roll call" },
      { time:"1:18", item:"Open public comment period" },
      { time:"5:00", item:"Approval of April 13, 2026 meeting minutes" },
      { time:"5:24", item:"Site plan review - Mountain Bay Metro Police Department and Municipal Court facility at 3600 Community Center Drive" },
      { time:"20:01", item:"Creation of salt storage shed inspection program - Wellhead protection district" },
      { time:"28:18", item:"April 2026 staff approved certified survey map and site plan" },
      { time:"28:35", item:"April 2026 building permit" },
      { time:"28:50", item:"Planning and development department monthly project update report" },
      { time:"30:00", item:"Commissioner remarks" },
      { time:"31:15", item:"Future agenda items" },
      { time:"34:25", item:"Adjournment" },
    ],
    discussions: [
      { item:"Mountain Bay Metro Police Department and Municipal Court facility site plan", body:"Staff presented the site plan for the new police department at 3600 Community Center Drive, noting it meets all B2 zoning requirements. Chief Jeremy explained the building was rotated to face east due to a gas pipeline underneath the parking lot, which significantly reduced fill costs. The building will accommodate 50-60 officers for future growth beyond the current 40 officers. Discussion included an alternate storage shed location and future expansion possibilities to the north. Motion to approve was made and passed unanimously with conditions 2 through 5 as listed by staff." },
      { item:"Salt storage shed inspection program for wellhead protection district", body:"Jennifer presented a new inspection program requiring two annual inspections per facility - one warm weather inspection focused on structural integrity and one winter operational inspection focused on material handling practices. The program includes a standardized inspection worksheet similar to DOT standards. Staff noted one existing facility near Sternberg has never gone through the wellhead protection conditional use process and agreed to reach out to them. Motion to approve passed unanimously with an amendment to report back to both the Plan Commission and Public Works Committee." },
      { item:"April 2026 meeting minutes", body:"Motion to approve the April 13, 2026 meeting minutes was made and seconded. Passed unanimously without discussion." },
      { item:"April 2026 staff approved items and building permits", body:"Both the certified survey map\/site plan report and building permit report for April 2026 were approved unanimously without discussion." },
      { item:"Planning department monthly update", body:"Jennifer announced the first meeting of the joint Plan Commission\/Village Board steering committee for the comprehensive plan is scheduled for Monday, June 1st at 5:00 p.m. Commissioner discussion followed regarding potential residential TIF districts for workforce housing, with staff noting Ehlers has prepared a presentation on qualifications that could be shared with the commission." },
    ],
    publicComment: "Jim Pensson of 5002 Arrow Street, Weston, spoke via video call requesting the commission use common sense regarding landscaping requirements for the police department project to avoid excessive taxpayer costs similar to the Green Heck Turner building. He also requested annual reporting on the salt shed inspection program, noting some zoning complaints are years old and get 'lost in the sauce.'",
    actionItems: [
      ...
      "Salt storage shed inspection program adopted for wellhead protection district with two annual inspections per facility",
      "Staff to report inspection program findings back to Plan Commission and Public Works Committee in approximately one year",
      "Staff to reach out to existing salt storage facility near Sternberg that has not gone through wellhead protection conditional use process",
      "Joint Plan Commission\/Village Board steering committee meeting scheduled for June 1st at 5:00 p.m.",
      "Staff to send email and calendar event for steering committee meeting",
      "Electric vehicle charging stations added as future agenda item for fall",
  ...
  },
  {
    ...
    isAgendaOnly: false,
    badge: "new",
    overview: "The Marathon County Health & Human Services Committee held an organizational meeting for new board members, providing educational presentations on the Health Department, Social Services, Veteran Services, and Aging & Disability Resource Center. The committee approved April 1st meeting minutes unanimously and received detailed overviews of department missions, budgets, and current initiatives including homelessness response efforts and veteran suicide prevention programs.",
    agenda: [
      { time:"0:00", item:"Call to order and verification of remote participants" },
      { time:"0:30", item:"Pledge of Allegiance" },
      { time:"1:00", item:"Approval of April 1st committee meeting minutes" },
      { time:"1:30", item:"Operational functions required by statute, ordinance, resolution or policy" },
      { time:"3:00", item:"Review of standing committee ordinance section 2.04 - missions, duties, responsibilities" },
      { time:"10:01", item:"Health Department overview and budget presentation" },
      { time:"25:04", item:"Social Services Department overview" },
      { time:"45:01", item:"Veteran Service Department overview" },
      { time:"1:15:00", item:"Aging & Disability Resource Center overview" },
    ...
    discussions: [
      ...
      { item:"Standing Committee Ordinance Review", body:"Administrator Lance Leonard explained the committee's structure under section 2.04 subsection 5, covering jurisdiction over Health Department, Social Services, Veteran Services, North Central Health Care, and the Aging & Disability Resource Center. He outlined relationships with subordinate bodies including the Social Services Board, Veteran Service Commission, Transportation Coordinating Committee, and Board of Health." },
      { item:"Health Department Presentation", body:"Health Officer Caitlyn Suginaka presented the department's mission of preventing disease, promoting health, and protecting against environmental hazards. The department has 37.6 FTE staff across four divisions. She highlighted public health vending machines offering free resources including tick kits, the Nurse Family Partnership program with first graduates, and a new homeless system response position created from a task force recommendation. The department's $5 million budget is approximately half tax levy with significant grant funding." },
      { item:"Social Services Department Overview", body:"Administrator Leonard presented on behalf of absent Director Christa, explaining the department's 140 FTE staff handling child welfare, youth justice, children's long-term support, economic support, and child support. He highlighted the successful Family Keys pilot program addressing housing instability, noting the program substantively changed based on board feedback. The department's $22 million budget includes about $7 million in tax levy." },
      { item:"Veteran Service Department Presentation", body:"Veteran Service Officer Aaron Galindo reported his department increased to 3.0 FTE in 2025. Customer interactions jumped from 5,900 to 8,149 in 2025. He highlighted $44 million annually in VA benefits flowing to county veterans and $2.6 million in retroactive payments in 2025. Key initiatives include surviving spouse benefits outreach, housing stability partnerships with Center for Veterans Issues, and suicide prevention efforts noting 7 of 30 county suicides in 2025 were veterans. He discussed the Staff Sergeant Gordon Fox suicide prevention grant opportunity." },
      { item:"ADRC Presentation", body:"Executive Director Mike Ray explained the four-county regional model serving Marathon, Lincoln, Langlade, and Wood counties with about 60 FTEs and 385-400 volunteers. He noted 11% of budget comes from county levy with Marathon contributing $413,135. The nutrition program faces 40-45% cost increases over four years while federal funding remains flat, forcing meal and service reductions. The organization hadn't requested a levy increase from 2011 until 2024." },
    ],
    publicComment: "No public comment was offered.",
    actionItems: [
      "Schedule North Central Healthcare for separate full presentation before the committee",
      "Chair Boots to bring strategic plan items to future meetings",
      "Health Department to provide location details for public health vending machines",
  ...
  },
  {
    ...
    isAgendaOnly: false,
    badge: "new",
    overview: "The Marathon County Board of Supervisors held an adjourned organizational meeting where they approved committee appointments, elected Supervisors Hapa and Arstead to the executive committee at-large positions, and unanimously approved a resolution to reduce landfill tipping fees for disaster debris following the recent severe weather emergency declaration. The board also heard public comment from residents affected by the tornado in Ringle requesting additional fee relief.",
    agenda: [
      { time:"0:00", item:"Pledge of Allegiance and moment of reflection" },
      { time:"0:30", item:"Reading of notice and roll call" },
      { time:"5:01", item:"Committee appointments discussion and remarks from Chair" },
      { time:"10:01", item:"Election of at-large executive committee members" },
      { time:"20:00", item:"Consent agenda items C10-C14A" },
      { time:"20:30", item:"Resolution 24-26: Out of home placement reserve increase" },
      { time:"21:00", item:"Resolution 25-26: Social services budget amendment" },
      { time:"21:30", item:"Resolution 26-26: Landfill tipping fee modification" },
      { time:"40:00", item:"Public comment on tipping fee resolution" },
      { time:"1:15:01", item:"Announcements and adjournment" },
    ],
    discussions: [
      { item:"Committee Appointments", body:"Chair Gibbs presented committee appointments developed with Vice Chair Boots, emphasizing goals of increasing diverse perspectives, mentoring opportunities for newer supervisors (34% in first or second term), and honoring supervisor preferences. The appointments for both county board chair and administrator positions were included in one motion by Supervisor Cavelli, seconded by Supervisor Crims. The motion carried but was not unanimous." },
      { item:"Election of At-Large Executive Committee Members", body:"Three supervisors were nominated: Supervisor Hapa (nominated by Supervisor Mask), Supervisor Leur (nominated by Supervisor Rosenberg, who cited Leur's advocacy for children and elders), and Supervisor Arstead (nominated by Supervisor Boots). After paper ballot voting, Supervisors Hapa and Arstead were elected to the executive committee at-large positions." },
      { item:"Consent Agenda", body:"Items C10-C14A were approved unanimously on motion by Supervisor Cavelli, seconded by Supervisor Drebeck, with no discussion." },
      ...
      { item:"Resolution 25-26: Social Services Budget Amendment", body:"Motion by Supervisor P, seconded by Supervisor Robinson. The motion carried but was not unanimous with no discussion." },
      { item:"Resolution 26-26: Landfill Tipping Fee Modification for Disaster Debris", body:"Administrator Leonard and Solid Waste Director Hagen Busher presented the proposal following severe weather including a tornado in Ringle. The resolution reduces tipping fees from the standard $65\/ton to $36.94\/ton for certified disaster debris, accounting for state fee waiver ($13.10), Ringle's fee waiver ($2.33), and county reduction to commercial rate. Leonard noted the county won't meet the $670,743 damage threshold for state disaster aid but expects Ringle will. Supervisor Rosenberg requested public comment; Jessica Toasty asked the county to waive fees entirely for six months, noting the state, DNR, and Ringle have waived their fees. Matt Haybeck requested extended timeframes as insurance adjusters haven't yet reached many of the approximately 44 affected homes. Multiple supervisors asked clarifying questions about fee structure and future policy. The board first voted unanimously to suspend rules to hear the resolution directly from the Solid Waste Management Board. The resolution then passed unanimously on motion by Supervisor Arstead, seconded by Supervisor Morash." },
    ],
    publicComment: "Two residents were granted special dispensation to speak on the tipping fee resolution. Jessica Toasty requested Marathon County waive its portion of fees entirely for six months, noting private businesses have donated up to $40,000 in cleanup efforts and that the state, DNR, and Ringle have all waived their fees. Matt Haybeck spoke on behalf of affected homeowners, noting approximately 44 homes were impacted and many are still waiting for insurance adjusters, requesting extended timeframes for any fee relief.",
    actionItems: [
      ...
      "Reduced landfill tipping fees for disaster debris approved through June 17, 2025 (state emergency declaration period)",
      "Administrator Leonard to work with Community Foundation on potential reimbursement mechanism for uninsured disaster cleanup costs",
      "Solid Waste Management Board to develop formal policy within six months for handling future disaster situations",
      "Staff to track all disaster-related waste with certification forms for potential state disaster aid documentation",
    ],
  },
  {
    ...
    isAgendaOnly: false,
    badge: "new",
    overview: "The Marathon County Environmental Resources Committee approved two rezoning petitions and voted to forward a modified fee waiver resolution to the county board that will only waive reconnect fees for properties impacted by the April 17, 2026 tornado. The committee also received educational presentations from the Solid Waste, Parks Recreation and Forestry, and Conservation Planning and Zoning departments.",
    agenda: [
      { time:"0:00", item:"Call to order and Pledge of Allegiance" },
      { time:"0:30", item:"Public comment" },
      { time:"0:45", item:"Approval of March 31, 2026 committee minutes" },
      { time:"1:15", item:"Public hearing: Tim Veland rezoning petition (Urban Residential\/General Agriculture to Rural Residential) - Town of Green Valley" },
      { time:"10:01", item:"Public hearing: Jeffrey and Cynthia Schmidtz rezoning petition (Conservancy Recreation to General Agriculture) - Town of McMillan" },
      { time:"20:00", item:"Consideration of fee waiver for properties impacted by April 17, 2026 severe weather" },
      { time:"55:02", item:"Department overview: Solid Waste Department" },
      { time:"1:20:00", item:"Department overview: Parks, Recreation, and Forestry Department" },
      { time:"1:35:02", item:"Department overview: Conservation Planning and Zoning Department" },
    ],
    discussions: [
      { item:"Approval of March 31, 2026 committee minutes", body:"Supervisor Sefeld made a motion to approve the minutes, seconded by Supervisor Drebeck. The motion carried with no opposition." },
      { item:"Tim Veland rezoning petition - Town of Green Valley", body:"Garrett Pogle presented the staff report for rezoning from Urban Residential and General Agriculture to Rural Residential for a proposed land division. The Town of Green Valley recommended approval on March 10, 2026. No public testimony was offered. Supervisor Drebeck moved to approve based on findings of fact and conclusions of law, seconded by Supervisor Kurt. The motion passed unanimously." },
      { item:"Jeffrey and Cynthia Schmidtz rezoning petition - Town of McMillan", body:"The petition sought to rezone from Conservancy Recreation to General Agriculture. Supervisor Leur asked about the conservancy designation, and Garrett Pogle explained the property contains a home and horse riding stable, with the home being a non-conforming use under current zoning. The rezone would make all structures conforming. The Town of McMillan recommended approval on April 20, 2026. Supervisor Sefelt moved to approve, seconded by Supervisor Drew. The motion passed unanimously." },
      { item:"Fee waiver for tornado-impacted properties", body:"Director Lori Mskimmons presented a proposal to waive county zoning and pouts fees for properties damaged by the April 17, 2026 tornado. Significant committee debate ensued. Supervisor Drew questioned fairness to individual tornado victims not in declared disaster areas. Supervisor Drebeck expressed concerns about costs and precedent. Eric Vogel asked about insurance coverage. Supervisor Sefelt moved to forward the resolution, seconded by Supervisor Leur. Supervisor Drebeck then amended the motion to only waive reconnect fees (approximately $160 per permit), not other zoning or pouts fees. Supervisor K seconded the amendment. The amendment passed, and the amended resolution passed with one dissenting vote." },
      { item:"Solid Waste Department presentation", body:"Director Dave Hagenbusher provided an overview of landfill operations, including the renewable natural gas partnership with Vidi Energy that began injecting gas in September 2025. He discussed major challenges including leachate treatment requirements mandated by state law by 2032, lithium-ion battery fires occurring weekly, and significant capital expenses including $6 million for cell construction and $3-4 million for closures." },
      { item:"Parks, Recreation, and Forestry Department presentation", body:"Tom Lovelin, County Forest Administrator, presented on behalf of Director Jamie. He noted the department operates both Marathon County and City of Wausau park systems with 44 full-time and 120 seasonal employees. A Nine Mile County Forest study found out-of-town visitors generate $3.25 million for the local economy. Supervisor Sefelt announced Tom Lovelin is retiring June 1st after nearly 30 years of service." },
    ],
    publicComment: "No public comment was offered.",
    actionItems: [
      "Forward amended fee waiver resolution to county board - waiving only pouts reconnect fees ($160) for tornado-impacted properties",
      "Both rezoning petitions forwarded to Marathon County Board of Supervisors for final approval",
      "Town of Green Valley should update comprehensive plan to reflect zoning change if applicable",
      "Conservation Planning and Zoning to schedule summer educational meeting on conservation topics",
    ],
  },
  {
    ...
    isAgendaOnly: false,
    badge: "new",
    overview: "The Village of Weston Community Life and Public Safety Committee recommended approval of nuisance ordinance amendments and a new e-bike ordinance prohibiting e-motos on public property, discussed overnight parking regulations for potential revision, and authorized the razing of an abandoned structure at 4104 Shore Avenue. The committee also approved fire inspection requirements for mobile food vendors and addressed corrections for several properties with E911 compliance issues.",
    agenda: [
      { time:"0:15", item:"Call to order and Pledge of Allegiance" },
      { time:"0:45", item:"Roll call" },
      { time:"1:00", item:"Public comments" },
      { time:"5:30", item:"Approval of minutes from previous meeting" },
      ...
      { time:"12:30", item:"E-bicycle ordinance in Chapter 82 Traffic and Vehicles" },
      { time:"33:30", item:"Section 82.107 overnight parking regulations" },
      { time:"50:30", item:"Crosswalk request on Alderson Street" },
      { time:"1:00:30", item:"Mobile food vendors fire inspection requirements" },
      { time:"1:10:30", item:"Address corrections for E911 compliance" },
      { time:"1:15:30", item:"Raze order for 4104 Shore Avenue" },
    ],
    discussions: [
      { item:"Public Comments", body:"Jim Senalt spoke regarding concerns about the new farmers market location, stating it was a 'terrible execution' and predicting the park's grassy areas would be destroyed. He raised issues about parking on grass potentially violating village code, ADA-compliant handicap parking being placed on grass rather than asphalt, questioned the need for new fire inspections on food trucks, and noted that several code violations on the enforcement list have been pending for years without visible progress." },
      { item:"Department Reports", body:"Staff reported that 3020 Mountain View Avenue will be removed from the code enforcement list following completion of a property sale and permit submission for repairs. Chief Hunt reported the police department had 2,394 calls in March (77 per day), 410 traffic stops, and 281 citations issued. The department has hired its 40th officer, with the 38th starting last week, 39th starting in May, and 40th around January. Two SROs work with zoning violations during summer for all three municipalities. Motion to acknowledge reports passed unanimously." },
      { item:"Chapter 50 Nuisance Amendments", body:"Committee reviewed final amendments including the tree limb height requirements (14 and 10 feet) that were switched in text per previous meeting direction, with added language about compliance with jurisdictions having authority. Olsen motioned to recommend approval to the board of trustees, seconded by Campkey. Motion passed unanimously." },
      { item:"E-Bicycle Ordinance", body:"Extensive discussion occurred regarding e-motos, with Chief Hunt strongly recommending they be prohibited on roadways and sidewalks, comparing them to unlicensed dirt bikes. Committee debated electric scooters used by middle school students, with Chief suggesting adding an exemption for 'kids play scooters' with officer discretion. Olsen motioned to recommend approval with amendment prohibiting e-motos on roadways, sidewalks, trails, and public property in the village, seconded by Chwanka. Motion passed unanimously. Rothschild has not yet approved their version; Wausau is making adjustments; Schofield declined as unnecessary." },
      { item:"Overnight Parking Regulations", body:"Trustee Tolson presented research showing Weston's 12-hour parking restriction (4 AM to 4 PM) is significantly longer than surrounding municipalities, which typically have 4-5 hour windows. Chief Hunt expressed concern about eliminating overnight restrictions, noting $10 citations are meant to change behavior and help ensure streets are clear for morning plowing. DPW Director Michael Wodalski noted plowing typically doesn't reach residential streets until 7-8 AM. Committee discussed potentially matching Rothschild's hours (2 AM to 7 AM, November 1 to April 1) and having Wodalski identify specific problem areas for additional signage. Item was tabled for July meeting pending Wodalski's analysis." },
      { item:"Alderson Street Crosswalk Request", body:"Mount Olive Church requested a crosswalk connecting to DC Everest High School parking lot where congregants park on Sundays. Committee discussed safety concerns near the new roundabout and costs ($2-3,000 for basic crosswalk, $25-30,000 for lighted system). Olsen motioned that if Mount Olive is willing to cover installation costs, committee recommends board approval; seconded by Chwanka. Motion passed unanimously. Wodalski will contact Mount Olive regarding cost sharing." },
      { item:"Mobile Food Vendors Fire Inspection", body:"Fire Chief explained a new multi-municipality inspection program with Wisconsin Rapids, Marshfield, Stevens Point, Plover, Rib Mountain, and Safer. Once inspected by any participating department, vendors receive a sticker valid for all jurisdictions. Chief noted a recent inspection failed due to improper galvanized steel LP piping and unsecured propane cylinders. Wausau declined participation, preferring their own system. Chwanka motioned to approve Ordinance 26-8, seconded by Campkey. Motion passed unanimously." },
      { item:"Address Corrections for E911 Compliance", body:"Staff presented three address corrections: 5915 Delicoski Street (duplex needing 5915\/5917 designation, owner agreed); Ross Avenue properties requiring renumbering due to sequencing issues with an existing apartment building at 3909; and 2211 Radkey Avenue for a new duplex on a private drive. Chief Hunt identified an additional issue at Weston Villa Apartments on Delicoski with eight separate addresses for one structure. Motion to recommend approval passed unanimously." },
      { item:"Raze Order for 4104 Shore Avenue", body:"Staff requested authorization to begin raze proceedings on a structure abandoned since 2010-2011, posted since 2021. A planned fire department training burn was cancelled due to unsafe structural conditions. Staff discovered chickens were being housed in the structure. Current owners, who are up to date on taxes, have agreed to the razing with costs added to their tax roll. Olsen motioned to recommend board authorization, seconded by Campkey. Motion passed unanimously." },
    ],
    publicComment: "Jim Senalt spoke regarding concerns about the new farmers market location at Kennedy Park, criticizing it as 'terrible execution' and predicting grass damage from vehicle parking. He raised concerns about grass parking potentially violating village code, improper ADA parking placement on grass instead of asphalt, questioned new fire inspection requirements for food trucks, noted ambiguous language regarding food truck permissions on farmers market days, and criticized the lack of follow-up reporting on long-standing code violations.",
    actionItems: [
      "Recommend Chapter 50 Nuisance amendments to board of trustees for approval",
      "Recommend e-bike ordinance to board with amendment prohibiting e-motos on roadways, sidewalks, trails, and public property",
      "DPW Director Wodalski to identify specific problem areas for overnight parking signage and return in July",
      "Wodalski to contact Mount Olive Church regarding cost sharing for Alderson Street crosswalk",
      "Recommend Ordinance 26-8 (mobile food vendor fire inspections) to board for approval",
      "Recommend address corrections for E911 compliance to board of trustees",
      "Recommend board authorize raze order proceedings for 4104 Shore Avenue",
      "Staff to investigate property at Sternberg and South Timber regarding furniture and dumpster in yard",
      "Next meeting scheduled for Monday, July 7th at 5:00 PM",
    ],
  },
  {
...
const SCHOOL_BOARD_UPCOMING = [
  { date:"2026-05-18", time:"5:00 PM", name:"Committee of the Whole Meeting", url:"https://meetings.boardbook.org/Public/Agenda/1360?meeting=744162", source:"school_board" },
  { date:"2026-05-18", time:"5:30 PM", name:"Special Meeting", url:"https://meetings.boardbook.org/Public/Agenda/1360?meeting=746488", source:"school_board" },
