...
const MEETINGS = [
  {
    ...
    date: "May 17, 2026", shortDate: "MAY 17",
    committee: "Public Works", duration: "~1h",
    url: "https://www.youtube.com/watch?v=j64Gj2ean2k",
    docUrl: null,
    isAgendaOnly: false,
    badge: "new",
    overview: "The Public Works Committee approved several items including a recycled asphalt crushing contract with King Gravel for $126,900, a resolution supporting state transportation funding, established $100\/day fines for sanitary sewer discharge violations, and approved construction agreements for Military Road and consulting services for the Alderson\/Jelinek roundabout and Bladel Avenue projects. The committee also received updates on CIP projects including a $9 million grant award for Birch Street reconstruction.",
    agenda: [
      { time:"0:09", item:"Call to order" },
      { time:"0:28", item:"Pledge of Allegiance" },
      { time:"1:00", item:"Roll call" },
      { time:"1:18", item:"Public comment" },
      { time:"1:24", item:"Approval of April 13, 2026 meeting minutes" },
      { time:"1:39", item:"Acknowledge April 2026 water and sewer permits" },
      { time:"1:55", item:"CIP update" },
      { time:"18:39", item:"Street operations update" },
      ...
      { time:"53:30", item:"Recycled base course production" },
      { time:"57:30", item:"Sanitary sewer discharge violation discussion" },
    ],
    discussions: [
      { item:"CIP Update", body:"Michael reported the village received a Local Road Improvement Grant for Birch Street reconstruction between Schofield Avenue and Community Center Drive, originally a 2029 project now being moved to 2028. The grant covers over 50% of the estimated $1.5 million project cost. Staff noted over $9 million in grant funding received over the past 4-5 years. Discussion also covered Weston Avenue repairs by Integrity Grading and Excavating for settlement issues over the sanitary sewer trench, and upcoming Schofield Avenue repairs by HOS Construction." },
      { item:"Street Operations Update", body:"Staff reported road limits were removed April 29th. Activities included mailbox repairs, sign repairs, dewatering operations along the Weston Avenue tributary for approximately one week, curb line sweeping, hot mix patching, and storm damage cleanup from East Nick. Culverts failed on Jones Street requiring replacement from two to three 18-inch culverts. Equipment maintenance and changeover from winter to summer operations was detailed." },
      { item:"Utility Operations Update", body:"Josh reported on a service repair at Caribou Coffee, well maintenance items, and significant clear water infiltration issues at lift stations. April showed 37 million gallons pumped into the system but 53-54 million gallons treated at wastewater plant - approximately 15 million gallons of clear water infiltration. Staff identified sump pump discharges to sanitary sewers as a major contributor. In-pipe Technologies will conduct an INI study to identify problem areas." },
      { item:"2025 Water Utility PSC Annual Report", body:"Michael presented the annual report showing operating revenues of $3 million, net operating income of $482,911 (consistent with 2024's $490,000), water loss at 6%, and utility value of nearly $34 million after infrastructure additions. PAS settlement funds of $1.44 million were received. Cash reserves stand at $6.8 million. Motion to acknowledge passed unanimously." },
      { item:"Resolution 2026-014 Transportation Funding", body:"Michael explained this League of Wisconsin Municipalities resolution supports long-term transportation funding solutions at the state level. Staff noted the village has decreased public works budgets recently and Wisconsin remains affordable compared to neighboring states for automobile ownership costs. Motion to adopt passed unanimously." },
      { item:"Recycled Base Course Production", body:"Michael explained the Ryan Street site recycling program where concrete and asphalt is crushed into base course. King Gravel submitted the low quote at $4.23\/ton for an estimated 30,000 tons ($126,900 total). Analysis showed the program saves approximately $11\/cubic yard compared to City of Wausau costs, totaling about $130,000 savings on 2026 projects. Motion to award to King Gravel passed unanimously." },
      { item:"Sanitary Sewer Discharge Violations", body:"Committee discussed enforcement of violations for discharging clear water (primarily sump pumps) into sanitary sewers. After discussion about willful versus unknowing violations, the committee agreed on $100\/day fines for violations. Staff will wait for In-pipe Technologies study results, then send notices giving 30-60 days to correct before fines apply. Motion to direct staff to create enforcement language with $100\/day maximum passed unanimously." },
      { item:"Water and Sewer Connection Agreement - Radkey Avenue", body:"Michael presented agreement for a new duplex at 2230 Radkey Avenue to temporarily connect via long lateral until Radkey Avenue reconstruction. Committee added requirement that reconstruction occur no later than 2029, at which point property will be assessed for main extension costs. Motion passed unanimously." },
      { item:"Military Road Construction Agreement", body:"Agreement with Village of Rothschild for Military Road reconstruction from Wolfman Street to Helin Street. Weston's share for water and sewer work is $94,860. Steam Construction is the contractor. Motion to approve passed unanimously." },
      { item:"Construction Services for Alderson\/Jelinek and Bladel Projects", body:"Michael presented proposals for construction inspection services. For Alderson\/Jelinek roundabout: MSA at $37,315 (selected) vs Clark Dietz at $48,910. For Bladel Avenue: Clark Dietz at $73,730 (selected for having full-time experienced staff) vs MSA at $70,400 (using summer intern). Motion to approve both assignments passed unanimously." },
    ],
    publicComment: "No public comment was offered.",
    actionItems: [
      "Staff to add no-later-than-2029 date to Radkey Avenue water\/sewer connection agreement",
      "Staff to develop enforcement language for sanitary sewer discharge violations at $100\/day fine",
      "Award 2026 recycled asphalt crushing project to King Gravel at $4.23\/ton",
      "Approve Village of Rothschild agreement for Military Road construction ($94,860 Weston share)",
      "Award MSA construction services for Alderson\/Jelinek roundabout project ($37,315)",
      "Award Clark Dietz construction services for Bladel Avenue project ($73,730)",
      "Schedule special assessment meeting for Bladel Avenue for May 28, 2026 at 6:00 PM",
      "Begin water main flushing next week with notices being mailed",
  ...
  },
  {
    ...
    isAgendaOnly: false,
    badge: "new",
    overview: "The Village of Weston Plan Commission approved a site plan for the new Mountain Bay Metropolitan Police Department and Municipal Court facility at 3600 Community Drive, and adopted a new salt storage shed inspection program for wellhead protection areas. Both items passed unanimously with the commission also scheduling the first comprehensive plan steering committee meeting for June 1st.",
    agenda: [
      ...
      { time:"5:30", item:"Site plan review - Mountain Bay Metro Police Department and Municipal Court facility at 3600 Community Center Drive (taken out of order as Item 6)" },
      { time:"20:01", item:"Unfinished business - Creation of salt storage shed inspection program for Wellhead Protection District" },
      ...
      { time:"31:00", item:"Future agenda items" },
      { time:"34:30", item:"Adjournment" },
    ],
    discussions: [
      { item:"Mountain Bay Metro Police Department and Municipal Court Facility Site Plan", body:"Staff presented the site plan for the new police department and municipal court at 3600 Community Center Drive. The building was rotated to address challenges with a gas pipeline easement running through the property. Chief Jeremy explained the building will accommodate 50-60 officers for future growth, up from current staffing of 40 officers. Discussion included the alternate storage shed location and potential for future building expansion to the north. A motion to recommend approval to the board of trustees with staff conditions 2-5 passed unanimously." },
      { item:"Salt Storage Shed Inspection Program for Wellhead Protection District", body:"Jennifer presented a new inspection program requiring two annual inspections per facility - a warm weather inspection focusing on structural integrity and a winter operational inspection focusing on material handling practices. The program includes a standardized inspection worksheet similar to DOT standards. Staff noted one existing facility near Sternberg has never gone through the wellhead protection conditional use process. Commission directed staff to reach out to that facility about compliance. Motion to approve the program with reporting back to both Plan Commission and Public Works passed unanimously." },
      { item:"April 2026 Minutes and Reports", body:"Minutes from April 13, 2026 meeting were approved unanimously. April 2026 staff approved certified survey maps, site plans, and building permits were approved unanimously as consent items." },
      { item:"Planning Department Monthly Update", body:"Jennifer announced the first joint Plan Commission\/Village Board steering committee meeting for the comprehensive plan is scheduled for Monday, June 1st at 5:00 p.m. Discussion also touched on potential residential TIF districts for workforce housing, with Ehlers having prepared a presentation on qualifications that may be shared with the commission or incorporated into comprehensive plan discussions." },
    ],
    publicComment: "Jim Pensel (5002 Arrow Street, Weston) spoke via online connection. He urged the commission to exercise common sense regarding landscaping requirements for the police department project, referencing previous Green Heck Turner building standards. He also requested that the salt shed inspection program include annual reporting on site visits and findings.",
    actionItems: [
      "Site plan for Mountain Bay Metro Police Department and Municipal Court facility recommended for Board of Trustees approval with staff conditions",
      ...
      "First comprehensive plan steering committee meeting scheduled for June 1, 2026 at 5:00 p.m.",
      "Electric vehicle charging station discussion planned for fall agenda",
  ...
  },
  {
    ...
    isAgendaOnly: false,
    badge: "new",
    overview: "The Marathon County Health & Human Services Committee held an educational orientation meeting for new board members, featuring presentations from the Health Department, Social Services, Veteran Service Office, and Aging Disability Resource Center. No action items were voted on besides approving minutes; the meeting focused on introducing department functions, budgets, and services to committee members.",
    agenda: [
      ...
      { time:"2:00", item:"Operational functions required by statute - overview of agenda structure" },
      { time:"4:30", item:"Review of standing committee ordinance section 2.04, missions and responsibilities" },
      { time:"12:30", item:"Health Department presentation by Health Officer Caitlyn Suginaka" },
      { time:"25:00", item:"Social Services Department overview by Administrator Leonard" },
      { time:"45:30", item:"Veteran Service Office presentation by Veteran Service Officer Aaron Galindo" },
    ...
    discussions: [
      ...
      { item:"Standing Committee Ordinance Review", body:"Administrator Lance Leonard explained the committee's jurisdiction under ordinance section 2.04 sub 5, covering the Health Department, Social Services, Veteran Services, North Central Health Care, and Aging Disability Resource Center. He outlined statutory responsibilities and reporting relationships with various boards including the Social Services Board, Veteran Service Commission, and Board of Health." },
      { item:"Health Department Presentation", body:"Health Officer Caitlyn Suginaka presented the department's mission of preventing disease and protecting public health. She highlighted over 1,200 licenses overseen, a new homeless system response position created from a task force recommendation, public health vending machines stocked with free resources including tick kits, and the Nurse Family Partnership program which just graduated its first cohort of two-year-olds. The department has about 37.6 FTE staff across environmental health, nursing, community health improvement, and administrative teams." },
      { item:"Social Services Department Overview", body:"Administrator Leonard presented on behalf of absent Director Christa, noting the department has nearly 140 FTE making it the second largest department. He highlighted the successful Family Keys housing stability pilot program conducted with Lacrosse and Wood counties, addressing root causes of housing instability. The department's $22 million budget relies on approximately one-third tax levy with various programs having different funding structures." },
      { item:"Veteran Service Office Presentation", body:"Veteran Service Officer Aaron Galindo reported his 3.0 FTE office had 8,149 client interactions in 2025, up significantly from 5,900. He noted $44 million annually flows to local veterans in benefits, plus $2.6 million in retroactive payments in 2025. Galindo highlighted housing stability work with Center for Veterans Issues, suicide prevention efforts (noting 7 of Marathon County's 30 suicides in 2025 were veterans), and challenges with the PACT Act increasing claims. Supervisor Kremes asked about regional collaboration; Galindo explained state statute requires each county to have its own VSO but offices collaborate across county lines." },
      { item:"Aging Disability Resource Center Presentation", body:"Executive Director Mike Ray explained the ADRC serves four counties (Marathon, Lincoln, Langlade, Wood) with about 60 FTE and 385-400 volunteers. He detailed services including Meals on Wheels, Medicare counseling, dementia care, and falls prevention. Ray noted significant financial challenges with nutrition program costs up 40-45% over four years while federal funding remains flat at 2024 levels. The Older Americans Act hasn't been reauthorized in over two years. Marathon County's 2026 contribution is $413,135." },
    ],
    publicComment: "No public comment was offered.",
    actionItems: [
      ...
      "Committee members encouraged to email Chair Boots and Administrator Leonard with future agenda item requests",
      "Strategic plan review and development to be presented at upcoming meetings",
    ],
  },
  {
    ...
    isAgendaOnly: false,
    badge: "new",
    overview: "The Marathon County Board held an adjourned organizational meeting where they approved committee appointments, elected Supervisors Hapa and Arstead to the executive committee at-large positions, and unanimously approved a resolution reducing landfill tipping fees for disaster-related debris following severe tornado and flood damage in the Ringle area. The board suspended its rules to bring the tipping fee resolution directly from the Solid Waste Management Board without going through a standing committee.",
    agenda: [
      ...
      { time:"20:00", item:"Consent agenda items C10 through C14A" },
      { time:"20:30", item:"Resolution D15 - Out of home placement reserve increase" },
      { time:"21:00", item:"Resolution D16 - Social services budget amendment" },
      { time:"22:00", item:"Resolution E17 - Landfill tipping fees modification" },
      { time:"1:15:00", item:"Announcements and adjournment" },
    ],
    discussions: [
      { item:"Committee Appointments", body:"Chair Gibbs outlined the guiding principles for committee appointments, including increasing diversity of perspectives, providing leadership development opportunities for newer supervisors (34% in first or second term), and honoring supervisor preferences. Vice Chair Boots assisted in developing the appointments. Motion by Supervisor Cavelli, seconded by Supervisor Crims. The motion carried but was not unanimous." },
      { item:"Election of At-Large Executive Committee Members", body:"Three supervisors were nominated: Supervisor Hapa (nominated by Supervisor Mask), Supervisor Leur (nominated by Supervisor Rosenberg), and Supervisor Arstead (nominated by Supervisor Boots). Supervisor Rosenberg spoke in support of Supervisor Leur, citing her advocacy for the county's youngest and oldest residents. Paper ballots were distributed, and Supervisors Hapa and Arstead were elected to the two at-large positions on the executive committee." },
      ...
      { item:"Out of Home Placement Reserve Increase (Resolution 24-26)", body:"Resolution from Health and Human Services Committee and Human Resources and Finance and Property Committee. Motion by Supervisor Morash, seconded by Supervisor Robinson. The motion carried but was not unanimous." },
      { item:"Social Services Budget Amendment (Resolution 25-26)", body:"Motion by Supervisor P, seconded by Supervisor Robinson. The motion carried but was not unanimous." },
      { item:"Landfill Tipping Fees Modification (Resolution 26-26)", body:"Administrator Leonard and Director Hagen Busher presented the resolution from the Solid Waste Management Board in response to severe weather damage in the Ringle area. The state waived $13.10 per ton, Ringle waived $2.33 per ton, and the county proposed reducing fees to $36.94 per ton (covering costs only). Two residents, Jessica Toasty and Matt Haybeck, were granted special permission to speak, requesting the county wave fees entirely for affected residents. Supervisors discussed insurance reimbursement challenges, timing concerns, and potential partnership with the community foundation for unreimbursed costs. The board first voted unanimously to suspend rules to bring the resolution directly from the Solid Waste Management Board, then approved Resolution 26-26 unanimously with motion by Supervisor Arstead and second by Supervisor Morash." },
    ],
    publicComment: "Two residents were granted special dispensation to speak on the tipping fee resolution. Jessica Toasty asked Marathon County to wave fees entirely, noting the state, DNR, and Ringle were waiving their portions, and that businesses had donated up to $40,000 in cleanup efforts. She requested a six-month fee waiver. Matt Haybeck spoke on behalf of homeowners facing demolition, noting some of the approximately 44 affected homes are still waiting for insurance adjusters, and requested more time and relief from the county.",
    actionItems: [
      "Committee appointments approved for the term",
      "Supervisors Hapa and Arstead elected to executive committee at-large positions",
      "Resolution 26-26 approved reducing landfill tipping fees for disaster-related debris through June 17, 2025",
      "Administrator to work with Community Foundation on potential reimbursement mechanism for unreimbursed insurance costs",
      "Solid Waste Management Board to develop clear policy on handling similar disaster situations within six months",
      "Board to revisit tipping fee reduction at May meeting if extension is needed beyond state declaration period",
    ],
  },
  {
    ...
    isAgendaOnly: false,
    badge: "new",
    overview: "The Marathon County Environmental Resources Committee approved two rezoning petitions unanimously and voted to forward a modified fee waiver resolution for tornado-affected properties to the county board. The fee waiver was amended to only cover septic system reconnect fees ($160) rather than all zoning and POWTS fees as originally proposed. New committee members also received department overviews from Solid Waste, Parks\/Recreation\/Forestry, and Conservation Planning and Zoning.",
    agenda: [
      { time:"0:00", item:"Call to order and Pledge of Allegiance" },
      { time:"0:45", item:"Public comment" },
      { time:"1:00", item:"Approval of March 31st, 2026 committee minutes" },
      { time:"1:30", item:"Public hearing introduction and committee member introductions" },
      { time:"5:01", item:"Rezoning petition 5A1: Tim Veland on behalf of James Offer and David Tract - Urban Residential\/General Agriculture to Rural Residential in Town of Green Valley" },
      { time:"15:01", item:"Rezoning petition 5A2: Jeffrey and Cynthia Schmidtz - Conservancy Recreation to General Agriculture in Town of McMillan" },
      { time:"20:00", item:"Consideration of fee waiver for properties impacted by April 17, 2026 severe weather" },
      { time:"55:02", item:"Educational presentations - Department overviews" },
      { time:"1:00:00", item:"Solid Waste Department overview by David Hagenbusher" },
      { time:"1:20:00", item:"Parks, Recreation and Forestry Department overview by Tom Lovelin" },
      { time:"1:35:02", item:"Conservation Planning and Zoning Department overview by Lori Miskimmons" },
    ],
    discussions: [
      { item:"Approval of March 31st, 2026 minutes", body:"Supervisor Sefeld made a motion to approve the minutes, seconded by Supervisor Drebeck. The motion carried unanimously with no discussion." },
      { item:"Rezoning petition - James Offer and David Tract", body:"Land Use Specialist Garrett Pogle presented the staff report for rezoning from Urban Residential and General Agriculture to Rural Residential in the Town of Green Valley. The Town Board recommended approval on March 10, 2026. No public comment was offered. Supervisor Drebeck moved to approve based on findings of fact and conclusions of law, seconded by Supervisor Kurt. Motion carried unanimously." },
      { item:"Rezoning petition - Jeffrey and Cynthia Schmidtz", body:"Garrett Pogle presented the rezoning request from Conservancy Recreation to General Agriculture in Town of McMillan. Supervisor Leur asked about the conservancy nature of the property; Pogle explained it currently has a home and horse riding stable, and the rezoning makes these conforming uses. He confirmed no natural areas would be lost - the property is home, barns, stables, and pasture. Town Board recommended approval April 20, 2026. Supervisor Sefeld moved to approve, seconded by Supervisor Drew. Motion carried unanimously." },
      { item:"Fee waiver for April 17, 2026 severe weather victims", body:"Director Lori Miskimmons presented a proposal to waive county zoning and POWTS fees for properties damaged by the April 17th tornado affecting towns of Ringle, Easton, villages of Kronenwetter and Weston. The proposal included a one-year duration and affected up to 149 parcels. Supervisor Drew questioned where to draw the line for future incidents. Supervisor Drebeck expressed concerns about fairness to others not in declared disaster areas. Marilyn Bend asked about mound system costs. After discussion, Supervisor Drebeck offered an amendment to limit the waiver to only reconnect fees ($160 for septic reconnections) rather than all fees. Supervisor Kurt seconded the amendment, which passed. The amended resolution was then approved to forward to the county board, though not unanimously." },
      { item:"Solid Waste Department overview", body:"Director David Hagenbusher presented on the department's operations, explaining the landfill accepts about 1,000 tons daily with 150-200 transactions. He discussed the renewable natural gas partnership with Vidi Energy generating revenue through gas royalties, upcoming leachate treatment requirements by 2032 due to PFAS concerns, and significant capital expenses including $6 million for 11-acre expansion. He noted hauling costs reached $90,000 in April due to heavy rainfall." },
      { item:"Parks, Recreation and Forestry overview", body:"Tom Lovelin, County Forest Administrator, presented on behalf of Director Jamie. He explained the department operates both city and county park systems since 1924, managing 17 county parks and 30,700 acres of county forest across 10 units. A Nine Mile County Forest study showed out-of-town visitors generate $3.25 million for the local economy. Lovelin announced his retirement effective June 1st after nearly 30 years, with Joe Tucker selected as his replacement." },
    ],
    publicComment: "No public comment was offered.",
    actionItems: [
      "Forward amended fee waiver resolution (covering only $160 reconnect fees) for April 17, 2026 tornado victims to full county board",
      "James Offer\/David Tract rezoning approved - forward to county board",
      "Jeffrey and Cynthia Schmidtz rezoning approved - forward to county board",
      "Towns should update comprehensive plans to reflect zoning changes if applicable",
      "Solid Waste to reapply for clean water fund program for 2027 funding by October",
      "Department to schedule summer educational meeting on conservation topics",
    ],
  },
  {
    ...
    isAgendaOnly: false,
    badge: "new",
    overview: "The Village of Weston Community Life and Public Safety Committee approved amendments to nuisance ordinances, an e-bike ordinance with emoto restrictions, mobile food vendor fire inspection requirements, address corrections, and a raze order for a deteriorated structure. Public comment raised concerns about the new farmers market location and code enforcement follow-up.",
    agenda: [
      { time:"0:15", item:"Call to order and Pledge of Allegiance" },
      { time:"0:45", item:"Roll call" },
      { time:"1:00", item:"Public comments" },
      { time:"5:00", item:"Approval of minutes from previous meeting" },
      { time:"5:30", item:"Written communications received" },
      ...
      { time:"1:00:02", item:"Mobile food vendors fire inspection requirements" },
    ...
    discussions: [
      ...
      { item:"Crosswalk on Alderson Street", body:"Mount Olive Church requested a crosswalk between their facility and DC Everest school parking lot they use on Sundays. Staff estimated $2,000-3,000 for a basic crosswalk or $25,000-30,000 for a lighted system. Committee expressed reluctance to fund the crosswalk, noting no accidents have occurred. Motion by Olsen, seconded by Sherwanka, to recommend board approval contingent on Mount Olive covering installation costs. Motion passed unanimously. Michael will contact Mount Olive about cost-sharing." },
      { item:"Mobile Food Vendor Fire Inspections", body:"Fire Chief explained a regional agreement with Wisconsin Rapids, Marshfield, Stevens Point, Plover, Rib Mountain, and Safer allowing mutual recognition of food truck fire inspections. Once inspected by any participating department, trucks receive a sticker valid across all jurisdictions. Chief noted Wausau declined to participate. Fire Marshal Marty recently failed a food truck inspection due to improper LP gas piping and unsecured propane containers. Sherwanka moved to approve Ordinance 26-8, seconded by Campke. Motion passed unanimously." },
