...
const MEETINGS = [
  {
    ...
    date: "May 19, 2026", shortDate: "MAY 19",
    committee: "Public Works", duration: "~1h",
    url: "https://www.youtube.com/watch?v=j64Gj2ean2k",
    docUrl: null,
    isAgendaOnly: false,
    badge: "new",
    overview: "The Public Works Committee approved several infrastructure projects and contracts, including a $126,900 recycled asphalt crushing contract, a resolution supporting state transportation funding, and construction service agreements for upcoming road projects. The committee also directed staff to develop enforcement language for sewer discharge violations at $100\/day penalties.",
    agenda: [
      { time:"0:09", item:"Call to order" },
      { time:"0:20", item:"Pledge of allegiance" },
      ...
      { time:"18:55", item:"Street operations update" },
      { time:"29:30", item:"Utility operations update" },
      { time:"44:30", item:"Review 2025 Water Utility PSC annual report" },
      { time:"49:45", item:"Resolution 2026-014 transportation funding" },
      { time:"54:00", item:"Recycled base course production contract" },
    ],
    discussions: [
      { item:"CIP Update", body:"Michael reported the village received a Local Road Improvement Grant for Birch Street reconstruction between Scofield Avenue and Community Center Drive, originally a 2029 project now likely moving to 2028. The grant covers over 50% of the estimated $1.5 million project cost. Michael noted the village has secured over $9 million in grant funding over the past 4-5 years. Discussion also covered Weston Avenue repairs by Integrity Grading and Excavating for settlement issues, and upcoming Scofield Avenue repairs by HOS Construction for pavement markings and manhole issues." },
      { item:"Street Operations Update", body:"Staff reported road limits were removed April 29th along with Marathon County. Crews handled dewatering near Weston Avenue for about a week due to flooding, with discussion about potential permanent pump solutions. Spring curb line sweeping, hot mix patching, storm damage cleanup, inlet repairs, and culvert replacements on Jones Street were completed. Vehicle maintenance included removing plow equipment and servicing mowers. A new MAC tandem axle chassis has been ordered." },
      { item:"Utility Operations Update", body:"Josh reported a service repair at Caribou Coffee, well maintenance items, and continued private well sampling. Sanitary side experienced significant clear water infiltration, with April showing 37 million gallons pumped into the system but 53-54 million gallons treated - indicating approximately 15 million gallons of clear water infiltration. Staff identified sump pump discharges into sanitary sewers as a significant contributor. The in-pipe technologies INI study will help identify problem areas." },
      { item:"2025 Water Utility PSC Annual Report", body:"Michael presented the annual report showing operating revenues of approximately $3 million, net operating income of $482,911 (slightly down from $490,000 in 2024), and 6% water loss. The utility value increased to nearly $34 million with $6.7 million in infrastructure placed in service. Total cash reserves are $6.8 million. Motion to acknowledge passed unanimously." },
      { item:"Resolution 2026-014 Transportation Funding", body:"Michael explained this League of Wisconsin Municipalities resolution supports long-term funding solutions for state transportation. The village has decreased public works budgets recently while grant funding helps with capital projects but not recurring operational costs. Motion to recommend village board adoption passed unanimously." },
      { item:"Recycled Base Course Production", body:"Michael presented the recycled asphalt crushing contract, with King Gravel as low bidder at $4.23\/ton for an estimated 30,000 tons ($126,900 total). Analysis showed this saves approximately $11 per cubic yard compared to purchasing material, resulting in about $130,000 savings on 2026 projects. Motion to award contract to King Gravel passed unanimously." },
      { item:"Sanitary Sewer Discharge Violations", body:"Committee discussed enforcement of sewer discharge violations, particularly sump pump connections to sanitary sewers. Staff recommended establishing fines, with code allowing $100-$1,000 per day per violation. Committee member Jordan distinguished between unknowing versus willful violations. Committee directed staff to create enforcement language with $100\/day penalty, starting after the in-pipe technology study identifies problem areas. Motion passed unanimously." },
      { item:"Radkkey Avenue Water\/Sewer Connection", body:"Michael explained a duplex builder on lot 1 needs temporary water\/sewer connection via long lateral until Radkkey Avenue reconstruction extends mains through outlot 1. Committee added language requiring reconstruction no later than 2029, with owner paying assessment at that time. Motion passed unanimously." },
      { item:"Military Road Construction Agreement", body:"Committee approved intergovernmental agreement with Village of Rothschild for Military Road construction from Wolfman Street to Helin Street. Weston's share for water main relocation and sanitary sewer is estimated at $94,860. Steam Construction is the contractor. Motion passed unanimously." },
      { item:"Construction Services Proposals", body:"Michael presented construction inspection proposals. For Alderson\/Jelinek roundabout project, MSA was lower at $37,315 versus Clark Dietz at $48,910. For Bladel Avenue, MSA was $70,400 and Clark Dietz was $73,730, but Michael recommended Clark Dietz due to having full-time experienced staff versus an intern. Committee approved MSA for the roundabout and Clark Dietz for Bladel Avenue unanimously." },
    ],
    ...
    actionItems: [
      ...
      "Direct staff to create enforcement language for sewer discharge violations at $100\/day penalty",
      "Approve water\/sewer connection agreement for 2230 Radkkey Avenue with assessment due upon reconstruction no later than 2029",
      "Approve Military Road construction agreement with Rothschild for estimated $94,860",
      "Approve MSA for Alderson\/Jelinek roundabout construction services and Clark Dietz for Bladel Avenue construction services",
      "Schedule Bladel Avenue special assessment meeting for May 28, 2026 at 6:00 PM",
      "Begin water main flushing next week with notices going out to residents",
      "Norcon to begin Scofield Avenue concrete repairs Wednesday\/Thursday this week",
    ],
  },
  {
    ...
    isAgendaOnly: false,
    badge: "new",
    overview: "The Village of Weston Plan Commission approved a site plan for the new Mountain Bay Metropolitan Police Department and Municipal Court facility at 3600 Community Center Drive, and adopted a new salt storage shed inspection program for wellhead protection areas. Both items passed unanimously with staff conditions.",
    agenda: [
      { time:"0:01", item:"Call to order and roll call" },
      { time:"1:32", item:"Open public comment period" },
      ...
      { time:"31:30", item:"Future agenda items" },
      { time:"34:40", item:"Adjournment" },
    ],
    discussions: [
      { item:"Mountain Bay Metro Police Department and Municipal Court facility site plan", body:"Staff presented the site plan for the new police and court facility at 3600 Community Center Drive. The building was rotated to accommodate a gas pipeline easement, with parking lot now positioned over the 36-inch underground pipeline. Chief Jeremy explained the building will accommodate 50-60 officers (currently 40) for future growth. Discussion included the alternate storage shed placement for future expansion potential, with suggestion to move it further north. The landscaping plan meets current relaxed code requirements. Motion to approve with staff conditions 2-5 passed unanimously." },
      { item:"Salt storage shed inspection program for wellhead protection district", body:"Staff proposed a two-inspection-per-year program for salt storage facilities in wellhead protection areas - one warm weather inspection focusing on structural integrity and one winter operational inspection. The program includes a standardized inspection worksheet similar to DOT standards. Staff noted one existing facility near the municipal well on Sternberg has never gone through the wellhead protection conditional use process. Commission directed staff to reach out to that facility about compliance. Motion to approve the program with reporting back to both Plan Commission and Public Works passed unanimously." },
      { item:"April 2026 staff approved items and building permits", body:"Both the April 2026 staff approved certified survey maps\/site plans and building permits were approved unanimously with no discussion." },
      { item:"Planning and development department update", body:"Staff announced the first meeting of the joint Plan Commission\/Village Board steering committee for the comprehensive plan is scheduled for Monday, June 1st at 5:00 p.m. Staff will send calendar invites. Discussion arose about potential residential TIF districts for workforce housing, with Ehlers having provided a presentation on qualifications that may be shared with the commission or incorporated into comprehensive plan discussions." },
    ],
    publicComment: "Jim Pensel of 5002 Arrow Street, Weston, spoke via remote connection. He urged the commission to exercise common sense on landscaping requirements for the police department project to avoid excessive taxpayer costs, referencing relaxed standards used for the Greenheck Turner building. He also requested that staff provide annual reports on salt shed inspections rather than letting oversight get 'lost in the sauce' like some other zoning complaints.",
    actionItems: [
      ...
      "Staff to report inspection findings to both Plan Commission and Public Works committee next year",
      "Staff to reach out to existing salt storage facility on Sternberg about wellhead protection conditional use compliance",
      "Joint Plan Commission\/Village Board comprehensive plan steering committee meeting scheduled for June 1st at 5:00 p.m.",
  ...
  },
  {
    ...
    isAgendaOnly: false,
    badge: "new",
    overview: "The Marathon County Health & Human Services Committee held an educational session for new board members, featuring presentations from four department heads on their missions, budgets, and current initiatives. No action items were voted on except approval of April 1st meeting minutes. Key highlights included updates on homelessness response efforts, veteran services achieving $44 million in annual benefits, and ADRC facing funding challenges for nutrition programs.",
    agenda: [
      ...
      { time:"3:15", item:"Review of standing committee ordinances and jurisdiction" },
      { time:"11:48", item:"Health Department presentation by Health Officer Caitlyn Suginaka" },
      { time:"25:04", item:"Social Services Department overview by Administrator Leonard" },
      { time:"45:01", item:"Veteran Service Department presentation by Aaron Galindo" },
      { time:"1:15:00", item:"ADRC of Central Wisconsin presentation by Executive Director Mike Ray" },
      { time:"1:30:00", item:"Next meeting date and adjournment" },
    ],
    discussions: [
      { item:"Approval of April 1st Meeting Minutes", body:"Supervisor Cavelli made a motion to approve the minutes, seconded by Vice Chair Rosenberg. The motion carried with all in favor by voice vote." },
      { item:"Health Department Overview", body:"Health Officer Caitlyn Suginaka presented the department's mission and four divisions: environmental health, nursing (communicable disease and family health), community health improvement, and administration. She highlighted 1,200+ licenses overseen, public health vending machines stocked with free resources including tick kits, the Nurse Family Partnership program graduating its first two-year-olds, and a new FTE position for homeless system response. The department has 37.6 FTE and approximately half of their $5 million budget comes from tax levy." },
      { item:"Social Services Department Overview", body:"Administrator Leonard provided an overview in the director's absence, explaining the department's divisions: child welfare (child protective services and youth justice), children's long-term support, economic support, and child support. He highlighted the successful Family Keys pilot program addressing housing instability, noting many participants had never had bank accounts or formal leases. The department has nearly 140 FTE with a $22 million budget, of which about $7 million is tax levy." },
      { item:"Veteran Service Department Overview", body:"Veteran Service Officer Aaron Galindo reported the department increased from 2.75 to 3.0 FTE and saw interactions jump from 5,900 to 8,149 in 2025. He highlighted $44 million in annual VA benefits flowing to local veterans and $2.6 million in retroactive payments in 2025. Key initiatives include surviving spouse benefits outreach, housing stability partnerships with Center for Veterans Issues, and suicide prevention efforts after 7 of 30 county suicides in 2025 were veterans. Supervisor Kremes asked about regional coordination; Galindo explained state statute requires each county to have a VSO but veterans can work with any county's office." },
      { item:"ADRC of Central Wisconsin Overview", body:"Executive Director Mike Ray explained the four-county agency serves as a one-stop shop for aging and disability services with about 60 FTE and 385-400 volunteers. He noted significant financial challenges with nutrition program costs up 40-45% over four years while federal funding remained flat. The Older Americans Act hasn't been reauthorized in over two years. Marathon County contributes $413,135 in levy, representing about 11% of ADRC's budget. The agency had not requested a levy increase from 2011 until 2024." },
      { item:"Next Meeting Date Correction", body:"Vice Chair Rosenberg caught an error in the announced next meeting date of May 29th, which is not a Wednesday. The committee confirmed the correct date is Tuesday, June 3rd at 3 PM." },
    ],
    publicComment: "No public comment was offered.",
    actionItems: [
      "April 1st meeting minutes approved",
      "North Central Healthcare to be scheduled for separate full presentation",
      "Mike Ray to present ADRC annual report with 2025 data to full board",
      ...
      "Next meeting scheduled for June 3rd at 3 PM",
    ],
  },
  {
    ...
    isAgendaOnly: false,
    badge: "new",
    overview: "The Marathon County Board held an adjourned organizational meeting where they approved committee appointments, elected Supervisors Hapa and Arstead to the executive committee at-large positions, and unanimously approved a resolution reducing landfill tipping fees for storm debris following the severe weather emergency declaration. The board suspended rules to bring forward the landfill fee resolution directly from the Solid Waste Management Board.",
    agenda: [
      ...
      { time:"20:00", item:"Ballot counting for executive committee election" },
      { time:"20:30", item:"Consent agenda items C10-C14A" },
      ...
      { time:"23:00", item:"Resolution 26-26: Landfill tipping fees modification" },
    ],
    discussions: [
      { item:"Committee Appointments", body:"Chair Gibbs delivered remarks thanking staff and Vice Chair Boots for developing committee appointments, noting that over 34% of the board is in their first or second term. He emphasized that appointments were guided by goals including increasing diversity of perspective, allowing supervisors to grow as leaders, and honoring supervisor preferences. Supervisor Cavelli moved and Supervisor Kremes seconded. The motion carried but was not unanimous." },
      { item:"Election of At-Large Executive Committee Members", body:"Three supervisors were nominated: Supervisor Hapa (nominated by Supervisor Mask), Supervisor Leur (nominated by Supervisor Rosenberg), and Supervisor Arstead (nominated by Supervisor Boots). Supervisor Rosenberg explained her nomination of Supervisor Leur, stating she has seen her advocate for the county's smallest children and oldest elders. Paper ballots were distributed and supervisors selected two names. Supervisors Hapa and Arstead were elected to the executive committee." },
      { item:"Consent Agenda (Items C10-C14A)", body:"Supervisor Cavelli moved and Supervisor Drebeck seconded the consent agenda. The motion carried unanimously." },
      ...
      { item:"Resolution 25-26: Social Services Budget Amendment", body:"Motion by Supervisor P and seconded by Supervisor Robinson. The motion carried but was not unanimous." },
      { item:"Resolution 26-26: Landfill Tipping Fees Modification", body:"Administrator Leonard and Director Hagen Busher presented the resolution from the Solid Waste Management Board regarding reduced tipping fees for storm debris following the April severe weather. The state is waiving the $13.10 fee, and the Town of Ringle is waiving its $2.33 fee. The proposed county reduction brings the fee to $36.94 per ton (covering costs) instead of the standard $65 gate rate. Public comment was allowed by special request, with Jessica Toasty and Matt Haybeck speaking in favor of additional fee waivers. Multiple supervisors asked questions about timelines, coverage areas, and future policy. The board first voted unanimously to suspend rules to consider the resolution directly, then voted unanimously to approve Resolution 26-26." },
    ],
    publicComment: "By special request from Supervisor Rosenberg, two members of the public were allowed to speak on the landfill tipping fee resolution. Jessica Toasty, a Ringle area resident, asked the county to fully waive fees for six months, noting that the state, DNR, and Town of Ringle are all waiving their fees, and requesting similar help from Marathon County. She stated private businesses have donated significant resources and residents are facing deductibles and uncovered costs. Matt Haybeck spoke on behalf of residents whose homes must be demolished, requesting fee waivers for underinsured residents and extended timelines since some insurance adjusters have not yet arrived, noting approximately 44 affected homes.",
    actionItems: [
      ...
      "Resolution 25-26 approved for social services budget amendment",
      "Resolution 26-26 approved reducing landfill tipping fees to $36.94 per ton for certified storm debris through June 17, 2025",
      ...
      "Solid Waste Management Board directed to develop long-term policy on handling disaster-related debris within six months",
    ],
  },
  {
    ...
    isAgendaOnly: false,
    badge: "new",
    overview: "The Marathon County Environmental Resources Committee approved two rezoning petitions unanimously and voted to forward a modified fee waiver resolution to the county board that will waive only septic system reconnect fees for properties damaged by the April 17, 2026 tornado. The committee also received educational presentations from Solid Waste, Parks Recreation and Forestry, and Conservation Planning and Zoning departments.",
    agenda: [
      ...
      { time:"1:05", item:"Public hearing on rezoning petitions" },
      { time:"5:01", item:"Rezoning petition 5A1 - Tim Veland on behalf of James Offer and David Trait" },
      { time:"15:01", item:"Rezoning petition 5A2 - Jeffrey and Cynthia Schmidtz" },
      { time:"20:00", item:"Fee waiver consideration for April 17, 2026 severe weather impacted properties" },
      { time:"55:02", item:"Educational presentation - Solid Waste Department" },
      { time:"1:20:00", item:"Educational presentation - Parks, Recreation, and Forestry Department" },
      { time:"1:35:02", item:"Educational presentation - Conservation Planning and Zoning Department" },
    ],
    discussions: [
      { item:"Approval of March 31st, 2026 committee minutes", body:"Supervisor Sefeld made a motion to approve the minutes with Supervisor Drebeck seconding. The motion carried unanimously with no discussion." },
      { item:"Rezoning petition - James Offer and David Trait (Urban Residential and General Agriculture to Rural Residential)", body:"Land Use Specialist Garrett Pogle presented the staff report for property in the Town of Green Valley. The Town Board recommended approval on March 10, 2026. Staff found the rezoning consistent with the comprehensive plan and met all criteria. Supervisor Drebeck moved to approve based on findings of fact and conclusions of law, seconded by Supervisor Kurt. The motion carried unanimously." },
      { item:"Rezoning petition - Jeffrey and Cynthia Schmidtz (Conservancy Recreation to General Agriculture)", body:"Garrett Pogle presented the petition for property in the Town of McMillan. Supervisor Leur asked about the conservancy nature of the property; Pogle explained there is a home and horse riding stable, and the rezoning would make the home a conforming use rather than non-conforming. No natural areas would be lost. The Town Board recommended approval on April 20, 2026. Supervisor Sefelt moved to approve, seconded by Supervisor Drew. The motion carried unanimously." },
      { item:"Fee waiver for April 17, 2026 severe weather impacted properties", body:"Director Lori Mskimmons presented a proposal to waive county zoning and septic system fees for tornado-damaged properties. Supervisor Drew questioned where to draw the line for future events. Supervisor Drebeck expressed concern about fairness to those affected by smaller disasters not declared emergencies. Eric Vogel asked if homeowners insurance would cover fees. Supervisor Sefelt moved to forward the resolution, seconded by Supervisor Leur. Supervisor Drebeck then proposed an amendment to limit the waiver to only reconnect fees ($160) for existing septic systems, excluding other pouts and zoning fees. The amendment was seconded by Supervisor Kurt and carried unanimously. The amended resolution then passed with one opposing vote to forward to the county board." },
      { item:"Solid Waste Department presentation", body:"Director David Hagenbusher provided an overview of the department's operations including the landfill facility, renewable natural gas partnership with Vidi Energy, and upcoming leachate treatment requirements mandated by state law by 2032. He noted significant capital expenses including $6 million for 11-acre construction and equipment costs of $1.5 million per compactor. Marilyn Bend commended the department for keeping costs competitive." },
      { item:"Parks, Recreation and Forestry Department presentation", body:"County Forest Administrator Tom Lovelin presented on behalf of Director Jamie who had an emergency. He explained the department operates both county and City of Wausau park systems with 44 full-time and 120 seasonal employees. A Nine Mile County Forest study showed out-of-town visitors generate $3.25 million for the county economy. Lovelin announced his retirement effective June 1st after nearly 30 years. Supervisor Sefelt praised the department's work." },
    ],
    publicComment: "No public comment was offered.",
    actionItems: [
      "Forward rezoning approval for James Offer and David Trait property to Marathon County Board of Supervisors",
      "Forward rezoning approval for Jeffrey and Cynthia Schmidtz property to Marathon County Board of Supervisors",
      "Forward amended resolution to county board waiving only septic system reconnect fees ($160) for properties damaged by April 17, 2026 severe weather",
      "Town of Green Valley and Town of McMillan should update comprehensive plans to reflect zoning changes if applicable",
      "Solid Waste to resubmit clean water fund application for leachate treatment facility by October 2026 for 2027 funding",
    ],
  },
  {
    ...
    isAgendaOnly: false,
    badge: "new",
    overview: "The Village of Weston Community Life and Public Safety Committee recommended approval of nuisance ordinance amendments, an e-bike ordinance with added emoto restrictions, mobile food vendor fire inspections, address corrections, and a raze order for an abandoned structure. The committee also discussed overnight parking regulations without taking final action, deferring the matter for staff to identify problem areas.",
    agenda: [
      ...
      { time:"1:01:30", item:"Mobile food vendors fire inspection amendment" },
      { time:"1:10:00", item:"Address corrections for E911 compliance" },
      { time:"1:15:30", item:"Raze order for 4104 Shore Avenue" },
    ],
    discussions: [
      { item:"Public Comments", body:"Jim Senalt spoke critically about the new farmers market location at the park, predicting the grassy areas would be destroyed by vehicles parking on grass. He questioned whether current village code prohibits parking on grass, raised concerns about ADA-compliant handicap parking being placed on grass rather than asphalt, questioned the need for new fire inspections on mobile food vendors, and expressed frustration about long-standing code violations on the enforcement list with no visible progress." },
      { item:"Department Reports", body:"Staff reported that 3020 Mountain View Avenue will be removed from the code enforcement roll after the property sold at auction and the new owner submitted repair permits. Chief Hunt reported the police department had 2,394 calls in March (77 per day), 410 traffic stops, and 281 citations. The department has hired its 40th officer, with the 38th starting last week, 39th in May, and 40th around January. Two SROs work with zoning violations and pet licensing during summer. Motion to acknowledge reports 5, 6, and 7 passed unanimously." },
      { item:"Chapter 50 Nuisances Amendments", body:"The committee reviewed final amendments including switching tree limb height requirements to 14 and 10 feet over streets and walkways, with language added requiring compliance with jurisdiction authority if different. Trustee Tolson confirmed no additional notes. Motion by Olsen, seconded by Campkey, to recommend approval to the board of trustees passed unanimously." },
      { item:"E-bicycle Ordinance", body:"Significant discussion occurred regarding emotos (electric motorcycles\/dirt bikes). Chief Hunt strongly advocated prohibiting emotos on roadways and sidewalks, comparing them to unlicensed dirt bikes and citing safety concerns including people riding wheelies past pedestrians. Committee member Mike raised concerns about electric scooters used by middle schoolers being included in the emoto definition. Chief Hunt suggested adding 'with exemption to kids play scooters' for officer discretion. Motion by Olsen to recommend approval with emotos prohibited on roadways, sidewalks, trails, and public property passed unanimously." },
      { item:"Overnight Parking Regulations", body:"Trustee Tolson presented research showing Weston's 12-hour no-parking window (4 AM to 4 PM) is far outside other municipalities which typically have 5-hour windows. Michael Wodalski from public works suggested eliminating overnight parking restrictions entirely and just signing 6-8 problem areas, noting plows rarely start on residential streets before 7-8 AM. Chief Hunt opposed elimination, saying overnight restrictions help officers get cars removed before morning plowing. The committee discussed various options but took no action, directing Michael Wodalski to identify specific problem areas for the July meeting." },
      { item:"Crosswalk Request on Alderson Street", body:"Mount Olive Church requested a crosswalk between the church and DC Everest school parking lot. Michael Wodalski estimated cost at about $2,000 for a basic crosswalk or $25,000-$30,000 for a lighted system. Committee members expressed reluctance to pay for it, noting no accidents have occurred and other crossing options exist nearby. Motion by Olsen that if Mount Olive is willing to cover the cost, the committee recommends board approval. Seconded by Chwanka, passed unanimously. Wodalski will contact Mount Olive about cost-sharing." },
      { item:"Mobile Food Vendors Fire Inspection", body:"Fire Marshal Marty has joined a regional consortium with Wisconsin Rapids, Marshfield, Stevens Point, Plover, Rib Mountain, and SAFER for reciprocal food truck fire inspections. One inspection and sticker is valid across all participating municipalities. Chief noted Wausau opted out to do their own inspections. Staff reported one recent inspection failed due to improper LP piping (galvanized steel instead of required materials) and unsecured propane containers. Motion by Chwanka to approve Ordinance 26-8, seconded by Campkey, passed unanimously." },
      { item:"Address Corrections", body:"Staff presented three address corrections for E911 compliance: 5915 Delicoski Street (duplex needing separate addresses), Ross Avenue properties out of sequence, and 2211 Radkey Avenue near a new duplex with an out-of-sequence apartment complex. Chief Hunt added another issue on Delicoski where an 8-plex has 9 separate addresses including a utility room. Motion to recommend approval passed unanimously." },
      { item:"Raze Order for 4104 Shore Avenue", body:"Staff requested authorization for a raze order on an abandoned structure that has been vacant since 2010-2011 and posted since 2021. A planned fire department training burn was cancelled because the structure was too deteriorated to be safe. Staff discovered the current owners had been housing chickens inside the building. The owners prefer the raze order route with costs added to their tax roll. Motion by Olsen, seconded by Campkey, passed unanimously." },
    ],
    publicComment: "Jim Senalt spoke for approximately 4 minutes raising concerns about the new farmers market location, predicting grass destruction from vehicle parking, questioning ADA compliance of handicap spaces on grass, questioning the need for mobile food vendor fire inspections, noting ambiguity in food truck prohibition language, and criticizing lack of visible progress on longstanding code violations.",
    actionItems: [
      "Recommend approval of Chapter 50 nuisance amendments to board of trustees",
      "Recommend approval of e-bike ordinance with emotos prohibited on roadways, sidewalks, trails, and public property",
      "Michael Wodalski to identify 6-8 specific problem areas for overnight parking restrictions and bring back to July meeting",
      "Michael Wodalski to contact Mount Olive Church about paying for crosswalk installation",
      "Recommend approval of Ordinance 26-8 for mobile food vendor fire inspections",
      "Recommend approval of address corrections for E911 compliance",
      "Recommend authorization for raze order on 4104 Shore Avenue",
      "Staff to investigate property on Sternberg and South Timber regarding furniture and dumpster in yard",
