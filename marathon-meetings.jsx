...
const MEETINGS = [
  {
    ...
    date: "May 9, 2026", shortDate: "MAY 9",
    ...
    isAgendaOnly: false,
    badge: "new",
    overview: "The Marathon County Health & Human Services Committee held an orientation meeting for new members, featuring educational presentations from the Health Department, Veteran Services, and Aging Disability Resource Center. The committee approved the April 1st meeting minutes and received detailed overviews of department missions, budgets, and key programs including homelessness response, veteran services, and nutrition programs for seniors.",
    agenda: [
      ...
      { time:"1:45", item:"Operational functions required by statute, ordinance, resolution or policy" },
      { time:"3:15", item:"Educational presentations - Review of standing committee ordinances and jurisdiction" },
      { time:"12:20", item:"Health Department presentation" },
      { time:"25:04", item:"Social Services Department overview" },
      { time:"45:01", item:"Veteran Services Department presentation" },
      { time:"1:15:00", item:"Aging Disability Resource Center presentation" },
      { time:"1:30:00", item:"Next meeting date and adjournment" },
    ],
    discussions: [
      { item:"Approval of April 1st meeting minutes", body:"Supervisor Cavalli made a motion to approve the minutes, seconded by Vice Chair Rosenberg. The motion carried unanimously with all members voting in favor." },
      { item:"Review of standing committee jurisdiction and ordinances", body:"Administrator Lance Leonard explained the committee's structure under section 2.04 subsection 5, including oversight of the Health Department, Social Services, and Veteran Services. He noted the committee also receives reports from North Central Health Care, ADRC of Central Wisconsin, Social Services Board, Veteran Service Commission, Transportation Coordinating Committee, and Board of Health. Chair Boots noted the upcoming strategic plan development expected to be completed by December." },
      { item:"Health Department presentation", body:"Health Officer Caitlyn Suginaka presented the department's mission of preventing disease, promoting health, and protecting from environmental hazards. She highlighted over 1,200 licenses overseen, the Nurse Family Partnership program now graduating its first two-year-olds, a new homeless system response position funded through county board and city of Wausau partnership, and free public health vending machines stocked with tick kits and harm reduction supplies. The department has approximately 37.6 FTE with about half of its $5 million budget from tax levy and significant intergovernmental grant revenues." },
      { item:"Social Services Department overview", body:"Administrator Leonard presented on behalf of Director Christa who was unavailable. He described the department's divisions including child welfare, youth justice, children's long-term support, economic support, and child support. The department has nearly 140 FTE with a 2026 budget over $22 million but only about $7 million from tax levy. Leonard highlighted the successful Family Keys housing stability pilot program implemented with state funding that addresses root causes of housing instability among families." },
      { item:"Veteran Services Department presentation", body:"Veteran Service Officer Erin Galindo reported the department increased to 3.0 FTE as of 2025. Customer interactions increased from 5,900 to 8,149 in 2025. The department brought in $44 million annually in veteran benefits to the county, with $2.6 million in retroactive payments in 2025 alone. Galindo discussed priorities including surviving spouse benefits through the PACT Act, housing stability through HUDVASH partnerships, and suicide prevention noting 7 of 30 county suicides in 2025 were veterans. He mentioned pursuing the Staff Sergeant Gordon Fox suicide prevention grant." },
      { item:"Aging Disability Resource Center presentation", body:"Executive Director Mike Ray explained the ADRC serves four counties (Marathon, Lincoln, Langlade, and Wood) as a one-stop shop for aging and disability services. He noted significant financial challenges with nutrition program costs up 40-45% over four years while federal funding remained flat. The ADRC has about 60 FTE plus 385-400 volunteers. Marathon County's contribution is $413,135. Ray noted they hadn't requested a levy increase from 2011 until 2024 due to the efficiency of the regional model." },
    ],
    publicComment: "No public comment was offered.",
    actionItems: [
      "April 1st committee meeting minutes approved",
      "North Central Healthcare to be scheduled for separate full presentation before budget process",
      "ADRC Executive Director to present annual report with 2025 data to full board",
      "Committee members to email Chair Boots and Administrator Leonard with future agenda item requests",
  ...
  },
  {
    ...
    discussions: [
      { item:"Committee Appointments", body:"Chair Gibbs presented committee appointments developed with Vice Chair Boots, emphasizing goals of increasing diversity of perspectives, developing new leaders (noting 34% of the board is in first or second terms), and honoring supervisor preferences. The appointments were approved by motion from Supervisor Cavelli, seconded by Supervisor Crims. The motion carried but was not unanimous. Supervisor Gao noted the system marked him absent but didn't allow him to vote, clarifying he was an 'I' on the motion." },
      { item:"Election of At-Large Executive Committee Members", body:"Three supervisors were nominated: Supervisor Hapa (nominated by Supervisor Mask), Supervisor Leur (nominated by Supervisor Rosenberg, who praised her advocacy for children and elders), and Supervisor Arstead (nominated by Vice Chair Boots). Nominations were closed unanimously. Paper ballots were distributed for supervisors to select two candidates. Supervisors Hapa and Arstead were elected to the executive committee." },
      { item:"Consent Agenda (Items C10-C14A)", body:"Motion by Supervisor Cavelli, seconded by Supervisor Drebeck. Passed unanimously by voice vote." },
      { item:"Resolution D15 - Out of Home Placement Reserve Increase", body:"Motion by Supervisor Morash, seconded by Supervisor Robinson. The motion carried but was not unanimous." },
      { item:"Resolution D16 - Social Services Budget Amendment", body:"Motion by Supervisor P, seconded by Supervisor Robinson. The motion carried but was not unanimous." },
      { item:"Resolution E17 - Landfill Tipping Fee Modification", body:"Administrator Leonard and Director Hagen Busher presented the resolution from the Solid Waste Management Board regarding reduced tipping fees for disaster debris. The state waived $13.10 per ton, Ringle waived $2.33, and the county proposed reducing fees to approximately $36.94 per ton (covering costs). Two residents, Jessica Toasty and Matt Haybeck, were granted special permission to speak, requesting the county waive fees entirely for affected homeowners. Supervisor Rosenberg supported the proposal but requested continued discussion. The board first voted unanimously to suspend rules to bring the resolution forward without going through a standing committee. The resolution (26-26) was then approved unanimously on motion by Supervisor Arstead, seconded by Supervisor Morash. Administrator Leonard noted ongoing discussions with the Community Foundation about a mechanism to reimburse uninsured costs for landowners." },
    ],
    publicComment: "Two residents were granted special permission to speak during the landfill tipping fee discussion. Jessica Toasty asked the county to waive fees entirely for disaster victims, noting the state, DNR, and Ringle are all waiving their portions, and emphasizing that residents are dealing with insurance deductibles and uncovered expenses. She requested a six-month waiver. Matt Haybeck spoke on behalf of homeowners facing demolition, noting some of the approximately 44 affected homes haven't received insurance adjuster visits yet, and requested extended relief and more time for the fee waiver.",
    actionItems: [
      ...
      "Resolution 26-26 approved reducing landfill tipping fees to cost-covering rate for disaster-related debris through June 17th",
      "Administrator Leonard to continue discussions with Community Foundation on reimbursement mechanism for uninsured disaster costs",
      "Solid Waste Management Board to develop long-term disaster debris policy within six months",
      "Staff to notify Supervisor Gao of future Solid Waste Board meetings",
    ],
  },
  {
    ...
    isAgendaOnly: false,
    badge: "new",
    overview: "The Marathon County Environmental Resources Committee approved two rezoning petitions and amended a resolution to waive only reconnect fees for septic systems for properties impacted by the April 17, 2026 tornado. The committee also received educational presentations from Solid Waste, Parks Recreation and Forestry, and Conservation Planning and Zoning departments.",
    agenda: [
      ...
      { time:"1:15", item:"Public hearing on rezoning petitions" },
      { time:"5:01", item:"Rezoning petition 5A1: Tim Veland on behalf of James Offer and David Tract - Urban Residential and General Agriculture to Rural Residential in Town of Green Valley" },
      ...
      { time:"20:00", item:"Consideration of fee waivers for properties impacted by April 17, 2026 severe weather" },
      { time:"55:02", item:"Educational presentations - Solid Waste Department overview" },
      { time:"1:20:00", item:"Educational presentations - Parks, Recreation and Forestry Department overview" },
      { time:"1:35:02", item:"Educational presentations - Conservation Planning and Zoning Department overview" },
    ],
    discussions: [
      ...
      { item:"Rezoning petition 5A1: James Offer and David Tract", body:"Land Use Specialist Garrett Pogle presented the staff report for rezoning from Urban Residential and General Agriculture to Rural Residential in the Town of Green Valley. The Town of Green Valley Town Board recommended approval on March 10, 2026. No public testimony was offered for or against. Supervisor Drebeck made a motion to approve based on findings of fact, conclusions of law, and town approval, seconded by Supervisor Kurt. Motion carried unanimously." },
      { item:"Rezoning petition 5A2: Jeffrey and Cynthia Schmidtz", body:"Garrett Pogle presented the petition to rezone from Conservancy Recreation to General Agriculture in the Town of McMillan. Supervisor Leur asked about the conservancy nature of the property; Pogle explained the property contains a home and horse riding stable, and the rezone would make these conforming uses. Pogle confirmed no natural areas would be lost. The Town of McMillan recommended approval on April 20, 2026. No public testimony was offered. Supervisor Sefeld moved to approve, seconded by Supervisor Drew. Motion carried unanimously." },
      { item:"Fee waivers for April 17, 2026 severe weather impacted properties", body:"Director Lori Mskimmons presented a proposal to waive county zoning and septic system fees for tornado-impacted properties in Ringle, Kronenwetter, Easton, and Weston. Supervisor Drew questioned the precedent this could set. Supervisor Leur asked about tracking costs. Supervisor Drebeck proposed an amendment to limit the waiver to only reconnect fees ($160) for septic systems, excluding other zoning and new system fees. The amendment passed and the amended resolution was approved to forward to the county board, though not unanimously." },
      { item:"Solid Waste Department presentation", body:"Director David Hagen Busher provided an overview of solid waste operations, including the landfill facility, renewable natural gas partnership with Vidi Energy, leachate treatment challenges, and upcoming capital projects. He noted the department accepts about 1,000 tons daily and operates with 11 FTEs. Marilyn Bend praised the department's work helping Ringle tornado victims." },
      { item:"Parks, Recreation and Forestry Department presentation", body:"County Forest Administrator Tom Lovelin presented on behalf of Director Jamie, covering the department's 44 full-time and 120 seasonal employees, 17 county parks, 30,700 acres of county forest, and services provided to the City of Wausau. He noted Nine Mile County Forest generates $3.25 million for the local economy from out-of-town visitors. Supervisor Sefeld announced Tom Lovelin's retirement effective June 1st after nearly 30 years of service." },
    ],
    publicComment: "No public comment was offered.",
    actionItems: [
      "Rezoning for James Offer and David Tract (Urban Residential\/General Agriculture to Rural Residential in Town of Green Valley) forwarded to County Board with approval recommendation",
      "Rezoning for Jeffrey and Cynthia Schmidtz (Conservancy Recreation to General Agriculture in Town of McMillan) forwarded to County Board with approval recommendation",
      "Amended resolution to waive only septic system reconnect fees for April 17, 2026 tornado-impacted properties forwarded to County Board",
      "Staff to track costs and requests related to tornado fee waivers for future policy development",
      "Conservation department to schedule special educational meeting on conservation topics for summer",
    ],
  },
  {
