...
const MEETINGS = [
  {
    ...
    isAgendaOnly: false,
    badge: "new",
    overview: "The Village of Weston Board of Trustees was scheduled to meet on March 23, 2026 to address multiple rezoning ordinances, a subdivision plat approval, parking restrictions, parks-related items including field maintenance agreements and shelter fees, and various infrastructure projects. Note: This summary is based on the agenda document, not a meeting transcript.",
    agenda: [
    ...
    discussions: [
      { item:"Ordinance No. 26-004: Rezoning at 8905 Birch Street", body:"The Board was scheduled to consider rezoning a portion of property at 8905 Birch Street from Rural Residential-5 Acre (RR-5) to Single Family Residential-Small Lot (SF-S) zoning district." },
      { item:"Ordinance No. 26-005: Rezoning at 7105 Christiansen Avenue", body:"The Board was scheduled to consider rezoning a portion of property at 7105 Christiansen Avenue from Single Family Residential-Large Lot (SF-L) to Single Family Residential-Small Lot (SF-S) zoning district." },
      { item:"Ordinance No. 26-006: Speed Limits Amendment", body:"The Board was scheduled to consider amending Chapter 82.600 of the Municipal Code relating to speed limits in the Village of Weston." },
      { item:"Resolution No. 2026-008: Hinner Springs Second Addition Subdivision", body:"The Board was scheduled to consider approval of the final plat for the Hinner Springs Second Addition Subdivision development." },
      { item:"April 2026 Referendum Informational Sessions Update", body:"A discussion-only item regarding updates on informational sessions planned for an upcoming April 2026 referendum." },
      { item:"Proposed E-Bicycle and E-Moto Ordinance", body:"The Board was scheduled to discuss dialogue at the Community Life and Public Safety Committee regarding proposed regulations for e-bicycles and e-motos." },
      { item:"Parking Restrictions Removal", body:"The Board was scheduled to consider removing no parking restrictions on Alta Verde Street south of Jelinek Avenue and on Alderson Street along Kennedy Park." },
      { item:"Intersection Signage at Community Center Drive and Birch St", body:"The Board was scheduled to discuss and potentially take action on signage at the intersection of Community Center Drive and Birch Street." },
      { item:"Baseball\/Softball Field Maintenance and User Agreement", body:"The Board was scheduled to discuss and potentially approve a maintenance and user agreement for baseball and softball fields." },
      { item:"Purchase of Commercial Rotary Mower", body:"The Board was scheduled to consider the purchase of a commercial rotary mower for parks or public works operations." },
      { item:"Park Shelter Fees and Field Rental Costs", body:"The Board was scheduled to review and potentially adjust fees for park shelter rentals and field rental costs." },
      { item:"Eagle Scout Project at Machmueller Park", body:"The Board was scheduled to discuss and potentially approve an Eagle Scout project proposed for Machmueller Park." },
      ...
      { item:"Microsoft Teams for Communication", body:"The Board was scheduled to discuss the use of Microsoft Teams as a communication tool for village operations." },
      { item:"Military Road Utility Engineering Services Contract", body:"The Board was scheduled to consider an engineering services contract for utility work on Military Road." },
      { item:"Bus 51 Storm Pond Engineering Services Contract Amendment", body:"The Board was scheduled to consider an amendment to the engineering services contract for the Bus 51 Storm Pond project." },
      { item:"Sewer Televising Software Contract", body:"The Board was scheduled to consider a contract for sewer televising software for infrastructure inspection." },
      { item:"2026 Annual Street Maintenance Plan and Budget", body:"The Board was scheduled to review and potentially approve the annual street maintenance plan and associated budget for 2026." },
      { item:"Hospital Area Repaving Change Order #4", body:"The Board was scheduled to consider the fourth change order for the hospital area repaving project." },
      { item:"Well 2 Rehabilitation", body:"The Board was scheduled to discuss and potentially take action on rehabilitation work for Well 2 in the village water system." },
      { item:"Sign Encroachment Agreement - Macco's Floor Covering", body:"The Board was scheduled to consider a sign encroachment agreement with 7th Floor Investments, LLC for Macco's Floor Covering at 3111 Schofield Avenue." },
    ],
    publicComment: "Public comments were on the agenda, allowing up to three minutes per person for non-agenda items, with time extensions permitted at the Chief Presiding Officer's discretion.",
    actionItems: [
      ...
      "Potential action on parking restrictions removal near Kennedy Park",
      ...
      "Potential action on Microsoft Teams usage",
  ...
  },
  {
    ...
    isAgendaOnly: false,
    badge: "new",
    overview: "This was a regular meeting of the Village of Weston Board of Trustees scheduled to cover multiple zoning ordinances, a subdivision plat approval, infrastructure projects, park fees, and various public works matters. Note: The agenda title references 'Finance and Human Resources Committee' but the document is actually for the Board of Trustees meeting. This summary is based on the agenda, not a transcript.",
    agenda: [
      { time:"6:00 p.m.", item:"Public Comments - up to three minutes for non-agenda items" },
      { time:"N\/A", item:"Approval of February 16, 2026 Board of Trustees Meeting Minutes" },
      { time:"N\/A", item:"Acknowledge Reports\/Minutes from Boards, Committees, Commissions" },
    ...
    discussions: [
      ...
      { item:"Resolution No. 2026-008: Hinner Springs Second Addition Final Plat", body:"This resolution would approve the final plat for the Hinner Springs Second Addition Subdivision development." },
      ...
      { item:"Proposed E-Bicycle and E-Moto Ordinance", body:"Discussion of a proposed ordinance addressing e-bicycles and e-motos, to be referred to the Community Life and Public Safety Committee for dialogue." },
      { item:"Parking Restrictions Removal", body:"Board to consider removing no parking restrictions on Alta Verde Street south of Jelinek Avenue and on Alderson Street along Kennedy Park." },
      { item:"Baseball\/Softball Field Maintenance and User Agreement", body:"Discussion and potential action regarding maintenance responsibilities and user agreements for village baseball and softball fields." },
      { item:"Park Shelter Fees and Field Rental Costs", body:"Board to discuss and potentially take action on fee structures for park shelter reservations and field rentals." },
      { item:"Eagle Scout Project at Machmueller Park", body:"Board to consider approval of an Eagle Scout project proposed for Machmueller Park." },
      { item:"Remote Meeting Attendance Policy", body:"Review and potential action on the handbook policy governing remote meeting attendance for elected and appointed officials." },
      { item:"Microsoft Teams for Communication", body:"Discussion regarding the adoption or use of Microsoft Teams as a communication platform for village operations." },
      { item:"Military Road Utility Engineering Services Contract", body:"Board to consider an engineering services contract for utility work on Military Road." },
      { item:"Bus 51 Storm Pond Engineering Services Contract Amendment", body:"Board to consider an amendment to the existing engineering services contract for the Bus 51 Storm Pond project." },
      { item:"2026 Annual Street Maintenance Plan and Budget", body:"Board to review and take action on the annual street maintenance plan and associated budget for 2026." },
      { item:"Hospital Area Repaving Change Order #4", body:"Board to consider the fourth change order for the hospital area repaving project." },
      { item:"Well 2 Rehabilitation", body:"Discussion and potential action regarding rehabilitation work needed for Well 2 in the village water system." },
    ...
    publicComment: "Public comment period included on agenda, allowing up to three minutes per person for non-agenda items, with time extensions at the Chief Presiding Officer's discretion.",
    actionItems: [
      "Vote on Ordinance No. 26-004 rezoning 8905 Birch Street",
      "Vote on Ordinance No. 26-005 rezoning 7105 Christiansen Avenue",
      "Vote on Ordinance No. 26-006 amending speed limits",
      ...
      "Action on parking restriction removal requests",
      "Action on intersection signage at Community Center Drive and Birch St",
      "Action on baseball\/softball field maintenance agreement",
      ...
      "Action on Microsoft Teams communication platform",
      "Action on Military Road utility engineering contract",
      "Action on Bus 51 storm pond engineering contract amendment",
  ...
  },
  {
    ...
    isAgendaOnly: false,
    badge: "new",
    overview: "This Village of Weston Board of Trustees meeting was expected to address multiple rezoning ordinances, a subdivision plat approval, infrastructure projects including utility engineering and street maintenance, and various parks and recreation matters. Based on the agenda, the meeting also included discussion of an upcoming April 2026 referendum and potential e-bicycle regulations.",
    agenda: [
    ...
    discussions: [
      ...
      { item:"Ordinance No. 26-005: Rezoning of 7105 Christiansen Avenue", body:"This ordinance would rezone a portion of property at 7105 Christiansen Avenue from SF-L (Single Family Residential-Large Lot) to SF-S (Single Family Residential-Small Lot), enabling smaller lot residential development." },
      { item:"Ordinance No. 26-006: Speed Limits Amendment", body:"This ordinance would amend Chapter 82.600 of the Municipal Code regarding speed limits in the Village of Weston." },
      { item:"Resolution No. 2026-008: Hinner Springs Second Addition Subdivision", body:"This resolution would approve the final plat for the Hinner Springs Second Addition Subdivision, advancing this residential development project." },
      ...
      { item:"Proposed E-Bicycle and E-Moto Ordinance", body:"The board was to discuss potential dialogue at the Community Life and Public Safety Committee regarding regulations for electric bicycles and electric motos." },
      ...
      { item:"Baseball\/Softball Field Maintenance and User Agreement", body:"Discussion and potential action on an agreement governing maintenance responsibilities and usage terms for baseball and softball fields." },
      { item:"Purchase of Commercial Rotary Mower", body:"The board was to consider the purchase of a commercial rotary mower for village maintenance operations." },
      { item:"Park Shelter Fees and Field Rental Costs", body:"Discussion on fee structures for park shelter reservations and field rentals." },
      ...
      { item:"Microsoft Teams for Communication", body:"Discussion on implementing Microsoft Teams as a communication tool for village operations." },
      ...
      { item:"Bus 51 Storm Pond Engineering Services Contract Amendment", body:"Discussion on amending the engineering services contract for the Bus 51 Storm Pond project." },
      { item:"Sewer Televising Software Contract", body:"Discussion and potential action on a contract for sewer televising software to support infrastructure inspection." },
      ...
      { item:"Hospital Area Repaving Change Order #4", body:"Discussion on the fourth change order for the hospital area repaving project." },
      ...
      { item:"Sign Encroachment Agreement with 7th Floor Investments, LLC", body:"Discussion on a sign encroachment agreement with 7th Floor Investments, LLC, the registered agent for Macco's Floor Covering at 3111 Schofield Avenue." },
    ],
    ...
    actionItems: [
      ...
      "Action on Resolution 2026-008 approving Hinner Springs Second Addition final plat",
      "Action on consent agenda including vouchers and agent change",
  ...
  },
  {
    ...
    isAgendaOnly: false,
    badge: "new",
    overview: "This Board of Public Works meeting was expected to address multiple street construction and paving projects, including opening bids for 2026 projects and approving change orders and payments for ongoing 2025 work. The agenda also included consideration of a concrete license application. Note: This summary is based on the agenda, not a transcript.",
    agenda: [
    ...
    discussions: [
      ...
      { item:"2026 Asphalt Paving Project 'A'", body:"Bids were to be opened for the 2026 asphalt paving project, with the board expected to review submissions and make a contract award recommendation." },
      { item:"Randolph Street\/Cherry Street Change Orders", body:"The board was to consider two change orders for the ongoing 2025 street construction project being performed by Haas Sons, Inc. on Randolph Street and Cherry Street." },
      { item:"Randolph Street\/Cherry Street Pay Estimate #9", body:"The board was scheduled to review and potentially approve Pay Estimate #9 for Haas Sons, Inc. for work completed on the Randolph Street\/Cherry Street project." },
      { item:"Portland Cement Concrete License: KSK, Inc.", body:"The board was to consider approving a Portland Cement Concrete license application from KSK, Inc." },
    ],
  ...
  },
  {
    ...
    isAgendaOnly: false,
    badge: "new",
    overview: "This Plan Commission meeting was scheduled to hold a public hearing on a conditional use permit for a personal storage facility and consider action on a 70-unit apartment building and transportation signal replacement project. Based on the agenda, not a transcript.",
    agenda: [
      { time:"N\/A", item:"Election of a Vice Chair" },
      { time:"N\/A", item:"Public comment on agenda items" },
      { time:"N\/A", item:"Consideration of the minutes of February 18, 2026 Regular Plan Commission Minutes" },
    ...
    discussions: [
      ...
      { item:"Conditional Use Permit - 218 South 4th Street (Dunwoody Storage)", body:"A public hearing was scheduled regarding a conditional use permit to authorize construction of a personal storage facility in the Light Industrial zoning district at 218 South 4th Street." },
      { item:"Conditional Use Permit - 731 N 1st Street (Beacon Resources, LLC)", body:"The commission was to discuss and potentially approve a conditional use permit for a 70-unit, 7-story apartment building at 731 N 1st Street proposed by Beacon Resources, LLC." },
    ...
    publicComment: "Public comment on agenda items was listed as agenda item 2.",
    actionItems: [
      "Election of Vice Chair",
      "Vote on Conditional Use Permit for 218 South 4th Street personal storage facility",
      "Vote on Conditional Use Permit for 731 N 1st Street apartment building",
  ...
  },
  {
    ...
    isAgendaOnly: false,
    badge: "new",
    overview: "This Board of Public Works meeting was scheduled to open and review bids for the 2026 Asphalt Paving Project 'A' and make a recommendation. This is a brief, single-item agenda focused on the city's road infrastructure maintenance program. Note: This summary is based on the agenda document, not a meeting transcript.",
    agenda: [
      { time:"N\/A", item:"Open bids and make recommendation for 2026 Asphalt Paving Project 'A'" },
    ],
    discussions: [
      { item:"2026 Asphalt Paving Project 'A' Bid Opening", body:"The board was expected to open sealed bids received for the 2026 Asphalt Paving Project 'A' and review the submissions. Following the bid opening, the board would evaluate proposals and make a recommendation for contract award." },
    ],
    publicComment: "Not indicated on agenda.",
    actionItems: [
      "Open bids for 2026 Asphalt Paving Project 'A'",
      "Make recommendation on bid award for 2026 Asphalt Paving Project 'A'",
    ],
    civicItems: [
  ...
  },
  {
    ...
    isAgendaOnly: false,
    badge: "new",
    overview: "This Public Health & Safety Committee meeting was expected to address several municipal code changes including solid waste disposal regulations and a repeal of hand-held device driving restrictions, as well as a renewable energy partnership. The agenda also included review of the Fire Department's annual report and tavern activity updates. Note: This summary is based on the agenda, not a transcript.",
    agenda: [
      { time:"N\/A", item:"Public comment on agenda items" },
      ...
      { time:"N\/A", item:"Approving Memorandum of Understanding between the City of Wausau and the Midwest Renewable Energy Association (MREA) to partner in the Grow Solar Central Wisconsin Group Buy Program" },
    ...
    discussions: [
      ...
      { item:"Solid Waste Disposal Code Update", body:"The committee was to discuss repealing and recreating Chapter 6.44 of the Wausau Municipal Code regarding solid waste disposal. This represents a comprehensive revision of the city's waste management regulations." },
      { item:"Hand-Held Device Driving Ban Repeal", body:"The agenda included consideration of repealing Section 10.01.012 prohibiting use of hand-held mobile telephones and electronic devices while driving. This may reflect changes in state law that supersede local ordinances." },
      { item:"Grow Solar Central Wisconsin Partnership", body:"The committee was to consider a Memorandum of Understanding with the Midwest Renewable Energy Association to partner in operating the Grow Solar Central Wisconsin Group Buy Program, a solar energy initiative." },
      { item:"Wausau Fire Department 2025 Annual Report", body:"The Fire Department's 2025 annual report was scheduled for discussion, providing an overview of department activities, responses, and operations from the previous year." },
      { item:"Tavern Activities Report", body:"A report on tavern activities from February 2026 was to be presented to the committee for informational purposes." },
      { item:"Community Outreach Update", body:"The committee was scheduled to receive an update on community outreach efforts, though specific details were not provided in the agenda." },
    ],
    publicComment: "Public comment on agenda items was included at the beginning of the meeting agenda.",
    actionItems: [
      "Vote on various license applications",
      "Vote on repealing and recreating solid waste disposal code Chapter 6.44",
      "Vote on repealing hand-held device driving prohibition Section 10.01.012",
  ...
  },
  {
    ...
    isAgendaOnly: false,
    badge: "new",
    overview: "The Wausau Finance Committee meeting was expected to address multiple financial matters including airport ground leases, participation in a national opioid settlement, budget amendments for water infrastructure and fund carryovers, and potential property acquisitions for the Public Works Streets Division. This agenda reflects significant fiscal decisions including approval of a 2026 general obligation promissory note for capital improvements. Note: This summary is based on the agenda, not a transcript.",
    agenda: [
      { time:"N\/A", item:"Public comment on agenda items" },
      ...
      { time:"N\/A", item:"Closed Session for property purchase deliberations" },
    ],
    discussions: [
      { item:"Alleged Claim for Recovery of Unlawful Tax - Green Acres at Greenwood Hills, LLC", body:"The committee was to consider approving an alleged claim for recovery of unlawful tax related to Outlot 1 of the Green Acres at Greenwood Hills development." },
      { item:"939 Woods Place Property Transfers and Leases", body:"Multiple related items involving the airport property at 939 Woods Place, including approving transfer of building titles with waiver of first right of refusal, terminating the existing ground lease with Wynn O. Jones, and approving a new ground lease with Owen Jones." },
      { item:"Airport Ground Lease with Cole Lundberg", body:"The committee was to consider approval of an airport ground lease agreement with Cole Lundberg at a separate airport property." },
      { item:"National Opioid Settlement Agreement", body:"The committee was to consider the city's approval and participation in the Six Remnant Defendants National Opioid Settlement Agreement, which would provide settlement funds related to the national opioid litigation." },
      { item:"Wausau Water Works Budget Amendment for Lead Service Line Replacement", body:"A budget amendment was proposed for the 2025 Lead Service Line Replacement project to cover costs not funded by the Wisconsin DNR subsidized loan program." },
      { item:"Budget Carryover from 2025 to 2026", body:"The committee was to approve a budget amendment allowing the carryover of unspent funds from the 2025 fiscal year into 2026." },
      ...
      { item:"2026 General Obligation Promissory Note", body:"The committee was to approve a 2026 General Obligation Promissory Note to fund capital improvement projects for the city." },
      { item:"2025 General Fund Financial Results", body:"A review of the city's 2025 General Fund financial performance was scheduled for committee discussion." },
      { item:"DPW Streets Division Property Acquisition", body:"The committee was to consider purchasing four properties on Adolph Street and Myron Street to expand land holdings for the Department of Public Works Streets Division. This item was also scheduled for closed session deliberation due to competitive bargaining considerations." },
    ],
    publicComment: "Public comment on agenda items was listed as the first item on the agenda.",
    actionItems: [
  ...
  },
  {
    ...
    isAgendaOnly: false,
    badge: "new",
    overview: "This Wausau Common Council meeting was expected to address solid waste and recycling service agreements, airspace obstruction removal agreements near the airport, a development agreement for Waterside Place, and a police department budget modification to purchase equipment. The meeting also included a closed session regarding litigation strategy for an ongoing lawsuit. Note: This summary is based on the agenda, not a transcript.",
    agenda: [
      { time:"6:30 PM", item:"Sarah Ruffi Day Proclamation (March 31, 2026)" },
    ...
    discussions: [
      { item:"Residential Solid Waste and Recycling Service Agreement", body:"The Finance Committee forwarded a resolution to approve a service agreement with Harter's Fox Valley Disposal LLC for residential solid waste and recycling services." },
      { item:"Airspace Obstruction Removal Agreements", body:"Two resolutions from the Finance Committee address airspace obstruction removal agreements with property owners at 724\/732 Ridgeland Avenue and 811 Ridgeland Avenue in Schofield, including related budget modifications likely connected to airport safety requirements." },
      { item:"Police Department Budget Modification for Red-Dot Optics", body:"This resolution would authorize the Wausau Police Department to use proceeds from the sale of a Thompson Sub-Machinegun to purchase red-dot optics equipment." },
      { item:"Waterside Place Development Agreement at 11 Scott Street", body:"A joint resolution from the Economic Development and Infrastructure & Facilities Committees would approve a development agreement and amended parking agreement with 11 Scott Street, LLC for the Waterside Place project." },
      { item:"Chapter 6.44 Solid Waste Disposal Code Update", body:"The Public Health & Safety Committee forwarded an ordinance to repeal and recreate the municipal code chapter governing solid waste disposal, requiring suspension of normal procedural rules for consideration." },
      { item:"David Hoelzel v. City of Wausau Settlement", body:"The Council was expected to consider a resolution approving release of all claims for property damage in settlement of a counterclaim and third-party complaint in ongoing litigation, with related closed session discussion on litigation strategy." },
      { item:"Police Officer Out of Country Training", body:"A joint resolution from the Human Resources and Finance Committees would approve paid duty time for a Wausau Police Department officer to participate in training outside the country." },
      { item:"Community Outreach Professional Shelter Operations Duty Premium", body:"This joint resolution would establish a duty premium differential for community outreach professionals involved in shelter operations." },
    ],
    publicComment: "Public comment was on the agenda both before the business meeting (Item 6 - preregistered citizens) and after (Item 13 - citizens present).",
    actionItems: [
      ...
      "Vote on airspace obstruction removal agreements with Schofield Ridgeland Legacy LLC and Zachary Lange",
      ...
      "Vote on settlement of claims in David Hoelzel v. City of Wausau case",
  ...
  },
  {
    ...
    isAgendaOnly: true,
    badge: "new",
    overview: "The Wausau School District Education\/Operations Committee meeting addressed 4K program partnerships for the 2026-2027 school year, reviewed the district's comprehensive safety program and recent drill results, and considered updates to 43 district policies. The meeting highlighted ongoing community collaboration for early childhood education and security measures implemented across district schools.",
    agenda: [
      { time:"0:00", item:"Call to Order" },
    ...
    discussions: [
      { item:"4K Program Agreement", body:"The district's four-year-old kindergarten program is seeking approval to continue Program Agreements with six community partner sites for the 2026-2027 school year, including Wausau Child Care, Mountain View Montessori, Woodson YMCA, Newman Catholic Schools, and the Marathon County Head Start Program. These community collaboration partnerships have been in place since 2002, and 4K Principal Kara Rakowski and Director of Elementary Education Julie Schell will present the agreement details." },
      { item:"Annual Safety Update \/ Drill Debrief", body:"The district is implementing the I Love U Guys Standard Response Protocol, which uses standardized vocabulary (HOLD, SECURE, LOCKDOWN, EVACUATE, SHELTER) for consistent emergency responses across students, staff, and first responders. Security highlights include secure building entrances, Visitor Aware System, security cameras, locked exterior doors, and district-wide drills conducted in September and October in partnership with Wausau Police Department and School Resource Officers." },
      { item:"Neola Policies Update", body:"The committee will review proposed changes to 43 district policies covering a wide range of topics including board member conduct, student entrance age, third grade promotion and retention, early graduation, academic honesty, student drug policies, school safety, food service, wellness, and various staff and administrative procedures. Both substantive policy updates and technical corrections are included in this comprehensive review." },
    ],
  ...
  },
  {
    ...
    discussions: [
      { item:"Discussion regarding the Competitive Negotiations of a Purchase\/Sale of Real Estate", body:"The board convened in closed session under Wisconsin Statute 19.85(1)(e) to discuss competitive negotiations related to the purchase or sale of real estate. This exemption allows the board to discuss property transactions confidentially to protect the district's negotiating position." },
      { item:"Evaluation of Superintendent of Schools", body:"The board met in closed session under Wisconsin Statute 19.85(1)(c) to conduct an evaluation of the Superintendent of Schools. This statutory exemption permits personnel evaluations to be conducted privately." },
      { item:"Reconvene in Open Session", body:"Following the closed session discussions, the board planned to reconvene in open session and potentially take formal action based on matters discussed during the closed session regarding real estate negotiations or the superintendent evaluation." },
    ],
    publicComment: "No public comment period was included on this agenda.",
    actionItems: [
      "Potential action as a result of closed session discussions on real estate purchase\/sale",
  ...
  },
  {
    ...
    isAgendaOnly: true,
    badge: "new",
    overview: "This Regular Meeting of the Wausau School District Board of Education covered referendum-funded elementary school construction updates at 50% completion, a Red Granite Charter School status update, and numerous policy revisions through Neola. The board also addressed 4K program agreements with community partners for the 2026-2027 school year and received an annual safety update in partnership with the Wausau Police Department.",
    agenda: [
      { time:"0:00", item:"Call to Order" },
    ...
    discussions: [
      ...
      { item:"Red Granite Update", body:"Red Granite Principal Maud Mangin and Red Granite Governance Board President Amanda Molin shared an update on the status of the Red Granite Charter School. This item required board action." },
      { item:"4K Program Agreement", body:"The Wausau School District four-year-old kindergarten program sought approval to enter into agreements with community collaboration partner sites for the 2026-2027 school year, including Wausau Child Care, Mountain View Montessori, Woodson YMCA Wausau Branch, Newman Catholic Schools, and Marathon County Child Development Agency Head Start Program." },
      ...
      { item:"Neola Policies Update", body:"The Board reviewed proposed changes to numerous district policies that were previously reviewed at the November Education\/Operations Committee meeting. The update included 43 policy attachments covering definitions, board member conduct, employment, student policies, safety, food service, and various technical corrections." },
    ],
  ...
  },
  {
    ...
    isAgendaOnly: true,
    badge: "new",
    overview: "The Audit of the Bills Committee met to review and approve the district's financial expenditures for December 2025. This routine financial oversight meeting ensures proper review of Wausau School District payments and expenses.",
    agenda: [
      { time:"0:00", item:"Call to Order" },
      { time:"0:02", item:"Audit of the Bills" },
      { time:"0:07", item:"Adjourn" },
    ...
    discussions: [
      { item:"Audit of the Bills", body:"Committee members reviewed the December 2025 audit of bills document, which details the district's financial expenditures requiring approval. The attachment dated December 9, 2025 contains the itemized list of payments and expenses for committee examination." },
    ],
    publicComment: "No public comment period was included on this agenda.",
    actionItems: [
      "Review and approve the December 2025 audit of bills",
    ],
  },
  {
    ...
    discussions: [
      ...
      { item:"Discussion regarding the Competitive Negotiations of a Purchase\/Sale of Real Estate", body:"The board held closed session discussions under Wisconsin Statute 19.85(1)(e) regarding competitive negotiations for the purchase or sale of real estate. Details of the specific property or transaction were not disclosed in the public agenda." },
      { item:"Resolution of Commendation: Ellie Mason", body:"The board considered a resolution of commendation to honor Ellie Mason. Supporting documentation for this recognition was attached to the agenda packet." },
    ],
    publicComment: "No public comment period was included on this agenda.",
    actionItems: [
  ...
  },
  {
    ...
    isAgendaOnly: true,
    badge: "new",
    overview: "The Education\/Operations Committee meeting addressed open enrollment seat availability for 2026-2027, snow day communication procedures, and athletic co-op renewals for hockey and lacrosse programs. The meeting also featured a performance and recognition of John Muir Middle School, followed by a tour of recent school updates.",
    agenda: [
      { time:"0:00", item:"Call to Order" },
    ...
    discussions: [
      ...
      { item:"Snow Day Communication & Procedures", body:"Diana White and Dr. Katie Colwell presented information on communications and procedures for snow days. The presentation addressed what happens beyond the standard 3 snow days allotted to the district." },
      { item:"Approve Co-Ops", body:"Athletic directors BJ Brandt and Darci Mick Beversdorf presented information on co-op renewals including boys hockey with East\/Merrill\/Newman Catholic, girls lacrosse with East\/West\/DCE\/Mosinee, and girls STORM hockey adding Merrill and Stratford to the existing partnership for the 26-27 and 27-28 school years." },
    ],
    publicComment: "A public and student comment period was included on the agenda.",
    actionItems: [
      "Approve Open Enrollment Seat Availability for 2026-2027",
      "Approve Co-Op renewals for boys hockey, girls lacrosse, and girls STORM hockey for 26-27 and 27-28 school years",
  ...
  },
  {
    ...
    isAgendaOnly: true,
    badge: "new",
    overview: "This special meeting of the Wausau School District Board of Education focused primarily on personnel matters, including a quasi-judicial hearing regarding employee termination and administrator contract approvals. The meeting included multiple closed sessions to address confidential employment issues.",
    agenda: [
      { time:"0:00", item:"Call to Order" },
      { time:"0:02", item:"Approve Consent Agenda (Action Requested)" },
      { time:"0:05", item:"Request for Closed Session - Employee Conduct Hearing" },
      { time:"0:08", item:"Request for Closed Session - Administrator Contracts" },
      { time:"0:11", item:"Adjourn" },
    ],
    discussions: [
      { item:"Consent Agenda", body:"The consent agenda included personnel actions covering appointments of additional and replacement staff, contract increases, separations including resignations and terminations, leaves of absence, and retirements." },
      { item:"Closed Session - Employee Conduct Hearing", body:"The board convened into closed session pursuant to Wis. Stat. 19.85(1)(b) to receive evidence concerning allegations regarding employee conduct and an administrative recommendation for termination. The board also deliberated on the evidence in a quasi-judicial capacity and may have considered an employee resignation agreement." },
      { item:"Closed Session - Administrator Contracts", body:"The board entered closed session pursuant to Wis. Stat. 19.85(1)(c) to approve administrator contracts and discuss the performance and employment of staff members." },
    ],
    publicComment: "No public comment period was included on this agenda.",
    actionItems: [
      "Approve Consent Agenda including appointments, separations, leaves of absence, and retirements",
      "Take action on employee termination recommendation following closed session hearing",
  ...
  },
  {
    ...
    isAgendaOnly: true,
    badge: "new",
    overview: "The Wausau School District Board of Education held a regular meeting covering the 2024-25 audit report presentation, WASB delegate voting resolutions, and a discussion on replacing the chiller system at Wausau West High School. The board also addressed open enrollment seat availability, athletic co-op renewals, and entered closed session for potential litigation and superintendent evaluation matters.",
    agenda: [
      { time:"0:00", item:"Call to Order" },
      { time:"0:02", item:"Roll Call" },
      { time:"0:04", item:"Pledge of Allegiance: Jim Bouch, President" },
    ...
    discussions: [
      { item:"Approve the 2024-25 Audit Report", body:"Amber Ebert from Hawkins Ash CPAs presented the results of the Wausau School District's June 30, 2025 Audited Financial Statements to the Board. This annual audit review provides the district with an independent assessment of its financial health and compliance." },
      { item:"WASB Resolutions", body:"The Board reviewed proposed Wisconsin Association of School Boards resolutions and directed the WASB Delegate on how to vote on behalf of the District. A late addition included Resolution 13, a proposed amendment to the bylaws of WASB." },
      { item:"Wausau West Chiller Discussion", body:"Elizabeth Channel, Interim Assistant Superintendent of Operations, and Ryan Urmanski, Director of Buildings and Grounds, presented a request to solicit bids for replacement of the chiller system at Wausau West High School. This infrastructure project addresses facility maintenance needs at the school." },
      { item:"Resolution Authorizing Entry into Wisconsin Investment Series Cooperative", body:"Assistant Superintendent of Operations Elizabeth Channel presented a resolution to continue the District's membership in the Wisconsin Investment Series Cooperative. This resolution updates authorization that is over ten years old in accordance with best practice." },
      { item:"Open Enrollment Seat Availability", body:"Information previously presented at the December Education\/Operations Committee Meeting regarding Open Enrollment Space Determinations for the 2026-2027 school year was brought forward for board action." },
      { item:"Approve Co-Ops", body:"The board considered athletic co-op renewals for boys hockey East\/Merrill with Newman Catholic, girls lacrosse East\/West\/DCE\/Mosinee, and girls STORM hockey East\/West\/DCE\/Mosinee with the addition of Merrill and Stratford for the 2026-27 and 2027-28 school years." },
    ],
  ...
  },
  {
    ...
    isAgendaOnly: true,
    badge: "new",
    overview: "This was a routine Audit of the Bills Committee meeting for the Wausau School District, focused on reviewing and approving district expenditures. The committee examined the January 26, 2026 audit of bills documentation for financial oversight purposes.",
    agenda: [
      { time:"0:00", item:"Call to Order" },
      { time:"0:02", item:"Audit of the Bills" },
      { time:"0:07", item:"Adjourn" },
    ...
    discussions: [
      { item:"Audit of the Bills", body:"The committee reviewed the district's bills and expenditures as documented in the January 26, 2026 audit attachment. This routine financial review ensures proper oversight of district spending and verifies that payments are appropriate and authorized." },
    ],
    publicComment: "No public comment period was included on this agenda.",
    actionItems: [
  ...
  },
  {
    ...
    isAgendaOnly: true,
    badge: "new",
    overview: "The Education\/Operations Committee meeting focused on advancing referendum-funded school construction projects, reviewing district financial planning, and examining student demographics. Key decisions included approving 95% design plans for four elementary schools and the 2026-2027 school calendar.",
    agenda: [
      { time:"0:00", item:"Call to Order" },
      { time:"0:02", item:"Approve the Minutes" },
    ...
    discussions: [
      ...
      { item:"Approve 2026-2027 District Calendar", body:"Diana White presented a draft of the 2026-2027 school year calendar for School Board review and approval." },
  ...
  },
  {
    ...
    isAgendaOnly: true,
    badge: "new",
    overview: "This special meeting of the Wausau School District Board of Education focused on personnel matters through a consent agenda, approval of the 2026-2027 district calendar, and a closed session for the Superintendent evaluation. The meeting addressed routine staffing changes and finalized the upcoming school year calendar previously reviewed by the board.",
    agenda: [
      { time:"0:00", item:"Call to Order" },
    ...
    discussions: [
      { item:"Approve 2026-2027 District Calendar", body:"Diana White previously presented a draft of the 2026-2027 school year calendar at a prior meeting for School Board review. The board was asked to take action to approve the finalized calendar for the upcoming school year." },
      { item:"Evaluation of Superintendent of Schools", body:"The board entered closed session pursuant to state statute s. 19.85 (1)(c) to conduct the evaluation of the Superintendent of Schools. This personnel matter required confidential discussion before potentially reconvening in open session to take any necessary action." },
    ],
    publicComment: "No public comment period was included on this agenda.",
    actionItems: [
      "Approve Consent Agenda including appointments, separations, leaves of absence, and retirements",
  ...
  },
  {
    ...
    isAgendaOnly: true,
    badge: "new",
    overview: "The Wausau School District Board of Education regular meeting covered referendum project design approvals for four elementary schools, addressed the Wausau West chiller system replacement, and discussed the disbandment of the East\/Merrill Boys Hockey Co-Op. The meeting also included proclamations, financial reports, and a closed session regarding real estate negotiations.",
    agenda: [
      { time:"0:00", item:"Call to Order" },
      { time:"0:02", item:"Roll Call" },
      ...
      { time:"1:35", item:"Request for Closed Session Pursuant to State Statutes" },
    ...
    discussions: [
      ...
      { item:"Legal Expenses for 2nd Quarter of 2025-2026", body:"The Interim Assistant Superintendent of Operations presented a summary report of all legal counsel expenses incurred during the second quarter. The report is broken down by law firm and by type of legal advice sought and requires no action." },
      { item:"2025-2026 Student Demographic Report", body:"The Director of Technology presented the Demographics Report for the 2025-2026 school year at the January Education\/Operations Committee Meeting. This informational report provides student demographic data for the district." },
      { item:"Wausau West Chiller System", body:"The Interim Assistant Superintendent of Operations and Director of Buildings and Grounds presented the request to approve the bid for replacement of the chiller system at Wausau West High School. The Board is being asked to take action on this facilities improvement." },
      { item:"Wausau East Hockey Update", body:"An informational presentation addresses the disbandment of the East\/Merrill Boys Hockey Co-Op and potential options for the district, Wausau East, and East Hockey players. This 15-minute presentation explores future arrangements for the hockey program." },
      { item:"Presentation of Financial Projection Model Assumptions", body:"The Interim Assistant Superintendent of Operations shared key variables contributing to the District's multi-year financial projection model. The model uses 2025-2026 budget numbers with percentages and dollar amounts projected forward, and will be presented to the Board at a later date." },
      { item:"Governance Model Option", body:"Discussion about potentially changing the Audit of the Bills Committee and clarifying the purpose of the Education\/Operations Committee with a potential rename of the meeting. Board procedures documentation is attached for consideration." },
      { item:"Closed Session - Real Estate", body:"The Board will enter closed session to discuss competitive negotiations regarding the purchase or sale of real estate pursuant to state statute s. 19.85 (1)(e)." },
    ],
    ...
    actionItems: [
      ...
      "Take action if necessary following closed session on real estate negotiations",
    ],
  },
  {
    ...
    isAgendaOnly: true,
    badge: "new",
    overview: "This special meeting of the Wausau School District Board of Education focused on routine personnel matters through the consent agenda and included a closed session to discuss potential litigation. The meeting addressed staff appointments, separations, leaves of absence, and retirements.",
    agenda: [
      { time:"0:00", item:"Call to Order" },
      { time:"0:02", item:"Approve Consent Agenda (Action Requested) - Including Appointments, Separations, Leaves of Absence, and Retirements" },
    ...
    discussions: [
      ...
      { item:"Closed Session - Potential Litigation", body:"The board entered closed session under Wisconsin State Statute 19.85(g) to conduct preliminary discussions regarding potential litigation facing the district. This statutory provision allows boards to meet privately when discussing matters that could result in legal action." },
    ],
    publicComment: "No public comment period was included on this agenda.",
    actionItems: [
      "Approve Consent Agenda including appointments, separations, leaves of absence, and retirements",
  ...
  },
  {
    ...
    isAgendaOnly: true,
    badge: "new",
    overview: "The Wausau School District Board of Education Committee of the Whole meeting covered financial planning with a five-year fiscal forecast, mid-year AGR school progress reports, and an extensive NEOLA policy update affecting over 60 district policies. The meeting also featured recognition of the district planetarium and Wausau West High School achievements, with a post-meeting facility tour offered to attendees.",
    agenda: [
      { time:"0:00", item:"Call to Order" },
      { time:"0:02", item:"Approve the Minutes" },
    ...
    discussions: [
      { item:"Five Year Fiscal Forecast", body:"The Board received a five-year fiscal forecast model that will guide the 2026-27 budget reconciliation plan and final budget construction over the next three months. Administration emphasized that projections depend on many variables that change periodically, and significant changes will be communicated to the Board as they occur." },
      { item:"AGR Annual Report", body:"This mid-year update provided AGR student outcome scores required by DPI, including screening results from the district's three AGR schools. The presentation highlighted systemic improvements and evolving practices at these schools designed to strengthen organizational systems and improve student achievement." },
      { item:"NEOLA UPDATE", body:"The Committee reviewed proposed changes to numerous district policies ranging from technical corrections to more substantive updates covering definitions, board member conduct, student supervision, cell phones, academic honesty, homeless students, debt management, purchasing, and school support organizations. Some changes are minor technical corrections while others are more lengthy revisions." },
      { item:"Referendum Budget Update", body:"As the April 2022 referendum-funded facility improvements continue, administration provided a routine construction and budget update on the ongoing projects until their completion." },
    ],
    ...
    actionItems: [
      ...
      "Approve NEOLA policy updates including policies on definitions, board member conduct, student supervision, cell phones, academic honesty, homeless students, fund balance, purchasing, school support organizations, and technical corrections to various policies",
    ],
  },
  {
    ...
    isAgendaOnly: true,
    badge: "new",
    overview: "This special meeting of the Wausau School District Board of Education was convened to conduct a closed session pupil expulsion hearing. The board was authorized to deliberate, take action in closed session if necessary, and potentially take further action upon reconvening in open session.",
    agenda: [
      { time:"0:00", item:"Call To Order" },
    ...
    discussions: [
      { item:"Closed Session - Pupil Expulsion Hearing", body:"The Board convened in closed session under Wisconsin Statutes to conduct a pupil expulsion hearing, with authority to deliberate privately on the matter. The Board was authorized to take action in closed session if necessary and appropriate, with the possibility of further action upon reconvening in open session." },
    ],
    publicComment: "No public comment period was included on this agenda.",
    actionItems: [
      ...
      "Potential further action following closed session",
      "Motion to adjourn",
    ],
  },
  {
    ...
    isAgendaOnly: true,
    badge: "new",
    overview: "This meeting brought together the Elementary Task Force one year after the elementary school consolidation to reflect on the process and outcomes. The reunion featured a summary of the consolidation effort and reflections from task force members on the transition.",
    agenda: [
    ...
    discussions: [
      { item:"Summary of Elementary Consolidation", body:"This item provided an overview of the elementary school consolidation process that was implemented in the Wausau School District. The summary likely covered the key decisions, timeline, and outcomes of the consolidation effort." },
      { item:"Task Force Member Reflectives: One Year Later", body:"Task force members shared their reflections on the consolidation one year after implementation. Members discussed their perspectives on how the transition has progressed and the impact on the district." },
    ],
    publicComment: "No public comment period was included on this agenda.",
    actionItems: [
  ...
  },
  {
    ...
    isAgendaOnly: true,
    badge: "new",
    overview: "This meeting was a WEA-sponsored candidate meet and greet event for Wausau School District Board of Education candidates. While a quorum of the Board may have been present, no official Board action was scheduled to be taken at this event.",
    agenda: [
  ...
  },
  {
    ...
    isAgendaOnly: true,
    badge: "new",
    overview: "The Wausau School District Board of Education held a regular meeting covering routine consent agenda items, a proposal to switch middle school devices from Chromebooks to iPads, and updates on the 2022 referendum budget, five-year fiscal forecast, and AGR school performance. The meeting addressed both operational matters and strategic planning for district technology and finances.",
    agenda: [
      { time:"0:00", item:"Call to Order" },
      { time:"0:02", item:"Roll Call" },
      { time:"0:04", item:"Pledge of Allegiance" },
    ...
    discussions: [
      ...
      { item:"iPads Presentation", body:"The board received information on switching one-to-one devices at the middle school from Chromebooks to iPads. This presentation lasted approximately 20 minutes and required board action." },
      { item:"Five Year Fiscal Forecast", body:"The board reviewed a five-year fiscal forecast model that will be applied during the next three months to aid in constructing the 2026-27 budget reconciliation plan. Administration noted that projections are based on many variables that change periodically and will report significant changes to the board." },
      { item:"AGR Annual Report", body:"The board received the mid-year AGR student outcome scores required by DPI, featuring screening results and work being done at the three AGR schools to strengthen organizational systems and improve student achievement." },
    ],
    publicComment: "A public and student comment period was included on the agenda.",
    actionItems: [
  ...
  },
  {
    ...
    isAgendaOnly: true,
    badge: "new",
    overview: "The Wausau School District Board of Education's Committee of the Whole meeting focused on approving continued membership in the Wisconsin School Nutrition Purchasing Cooperative, establishing facility use fees for artificial fields and lighting, receiving a referendum budget update, and reviewing extensive NEOLA policy updates including changes related to cell phones, AI, child abuse reporting (Act 57), and school support organizations.",
    agenda: [
      { time:"0:00", item:"Call to Order" },
      { time:"0:02", item:"Approve the Minutes" },
    ...
    discussions: [
      { item:"Wisconsin School Nutrition Purchasing Cooperative Agreement (WiSNP)", body:"The Wausau School District Nutrition Service Department currently belongs to the WiSNP Co-op, which is requesting member districts to present the Co-op's resolution to their School Boards for approval of continued membership for the 2026-2027 school year. The presentation was estimated at 5 minutes." },
      ...
      { item:"Referendum Budget Update", body:"Elizabeth Channel, Interim Assistant Superintendent of Operations, shared an update on the status of the Referendum Budget. The presentation was estimated at 10 minutes with supporting documentation provided." },
      { item:"NEOLA UPDATE", body:"The Committee reviewed proposed changes to numerous district policies, with some being technical corrections and others more substantial. Key policy areas included board member conduct, reading instruction goals, cell phones, academic honesty, artificial intelligence, student fund-raising, school support organizations, and Act 57 related policies on child abuse and neglect reporting." },
    ],
    publicComment: "No public comment period was included on this agenda.",
    actionItems: [
      ...
      "Review and approve NEOLA policy updates including 39 general policies, 9 school support organization policies, 18 technical corrections, and 4 Act 57 related policies",
    ],
  },
  {
