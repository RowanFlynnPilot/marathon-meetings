...
const MEETINGS = [
  {
    ...
    isAgendaOnly: false,
    badge: "new",
    overview: "The Wausau City Council approved a development agreement for the 11 Scott Street Wateride Place project by a 6-3 vote, which will convert a vacant 100,000 square foot building into 52 mid-priced apartments. The council also recognized city employees for their response to a record 30.9-inch snowfall and presented a sustainability award to Colby and Colby Millwork for their solar panel installation.",
    agenda: [
      { time:"0:00", item:"Call to order and Pledge of Allegiance" },
      { time:"1:00", item:"Proclamation - Sarah Rafi Day (March 31st)" },
      { time:"5:30", item:"Mayoral Citation - Department of Public Works snow response" },
      ...
      { time:"24:00", item:"Development agreement for 11 Scott Street LLC \/ Wateride Place" },
      { time:"38:00", item:"Mayoral appointments to Plan Commission, Affordable Housing Task Force, and BID Board" },
      { time:"39:00", item:"Solid waste and recycling service agreement with Harter's Fox Valley Disposal" },
      { time:"40:00", item:"Announcements and adjournment" },
    ],
    discussions: [
      { item:"Development Agreement for 11 Scott Street \/ Wateride Place", body:"The council approved a joint resolution from Economic Development and Infrastructure committees for a development agreement with 11 Scott Street LLC by a 6-3 vote. Developers Raleigh Lray and Mark Craig spoke during public comment, noting the $10 million project would create 52 mid-priced residential units in a building vacant for 3 years. Alder Rasmusson supported the project citing the need for downtown residents and mid-priced housing. Alder Neil outlined benefits including $55,000 annual parking revenue and helping close TID 8 within 5 years. Alder Larson dissented, opposing discounted parking rates for city assets during budget cuts. Alder Tierney questioned the city's obligation to provide 150 parking spaces within 300 yards if the ramp closes; Economic Development Director Randy Feifer explained this replaced an existing agreement that required 480 spaces, reducing the city's obligation while generating new revenue." },
      { item:"DPW Snow Response Recognition", body:"Mayor Denny presented a mayoral citation to the Department of Public Works for their response to a record-shattering 30.9 inches of snowfall from March 14-16, 2026. Street Supervisor Kevin Kester, Dustin, Josh, and fleet technicians including Jieven Matah were recognized. Kester addressed the council, praising the plow operators and mechanics, noting the fleet technicians worked 12-hour shifts providing 24-hour breakdown support and would work 12 straight days without a day off." },
      { item:"Sustainability Award to Colby and Colby Millwork", body:"Christine Daniels from the Sustainability, Energy and Environment Committee presented the 2026 City of Wausau Sustainability Award to Colby and Colby Millwork. Representatives Mike Thompson and Keith Kaning accepted, describing their solar installation of over 2,000 panels operational since July, generating enough power for approximately 120 homes. They also highlighted LED lighting upgrades, high-efficiency air compressors, and comprehensive recycling programs for wood, aluminum, glass, vinyl, cardboard, and other materials." },
      { item:"Solid Waste and Recycling Service Agreement", body:"The council approved a seven-year residential solid waste and recycling service agreement with Harter's Fox Valley Disposal by a 9-0 vote. Mayor Denny noted a correction was made from earlier discussions regarding whether the term was seven or ten years, confirming the final agreement is for seven years as recommended by Public Health and Safety committee." },
      { item:"Settlement Resolution - David Holes vs City of Wausau", body:"Assistant City Attorney Vincent Bonito explained the resolution regarding a 2022 bus accident where the city's insurer paid the initial claim. The individual who struck the bus later filed a personal injury claim, and the city filed a counter claim. The other party's insurer agreed to pay damages for the bus. Alder Neil confirmed this settlement does not affect the separate ongoing personal injury claim. Approved 8-1." },
    ],
    publicComment: "Two speakers addressed the council regarding the 11 Scott Street project. Raleigh Lray requested support for the green sustainable project converting a vacant building to mid-priced apartments. Mark Craig (3246 North 8th Street) emphasized the project is over $10 million with $8.3 million for the residential component, stating 'Without your help, it won't happen.'",
    actionItems: [
      "Development agreement with 11 Scott Street LLC for Wateride Place approved (6-3)",
      ...
      "Municipal Code Chapter 6.44 solid waste disposal ordinance recreated to align with state code",
  ...
  },
  {
    ...
    isAgendaOnly: false,
    badge: "new",
    overview: "The Wausau Board of Public Works approved contracts for the 26th Street construction project, a change order for the Rolph\/Cherry Street project addressing unforeseen underground conditions, and a concrete license. All items passed unanimously with no opposition or public comment.",
    agenda: [
      { time:"0:00", item:"Call to order" },
      { time:"0:08", item:"Consideration of March 10th regular Board of Public Works minutes" },
      { time:"0:27", item:"Open bids for 26th Street construction project" },
      { time:"1:28", item:"North 8th Avenue bid opening - postponed" },
      { time:"1:38", item:"2025 Street Construction Project A - Rolph Street, Cherry Street Change Order 1" },
      { time:"3:37", item:"2025 Street Construction Project A - Pay Estimate Number 9" },
      { time:"4:02", item:"Portland cement concrete license for KSK Incorporated" },
      { time:"4:28", item:"Adjournment" },
    ],
    discussions: [
      ...
      { item:"26th Street Construction Project Bid Award", body:"Seven bids were opened and read aloud. Switlick submitted the lowest bid at $1,279,089.75, narrowly beating Haas at $1,280,877.96. Other bidders included A1 ($1,374,600), Francis Melvin ($1,385,383), Steen ($1,489,126), James Peterson ($1,570,698.56), and Earth ($1,686,078.75). A board member remarked on the tight bids. A motion was made to approve Switlick as the contractor, which passed unanimously." },
      ...
      { item:"2025 Street Construction Project A - Change Order 1", body:"Staff presented Change Order 1 for $14,436.50 to address unforeseen conditions discovered during the Rolph Street\/Cherry Street project. Items included: an inside drop on a manhole due to an unrecorded large diameter sanitary service ($4,856); water main tie-in modifications where 6-inch pipe was found instead of expected 8-inch ($2,317.50); miscellaneous storm sewer tie-ins ($5,016); and geogrid installation near Thomas Jefferson Elementary due to poor soils ($2,247). Change Order 2 regarding liquidated damages was deferred for further discussion. The motion to approve passed unanimously." },
      { item:"2025 Street Construction Project A - Pay Estimate 9", body:"Pay estimate number nine from Haas Suns Incorporated for work completed through the end of the year was presented in the amount of $535,114.20. The motion to approve passed unanimously." },
      { item:"Portland Cement Concrete License - KSK Incorporated", body:"Vinnie confirmed he reviewed the application and everything was in order. A motion was made to approve the Portland cement concrete license for KSK, Inc., which passed unanimously." },
    ],
    publicComment: "No public comment was offered.",
    actionItems: [
      "Switlick awarded 26th Street construction project contract at $1,279,089.75",
      "Change Order 1 approved for Rolph\/Cherry Street project at $14,436.50",
      "Pay Estimate 9 approved for Haas Suns Inc. at $535,114.20",
      "Portland cement concrete license approved for KSK Incorporated",
      "North 8th Avenue bid opening postponed to future meeting",
      "Change Order 2 for Rolph\/Cherry Street project to return for discussion on liquidated damages",
    ],
    civicItems: [
  ...
  },
  {
    ...
    isAgendaOnly: false,
    badge: "new",
    overview: "The Finance and Human Resource Committee approved a modified employee clothing allowance policy after significant debate, settling on $400 for the remainder of 2026 and $500 annually starting in 2027, plus a washer and dryer purchase, after canceling the Cintas uniform contract. Public Works Director Michael presented a comprehensive budget overview showing the department decreased its budget by 1.1% while maintaining services, and the committee acknowledged various financial reports.",
    agenda: [
      { time:"0:00", item:"Call to order and Pledge of Allegiance" },
      { time:"0:32", item:"Roll call" },
      { time:"0:47", item:"Public comments" },
      { time:"2:56", item:"Approval of minutes from February 16, 2026" },
      { time:"3:27", item:"Acknowledge February financial reports for all funds" },
      { time:"4:00", item:"Acknowledge T1 and T2 detail reports for February" },
      { time:"4:31", item:"Acknowledge legal details for February" },
      { time:"4:53", item:"Educational presentation: Public Works operations and budget" },
      { time:"36:34", item:"Discussion and action on reimbursement for clothing and equipment including amendments to Chapter 5 and Chapter 10" },
      { time:"1:07:45", item:"Remarks from staff and committee members, future meeting scheduling" },
      { time:"1:10:00", item:"Adjournment" },
    ],
    discussions: [
      { item:"Public Works Operations and Budget Presentation", body:"Public Works Director Michael presented a comprehensive overview of department operations and budget, highlighting that the 2026 budget decreased by $26,000 (1.1%) compared to 2025. He detailed infrastructure including 119.5 centerline miles of road, 114 miles of water main, and 103 miles of sewer. Michael emphasized that Weston spends approximately $9,700 less per mile than the average central Wisconsin community on street maintenance, making them the third lowest spending community per mile in the region. He also discussed the recent major storm event that cost approximately $50,000, with staff working 16-17 hour shifts, and noted the department operates with 10 frontline employees compared to 11 when he started in 2010." },
      { item:"Employee Clothing and Equipment Allowance Policy", body:"Significant debate occurred over the proposed increase in employee clothing allowance from $300 to $600 following cancellation of the Cintas uniform contract. Committee member Stephanie Olsson opposed the full increase, citing fiscal responsibility and the upcoming fire department referendum, suggesting $400 instead. Director Michael defended the proposal, emphasizing employee retention, safety needs, and that employees deal with chemicals and hazardous materials. The initial motion for $600 failed on a 3-3 roll call vote (Daniels-yes, Armain-no, Love-yes, My-no, Olsson-no, Satai-yes). A motion for $400 also failed 3-3. A motion for $500 with washer\/dryer also failed. Finally, a motion for $400 for remainder of 2026, $500 annually starting 2027, plus a one-time washer and dryer purchase passed with one opposed." },
      { item:"Financial Reports Acknowledgment", body:"The committee acknowledged the February 2026 financial reports for all funds, T1 and T2 detail reports, and legal details for February. All acknowledgments passed unanimously with no discussion." },
      { item:"Minutes Approval", body:"Minutes from the February 16, 2026 meeting were approved unanimously on a motion by Steve, seconded by Stephanie." },
    ],
    publicComment: "Lisa Beck of 1808 Cortez Lane offered public comment. She commended Public Works Director Mike for his work during the recent storm, stating she tries to recognize him at every meeting. She also expressed concern about the proposed employee clothing allowance increase, questioning why the village would implement the highest amount when the Cintas contract was cancelled to save money, suggesting a lesser amount could be used to save funds elsewhere.",
    actionItems: [
      "Employee clothing allowance policy approved at $400 for remainder of 2026, $500 annually starting 2027, with one-time purchase of washer and dryer - to be recommended to Village Board",
      "Staff to submit disaster relief costs to Marathon County for the recent storm event",
      "New public works employee starting Wednesday to bring department to 10 staff members",
      "Next committee meeting tentatively scheduled for Tuesday, April 21st at 5:00 PM due to new board member swearing-in",
    ],
  },
  {
    ...
    isAgendaOnly: false,
    badge: "new",
    overview: "The Village of Weston Board of Trustees approved multiple rezoning ordinances, modified a speed limit ordinance for Weston Avenue after debate, and received updates on the April 2026 referendum for fire department funding. A resident delivered pointed public comment criticizing the board's approach to funding the fire department, calling it short-sighted and urging prioritization of emergency services over amenities.",
    agenda: [
      { time:"0:00", item:"Call to order and Pledge of Allegiance" },
      ...
      { time:"23:00", item:"Consent agenda and vouchers" },
      { time:"25:00", item:"Ordinances - Rezoning and speed limit changes" },
      ...
      { time:"40:00", item:"E-bike and euro ordinance discussion" },
      { time:"52:00", item:"Baseball\/softball field maintenance agreement and park fees" },
    ],
    discussions: [
      { item:"Public Comment - Fire Department Funding", body:"Jim Pensel of 5002 Aerrol Street delivered critical public comment about fire department funding. He praised SAFER personnel but criticized the board's approach, calling the referendum a 'band-aid' without a sunset date. He argued the village has 'a priority problem, not a revenue problem' and urged the board to prioritize emergency services over amenities like artificial turf at Kennedy Park and the aquatic center." },
      { item:"Finance Director Response to Public Comment", body:"Finance Director Jessica responded to the public comment, explaining that the village cannot borrow for additional firefighters - only for capital projects like the Kennedy Park turf. She noted public works is understaffed and referenced complaints about snow removal during the recent blizzard. She stated the village is 'the cheapest' and 'most efficient' but 'can't do it anymore' without additional revenue." },
      { item:"Fire and EMS Blizzard Response", body:"The Fire Chief reported 28 calls for service during the recent blizzard. Some calls could not be responded to due to lack of staffing, requiring mutual aid requests. Crews got stuck three times but were able to self-recover. The Chief described it as 'very labor intensive' with crews running hard." },
      { item:"Public Works Blizzard Response", body:"Michael from Public Works reported 17-18 hour days during the blizzard. He credited equipment investments made about 10 years ago for helping manage the storm. The department's vac truck sold at auction for $352,000 - $100,000 more than expected. Trustee Maloney praised the crew, noting positive feedback from neighbors." },
      { item:"Ordinance 26-00006 - Speed Limits on Weston Avenue", body:"Significant debate occurred over speed limits on Weston Avenue. The Community Life and Public Safety Committee recommended 35 mph from Von Kennel to Ryan Street based on engineering design. Trustees Maloney and Jordan objected, comparing it unfavorably to other roads. The original motion failed 4-3 (Maloney, Jordan, and President voting no). A revised motion by Maloney to keep Von Kennel to Camp Phillips at 35 mph but restore Von Kennel to Highway J at 45 mph passed with Trustee Kerns as the only no vote." },
      ...
      { item:"April 2026 Referendum Update", body:"Administrator provided an update on referendum informational sessions. Two presentations have been completed with recordings available on the village website. Two remaining sessions on March 31st (4:30-6pm) and April 2nd (12-1:30pm) will be open house format for questions. The Fire Chief noted the sessions went well with good questions." },
      { item:"E-bike and Euro Ordinance", body:"The board discussed a proposed e-bike ordinance being developed through the MPO subcommittee. Motion to table until the county finalizes their process passed unanimously." },
      { item:"Parking Restrictions at Kennedy Park", body:"Motion to remove no parking restrictions on the west side of Alderson Street along Kennedy Park approved unanimously. The change accommodates farmers market parking and anticipated traffic impacts from roundabout construction this summer." },
      { item:"Intersection Signage at Community Center Drive and Birch Street", body:"Motion approved to change stop sign to yield sign, with a friendly amendment adding a stop sign for bicyclists coming off the pedestrian bridge. Trustee Huang raised safety concerns about cyclists traveling 15-20 mph off the bridge without any signage. The amended motion passed unanimously." },
      { item:"Baseball\/Softball Field Maintenance Agreement", body:"A 10-year agreement with youth baseball and softball organizations was approved unanimously. The lengthy term was justified to protect the village's investment at Kennedy Park and provide stability despite leadership changes on various boards." },
      ...
      { item:"Microsoft Teams for Communication", body:"Motion to approve using Microsoft Teams for trustee communication passed unanimously. A training session will be held when the new board is seated. Teams will replace text messaging between trustees." },
    ],
    publicComment: "Jim Pensel of 5002 Aerrol Street spoke about fire department funding. He praised SAFER staff after attending their inaugural citizen academy but criticized the board's referendum approach as short-sighted, noting it lacks a sunset date and won't address future cost increases. He urged the board to prioritize fire and EMS funding over amenities like artificial turf and the aquatic center, stating 'We have the money. You just need to have the courage to spend it where it actually matters.'",
    actionItems: [
      "Minutes from February 16th board meeting approved",
      "Ordinance 26-00004 rezoning 8905 Bert Street approved",
      "Ordinance 26-00005 rezoning 7105 Christensen Avenue approved",
      "Ordinance 26-00006 speed limits approved as amended - Von Kennel to Camp Phillips at 35 mph, Von Kennel to Highway J at 45 mph",
      "Resolution 2026-008 approving Hinter Springs Second Edition subdivision final plat approved",
      "E-bike ordinance discussion tabled pending county process completion",
      "Parking restrictions removed on west side of Alderson Street along Kennedy Park",
      "Yield sign to replace stop sign at Community Center Drive and Birch Street; stop sign added for bicyclists on bridge",
  ...
  },
  {
    ...
    isAgendaOnly: false,
    badge: "new",
    overview: "The Parks Committee approved selecting Rettler Corporation for the Mock Mueller Park master plan, discussed potential increases to park and recreation impact fees to align with neighboring communities, and reviewed the successful Yellow Banks kayak launch project which came in significantly under budget due to grant funding. The committee also discussed ice rink operations at Kennedy Park and potential future hockey facility improvements.",
    agenda: [
      { time:"0:00", item:"Call to order and Pledge of Allegiance" },
      { time:"0:30", item:"Roll call" },
      { time:"0:58", item:"Approval of minutes from February 23rd, 2026" },
      { time:"1:28", item:"Public comments" },
      { time:"6:18", item:"Review of parks and recreation impact fee discussion" },
      { time:"21:45", item:"Request for proposals for Mock Mueller Park master plan and budget estimates" },
      { time:"28:15", item:"Review of Yellow Banks kayak launch expenses" },
      { time:"34:30", item:"Components of operations for ice rink at Kennedy Park" },
      { time:"47:00", item:"Future items and next meeting date" },
      { time:"49:30", item:"Remarks from staff and committee members" },
    ...
    discussions: [
      ...
      { item:"Review of parks and recreation impact fees", body:"Jennifer presented information on park impact fees, noting the village currently charges $300 for single family units while neighboring communities charge $600-$900. A 2020 study recommended fees of $761 for single family but the village only raised fees from $244 to $300 in 2022. Committee members expressed support for a moderate increase to align with neighboring communities like Kronenwetter ($603) and Rib Mountain ($650). Katrina stated she would support the moderate increase bracket. The committee provided feedback that plan commission should keep fees consistent with neighbors while remaining competitive, with no formal action taken as plan commission will make the final decision." },
      { item:"Request for proposals for Mock Mueller Park master plan", body:"Seven proposals were received for the park master plan, reviewed by four staff members. Discussion focused on the two lowest bidders - JSD and Rettler Corporation - which had similar pricing and relevant experience. Roger made a motion to select Rettler Corporation, seconded by Katrina. The motion passed unanimously. Staff noted Rettler has done the village's comprehensive plan and most recent master plans including Kennedy Park." },
      { item:"Review of Yellow Banks kayak launch expenses", body:"Jessica prepared a detailed breakdown of the kayak launch project expenses and grant funding. The project had unforeseen costs including poor subgrade conditions and discovery of an unknown well casing. Multiple grants were obtained through efforts by Jessica and Dan Higginbotham, with Marathon County Transportation covering the full expense for ADA accessibility components. Committee member Katrina praised the RFC as 'awesome' and thanked staff for their grant writing work. The committee discussed recognizing Dan Higginbotham's contributions, noting he will return to the committee with signage proposals for the Great Pineries Heritage Waterway." },
      { item:"Ice rink operations at Kennedy Park", body:"Staff presented information requested by committee member Katrina regarding ice rink operations. The warming house has been unattended since 2020 due to COVID and subsequent staffing recruitment difficulties. Everest Youth Hockey has expressed interest in potential improvements including a roofed structure to extend the ice season, and has provided cost estimates. Staff noted ongoing discussions about Marathon Park's hockey facilities may increase demand for Kennedy Park's ice. Katrina stated she wants to ensure hockey is not forgotten amid baseball-focused Kennedy Park discussions. The committee requested staff bring back attendance numbers from 2018-19 seasons and user feedback for future discussion." },
    ],
    publicComment: "Jim Pinsel of Pencil Street spoke expressing frustration about not receiving responses to questions submitted at the previous meeting regarding playground equipment installation issues and Kennedy Park updates. He criticized the ice rink cost analysis as incomplete, arguing true costs including staff hours are closer to $20,000-$30,000 rather than the stated $1,320.98. Lisa Beck of 1808 Cortez Lane thanked Michael for snow removal work during the recent blizzard and praised Sean and Jessica for the well-written Yellow Banks RFC. A written response to Jim Benson regarding an email from the previous month was also submitted and will be included in the minutes.",
    actionItems: [
      ...
      "Staff to compile ice rink attendance data from 2018-19 seasons and user feedback for future committee discussion",
      "Dan Higginbotham to return to committee with Great Pineries Heritage Waterway signage proposals",
  ...
  },
  {
    ...
    discussions: [
      ...
      { item:"Consideration of February 18, 2026 Regular Plan Commission Minutes", body:"The minutes from the February 18, 2026 Regular Plan Commission meeting were approved. The motion passed." },
      { item:"Public Hearing: Conditional Use Permit for 218 South 4th Street (Dunwoody Storage)", body:"A public hearing was held regarding a Conditional Use Permit to authorize construction of a Personal Storage Facility in the Light Industrial Zoning District. No vote was recorded as this was a public hearing item." },
      { item:"Conditional Use Permit for 731 N 1st Street (Beacon Resources, LLC)", body:"The commission approved a Conditional Use Permit for a 70-unit, 7-story apartment building at 731 N 1st Street. The motion passed." },
      { item:"Transportation Project Plat for Project 370-40-40", body:"The commission approved the Transportation Project Plat for Grand Avenue signal replacements at Sturgeon Eddy Road and Townline Road. The motion passed." },
    ],
    ...
    actionItems: [
      ...
      "Public hearing completed for Dunwoody Storage Conditional Use Permit at 218 South 4th Street",
    ],
    civicItems: [
  ...
  },
  {
    ...
    isAgendaOnly: false,
    badge: "new",
    overview: "The Wausau Board of Public Works awarded the 2026 Asphalt Paving Project 'A' contract to RC Pavers, LLC for $824,146.34. The board passed all items on the brief one-item agenda.",
    agenda: [
      { time:"N\/A", item:"Open bids and make recommendation for 2026 Asphalt Paving Project 'A'" },
    ],
    discussions: [
      { item:"2026 Asphalt Paving Project 'A' Bid Award", body:"The board opened bids and voted to award the contract for the 2026 Asphalt Paving Project 'A' to RC Pavers, LLC in the amount of $824,146.34. The motion passed." },
    ],
  ...
  },
  {
    ...
    isAgendaOnly: false,
    badge: "new",
    overview: "The Wausau Public Health and Safety Committee approved all action items including license applications, a new solid waste disposal code, repeal of the hand-held mobile device ordinance, and a solar energy partnership. Minutes were approved 3-0, and discussion items included the Fire Department's 2025 annual report and tavern activities.",
    agenda: [
    ...
    discussions: [
      { item:"Consideration of the minutes of the preceding meeting(s)", body:"The February 16, 2026 meeting minutes were approved 3-0. Sarah Watson moved to approve, seconded by Lou Larson. Lisa Rasmussen, Lou Larson, and Sarah Watson all voted yes." },
      { item:"Approval or denial of various license applications", body:"The committee approved a parklet permit and approved licenses as indicated by staff with the exception of Theodore Davis. Both votes passed, though specific vote counts were not recorded." },
      { item:"Repealing and recreating Wausau Municipal Code Chapter 6.44 Solid Waste Disposal", body:"The committee approved the new solid waste disposal provision, repealing and recreating Chapter 6.44 of the Municipal Code. The motion passed." },
      { item:"Repealing Wausau Municipal Code Section 10.01.012 Use of Hand-Held Mobile Telephones and Mobile Electronic Devices While Driving Prohibited", body:"The committee voted to repeal the city's hand-held mobile phone ordinance. The motion passed." },
      { item:"Approving Memorandum of Understanding with Midwest Renewable Energy Association", body:"The committee approved the MOU to partner with MREA for the Grow Solar Central Wisconsin Group Buy Program. The motion passed." },
    ...
    actionItems: [
      ...
      "New Wausau Municipal Code Chapter 6.44 Solid Waste Disposal takes effect",
      "Municipal Code Section 10.01.012 regarding hand-held mobile devices while driving repealed",
  ...
  },
  {
    ...
    isAgendaOnly: false,
    badge: "new",
    overview: "The Wausau Finance Committee denied a claim for recovery of unlawful tax for Green Acres at Greenwood Hills, LLC and postponed several items including the National Opioid Settlement Agreement and Water Works budget amendment to the next meeting. The committee approved multiple airport ground lease transactions, a budget carryover amendment, and the 2026 General Obligation Promissory Note for Capital Improvements.",
    agenda: [
      { time:"N\/A", item:"Public comment on agenda items" },
    ...
    discussions: [
      { item:"March 10, 2026 Regular Finance Committee Minutes", body:"The minutes from the March 10, 2026 meeting were approved 4-0. Sarah Watson moved to approve and Aaron Griner seconded the motion." },
      { item:"Alleged Claim for Recovery of Unlawful Tax for Green Acres at Greenwood Hills, LLC - Outlot 1", body:"The committee denied the claim for recovery of unlawful tax. The motion to approve failed, though specific vote counts were not recorded." },
      ...
      { item:"Six Remnant Defendants National Opioid Settlement Agreement", body:"The committee voted to postpone consideration of the National Opioid Settlement Agreement to the next scheduled meeting. The motion to postpone passed." },
      { item:"Budget amendment for Wausau Water Works Lead Service Line Replacement", body:"The committee voted to postpone consideration of this budget amendment to the next meeting. The motion to postpone passed." },
      ...
      { item:"Review of 2025 Motor Pool Fund financial results and related budget amendment", body:"This item was on the agenda for review. No vote action was recorded in the official records." },
      { item:"2026 General Obligation Promissory Note for Capital Improvements", body:"The committee approved the 2026 General Obligation Promissory Note for Capital Improvements to the calendar. The motion passed." },
    ...
    actionItems: [
      "Tax claim for Green Acres at Greenwood Hills, LLC - Outlot 1 denied",
      "Three airport ground lease transactions at 939 Woods Place approved (title transfer consent, lease termination with Wynn O. Jones, new lease with Owen Jones)",
  ...
  },
  {
    ...
    isAgendaOnly: true,
    badge: "new",
    overview: "Based on the published agenda, the Marathon County Board Education Meeting Part 1 was scheduled for March 19, 2026. This appears to be an educational session for county board members, though specific agenda details were not provided in the available documentation.",
    agenda: [
      { time:"N\/A", item:"County Board Education Session Part 1" },
    ],
    discussions: [
      { item:"County Board Education Session", body:"This meeting was scheduled as an educational session for Marathon County Board members. The specific topics and presentations were set to be covered as part of ongoing board member training and development." },
    ],
    publicComment: "Not indicated on agenda.",
    actionItems: [
      "Educational session scheduled - no formal action items indicated on available agenda documentation",
    ],
  },
  {
    ...
    isAgendaOnly: true,
    badge: "new",
    overview: "Based on the published agenda, this Marathon County Board Education Meeting Part 3 was scheduled as a continuation of board member education sessions. The meeting agenda packet was published but specific agenda items were not detailed in the provided text, suggesting this was part of an ongoing educational series for county board members.",
    agenda: [
      { time:"N\/A", item:"Board Education Session Part 3" },
    ],
    discussions: [
      { item:"Board Education Session Part 3", body:"This meeting was scheduled as the third part of an education series for Marathon County Board members. The session was expected to continue board member training and orientation on county governance matters." },
    ],
    publicComment: "Not indicated on agenda.",
    actionItems: [
      "Board members were scheduled to participate in continuing education session",
    ],
  },
  {
    ...
    isAgendaOnly: true,
    badge: "new",
    overview: "Based on the published agenda, the Marathon County HR, Finance, and Property Committee was scheduled to meet on 3\/24\/26. The specific agenda items were not provided in the source document, which only contained a link to the full meeting packet on the Marathon County website.",
    agenda: [
      { time:"N\/A", item:"Agenda details not available - only packet link provided" },
    ],
    discussions: [
      { item:"Meeting Packet", body:"The full agenda and supporting documents were scheduled to be available via the Marathon County website. Specific discussion items cannot be determined from the provided source, which contained only a link to the meeting packet." },
    ],
    publicComment: "Not indicated on agenda.",
    actionItems: [
      "Unable to determine from provided source - agenda document contained only a link to the full meeting packet",
    ],
  },
  {
    ...
    isAgendaOnly: true,
    badge: "new",
    overview: "Based on the published agenda, the Marathon County Executive Committee was scheduled to meet on March 24, 2026. Without access to the detailed agenda document, the specific items scheduled for discussion cannot be determined from the available information.",
    agenda: [
      { time:"N\/A", item:"Agenda details not available - document link provided but content not accessible" },
    ],
    discussions: [
      { item:"Meeting Agenda Items", body:"The specific discussion items were scheduled to be addressed as outlined in the Marathon County agenda packet. The detailed agenda document was published at the county website but the content is not available for review in this context." },
    ],
    publicComment: "Not indicated on agenda.",
    actionItems: [
      "Specific action items were expected to be outlined in the full agenda packet available at the Marathon County website",
    ],
  },
  {
    ...
    isAgendaOnly: true,
    badge: "new",
    overview: "Based on the published agenda, this Marathon County Executive Committee meeting (Part 2) was scheduled for March 24, 2026. The specific agenda items were not available in the provided document, limiting detailed reporting on scheduled business items.",
    agenda: [
      { time:"N\/A", item:"Agenda details not available in provided document - full agenda packet available at county website" },
    ],
    discussions: [
      { item:"Meeting Business", body:"The Executive Committee was scheduled to convene for Part 2 of their meeting. Specific discussion items were not available in the provided agenda text, though the full agenda packet is available through the Marathon County website." },
    ],
    publicComment: "Not indicated on agenda.",
    actionItems: [
      "Specific action items not available - refer to full agenda packet at marathoncounty.gov",
    ],
  },
  {
    ...
    isAgendaOnly: true,
    badge: "new",
    overview: "Based on the published agenda, the Marathon County Board was scheduled to hold a regular meeting on March 24, 2026. The specific agenda items were not available in the provided document, as only a link to the full agenda packet was included.",
    agenda: [
      { time:"N\/A", item:"Agenda details not available - document contains only link to full agenda packet" },
    ],
    discussions: [
      { item:"Full Agenda", body:"The complete meeting agenda was scheduled to be available via the Marathon County website. Specific discussion items were not provided in the source document and would require accessing the linked agenda packet." },
    ],
    publicComment: "Not indicated on agenda.",
    actionItems: [
      "Unable to determine from provided document - full agenda packet available at linked URL",
    ],
  },
  {
  ...
  },
  {
    ...
    isAgendaOnly: true,
    badge: "new",
    overview: "This special meeting of the Wausau School District Board of Education was convened to conduct a student expulsion hearing in closed session. The board met to consider disciplinary action against a student under Wisconsin statutes governing pupil records and closed session requirements.",
    agenda: [
      { time:"0:00", item:"Call To Order" },
    ...
    discussions: [
      { item:"Closed Session - Pupil Expulsion Hearing", body:"The Board convened in closed session under Wisconsin Statutes to conduct a pupil expulsion hearing, with authority to deliberate privately at the conclusion. The Board retained the option to take action in closed session if necessary and could reconvene to open session to take further action before adjournment." },
    ],
    publicComment: "No public comment period was included on this agenda.",
    actionItems: [
