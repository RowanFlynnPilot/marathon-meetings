...
const MEETINGS = [
  {
    ...
    isAgendaOnly: false,
    badge: "new",
    overview: "The Wausau City Council approved a development agreement for the 11 Scott Street\/Waterside Place project in a 6-3 vote, which will convert a vacant 100,000 square foot building into 52 mid-priced residential units with TIF assistance. The council also recognized city employees for their response to a record 30.9-inch snowfall and presented a sustainability award to Kolbe and Kolbe Millwork for their solar energy initiatives.",
    agenda: [
      { time:"2:49", item:"Call to order and pledge of allegiance" },
      { time:"3:30", item:"Proclamation for Sarah Rafi Day (March 31st)" },
      { time:"7:00", item:"Mayoral citation recognizing DPW snow response team" },
      ...
      { time:"24:00", item:"Resolution approving 11 Scott Street development agreement" },
      { time:"36:00", item:"Resolution approving residential solid waste agreement with Harter's Fox Valley" },
      { time:"42:00", item:"Resolution approving settlement in David Holes vs. City of Wausau" },
    ],
    discussions: [
      { item:"11 Scott Street Development Agreement", body:"The council approved the development agreement and amended parking agreement for 11 Scott Street LLC's Waterside Place project in a 6-3 vote. Alder Rasmusson spoke in support, noting it would return the building to taxable status and add downtown residents. Alder Neil outlined benefits including $55,000 annual parking revenue, helping TID 8 reach valuation goals, and filling mid-range housing gaps. Alder Larson was the primary dissenting voice, expressing concern about discounting city parking assets during budget cuts. Alder Tierney questioned the city's ability to provide 150 alternative parking spaces within 300 yards if the ramp closes; Economic Development Director Randy Feifer explained this reduces an existing obligation from 480 to 150 spaces under a 2062 agreement." },
      { item:"DPW Snow Response Recognition", body:"Mayor Denny presented a mayoral citation to the Department of Public Works for their response to the record 30.9-inch snowfall from March 14-16, 2026. Kevin Kester accepted the award and praised the plow operators and mechanics, stating 'you kicked its ass' regarding the storm response. Fleet technicians worked 12-hour shifts providing 24-hour breakdown support, and by Friday would have worked 12 straight days without a day off." },
      { item:"Sustainability Award to Kolbe and Kolbe", body:"Christine Daniels from the Sustainability, Energy and Environment Committee presented the 2026 City of Wausau Sustainability Award to Kolbe and Kolbe Millwork. Representatives Mike Thompson and Keith Kaning accepted, describing their over 2,000 solar panels installed in July that generate enough power for 120 homes and have exceeded expectations. They also highlighted LED lighting upgrades, high-efficiency air compressors, and recycling initiatives for wood, aluminum, glass, and vinyl manufacturing materials." },
      { item:"Solid Waste Service Agreement", body:"The council approved the residential solid waste and recycling service agreement with Harter's Fox Valley Disposal for a corrected seven-year term (not ten years as previously misstated). Passed 9-0." },
      { item:"Settlement Resolution - David Holes vs. City of Wausau", body:"Assistant City Attorney Vincent Bonito explained this involves a 2022 bus accident where Transit Mutual (insurer) paid the city's claim, and now the other party's insurer agreed to pay damages. The resolution releases the city's counter claim and third-party complaint. Alder Neil clarified this is separate from the individual's ongoing personal injury claim. Passed 8-1 without need for closed session." },
    ],
    publicComment: "Two speakers addressed the council. Raleigh Lray spoke in support of the 11 Scott Street project, describing it as a green sustainable repurposing project offering mid-priced apartments. Mark Craig, from 3246 North 8th Street, joined to emphasize the project's difficulty at over $10 million for a 100,000 square foot building with $8.3 million for 52 residential units, stating 'Without your help, it won't happen.'",
    actionItems: [
      "11 Scott Street development agreement and amended parking agreement approved - project to proceed",
      ...
      "Settlement approved in David Holes vs. City of Wausau case",
  ...
  },
  {
    ...
    isAgendaOnly: false,
    badge: "new",
    overview: "The Wausau Plan Commission approved two major items: a conditional use permit for a 70-unit, 7-story apartment building at 731 North First Street for Beacon Resources LLC, and a transportation project plat for signal replacements at Grand Avenue, Sturgeon, and Townline Road. The commission also heard public comment supporting the downtown apartment development and from applicants seeking a storage facility permit.",
    agenda: [
      ...
      { time:"0:55", item:"Consideration of minutes from February 18th meeting" },
    ...
    discussions: [
      { item:"Minutes from February 18th", body:"Motion to approve made by Bugamin with a second from Balkan. The minutes passed unanimously with no discussion." },
      { item:"Public hearing on conditional use permit for 218 South Fourth Street (personal storage facility)", body:"Jason Dunwy and Melinda Don Woody spoke in support of the storage facility, noting that downtown Wausau has added over 400 new apartment units recently including the 153-unit Foundry on Third and 102-unit Evergreen Landing project. They argued apartment residents need storage options and this would keep spending in Wausau rather than surrounding areas like Kronenwetter. The public hearing was closed but no vote was taken on this item during the meeting." },
      { item:"Conditional use permit for 731 North First Street (70-unit, 7-story apartment building)", body:"Motion to approve made by Bornman with a second from Bugamin. There were no questions or comments from commissioners. The motion passed unanimously to approve the conditional use permit for Beacon Resources LLC." },
      { item:"Transportation project plat for Grand Avenue signal replacements at Sturgeon and Townline Road", body:"Motion to approve made by Bugamin with a second from Balkan. No discussion occurred and the motion passed unanimously." },
    ],
    publicComment: "One written public comment was submitted by Linda Lawrence on March 12th supporting the apartment development proposal, stating 'Housing of this capacity will be good for downtown small businesses' and that she would personally live at the location. Jason Dunwy and Melinda Don Woody spoke in person during the storage facility public hearing in support of the project.",
    actionItems: [
      "Approved conditional use permit for 731 North First Street 70-unit, 7-story apartment building for Beacon Resources LLC",
  ...
  },
  {
    ...
    isAgendaOnly: false,
    badge: "new",
    overview: "The Marathon County Board held an educational meeting featuring presentations on PFAS contamination litigation opportunities and county authority over renewable energy projects. No votes were taken as this was an informational session; the board heard from attorneys about joining multi-district litigation to recover costs from PFAS manufacturers and learned about options for regulating wind and solar projects proposed in the county.",
    agenda: [
      ...
      { time:"50:02", item:"Discussion of PFAS litigation scope and costs" },
      { time:"1:01:00", item:"Presentation on renewable energy regulatory authority" },
      { time:"1:10:01", item:"Overview of Hub City Wind Project and other proposed projects" },
      { time:"1:20:02", item:"Discussion of PSC process and county preemption" },
      { time:"1:30:01", item:"County options for renewable energy project engagement" },
      { time:"1:40:00", item:"Joint Development Agreement considerations" },
    ],
    discussions: [
      { item:"Public Comment", body:"Five residents spoke during public comment. Cindy Nelson from Stratford reported visiting 200 homes and finding unanimous opposition to proposed wind turbines, stating setbacks are only 1,250 feet from her property. Wendy Rowski from Green Valley urged the board to vote no on the comprehensive plan, arguing industrial energy facilities should not be called 'farms.' Barb Newton from Rib Mountain reiterated support for speed reduction on Double N Road, noting 75 residents signed a petition. Heidi Pesky from Town of McMillan warned against Joint Development Agreements, listing concerns including 30-50 year commitments, liability issues, and inadequate decommissioning bonds. Cindy Hogan supported the Double N Road speed reduction petition." },
      { item:"PFAS Multi-District Litigation Presentation", body:"Attorney Carrie McDougall from Baron and Budd Law Firm explained the nationwide PFAS litigation, noting his firm serves as co-lead counsel in the MDL consolidated in Charleston, SC before Judge Richard Gergel. He described the $12-13 billion settlement with 3M and $3-5 billion from DuPont for water provider claims, emphasizing that soil-based claims including airports, landfills, and wastewater are excluded and still available. The arrangement is a 25% contingency fee with no upfront costs to the county. Supervisor Robinson asked about land spreading impacts; attorneys clarified claims are against original chemical manufacturers only, not spreaders. Vice Chair Dickinson noted the airport has no known PFAS contamination currently. Supervisor Mash confirmed the compensation structure involves 25% contingency plus expense reimbursement only upon recovery." },
      { item:"Renewable Energy Regulatory Authority Presentation", body:"Attorney Rebecca Roker from Atollis Law explained that PSC jurisdiction preempts local control for projects over 100 megawatts. She noted the Hub City Wind Project from Alliant Energy has no CPCN application filed yet with PSC, and the EDP Marathon Wind project was purchased as part of Hub City, explaining why that litigation was dismissed. Roker stated PSC has approved 33 solar projects with zero denials. She outlined county options: do nothing, negotiate a Joint Development Agreement, intervene in PSC proceedings, or litigate. She strongly recommended JDAs as the most effective tool to protect county interests regarding liability, roads, decommissioning, emergency response training, and other impacts not otherwise available under state law." },
    ],
    publicComment: "Five speakers addressed the board. Cindy Nelson (Stratford) reported canvassing 200 homes finding no support for wind turbines and concerns about 1,250-foot setbacks. Wendy Rowski (Green Valley) urged voting no on the comprehensive plan and requested industrial energy facilities not be called 'farms.' Barb Newton and Cindy Hogan (Rib Mountain) supported speed reduction and no-passing zone on Double N Road, citing 75 petition signatures and near-collision incidents. Heidi Pesky (Town of McMillan) warned against Joint Development Agreements, listing concerns about liability, decommissioning costs, and long-term commitments.",
    actionItems: [
      ...
      "County to identify potential PFAS exposure sites including airport, landfill, and wastewater for due diligence testing",
      "Board to consider options for engaging with proposed Hub City Wind Project before CPCN application is filed with PSC",
    ],
  },
  {
  ...
  },
  {
    ...
    isAgendaOnly: false,
    badge: "new",
    overview: "The Wausau Board of Public Works approved a construction contract for the 26th Street\/North 8th Avenue project to the lowest bidder Switlick for approximately $1.28 million, and approved a change order and pay estimate for the Randolph Street\/Cherry Street construction project. All items passed unanimously.",
    agenda: [
      { time:"0:01", item:"Call to order" },
      { time:"0:01", item:"Consideration of March 10th Board of Public Works minutes" },
      { time:"0:18", item:"Open bids for 26th Street Construction Project B, North 8th Avenue" },
      { time:"1:43", item:"Open bids for additional project (postponed)" },
    ...
    discussions: [
      { item:"March 10th Board of Public Works Minutes", body:"The minutes from the March 10th meeting were approved. A motion was made and seconded, passing unanimously with all ayes." },
      { item:"26th Street Construction Project B, North 8th Avenue - Bid Opening", body:"Seven bids were opened and read aloud. Switlick submitted the lowest bid at $1,279,089.75, narrowly beating Haas at $1,280,877.96. Other bidders included A1 ($1,374,600), Francis Melvin ($1,385,383), Steen ($1,489,126), James Peterson ($1,570,698.56), and Earth ($1,686,078.75). A board member noted the 'tight bids' between the top two. A motion to approve Switlick passed unanimously." },
      { item:"2025 Street Construction Project A - Change Order 1", body:"Staff presented four items totaling $14,436.50 for unforeseen conditions: an inside drop on a manhole ($4,856) due to an unrecorded large diameter sanitary service; water main adjustment ($2,317.50) after discovering 6-inch pipe instead of expected 8-inch; miscellaneous storm sewer tie-ins ($5,016 at $66 per lineal foot); and geogrid installation ($2,247) for approximately 750 square yards near Thomas Jefferson Elementary due to poor soil conditions. Change Order 2 regarding liquidated damages was postponed pending further discussions. Motion to approve passed unanimously." },
      { item:"2025 Street Construction Project A - Pay Estimate Number 9", body:"Staff recommended approval of pay estimate number nine for work completed through year end in the amount of $535,114.02. Motion to approve passed unanimously." },
    ...
    publicComment: "No public comment was offered.",
    actionItems: [
      "Switlick awarded 26th Street Construction Project B contract at $1,279,089.75",
      "Change Order 1 for Randolph Street\/Cherry Street project approved at $14,436.50",
      "Pay Estimate #9 approved for $535,114.02 for Randolph Street\/Cherry Street project",
      "Portland Cement Concrete License approved for KSK Incorporated",
      "Change Order 2 and liquidated damages discussion for Randolph Street project to return at future meeting",
      "One bid opening postponed due to extended deadline",
    ],
    civicItems: [
  ...
  },
  {
    ...
    isAgendaOnly: false,
    badge: "new",
    overview: "The Finance and Human Resources Committee debated and ultimately approved a modified employee clothing allowance policy after canceling the Cintas uniform contract. Following multiple failed votes on $600 and $400 annual allowances, the committee approved $500 annually starting 2027 ($400 for remainder of 2026) plus a one-time washer\/dryer purchase. The committee also received an extensive presentation on public works operations and budget.",
    agenda: [
      { time:"0:01", item:"Call to order and Pledge of Allegiance" },
      { time:"2:15", item:"Public comments" },
      { time:"3:45", item:"Approval of minutes from February 16, 2026" },
      { time:"4:15", item:"Acknowledge February 2026 financial reports" },
      { time:"4:45", item:"Acknowledge T1 and T2 detail reports for February" },
      { time:"5:00", item:"Acknowledge legal details for February" },
      { time:"5:15", item:"Educational presentation: Public Works operations and budget" },
    ...
    discussions: [
      { item:"Public Comments", body:"Lisa Beck of 1808 Cortez Lane spoke during public comment. She praised Mike for public works efforts during the recent storm. She also expressed concern about the proposed employee clothing allowance increase, questioning whether the village should approve the highest proposed amount ($600) given the Cintas contract cancellation was meant to save money." },
      { item:"Approval of Minutes and Financial Reports", body:"Minutes from February 16, 2026 were approved with motion by Steve, second by Stephanie, passed unanimously. February financial reports, T1 and T2 detail reports, and legal details were all acknowledged with unanimous votes." },
      { item:"Public Works Operations and Budget Presentation", body:"Public Works Director Michael delivered an extensive presentation covering the department's infrastructure (119.5 centerline miles of road, 114 miles of water main, 103 miles of sanitary sewer, 70 miles of storm sewer). He noted the 2026 budget decreased 1.1% ($26,000) from 2025. The village spends approximately $9,700 less per mile than average central Wisconsin communities. He discussed the March 15 storm event which cost approximately $50,000 and may qualify for disaster relief through the county. Staff worked up to 17.5 hours during that event. The department has 10 full-time members (was 11 in 2010) with a new employee starting Wednesday." },
      { item:"Employee Clothing and Equipment Allowance Policy", body:"This item generated significant debate. Committee member Daniels argued against the $600 increase, citing fiscal responsibility and the upcoming fire department referendum. She noted the village provides more clothing items than comparable municipalities. Michael defended the increase, emphasizing employee value, retention concerns, and that transportation aids are tied to street spending. Initial motion for $600 failed 2-3 (Daniels yes, Armain no, My yes, Olsson no, Satai no). Motion for $400 failed 2-3. Motion for $500 with washer\/dryer failed 2-3. Final motion by Stephanie for $400 remainder of 2026, $500 annually starting 2027, plus one-time washer\/dryer purchase passed with one opposed." },
    ],
    publicComment: "Lisa Beck of 1808 Cortez Lane offered public comment praising Mike for public works storm response and questioning the proposed employee clothing allowance increase, suggesting the village should consider a lesser amount rather than the highest proposed $600.",
    actionItems: [
      ...
      "Submit disaster relief documentation to county\/state for March storm event costs",
  ...
  },
  {
    ...
    isAgendaOnly: false,
    badge: "new",
    overview: "The Wausau Public Health and Safety Committee approved a parklet permit for West Cider Diner and Lounge after the owner presented detailed plans, approved multiple license applications and summer events, and repealed outdated municipal codes regarding solid waste and cell phone use while driving. The committee also heard updates on the transition of the homeless shelter from WMC to Bridge Street Mission, expected to complete around April 20th.",
    agenda: [
      { time:"0:00", item:"Call to order and roll call" },
      { time:"0:23", item:"Public comment on agenda items" },
      { time:"0:50", item:"Approval of minutes from February 16th, 2026" },
      { time:"1:20", item:"License applications - West Cider Diner parklet permit" },
      { time:"10:25", item:"License denial recommendations - Theodore Davis and Joanna Gregory" },
      { time:"18:45", item:"Batch approval of licenses and summer events" },
      { time:"20:01", item:"Repealing and recreating solid waste disposal ordinance" },
      { time:"21:05", item:"Repealing handheld mobile phone ordinance" },
      { time:"22:40", item:"Grow Solar Central Wisconsin Group buy program MOU" },
      { time:"25:30", item:"Fire Department 2025 annual report" },
      { time:"32:15", item:"Tavern activities report - February 2026" },
      { time:"36:30", item:"Community outreach update and shelter transition" },
    ],
    discussions: [
      { item:"West Cider Diner Parklet Permit", body:"Owner Tyler Voigt presented detailed plans for a parklet extending 4 feet into the street and 4 feet onto the 11-foot sidewalk at 628 North Third Avenue. He explained it would be lit, decorated with flowers and flags, and positioned 75 feet from the corner for safety. Alder Larson noted he was initially against it but changed his mind after seeing the layout. The permit was approved unanimously with Watson making the motion and Larson seconding. Voigt was asked to report back in November on how the summer trial went." },
      { item:"License Denial - Theodore Davis", body:"Theodore Davis appeared regarding his bartender license denial recommendation, explaining he made a mistake 20 years ago as a minor that has followed him his whole life. He stated he has completed therapy and registry requirements and wants to work at Emerald Nightclub. His boyfriend Matthew Prieb also spoke in support, describing Davis as a loving person who has not reoffended. Deputy Chief Baiton indicated he was unfamiliar with rehabilitation documents Davis had submitted to Chief Barnes. The committee voted to hold the matter until the next meeting to allow Chief Barnes to review the evidence of rehabilitation and provide an updated recommendation." },
      { item:"License Denial - Joanna Gregory", body:"Joanna Gregory did not appear for her denial hearing. Her denial was included in the batch motion that passed." },
      { item:"Batch License Approvals", body:"The committee approved multiple items including summer events (Wings over Wausau, Concerts on the Square, Chalkfest, Memorial Day parade, Hope on the Block, Jazz on the River) and new\/transfer licenses for Oasis Arcade, Whiskey River Bar and Grill rebranding, and Hayawa new ownership. The liquor license review subcommittee had unanimously recommended approval for all three establishment applications. Motion by Larson, second by Watson, passed unanimously." },
      { item:"Solid Waste Disposal Ordinance", body:"The committee approved repealing and recreating Wausau Municipal Code Chapter 6.44 to comply with state-level changes. Assistant City Attorney Vinnie Bonino was present for questions. Motion by Larson, second by Watson, passed unanimously." },
      { item:"Handheld Mobile Phone Ordinance Repeal", body:"The committee repealed the local cell phone ban ordinance as state traffic laws have matured to cover the same regulations, making the local ordinance redundant. Attorney Bonino confirmed the inattentive driving statute now regulates cell phone usage. Motion by Watson, second by Larson, passed unanimously." },
      { item:"Grow Solar Program MOU", body:"The committee approved the memorandum of understanding with Midwest Renewable Energy (MREA) for a group solar purchasing program. Carrie from planning noted the sustainability committee unanimously recommended it on March 5th. Alder Sarah, who has solar on her house, praised the partnership with MREA as beneficial for homeowners navigating the complex process. Motion by Watson, second by Larson, passed unanimously." },
      { item:"Fire Department Annual Report", body:"Fire Chief presented the 2025 annual report showing over 7,200 calls averaging 20 per day. He announced the city has been confirmed as ISO Class 2 status as of that Friday, valid for four years. The chief mentioned three upcoming informational sessions on March 31st, April 1st at Station 2 at 5pm, and April 3rd at Station 1 regarding the upcoming April 7th referendum. The report was placed on file." },
      { item:"Shelter Transition Update", body:"Tracy Durante reported 415 unduplicated guests since the WMC shelter opened and over 740 volunteer hours in February. James Torensson, new Director of Homeless Services at Bridge Street Mission, explained the shelter transition is expected around April 20th, pending contractor confirmation on April 1st. The WMC contract with First United Methodist Church has been extended through April 19th to ensure no gap in service. Catholic Charities reported 99 unduplicated guests at their shelter since November 1st. The committee expressed interest in touring the new facility at the ribbon cutting ceremony." },
    ],
    publicComment: "One public commenter, Carrie Mor Everest of 1025 Everest Boulevard, spoke at the end of the meeting regarding concerns about how emergency services treat unhoused individuals at the shelter. She stated she has volunteered at the shelter for 10 months and witnessed multiple 911 calls where she felt people were not treated ethically or professionally. She expressed frustration that her complaints over 10 months have not been addressed and was recently told to bring complaints to the Police and Fire Commission. The chair thanked her and noted the formal process exists through the Police and Fire Commission for such matters.",
    actionItems: [
      "Approved parklet permit for West Cider Diner and Lounge at 628 North Third Avenue for summer 2026 trial",
      ...
      "Approved all summer event permits and new\/transfer liquor licenses as recommended",
      ...
      "Tyler Voigt to report back in November 2026 on parklet operations",
      "Committee to tour Bridge Street Mission shelter at ribbon cutting ceremony",
      "Staff to investigate Trace Armanos status and whether Days points were omitted from tavern report",
    ],
    civicItems: [
  ...
  },
  {
    ...
    isAgendaOnly: false,
    badge: "new",
    overview: "The Village of Weston Board of Trustees approved multiple ordinances including rezonings and a modified speed limit ordinance for Weston Avenue, with the board rejecting the 35 mph limit from Von Kennel to Highway J in favor of keeping it at 45 mph. The board also approved a 10-year baseball\/softball field maintenance agreement, deferred action on a remote meeting attendance policy to the next meeting, and heard passionate public comment criticizing the board's approach to fire department funding through a referendum rather than budget prioritization.",
    agenda: [
      { time:"0:01", item:"Call to order and Pledge of Allegiance" },
      ...
      { time:"5:01", item:"Reports from boards, committees, commissions and departments" },
      { time:"20:02", item:"Ordinances - Rezonings and speed limit amendments" },
      { time:"30:01", item:"Resolution for Hinter Springs Second Edition subdivision final plat" },
      ...
      { time:"50:00", item:"Eagle Scout project and handbook remote meeting policy" },
      { time:"55:02", item:"Utility engineering contracts and sewer software" },
      { time:"1:05:01", item:"Trustee remarks and adjournment" },
    ],
    discussions: [
      { item:"Public Comment on Fire Department Funding", body:"Jim Pensel of 5002 Aerrol Street spoke critically about the board's approach to fire department funding. He praised SAFER staff after attending their citizen academy but criticized the referendum approach, noting it has no sunset date and the $600,000 levy increase won't be adequate by 2037. He urged the board to prioritize fire\/EMS funding over 'wants' like artificial turf at Kennedy Park and the aquatic center, stating 'We have the money. You just need to have the courage to spend it where it actually matters.'" },
      { item:"Finance Director Response to Public Comment", body:"Finance Director Jessica responded that the village cannot borrow for additional firefighters - the turf at Kennedy Park was funded through approved borrowing, but operating revenue is needed for staffing, hence the referendum. She noted that even public works is understaffed, citing complaints about snow removal during the recent storm despite 17-18 hour days. She stated emotionally that 'maybe in a couple months my position will be open' and that naysayers don't acknowledge staff efforts." },
      { item:"Speed Limit Ordinance 26-006", body:"The original ordinance to set Weston Avenue at 35 mph from Von Kennel to Camp Phillips and Ryan to Jay at 45 mph failed on a 4-3 vote, with Maloney, Jordan, and the president voting no. Trustee Maloney argued the road from Von Kennel to Ryan should remain 45 mph due to sparse driveways compared to Scoffield Avenue. A subsequent motion by Maloney to keep Von Kennel to Jay at 45 mph while setting Von Kennel to Camp Phillips at 35 mph passed, with Trustee Kern voting no." },
      { item:"Intersection Signage at Community Center Drive and Birch Street", body:"The Community Life and Public Safety Committee recommended changing the stop sign to a yield sign. Trustee Hooang raised concerns about bicyclists coming off the pedestrian bridge at 15-20 mph with no signage. The motion was amended to add a stop sign for bicyclists at the bridge landing. The amended motion passed unanimously." },
      { item:"Baseball\/Softball Field Maintenance Agreement", body:"The board approved a 10-year agreement with youth baseball and softball organizations. The committee recommended the lengthy term to protect the village's investment at Kennedy Park, noting that youth organizations could otherwise pull out after one year. The agreement formalizes existing arrangements and specifies that the village determines when fields can be used." },
      ...
      { item:"Microsoft Teams for Communication", body:"The board approved using Microsoft Teams for trustee communication starting with the next term, which would eliminate text messaging between trustees. A training session will be held for the new board." },
      { item:"E-bike and Euro Ordinance", body:"Trustee Zagami, who serves on the MPO bike\/ped subcommittee, provided an update on the draft ordinance being developed by multiple communities. The board voted to table the item until the county finalizes their process." },
    ],
    publicComment: "Jim Pensel of 5002 Aerrol Street spoke for approximately 4 minutes criticizing the board's approach to fire department funding. He praised SAFER staff after attending their inaugural citizen academy but argued the referendum approach is 'short-sighted' since it has no sunset date. He urged the board to prioritize fire and EMS funding over discretionary spending like artificial turf and the aquatic center.",
    actionItems: [
      "Approved minutes from February 16th meeting unanimously",
      "Approved rezoning of 8905 Bert Street from RR5 to SFS zoning district",
      "Approved rezoning of 7105 Christensen Avenue from SL to SFS zoning district",
      "Approved speed limit ordinance 26-006 as amended: Von Kennel to Camp Phillips at 35 mph, Von Kennel to Highway J remains at 45 mph",
      "Approved final plat for Hinter Springs Second Edition subdivision",
      ...
      "Approved changing stop sign to yield sign at Community Center Drive\/Birch Street with addition of bicycle stop sign at bridge landing",
      ...
      "Deferred handbook remote meeting attendance policy to next meeting for new board consideration",
  ...
  },
  {
    ...
    isAgendaOnly: false,
    badge: "new",
    overview: "The Marathon County Board of Supervisors adopted the 2026 Comprehensive Plan with 10 amendments addressing renewable energy terminology, data centers, AI\/automation, and energy policy. The board also approved salaries for elected officials, authorized phase 2 design for a new highway facility, approved PFAS litigation, and ratified an emergency declaration for the recent blizzard event.",
    agenda: [
      ...
      { time:"1:20:01", item:"Resolution establishing salaries for elected officials (R-12-26)" },
      { time:"1:21:00", item:"Highway facility phase 2 design services (R-13-26)" },
      { time:"1:25:01", item:"PFAS litigation authorization (R-14-26)" },
      { time:"1:30:01", item:"Emergency declaration ratification (R-22-26)" },
      { time:"1:35:00", item:"Administrator performance evaluation" },
      { time:"1:40:00", item:"Announcements and adjournment" },
    ],
    discussions: [
      { item:"Comprehensive Plan 2026 Adoption", body:"Administrator Leonard presented 10 proposed amendments compiled from supervisor feedback. Amendments 1-4 addressed livability standards and renewable energy terminology changes (changing 'renewable energy farms' to 'energy systems'). Amendment 5 added language on data centers and battery storage. Supervisor Crawl requested separating amendments 2-4 for individual votes, which passed. Vice Chair Dickinson explained the energy terminology changes were to address large-scale wind and solar installations. Amendments 2, 3, and 4 each passed but not unanimously. Amendment 9, proposed by Supervisor Sindellski promoting coal, natural gas, and nuclear, was amended by Supervisor Boots to read 'promote coal and natural gas until a long-term sustainable and reliable energy source can be found that does not adversely affect agricultural land.' Supervisor Robinson opposed citing no such thing as 'clean coal.' Supervisor Rosenberg, who worked at Weston Power Plant, also opposed saying coal is dirty and the wording 'smacks of politics.' The amended version passed but not unanimously. A late amendment by Supervisor Sindellski regarding utility-scale wind\/solar as industrial uses was debated but defeated after Supervisor Jeang attempted to refer it to committee. The final comprehensive plan as amended passed but not unanimously." },
      { item:"Salaries for Elected Officials (R-12-26)", body:"Resolution establishing salaries for clerk of courts, sheriff, and elected department heads for upcoming term. Motion by Supervisor Conway, second by Supervisor Rosenberg. Passed with no discussion." },
      { item:"Highway Facility Phase 2 Design (R-13-26)", body:"Supervisor Soyber requested future information on plans for the old facility. Chair Gibbs noted the HR Finance and Property Committee would address this years down the road. Supervisor Sindellski asked about the $53 million cost estimate but was informed that amount was not part of this vote. Motion by Supervisor Robinson, second by Supervisor V. Passed unanimously." },
      { item:"PFAS Litigation Authorization (R-14-26)", body:"Resolution authorizing outside counsel on contingency basis for PFAS lawsuits. Two amendments were adopted: Supervisor Robinson's amendment directing the county administrator to evaluate past and present practices that may have resulted in PFAS release or exposure (passed unanimously), and Vice Chair Dickinson's amendment modifying language regarding airport property and historical use (passed unanimously). The resolution as amended passed unanimously." },
      { item:"Emergency Declaration Ratification (R-22-26)", body:"Administrator Leonard explained the ratification preserves opportunity for reimbursement after the governor's emergency declaration expired during the blizzard. He praised staff across facilities, parks, forestry, highway, sheriff's office, and airport who worked 12-16 hour shifts during the event, with over 600 hours of call-in time in 24 hours for facilities and parks alone. Supervisor Fifer, as infrastructure committee chair, echoed thanks for staff efforts during the 'unprecedented' event. Passed unanimously." },
      { item:"Administrator Performance Evaluation", body:"Chair Gibbs explained the executive committee finalized the administrator's evaluation based on board input from the previous Thursday meeting with no wording changes. The board could go into closed session but chose not to. Supervisor Robinson moved to accept the executive committee's recommendation on salary and performance evaluation. Passed unanimously." },
    ],
    publicComment: "No public comment was offered.",
    actionItems: [
      "Comprehensive Plan 2026 adopted with 10 amendments effective immediately",
      "County administrator directed to evaluate past and present PFAS practices and exposure risks",
      ...
      "Administrator salary and evaluation finalized per executive committee recommendation",
      "Departing supervisors (Crawl, Fifick, Marshall, Rosenberg, Hardinger, V, Reynolds) to turn in iPads after final official meetings",
  ...
  },
  {
    ...
    isAgendaOnly: false,
    badge: "new",
    overview: "The Parks Committee approved minutes, selected Rettler Corporation for the Mock Mueller Park master plan ($24,350), and discussed increasing park impact fees to align with neighboring communities. The committee also reviewed Yellow Banks kayak launch expenses showing significant grant funding success and received an update on Kennedy Park ice rink operations.",
    agenda: [
      ...
      { time:"50:00", item:"Future items and remarks from staff and committee members" },
      { time:"53:00", item:"Adjournment" },
    ],
    discussions: [
      { item:"Approval of minutes", body:"Minutes from February 23rd, 2026 meeting were approved. A motion was made and seconded, passing unanimously with no discussion." },
      { item:"Parks and recreation impact fee discussion", body:"Jennifer presented information on park impact fees, noting the current $300 single-family fee is significantly below neighboring communities (Kronenwetter at $603, Rothschild at $4,000 base, Rib Mountain at $650). The 2020 study recommended $761 but fees were only raised from $244 to $300. Committee members expressed support for a moderate increase to align with neighbors. Katrina stated she would be 'more in the moderate increase bracket instead of the maximum.' No formal action was taken; information will go to Plan Commission." },
      { item:"Mock Mueller Park master plan RFP selection", body:"Seven proposals were received for the park master plan. Staff reviewed and rated proposals based on firm experience, personnel, similar projects, scope understanding, and cost. The two lowest bids were JSD and Rettler Corporation, both with prior village experience. Roger made a motion to select Rettler Corporation, seconded by Katrina. Motion passed unanimously." },
      { item:"Yellow Banks kayak launch expenses review", body:"Jessica presented a comprehensive expense report for the kayak launch project. The project received significant grant funding from DNR, Marathon County Transportation, and others, substantially reducing village out-of-pocket costs. Lisa Beck during public comment praised the RFC as 'super well written.' Katrina commended staff and suggested formal recognition for Dan Higginbotham who donated site planning work. MTS also donated time for site plans, and PGA provided labor discounts. No formal action taken; informational only." },
      { item:"Kennedy Park ice rink operations", body:"Discussion initiated by committee member Katrina to ensure hockey interests aren't forgotten amid Kennedy Park baseball focus. Staff reported Everest Youth Hockey remains interested in improvements including a potential covered structure. The warming house has been unattended since 2020 due to COVID and subsequent staffing challenges. Staff will bring back historical attendance figures from 2018-19 seasons and labor hour costs for future discussion. No action taken." },
    ],
    publicComment: "Jim Pinsel (Street not specified) expressed frustration about receiving no response to his previous three-page submission regarding playground equipment installation issues and Kennedy Park fundraising transparency. He criticized the ice rink cost analysis as incomplete, arguing true costs including labor are closer to $20,000-$30,000 rather than the stated $1,320.98. Lisa Beck (1808 Cortez Lane) thanked Michael for snow removal during the recent blizzard and praised Sean and Jessica for the well-written Yellow Banks RFC. A written response to Jim Pinsel's previous email was submitted and will be included in the minutes.",
    actionItems: [
      "Rettler Corporation selected for Mock Mueller Park master plan at $24,350",
      "Jennifer to present park impact fee comparison data to Plan Commission next month",
      "Staff to compile historical ice rink attendance data from 2018-19 seasons",
      "Staff to calculate labor hour costs for ice rink operations",
  ...
  },
  {
    ...
    isAgendaOnly: false,
    badge: "new",
    overview: "The Wausau Finance Committee approved several airport ground lease transfers, denied a tax recovery claim related to ongoing Greenwood Hills litigation, and postponed decisions on joining a national opioid settlement and a lead service line budget amendment pending more information. The committee also approved budget carryover funds and transfers to cover shortfalls in recycling, airport, and parking funds.",
    agenda: [
      { time:"2:01", item:"Call to order and public comment" },
      { time:"2:25", item:"Approval of March 10, 2026 minutes" },
      { time:"2:48", item:"Tax recovery claim for Green Acres at Greenwood Hills LLC" },
      ...
      { time:"4:28", item:"Approving airport ground lease with Owen Jones" },
      ...
      { time:"47:00", item:"Approving 2026 general obligation promissory note" },
      { time:"54:30", item:"Considering purchase of properties for DPW Streets Division" },
    ],
    discussions: [
      { item:"Approval of March 10, 2026 minutes", body:"Alder Watson moved to approve the minutes, seconded by Alder Griner. The motion passed unanimously." },
      { item:"Tax recovery claim for Green Acres at Greenwood Hills LLC", body:"This claim is part of ongoing litigation with Greenwood Hills. The chair explained that a no vote would deny the claim. Alder Watson moved to approve, seconded by Griner. The motion failed with opposition votes, effectively denying the tax recovery claim." },
      { item:"Airport ground lease transfers at 939 Woods Place", body:"Three related items transferred a hangar from Win O. Jones to Owen Jones. The committee approved consent to transfer title (Watson motion, Griner second), terminated the existing lease with Win O. Jones (Tierney motion, Watson second), and approved a new lease with Owen Jones (Watson motion, Tierney second). All three passed unanimously." },
      ...
      { item:"National opioid settlement agreement", body:"Committee members expressed discomfort proceeding without more information. Alder Maloney asked where the request came from, and Assistant Attorney Vincent explained law firms identify potential class members and send notices. Alder Tierney and others said they weren't comfortable signing away future legal remedies without understanding the details. Alder Griner moved to postpone to the next meeting, seconded by Tierney. Motion passed unanimously, with the deadline for participation being May 4th." },
      { item:"Lead service line replacement budget amendment", body:"Public Works Director Eric explained the DNR unexpectedly limited subsidized loan eligibility, leaving $709,672 unfunded - $283,868 for private\/homeowner side and $425,803 for utility side. Finance Director Marian outlined options including borrowing, using general fund reserves, or PFAS settlement money. Alder Tierney opposed adding debt given current levels. Discussion included potentially using PFAS settlement funds, but members agreed broader discussion is needed before spending those funds. Alder Watson moved to postpone, seconded by Griner. Motion passed unanimously." },
      { item:"Budget amendment for 2025-2026 carryover funds", body:"The Finance Director noted large items include 10 transit buses funded by VW mitigation grants and various airport projects with grant funding. Some projects like city hall chimney liner, public safety roof, and DPW fence haven't started yet. Alder Watson moved to approve, seconded by Griner. Motion passed unanimously." },
      { item:"2025 motorpool fund financial results", body:"The Finance Director reported the motorpool fund continues to struggle with cash flow. After adjustments including GMT money transfer, there would be a $150,000 net profit, but a $177,000 cash shortfall when outstanding purchase orders are paid. ARPA savings and sale proceeds from auctioned vehicles should cover this shortfall. Solomon from MotorPool explained two dump trucks ordered in 2023 are waiting for spreader upfits and should arrive shortly. This was an informational item with no action required." },
      { item:"2025 general fund financial results", body:"The Finance Director reported a $1.2 million surplus driven by strong building permits, unexpected GMT money, and higher investment income. Expenditures were $320,000 over budget primarily due to full-year motorpool charges to public works, fire, and police departments. CCITC was also over budget by $194,000 due to communication issues about software subscriptions and a duplicate 95% personnel budget adjustment. After proposed transfers to recycling, airport, and parking funds, a $540,000 surplus remains. Alder Tierney moved to approve the transfers, seconded by Watson. Motion passed unanimously." },
      { item:"2026 general obligation promissory note", body:"The Finance Director presented the borrowing calendar for 2026 capital improvements including street projects, motorpool, and TID district items. The city's debt utilization will decrease slightly even with this issuance - about $12 million retiring versus $10 million in new borrowing. Alder Watson moved to approve the calendar, the chair seconded. Motion passed unanimously. Phil Cawson from Ehlers will present parameters at the next meeting." },
      { item:"Purchase of properties for DPW Streets Division", body:"Properties at 108 Adolf Street, 112 Adolf Street, 112½ Adolf Street, and 233 Myron Street were scheduled for closed session discussion. Due to time constraints with council starting at 6:30 and the Maple Room being under construction, Alder Watson moved to postpone to the next meeting, noting time is not of the essence. Seconded by Tierney, passed unanimously." },
    ],
    publicComment: "No public comment was offered.",
    actionItems: [
      "Tax recovery claim for Green Acres at Greenwood Hills LLC denied",
      "Airport ground lease transfers at 939 Woods Place approved - title transfer, lease termination with Win O. Jones, and new lease with Owen Jones",
      "Airport ground lease with Cole Lundberg approved",
      "Opioid settlement participation postponed to next meeting for more information",
      "Lead service line budget amendment postponed to next meeting for further discussion on funding options",
      "Budget carryover funds from 2025 to 2026 approved",
      "Transfers to recycling, airport, and parking funds from general fund approved",
      "2026 general obligation promissory note calendar approved; parameters resolution to come at next meeting with Ehlers representative",
      "Property purchase discussion for DPW Streets Division postponed to next meeting",
    ],
    civicItems: [
      { number:"1", name:"Public comment on agenda items and reading of the City of Wausau Public Comment Statement.", votes:[], docs:[], children:[] },
  ...
  },
  {
    ...
    isAgendaOnly: false,
    badge: "new",
    overview: "The Marathon County Executive Committee met briefly before entering closed session to discuss the performance review of the county administrator. The committee voted unanimously to go into closed session, with all members voting in favor.",
    agenda: [
      { time:"0:00", item:"Call to order and Pledge of Allegiance" },
      { time:"0:32", item:"Performance review of the administrator (Item 3A1)" },
    ],
    discussions: [
      { item:"Performance review of the administrator", body:"The chair explained that the committee had the opportunity to go into closed session to discuss the final review of the county administrator, incorporating feedback received from the board the previous Thursday. The chair noted that executive committee members had rated the administrator on various questions using three criteria: needs improvement, successful, and exceptional, with scores averaged on a 0-5 scale. Corporation counsel was asked to provide a summary of the appraisal. A motion was made and seconded to enter closed session, and the roll call vote passed unanimously with all members (Gibbs, Dickinson, Arstead, Boots, Drebeck, Fifick, Mask, Ritter, Morash, and Robinson) voting aye." },
    ],
    publicComment: "No public comment was offered.",
    actionItems: [
  ...
  },
  {
    ...
    agenda: [
      ...
      { time:"2:18", item:"Revised property values for public auction" },
      { time:"5:00", item:"Resolution to approve carry forward funds" },
      { time:"11:27", item:"Resolution to amend capital assets threshold policy" },
    ...
    discussions: [
      ...
      { item:"Revised property values for public auction", body:"Staff reported two parcels had failed to sell twice on Wisconsin Surplus with bids not reaching appraised value. Requested revised minimum sale prices of $9,000 for 529 Mullen Street and $7,500 for 738 South 3rd Avenue. Chair Gibbs made the motion to approve. One bidder who made an error was marked as non-pay and barred from future auctions, described as a rare occurrence. Motion carried unanimously." },
      { item:"Resolution to approve carry forward funds", body:"Finance Director Sam presented Resolution R20-2026 for program revenues and multi-year project funds to carry forward to 2026. Notable items included veterans relief fund replenishment (estimated three years of funding), redacted records fees for Register of Deeds, and $142,731 for administration special projects including $75,000 for homelessness contract. Vice Chair Marshall inquired about redacted records fund usage. Chair Gibbs moved to approve; Supervisor Hart seconded. Motion carried unanimously." },
      { item:"Resolution to amend capital assets threshold policy", body:"Finance Director Sam explained the proposal to increase the capital asset threshold from $5,000 to $10,000, following GFOA guidance from 2006. This change had been considered in 2022 but not completed. Supervisor Hart moved to approve and forward to full county board; Chair Gibbs seconded. Motion carried unanimously." },
      { item:"Introduction of healthcare consultants - National Insurance Services", body:"HR Director Candace introduced National Insurance Services (NIS), selected through RFP for healthcare consulting. Account Executive with 28 years experience and Account Manager Jordan Stanley presented their team and approach. They discussed evaluating the county's near-site ATA clinic, funding model options (fully insured vs self-insured), pharmacy benefit management, and strategies to reduce emergency room usage through Teladoc virtual care. Vice Chair Marshall asked about per-member costs compared to other employers and ER utilization strategies. Chair Gibbs inquired about evaluation processes for insurance models and risk tolerance considerations." },
      { item:"Audited 2025 year-end fiscal update", body:"Finance Director Sam provided detailed department-by-department review of 2025 fiscal year, noting various transfers, reclassifications, and carryovers still being processed. Key items included: county treasurer received $257,238 TID closure check from City of Wausau and $222,752 in unclaimed property; opioid fund has $2.2 million cash with $3.49 million in future settlements expected; ARPA funds nearly exhausted with $800,000+ interest to be moved. Sam noted capital asset reconciliation still in progress before final fund balance surplus can be determined." },
      { item:"2026 year-to-date fiscal update", body:"Sam reported 2026 is progressing as expected with some reclassifications needed. First quarter closeout scheduled for May 31st, then monthly closeouts thereafter with two-month lag to ensure accurate reporting. Reports will be provided to standing committees regularly." },
      { item:"Finance Department quarterly update", body:"Sam reported welcoming a new financial analyst for payroll, reaching full staff since mid-December. Accomplishments included quarterly closeouts with departments, countywide training on reports, uniform practices, random cash audits (all successful), and extensive W-2 processing including overtime calculations under the 'big beautiful bill.' Administrator Lance Leonhard praised Sam and her team for their work on year-end processing and noted upcoming recommendation to increase the $400,000 social services reserve account due to rising correctional care and child protection placement costs." },
      { item:"County Treasurer quarterly update", body:"Treasurer Connie reported on tax collections, delinquent parcel monitoring, eviction hearings, and year-end procedures. 1,582 delinquent tax notices were mailed (down from 1,786 last year). Staff discussed challenges with municipal treasurer receiving errors affecting lottery credits and tax payments. Supervisor Lemmer asked about poverty trends; Connie explained payment agreements were discontinued due to high default rates and that residents are directed to family help, loans, or veterans services. Administrator clarified evictions referenced are county tax deed process-related, not general evictions." },
    ],
    publicComment: "No public comment was offered.",
    actionItems: [
      ...
      "Finance to provide update on fund balance surplus at next meeting",
      "NIS consultants to provide healthcare cost analysis before budget assumption development in early summer",
      "Finance Director to research Register of Deeds redacted records fund history and potential repurposing",
      "Recommendation forthcoming to increase social services reserve account above current $400,000",
      "Training planned with Transcendent\/Ascent for municipal treasurers on tax receiving and lottery credits",
  ...
  },
  {
    ...
    isAgendaOnly: true,
    badge: "new",
    overview: "Based on the published agenda, the Wausau School District Board of Education Committee of the Whole meeting was scheduled to address several significant items including a referendum budget update, new facility fee schedules for artificial fields, and an extensive NEOLA policy update covering over 60 policies. The board was expected to consider action on the Wisconsin School Nutrition Purchasing Cooperative membership renewal and policy revisions including new artificial intelligence guidelines and Act 57-related child welfare policies.",
    agenda: [
    ...
    discussions: [
      { item:"Excellence in Action: Stettin Elementary", body:"The board was scheduled to recognize Stettin Elementary as part of the district's Excellence in Action series, which typically highlights achievements and programs at individual schools." },
      { item:"Wisconsin School Nutrition Purchasing Cooperative Agreement (WiSNP)", body:"The district's Nutrition Service Department was scheduled to present a resolution for continued membership in the Wisconsin School Nutrition Purchasing Cooperative for the 2026-2027 school year. The presentation was estimated at 5 minutes, with action requested for board approval of the cooperative agreement." },
      { item:"Facility Fees", body:"Ryan Urmanski, Director of Buildings and Grounds, was scheduled to present information to amend the current Wausau School District Facility Use Fee Schedule. The 10-minute presentation was expected to address costs for use of artificial fields and field lighting for requested events, with the board asked to approve immediate implementation if agreed upon." },
      { item:"Referendum Budget Update", body:"Elizabeth Channel, Interim Assistant Superintendent of Operations, was scheduled to share a 10-minute update on the status of the Referendum Budget. The update memo was uploaded the day before the meeting, suggesting timely financial information for board members." },
      { item:"NEOLA UPDATE - General Policies", body:"The committee was scheduled to review an extensive 20-minute NEOLA policy update covering numerous policies ranging from board definitions and orientation to cell phone policies, artificial intelligence guidelines, third grade promotion requirements, and debt management. Notable policies included updates to Policy 5136 on cell phones and personal communication devices, Policy 7540.08 on Artificial Intelligence, and Policy 2131.01 on Reading Instructional Goals and Kindergarten Assessment." },
      { item:"NEOLA UPDATE - School Support Organization Related Policies", body:"The board was scheduled to review policies related to school support organizations including student fund-raising, crowdfunding, accountability and oversight of fundraising activities, gifts and bequests, and relations with non-school affiliated groups. These policies were expected to provide updated guidelines for booster clubs and parent organizations." },
      { item:"NEOLA UPDATE - Technical Corrections", body:"The committee was scheduled to review 18 policies requiring technical corrections, including policies on video surveillance, crisis intervention, school safety, threats of violence, and administration of medication. These updates were described as minor technical adjustments rather than substantive changes." },
      { item:"NEOLA UPDATE - Act 57 Related Policies", body:"The board was scheduled to review four policies related to Wisconsin Act 57, including Student Supervision and Welfare policies for administrators, professional staff, and support staff (Policies 1213, 3213, 4213), as well as Policy 8462 on Child Abuse and Neglect. These updates appeared to address mandatory reporting and child protection requirements." },
    ],
    ...
    actionItems: [
      ...
      "Action was requested on the comprehensive NEOLA policy update covering general policies, school support organization policies, technical corrections, and Act 57 related policies",
    ],
  }
];
