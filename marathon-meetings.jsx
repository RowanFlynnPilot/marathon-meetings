...
const MEETINGS = [
  {
    ...
    date: "May 24, 2026", shortDate: "MAY 24",
    committee: "Public Works and Utility Committee", duration: "~1h",
    url: "https://www.youtube.com/watch?v=j64Gj2ean2k",
    docUrl: null,
    isAgendaOnly: false,
    badge: "new",
    overview: "The Village of Weston Public Works Committee met on May 11, 2026, approving minutes and reports, awarding a $126,900 recycled asphalt crushing contract to King Gravel, and recommending board approval for construction agreements related to Military Road and water\/sewer connections. The committee also directed staff to develop enforcement language for sanitary sewer discharge violations at $100\/day fines.",
    agenda: [
      { time:"0:09", item:"Call to order" },
      { time:"0:25", item:"Pledge of Allegiance" },
      ...
      { time:"19:55", item:"Street operations update" },
      { time:"29:45", item:"Utility operations update" },
      { time:"41:15", item:"Review 2025 Weston Water Utility PSC annual report" },
      { time:"48:05", item:"Resolution 2026-014 transportation funding" },
      { time:"51:05", item:"Recycled base course production" },
      { time:"55:15", item:"Sanitary sewer discharge violation discussion" },
      { time:"1:11:20", item:"Water and sewer connection agreement for Radkkey Avenue duplex" },
      { time:"1:17:05", item:"Military Road construction agreement" },
      { time:"1:22:15", item:"Construction service proposals for Alderson\/Jelnik and Bladel projects" },
    ],
    discussions: [
      { item:"CIP Update", body:"Michael reported the village received a Local Road Improvement Grant for Birch Street reconstruction between Schofield Avenue and Community Center Drive, originally a 2029 project that will likely move to 2028. The grant covers over 50% of the estimated $1.5 million project. Michael noted the village has secured over $9 million in grant funding in the past 4-5 years. Discussion also covered Weston Avenue repairs by Integrity Grading and Excavating for road settlement issues, and upcoming Schofield Avenue manhole repairs by HOS Construction." },
      { item:"Approval of Minutes and Permits", body:"Motion to approve April 13, 2026 meeting minutes passed unanimously. Motion to acknowledge April 2026 water and sewer permits passed unanimously." },
      { item:"Street Operations Update", body:"Staff reported road limits were removed April 29th along with Marathon County. Activities included mailbox\/sign repairs, dewatering operations near Weston Avenue tributary for about a week, spring curb sweeping, hot mix patching, storm damage cleanup from East Nick area, inlet repairs on Birch, and signing installation on Schofield Avenue. Culvert failures on Jones Street required installing a third 18-inch culvert. Shop repairs included seasonal equipment changeover from winter to summer operations." },
      { item:"Utility Operations Update", body:"Josh reported on a service repair at Caribou Coffee, well maintenance, and significant clear water infiltration issues. April data showed 37 million gallons pumped into the system but 53-54 million gallons treated at wastewater facility, indicating approximately 15 million gallons of clear water infiltration. Staff identified sump pump discharges into sanitary sewers as a major contributor. The in-pipe technologies INI study will help identify problem areas. Water main flushing notices going out with work starting next week." },
      { item:"2025 Water Utility PSC Annual Report", body:"Michael presented the annual report showing net operating income of $482,911 for 2025, consistent with 2024's $490,000. Water loss was 6%. Utility value reached nearly $34 million, up 6.7% due to infrastructure additions including Wells 7 and 8, and water main from Weston Avenue project. The utility serves 6,100 customers total: 5,250 in Weston, 830 in Rothschild, and 5 in other areas. Motion to acknowledge passed unanimously." },
      { item:"Resolution 2026-014 Transportation Funding", body:"Michael explained this League of Wisconsin Municipalities sample resolution supports long-term transportation funding solutions, noting the village has decreased public works budgets recently and needs state support beyond one-time grants. Wisconsin remains affordable compared to neighboring states for automobile ownership. Motion to recommend board adoption passed unanimously." },
      { item:"Recycled Base Course Production", body:"King Gravel was low bidder at $4.23\/ton for crushing recycled asphalt at the Ryan Street site, with estimated 30,000 tons totaling $126,900. Michael noted savings of approximately $11\/cubic yard compared to City of Wausau costs, translating to about $130,000 savings across three 2026 projects. Motion to award contract to King Gravel passed unanimously." },
      { item:"Sanitary Sewer Discharge Violations", body:"Committee discussed enforcement of ordinance violations for clear water discharge into sanitary sewers. Current code allows fines of $100-$1,000 per day. Committee members distinguished between unknowing violations (first offense with correction period) versus willful violations. After discussion, committee directed staff to create enforcement language starting at $100\/day for violations. Motion passed unanimously." },
      { item:"Radkkey Avenue Water\/Sewer Connection", body:"Michael requested approval for temporary water\/sewer connection for a new duplex at 2230 Radkkey Avenue via long lateral until Radkkey Avenue reconstruction. Committee added language requiring reconstruction no later than 2029 when permanent mains would be extended and assessed. Motion to recommend board approval with 2029 deadline passed unanimously." },
      { item:"Military Road Construction Agreement", body:"Agreement with Village of Rothschild for Military Road reconstruction from Wolfman Street to Helin Street, with Steam Construction as contractor. Weston's share for utility relocation (water main and sanitary sewer) estimated at $94,860. Motion to recommend board approval passed unanimously." },
      { item:"Construction Services Proposals", body:"Michael presented proposals for construction inspection services. For Alderson\/Jelnik intersection project, MSA proposed $37,315 versus Clark Dietz at $48,910; MSA recommended due to lower cost and roundabout design involvement. For Bladel Avenue, MSA proposed $70,400 versus Clark Dietz at $73,730; Clark Dietz recommended despite slightly higher cost due to full-time experienced staff versus MSA's summer intern. Motion to approve MSA for roundabout and Clark Dietz for Bladel passed unanimously." },
    ],
    ...
    actionItems: [
      ...
      "Recommend board adoption of Resolution 2026-014 supporting state transportation funding solutions",
      "Direct staff to create enforcement language for sanitary sewer discharge violations at $100\/day fine",
      "Recommend board approval of temporary water\/sewer connection agreement for 2230 Radkkey Avenue with Radkkey reconstruction deadline of 2029",
      "Recommend board approval of Military Road construction agreement with Rothschild for $94,860 utility costs",
      "Approve MSA for Alderson\/Jelnik construction services ($37,315) and Clark Dietz for Bladel Avenue ($73,730)",
      "Schedule special assessment meeting for Bladel Avenue project on Thursday, May 28, 2026 at 6:00 PM",
      "Staff to provide cost analysis of clear water infiltration impact for next meeting",
      "Norcon to begin Schofield Avenue concrete repairs starting Wednesday\/Thursday this week",
    ],
  },
  {
    ...
    isAgendaOnly: false,
    badge: "new",
    overview: "The Village of Weston Plan Commission approved the site plan for the new Mountain Bay Metropolitan Police Department and Municipal Court facility at 3600 Community Center Drive, and adopted a new salt storage shed inspection program for wellhead protection districts. The commission also approved April 2026 minutes, staff-approved survey maps, and building permits.",
    agenda: [
      { time:"0:01", item:"Call to order and roll call" },
      { time:"1:24", item:"Open public comment period" },
      { time:"5:00", item:"Approval of April 13, 2026 meeting minutes" },
      { time:"5:21", item:"Site plan review for Mountain Bay Metro Police Department and Municipal Court facility at 3600 Community Center Drive" },
      { time:"20:01", item:"Salt storage shed inspection program for wellhead protection district" },
      { time:"28:15", item:"April 2026 staff approved certified survey maps and site plans" },
      { time:"28:30", item:"April 2026 building permits" },
      { time:"28:45", item:"Planning and development department monthly project update report" },
      { time:"30:00", item:"Commissioner remarks" },
      { time:"32:30", item:"Future agenda items and adjournment" },
    ],
    discussions: [
      { item:"Mountain Bay Metro Police Department and Municipal Court Facility Site Plan", body:"Staff presented the site plan for the new police department and court facility on Community Center Drive. Chief Jeremy explained the building was rotated to face east due to a gas pipeline on the property, which reduced fill costs significantly. The building meets all B2 zoning requirements and landscaping codes. Discussion included questions about future expansion capability (possible to the north), placement of an alternate storage shed, and coordination with ANR regarding the gas pipeline. The motion to recommend approval to the Board of Trustees with staff conditions 2-5 passed unanimously." },
      { item:"Salt Storage Shed Inspection Program", body:"Staff proposed a new inspection program with two annual inspections per facility in wellhead protection districts - one in warm weather focusing on structural integrity and one in winter focusing on operations. A standardized inspection worksheet similar to DOT standards was developed. Staff noted one existing facility near Sternberg has never gone through the wellhead protection conditional use process and commissioners agreed staff should reach out to bring them into compliance. Motion to approve the program with reporting to both Plan Commission and Public Works passed unanimously." },
      ...
      { item:"April 2026 Staff Approved Survey Maps and Site Plans", body:"Motion to approve passed unanimously." },
      { item:"April 2026 Building Permits", body:"Motion to approve passed unanimously." },
      { item:"Planning Department Update and Future Items", body:"Staff announced the first joint Plan Commission\/Village Board steering committee meeting for the comprehensive plan is scheduled for Monday, June 1st at 5:00 p.m. Discussion occurred about residential TIF districts for workforce housing, with commissioners requesting Ehlers' presentation on qualifications be shared, possibly incorporated into comprehensive plan discussions." },
    ],
    publicComment: "Jim Pensel of 5002 Arrow Street, Weston, spoke via online connection. He urged the commission to exercise common sense on landscaping requirements for the police department project to avoid excessive taxpayer costs, similar to accommodations made for the Greenheck Turner building. He also requested the commission require annual reporting on the salt shed inspection program to ensure follow-through on compliance visits.",
    actionItems: [
      "Site plan for Mountain Bay Metro Police Department and Municipal Court facility at 3600 Community Center Drive recommended for Board of Trustees approval with staff conditions",
      "Salt storage shed inspection program adopted with twice-annual inspections in wellhead protection district",
      "Staff to report inspection findings to Plan Commission and Public Works Committee annually",
      "Staff to reach out to existing salt storage facility near Sternberg that hasn't gone through wellhead protection conditional use process",
      ...
      "Electric vehicle charging station discussion to be added to future agenda (likely fall)",
      "Staff to share Ehlers presentation on residential TIF district qualifications with commission",
    ],
  },
  {
    ...
    isAgendaOnly: false,
    badge: "new",
    overview: "The Marathon County Health & Human Services Committee held an introductory meeting for new board members, providing educational presentations on the Health Department, Social Services, Veteran Service Office, and Aging Disability Resource Center. The only action taken was approval of the April 1st meeting minutes. The meeting served primarily to orient new supervisors to department missions, budgets, and organizational structures.",
    agenda: [
      { time:"0:00", item:"Call to order and remote participation confirmation" },
      { time:"0:22", item:"Pledge of Allegiance" },
      { time:"0:55", item:"Approval of April 1st committee meeting minutes" },
      { time:"1:30", item:"Operational functions required by statute - none presented" },
      { time:"2:45", item:"Review of standing committee ordinance and jurisdiction" },
      { time:"6:13", item:"Educational presentation - Health Department overview" },
      { time:"20:00", item:"Health Department budget discussion" },
      { time:"25:04", item:"Social Services Department overview" },
      { time:"45:01", item:"Veteran Service Office presentation" },
    ...
    discussions: [
      ...
      { item:"Review of standing committee jurisdiction", body:"Administrator Lance Leonard explained the committee's structure under ordinance 2.04 sub5, including oversight of Veterans Service Department, Social Services, and Health Department, plus affiliated entities North Central Health Care and Aging Disability Resource Center. He outlined subordinate boards including the Social Services Board, Veteran Service Commission, Transportation Coordinating Committee, and Board of Health that may bring recommendations to the committee." },
      { item:"Health Department presentation", body:"Health Officer Caitlyn Suginaka presented department operations including 37.6 FTE staff across four divisions: environmental health, nursing, community health improvement, and administration. She highlighted over 1,200 licenses managed, Nurse Family Partnership program graduating its first two-year-olds, public health vending machines stocked with free resources including tick kits, and a new homeless system response position. Budget discussion noted approximately $5 million total with about half from tax levy and significant intergovernmental grant revenue." },
      { item:"Social Services Department overview", body:"Administrator Leonard presented on behalf of Director Christa who was absent, covering the department's 140 FTE staff working in child welfare, youth justice, children's long-term support, economic support, and child support. He highlighted the successful Family Keys housing stability pilot program addressing housing instability for child welfare cases. The department's 2026 budget shows over $22 million total revenue with approximately $7 million from tax levy." },
      { item:"Veteran Service Office presentation", body:"Veteran Service Officer Aaron Galindo reported the office now has 3.0 FTE and completed 8,149 interactions in 2025, up from 5,900 the prior year. He reported $44 million annually in VA benefits flowing to Marathon County veterans, with $2.6 million in retroactive payments in 2025. Galindo discussed suicide prevention efforts noting Marathon County had 30 suicides in 2025, seven of which were veterans, and announced partnership with Center for Veterans Issues for housing stability. Supervisor Kremes asked about regional coordination with neighboring counties." },
      { item:"Aging Disability Resource Center presentation", body:"Executive Director Mike Ray presented on the four-county ADRC serving Marathon, Lincoln, Langlade, and Wood counties with about 60 FTE and 385-400 volunteers. He described services including information assistance, caregiver support, dementia care, falls prevention, and Meals on Wheels nutrition program. Ray noted significant financial challenges with nutrition costs up 40-45% over four years while federal Older American Act funding remains flat. Marathon County's 2026 contribution is $413,135." },
    ],
    publicComment: "No public comment was offered.",
    actionItems: [
      "Minutes from April 1st meeting approved",
  ...
  },
  {
    ...
    isAgendaOnly: false,
    badge: "new",
    overview: "The Marathon County Board of Supervisors held an adjourned organizational meeting where they approved committee appointments, elected Supervisors Hapa and Arstead to at-large executive committee positions, and unanimously passed a resolution reducing landfill tipping fees for disaster debris from recent severe weather affecting Ringle and other communities. The board suspended its rules to address the emergency tipping fee modification, which reduces fees from $65\/ton to approximately $36.94\/ton for certified storm-related debris through June 17th.",
    agenda: [
      { time:"0:00", item:"Pledge of Allegiance and Silent Moment of Reflection" },
      { time:"0:30", item:"Reading of Notice and Roll Call" },
      { time:"5:01", item:"Committee Appointments (Item B7)" },
      { time:"10:01", item:"Election of At-Large Executive Committee Members (Item 9B)" },
      { time:"20:00", item:"Consent Agenda (Items C10-C14A)" },
      { time:"20:00", item:"Resolution 24-26: Out of Home Placement Reserve Increase (Item D15)" },
      { time:"25:01", item:"Resolution 25-26: Social Services Budget Amendment (Item D16)" },
      { time:"25:01", item:"Resolution 26-26: Landfill Tipping Fee Modification (Item E17)" },
      { time:"1:10:02", item:"Announcements and Requests (Item F18)" },
      { time:"1:10:02", item:"Adjournment (Item F19)" },
    ],
    discussions: [
      { item:"Committee Appointments", body:"Chair Gibbs explained the committee appointment process, noting goals included increasing diversity of perspectives, developing supervisor leadership, and honoring supervisor preferences. Vice Chair Boots assisted in developing appointments. Chair Gibbs emphasized that over 34% of the board is in first or second terms. Motion by Supervisor Cavelli, seconded by Supervisor Crims. The motion carried but was not unanimous." },
      { item:"Election of At-Large Executive Committee Members", body:"Three supervisors were nominated for two at-large executive committee positions: Supervisor Hapa (nominated by Supervisor Mask), Supervisor Leur (nominated by Supervisor Rosenberg), and Supervisor Arstead (nominated by Vice Chair Boots). Supervisor Rosenberg explained she nominated Supervisor Leur because she has advocated for the county's smallest children and oldest elders. Paper ballots were distributed and supervisors voted for two candidates. Supervisors Hapa and Arstead were elected to the executive committee." },
      { item:"Consent Agenda", body:"Items C10 through C14A were approved on consent. Motion by Supervisor Cavelli, seconded by Supervisor Drebeck. The motion carried unanimously." },
      { item:"Resolution 24-26: Out of Home Placement Reserve Increase", body:"Resolution from Health and Human Services Committee and Human Resources and Finance and Property Committee. Motion by Supervisor Morash, seconded by Supervisor Robinson. The motion carried but was not unanimous." },
      { item:"Resolution 25-26: Social Services Budget Amendment", body:"Motion by Supervisor P, seconded by Supervisor Robinson. The motion carried but was not unanimous." },
      { item:"Resolution 26-26: Landfill Tipping Fee Modification", body:"Administrator Leonard and Director Hagen Busher presented the emergency tipping fee reduction for disaster debris following severe weather affecting Ringle and other communities. The state declared an emergency allowing waiver of $13.10 state fee; Ringle is waiving its $2.33 fee. The solid waste management board proposed reducing the county rate to approximately $36.94\/ton (covering costs) from the standard $65\/ton gate rate. Supervisor Rosenberg requested public comment be allowed. Jessica Tolesie and Matt Haybeck spoke, requesting the county waive fees entirely and extend the timeframe to six months due to ongoing insurance delays. Multiple supervisors asked questions about the fee structure and timeline. The board first voted unanimously to suspend rules to bring the resolution forward, then voted unanimously to approve Resolution 26-26." },
    ],
    publicComment: "By special dispensation requested by Supervisor Rosenberg, two residents were allowed to speak on the landfill tipping fee resolution. Jessica Tolesie asked Marathon County to completely waive its fees like other entities have done, noting businesses have donated up to $40,000 in cleanup efforts and requesting a six-month timeframe. Matt Haybeck spoke on behalf of homeowners needing house demolitions, noting 44 homes are affected and many insurance adjusters haven't yet arrived, requesting more time for the fee waiver.",
    actionItems: [
      ...
      "Resolution 26-26 approved reducing landfill tipping fees for certified disaster debris through June 17th",
      "Administrator to continue discussions with Community Foundation regarding reimbursement mechanism for uninsured debris disposal costs",
      "Solid waste management board to develop long-term policy for handling similar disaster situations within six months",
      "Staff to track certified disaster-related debris and apply reduced fee structure",
    ],
  },
  {
    ...
    isAgendaOnly: false,
    badge: "new",
    overview: "The Marathon County Environmental Resources Committee approved two rezoning petitions and voted to forward a modified fee waiver resolution to the county board that would waive only reconnect fees for properties damaged by the April 17, 2026 tornado. The committee also received educational presentations from Solid Waste, Parks Recreation and Forestry, and Conservation Planning and Zoning departments.",
    agenda: [
      ...
      { time:"13:45", item:"Public hearing: Jeffrey and Cynthia Schmidtz rezoning petition (conservancy recreation to general agriculture) - Town of McMillan" },
      { time:"19:30", item:"Consideration of fee waiver for properties impacted by April 17, 2026 severe weather" },
      { time:"55:00", item:"Educational presentation: Solid Waste Department overview" },
      { time:"1:15:02", item:"Educational presentation: Parks, Recreation, and Forestry Department overview" },
    ...
    discussions: [
      ...
      { item:"Tim Veland rezoning petition - Town of Green Valley", body:"Land use specialist Garrett Pogle presented the staff report for rezoning from urban residential and general agriculture to rural residential for a land division. The Town of Green Valley recommended approval on March 10, 2026. No public testimony was offered for or against. Supervisor Drebeck moved to approve based on findings of fact, conclusions of law, and town approval. Supervisor Kurt seconded. Motion carried unanimously." },
      { item:"Jeffrey and Cynthia Schmidtz rezoning petition - Town of McMillan", body:"Garrett Pogle presented the petition to rezone from conservancy recreation to general agriculture. Supervisor Leur asked about the conservancy nature; staff explained the property has a home and horse riding stable, and rezoning would make the non-conforming home use conforming. No natural areas would be lost. Town of McMillan recommended approval on April 20, 2026. No public testimony was offered. Supervisor Sefeld moved to approve, Supervisor Drew seconded. Motion carried unanimously." },
      { item:"Fee waiver for properties impacted by April 17, 2026 severe weather", body:"Director Lori Mskimmons presented staff recommendation to waive county zoning and pouts fees for tornado-damaged properties. Significant debate ensued. Supervisor Drew questioned where to draw the line for future events. Supervisor Drebeck expressed concern about fairness to those not in declared disaster areas. Supervisor Leur asked about tracking costs. Eric Vogel questioned if homeowners insurance would cover fees. Supervisor Sefeld moved to forward the resolution; Supervisor Lam seconded. Supervisor Drebeck then moved to amend the resolution to only waive reconnect fees ($160) for pouts systems, not other fees. Supervisor K seconded the amendment. The amendment passed, and the amended resolution was approved to forward to county board, though not unanimously." },
      { item:"Solid Waste Department presentation", body:"Director David Hagenbusher provided overview of operations including the landfill serving Marathon, Portage, and Shawano counties, accepting about 1,000 tons daily. He discussed the renewable natural gas partnership with Vidi Energy generating royalties, significant capital expenses of $4-6 million for expansions and closures, and the requirement by 2032 to install on-site leachate treatment for PFAS removal. Marilyn Bend praised the department for keeping private landfill costs in check." },
      { item:"Parks, Recreation, and Forestry Department presentation", body:"Tom Lovelin, county forest administrator, presented on behalf of Director Jamie who had an emergency. He explained the joint city-county operation with 44 full-time and 120 seasonal staff managing 17 county parks, 30,700 acres of county forest, and city of Wausau parks and street trees. A Nine Mile study showed out-of-town visitors generate $3.25 million annually. Supervisor Sefeld announced Tom's retirement effective June 1st after nearly 30 years, with Joe Tucker selected as successor." },
    ],
    publicComment: "No public comment was offered.",
    actionItems: [
      "Rezoning for James Offer and David Tract property approved - forwarded to Marathon County Board of Supervisors",
      "Rezoning for Jeffrey and Cynthia Schmidtz property approved - forwarded to Marathon County Board of Supervisors",
      "Modified fee waiver resolution (reconnect fees only) forwarded to Marathon County Board of Supervisors for tornado-damaged properties",
      "Staff to track costs and requests related to tornado fee waivers for future policy development",
      "Solid Waste to reapply for clean water fund loan by October 2025 for on-site leachate treatment facility",
    ],
  },
  {
    ...
    isAgendaOnly: false,
    badge: "new",
    overview: "The Village of Weston Community Life and Public Safety Committee met on May 4th, recommending approval of nuisance code amendments, an e-bike ordinance with restrictions on e-motos, mobile food vendor fire inspection requirements, address corrections, and a raze order for an abandoned property. The committee also discussed parking regulations and a crosswalk request, deferring both items for further staff research.",
    agenda: [
      ...
      { time:"6:00", item:"Acknowledgment of department reports (Code Enforcement, Fire\/EMS, Police)" },
      { time:"11:30", item:"Discussion on proposed amendments to Chapter 50 Nuisances" },
      { time:"13:00", item:"Discussion on proposed e-bicycle ordinance in Chapter 82" },
      { time:"33:30", item:"Discussion on overnight parking regulations" },
      { time:"50:45", item:"Discussion on crosswalk request on Alderson Street" },
      { time:"1:02:00", item:"Discussion on mobile food vendor fire inspection ordinance" },
      { time:"1:10:30", item:"Discussion on address corrections for E911 compliance" },
      { time:"1:15:30", item:"Discussion on raze order for 4104 Shore Avenue" },
    ],
    discussions: [
      { item:"Public Comments", body:"Jim Senalt spoke regarding several agenda items. He criticized the new farmers market location, predicting the park's grassy areas will be destroyed by vehicles parking on grass. He noted potential ADA compliance issues with handicap parking on grass rather than asphalt, questioned the need for new fire inspections on food trucks, raised concerns about mobile food vendor regulations on public property, and criticized the age of some code violation cases on the report, suggesting better accountability and progress updates are needed." },
      { item:"Approval of Minutes", body:"Motion to approve minutes was made by Olsen and seconded by Chwanka. Motion passed unanimously." },
      { item:"Department Reports", body:"Audrey reported that 3020 Mountain View Avenue will be removed from the code enforcement roll after the property sale was completed and the new owner submitted repair permits. Chief Hunt reported the police department had 2,394 calls in March (77 per day), 410 traffic stops, and 281 citations issued. The department has hired their 40th officer. Two SROs work with code enforcement during summer for zoning violations and pet licensing. Motion to acknowledge reports 5, 6, and 7 was made by Chwanka and passed unanimously." },
      { item:"Proposed Amendments to Chapter 50 Nuisances", body:"The committee reviewed final amendments including changes to tree limb height requirements over streets and walkways (14 and 10 feet) and language requiring compliance with jurisdictions that have authority over specific areas. Motion to recommend approval to the board of trustees was made by Olsen, seconded by Campkey, and passed unanimously." },
      { item:"E-Bicycle Ordinance Chapter 82", body:"Extensive discussion focused on e-motos, which Chief Hunt recommended prohibiting from roadways, sidewalks, and trails due to safety concerns, comparing them to unlicensed dirt bikes. The committee debated whether to also restrict electric scooters used by children but decided to leave officer discretion for those situations. Motion to recommend approval with the addition that e-motos are prohibited from roadways, sidewalks, trails, and any public property in the Village of Weston was made by Olsen, seconded by Chwanka, and passed unanimously." },
      { item:"Overnight Parking Regulations", body:"Trustee Tolson presented research showing Weston's 12-hour parking restriction window (4 AM to 4 PM) is significantly longer than surrounding municipalities, which typically have 4-5 hour windows. Public Works Director Mike Bartel suggested either eliminating the regulation entirely and signing only the 6-8 problem areas, or matching Rothschild's approach. Chief Hunt advocated keeping overnight restrictions to allow officers time to clear vehicles before plows arrive. The committee deferred action, directing Bartel to identify specific problem areas and return with a proposal in July or August." },
      { item:"Crosswalk Request on Alderson Street", body:"Mount Olive Church requested a crosswalk between the church and DC Everest High School administrative parking lot. Staff estimated a basic crosswalk would cost approximately $2,000-$3,000, while a lighted system would cost $25,000-$30,000. Chief Hunt reported no known safety incidents in the area. The committee agreed to approve the crosswalk only if Mount Olive covers the installation costs. Motion to recommend board approval contingent on Mount Olive paying for the crosswalk was made by Olsen, seconded by Chwanka, and passed unanimously." },
      { item:"Mobile Food Vendor Fire Inspection Ordinance", body:"Fire Chief explained that this ordinance establishes a regional fire inspection program with Marshfield, Stevens Point, Wisconsin Rapids, Plover, and Rib Mountain. A food truck inspected by any participating department receives a sticker valid for all municipalities, eliminating redundant inspections. Wausau declined to participate. Fire Marshal Marty already conducted one inspection that failed due to improper LP piping and unsecured propane containers. Motion to approve Ordinance 26-8 was made by Chwanka, seconded by Campkey, and passed unanimously." },
      { item:"Address Corrections for E911 Compliance", body:"Staff presented three addressing errors: 5915 Delicoski Street (duplex needing separate addresses), Ross Avenue properties out of sequence, and 2211 Radkey Avenue needing correction for a new duplex on a private drive. Chief Hunt added another issue at Weston Villa Apartments on Delicoski with eight apartments having separate addresses plus a utility room address. Motion to recommend approval to the board was made and seconded by Campkey, passing unanimously." },
      { item:"Raze Order for 4104 Shore Avenue", body:"Staff requested authorization to proceed with a raze order for an abandoned structure that has been posted since 2021 and abandoned since approximately 2010. A planned fire training burn was cancelled due to unsafe structural conditions. The property owners are current on taxes and have agreed to the demolition. Demolition costs will be added to the tax roll. Motion to recommend board authorization was made by Olsen, seconded by Campkey, and passed unanimously." },
    ],
    publicComment: "Jim Senalt spoke during public comment, criticizing the new farmers market location and predicting damage to park grass from vehicle parking. He raised concerns about ADA compliance for handicap parking on grass, questioned the necessity of new fire inspections for food trucks, noted ambiguity in mobile food vendor regulations on public property, and criticized the lack of visible progress on older code enforcement cases.",
    actionItems: [
      "Chapter 50 Nuisance amendments recommended for board approval",
      "E-bicycle ordinance with e-moto prohibition recommended for board approval",
      "Public Works Director to identify specific problem areas for overnight parking restrictions and return with proposal",
      "Public Works Director to contact Mount Olive Church regarding crosswalk cost sharing",
      "Ordinance 26-8 for mobile food vendor fire inspections approved",
      "Address corrections for E911 compliance recommended for board approval",
      "Raze order for 4104 Shore Avenue recommended for board authorization",
      "Staff to investigate property at Sternberg and South Timber for potential code violations",
