...
const MEETINGS = [
  {
    ...
    isAgendaOnly: false,
    badge: "new",
    overview: "The Wausau City Council approved several key items including a $10 million development agreement for 11 Scott Street to create 52 mid-priced residential units in a vacant downtown building (6-3 vote), a 7-year residential solid waste agreement with Harter's Fox Valley Disposal, and recognized city public works crews for their response to a record 30.9-inch snowfall. The meeting also featured a sustainability award presentation to Kolbe and Kolbe Millwork and a proclamation declaring March 31st as Sarah Rafi Day.",
    agenda: [
      ...
      { time:"36:00", item:"Mayoral appointments confirmation" },
      { time:"37:02", item:"Solid waste and recycling service agreement" },
      { time:"42:00", item:"Police department items and legal settlement" },
      { time:"46:00", item:"Announcements and adjournment" },
    ],
    discussions: [
      { item:"11 Scott Street Development Agreement", body:"The council approved a joint resolution from economic development and infrastructure committees for a development agreement with 11 Scott Street LLC for Waterside Place, passing 6-3. Developers Raleigh Lray and Mark Craig spoke during public comment, noting the $10 million project would create 52 mid-priced residential units in a 100,000 square foot building vacant for 3 years. Alder Rasmussen supported the project citing return of parking spaces for public use and need for downtown residents. Alder Neil noted benefits including $55,000 annual parking revenue and TID 8 valuation goals. Alder Larson was the dissenting voice, objecting to discounting city parking assets. Alder Tierney questioned the city's obligation to provide 150 parking spaces within 300 yards if the ramp closes; Economic Development Director Randy Feifer explained the new agreement reduces parking obligations from 480 to 150 spaces while generating revenue." },
      { item:"Public Works Snow Response Recognition", body:"Mayor Denny presented a mayoral citation to the Department of Public Works for their response to a record-breaking 30.9-inch snowfall from March 14-16, 2026. Kevin Kester, street supervisor, accepted the award and praised the plow crews and mechanics, stating 'you kicked its ass.' Four municipal fleet technicians maintained 12-hour shifts for continuous 24-hour breakdown support, with some volunteering on Saturday. By week's end, these technicians will have worked 12 straight days without a day off." },
      { item:"Sustainability Award to Kolbe and Kolbe", body:"Christine Daniels from the Sustainability, Energy and Environment Committee presented the 2026 City of Wausau Sustainability Award to Kolbe and Kolbe Millwork. Representatives Mike Thompson and Keith Kaning accepted, describing their 2,000+ solar panel installation operational since July that generates enough power for 120 homes. They also highlighted LED lighting projects, high-energy air compressors, and recycling initiatives for wood, aluminum, glass, vinyl, cardboard, and other materials." },
      { item:"Residential Solid Waste Agreement", body:"The council unanimously approved (9-0) a resolution from the finance committee approving a 7-year residential solid waste and recycling service agreement with Harter's Fox Valley Disposal. Mayor Denny noted there had been a previous mix-up regarding whether the term was 7 or 10 years, confirming it was corrected to 7 years as public health and safety had originally approved." },
      { item:"Police Department Thompson Submachine Gun Proceeds", body:"The council unanimously approved (9-0) a 2026 budget modification allowing the Wausau Police Department to use proceeds from the sale of a Thompson submachine gun to purchase Red Dot Optics. Mayor Denny noted the money had been 'sitting in the safe a long time waiting to spend it.'" },
      { item:"Legal Settlement - David Holes vs City of Wausau", body:"Assistant City Attorney Vincent Bonito presented a resolution to release claims related to a 2022 bus accident. The insurer agreed to pay damages for the bus to Transit Mutual (the city's insurer who had already paid the claim). Alder Neil clarified this settlement is separate from any ongoing personal injury claim. The resolution passed 8-1 with no closed session needed." },
    ],
    publicComment: "Two speakers addressed the council. Raleigh Lray from 11 Scott Street LLC asked for support for the Waterside Place project, describing it as a green sustainable repurposing of a vacant building with mid-priced apartment units. Mark Craig of 3246 North 8th Street joined her, explaining the $10 million project includes $8.3 million for 52 residential units, noting 'without your help, it won't happen' and referencing a previous 7-4 term sheet vote.",
    actionItems: [
      "Development agreement with 11 Scott Street LLC approved for Waterside Place project (6-3)",
      ...
      "Police department budget modification for Red Dot Optics purchase approved (9-0)",
      ...
      "Legal settlement release for David Holes case approved (8-1)",
      "Thomas Street Neighborhood Group meeting announced for Thursday with Chief Jeremy Cop discussing referendum",
    ],
    civicItems: [
  ...
  },
  {
    ...
    isAgendaOnly: false,
    badge: "new",
    overview: "The Wausau Plan Commission approved two major items: a conditional use permit for a 70-unit, 7-story apartment building at 731 North First Street for Beacon Resources LLC, and a transportation project plat for Grand Avenue signal replacements. A public hearing was held regarding a proposed personal storage facility at 218 South Fourth Street, with the applicants citing growing downtown residential demand as justification.",
    agenda: [
      { time:"0:00", item:"Call to order and election of vice chair (skipped until April)" },
      { time:"0:15", item:"Public comment on agenda items" },
      { time:"0:52", item:"Consideration of minutes from February 18th meeting" },
      { time:"1:08", item:"Public hearing on conditional use permit for 218 South Fourth Street storage facility" },
      { time:"3:12", item:"Discussion and possible action on conditional use permit for 731 North First Street apartment building" },
      { time:"3:50", item:"Discussion and possible action on transportation project plat for Grand Avenue signal replacements" },
      { time:"4:35", item:"General discussion and next meeting announcement" },
      { time:"5:00", item:"Adjournment" },
    ],
    discussions: [
      { item:"Consideration of minutes from February 18th", body:"Bugamman made a motion to approve the minutes, seconded by Balkan. The motion passed unanimously with all members voting in favor." },
      { item:"Public hearing on conditional use permit for 218 South Fourth Street storage facility", body:"Jason Dunwy and Melinda Don Woody spoke in favor of the proposed personal storage facility in the light industrial district. They argued that with over 400 new apartment units recently approved downtown, including the 153-unit Foundry on Third and 102-unit Evergreen Landing project, there is demand for convenient storage options for residents with limited apartment space. No action was taken during this agenda item; the public hearing was closed." },
      { item:"Conditional use permit for 731 North First Street apartment building", body:"Bornman made a motion to approve the conditional use permit for a 70-unit, 7-story apartment building for Beacon Resources LLC, seconded by Bugamin. With no questions or discussion from commissioners, the motion passed unanimously." },
      { item:"Transportation project plat for Grand Avenue signal replacements", body:"Bugamin made a motion to approve the transportation project plat for project 370-40-40 Grand Avenue signal replacements at Sturgeon and Townline Road, seconded by Balkan. The motion passed unanimously with no discussion." },
    ],
    publicComment: "One written comment was submitted by Linda Lawrence on March 12th expressing support for a development proposal, stating housing of this capacity would benefit downtown small businesses and citing the developer's track record. Jason Dunwy and Melinda Don Woody spoke in person during the public hearing for the storage facility at 218 South Fourth Street, advocating for the project based on growing downtown residential population.",
    actionItems: [
  ...
  },
  {
    ...
    isAgendaOnly: false,
    badge: "new",
    overview: "The Marathon County Board held an educational meeting featuring presentations on PFAS contamination litigation opportunities and county regulatory authority over renewable energy projects. No votes were taken as this was an informational session, but the board received detailed legal guidance on joining multi-district PFAS litigation and options for responding to proposed wind energy projects in the county.",
    agenda: [
      ...
      { time:"1:01:30", item:"Presentation on county regulatory authority over wind and solar energy systems" },
      { time:"1:10:01", item:"Discussion of Hub City Wind Project and other proposed projects" },
      { time:"1:25:03", item:"County options for responding to renewable energy projects" },
    ],
    discussions: [
      { item:"Public Comment", body:"Five residents spoke during public comment. Cindy Nelson from Stratford reported visiting 200 homes and finding no support for wind turbines, urging the board to provide more information to residents. Wendy Rowski from Green Valley asked the board to vote no on the comprehensive plan draft, objecting to the term 'wind farm' as misleading for industrial energy facilities. Barb Newton and Cindy Hogan from Rib Mountain supported a petition with 75 signatures requesting speed reduction and no-passing zone on Double N road. Heidi Pesky from McMillan argued that joint development agreements are not required for counties to regulate wind projects and listed numerous concerns about JDA provisions." },
      { item:"PFAS Multi-District Litigation Presentation", body:"Attorney Carrie McDougall from Baron and Budd Law Firm presented on the nationwide PFAS litigation. He explained that the water provider settlement totaled approximately $12-13 billion from 3M and $3-5 billion from DuPont - the largest toxic tort settlement in U.S. history. Marathon County could pursue claims related to airport contamination, landfill issues, and wastewater facilities. The legal services would be on a 25% contingency fee basis with no upfront costs to the county. Vice Chair Dickinson noted the airport has no known PFAS contamination currently. Supervisor Robinson asked about including land-spreading impacts in claims, but attorneys clarified claims must be for injuries unique to the county, though settlement proceeds could be used at the county's discretion." },
      { item:"Renewable Energy Regulatory Authority Presentation", body:"Attorney Rebecca Roker from Atollis Law presented on county options for responding to proposed wind projects including the Hub City Wind Project from Alliant Energy and Stormark Wind Energy Center. She explained that PSC has approved 33 solar projects with zero denials, making it unlikely counties can stop projects. She outlined four options: do nothing, negotiate a joint development agreement (JDA), intervene in PSC proceedings, or litigate. She strongly recommended JDAs as the most effective tool to protect county interests on liability, environmental impacts, roads, decommissioning, and emergency response, noting these protections are not available through state law alone. The Town of Brighton case was referenced as an example where local ordinances were upheld but the project is still proceeding." },
    ],
    publicComment: "Five speakers addressed the board. Cindy Nelson (Stratford\/Oplane Township) reported canvassing 200 homes and finding unanimous opposition to wind turbines, noting setbacks of only 1,250 feet from her home. Wendy Rowski (Green Valley) urged the board to vote no on the comprehensive plan draft and replace the term 'wind farm' with 'industrial wind energy development.' Barb Newton and Cindy Hogan (Rib Mountain) supported a petition with 75 signatures for speed reduction and no-passing zone on Double N road, citing near head-on collision incidents. Heidi Pesky (McMillan) argued against joint development agreements, listing twelve concerns including restrictions on county ordinance updates and inadequate decommissioning bonds.",
    actionItems: [
      "Board to consider resolution on PFAS litigation at next week's meeting",
      "County to evaluate PFAS testing at airport, landfill, and wastewater facilities",
      "Board to consider options for responding to Hub City Wind Project and other proposed renewable energy projects",
      "Speed reduction and no-passing zone petition for Double N road forwarded by infrastructure committee for board vote",
    ],
  },
  {
    ...
    discussions: [
      { item:"2026 Asphalt Paving Project Bid Opening", body:"Two bids were opened for the 2026 asphalt paving project. RC Pavers submitted the low bid at $824,146.34, while American bid $849,872.10. A motion was made to approve RC Pavers as the contractor, which was seconded and passed unanimously with all members voting 'aye.'" },
    ],
  ...
  },
  {
    ...
    isAgendaOnly: false,
    badge: "new",
    overview: "The Wausau Board of Public Works approved the lowest bid of $1,279,089.75 from Switlick for the 26th Street\/North 8th Avenue construction project, and approved a change order of $14,436.50 for the Rolph Street\/Cherry Street project to address unforeseen underground conditions. All items passed unanimously in a brief meeting.",
    agenda: [
      { time:"0:01", item:"Call to order" },
      { time:"0:01", item:"Consideration of March 10th regular Board of Public Works minutes" },
      { time:"0:25", item:"Open bids for 26th Street construction project \/ North 8th Avenue" },
      { time:"2:15", item:"2025 street construction project A (Rolph Street, Cherry Street) - Change Order 1" },
      { time:"5:01", item:"2025 street construction project A - Pay Estimate Number 9" },
      { time:"5:35", item:"Portland cement concrete license for KSK Incorporated" },
    ...
    discussions: [
      ...
      { item:"26th Street Construction Project \/ North 8th Avenue Bid Opening", body:"Seven bids were opened and read aloud. Switlick submitted the lowest bid at $1,279,089.75, narrowly beating Haas at $1,280,877.96. Other bidders included A1 ($1,374,600), Francis Melvin ($1,385,383), Steen ($1,489,126), James Peterson ($1,570,698.56), and Earth ($1,686,780.75). A board member noted the bids were 'tight.' Motion to approve Switlick as the winning bidder passed unanimously." },
      { item:"2025 Street Construction Project A - Change Order 1", body:"Staff explained four items requiring additional work due to conditions differing from records: an inside drop on a manhole ($4,856) for an unrecorded large sanitary service, water main tie-in work ($2,317.50) due to finding 6-inch pipe instead of expected 8-inch, miscellaneous storm sewer tie-ins ($5,016 at $66\/linear foot), and geogrid installation ($2,247) near Thomas Jefferson Elementary due to poor soil conditions. Change order two regarding liquidated damages was postponed pending further discussions. Total change order of $14,436.50 was approved unanimously." },
      { item:"2025 Street Construction Project A - Pay Estimate Number 9", body:"Pay estimate for work completed through year end in the amount of $535,114.42 from Haas Suns Incorporated was approved unanimously." },
      { item:"Portland Cement Concrete License - KSK Incorporated", body:"Board member Vinnie confirmed he reviewed the application and everything was in order. License was approved unanimously." },
    ],
    publicComment: "No public comment was offered.",
    actionItems: [
      "Award 26th Street\/North 8th Avenue construction project to Switlick for $1,279,089.75",
      "Approve Change Order 1 for Rolph Street\/Cherry Street project totaling $14,436.50",
      "Process Pay Estimate #9 of $535,114.42 to Haas Suns Incorporated",
      "Issue Portland cement concrete license to KSK Incorporated",
      "Bring back Change Order 2 with liquidated damages discussion at future meeting",
      "North 8th Avenue bid opening postponed - deadline extended",
    ],
    civicItems: [
  ...
  },
  {
    ...
    isAgendaOnly: false,
    badge: "new",
    overview: "The Finance and Human Resources Committee approved a modified employee clothing allowance of $400 for the remainder of 2026 and $500 annually starting in 2027, plus a one-time washer\/dryer purchase, after rejecting the originally proposed $600 allowance. Public Works Director Michael Wodalski presented a detailed report on department operations, budget efficiency, and the recent major snow event response.",
    agenda: [
      ...
      { time:"3:45", item:"Acknowledge February 2026 financial reports for all funds" },
      ...
      { time:"1:11:45", item:"Remarks from staff and committee members" },
    ...
    discussions: [
      ...
      { item:"February 2026 financial reports and work products", body:"The committee acknowledged the February 2026 financial reports for all funds, T1 and T2 detail reports, and legal details through a series of motions. Steve and Brad made motions to acknowledge these items, with Stephanie providing seconds. All motions passed unanimously." },
      { item:"Public Works operations and budget presentation", body:"Public Works Director Michael Wodalski delivered a comprehensive presentation showing the department manages 119.5 centerline miles of road with 10 full-time employees (down from 11 in 2010). He noted the 2026 budget decreased by $26,000 (1.1%) compared to 2025. Wodalski highlighted that Weston spends approximately $9,700 less per mile than the average central Wisconsin community, ranking as the second lowest per capita and third lowest per mile. He detailed the recent major snow event where staff worked 16-17 hour shifts, with estimated costs around $50,000 for that single storm. The county is pursuing disaster relief funds. Wodalski emphasized that transportation aids are tied to spending - when the village stopped street reconstruction from 2012-2020, state funding dropped significantly." },
      { item:"Reimbursement for clothing and equipment allowance amendments", body:"This item generated significant debate. The original proposal to increase the clothing allowance from $300 to $600 (after canceling the Cintas uniform contract) failed on a roll call vote with Daniels and Olsson voting yes, Armain and Satai voting no. Committee member Armain argued that despite saving money on the Cintas contract, 'just because we save money does not automatically mean we have to spend it,' citing the upcoming fire department referendum and fiscal sustainability concerns. Director Wodalski countered that employees deserve recognition for their work ethic during events like the recent 17-hour snow shifts and that taking away benefits could harm retention. A motion for $400 annually failed 2-2 (My and Satai yes; Daniels and Love no). A motion for $500 annually with washer\/dryer failed. Finally, a motion for $400 for remainder of 2026, $500 annually starting 2027, plus a one-time washer\/dryer purchase passed with only one opposed." },
    ],
    publicComment: "Lisa Beck of 1808 Cortez Lane spoke during public comment. She praised Public Works Director Mike for the department's work during the recent storm. She also expressed concern about the proposed clothing allowance increase, questioning why the village would spend the maximum amount when the goal of canceling the Cintas contract was to save money. She suggested considering a lesser amount rather than the highest proposed option.",
    actionItems: [
      ...
      "Marathon County pursuing disaster relief funds for March snow event - village to submit actual costs to state in coming weeks",
  ...
  },
  {
    ...
    isAgendaOnly: false,
    badge: "new",
    overview: "The Wausau Public Health and Safety Committee approved a parklet permit for West Cider Diner and Lounge after the owner presented detailed plans, approved multiple license applications and summer events, and updated a solid waste disposal ordinance to comply with state law. The committee also repealed a local cell phone driving ban that became redundant after state law changes, and heard updates on the homeless shelter transition to Bridge Street Mission expected in late April.",
    agenda: [
      ...
      { time:"0:55", item:"Approval of February 16, 2026 meeting minutes" },
      { time:"1:25", item:"License applications - West Cider Diner parklet permit discussion" },
      { time:"10:35", item:"License denial recommendations - Theodore Davis and Joanna Gregory" },
      { time:"18:55", item:"Batch approval of licenses and summer events" },
      { time:"20:01", item:"Repealing and recreating solid waste disposal ordinance (Chapter 6.44)" },
      { time:"21:10", item:"Repealing handheld mobile phone driving ordinance (Section 10.01.012)" },
      { time:"23:05", item:"MREA solar group buy program memorandum of understanding" },
      { time:"25:55", item:"Wausau Fire Department 2025 annual report discussion" },
      { time:"35:50", item:"Tavern activities report - February 2026" },
      { time:"38:15", item:"Community outreach update and homeless shelter transition" },
    ],
    discussions: [
      { item:"West Cider Diner Parklet Permit", body:"Owner Tyler Vote presented detailed mockups for a parklet extending 4 feet into the street and 4 feet on the sidewalk at 628 North Third Avenue. The parklet would use fiberglass panels similar to his previous parklet at Malarkey's Pub, with lighting and flowers for visibility. Alder Larson noted he was initially against it but changed his mind after seeing the layout. The permit was approved unanimously with a one-year trial through October 31, 2026, with Vote asked to report back in November." },
      { item:"Theodore Davis License Denial", body:"Davis appeared requesting a bartender\/operator license for work at Emerald Nightclub, acknowledging a conviction from 20 years ago when he was a minor. He submitted evidence of rehabilitation including registry completion to Chief Barnes at the last meeting. His boyfriend Matthew Prieb also spoke emotionally in support. Deputy Chief Baiton indicated he had not discussed the additional materials with Chief Barnes. The committee voted to hold the item for the next meeting pending the chief's review of rehabilitation evidence rather than act without full information." },
      { item:"Joanna Gregory License Denial", body:"Gregory did not appear for her scheduled hearing. The record noted her non-appearance and her application was included in the batch denial as recommended." },
      { item:"Batch License Approvals", body:"The committee approved licenses as recommended by staff including summer events (Wings over Wausau, Concerts on the Square, Chalkfest, Memorial Day parade, Hope on the Block, Jazz on the River), three applicants from the liquor license review subcommittee (Oasis Arcade, rebranded Whiskey River Bar and Grill, new Hayawa owner - all unanimously recommended), and class A retailers. Motion by Larson, second by Watson, passed unanimously." },
      { item:"Solid Waste Disposal Ordinance Update", body:"The committee repealed and recreated Municipal Code Chapter 6.44 to comply with evolving state-level changes. Assistant City Attorney Vinnie Bonino was available for questions but none were raised. Motion by Larson, second by Watson, passed unanimously." },
      { item:"Handheld Mobile Phone Ordinance Repeal", body:"The committee repealed Section 10.01.012 banning handheld phone use while driving, as state inattentive driving statutes have been amended to regulate cell phone usage, making the local ordinance redundant. Attorney Bonino confirmed the city adopts state traffic code. Motion by Watson, second by Larson, passed unanimously." },
      { item:"MREA Solar Group Buy Program", body:"The committee approved a memorandum of understanding with Midwest Renewable Energy for the Grow Solar Central Wisconsin program. The sustainability committee had unanimously recommended it on March 5th. Carrie from planning noted the program provides vetting of solar installers, cost savings, and educational sessions. Alder Sarah spoke positively about the program from her personal experience with solar installation. Motion by Watson, second by Larson, passed unanimously." },
      { item:"Fire Department 2025 Annual Report", body:"Chief Cop reported the department set a new record with over 7,200 calls averaging 20 per day. He announced that as of Friday, the city was confirmed as ISO Class 2 status for the next four years, with a goal of reaching Class 1. Three public information sessions were announced for March 31st at 1pm at the tech, April 1st at 5pm at Station 2, and April 3rd at Station 1 regarding the upcoming April 7th referendum. The report was placed on file." },
      { item:"Homeless Shelter Transition Update", body:"Tracy Durante reported 415 unduplicated guests served since opening and 740+ volunteer hours in February. James Torensson, new Director of Homeless Services at Bridge Street Mission, announced the emergency shelter transition is expected around April 20th pending contractor confirmation on April 1st. The WMC shelter contract with First United Methodist Church was extended through April 19th to ensure no service gap. The committee expressed interest in touring the new facility at the ribbon cutting ceremony." },
    ],
    publicComment: "No public comment was offered at the designated time at the beginning of the meeting. At the end of the meeting, Carrie Mor Everest of 1025 Everest Boulevard spoke, expressing concerns about how unhoused individuals are treated during emergency 911 calls at the shelter, stating she has witnessed multiple incidents over 10 months of volunteering where she felt people were not treated ethically or professionally. She noted her previous complaints had not been addressed and was directed to the Police and Fire Commission citizen board process.",
    actionItems: [
      "West Cider parklet permit approved for trial through October 31, 2026; owner to report back in November",
      "Theodore Davis license application held for next meeting pending Chief Barnes' review of rehabilitation evidence",
      "Joanna Gregory license denied (non-appearance)",
      ...
      "February 2026 tavern activities report placed on file",
      "Committee to tour Bridge Street Mission shelter at ribbon cutting ceremony after late April opening",
    ],
    civicItems: [
  ...
  },
  {
    ...
    isAgendaOnly: false,
    badge: "new",
    overview: "The Village of Weston Board of Trustees approved multiple ordinances including rezonings and a modified speed limit ordinance for Weston Avenue, rejected the original speed limit proposal 4-3 before passing an amended version keeping Von Kennel to Highway J at 45 mph. The board also approved a 10-year baseball\/softball field maintenance agreement, park fee changes, and deferred action on the remote meeting attendance policy until the new board is seated after the April election.",
    agenda: [
      { time:"0:01", item:"Call to order and Pledge of Allegiance" },
      ...
      { time:"31:00", item:"Discussion on April 2026 referendum informational sessions" },
    ...
    discussions: [
      { item:"Public Comment - Fire Department Funding", body:"Jim Pensel of 5002 Aerrol Street spoke passionately about fire department staffing after attending the inaugural Safer Citizen Academy. He criticized the board's approach of using referendums and band-aids rather than prioritizing public safety funding, stating 'We don't have a revenue problem here in Weston. We have a priority problem.' He urged the board to fund firefighters over amenities like artificial turf and the aquatic center." },
      { item:"Finance Director Response to Public Comment", body:"Finance Director Jessica responded that the village cannot borrow for additional firefighters - only for capital projects like Kennedy Park turf. She noted public works was understaffed during the recent blizzard and couldn't meet resident expectations. She stated emotionally that staff works efficiently but needs more revenue, and suggested her position might be open soon, noting '$150,000 you can fund a firefighter.'" },
      { item:"Speed Limit Ordinance 26-006", body:"The original ordinance to set Weston Avenue at 35 mph from Von Kennel to Ryan failed 3-4, with Maloney, Jordan, and the president voting no. Trustee Maloney argued the road section from Von Kennel to J should remain 45 mph due to sparse driveways compared to other village roads. An amended motion by Maloney to keep Von Kennel to Highway J at 45 mph while setting Von Kennel to Camp Phillips at 35 mph passed with only Trustee Karns opposed." },
      { item:"Intersection Signage at Community Center Drive and Birch Street", body:"The board approved changing the stop sign to a yield sign, with Trustee Huang raising safety concerns about bicyclists coming off the pedestrian bridge at speeds up to 20 mph. A friendly amendment was added to install a stop sign for bicyclists on the path near the bridge landing. Motion passed unanimously as amended." },
      { item:"Baseball\/Softball Field Maintenance Agreement", body:"The board approved a 10-year agreement with youth baseball and softball organizations for Kennedy Park field use. Parks staff explained the long term protects the village's investment if organizations were to pull out, and formalizes arrangements that have existed informally for over 10 years. Youth organizations will maintain fields in lieu of fees. Passed unanimously." },
      { item:"Remote Meeting Attendance Policy", body:"Trustee Lewis recommended postponing this item until the next meeting so the newly seated board could make the decision. The motion to defer passed unanimously." },
      { item:"Microsoft Teams for Communication", body:"The board approved using Microsoft Teams for trustee communications starting with the next term, eliminating text messaging between trustees. A training session will be held when the new board is seated. Passed unanimously." },
      { item:"Public Works Blizzard Response", body:"Director Michael reported staff worked 17-18 hour days during the historic blizzard, with equipment holding up well due to investments made about 10 years ago. The department's vac truck sold at auction for $352,000 - $100,000 more than expected. Trustee Maloney praised the response, noting neighbors helped each other and he received positive feedback from residents." },
    ],
    publicComment: "Jim Pensel of 5002 Aerrol Street spoke for approximately 4 minutes criticizing the board's approach to fire department funding. He attended the inaugural Safer Citizen Academy and witnessed staff exhaustion from understaffing. He opposed the referendum approach, noting it has no sunset date and won't solve long-term funding issues. He urged the board to prioritize public safety over amenities like artificial turf at Kennedy Park and the aquatic center.",
    actionItems: [
      "Speed limit ordinance amended: Von Kennel to Camp Phillips at 35 mph, Von Kennel to Highway J remains 45 mph",
      "Rezoning approved for 8905 Bert Street from RR5 to SFS zoning district",
      "Rezoning approved for 7105 Christensen Avenue from SL to SFS zoning district",
      "Final plat approved for Hinter Springs Second Edition subdivision",
      "E-bike\/Euro ordinance tabled pending Marathon County completion of their process",
      "No parking restrictions removed on west side of Alderson Street along Kennedy Park",
      "Yield sign to replace stop sign at Community Center Drive\/Birch Street; stop sign added for bicyclists on path",
      ...
      "Sign encroachment agreement approved for Mo Floor Coverings at 3111 Scofield Avenue",
      "Two more referendum Q&A sessions scheduled: March 31st 4:30-6pm and April 2nd 12-1:30pm",
  ...
  },
  {
    ...
    isAgendaOnly: false,
    badge: "new",
    overview: "The Marathon County Board of Supervisors adopted the 2026 Comprehensive Plan with 10 amendments addressing energy systems, AI technology, data centers, and other topics. The board also approved salaries for elected officials, authorized phase 2 design for a new highway facility, approved PFAS litigation, and ratified an emergency declaration for the recent blizzard event.",
    agenda: [
      { time:"0:12", item:"Call to order, pledge of allegiance, and moment of reflection" },
      { time:"1:35", item:"Roll call and welcome to visitors" },
      { time:"2:15", item:"Consent agenda items C8 through C13 B2" },
      { time:"2:52", item:"Adopting Marathon County Comprehensive Plan 2026 (Ordinance 0-13-26)" },
      { time:"1:20:01", item:"Establishing salaries for clerk of courts, sheriff, elected department heads (Resolution 12-26)" },
      { time:"1:21:15", item:"Phase 2 design services for new highway facility (Resolution 13-26)" },
      { time:"1:23:45", item:"Authorizing PFAS litigation (Resolution 14-26)" },
      { time:"1:28:30", item:"Carry forwards and budget amendments (Resolution R-20-26)" },
      { time:"1:29:15", item:"Capital asset threshold approval (Resolution 21-26)" },
    ...
    discussions: [
      { item:"Comprehensive Plan 2026 (Ordinance 0-13-26)", body:"Administrator Leonard presented 10 proposed amendments compiled from supervisor feedback. The board voted on each amendment separately after Supervisor Crawl successfully moved to separate amendments 2, 3, and 4 which had been offered together. Amendment 1 (livability standards) passed unanimously. Amendments 2, 3, and 4 (alternative energy systems language changes proposed by Vice Chair Dickinson) each passed but were not unanimous. Amendment 5 (data centers and battery storage) passed with Supervisor Leur voting no, calling it 'too ideological.' Amendment 6 (radon and lead references) passed unanimously. Amendment 7 (data centers regulation) passed not unanimously. Amendment 8 (AI and automation language proposed by Supervisor Leur) passed unanimously. Amendment 9 saw significant debate - Supervisor Sindellski's original amendment promoting clean coal, natural gas, and nuclear energy was amended by Supervisor Boots to read 'promote coal and natural gas until a long-term sustainable and reliable energy source can be found that does not adversely affect agricultural land.' Supervisors Robinson and Rosenberg opposed it, with Rosenberg stating 'There is no such thing as clean coal' from his experience at Weston Power Plant. The amended version passed not unanimously. A late amendment from Supervisor Sindellski regarding utility-scale wind\/solar as industrial uses was debated; Supervisor Jeang moved to refer it to the ERC committee for the July meeting, but that motion was defeated, and the amendment itself was then defeated. The final comprehensive plan as amended passed but was not unanimous." },
      { item:"Salaries for Elected Officials (Resolution 12-26)", body:"The resolution establishing salaries for the clerk of courts, sheriff, and elected department heads for the upcoming term of office was approved. Motion by Supervisor Conway, second by Supervisor Rosenberg. Passed with no discussion." },
      { item:"Highway Facility Phase 2 Design (Resolution 13-26)", body:"Motion by Supervisor Robinson, second by Supervisor V. Supervisor Soyber requested future information about plans for the old facility. Chair Gibbs noted that would be addressed by the HR Finance and Property committee potentially years down the road. Supervisor Sundowski asked about the $53 million cost estimate but Chair Gibbs clarified that amount was not being approved in this resolution. Passed unanimously." },
      { item:"PFAS Litigation (Resolution 14-26)", body:"The board authorized engaging outside counsel on contingency basis for PFAS lawsuits. Two amendments were adopted unanimously: Supervisor Robinson's amendment directing the county administrator to evaluate past and present practices that may have resulted in PFAS exposure to determine extent of risk to the county; and Vice Chair Dickinson's amendment modifying language regarding airport property. The resolution as amended passed unanimously." },
      { item:"Emergency Declaration Ratification (Resolution 22-26)", body:"Administrator Leonard explained the ratification preserves the county's opportunity for state reimbursement related to blizzard response. He praised staff across facilities, parks, highway, sheriff's office, and airport who worked 12-16 hour shifts and slept on cots during the emergency. Supervisor Fifer echoed the thanks as infrastructure committee chair, calling the event 'unprecedented.' Passed unanimously." },
      { item:"Administrator Performance Evaluation", body:"Chair Gibbs explained the executive committee completed the administrator's evaluation using input from the full board summarized at the previous Thursday meeting. Supervisor Robinson moved to accept the executive committee's recommendation including salary placement under the new pay structure. Passed unanimously without going into closed session." },
    ],
    publicComment: "No public comment was offered.",
    actionItems: [
      "Comprehensive Plan 2026 adopted with 10 amendments effective immediately",
      ...
      "Administrator evaluation and salary finalized per executive committee recommendation",
      "Departing supervisors (Crawl, Fifick, Marshall, Rosenberg, Hardinger, V, Reynolds) to return iPads after final meetings",
    ],
  },
  {
    ...
    isAgendaOnly: false,
    badge: "new",
    overview: "The Parks Committee approved minutes, selected Rettler Corporation for the Mock Mueller Park master plan, and discussed park impact fees with consensus supporting moderate increases to align with neighboring communities. The committee also reviewed Yellow Banks kayak launch expenses and Kennedy Park ice rink operations.",
    agenda: [
      ...
      { time:"26:00", item:"Discussion on Mock Mueller Park master plan RFP proposals" },
      ...
      { time:"50:30", item:"Future items and remarks from staff and committee" },
    ...
    discussions: [
      ...
      { item:"Parks and Recreation Impact Fee Discussion", body:"Jennifer presented information on park impact fees, noting the 2020 study recommended fees of $761 for single family but the village only raised fees to $300 in 2022. Neighboring communities charge $600-900 for single family homes. Committee members expressed consensus that fees should increase to a moderate level to align with neighbors while remaining competitive. Clark stated 'we want to keep our parks nice' and Katrina supported 'the moderate increase bracket instead of the maximum.' No formal action was taken; information will go to Plan Commission." },
      { item:"Mock Mueller Park Master Plan RFP Selection", body:"Seven proposals were received for the park master plan. Staff reviewed and rated proposals based on firm experience, personnel, similar projects, scope understanding, and cost. The two lowest bids were JSD ($[inaudible]) and Rettler Corporation, both with village experience. Roger made a motion to select Rettler Corporation, seconded by Katrina. The motion passed unanimously." },
      { item:"Yellow Banks Kayak Launch Expenses Review", body:"Jessica presented a comprehensive breakdown of the kayak launch project expenses and grant funding. Grants were secured from DNR, Marathon County Transportation, and others. Lisa Beck praised the RFC as 'super well written.' Committee members commended staff, particularly Jessica and Dan Higginbotham, for grant writing that significantly reduced village out-of-pocket costs. The launch is ADA accessible. No action required; informational only." },
      { item:"Kennedy Park Ice Rink Operations", body:"Staff presented information on ice rink operations at committee request. The warming house has been unstaffed since 2020 due to COVID and subsequent recruitment difficulties. Everest Youth Hockey remains interested in improvements including a roofed structure. Katrina expressed concern about not losing sight of hockey amid Kennedy Park baseball focus. Staff will bring back attendance figures from 2018-19 seasons and user feedback for future discussion. No action taken." },
    ],
    publicComment: "Jim Pinsel expressed frustration about receiving no response to his previous three-page submission of questions, raised concerns about playground equipment installation in 2024, Kennedy Park fundraising transparency, ice rink costs (estimating true costs at $20,000-30,000 including labor hours versus the reported $1,320.98), and criticized incomplete financial information provided to decision-makers. Lisa Beck thanked Michael for snow removal efforts during the recent blizzard and praised Sean and Jessica for the well-written Yellow Banks RFC. A written response to Jim Pinsel's previous comments was also submitted and will be included in minutes.",
    actionItems: [
      ...
      "Staff to compile ice rink attendance records from 2018-19 seasons for future discussion",
  ...
  },
  {
    ...
    isAgendaOnly: false,
    badge: "new",
    overview: "The Wausau Finance Committee approved several routine items including airport ground leases and budget carryovers, but postponed decisions on participating in a national opioid settlement and funding a lead service line replacement shortfall pending more information. The committee also denied a tax recovery claim related to ongoing Greenwood Hills litigation and approved transfers to cover fund shortfalls.",
    agenda: [
      { time:"2:01", item:"Call to order and public comment" },
      { time:"2:40", item:"Approval of March 10, 2026 meeting minutes" },
      ...
      { time:"12:00", item:"Budget amendment for 2025 lead service line replacement project" },
      { time:"27:03", item:"Budget amendment for carryover funds from 2025 to 2026" },
      { time:"37:00", item:"Review of 2025 general fund financial results and debt issuance calendar" },
    ],
    discussions: [
      { item:"Minutes approval", body:"The minutes from the March 10, 2026 meeting were approved. Motion by Watson, second by Griner. Passed unanimously." },
      { item:"Green Acres at Greenwood Hills LLC tax claim", body:"This claim for recovery of unlawful tax is part of ongoing litigation with Greenwood Hills. Staff explained that a 'no' vote would deny the claim. Watson moved to approve, Griner seconded. The motion failed when members voted 'no' to deny the claim." },
      { item:"Airport ground lease transfers - 939 Woods Place", body:"Three related items transferred a hangar from Win O. Jones to Owen Jones. The committee approved consent to transfer title (Watson\/Griner), terminated the lease with Win O. Jones (Tierney\/Watson), and approved a new lease with Owen Jones (Watson\/Tierney). All passed unanimously." },
      { item:"Airport ground lease with Cole Lundberg", body:"Motion by Griner, second by Watson to approve the ground lease. Passed unanimously." },
      { item:"National opioid settlement agreement", body:"The committee discussed whether to participate in a class action settlement involving six pharmaceutical defendants with potential $97 million payout. Alder Malini questioned where this came from, noting it 'dropped from heaven.' Assistant Attorney Vincent explained law firms send notices to potential class members. Multiple members expressed discomfort proceeding without more information, noting City Attorney Ann was unexpectedly absent. Griner moved to postpone to the next meeting, Tierney seconded. Passed unanimously." },
      { item:"Lead service line replacement budget amendment", body:"Finance Director Marian explained the DNR changed its interpretation of eligible costs, leaving $709,672 unfunded - $283,868 for homeowner-side work and $425,803 for utility-side. Committee discussed options including borrowing, using general fund surplus, or PFAS settlement money. Alder Tierney stated he opposed adding more debt given current debt levels. Watson moved to postpone to allow time to determine funding sources. Passed unanimously." },
      { item:"Carryover funds budget amendment", body:"The committee reviewed $10+ million in carryover items including 10 transit buses funded by VW mitigation grants and various airport projects. Finance Director noted the city hall chimney liner, public safety roof, and DPW fence projects had not yet started. Watson moved to approve, Griner seconded. Passed unanimously." },
      { item:"2025 motorpool fund review", body:"Finance Director reported a $41,373 loss before GMT transfer, improving to $150,000 profit after the $191,000 GMT transfer. A $177,000 cash shortfall exists due to unfunded vehicle purchases dating to 2023 supply chain issues. Solomon from Motorpool explained they're now second or third in line for long-delayed dump trucks. No action required - informational only." },
      { item:"2025 general fund results and fund transfers", body:"The general fund showed a $1.2 million surplus driven by strong building permits, investment income, and EMS revenues. After proposed transfers to recycling, airport, and parking funds to cover shortfalls, surplus would be $539,000. CCITC was $194,000 over budget due to communication problems on subscription costs and duplicate 95% personnel vacancy adjustments. Tierney moved to approve transfers, Watson seconded. Passed unanimously." },
      { item:"2026 general obligation promissory note calendar", body:"Committee reviewed the borrowing schedule for 2026 capital improvements including street projects (10-year amortization), motorpool (5-year), and TID projects. Finance Director noted debt utilization will decrease by about $2 million even with new issuance. Watson moved to approve the calendar, chair seconded. Passed unanimously. Phil Cawson from Ehlers will present parameters resolution at next meeting." },
      { item:"DPW property purchases consideration", body:"Items at 108, 112, 112.5 Adolf Street and 233 Myron Street were scheduled for closed session discussion. Given time constraints before council meeting and no urgency, Watson moved to postpone to next meeting, Tierney seconded. Passed unanimously." },
    ],
    publicComment: "No public comment was offered.",
    actionItems: [
      "Bring opioid settlement information back to next meeting with more details from City Attorney",
      "Return lead service line funding decision to next meeting after determining funding source options",
      "Process approved fund transfers to recycling, airport, and parking funds",
      "Phil Cawson from Ehlers to present debt parameters resolution at next meeting",
  ...
  },
  {
    ...
    isAgendaOnly: false,
    badge: "new",
    overview: "The Marathon County Executive Committee met briefly before entering closed session to conduct the performance review of the county administrator. The committee voted unanimously to go into closed session to finalize the administrator's evaluation based on board feedback received the previous Thursday.",
    agenda: [
      { time:"0:00", item:"Call to order" },
    ...
    discussions: [
      { item:"Performance review of the administrator", body:"The chair explained that the committee had the option to enter closed session to discuss the final review of the county administrator, incorporating board feedback received the previous Thursday. The chair noted that the executive committee had rated the administrator on various questions using three criteria: needs improvement, successful, and exceptional, scored on a scale of 0 to 5. Corporation counsel was asked to provide a summary of the appraisal. A motion was made and seconded to enter closed session, which passed unanimously with all members (Gibbs, Dickinson, Arstead, Boots, Drebeck, Fifick, Mask, Ritter, Morash, and Robinson) voting aye." },
    ],
    publicComment: "No public comment was offered.",
    actionItems: [
  ...
  },
  {
    ...
    agenda: [
      ...
      { time:"37:22", item:"Audited 2025 year-end fiscal update" },
      { time:"55:03", item:"2026 year-to-date fiscal update" },
      { time:"57:30", item:"Finance Department quarterly update" },
      { time:"1:07:22", item:"County Treasurer quarterly update" },
      { time:"1:36:30", item:"Announcements and adjournment" },
    ],
    discussions: [
      { item:"Claim disallowance - Mercedes Holmes", body:"Corporation Counsel presented a claim received December 5th from Mercedes Holmes related to the death of her 3-year-old child Zalen Bernett, who was placed in a treatment foster care home licensed through another agency in Dunn County. The death was determined to be from natural causes with no wrongdoing found through law enforcement and social service investigations. Outside counsel and insurance carrier WIMIK recommended disallowance. Chair Gibbs moved to disallow the claim per the insurance carrier's recommendation. The motion passed unanimously." },
      { item:"Revised property values for public auction", body:"Staff reported that two parcels listed on Wisconsin Surplus twice failed to sell because bids did not reach appraised value. The parcels at 529 Mullen Street and 738 South 3rd Avenue were recommended for revised minimum sale prices of $9,000 and $7,500 respectively. Chair Gibbs noted that one bidder who failed to pay was marked as 'non-pay' and banned from future Wisconsin Surplus auctions. Chair Gibbs moved to approve the revised prices, seconded by Supervisor Lumer. Motion passed unanimously." },
      { item:"Resolution to approve carry forward funds", body:"Finance Director Sam presented resolution R20-2026 for program revenues and multi-year projects requiring fund carryovers. Notable items included replenishing the veterans relief fund with 2025 budget excess to provide approximately three years of funding, and $142,731 for administration special projects including $75,000 for homelessness contract approved in the 2026 budget. Vice Chair Marshall asked about the redacted records fund for Register of Deeds; staff will follow up on its purpose and potential repurposing. Chair Gibbs moved to approve, seconded by Supervisor Hart. Motion passed unanimously." },
      { item:"Capital assets threshold policy amendment", body:"Finance Director Sam explained the policy change would increase the capitalization threshold from $5,000 to $10,000, aligning with GFOA guidance from 2006. This determines whether items are expensed immediately or depreciated as capital assets. Supervisor Hart moved to approve and forward to the full county board, seconded by Chair Gibbs. Motion passed unanimously." },
      { item:"Introduction of healthcare consultants - National Insurance Services", body:"HR Director Candace introduced NIS representatives following their selection through an RFP process. Tom (28 years experience) and Jordan Stanley presented their team of five specialists focused on public sector benefits. They outlined current projects including evaluating the near-site ATA clinic's return on investment, assessing funding models (fully insured, self-insured, level funded), and developing a long-term healthcare strategy. Vice Chair Marshall asked about comparative employer costs and emergency room utilization strategies. Chair Gibbs inquired about evaluation processes for different insurance models. NIS committed to providing quarterly or biannual updates and data-driven recommendations to the committee." },
      { item:"2025 year-end fiscal update", body:"Finance Director Sam provided detailed department-by-department review of unaudited 2025 year-end figures. Key items included: county treasurer received $257,238 TID closure check and $222,752 in unclaimed state property; opioid fund has $2.2 million cash with $3.5 million in future settlements expected; parks revenue increased including $70,000 more in ice revenue; ARPA funds nearly exhausted with $800,000+ interest to be transferred to different fund. Sam noted capital assets reconciliation still pending before final fund balance surplus can be determined." },
      { item:"2026 year-to-date fiscal update", body:"Sam reported 2026 is progressing as expected with some reclassification entries needed. First quarter closeout is scheduled for May 31st, followed by monthly closeouts with reports approximately two months in arrears to ensure accuracy and completeness." },
      { item:"Finance Department quarterly update", body:"Sam reported the finance team is fully staffed since mid-December with a new financial analyst for payroll. Accomplishments include quarterly closeouts with departments, countywide report training, W-2 processing including 'big beautiful bill' overtime calculations, 1099 processing, random cash audits (all successful), and grant reconciliation. Upcoming priorities include budget preparation, policy updates for accounts receivable and fixed assets, and continued uniformity efforts. County Administrator Lance publicly thanked Sam and her team for exceptional work during challenging year-end processes." },
      { item:"County Treasurer quarterly update", body:"Treasurer Connie reported on active tax collection monitoring, eviction hearing attendance, year-end procedures, and processing of 1,582 delinquent tax notices (down from 1,786 last year). She discussed ongoing challenges with municipal treasurer errors in receiving payments and lottery credit processing. Staff is working with DOR on training materials and considering bringing Transcendent (Ascent Land Records) for centralized municipal treasurer training. The committee discussed resources for taxpayers struggling to pay, noting payment agreements were discontinued due to high default rates but informal 'pay what you can' arrangements continue." },
    ],
    publicComment: "No public comment was offered.",
    actionItems: [
      "Claim of Mercedes Holmes disallowed per insurance carrier recommendation",
      "Revised minimum sale prices approved: 529 Mullen Street at $9,000 and 738 South 3rd Avenue at $7,500",
      ...
      "NIS to provide healthcare cost update before summer budget assumptions development",
      "Administration to bring recommendation for increasing Social Services reserve account above $400,000",
      "Finance to complete first quarter 2026 closeout by May 31st",
  ...
  },
  {
    ...
    isAgendaOnly: true,
    badge: "new",
    overview: "Based on the published agenda, the Wausau School District Board of Education Committee of the Whole was scheduled to address several significant items including an update on the referendum budget, approval of facility fees for artificial fields, and a substantial policy review of over 60 NEOLA policies. The meeting was also expected to feature an Excellence in Action presentation from Stettin Elementary and consider continued membership in the Wisconsin School Nutrition Purchasing Cooperative.",
    agenda: [
    ...
    discussions: [
      { item:"Excellence in Action: Stettin Elementary", body:"The meeting was scheduled to feature an Excellence in Action presentation highlighting Stettin Elementary School. This segment typically showcases achievements, programs, or initiatives at the featured school." },
      { item:"Wisconsin School Nutrition Purchasing Cooperative Agreement (WiSNP)", body:"The Wausau School District Nutrition Service Department was expected to present a resolution for continued membership in the Wisconsin School Nutrition Purchasing Cooperative for the 2026-2027 school year. The presentation was estimated to take 5 minutes, with action requested for approval of the cooperative agreement." },
      { item:"Facility Fees", body:"Ryan Urmanski, Director of Buildings and Grounds, was scheduled to present information to amend the current Wausau School District Facility Use Fee Schedule in a 10-minute presentation. The proposed changes were expected to address costs for use of artificial fields and field lighting for requested events, with immediate implementation requested upon approval." },
      { item:"Referendum Budget Update", body:"Elizabeth Channel, Interim Assistant Superintendent of Operations, was scheduled to share an update on the status of the Referendum Budget in a 10-minute presentation. This update was expected to provide the Board with current information on referendum-related spending and financial planning." },
      { item:"NEOLA UPDATE", body:"The Committee was scheduled to review proposed changes to numerous district policies during a 20-minute session. The policy review was organized into four categories: general policy updates covering board governance, student policies, and financial procedures; school support organization related policies; technical corrections; and Act 57 related policies addressing student supervision, welfare, and child abuse reporting. Notable policy areas included cell phones, artificial intelligence, academic honesty, third grade promotion, and homeless students." },
    ],
    ...
    actionItems: [
      ...
      "Action was requested to amend the Facility Use Fee Schedule to add costs for artificial fields and field lighting with immediate implementation",
      "Action was requested for approval of NEOLA policy updates including over 60 policies across governance, student affairs, financial operations, school support organizations, and Act 57 compliance",
    ],
  },
  {
