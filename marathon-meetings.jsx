...
const MEETINGS = [
  {
    ...
    date: "May 13, 2026", shortDate: "MAY 13",
    ...
    isAgendaOnly: false,
    badge: "new",
    overview: "The Marathon County Health & Human Services Committee held an educational orientation meeting for new and returning board members, reviewing committee structure, duties, and receiving department presentations from Health, Social Services, Veterans Services, and ADRC. The only formal action was unanimous approval of April 1st meeting minutes.",
    agenda: [
  ...
  },
  {
    ...
    isAgendaOnly: false,
    badge: "new",
    overview: "The Marathon County Board of Supervisors held an adjourned organizational meeting where they approved committee appointments, elected Supervisors Hapa and Arstead to the Executive Committee, and unanimously approved a resolution reducing landfill tipping fees for debris from the recent severe weather emergency affecting Ringle and other communities. The board heard public testimony from residents requesting expanded fee relief for tornado and flood victims.",
    agenda: [
      { time:"0:00", item:"Pledge of Allegiance and moment of reflection" },
      { time:"0:30", item:"Reading of meeting notice" },
      { time:"1:15", item:"Roll call and sign-in (technical difficulties with meeting manager)" },
      ...
      { time:"22:00", item:"Resolution 25-26: Amendment to social services budget" },
      { time:"23:00", item:"Resolution 26-26: Modification to landfill tipping fees" },
    ],
    discussions: [
      { item:"Committee Appointments", body:"Chair Gibbs presented committee appointments developed with Vice Chair Boots, emphasizing goals of increasing diverse perspectives, developing supervisors as leaders, and accommodating supervisor preferences. Motion by Supervisor Cavelli, seconded by Supervisor Crims. The motion carried but was not unanimous, with Supervisor Mask noting the system marked him absent but he wished to be recorded as voting aye." },
      { item:"Executive Committee At-Large Election", body:"Three supervisors were nominated: Supervisor Hapa (nominated by Supervisor Mask), Supervisor Leur (nominated by Supervisor Rosenberg, who praised her advocacy for children and elders), and Supervisor Arstead (nominated by Vice Chair Boots). Paper ballots were distributed and supervisors selected two names. Supervisors Hapa and Arstead were elected to the Executive Committee." },
      ...
      { item:"Resolution 26-26: Landfill Tipping Fee Modification", body:"Administrator Leonard and Director Hagen Busher explained the fee reduction proposal in response to severe weather damage affecting Ringle, Kronenwetter, and other areas. The proposal reduces fees from $65\/ton standard rate to approximately $36.94\/ton by waiving the state fee ($13.10) and town of Ringle fee ($2.33) for certified disaster-related debris. About 400 tons of debris have already been processed. The board voted unanimously to suspend rules to hear this resolution directly from the Solid Waste Management Board, then approved the resolution unanimously on motion by Supervisor Arstead, seconded by Supervisor Morash." },
    ],
    publicComment: "Two residents were granted special permission to speak on the tipping fee resolution. Jessica Tolesie urged the county to waive fees entirely for six months, noting that the state, DNR, and Ringle are waiving their fees and requesting Marathon County do the same. She stated private businesses have donated significant resources (one up to $40,000) and asked the county to contribute similarly. Matt Haybeck spoke on behalf of residents with demolished homes, requesting fee waivers for underinsured homeowners and noting some insurance adjusters haven't arrived yet, requesting more time beyond the proposed deadline.",
    actionItems: [
      ...
      "Administrator to work with Community Foundation on potential mechanism for reimbursing uninsured disaster cleanup costs",
      "Solid Waste Management Board directed to develop long-term policy on emergency fee reductions within six months",
      "Staff to continue tracking and certifying disaster-related debris for potential state disaster aid documentation",
    ],
  },
  {
    ...
    isAgendaOnly: false,
    badge: "new",
    overview: "The Marathon County Environmental Resources Committee approved two rezoning petitions and voted to forward a modified fee waiver resolution to the county board that will only waive reconnect fees for septic systems on properties damaged by the April 17, 2026 tornado. The committee also received educational presentations from Solid Waste, Parks Recreation and Forestry, and Conservation Planning and Zoning departments.",
    agenda: [
    ...
    discussions: [
      { item:"Approval of March 31st, 2026 committee minutes", body:"Supervisor Sefeld made a motion to approve the minutes, seconded by Supervisor Drebeck. The motion carried with no opposition." },
      { item:"Rezoning petition - Tim Veland on behalf of James Offer and David Tract", body:"Garrett Pogle presented the staff report for rezoning from urban residential and general agriculture to rural residential in the Town of Green Valley. The Town Board recommended approval on March 10, 2026. No public testimony was offered. Supervisor Drebeck moved to approve based on findings of fact and conclusions of law, seconded by Supervisor Kurt. Motion carried unanimously." },
      { item:"Rezoning petition - Jeffrey and Cynthia Schmidtz", body:"Garrett Pogle presented the petition to rezone from conservancy recreation to general agriculture in the Town of McMillan. Supervisor Leur asked about the conservancy designation, and Pogle explained the property has a home and horse riding stable, and the rezone would make these conforming uses. The Town Board recommended approval on April 20, 2026. No public testimony was offered. Supervisor Sefeld moved to approve, seconded by Supervisor Drew. Motion carried unanimously." },
      { item:"Fee waivers for April 17, 2026 severe weather victims", body:"Director Lori Miskimmons presented staff recommendations to waive county zoning and septic fees for tornado-impacted properties. Supervisor Drew questioned where to draw the line for future events. Supervisor Leur asked about tracking costs. Supervisor Drebeck expressed concerns about fairness to individuals not in declared disaster areas and referenced the recent $6 fee increase for septic systems. Eric Vogel asked if homeowners insurance would cover fees. After significant debate, Supervisor Drebeck moved to amend the resolution to only waive reconnect fees ($160) for septic systems, not other zoning or septic fees. The amendment was seconded by Supervisor Kurt and passed. The amended resolution was then approved to forward to the county board, though not unanimously." },
      { item:"Solid Waste Department overview", body:"Director Dave Hagenbusher presented an overview of the department's operations, explaining the landfill accepts about 1,000 tons daily with 11 staff members. He highlighted the renewable natural gas partnership with Vidi Energy that began injecting gas into pipelines in September 2025, significant capital expenses of $4-6 million for expansions and closures, and the requirement by 2032 to have on-site leachate treatment due to PFAS concerns. Marilyn Bend praised the department for keeping private landfills competitive on pricing." },
      { item:"Parks, Recreation and Forestry Department overview", body:"Tom Lovelin, County Forest Administrator, presented on behalf of Director Jamie who had an emergency. He explained the department operates both county and City of Wausau park systems since 1924, manages 17 county parks and 30,700 acres of county forest. A Nine Mile County Forest study showed out-of-town visitors generate $3.25 million annually for the county economy. Supervisor Sefeld thanked Tom and announced his retirement effective June 1st after 35 years of service. Joe Tucker was selected as the new county forest administrator." },
    ],
    publicComment: "No public comment was offered.",
    actionItems: [
      ...
      "Staff directed to track costs and requests related to fee waivers for future policy development",
