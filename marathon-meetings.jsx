...
const MEETINGS = [
  {
    ...
    date: "May 10, 2026", shortDate: "MAY 10",
    ...
    isAgendaOnly: false,
    badge: "new",
    overview: "The Marathon County Health & Human Services Committee held an introductory meeting for new board members, providing educational presentations on the Health Department, Social Services, Veteran Service Office, and Aging Disability Resource Center. The only action taken was approval of April 1st meeting minutes. The meeting focused on orienting new supervisors to department missions, budgets, and services.",
    agenda: [
      { time:"0:00", item:"Call to order and roll call (noting Supervisors Kremes and Vice Chair Rosenberg participating remotely)" },
      { time:"0:25", item:"Pledge of Allegiance" },
      { time:"0:55", item:"Approval of April 1st committee meeting minutes" },
      { time:"1:25", item:"Operational functions required by statute - no items for this meeting" },
      { time:"2:30", item:"Review of standing committee ordinance section 2.04, missions, duties, and responsibilities" },
      { time:"13:00", item:"Health Department overview presentation by Health Officer Caitlyn Suginaka" },
      { time:"25:00", item:"Social Services Department overview by Administrator Leonard" },
      { time:"45:00", item:"Veteran Service Office overview by Veteran Service Officer Aaron Galindo" },
      { time:"1:15:00", item:"Aging Disability Resource Center overview by Executive Director Mike Ray" },
    ...
    discussions: [
      ...
      { item:"Review of standing committee ordinance and structure", body:"Administrator Lance Leonard explained the committee's jurisdiction over Health Department, Social Services, and Veteran Service Office, plus affiliated multi-county entities North Central Health Care and the Aging Disability Resource Center. He outlined statutory responsibilities and explained how the Social Services Board, Veteran Service Commission, Transportation Coordinating Committee, and Board of Health provide input but not direct oversight of departments." },
      { item:"Health Department presentation", body:"Health Officer Caitlyn Suginaka presented the department's mission to prevent disease, promote health, and protect from environmental hazards. The department has 37.6 FTE staff and oversees 1,200 licenses for restaurants, pools, campgrounds, and hotels. She highlighted the Nurse Family Partnership program graduating its first two-year-olds, a new homeless system response position funded jointly with City of Wausau, public health vending machines with free resources including tick kits, and lead mitigation efforts through a HUD grant. Administrator Leonard noted approximately half of the $5 million budget is tax levy with the rest from grants and fees." },
      { item:"Social Services Department overview", body:"Administrator Leonard presented on behalf of absent Director Christa, noting the department is the second largest with nearly 140 FTE. The department handles child welfare, youth justice, children's long-term support, economic support, and child support. He highlighted the successful Family Keys housing stability pilot program done in partnership with the state, which addresses root causes of housing instability for families. Of the $22 million budget, approximately $7 million is tax levy." },
      { item:"Veteran Service Office presentation", body:"Veteran Service Officer Aaron Galindo reported his office increased to 3.0 FTE in 2025 and had 8,149 veteran interactions, up significantly from 5,900 the prior year. He reported veterans in Marathon County receive $44 million annually in VA benefits, with $2.6 million in retroactive payments in 2025 alone. Galindo discussed initiatives including surviving spouse benefits outreach, housing stability partnerships with Center for Veterans Issues, and suicide prevention efforts noting Marathon County had 30 suicides in 2025, seven of whom were veterans. The office is exploring the Staff Sergeant Gordon Fox suicide prevention grant." },
      { item:"Aging Disability Resource Center presentation", body:"Executive Director Mike Ray explained the ADRC serves Marathon, Lincoln, Langlade, and Wood counties as a one-stop shop for aging and disability services. The organization has about 60 FTEs plus 385-400 volunteers. He discussed significant financial challenges with nutrition program costs up 40-45% over four years while federal funding remained flat, noting the Older Americans Act hasn't been reauthorized in over two years. Marathon County's contribution is $413,135 annually, with the first levy increase since 2011 granted in 2025." },
      { item:"Emergency preparedness discussion", body:"Supervisor Kremes asked about pandemic preparedness in light of norovirus outbreak news. Health Officer Suginaka confirmed the department has plans in place, conducts training exercises including recent measles response practice, and has a full-time public health emergency preparedness staff member. She noted staff would be reallocated from chronic disease work if needed for an outbreak response." },
    ],
    publicComment: "No public comment was offered.",
    actionItems: [
      "April 1st committee meeting minutes approved unanimously",
      "North Central Health Care to be scheduled for separate full presentation before the committee",
      "Mike Ray to present ADRC annual report with 2025 data to full county board",
  ...
  },
  {
    ...
    isAgendaOnly: false,
    badge: "new",
    overview: "The Marathon County Board held its organizational meeting, approving committee appointments and electing Supervisors Hapa and Arstead to the executive committee. The board unanimously approved a resolution to reduce landfill tipping fees for disaster-related debris following severe weather that impacted Ringle and other communities, with the county waiving approximately $13 per ton to bring fees down to $36.94 for certified storm debris.",
    agenda: [
      { time:"0:00", item:"Pledge of Allegiance and moment of reflection" },
      { time:"0:30", item:"Reading of the notice and roll call" },
      { time:"5:01", item:"Committee appointments discussion and Chair remarks on leadership" },
      { time:"10:01", item:"Election of at-large executive committee members" },
      { time:"20:00", item:"Consent agenda items C10 through C14A" },
      { time:"20:00", item:"Resolution D15 - Out of home placement reserve increase" },
      { time:"20:00", item:"Resolution D16 - Social services budget amendment" },
      { time:"25:01", item:"Resolution E17 - Landfill tipping fees modification for disaster relief" },
      { time:"1:10:02", item:"Announcements and requests" },
      { time:"1:10:02", item:"Adjournment" },
    ],
    discussions: [
      { item:"Committee Appointments", body:"Chair Gibbs outlined goals for committee appointments including increasing diversity of perspective, allowing supervisors to grow as leaders, and noting that over 34% of the board is in their first or second term. The appointments were developed with Vice Chair Boots. Motion by Supervisor Cavelli, seconded by Supervisor Crims. The motion carried but was not unanimous." },
      { item:"Election of At-Large Executive Committee Members", body:"Three supervisors were nominated: Supervisor Hapa (nominated by Supervisor Mask), Supervisor Leur (nominated by Supervisor Rosenberg, who praised her advocacy for children and elders), and Supervisor Arstead (nominated by Supervisor Boots). Following paper ballot voting, Supervisors Hapa and Arstead were elected to the executive committee." },
      { item:"Consent Agenda", body:"Items C10 through C14A were approved. Motion by Supervisor Cavelli, seconded by Supervisor Drebeck. The motion carried unanimously." },
      ...
      { item:"Resolution 25-26 - Social Services Budget Amendment", body:"Motion by Supervisor P [name unclear], seconded by Supervisor Robinson. The motion carried but was not unanimous." },
      { item:"Resolution 26-26 - Landfill Tipping Fees Modification", body:"Administrator Leonard and Director Hagen Busher presented this resolution from the Solid Waste Management Board responding to severe weather that impacted Ringle and surrounding areas. The proposal reduces tipping fees from $65\/ton to approximately $36.94 for certified disaster debris by waiving the state fee ($13.10), town of Ringle fee ($2.33), and county's portion. Two members of the public, Jessica Toasty and Matt Haybeck, were granted special permission to speak, requesting the county wave fees entirely for affected residents. Supervisor Rosenberg requested continued discussion. The board first voted unanimously to suspend rules to consider the resolution directly, then approved the resolution unanimously. Motion by Supervisor Arstead, seconded by Supervisor Morash." },
    ],
    publicComment: "Two members of the public were granted special dispensation to speak on the landfill tipping fee resolution. Jessica Toasty urged the county to wave fees entirely, noting the state, DNR, and Ringle are waving their fees, and that private businesses have donated significant resources. She stated Marathon County had not provided much financial assistance and requested a six-month fee waiver. Matt Haybeck spoke on behalf of homeowners facing demolition, noting 44 homes affected and many still waiting for insurance adjusters, requesting more time and relief from fees.",
    actionItems: [
      "Landfill tipping fees reduced to approximately $36.94 per ton for certified disaster-related debris through June 17, 2025",
      ...
      "Supervisors Hapa and Arstead elected to executive committee",
  ...
  },
  {
    ...
    isAgendaOnly: false,
    badge: "new",
    overview: "The Marathon County Environmental Resources Committee approved two rezoning petitions and voted to forward a modified fee waiver resolution to the county board that will only waive septic system reconnect fees for tornado victims, rather than the broader fee waiver originally proposed. The committee also received educational presentations from Solid Waste, Parks Recreation and Forestry, and Conservation Planning and Zoning departments.",
    agenda: [
      ...
      { time:"19:30", item:"Consideration of fee waivers for properties impacted by April 17, 2026 severe weather" },
    ...
    discussions: [
      { item:"Approval of March 31st, 2026 committee minutes", body:"Supervisor Sefeld made the motion to approve and Supervisor Drebeck seconded. The motion carried with no opposition on a voice vote." },
      { item:"Tim Veland rezoning petition - Town of Green Valley", body:"Garrett Pogle presented the staff report for rezoning from urban residential and general agriculture to rural residential for a proposed land division. The Town of Green Valley recommended approval on March 10, 2026. No public testimony was offered for or against. Supervisor Drebeck moved to approve based on findings of fact and town approval, Supervisor Kurt seconded. Motion carried unanimously." },
      { item:"Jeffrey and Cynthia Schmidtz rezoning petition - Town of McMillan", body:"Staff presented the petition to rezone from Conservancy Recreation to General Agriculture. Supervisor Leur asked about conservancy implications; staff explained the property has a home and horse riding stable, and rezoning makes these conforming uses rather than non-conforming. No natural areas would be lost. Town of McMillan recommended approval on April 20, 2026. No public testimony was offered. Supervisor Sefelt moved to approve, Supervisor Drew seconded. Motion carried unanimously." },
      { item:"Fee waivers for April 17, 2026 severe weather victims", body:"Director Lori Mskimmons presented staff recommendation to waive county zoning and septic system fees for properties damaged by the April 17 tornado affecting Ringle, Kronenwetter, Easton, and Weston. Supervisor Drew questioned fairness of waiving fees for declared disasters but not individual incidents. Supervisor Drebeck expressed similar concerns and proposed an amendment to limit waivers to only septic system reconnect fees ($160 each) rather than all zoning and pouts fees. The amendment was seconded by Supervisor K and passed. The amended resolution then passed on a non-unanimous voice vote to forward to the county board." },
      { item:"Solid Waste Department educational presentation", body:"Director Dave Hagen Busher provided an overview of landfill operations, explaining the facility accepts about 1,000 tons daily and has partnerships with Portage and Shawano counties. He discussed the renewable natural gas partnership with Vidi Energy, significant capital expenses for expansion and closure ($4-6 million projects), and the upcoming requirement by 2032 for on-site leachate treatment due to PFAS concerns. Marilyn Bend praised the department for keeping regional costs competitive." },
      { item:"Parks, Recreation, and Forestry Department educational presentation", body:"Tom Lovelin, County Forest Administrator, presented on behalf of absent director Jamie. He explained the department serves both city and county with 44 full-time and 120 seasonal employees, manages 17 county parks and 30,700 acres of county forest. A Nine Mile County Forest study showed out-of-town visitors generate $3.25 million for the local economy. Supervisor Sefelt announced Tom's upcoming retirement on June 1st after nearly 30 years of service, with Joe Tucker selected as his replacement." },
    ],
    publicComment: "No public comment was offered.",
    actionItems: [
      "Forward amended resolution to county board waiving only septic system reconnect fees for properties damaged by April 17, 2026 severe weather",
      "Forward Tim Veland rezoning petition (urban residential\/general agriculture to rural residential) to county board for approval",
      ...
      "Track costs and requests related to tornado fee waivers for future policy development",
      "Schedule summer educational meeting on conservation topics with Conservation Director Kirsty Heiden",
    ],
  },
  {
