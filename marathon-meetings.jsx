...
const MEETINGS = [
  {
    ...
    isAgendaOnly: false,
    badge: "new",
    overview: "The Marathon County Health & Human Services Committee held an educational orientation meeting for new board members, featuring presentations from department heads on the Health Department, Social Services, Veteran Services, and Aging & Disability Resource Center. No action items were voted on beyond approving April 1st meeting minutes. The meeting focused on introducing committee jurisdiction, department missions, budgets, and key programs.",
    agenda: [
      { time:"0:00", item:"Call to order and verification of remote participation" },
      { time:"0:22", item:"Pledge of Allegiance" },
      { time:"1:02", item:"Approval of April 1st committee meeting minutes" },
      { time:"1:40", item:"Operational functions required by statute (no items this meeting)" },
    ...
    discussions: [
      { item:"Approval of April 1st Meeting Minutes", body:"Supervisor Cavelli made a motion to approve the minutes, seconded by Vice Chair Rosenberg. The motion carried unanimously with no opposition." },
      { item:"Standing Committee Jurisdiction Overview", body:"Administrator Lance Leonard explained the committee's structure under ordinance section 2.04 subsection 5, including oversight of Veterans Service Department, Social Services Department, Health Department, North Central Health Care, and Aging Disability Resource Center. He explained reporting relationships with statutory boards including the Social Services Board, Veteran Service Commission, Transportation Coordinating Committee, and Board of Health." },
      { item:"Health Department Presentation", body:"Health Officer Caitlyn Suginaka presented the department's mission of preventing disease, promoting health, and protecting from environmental hazards. She highlighted 1,200 licenses overseen, communicable disease prevention, Nurse Family Partnership program (first graduates at age 2), and a new FTE position for homeless system response. The department has 37.6 FTE and approximately half of their $5 million budget comes from tax levy, with significant grant and fee revenue." },
      { item:"Social Services Department Overview", body:"Administrator Leonard presented on behalf of Director Christa (not present). The department has nearly 140 FTE handling child welfare, youth justice, children's long-term support, economic support, and child support. Their 2026 budget is over $22 million with about $7 million in tax levy. Leonard highlighted the successful Family Keys housing stability pilot program addressing housing instability among child welfare and youth justice populations." },
      { item:"Veteran Services Department Presentation", body:"Veteran Service Officer Aaron Galindo reported his department increased from 2.75 to 3.0 FTE in 2025. Customer interactions jumped from 5,900 to 8,149 in 2025. The department brings $44 million annually in VA compensation to local veterans, with $2.6 million in retroactive payments in 2025. Galindo discussed new suicide prevention initiatives (noting 30 county suicides in 2025, 7 being veterans), housing stability partnerships with Center for Veterans Issues, and efforts to help surviving spouses with dependency and indemnity compensation benefits." },
      { item:"ADRC Presentation", body:"Executive Director Mike Ray explained the four-county Aging & Disability Resource Center serves Marathon, Lincoln, Langlade, and Wood counties with about 60 FTE and 385-400 volunteers. Services include Meals on Wheels, Medicare counseling, caregiver support, dementia care, and falls prevention. Ray noted significant budget challenges with nutrition program costs up 40-45% over four years while federal funding remained flat. Marathon County's 2026 contribution is $413,135. The organization had no levy increase from 2011-2024." },
    ],
    publicComment: "No public comment was offered.",
    actionItems: [
      "Schedule North Central Healthcare for a separate full presentation meeting",
      "Chair Boots to bring strategic plan information to future meetings",
      "Next meeting confirmed for Wednesday, June 3rd at 3:00 PM (corrected from initially stated May 29th)",
      "Committee members invited to email agenda item suggestions to Chair Boots and Administrator Leonard",
    ],
  },
  {
    ...
    isAgendaOnly: false,
    badge: "new",
    overview: "The Marathon County Board of Supervisors held an adjourned organizational meeting where they approved committee appointments, elected two at-large executive committee members (Supervisors Hapa and Arstead), and unanimously approved a resolution reducing landfill tipping fees for storm debris following the recent tornado and flooding disaster. The board also heard from two affected residents requesting additional fee relief.",
    agenda: [
      ...
      { time:"20:00", item:"Ballot Results Announcement" },
    ...
    discussions: [
      { item:"Committee Appointments", body:"Chair Gibbs presented committee appointments developed with Vice Chair Boots, emphasizing goals of increasing perspective diversity, developing supervisors as leaders, and respecting supervisor preferences. He noted 34% of the board is in their first or second term. The motion by Supervisor Cavelli, seconded by Supervisor Crims, included both county board chair and administrator appointments. The motion carried but was not unanimous. Supervisor Oldenberg noted he was marked absent but wanted to be recorded as voting aye." },
      { item:"Election of At-Large Executive Committee Members", body:"Three supervisors were nominated: Supervisor Hapa (nominated by Supervisor Mask), Supervisor Leur (nominated by Supervisor Rosenberg), and Supervisor Arstead (nominated by Vice Chair Boots). Supervisor Rosenberg explained she nominated Supervisor Leur because she had seen her advocate for the county's smallest children and oldest elders. Nominations were closed unanimously. Paper ballots were distributed with supervisors selecting two names. Supervisors Hapa and Arstead were elected to the executive committee." },
      { item:"Consent Agenda Items C10-C14A", body:"Motion by Supervisor Cavelli, seconded by Supervisor Drebeck. The consent agenda was approved unanimously by voice vote." },
      { item:"Resolution 24-26: Out of Home Placement Reserve Increase", body:"Motion by Supervisor Morash, seconded by Supervisor Robinson. The resolution was carried but was not unanimous." },
      { item:"Resolution 25-26: Social Services Budget Amendment", body:"Motion by Supervisor P, seconded by Supervisor Robinson. The resolution was carried but was not unanimous." },
      { item:"Resolution 26-26: Landfill Tipping Fee Modification", body:"Administrator Leonard and Solid Waste Director Hagen Busher presented the proposal from the Solid Waste Management Board to reduce tipping fees for storm debris following the recent tornado and flooding. The standard $65\/ton fee would be reduced to $36.94 by removing the state fee ($13.10), Ringle's fee ($2.33), and reducing to commercial rates. Leonard noted the county will not meet the $670,743 threshold for state disaster aid, but expects Ringle to qualify. He discussed potential partnership with the Community Foundation for unreimbursed insurance costs. The board suspended rules unanimously to consider the resolution that hadn't gone through a standing committee. The resolution was then approved unanimously." },
    ],
    publicComment: "Two residents were granted special dispensation to speak on the tipping fee resolution. Jessica Toasty asked Marathon County to wave all fees like the state, DNR, and Ringle were doing, noting they hadn't seen Marathon County assistance during cleanup and businesses had donated up to $40,000 in hauling expenses. She requested a six-month fee waiver. Matt Haybeck spoke on behalf of homeowners needing house demolition, noting 44 homes affected and some insurance adjusters hadn't yet arrived. He requested more time for fee waivers and relief for underinsured residents.",
    actionItems: [
      ...
      "Resolution 26-26 approved reducing landfill tipping fees to $36.94\/ton for certified storm debris through June 17, 2025",
      "Administrator Leonard to continue discussions with Community Foundation regarding unreimbursed insurance costs for disaster victims",
      ...
      "Staff to review Ringle's fee waiver resolution to determine geographic scope of their $2.33 fee waiver",
    ],
  },
  {
    ...
    isAgendaOnly: false,
    badge: "new",
    overview: "The Marathon County Environmental Resources Committee approved two rezoning petitions unanimously and voted to recommend a limited fee waiver for tornado-damaged properties, restricting it to only septic system reconnect fees rather than the broader waiver initially proposed by staff. The committee also received educational presentations from Solid Waste, Parks Recreation and Forestry, and Conservation Planning and Zoning departments.",
    agenda: [
      ...
      { time:"1:00", item:"Public hearing introduction and procedures" },
      { time:"5:01", item:"Rezoning petition 5A1: Tim Veland on behalf of James Offer and David Trait - Urban Residential and General Agriculture to Rural Residential in Town of Green Valley" },
    ...
    discussions: [
      ...
      { item:"Rezoning petition 5A1: James Offer and David Trait property", body:"Land Use Specialist Garrett Pogle presented the staff report for rezoning approximately 2 acres from Urban Residential and General Agriculture to Rural Residential in the Town of Green Valley. The Town Board recommended approval on March 10, 2026. Supervisor Drebeck moved to approve based on findings of fact and conclusions of law, seconded by Supervisor Kurt. The motion carried unanimously with no public comment offered." },
      { item:"Rezoning petition 5A2: Jeffrey and Cynthia Schmidtz property", body:"Garrett Pogle presented the petition to rezone from Conservancy Recreation to General Agriculture in the Town of McMillan. Supervisor Leur asked about the conservancy nature of the property; Pogle explained it currently has a home and horse riding stable, and the rezoning would make the home a conforming use rather than non-conforming. No natural areas would be lost. The Town Board recommended approval on April 20, 2026. Supervisor Sefeld moved to approve, seconded by Supervisor Drew. Motion carried unanimously." },
      { item:"Fee waiver for April 17, 2026 tornado-damaged properties", body:"Director Lori Mskimmons presented a proposal to waive county zoning and septic system fees for properties damaged by the April 17th tornado affecting Towns of Ringle, Easton, and villages of Kronenwetter and Weston. Supervisor Drew questioned where to draw the line for future disasters. Supervisor Drebeck expressed concern about fairness to property owners hit by disasters not declared emergencies. Marilyn Bend asked about septic hookup costs. After debate, Supervisor Drebeck moved to amend the proposal to only waive reconnect fees ($160) for septic systems, not other zoning or septic fees. The amendment was seconded by Supervisor Kurt and passed. The amended resolution was then approved on a non-unanimous voice vote to forward to the county board." },
      { item:"Solid Waste Department presentation", body:"Director David Hagenbusher provided an overview of landfill operations, explaining the facility has operated since 1980 and accepts about 1,000 tons daily. He highlighted the 2023 partnership with Vidi Energy to convert landfill gas to renewable natural gas, the $6 million 11-acre expansion starting this year, and the requirement by 2032 to install on-site leachate treatment due to PFAS concerns. Current hauling costs are approximately $90,000 per month." },
      { item:"Parks, Recreation and Forestry presentation", body:"County Forest Administrator Tom Lovelin presented on behalf of Director Jamie, covering the department's 44 full-time and 120 seasonal employees serving both county and city facilities. He noted Nine Mile County Forest generates $3.25 million annually for the local economy from out-of-town visitors. Supervisor Sefeld announced Tom Lovelin is retiring June 1st after nearly 30 years of service, with Joe Tucker selected as his replacement." },
    ],
    publicComment: "No public comment was offered. No one signed up for public comment at the beginning of the meeting, and no members of the public spoke during the public hearing portions for either rezoning petition.",
    actionItems: [
      "Forward rezoning approval for James Offer and David Trait property (Urban Residential\/General Agriculture to Rural Residential) to County Board",
      "Forward rezoning approval for Jeffrey and Cynthia Schmidtz property (Conservancy Recreation to General Agriculture) to County Board",
      "Forward amended resolution to County Board recommending waiver of only septic system reconnect fees ($160) for properties damaged by April 17, 2026 tornado, with one-year duration from county board approval",
      "Town of Green Valley and Town of McMillan should update comprehensive plans to reflect zoning changes if applicable",
      "CPZ staff to track costs and requests related to tornado fee waiver program",
    ],
  },
  {
...
const SCHOOL_BOARD_UPCOMING = [
  { date:"2026-05-11", time:"5:00 PM", name:"Regular Meeting", url:"https://meetings.boardbook.org/Public/Agenda/1360?meeting=744112", source:"school_board" },
...
const WESTON_UPCOMING = [
  ...
  { date:"2026-05-12", time:"6:00 PM", name:"S.A.F.E.R. Board of Directors", url:"https://www.westonwi.gov/agendacenter", source:"weston" },
  { date:"2026-05-18", time:"5:30 PM", name:"Finance & Human Resources Committee", url:"https://www.westonwi.gov/agendacenter", source:"weston" },
