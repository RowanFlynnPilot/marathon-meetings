...
const SOURCE_CONFIG = {
  marathon: {
    ...
    avatar:   BASE_URL + "marathon-avatar.jpg",
  },
  wausau: {
    ...
    avatar:   BASE_URL + "wausau-avatar.jpg",
  },
  weston: {
    ...
    avatar:   BASE_URL + "weston-avatar.jpg",
  },
  school_board: {
...
const MEETINGS = [
  {
    ...
    date: "May 27, 2026", shortDate: "MAY 27",
    committee: "Public Works", duration: "~1h",
    url: "https://www.youtube.com/watch?v=j64Gj2ean2k",
    docUrl: null,
    isAgendaOnly: false,
    badge: "new",
    overview: "The Public Works Committee approved several infrastructure-related items including a transportation funding resolution, a recycled asphalt crushing contract, and construction service proposals. Staff reported on receiving a $800,000+ grant for Birch Street reconstruction and discussed ongoing road repairs, utility projects, and a significant sanitary sewer clear water infiltration problem costing the village tens of thousands in extra treatment costs.",
    agenda: [
      { time:"0:09", item:"Call to order" },
      { time:"0:28", item:"Pledge of Allegiance" },
      { time:"0:56", item:"Roll call" },
      { time:"1:15", item:"Public comment" },
      { time:"1:22", item:"Approval of April 13, 2026 meeting minutes" },
      { time:"1:38", item:"Acknowledge April 2026 water and sewer permits" },
      { time:"1:53", item:"CIP update" },
      { time:"20:01", item:"Street operations update" },
      { time:"30:01", item:"Utility operations update" },
      { time:"45:01", item:"Review 2025 Water Utility PSC annual report" },
      { time:"50:00", item:"Resolution 2026-014 transportation funding" },
      { time:"55:04", item:"Recycled base course production contract" },
    ...
    discussions: [
      { item:"CIP Update", body:"Michael reported the village received a local road improvement grant for Birch Street reconstruction between Schofield Avenue and Community Center Drive, covering over 50% of the estimated $1.5 million project cost. The project will be moved from 2029 to 2028. He noted the village has received over $9 million in grant funding over the past 4-5 years. Discussion also covered Weston Avenue road settlement repairs by Integrity Grading and Excavating, and Schofield Avenue repairs by HOS Construction including manhole and concrete work." },
      { item:"Street Operations Update", body:"Staff reported on spring road activities including removing road limits on April 29th, mailbox repairs, sign repairs, and shoulder damage repairs. Significant discussion occurred about flooding issues near Weston Avenue requiring dewatering pumps for approximately one week. Committee members discussed potential permanent pump solutions and drainage improvements. Spring sweeping, patching with hot mix, and storm damage cleanup were completed. A culvert failure on Jones Street required installation of a third 18-inch culvert." },
      { item:"Utility Operations Update", body:"Josh reported on water service repairs, well maintenance, and ongoing sanitary sewer issues. A significant clear water infiltration problem was identified - in April, the village pumped 37 million gallons into the water system but treated nearly 54 million gallons at the wastewater plant, meaning approximately 15 million gallons of clear water entered the sanitary system. This is attributed to sump pumps illegally connected to sanitary sewers and groundwater infiltration. An INI study with In-Pipe Technologies is planned to identify problem areas." },
      { item:"2025 Water Utility PSC Annual Report", body:"Michael presented the annual report showing net operating income of $482,911 for 2025, consistent with 2024's $490,000. Water loss was 6%. The utility value increased to nearly $34 million with $6.7 million in infrastructure added. The utility serves approximately 6,100 customers total - 5,250 in Weston, 830 in Rothschild, and 5 in other areas. Motion to acknowledge passed unanimously." },
      { item:"Resolution 2026-014 Transportation Funding", body:"Michael explained this League of Wisconsin Municipalities resolution supports long-term funding solutions for the state transportation fund, noting that while grant funding helps one-time costs, recurring annual costs for street maintenance and snow plowing are inadequately funded by the state. The committee voted to recommend the village board adopt the resolution. Motion passed unanimously." },
      { item:"Recycled Base Course Production", body:"Michael reported King Gravel submitted the low bid at $4.23 per ton for crushing approximately 30,000 tons of recycled material, totaling $126,900. He noted this program saves the village approximately $11 per cubic yard compared to purchasing material, resulting in about $130,000 savings across the three 2026 projects. Motion to award to King Gravel passed unanimously." },
      { item:"Sanitary Sewer Discharge Violation Discussion", body:"Staff sought guidance on fining residents who illegally discharge clear water (primarily sump pumps) into the sanitary sewer system. Current code allows fines of $100-$1,000 per day per violation. Committee members discussed distinguishing between unknowing and willful violations. Michael noted March treatment costs were $30,000 higher than last year and April was $42,000 higher due to excess flow. Committee directed staff to develop enforcement language with fines not exceeding $100 per day. Motion passed unanimously." },
      { item:"Water and Sewer Connection Agreement - Radkey Avenue", body:"Michael explained a builder wants to construct a duplex on Lot 1 at 2230 Radkey Avenue, which currently lacks water\/sewer main frontage. Staff proposed allowing a temporary long lateral connection until Radkey Avenue is reconstructed. Committee amended the agreement to specify reconstruction no later than 2029, at which time the owner will pay assessment costs for main extension. Motion passed unanimously." },
      { item:"Military Road Construction Agreement", body:"The committee approved an intergovernmental agreement with Village of Rothschild for Military Road construction from Wolfman Street to Helin Street. Weston's share covers utility relocation costs of $94,860 ($6,156 for sanitary sewer, $88,704 for water main). Steam Construction is the contractor. Motion passed unanimously." },
      { item:"Construction Service Proposals", body:"Michael presented proposals for construction inspection services on two projects. For the Alderson\/Jelinek roundabout project, MSA submitted the low proposal at $37,315 versus Clark Dietz at $48,910. For Bladel Avenue, MSA was lower at $70,400 versus Clark Dietz at $73,730, but staff recommended Clark Dietz due to having a full-time experienced inspector rather than a summer intern. Committee approved MSA for the roundabout and Clark Dietz for Bladel Avenue. Motion passed unanimously." },
    ],
    publicComment: "No public comment was offered.",
    actionItems: [
      "Approve Resolution 2026-014 supporting state transportation funding solutions",
      "Award recycled asphalt crushing contract to King Gravel at $4.23\/ton (estimated $126,900)",
      "Staff to develop sanitary sewer discharge violation enforcement language with fines not exceeding $100\/day",
      "Approve Radkey Avenue water\/sewer connection agreement with reconstruction deadline no later than 2029",
      "Approve Military Road construction agreement with Rothschild for $94,860 in utility costs",
      "Award Alderson\/Jelinek roundabout construction services to MSA ($37,315)",
      "Award Bladel Avenue construction services to Clark Dietz ($73,730)",
      "Special assessment meeting scheduled for Thursday, May 28, 2026 at 6:00 p.m.",
  ...
  },
  {
    ...
    isAgendaOnly: false,
    badge: "new",
    overview: "The Village of Weston Plan Commission approved the site plan for the new Mountain Bay Metropolitan Police Department and Municipal Court facility at 3600 Community Center Drive, and adopted a new salt storage shed inspection program for wellhead protection areas. Both items passed unanimously with the commission addressing building orientation challenges due to a gas pipeline easement.",
    agenda: [
      ...
      { time:"28:12", item:"April 2026 staff approved certified survey maps and site plans" },
      ...
      { time:"31:15", item:"Future agenda items and staff remarks" },
      { time:"34:40", item:"Adjournment" },
    ],
    discussions: [
      { item:"Site plan review - Mountain Bay Metro Police Department and Municipal Court facility", body:"Staff presented the site plan for the new police department and municipal court at 3600 Community Center Drive, noting it meets all B2 zoning requirements. Chief Jeremy explained the building was rotated to face east due to a 36-inch gas pipeline running through the property, which significantly reduced fill costs. The building is designed for 50-60 officer capacity versus the current 40 officers. Discussion included an alternate storage shed placement, with commissioners suggesting moving it north to accommodate future expansion. A motion to recommend approval to the board of trustees with staff conditions 2-5 passed unanimously." },
      { item:"Salt storage shed inspection program for wellhead protection district", body:"Staff proposed two annual inspections per facility - a warm weather inspection focusing on structural integrity and drainage, and a winter operational inspection focusing on material handling and containment. The program includes a standardized inspection worksheet similar to DOT requirements. Staff noted one existing facility near Sternberg that predates the wellhead protection ordinance and has never gone through the conditional use process. Commissioners agreed staff should reach out to bring them into compliance. Motion to approve the program with reporting to both Plan Commission and Public Works passed unanimously." },
      ...
      { item:"Planning department monthly update", body:"Staff announced the first joint Plan Commission-Village Board steering committee meeting for the comprehensive plan is scheduled for Monday, June 1st at 5:00 p.m. Staff will send calendar invites. Discussion touched on potential residential TIF districts for workforce housing, with commissioners requesting Ehlers' presentation on residential TIF qualifications be shared, possibly incorporated into comprehensive plan discussions." },
    ],
    publicComment: "Jim Penson of 5002 Arrow Street, Weston, spoke via remote connection. He requested the commission urge staff to waive excessive landscaping requirements for the police department project similar to what was done for the Greenheck Turner building to save taxpayer dollars. He also asked that the salt shed inspection program include annual reporting on inspections conducted and results, noting some zoning complaints are years old and get 'lost in the sauce.'",
    actionItems: [
      ...
      "Salt storage shed inspection program approved for implementation with reporting to Plan Commission and Public Works Committee",
      "Staff to reach out to existing salt storage facility near Sternberg that predates wellhead protection ordinance about compliance",
      "Staff to conduct first round of salt shed inspections summer 2026 and winter 2026, reporting back around May 2027",
      "Joint Plan Commission-Village Board steering committee meeting for comprehensive plan scheduled June 1st at 5:00 p.m.",
      "Staff to send Ehlers presentation on residential TIF qualifications to commissioners",
      "Electric vehicle charging stations to be future agenda item in fall 2026",
    ],
  },
  {
    ...
    isAgendaOnly: false,
    badge: "new",
    overview: "The Marathon County Health & Human Services Committee held an introductory meeting for new board members, featuring educational presentations from the Health Department, Social Services, Veteran Service Office, and Aging Disability Resource Center. The committee approved April 1st meeting minutes unanimously and received comprehensive overviews of department missions, budgets, and current initiatives including homelessness response, veteran services, and nutrition programs.",
    agenda: [
      { time:"0:00", item:"Call to order and roll call (remote participation noted)" },
      { time:"0:30", item:"Pledge of Allegiance" },
      { time:"1:15", item:"Approval of April 1st committee meeting minutes" },
      { time:"2:00", item:"Operations functions required by statute - overview of agenda structure" },
      { time:"4:30", item:"Review of standing committee ordinance section 2.04 - missions, duties, responsibilities" },
      { time:"12:30", item:"Health Department educational presentation" },
      { time:"20:00", item:"Health Department budget overview" },
      { time:"40:00", item:"Social Services Department overview" },
      { time:"50:00", item:"Veteran Service Office presentation" },
    ...
    discussions: [
      ...
      { item:"Health Department presentation", body:"Health Officer Caitlyn Suginaka presented an overview of the department's four divisions: environmental health, nursing (communicable disease and family health), community health improvement, and administration. She highlighted 1,200 licenses overseen, public health vending machines stocked with free tick kits, the Nurse Family Partnership program's first graduates, and a new FTE position for homeless system response. The department has approximately 37.6 FTE staff and a 2026 budget of about $5 million, with roughly half from tax levy." },
      { item:"Social Services Department overview", body:"Administrator Leonard presented on behalf of Director Christa who was absent. He described the department's divisions including child welfare, youth justice, children's long-term support, economic support, and child support. With nearly 140 FTE, it's the second largest department. He highlighted the successful Family Keys housing stability pilot program and noted potential restructuring requests coming due to increased need in areas like child support." },
      { item:"Veteran Service Office presentation", body:"Veteran Service Officer Aaron Galindo reported the office increased to 3.0 FTE and had 8,149 interactions in 2025, up from 5,900. He noted veterans received $2.6 million in retroactive VA payments and $44 million annually in benefits. Key initiatives include surviving spouse benefits outreach, housing stability partnerships with Center for Veterans Issues, and suicide prevention efforts after 7 of 30 county suicides in 2025 were veterans. Supervisor Kremes asked about regional coordination; Galindo explained state statute requires each county have its own VSO." },
      { item:"Aging Disability Resource Center presentation", body:"Executive Director Mike Ray explained the ADRC serves four counties (Marathon, Lincoln, Langlade, Wood) with about 60 FTE and 385-400 volunteers. He described services including information assistance, caregiver support, dementia care, falls prevention, Medicare counseling, and Meals on Wheels. Ray noted significant financial challenges with federal nutrition funding flat since 2024 while food costs increased 40-45%, requiring meal and staffing reductions. Marathon County's 2026 contribution is $413,135." },
      { item:"Strategic plan discussion", body:"Chair Boots noted the county completed its comprehensive plan last session and will develop a new strategic plan by December. He indicated he will bring strategic plan items to future meetings to ensure committee work aligns with county goals." },
    ],
    publicComment: "No public comment was offered.",
    actionItems: [
      ...
      "Committee members to email Chair Boots and Administrator Leonard with suggested future agenda items",
  ...
  },
  {
    ...
    isAgendaOnly: false,
    badge: "new",
    overview: "The Marathon County Board held an organizational meeting where they approved committee appointments, elected Supervisors Hapa and Arstead to the Executive Committee, and unanimously approved a resolution reducing landfill tipping fees for storm debris from the recent tornado and flooding disaster. The board heard emotional testimony from affected Ringle residents requesting fee waivers for disaster cleanup.",
    agenda: [
      { time:"0:00", item:"Pledge of Allegiance and moment of reflection" },
      { time:"0:30", item:"Reading of meeting notice" },
      { time:"1:30", item:"Roll call of 38 supervisors" },
      ...
      { time:"21:30", item:"Resolution 26-26: Landfill tipping fees modification for disaster relief" },
      { time:"1:15:00", item:"Announcements and adjournment" },
    ],
    discussions: [
      { item:"Committee Appointments", body:"Chair Gibbs presented committee appointments developed with Vice Chair Boots, emphasizing goals of increasing diversity of perspectives, developing new supervisors as leaders, and respecting supervisor preferences. He noted 34% of the board is in their first or second term. The motion by Supervisor Cavelli and seconded by Supervisor Crims was carried but not unanimous. Supervisor Enzy noted he was marked absent but wanted to be recorded as voting aye." },
      { item:"Election of At-Large Executive Committee Members", body:"Three supervisors were nominated: Supervisor Hapa (nominated by Supervisor Mask), Supervisor Leur (nominated by Supervisor Rosenberg), and Supervisor Arstead (nominated by Vice Chair Boots). Supervisor Rosenberg explained she nominated Supervisor Leur because she had seen her advocate for the county's smallest children and oldest elders. Paper ballots were distributed and supervisors voted for two candidates. Supervisors Hapa and Arstead were elected to the Executive Committee." },
      { item:"Resolution 26-26: Landfill Tipping Fees Modification", body:"Administrator Leonard and Solid Waste Director Hagen Busher presented a proposal to reduce tipping fees for disaster debris following the tornado and flooding. The proposal reduces fees from $65\/ton to approximately $36.94\/ton by waiving the state fee ($13.10), town of Ringle fee ($2.33), and reducing to the commercial rate. Two residents, Jessica Toasty and Matt Haybeck, were granted special permission to speak, requesting the county wave all fees. Leonard mentioned exploring a partnership with the Community Foundation to help residents with unreimbursed costs. The board voted unanimously to suspend rules to consider the resolution, then approved Resolution 26-26 unanimously." },
      { item:"Consent Agenda", body:"Items C10 through C14A were approved on consent. Motion by Supervisor Cavelli, seconded by Supervisor Drebeck. Passed unanimously." },
    ...
    publicComment: "Two residents were granted special permission to speak on the landfill tipping fee resolution. Jessica Toasty requested Marathon County wave all fees for disaster victims, noting the state, DNR, and Ringle are waiving their fees, and that private businesses have donated $40,000+ in cleanup efforts. She requested a six-month timeline. Matt Haybeck spoke on behalf of residents whose homes must be demolished, noting some insurance adjusters haven't arrived yet and requesting more time and fee relief for underinsured residents.",
    actionItems: [
      ...
      "Resolution 26-26 approved reducing landfill tipping fees for disaster debris through June 17, 2025",
      "Solid Waste Management Board directed to develop a long-term policy for handling similar disaster situations within six months",
      "Administrator Leonard to explore partnership with Community Foundation for reimbursing residents' out-of-pocket disposal costs",
      "Staff to track all disaster-related debris with certification forms for potential state disaster aid documentation",
    ],
  },
  {
    ...
    isAgendaOnly: false,
    badge: "new",
    overview: "The Marathon County Environmental Resources Committee approved two rezoning petitions unanimously and voted to forward a modified fee waiver resolution to the full county board that will only cover septic system reconnect fees for properties damaged by the April 17, 2026 tornado. The committee also received educational presentations from the Solid Waste, Parks Recreation and Forestry, and Conservation Planning and Zoning departments.",
    agenda: [
      ...
      { time:"1:18:30", item:"Educational presentation: Parks, Recreation, and Forestry Department overview" },
      { time:"1:35:00", item:"Educational presentation: Conservation, Planning, and Zoning Department overview" },
    ],
    discussions: [
      ...
      { item:"Tim Veland rezoning petition (Town of Green Valley)", body:"Land Use Specialist Garrett Pogle presented the staff report for rezoning from Urban Residential and General Agriculture to Rural Residential for a land division. The Town of Green Valley recommended approval on March 10, 2026. No public comment was offered. Supervisor Drebeck moved to approve based on findings of fact and conclusions of law, seconded by Supervisor Kurt. Motion carried unanimously." },
      { item:"Jeffrey and Cynthia Schmidtz rezoning petition (Town of McMillan)", body:"Garrett Pogle presented the petition to rezone from Conservancy Recreation to General Agriculture. Supervisor Leur asked about the conservancy nature, and Pogle explained the property contains a home and horse riding stable, and rezoning would make the non-conforming home use conforming. He confirmed no natural areas would be lost. The Town of McMillan recommended approval on April 20, 2026. Supervisor Sefelt moved to approve, seconded by Supervisor Drew. Motion carried unanimously." },
      { item:"Fee waiver for April 17, 2026 severe weather victims", body:"Director Lori Mskimmons presented a proposal to waive county zoning and septic fees for properties damaged by the April 17 tornado affecting the towns of Ringle, Easton, and villages of Kronenwetter and Weston. Supervisor Drew questioned where to draw the line for future events. Supervisor Leur asked about potential levy impacts. Supervisor Drebeck expressed concern about fairness to victims of non-declared disasters and proposed an amendment to only waive reconnect fees ($160) for septic systems rather than all fees. The amendment was seconded by Supervisor Kurt and passed. The amended resolution to forward to the county board also passed, though not unanimously." },
      { item:"Solid Waste Department presentation", body:"Director Dave Hagen Busher presented an overview of solid waste operations including the landfill's history since 1980, the renewable natural gas partnership with Vidi Energy launched in 2023, and challenges with leachate treatment due to PFAS regulations requiring on-site treatment by 2032. He noted significant capital expenses including $6 million for 11-acre construction and $3-4 million closures. Marilyn Bend praised the department's work helping Ringle tornado victims." },
      { item:"Parks, Recreation, and Forestry Department presentation", body:"Tom Lovelin, County Forest Administrator, presented on behalf of Director Jamie who had an emergency. He covered the joint city-county department structure with 44 full-time and 120 seasonal employees, 17 county parks, 30,700 acres of county forest, and Nine Mile County Forest recreation. A study showed out-of-town visitors generate $3.25 million annually for Marathon County. Supervisor Sefelt announced Lovelin's retirement effective June 1st after nearly 30 years of service." },
    ],
    publicComment: "No public comment was offered. No one signed up for public comment and no one spoke during the public hearing portions for either rezoning petition.",
    actionItems: [
      "Forward amended resolution to county board waiving only reconnect fees for septic systems for tornado-damaged properties",
      "Forward James Offer\/David Tract rezoning approval to Marathon County Board of Supervisors",
      "Forward Jeffrey and Cynthia Schmidtz rezoning approval to Marathon County Board of Supervisors",
      "Town of Green Valley and Town of McMillan should update comprehensive plans to reflect zoning changes if applicable",
      "Conservation department to provide special educational meeting on conservation topics in summer",
    ],
  },
  {
    ...
    isAgendaOnly: false,
    badge: "new",
    overview: "The Village of Weston Community Life and Public Safety Committee approved amendments to the nuisance ordinance, recommended an e-bike ordinance with emoto restrictions, approved fire inspection requirements for mobile food vendors, and authorized demolition of an abandoned structure. Public comment raised concerns about the new farmers market location and parking on grass potentially violating village code.",
    agenda: [
      { time:"0:15", item:"Call to order and Pledge of Allegiance" },
      { time:"0:45", item:"Roll call" },
      { time:"1:00", item:"Public comments" },
      { time:"5:00", item:"Minutes from previous meetings" },
      { time:"5:30", item:"Department reports - Code Enforcement, Fire\/EMS, Police" },
      { time:"11:30", item:"Proposed amendments to Chapter 50 Nuisances" },
      { time:"13:00", item:"E-bicycle ordinance in Chapter 82 Traffic and Vehicles" },
      { time:"33:30", item:"Overnight parking regulations October 31st to May 1st" },
      { time:"51:00", item:"Crosswalk request on Alderson Street" },
      { time:"1:01:30", item:"Mobile food vendors fire inspection requirements" },
      { time:"1:10:00", item:"Address corrections for E911 compliance" },
      { time:"1:15:30", item:"Raze order for 4104 Shore Avenue" },
    ],
    discussions: [
      { item:"Department Reports", body:"Code Enforcement Officer Audrey reported that 3020 Mountain View Avenue will be removed from the code enforcement list after the property sale was completed and new owner submitted repair permits. Chief Hunt reported 2,394 police calls in March (77 per day), 410 traffic stops, and 281 citations. The police department has hired its 40th officer. Two SROs work with code enforcement during summer for zoning violations and pet licensing. Motion to acknowledge reports 5, 6, and 7 passed unanimously." },
      { item:"Chapter 50 Nuisances Amendments", body:"The committee reviewed final amendments including tree limb height requirements of 14 and 10 feet over streets and walkways. Motion by Olsen, seconded by Campkey, to recommend approval to the Board of Trustees passed unanimously." },
      { item:"E-bicycle Ordinance", body:"Extensive discussion focused on emotos (electric dirt bikes). Chief Hunt strongly advocated prohibiting emotos on roadways and sidewalks, comparing them to unlicensed dirt bikes. Discussion included whether electric scooters used by children should be exempted, with the committee deciding to rely on officer discretion. Motion by Olsen, seconded by Sherwanka, to recommend approval with the addition of prohibiting emotos on roadways, sidewalks, trails, and public property passed unanimously. Rothschild has not yet approved; Schofield declined to participate." },
      { item:"Overnight Parking Regulations", body:"Trustee Tolson presented research showing Weston's 12-hour parking restriction (4am-4pm) is significantly longer than surrounding municipalities which typically use 5-hour windows. Michael from Public Works suggested potentially eliminating overnight parking and just signing 6-8 problem areas. Chief Hunt opposed eliminating overnight parking, noting $10 citations help clear streets before plowing begins. Committee decided to table the item until July so Michael can identify specific exception areas." },
      { item:"Crosswalk Request on Alderson Street", body:"Mount Olive Church requested a crosswalk between the church and DC Everest parking lot. Committee discussed whether to install a basic crosswalk ($2-3K) or lighted system ($25-30K). Committee consensus was that Mount Olive should pay for installation if they want it. Motion by Olsen, seconded by Sherwanka, to recommend board approval if Mount Olive agrees to cover costs passed unanimously." },
      { item:"Mobile Food Vendors Fire Inspection", body:"Fire department presented regional fire inspection program involving Wisconsin Rapids, Marshfield, Stevens Point, Plover, Rib Mountain, and Weston. One inspection and sticker would be valid across all participating municipalities. Fire Marshal Marty already inspected one truck that failed due to improper LP piping. Wausau opted out to continue their own inspections. Motion by Sherwanka, seconded by Campkey, to approve Ordinance 26-8 passed unanimously." },
      { item:"Address Corrections", body:"Staff presented three addressing errors: 5915 Delicoski Street (duplex needing separate addresses), Ross Avenue properties out of sequence, and 2211 Radkey Avenue near a new duplex development. Chief Hunt noted an additional issue at Weston Villa Apartments with eight separate addresses for one structure. Motion passed unanimously to recommend approval." },
      { item:"Raze Order for 4104 Shore Avenue", body:"Structure has been abandoned since 2010-2011 and on code enforcement since 2021. Fire department previously declined to do a training burn due to unsafe conditions. Owners had housed chickens in the abandoned structure. Current owners prefer demolition with costs added to their tax roll rather than paying out of pocket. They are current on taxes. Motion by Olsen, seconded by Campkey, to authorize raze order passed unanimously." },
    ],
    publicComment: "Jim Senalt spoke regarding the new farmers market location, expressing concern that parking vehicles on grass would destroy the park and potentially violates village code prohibiting grass parking. He noted ADA handicap spaces are signed on grass rather than adjacent asphalt, creating accessibility issues for wheelchair users. He questioned the origin of new fire inspection requirements for food trucks and raised concerns about mobile food vendor regulations on public property. He also criticized the age of some code enforcement cases, noting some have been pending for years with no visible progress.",
    actionItems: [
      "Recommend Chapter 50 Nuisances amendments to Board of Trustees for May agenda",
      "Recommend e-bike ordinance with emoto prohibition to Board of Trustees",
      "Michael to develop list of specific areas requiring even\/odd parking signage for July meeting",
      "Michael to contact Mount Olive Church regarding crosswalk cost-sharing; if agreed, proceed to board approval",
      "Ordinance 26-8 for mobile food vendor fire inspections approved",
      "Address corrections for Delicoski, Ross, and Radkey properties to proceed",
      "Staff authorized to begin raze order process for 4104 Shore Avenue",
            ...
            <div style={{ border: `1px solid ${RULE}`, overflow: "hidden" }}>
              ...
              <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", borderTop: `1px solid ${RULE}` }}>
                ...
                <div>
                  ...
                  {actions.length === 0 && (
                    <div style={{ padding: "16px 14px", fontFamily: "'Lora', Georgia, serif", fontSize: "13px", color: "#666", fontStyle: "italic" }}>
                    ...
                    <div style={{ display: "flex", gap: "1px", padding: "12px 14px" }}>
                      ...
                      {v.no.length === 0 && (
                        <div style={{ flex: 1, textAlign: "center" }}>
                          ...
                          <div style={{ fontFamily: "'Lora', Georgia, serif", fontSize: "28px", fontWeight: 700, color: "#666" }}>0</div>
                        </div>
                      )}
                    </div>
                  </div>
...
const labelStyle = { fontFamily: "'Bebas Neue', sans-serif", fontSize: "10px", letterSpacing: "0.18em", color: "#5a5a5a", marginBottom: "12px", paddingBottom: "5px", borderBottom: `1px solid ${RULE}` };
...
const WAUSAU_UPCOMING = [
  ...
  { date:"2026-06-02", time:"10:00 AM", name:"Board of Public Works Meeting", url:"https://wausauwi.portal.civicclerk.com/event/2361/overview", source:"wausau" },
  ...
  { date:"2026-06-09", time:"2:00 PM", name:"Board of Public Works Meeting", url:"https://wausauwi.portal.civicclerk.com/event/2362/overview", source:"wausau" },
  ...
  { date:"2026-06-15", time:"5:15 PM", name:"Public Health & Safety Committee Meeting", url:"https://wausauwi.portal.civicclerk.com/event/2070/overview", source:"wausau" },
];
                      ...
                      <div key={i} style={{ position: "relative" }}>
                        ...
                        {isOpen && (
                          <div style={{
                            ...
                            {[
                              { label: "Google Calendar",      icon: BASE_URL + "cal-google.png",  href: urls.google  },
                              { label: "Outlook / Office 365", icon: BASE_URL + "cal-outlook.png", href: urls.outlook },
                            ].map(opt => (
                              <a
                                key={opt.label}
                                href={opt.href}
  ...
  return (
    <>
      ...
      <div style={{ display: "flex", flexDirection: "column", height: "100vh" }}>
        ...
        <header style={{ background: TEAL, flexShrink: 0, borderBottom: `3px solid #1a5c57` }}>
          <div style={{
        ...
        <main style={{ display: "flex", flex: 1, overflow: "hidden", flexDirection: isMobile ? "column" : "row" }}>
          ...
          {showList && (
            <nav aria-label="Meetings list" style={{
              ...
              <div style={{ padding: "12px 14px 10px", borderBottom: `2px solid ${RULE}`, background: CREAM }}>
                <div style={{ fontFamily: "'Bebas Neue', sans-serif", fontSize: "10px", letterSpacing: "0.18em", color: "#5a5a5a", marginBottom: "10px" }}>RECENT MEETINGS</div>
              ...
              {selected
                ...
                : (
                  <div style={{ flex: 1, display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", background: CREAM, gap: "14px", padding: "0 24px", textAlign: "center" }}>
                    ...
                    <div style={{ fontFamily: "'Lora', Georgia, serif", fontSize: "15px", color: "#5a5a5a", maxWidth: "440px", lineHeight: 1.55 }}>
