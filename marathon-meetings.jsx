...
const MEETINGS = [
  {
    ...
    isAgendaOnly: false,
    badge: "new",
    overview: "The Village of Weston Parks Committee approved selecting Rettler Corporation for the Mock Mueller Park master plan, reviewed successful grant funding for the Yellow Banks kayak launch project, and discussed park impact fees and ice rink operations. The committee provided input supporting a moderate increase in park impact fees to align with neighboring communities.",
    agenda: [
      { time:"0:05", item:"Call to order and Pledge of Allegiance" },
      { time:"0:51", item:"Approval of minutes from February 23rd, 2026" },
      { time:"1:13", item:"Public comments" },
      { time:"6:00", item:"Review of parks and recreation impact fee discussion" },
      { time:"26:09", item:"Request for proposals for Mock Mueller Park master plan and budget estimates" },
      { time:"31:16", item:"Review of Yellow Banks kayak launch expenses" },
      { time:"36:52", item:"Discussion on components of operations for ice rink at Kennedy Park" },
      { time:"50:18", item:"Future items and next meeting date" },
      { time:"50:38", item:"Remarks from staff and committee members" },
      { time:"53:34", item:"Adjournment" },
    ],
    discussions: [
      { item:"Approval of minutes from February 23rd, 2026", body:"Motion to accept the minutes was made and seconded. The motion carried unanimously with no discussion." },
      { item:"Review of parks and recreation impact fee discussion", body:"Jennifer presented information on park impact fees, explaining that a 2020 study allowed fees up to $761 for single family units but the village only raised them to $300. Neighboring communities charge $600-$900 for single family units. Committee members expressed support for a moderate increase to stay competitive with neighbors and fund park amenities like trails. Esker stated 'we need to get, you know, we want to keep our parks nice.' Katrina supported increasing to 'be more in line' with other communities but preferred moderate over maximum increases. No formal action was taken; input will be provided to the Plan Commission." },
      { item:"Request for proposals for Mock Mueller Park master plan", body:"The committee received seven proposals for the park master plan. Four staff members reviewed and rated proposals based on firm experience, personnel experience, similar projects, scope understanding, and cost. After discussion comparing Rettler Corporation and JSD as the two lowest bidders with relevant experience, Roger made a motion to select Rettler Corporation. Katrina seconded. The motion carried unanimously." },
      { item:"Review of Yellow Banks kayak launch expenses", body:"Jessica compiled a detailed expense report showing the project received significant grant funding from DNR and Marathon County, with the county covering full costs for the ADA-accessible dock. Additional unforeseen expenses included subgrade issues and an abandoned well casing. Committee members praised the staff work, with Katrina stating 'this in my opinion was a huge success.' Lisa Beck during public comment also complimented the RFC as 'super well written.' The committee acknowledged contributions from Dan Higginbotham, MTS, and PGA. No formal action was required; this was an informational item." },
      { item:"Components of operations for ice rink at Kennedy Park", body:"Staff presented information on ice rink operations noting the warming house has been unstaffed since 2020 due to COVID and subsequent staffing shortages. The rink remains well-used when weather permits. Discussion covered Everest Youth Hockey's interest in potentially building a covered rink structure at Kennedy Park. Katrina explained her request was to ensure 'we don't lose sight of hockey' while focusing on baseball facilities. Staff will bring back historical attendance figures from 2018-19 seasons and additional information for next month." },
    ],
    publicComment: "Jim Pinsel expressed frustration about not receiving responses to his previous written questions regarding playground equipment installation, Kennedy Park fundraising, and ice rink costs. He argued the $1,320 reported ice rink cost doesn't include staff hours and actual costs are closer to $20,000-$30,000. Lisa Beck of 1808 Cortez Lane thanked staff for handling the blizzard and complimented the Yellow Banks kayak launch RFC as well-written. A written response to Jim Benson from last month was submitted and will be included in the minutes.",
    actionItems: [
      "Rettler Corporation selected for Mock Mueller Park master plan (approved unanimously)",
      "Jennifer to present park impact fee comparisons with neighboring communities to Plan Commission next month",
      "Staff to bring back ice rink attendance figures from 2018-19 seasons and additional user feedback",
  ...
  },
  {
    ...
    isAgendaOnly: true,
    badge: "new",
    overview: "Based on the published agenda, the Village of Weston Board of Trustees was scheduled to meet on March 23, 2026, to consider multiple rezoning ordinances, a subdivision plat approval, parking restriction changes, infrastructure projects, and various parks and recreation matters. The meeting also included discussion items on e-bicycle regulations, street maintenance planning, and an April referendum informational session update.",
    agenda: [
    ...
    discussions: [
      { item:"Ordinance No. 26-004: Rezoning of 8905 Birch Street", body:"The Board was scheduled to consider rezoning a portion of 8905 Birch Street from Rural Residential-5 Acre (RR-5) to Single Family Residential-Small Lot (SF-S). This zoning change was expected to enable different residential development options on the property." },
      { item:"Ordinance No. 26-005: Rezoning of 7105 Christiansen Avenue", body:"The Board was set to review rezoning a portion of 7105 Christiansen Avenue from Single Family Residential-Large Lot (SF-L) to Single Family Residential-Small Lot (SF-S). This change was expected to allow for smaller lot residential development on the property." },
      { item:"Ordinance No. 26-006: Speed Limits Amendment", body:"The Board was scheduled to consider amendments to Chapter 82.600 of the Municipal Code regarding speed limits. The specific street locations and proposed speed limit changes were expected to be detailed in the ordinance." },
      { item:"Resolution No. 2026-008: Hinner Springs Second Addition Subdivision", body:"The Board was expected to consider approval of the final plat for the Hinner Springs Second Addition Subdivision. This action would authorize the next phase of development in this residential subdivision." },
      { item:"April 2026 Referendum Informational Sessions Update", body:"The Board was scheduled to receive an update on informational sessions planned for an April 2026 referendum. This discussion-only item was expected to inform trustees about public outreach efforts related to the upcoming vote." },
      { item:"Proposed E-Bicycle and E-Moto Ordinance", body:"The Board was set to discuss whether to direct the Community Life and Public Safety Committee to develop regulations for e-bicycles and e-moto vehicles. This item was expected to address growing use of electric-powered personal transportation in the village." },
      { item:"Removal of No Parking Restrictions", body:"The Board was scheduled to consider removing no parking restrictions on Alta Verde Street south of Jelinek Avenue and on Alderson Street along Kennedy Park. This action was expected to provide additional parking options for residents and park users." },
      { item:"2026 Annual Street Maintenance Plan and Budget", body:"The Board was expected to review and potentially approve the 2026 annual street maintenance plan and associated budget. This item was scheduled to outline the village's roadway repair and improvement priorities for the year." },
      { item:"Baseball\/Softball Field Maintenance and User Agreement", body:"The Board was set to consider a maintenance and user agreement for baseball and softball fields. This was expected to address responsibilities and terms for organizations using village athletic facilities." },
      { item:"Park Shelter Fees and Field Rental Costs", body:"The Board was scheduled to review park shelter fees and field rental costs. This item was expected to potentially adjust pricing for public use of village recreation facilities." },
      { item:"Military Road Utility Engineering Services Contract", body:"The Board was set to consider an engineering services contract for Military Road utilities. This infrastructure project was expected to address utility improvements along this corridor." },
      { item:"Well 2 Rehabilitation", body:"The Board was scheduled to consider action on rehabilitation of Well 2, a village water supply facility. This maintenance project was expected to ensure continued reliable water service to residents." },
    ],
    ...
    actionItems: [
      ...
      "Expected to consider approval of vouchers check numbers 66279-66316, 66322-66380, 66396-66429 and 90240-90243",
      ...
      "Expected to consider Well 2 Rehabilitation project",
      "Expected to consider Baseball\/Softball Field Maintenance and User Agreement",
      "Expected to consider Park Shelter Fees and Field Rental Costs changes",
    ],
  },
  {
    ...
    isAgendaOnly: true,
    badge: "new",
    overview: "Based on the published agenda, the Village of Weston Board of Trustees was scheduled to address multiple rezoning ordinances, a subdivision plat approval, infrastructure projects including street maintenance and utility engineering, and various parks and recreation matters. The meeting was also set to include discussion of an April 2026 referendum and potential e-bicycle regulations.",
    agenda: [
    ...
    discussions: [
      { item:"Ordinance No. 26-004: Rezoning of 8905 Birch Street", body:"The Board was scheduled to consider rezoning a portion of 8905 Birch Street from Rural Residential-5 Acre (RR-5) to Single Family Residential-Small Lot (SF-S) zoning district. This change was expected to enable different residential development options on the property." },
      { item:"Ordinance No. 26-005: Rezoning of 7105 Christiansen Avenue", body:"The Board was set to review rezoning a portion of 7105 Christiansen Avenue from Single Family Residential-Large Lot (SF-L) to Single Family Residential-Small Lot (SF-S). This ordinance was expected to allow for smaller lot development on the property." },
      { item:"Ordinance No. 26-006: Speed Limits Amendment", body:"The Board was scheduled to consider amending Chapter 82.600 Speed Limits of the Municipal Code. The specific speed limit changes were not detailed in the agenda." },
      { item:"Resolution No. 2026-008: Hinner Springs Second Addition Subdivision", body:"The Board was expected to consider approval of the final plat for Hinner Springs Second Addition Subdivision. This represents a continuation of residential development in the subdivision." },
      { item:"April 2026 Referendum Informational Sessions Update", body:"The Board was scheduled to receive a discussion-only update on informational sessions planned for an April 2026 referendum. No action was indicated for this item." },
      { item:"Proposed E-Bicycle and E-Moto Ordinance Dialogue", body:"The Board was set to discuss and potentially take action on referring dialogue about e-bicycle and e-moto regulations to the Community Life and Public Safety Committee. This suggests the village may be considering how to regulate electric bicycles and motorized vehicles." },
      { item:"Removal of No Parking Restrictions", body:"The Board was expected to consider removing no parking restrictions on Alta Verde Street south of Jelinek Avenue and on Alderson Street along Kennedy Park. This could affect parking availability for park users and residents." },
      { item:"Baseball\/Softball Field Maintenance and User Agreement", body:"The Board was scheduled to discuss and potentially take action on maintenance arrangements and user agreements for baseball and softball fields. This would establish responsibilities and terms for field use." },
      { item:"Purchase of Commercial Rotary Mower", body:"The Board was expected to consider the purchase of a commercial rotary mower for village operations. The specific cost or vendor details were not included in the agenda." },
      { item:"Park Shelter Fees and Field Rental Costs", body:"The Board was set to review and potentially take action on fees for park shelter reservations and field rentals. This could result in updated pricing for community use of village facilities." },
      { item:"Eagle Scout Project at Machmueller Park", body:"The Board was scheduled to discuss and potentially approve an Eagle Scout project proposed for Machmueller Park. Specific project details were not included in the agenda." },
      { item:"Remote Meeting Attendance Policy Review", body:"The Board was expected to review the Elected and Appointed Officials' Handbook regarding remote meeting attendance policy. This could result in updates to how officials may participate in meetings remotely." },
      { item:"Military Road Utility Engineering Services Contract", body:"The Board was scheduled to consider an engineering services contract for Military Road utility work. This represents infrastructure planning for the roadway." },
      { item:"Bus 51 Storm Pond Engineering Services Contract Amendment", body:"The Board was expected to consider an amendment to the engineering services contract for the Bus 51 storm pond project. This suggests ongoing stormwater management work in that area." },
      { item:"Sewer Televising Software Contract", body:"The Board was set to review a contract for sewer televising software. This technology is typically used for inspecting sewer infrastructure conditions." },
      { item:"2026 Annual Street Maintenance Plan and Budget", body:"The Board was scheduled to discuss and potentially approve the annual street maintenance plan and associated budget for 2026. This would establish priorities and funding for road maintenance throughout the year." },
      { item:"Hospital Area Repaving Change Order #4", body:"The Board was expected to consider the fourth change order for the hospital area repaving project. Change orders typically address modifications to scope, timeline, or cost of ongoing construction projects." },
      { item:"Well 2 Rehabilitation", body:"The Board was scheduled to discuss and potentially take action on rehabilitation of Well 2. This represents maintenance of the village's water supply infrastructure." },
      { item:"Sign Encroachment Agreement with 7th Floor Investments, LLC", body:"The Board was expected to consider a sign encroachment agreement with 7th Floor Investments, LLC for Macco's Floor Covering at 3111 Schofield Avenue. This would authorize a sign that extends into public right-of-way." },
    ],
    publicComment: "Public comment was scheduled for up to three minutes per person regarding non-agenda items, with time extensions permitted at the discretion of the Chief Presiding Officer.",
    actionItems: [
      "Scheduled to vote on approval of February 16, 2026 meeting minutes",
      "Scheduled to vote on vouchers (check numbers 66279-66316, 66322-66380, 66396-66429 and 90240-90243)",
      "Scheduled to vote on agent change appointment for Reliance Fuel LLC",
      "Scheduled to vote on Ordinance No. 26-004 rezoning 8905 Birch Street",
      "Scheduled to vote on Ordinance No. 26-005 rezoning 7105 Christiansen Avenue",
      "Scheduled to vote on Ordinance No. 26-006 amending speed limits",
      "Scheduled to vote on Resolution No. 2026-008 approving Hinner Springs Second Addition Subdivision final plat",
      "Expected to consider E-Bicycle and E-Moto Ordinance committee referral",
      "Expected to consider removal of parking restrictions on Alta Verde St and Alderson Street",
      "Expected to consider intersection signage at Community Center Drive and Birch St",
      "Expected to consider Baseball\/Softball Field Maintenance and User Agreement",
      ...
      "Expected to consider remote meeting attendance policy updates",
      "Expected to consider Microsoft Teams for communication",
      "Expected to consider Military Road Utility Engineering Services Contract",
  ...
  },
  {
    ...
    isAgendaOnly: false,
    badge: "new",
    overview: "The Board of Public Works awarded a $1,279,989.75 contract to Switlick & Sons, Inc. for the 2026 North 8th Avenue Street Construction Project. The board denied the 2026 Asphalt Paving Project 'A' bid recommendation, while approving change orders and a pay estimate for the ongoing Randolph Street\/Cherry Street construction project.",
    agenda: [
    ...
    discussions: [
      { item:"March 10, 2026 Regular Board of Public Work Minutes", body:"The minutes from the March 10, 2026 meeting were approved by the board." },
      { item:"2026 Street Construction Project 'B' - North 8th Avenue", body:"The board opened bids and approved awarding the contract to Switlick & Sons, Inc. in the amount of $1,279,989.75. The motion passed." },
      { item:"2026 Asphalt Paving Project 'A'", body:"The board opened bids for the 2026 Asphalt Paving Project 'A' but the motion to approve the bid recommendation failed." },
      { item:"2025 Street Construction Project 'A' - Change Orders", body:"The board approved Change Order #1 in the amount of $14,436.50 for the Randolph Street\/Cherry Street project with Haas Sons, Inc. The motion passed." },
      { item:"2025 Street Construction Project 'A' - Pay Estimate #9", body:"The board approved Pay Estimate #9 in the amount of $535,011.42 for Haas Sons, Inc. for the Randolph Street\/Cherry Street project. The motion passed." },
    ...
    actionItems: [
      "Contract awarded to Switlick & Sons, Inc. for $1,279,989.75 for 2026 North 8th Avenue Street Construction Project",
      "2026 Asphalt Paving Project 'A' bid recommendation denied - may require rebidding or reconsideration",
      "Change Order #1 for $14,436.50 approved for Haas Sons, Inc. on Randolph Street\/Cherry Street project",
      "Pay Estimate #9 for $535,011.42 approved for Haas Sons, Inc.",
      "Portland Cement Concrete License issued to KSK, Inc.",
    ],
    civicItems: [
  ...
  },
  {
    ...
    discussions: [
      ...
      { item:"February 18, 2026 Regular Plan Commission Minutes", body:"The minutes from the February 18, 2026 Regular Plan Commission meeting were approved. Specific vote count and movers not recorded." },
      { item:"Conditional Use Permit for 218 South 4th Street - Dunwoody Storage", body:"A public hearing was held regarding a Conditional Use Permit to authorize construction of a Personal Storage Facility in the Light Industrial Zoning District. No final action vote is recorded for this item." },
      { item:"Conditional Use Permit for 731 N 1st Street - Beacon Resources, LLC", body:"The Commission approved the Conditional Use Permit for a 70-unit, 7-story apartment building at 731 N 1st Street. The motion passed, though specific vote count and movers are not recorded." },
      { item:"Transportation Project Plat for Project 370-40-40", body:"The Commission approved the Transportation Project Plat for Grand Avenue signal replacements at Sturgeon Eddy Road and Townline Road. The motion passed, though specific vote count and movers are not recorded." },
    ],
    ...
    actionItems: [
      "Conditional Use Permit approved for 70-unit apartment building at 731 N 1st Street by Beacon Resources, LLC",
      "Transportation Project Plat approved for Grand Avenue signal replacements at Sturgeon Eddy Road and Townline Road",
      "Public hearing held for Dunwoody Storage Conditional Use Permit at 218 South 4th Street - action pending",
    ],
    civicItems: [
  ...
  },
  {
    ...
    isAgendaOnly: false,
    badge: "new",
    overview: "The Board of Public Works awarded the 2026 Asphalt Paving Project 'A' contract to RC Pavers, LLC for $824,146.34. The board conducted a brief meeting with one substantive action item before adjourning.",
    agenda: [
      { time:"N\/A", item:"Open bids and make recommendation for 2026 Asphalt Paving Project 'A'" },
    ],
    discussions: [
      { item:"Open bids and make recommendation for 2026 Asphalt Paving Project 'A'", body:"The board opened bids and voted to award the contract for the 2026 Asphalt Paving Project 'A' to RC Pavers, LLC in the amount of $824,146.34. The motion passed." },
    ],
    publicComment: "Not indicated on agenda.",
    actionItems: [
  ...
  },
  {
    ...
    isAgendaOnly: false,
    badge: "new",
    overview: "The Wausau Public Health and Safety Committee approved all action items including license applications with one exception for Theodore Davis, repealed and recreated the solid waste disposal code, repealed the hand-held mobile phone driving prohibition ordinance, and approved a solar energy partnership with MREA. The committee also received informational reports from the Fire Department and on tavern activities.",
    agenda: [
      { time:"N\/A", item:"Public comment on agenda items and reading of the City of Wausau Public Comment Statement" },
    ...
    discussions: [
      { item:"Consideration of the minutes of the preceding meeting(s)", body:"The February 16, 2026 Regular Public Health & Safety Committee Minutes were approved 3-0. Sarah Watson moved and Lou Larson seconded the motion." },
      { item:"Approval or denial of various license applications", body:"The committee approved a parklet permit and approved licenses as indicated by staff with the exception of Theodore Davis. Both motions passed, though specific vote counts were not recorded." },
      { item:"Repealing and recreating Wausau Municipal Code Chapter 6.44 Solid Waste Disposal", body:"The committee approved the new solid waste disposal code provision. The motion passed, though the specific vote count was not recorded." },
      { item:"Repealing Wausau Municipal Code Section 10.01.012 Use of Hand-Held Mobile Telephones and Mobile Electronic Devices While Driving Prohibited", body:"The committee voted to repeal the code section prohibiting use of hand-held mobile phones while driving. The motion passed, though the specific vote count was not recorded." },
      { item:"Approving Memorandum of Understanding between the City of Wausau and the Midwest Renewable Energy Association (MREA)", body:"The committee approved the MOU to partner with MREA in operating the Grow Solar Central Wisconsin Group Buy Program. The motion passed, though the specific vote count was not recorded." },
      { item:"Wausau Fire Department 2025 Annual Report", body:"The Fire Department's 2025 Annual Report was presented as a discussion item. No action was required or taken." },
      { item:"Tavern Activities Report from February 2026", body:"The February 2026 Tavern Activities Report was presented as a discussion item. No action was required or taken." },
      { item:"Community Outreach Update", body:"A community outreach update was presented as a discussion item. No action was required or taken." },
    ],
    publicComment: "Public comment on agenda items was listed as the first item on the agenda.",
    actionItems: [
      "License applications approved as indicated by staff, with Theodore Davis application handled separately",
      "Parklet permit approved",
      "New Wausau Municipal Code Chapter 6.44 Solid Waste Disposal provisions to take effect",
  ...
  },
  {
    ...
    isAgendaOnly: false,
    badge: "new",
    overview: "The Finance Committee denied a tax recovery claim for Green Acres at Greenwood Hills LLC, while approving multiple airport ground leases and several budget-related items. Three significant items were postponed to the next meeting, including the National Opioid Settlement participation, a Water Works budget amendment, and a property purchase decision for the Department of Public Works.",
    agenda: [
      { time:"N\/A", item:"Public comment on agenda items and reading of the City of Wausau Public Comment Statement" },
    ...
    discussions: [
      { item:"March 10, 2026 Regular Finance Committee Minutes", body:"The minutes were approved 4-0. Sarah Watson moved and Aaron Griner seconded the motion." },
      { item:"Approving Alleged Claim for Recovery of Unlawful Tax for Green Acres at Greenwood Hills, LLC - Outlot 1", body:"The committee voted to deny the claim for recovery of unlawful tax. The motion to approve the claim failed." },
      { item:"Approving consent to transfer title to buildings and improvements at 939 Woods Place", body:"The committee approved the consent to transfer title to buildings and improvements and waiver of first right of refusal for the property at 939 Woods Place." },
      { item:"Terminating Airport Ground Lease with Wynn O. Jones at 939 Woods Place", body:"The committee approved the termination of the airport ground lease with Wynn O. Jones at 939 Woods Place." },
      { item:"Approving Airport Ground Lease with Owen Jones at 939 Woods Place", body:"The committee approved a new airport ground lease with Owen Jones at 939 Woods Place." },
      { item:"Approving Airport Ground Lease with Cole Lundberg", body:"The committee approved an airport ground lease with Cole Lundberg." },
      { item:"Six Remnant Defendants National Opioid Settlement Agreement", body:"The committee voted to postpone consideration of participation in the National Opioid Settlement Agreement to the next scheduled meeting." },
      { item:"Wausau Water Works budget amendment for 2025 Lead Service Line Replacement project", body:"The committee voted to postpone consideration of the budget amendment for costs not funded by the WDNR subsidized loan to the next meeting." },
      { item:"Budget amendment for carryover of funds from 2025 to 2026", body:"The committee approved the budget amendment for the carryover of funds from 2025 to 2026." },
      { item:"Review of 2025 Motor Pool Fund financial results and related budget amendment", body:"This item was on the agenda for review. No vote was recorded in the official records." },
      { item:"Approving 2026 General Obligation Promissory Note for Capital Improvements", body:"The committee approved forwarding the 2026 General Obligation Promissory Note for Capital Improvements to the calendar." },
      { item:"Review of 2025 General Fund Financial Results", body:"The committee approved the transfer of funds following review of the 2025 General Fund financial results." },
      { item:"Purchasing properties for Department of Public Works Streets Division", body:"The committee voted to postpone consideration of purchasing properties at 108 Adolph Street, 112 Adolph Street, 112-1\/2 Adolph Street and 233 Myron Street until the next meeting." },
    ],
    publicComment: "Public comment on agenda items was on the agenda as the first item.",
    actionItems: [
      "Tax recovery claim for Green Acres at Greenwood Hills LLC - Outlot 1 denied",
      "Airport ground lease transfers at 939 Woods Place approved - terminating lease with Wynn O. Jones and approving new lease with Owen Jones",
      ...
      "Transfer of funds from 2025 General Fund approved",
      "National Opioid Settlement participation postponed to next meeting",
      "Water Works budget amendment for Lead Service Line Replacement project postponed to next meeting",
  ...
  },
  {
    ...
    isAgendaOnly: false,
    badge: "new",
    overview: "The Wausau Common Council approved all items on the March 24, 2026 agenda, including a development agreement for Waterside Place at 11 Scott Street, a residential solid waste and recycling service agreement with Harter's Fox Valley Disposal LLC, and a budget modification allowing the Police Department to use proceeds from selling a Thompson sub-machinegun to purchase red-dot optics. The council also approved a settlement release in the David Hoelzel litigation case after a closed session.",
    agenda: [
    ...
    discussions: [
      { item:"Consent Agenda", body:"Approved 9-0. Sarah Watson moved and Chad Henke seconded. The consent agenda included an ordinance amending parks regulations on fires, fireworks, firearms, and missiles, plus renewal of a parking lot lease with Colonial Property 4, LLC for the Grant and 3rd Streets location." },
      { item:"Confirming Mayoral Appointments", body:"Approved. The council confirmed the Mayor's appointments to the Plan Commission, Affordable Housing Task Force, and the Business Improvement District Board." },
      { item:"Residential Solid Waste and Recycling Service Agreement", body:"Approved. The resolution authorizes a service agreement with Harter's Fox Valley Disposal LLC for residential solid waste and recycling services." },
      { item:"Airspace Obstruction Removal Agreements", body:"Both resolutions approved. The agreements with Schofield Ridgeland Legacy LLC for 724 and 732 Ridgeland Avenue, and with Zachary Lange for 811 Ridgeland Avenue in Schofield, include related budget modifications." },
      { item:"Police Department Budget Modification for Red-Dot Optics", body:"Approved. The 2026 budget modification allows the Wausau Police Department to use proceeds from the sale of a Thompson sub-machinegun to purchase red-dot optics." },
      { item:"Development Agreement for Waterside Place at 11 Scott Street", body:"Approved. The joint resolution from the Economic Development Committee and Infrastructure & Facilities Committee authorizes a development agreement and amended parking agreement with 11 Scott Street, LLC for the Waterside Place project." },
      { item:"Suspend Council Rules", body:"Approved 7-2. Lisa Rasmussen moved and Sarah Watson seconded. Terry Kilian and Vicki Tierney voted no. The suspension allowed consideration of late-filed items." },
      { item:"Solid Waste Disposal Code Update", body:"Approved. The ordinance repeals and recreates Wausau Municipal Code Chapter 6.44 regarding solid waste disposal." },
      { item:"Settlement Release - David Hoelzel v. City of Wausau", body:"Approved. The resolution authorizes release of all claims for property damage settlement of counterclaim and third party complaint in Marathon County Case No. 25-CV-594." },
      { item:"Paid Duty Time for Out of Country Police Training", body:"Approved. The joint resolution from Human Resources and Finance committees authorizes paid duty time for a Wausau Police Department officer to attend training outside the country." },
      { item:"Community Outreach Professional Shelter Operations Duty Premium", body:"Approved. The joint resolution establishes a duty premium differential for Community Outreach Professional shelter operations." },
    ],
    publicComment: "Public comment was on the agenda, with preregistered citizen comments and comments from citizens present occurring both before and after the business meeting.",
    actionItems: [
      "Implement residential solid waste and recycling service agreement with Harter's Fox Valley Disposal LLC",
      "Execute airspace obstruction removal agreements with Schofield Ridgeland Legacy LLC and Zachary Lange",
      "Process budget modification for Police Department red-dot optics purchase",
      "Finalize development agreement with 11 Scott Street, LLC for Waterside Place project",
      "Implement updated Solid Waste Disposal code (Chapter 6.44)",
      "Process settlement release in David Hoelzel litigation",
      "Implement shelter operations duty premium differential for Community Outreach Professionals",
    ],
    civicItems: [
  ...
  },
  {
    ...
    isAgendaOnly: true,
    badge: "new",
    overview: "The Wausau School District Education\/Operations Committee meeting covered the 4K program partnership agreements for 2026-2027, an annual safety update including drill debriefs, and a comprehensive review of 43 Neola policy updates. The meeting addressed key operational matters including school security protocols and administrative policy revisions.",
    agenda: [
    ...
    discussions: [
      { item:"4K Program Agreement", body:"The district's four-year-old kindergarten program is seeking approval to enter into agreements with six community collaboration sites for the 2026-2027 school year, including Wausau Child Care, Mountain View Montessori, Woodson YMCA, Newman Catholic Schools, and the Marathon County Child Development Agency Head Start Program. This partnership program has been in place since 2002 and will be presented by 4K Principal Kara Rakowski and Director of Elementary Education Julie Schell." },
      { item:"Annual Safety Update \/ Drill Debrief", body:"The district is implementing the I Love U Guys Standard Response Protocol (SRP) with standardized vocabulary including HOLD, SECURE, LOCKDOWN, EVACUATE, and SHELTER for consistent emergency responses. Security highlights include secure building entrances, the Visitor Aware System, security cameras, and locked exterior doors, with district-wide drills conducted in September (LOCKDOWN) and October (EVACUATION) in partnership with Wausau Police Department and School Resource Officers." },
      { item:"Neola Policies Update", body:"The committee reviewed 43 proposed policy changes covering a wide range of topics including board member conduct, student drug policies, drone use, school safety, wellness programs, volunteer policies, and food service regulations. The updates include both substantive Volume 34 Number 2 revisions and technical corrections to existing policies." },
    ],
    ...
    actionItems: [
      ...
      "Approve Neola Policies Update including 43 policy revisions",
      "Approve the Minutes from 10.27.25 meeting",
    ],
  },
  {
    ...
    isAgendaOnly: true,
    badge: "new",
    overview: "This special meeting of the Wausau School District Board of Education focused on closed session discussions regarding real estate negotiations and the superintendent evaluation. The board may take action following these confidential deliberations.",
    agenda: [
      { time:"0:00", item:"Call to Order" },
    ...
    discussions: [
      { item:"Discussion regarding the Competitive Negotiations of a Purchase\/Sale of Real Estate", body:"The board entered closed session under Wisconsin statute 19.85(1)(e) to discuss competitive negotiations related to the purchase or sale of real estate. This exemption allows confidential deliberation to protect the district's bargaining position in property transactions." },
      { item:"Evaluation of Superintendent of Schools", body:"The board conducted a closed session evaluation of the Superintendent of Schools under Wisconsin statute 19.85(1)(c). This statute permits private discussion of employee performance reviews to protect personnel matters." },
    ],
    publicComment: "No public comment period was included on this agenda.",
    actionItems: [
      "Possible action as a result of closed session discussions on real estate negotiations",
      "Possible action as a result of closed session discussions on superintendent evaluation",
    ],
  },
  {
    ...
    isAgendaOnly: true,
    badge: "new",
    overview: "The Wausau School District Board of Education Regular Meeting covered referendum construction updates for four elementary schools, a Red Granite Charter School status update, 4K program partnership agreements, annual safety updates, and numerous policy revisions. The meeting also included a resolution of commendation for Rob Hughes and approval of routine consent agenda items including personnel matters and financial reports.",
    agenda: [
      { time:"0:00", item:"CALL TO ORDER" },
      ...
      { time:"0:30", item:"50% Updates for Elementary Referendum Construction" },
      { time:"0:45", item:"Education\/Operations Committee Meeting" },
      { time:"0:50", item:"NEW BUSINESS" },
      { time:"0:52", item:"Red Granite Update (Action Requested)" },
      { time:"0:57", item:"Education\/Operations Committee Meeting - 4K Program Agreement (Action Requested)" },
      { time:"0:59", item:"Annual Safety Update \/ Drill Debrief" },
      { time:"1:01", item:"Neola Policies Update (Action Requested)" },
      { time:"1:06", item:"OPEN FORUM" },
      { time:"1:08", item:"Board Member Professional Growth & Development Report" },
      { time:"1:11", item:"Legislative Liaison" },
      { time:"1:14", item:"Superintendent Commentary" },
      { time:"1:17", item:"Presiding Officer Commentary" },
      { time:"1:20", item:"ADJOURN" },
    ],
    discussions: [
      { item:"50% Updates for Elementary Referendum Construction", body:"As referendum-funded improvement plans develop for each facility, the Board received updates when designs reach 50% completion. Current plans for John Marshall, Rib Mountain, Franklin Elementaries, and Lincoln Early Learning Academy were shared with the Board during an estimated 15-minute presentation." },
      { item:"Red Granite Update", body:"Red Granite Principal Maud Mangin and Red Granite Governance Board President Amanda Molin shared an update on the status of the Red Granite Charter School during an estimated 5-minute presentation." },
      { item:"4K Program Agreement", body:"The Wausau School District four-year-old kindergarten program, which has partnered with community collaboration sites since 2002, sought approval to enter into agreements with partner sites for the 2026-2027 school year including Wausau Child Care, Mountain View Montessori, Woodson YMCA, Newman Catholic Schools, and Marathon County Child Development Agency Head Start Program." },
      { item:"Annual Safety Update \/ Drill Debrief", body:"At the November Education\/Operations Committee Meeting, Andy Grimm and members of the Wausau Police Department shared the annual safety update and provided information about the strong partnership between the Wausau Police Department and the district, especially with School Resource Officers." },
      { item:"Neola Policies Update", body:"At the November Education\/Operations Committee meeting, proposed changes to 43 attached policies were reviewed, covering topics including board member conduct, student drug policies, drone use, school safety, wellness, and various technical corrections." },
    ],
    publicComment: "A public and student comment period was included on this agenda.",
    actionItems: [
      ...
      "Red Granite Charter School status update approval",
      "4K Program Agreement with community partner sites for 2026-2027",
  ...
  },
  {
    ...
    discussions: [
      { item:"Audit of the Bills", body:"Committee members reviewed the December 2025 audit of bills document attached to the agenda. This review involves examining district expenditures and invoices to ensure proper financial controls and authorize payments." },
    ],
    publicComment: "No public comment period was included on this agenda.",
    actionItems: [
  ...
  },
  {
    ...
    discussions: [
      { item:"Approve Administrator Contracts and Discuss Performance and Employment of a Staff Member", body:"The board entered closed session under Wisconsin Statute 19.85(1)(c) to discuss and approve administrator contracts and address performance and employment matters related to one or more staff members. This closed session item involves confidential personnel matters." },
      { item:"Discussion regarding the Competitive Negotiations of a Purchase\/Sale of Real Estate", body:"The board discussed competitive negotiations related to the purchase or sale of real estate in closed session under Wisconsin Statute 19.85(1)(e). This exemption allows the board to discuss property transactions without public disclosure during active negotiations." },
      { item:"Resolution of Commendation: Ellie Mason", body:"The board presented a resolution of commendation to recognize Ellie Mason for her contributions to the district. Supporting documentation for this recognition was attached to the agenda packet." },
    ],
    publicComment: "No public comment period was included on this agenda.",
    actionItems: [
      "Approve Administrator Contracts",
      "Approve Resolution of Commendation for Ellie Mason",
      "Take any necessary action following closed session reconvening in open session",
    ],
  },
  {
    ...
    isAgendaOnly: true,
    badge: "new",
    overview: "The Education\/Operations Committee meeting addressed open enrollment space determinations for the 2026-2027 school year, snow day communication procedures, and several athletic co-op renewals. The meeting also featured a performance by John Muir Middle School students and highlighted recent updates to the school facility.",
    agenda: [
      { time:"0:00", item:"Call to Order" },
    ...
    discussions: [
      { item:"Open Enrollment Seat Availability", body:"Wendy Cartledge presented the Open Enrollment Space Determinations for the 2026-2027 school year. The committee was asked to take action on seat availability for students from outside the district who wish to enroll through Wisconsin's open enrollment program." },
      { item:"Snow Day Communication & Procedures", body:"Diana White and Dr. Katie Colwell presented information on communications and procedures for snow days. The presentation addressed what happens beyond the three allotted snow days in the district calendar." },
      { item:"Approve Co-Ops", body:"Athletic Directors BJ Brandt and Darci Mick Beversdorf presented information on multiple athletic co-op renewals including boys hockey (East\/Merrill\/Newman Catholic), girls lacrosse (East\/West\/DCE\/Mosinee), and girls STORM hockey (East\/West\/DCE\/Mosinee with the addition of Merrill and Stratford) for the 2026-27 and 2027-28 school years." },
    ],
    ...
    actionItems: [
      ...
      "Approve girls STORM hockey co-op renewal with East\/West\/DCE\/Mosinee\/Merrill\/Stratford for 2026-28",
  ...
  },
  {
    ...
    isAgendaOnly: true,
    badge: "new",
    overview: "This special meeting of the Wausau School District Board of Education focused primarily on personnel matters, including routine staff appointments and separations, as well as two closed sessions to address employee termination proceedings and administrator contracts. The meeting included a quasi-judicial hearing regarding employee conduct allegations.",
    agenda: [
      { time:"0:00", item:"Call to Order" },
      { time:"0:02", item:"Approve Consent Agenda (Action Requested) - Appointments, Separations, Leaves of Absence, Retirements" },
      { time:"0:07", item:"Request for Closed Session - Employee conduct hearing and deliberation" },
      { time:"0:10", item:"Reconvene in Open Session" },
      { time:"0:12", item:"Request for Closed Session - Administrator Contracts and Staff Performance" },
      { time:"0:15", item:"Reconvene in Open Session" },
      { time:"0:17", item:"Adjourn" },
    ],
    discussions: [
      { item:"Consent Agenda", body:"The consent agenda included personnel actions covering appointments of additional and replacement staff, contract increases, staff separations including resignations and terminations, leaves of absence, and retirements." },
      { item:"Closed Session - Employee Conduct", body:"The board convened into closed session pursuant to Wisconsin Statute 19.85(1)(b) to receive evidence concerning allegations regarding employee conduct and an administrative recommendation for termination. The board was also authorized to deliberate on evidence received during the quasi-judicial hearing and consider a potential employee resignation agreement." },
    ...
    actionItems: [
      ...
      "Consider action on employee termination or resignation agreement following closed session",
  ...
  },
  {
    ...
    isAgendaOnly: true,
    badge: "new",
    overview: "This regular meeting of the Wausau School District Board of Education covers the approval of the 2024-25 audit report, WASB delegate voting resolutions, and a discussion on replacing the chiller system at Wausau West High School. The board will also address open enrollment seat availability, athletic co-op renewals, and enter closed session for potential litigation and superintendent evaluation matters.",
    agenda: [
      { time:"0:00", item:"Call to Order" },
      { time:"0:02", item:"Roll Call" },
      { time:"0:04", item:"Pledge of Allegiance: Jim Bouch, President" },
      ...
      { time:"1:13", item:"New Business - Open Enrollment Seat Availability" },
      { time:"1:14", item:"New Business - Approve Co-Ops" },
      ...
      { time:"1:44", item:"Closed Session - Evaluation of Superintendent of Schools" },
    ...
    discussions: [
      ...
      { item:"WASB Resolutions", body:"The Board will review the proposed WASB Resolutions and direct the WASB Delegate on how to vote on behalf of the District. A late addition includes Resolution 13 proposing an amendment to the Bylaws of WASB." },
      ...
      { item:"Wisconsin Investment Series Cooperative Resolution", body:"Assistant Superintendent of Operations Elizabeth Channel is presenting a resolution to allow the District to continue its membership in the Wisconsin Investment Series Cooperative. This resolution updates the most recent authorization, which is over ten years old, in accordance with best practice." },
      ...
      { item:"Approve Co-Ops", body:"The Board will consider athletic co-op renewals including boys hockey East\/Merrill\/Newman Catholic, girls lacrosse East\/West\/DCE\/Mosinee, and girls STORM hockey East\/West\/DCE\/Mosinee with the addition of Merrill and Stratford, all for the 26-27 and 27-28 school years." },
    ],
    publicComment: "A public and student comment period is included on the agenda under item V.",
    actionItems: [
      "Approve Consent Agenda including appointments, separations, leaves of absence, retirements, meeting minutes, payment of bills, and donations",
      "Approve the 2024-25 Audit Report",
      "Direct WASB Delegate on how to vote on proposed WASB Resolutions",
      "Possible action on Wausau West Chiller replacement bid solicitation",
      "Approve Resolution Authorizing Entry into Wisconsin Investment Series Cooperative Agreement",
      "Approve Open Enrollment Seat Availability for 2026-2027",
  ...
  },
  {
    ...
    isAgendaOnly: true,
    badge: "new",
    overview: "The Audit of the Bills Committee met to review and approve the district's financial expenditures for the billing period. This routine financial oversight meeting ensures proper review of Wausau School District payments and expenditures.",
    agenda: [
      { time:"0:00", item:"Call to Order" },
      { time:"0:02", item:"Audit of the Bills" },
    ...
    discussions: [
      { item:"Audit of the Bills", body:"Committee members reviewed the district's bills and expenditures as documented in the January 26 audit attachment. This standard financial review process ensures all district payments are properly vetted before approval." },
    ],
    publicComment: "No public comment period was included on this agenda.",
    actionItems: [
      "Review and approval of district bills and expenditures for the billing period",
    ],
  },
  {
    ...
    isAgendaOnly: true,
    badge: "new",
    overview: "The Wausau School District Education\/Operations Committee meeting covered referendum project designs for four elementary schools at 95% completion, legal expenses, the 2026-2027 school calendar, financial projection model assumptions, and student demographics. The meeting also included recognition of excellence at two elementary schools and continued discussion about potential governance model changes.",
    agenda: [
      { time:"0:00", item:"Call to Order" },
      { time:"0:02", item:"Approve the Minutes" },
    ...
    discussions: [
      { item:"Franklin, Rib Mountain, Lincoln & John Marshall 95% Design", body:"As referendum projects for each facility reach the end of the design phase at 95% completion, the Board reviews the designs and budget. The Committee is being asked to consider approval of these plans for Franklin, Rib Mountain, Lincoln & John Marshall Elementary schools to be issued for competitive bidding." },
      ...
      { item:"Approve 2026-2027 District Calendar", body:"Diana White presented a draft of the 2026-2027 school year calendar for School Board review. The Committee is being asked to approve the calendar." },
    ...
    publicComment: "A public and student comment period was included on the agenda.",
    actionItems: [
      "Approval of 95% design plans for Franklin, Rib Mountain, Lincoln & John Marshall Elementary schools for competitive bidding",
      "Approve 2026-2027 District Calendar",
      "Possible action on Governance Model Option regarding committee structure changes",
      "Approve the Minutes from 12\/15\/25",
    ],
  },
  {
    ...
    isAgendaOnly: true,
    badge: "new",
    overview: "This special meeting of the Wausau School District Board of Education focused on personnel matters, approving the 2026-2027 district calendar, and conducting the closed session evaluation of the Superintendent. The meeting addressed routine staffing changes through the consent agenda and finalized the upcoming school year calendar.",
    agenda: [
      { time:"0:00", item:"Call to Order" },
      ...
      { time:"0:06", item:"Request for Closed Session - Evaluation of Superintendent of Schools" },
      { time:"0:08", item:"Reconvene in Open Session, and if Necessary, Take Action as a Result of the Closed Session" },
      { time:"0:10", item:"Adjourn" },
    ],
    discussions: [
      { item:"Approve 2026-2027 District Calendar", body:"Diana White previously presented a draft of the 2026-2027 school year calendar for School Board review at a prior meeting. The board was asked to take action on final approval of the calendar with an estimated presentation time of 1 minute." },
      { item:"Evaluation of Superintendent of Schools", body:"The board entered closed session pursuant to state statute s. 19.85 (1)(c) to conduct the evaluation of the Superintendent of Schools. This personnel matter required confidential deliberation as permitted under Wisconsin open meetings law." },
    ],
    publicComment: "No public comment period was included on this agenda.",
    actionItems: [
      "Approve Consent Agenda including appointments, separations, leaves of absence, and retirements",
      "Approve 2026-2027 District Calendar",
      "Potential action following closed session evaluation of Superintendent",
    ],
  },
  {
    ...
    isAgendaOnly: true,
    badge: "new",
    overview: "This Regular Meeting of the Wausau School District Board of Education addressed referendum construction projects reaching 95% design completion for four elementary schools, the replacement of Wausau West's chiller system, and an important update on the disbandment of the East\/Merrill Boys Hockey Co-Op. The meeting also included recognition of School Bus Driver Appreciation Week and presentation of the district's financial projection model assumptions.",
    agenda: [
      { time:"0:00", item:"Call to Order" },
      { time:"0:02", item:"Roll Call" },
    ...
    discussions: [
      ...
      { item:"Legal Expenses for 2nd Quarter of 2025-2026", body:"Interim Assistant Superintendent of Operations Elizabeth Channel presented a summary report of all legal counsel expenses incurred during the second quarter of 2025-2026. The report was broken down by law firm and by type of legal advice sought as a written report requiring no action." },
      { item:"2025-2026 Student Demographic Report", body:"Director of Technology Ralph Williams presented the Demographics Report for the 2025-2026 school year at the January Education\/Operations Committee Meeting. This informational report provides data on student population characteristics across the district." },
      { item:"Wausau West Chiller System", body:"Interim Assistant Superintendent of Operations Elizabeth Channel and Director of Buildings and Grounds Ryan Urmanski presented the request to approve the bid for replacement of the chiller system at Wausau West. This infrastructure improvement addresses HVAC needs at the high school." },
      { item:"Wausau East Hockey Update", body:"An informational presentation was provided on the disbandment of the East\/Merrill Boys Hockey Co-Op and potential options for the district, Wausau East, and East Hockey players. This significant change affects student athletic opportunities and partnerships." },
      { item:"Presentation of Financial Projection Model Assumptions", body:"Interim Assistant Superintendent of Operations Elizabeth Channel shared key variables contributing to the District's multi-year financial projection model. The model represents a baseline using current information from the 2025-2026 District budget with percentages and dollar amounts projected forward." },
      { item:"Governance Model Option", body:"Discussion centered on potentially changing the Audit of the Bills Committee and clarifying the purpose of the Education\/Operations Committee with a potential rename. This item addressed board procedures and committee structure." },
    ],
    ...
    actionItems: [
      ...
      "Possible action resulting from closed session regarding competitive negotiations of real estate purchase\/sale",
    ],
  },
  {
    ...
    isAgendaOnly: true,
    badge: "new",
    overview: "The Wausau School District Board of Education held a special meeting primarily focused on personnel matters through the consent agenda and a closed session regarding potential litigation. This meeting addressed routine staffing changes including appointments, separations, leaves of absence, and retirements.",
    agenda: [
      { time:"0:00", item:"Call to Order" },
      ...
      { time:"0:40", item:"Reconvene in Open Session, to take further action if necessary and appropriate" },
      { time:"0:45", item:"Adjourn" },
    ],
    discussions: [
      { item:"Approve Consent Agenda", body:"The consent agenda included personnel matters covering appointments for additional and replacement staff with contract increases, separations including resignations, contract decreases, and terminations, as well as leaves of absence and retirements. An addendum was added to the consent agenda on February 23, 2026." },
      { item:"Preliminary Discussion Regarding Potential Litigation", body:"The board entered closed session under Wisconsin State Statute 19.85(g) to discuss preliminary matters regarding potential litigation facing the district. This statute allows closed sessions for conferring with legal counsel concerning litigation strategy." },
    ],
    publicComment: "No public comment period was included on this agenda.",
    actionItems: [
      "Approve Consent Agenda including appointments, separations, leaves of absence, and retirements",
  ...
  },
  {
    ...
    isAgendaOnly: true,
    badge: "new",
    overview: "The Wausau School District Board of Education Committee of the Whole meeting focused on fiscal planning with a five-year forecast presentation, mid-year AGR school performance data, a comprehensive NEOLA policy update covering over 60 policies, and referendum budget updates. The meeting also celebrated district achievements including the Wausau School District Planetarium and Wausau West High School programs.",
    agenda: [
      { time:"0:00", item:"Call to Order" },
      { time:"0:02", item:"Approve the Minutes" },
    ...
    discussions: [
      { item:"Five Year Fiscal Forecast", body:"The Board received a five-year fiscal forecast model that will be used over the next three months to construct the 2026-27 budget reconciliation plan. Administration emphasized that projections involve many variables that change periodically and committed to updating the Board on significant changes." },
      { item:"AGR Annual Report", body:"This mid-year update presented AGR student outcome scores required by DPI, including screening results from winter 2026. The report highlighted systemic improvements being implemented at the three AGR schools to strengthen organizational systems and improve student achievement." },
      { item:"NEOLA UPDATE", body:"The Committee reviewed proposed changes to numerous district policies, ranging from technical corrections to more substantial revisions. Policy areas covered include board member conduct, student supervision, cell phones, homeless students, third grade promotion, purchasing, fund balance, and school support organizations." },
      { item:"Referendum Budget Update", body:"Construction and budget updates were presented for the ongoing April 2022 referendum-funded facility improvements. These updates will continue to be provided routinely until all projects are completed." },
    ],
    publicComment: "A public and student comment period was included on the agenda.",
    actionItems: [
      "Approve NEOLA policy updates covering definitions, board orientation, board member behavior, anti-harassment, committees, administrator relationships, student supervision, reading instruction, Title I engagement, athletics, advanced learning, job expenses, termination\/resignation, academic honesty, homeless students, cell phones, third grade promotion, student parking, intoxicants policy, student employment, electronic fund transfers, debt management, returned checks, fee waivers, fund balance, purchasing, accounting systems, property disposition, and digital accessibility",
      "Approve school support organization related policies including student fundraising, crowdfunding, accountability and oversight, non-district supported accounts, gifts and grants, district supported organizations, school support organizations, and advertising policies",
      "Approve technical corrections to policies covering board number and qualifications, employment, medication administration, at-risk students, suspension\/expulsion, student activism, student rights, investment income, fees, video surveillance, crisis intervention, school safety, pandemic equipment, head lice, threats of violence, locker room cameras, and veteran diplomas",
    ],
  },
  {
    ...
    isAgendaOnly: true,
    badge: "new",
    overview: "This special meeting of the Wausau School District Board of Education was convened solely to conduct a pupil expulsion hearing in closed session. The meeting addressed student discipline matters requiring confidential deliberation under Wisconsin Statutes.",
    agenda: [
      { time:"0:00", item:"Call To Order" },
  ...
  },
  {
    ...
    isAgendaOnly: true,
    badge: "new",
    overview: "This special meeting brought together the Elementary Task Force members one year after the elementary consolidation decision to review the consolidation summary and gather reflections from task force members. The meeting was informational only, with no Board action taken despite a quorum potentially being present.",
    agenda: [
    ...
    discussions: [
      { item:"Summary of Elementary Consolidation", body:"This item provided an overview of the elementary consolidation process and outcomes. The summary likely covered the decisions made and implementation of school consolidation efforts in the Wausau School District." },
      { item:"Task Force Member Reflectives: One Year Later", body:"Task force members shared their reflections on the consolidation process one year after the decisions were made. This allowed participants to assess the outcomes and share perspectives on how the consolidation has affected the district." },
    ],
    publicComment: "No public comment period was included on this agenda.",
    actionItems: [
  ...
  },
  {
    ...
    isAgendaOnly: true,
    badge: "new",
    overview: "This meeting was a WEA-sponsored candidates Meet & Greet event for Wausau School District School Board candidates. While a quorum of the Board of Education may have been present, this was explicitly not a decision-making meeting as no Board action was scheduled to be taken.",
    agenda: [
      { time:"0:00", item:"WEA Sponsored WSD School Board Candidates Meet & Greet Event" },
    ],
    discussions: [
      { item:"WEA Sponsored WSD School Board Candidates Meet & Greet Event", body:"This event was sponsored by the WEA (Wisconsin Education Association) to provide an opportunity for the public to meet candidates running for the Wausau School District Board of Education. A quorum of current board members may have attended, but the agenda explicitly noted that no official board action would be taken." },
    ],
    publicComment: "No public comment period was included on this agenda.",
    actionItems: [
  ...
  },
  {
    ...
    isAgendaOnly: true,
    badge: "new",
    overview: "The Wausau School District Board of Education held a regular meeting covering a proposed switch from Chromebooks to iPads at middle schools, updates on the 2022 referendum-funded facility improvements, and a five-year fiscal forecast for budget planning. The meeting also included reports on Achievement Gap Reduction schools and routine consent agenda items including personnel matters and bill payments.",
    agenda: [
      { time:"0:00", item:"Call to Order" },
      { time:"0:02", item:"Roll Call" },
      { time:"0:04", item:"Pledge of Allegiance: Jim Bouch, President" },
      ...
      { time:"0:13", item:"Public and Student Comment" },
      { time:"0:23", item:"Approve Consent Agenda (Action Requested)" },
      { time:"0:28", item:"Old\/Recurring Business - Committee of the Whole Meeting: Referendum Budget Update" },
      { time:"0:30", item:"New Business - iPads Presentation (Action Requested)" },
      { time:"0:50", item:"New Business - Committee of the Whole Meeting: Five Year Fiscal Forecast" },
      { time:"0:52", item:"New Business - Committee of the Whole Meeting: AGR Annual Report" },
      { time:"0:54", item:"Open Forum - Board Member Professional Growth & Development Report" },
      { time:"0:57", item:"Open Forum - Legislative Liaison" },
      { time:"1:00", item:"Open Forum - Superintendent Commentary" },
      { time:"1:03", item:"Open Forum - Presiding Officer Commentary" },
      { time:"1:06", item:"Adjourn" },
    ],
    discussions: [
      ...
      { item:"AGR Annual Report", body:"The Committee was presented with mid-year AGR student outcome scores required by the DPI at the February Committee of the Whole Meeting. The report featured screening results and work being done in the three AGR schools to strengthen organizational systems and improve student achievement." },
    ],
    publicComment: "A public and student comment period was included on the agenda.",
    actionItems: [
      ...
      "Approve iPads Presentation proposal for middle school device transition",
    ],
  },
  {
    ...
    isAgendaOnly: true,
    badge: "new",
    overview: "The Wausau School District Board of Education Committee of the Whole meeting addressed several operational matters including nutrition service cooperative membership, facility fee updates for artificial fields, a referendum budget update, and an extensive review of NEOLA policy updates covering over 60 district policies. The meeting also featured recognition of Stettin Elementary through the Excellence in Action program.",
    agenda: [
      { time:"0:00", item:"Call to Order" },
      { time:"0:02", item:"Approve the Minutes" },
    ...
    discussions: [
      ...
      { item:"Referendum Budget Update", body:"Elizabeth Channel, Interim Assistant Superintendent of Operations, will share an update on the status of the Referendum Budget. A memo summarizing the referendum budget status was prepared for the meeting." },
      { item:"NEOLA UPDATE", body:"The Committee will review proposed changes to over 60 policies covering various areas including board definitions, administrator relationships, reading instruction goals, student policies on cell phones and academic honesty, financial procedures, and a new artificial intelligence policy. Some suggestions include technical corrections while others involve more substantive changes including Act 57 related policies on child abuse reporting and student supervision." },
    ],
    publicComment: "No public comment period was included on this agenda.",
    actionItems: [
      ...
      "Approve NEOLA policy updates including policies on definitions, board member conduct, administrator relations, reading instruction, parent engagement, athletics, cell phones, student fees, purchasing, digital accessibility, and artificial intelligence",
      "Approve school support organization related policies on fundraising, crowdfunding, and gifts",
      "Approve technical corrections to various policies",
      "Approve Act 57 related policies on student supervision and child abuse and neglect",
    ],
  },
  {
